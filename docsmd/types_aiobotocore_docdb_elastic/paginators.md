...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListPendingMaintenanceActionsOutputTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListPendingMaintenanceActionsInputListPendingMaintenanceActionsPaginateTypeDef](./type_defs.md#listpendingmaintenanceactionsinputlistpendingmaintenanceactionspaginatetypedef) 
