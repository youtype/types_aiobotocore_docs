<a id="connectclient-for-aiobotocore-connect-module"></a>
...
Asynchronous method. Use `await update_hours_of_operation(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_instance_attribute(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_instance_storage_config(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_queue_hours_of_operation(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_queue_max_contacts(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_queue_name(...)` for a synchronous call.
...
Asynchronous method. Use `await update_queue_outbound_caller_config(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_queue_status(...)` for a synchronous
call.
...
Asynchronous method. Use `await update_quick_connect_config(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_quick_connect_name(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_routing_profile_concurrency(...)` for a
synchronous call.
...
`await update_routing_profile_default_outbound_queue(...)` for a synchronous
call.
...
Asynchronous method. Use `await update_routing_profile_name(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_routing_profile_queues(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_user_hierarchy(...)` for a synchronous
call.
...
Asynchronous method. Use `await update_user_hierarchy_group_name(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_user_hierarchy_structure(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_user_identity_info(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_user_phone_config(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_user_routing_profile(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_user_security_profiles(...)` for a
synchronous call.
...
Boto3 documentation:
[Connect.Client.\_\_aenter\_\_](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/connect.html#Connect.Client.__aenter__)
...
Boto3 documentation:
[Connect.Client.\_\_aexit\_\_](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/connect.html#Connect.Client.__aexit__)
