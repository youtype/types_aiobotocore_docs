...
1. See `List[AgentEndpointTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
class GetAgentRuntimeResponseTypeDef(TypedDict):
    ...
    lastUpdatedAt: datetime.datetime,
    roleArn: str,
    agentRuntimeArtifact: AgentArtifactTypeDef,  # (2)
    networkConfiguration: NetworkConfigurationTypeDef,  # (3)
    protocolConfiguration: ProtocolConfigurationTypeDef,  # (4)
    environmentVariables: Dict[str, str],
    authorizerConfiguration: AuthorizerConfigurationOutputTypeDef,  # (5)
    status: AgentStatusType,  # (6)
    ResponseMetadata: ResponseMetadataTypeDef,  # (7)
```

1. See [:material-code-braces: WorkloadIdentityDetailsTypeDef](./type_defs.md#workloadidentitydetailstypedef)
2. See [:material-code-braces: AgentArtifactTypeDef](./type_defs.md#agentartifacttypedef)
3. See [:material-code-braces: NetworkConfigurationTypeDef](./type_defs.md#networkconfigurationtypedef)
4. See [:material-code-braces: ProtocolConfigurationTypeDef](./type_defs.md#protocolconfigurationtypedef)
5. See [:material-code-braces: AuthorizerConfigurationOutputTypeDef](./type_defs.md#authorizerconfigurationoutputtypedef)
6. See [:material-code-brackets: AgentStatusType](./literals.md#agentstatustype)
...
class CreateGatewayResponseTypeDef(TypedDict):
    ...
    authorizerConfiguration: AuthorizerConfigurationOutputTypeDef,  # (5)
    kmsKeyArn: str,
    workloadIdentityDetails: WorkloadIdentityDetailsTypeDef,  # (6)
...
5. See [:material-code-braces: AuthorizerConfigurationOutputTypeDef](./type_defs.md#authorizerconfigurationoutputtypedef)
6. See [:material-code-braces: WorkloadIdentityDetailsTypeDef](./type_defs.md#workloadidentitydetailstypedef)
...
1. See [:material-code-braces: BrowserNetworkConfigurationTypeDef](./type_defs.md#browsernetworkconfigurationtypedef)
2. See [:material-code-braces: RecordingConfigTypeDef](./type_defs.md#recordingconfigtypedef)
3. See [:material-code-brackets: BrowserStatusType](./literals.md#browserstatustype)
...
class CreateAgentRuntimeRequestTypeDef(TypedDict):
    ...
    description: NotRequired[str],
    protocolConfiguration: NotRequired[ProtocolConfigurationTypeDef],  # (3)
    clientToken: NotRequired[str],
...
class CreateGatewayRequestTypeDef(TypedDict):
    ...
    description: NotRequired[str],
    clientToken: NotRequired[str],
    protocolConfiguration: NotRequired[GatewayProtocolConfigurationUnionTypeDef],  # (4)
    kmsKeyArn: NotRequired[str],
    exceptionLevel: NotRequired[ExceptionLevelType],  # (5)
```
