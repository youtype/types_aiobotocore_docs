...
Type annotations and code completion for `#!python session.create_client("cognito-idp").add_user_pool_client_secret` method.
...
await def add_user_pool_client_secret(
    self,
    *,
    UserPoolId: str,
    ClientId: str,
...
Type annotations and code completion for `#!python session.create_client("cognito-idp").delete_user_pool_client_secret` method.
...
await def delete_user_pool_client_secret(
    self,
    *,
    UserPoolId: str,
    ClientId: str,
...
Type annotations and code completion for `#!python session.create_client("cognito-idp").list_terms` method.
...
Type annotations and code completion for `#!python session.create_client("cognito-idp").list_user_pool_client_secrets` method.
...
await def list_user_pool_client_secrets(
    self,
    *,
    UserPoolId: str,
    ClientId: str,
...
Type annotations and code completion for `#!python session.create_client("cognito-idp").update_terms` method.
