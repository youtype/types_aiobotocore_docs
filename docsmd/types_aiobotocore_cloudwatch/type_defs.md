...
from types_aiobotocore_cloudwatch.type_defs import MuteTargetsUnionTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import AlarmMuteRuleSummaryTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import AlarmPromQLCriteriaTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import DeleteAlarmMuteRuleInputTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import DescribeAlarmContributorsInputTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import GetAlarmMuteRuleInputTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import MuteTargetsOutputTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import ListAlarmMuteRulesInputTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import MuteTargetsTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import ScheduleTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import EvaluationCriteriaTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import DescribeAlarmContributorsOutputTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import GetOTelEnrichmentOutputTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import ListAlarmMuteRulesOutputTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import ListAlarmMuteRulesInputPaginateTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import GetAlarmMuteRuleInputWaitTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import RuleTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import GetAlarmMuteRuleOutputTypeDef
...
from types_aiobotocore_cloudwatch.type_defs import PutAlarmMuteRuleInputTypeDef
...
class MetricAlarmTypeDef(TypedDict):
    ...
    StateTransitionedTimestamp: NotRequired[datetime.datetime],
    EvaluationCriteria: NotRequired[EvaluationCriteriaTypeDef],  # (8)
...
8. See [:material-code-braces: EvaluationCriteriaTypeDef](./type_defs.md#evaluationcriteriatypedef)
...
class PutMetricAlarmInputMetricPutAlarmTypeDef(TypedDict):
    ...
    ThresholdMetricId: NotRequired[str],
    EvaluationCriteria: NotRequired[EvaluationCriteriaTypeDef],  # (7)
    EvaluationInterval: NotRequired[int],
```
...
7. See [:material-code-braces: EvaluationCriteriaTypeDef](./type_defs.md#evaluationcriteriatypedef)
