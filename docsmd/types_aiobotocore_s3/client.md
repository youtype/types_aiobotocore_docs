...
kwargs: CreateBucketMetadataTableConfigurationRequestRequestTypeDef = {  # (1)
    "Bucket": ...,
...
1. See [:material-code-braces: CreateBucketMetadataTableConfigurationRequestRequestTypeDef](./type_defs.md#createbucketmetadatatableconfigurationrequestrequesttypedef) 
...
kwargs: DeleteBucketMetadataTableConfigurationRequestRequestTypeDef = {  # (1)
    "Bucket": ...,
}
...
1. See [:material-code-braces: DeleteBucketMetadataTableConfigurationRequestRequestTypeDef](./type_defs.md#deletebucketmetadatatableconfigurationrequestrequesttypedef) 
...
kwargs: GetBucketMetadataTableConfigurationRequestRequestTypeDef = {  # (1)
    "Bucket": ...,
}
...
1. See [:material-code-braces: GetBucketMetadataTableConfigurationRequestRequestTypeDef](./type_defs.md#getbucketmetadatatableconfigurationrequestrequesttypedef) 
