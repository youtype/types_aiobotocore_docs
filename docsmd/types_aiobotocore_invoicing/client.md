...
Type annotations and code completion for `#!python session.create_client("invoicing").create_procurement_portal_preference` method.
...
await def create_procurement_portal_preference(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("invoicing").delete_procurement_portal_preference` method.
...
await def delete_procurement_portal_preference(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("invoicing").get_invoice_pdf` method.
...
Type annotations and code completion for `#!python session.create_client("invoicing").get_procurement_portal_preference` method.
...
await def get_procurement_portal_preference(
    self,
    *,
    ProcurementPortalPreferenceArn: str,
...
Type annotations and code completion for `#!python session.create_client("invoicing").list_procurement_portal_preferences` method.
...
await def list_procurement_portal_preferences(
    self,
    *,
    NextToken: str = ...,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("invoicing").put_procurement_portal_preference` method.
...
await def put_procurement_portal_preference(
    self,
    *,
    ProcurementPortalPreferenceArn: str,
    EinvoiceDeliveryEnabled: bool,
...
Type annotations and code completion for `#!python session.create_client("invoicing").update_procurement_portal_preference_status` method.
...
await def update_procurement_portal_preference_status(
    self,
    *,
    ProcurementPortalPreferenceArn: str,
