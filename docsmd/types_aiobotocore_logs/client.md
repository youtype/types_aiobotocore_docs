...
Type annotations and code completion for `#!python session.create_client("logs").associate_source_to_s3_table_integration` method.
...
await def associate_source_to_s3_table_integration(
    self,
    *,
    integrationArn: str,
...
Type annotations and code completion for `#!python session.create_client("logs").cancel_import_task` method.
...
Type annotations and code completion for `#!python session.create_client("logs").create_import_task` method.
...
Type annotations and code completion for `#!python session.create_client("logs").create_lookup_table` method.
...
Type annotations and code completion for `#!python session.create_client("logs").create_scheduled_query` method.
...
Type annotations and code completion for `#!python session.create_client("logs").delete_lookup_table` method.
...
Type annotations and code completion for `#!python session.create_client("logs").delete_scheduled_query` method.
...
Type annotations and code completion for `#!python session.create_client("logs").describe_import_task_batches` method.
...
await def describe_import_task_batches(
    self,
    *,
    importId: str,
...
Type annotations and code completion for `#!python session.create_client("logs").describe_import_tasks` method.
...
Type annotations and code completion for `#!python session.create_client("logs").describe_lookup_tables` method.
...
await def describe_lookup_tables(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("logs").disassociate_source_from_s3_table_integration` method.
...
await def disassociate_source_from_s3_table_integration(
    self,
    *,
    identifier: str,
...
Type annotations and code completion for `#!python session.create_client("logs").get_log_fields` method.
...
Type annotations and code completion for `#!python session.create_client("logs").get_lookup_table` method.
...
Type annotations and code completion for `#!python session.create_client("logs").get_scheduled_query` method.
...
Type annotations and code completion for `#!python session.create_client("logs").get_scheduled_query_history` method.
...
await def get_scheduled_query_history(
    self,
    *,
    identifier: str,
    startTime: int,
...
Type annotations and code completion for `#!python session.create_client("logs").list_aggregate_log_group_summaries` method.
...
await def list_aggregate_log_group_summaries(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("logs").list_scheduled_queries` method.
...
Type annotations and code completion for `#!python session.create_client("logs").list_sources_for_s3_table_integration` method.
...
await def list_sources_for_s3_table_integration(
    self,
    *,
    integrationArn: str,
    maxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("logs").put_bearer_token_authentication` method.
...
await def put_bearer_token_authentication(
    self,
    *,
    logGroupIdentifier: str,
...
Type annotations and code completion for `#!python session.create_client("logs").put_log_group_deletion_protection` method.
...
await def put_log_group_deletion_protection(
    self,
    *,
    logGroupIdentifier: str,
    deletionProtectionEnabled: bool,
...
Type annotations and code completion for `#!python session.create_client("logs").update_lookup_table` method.
...
Type annotations and code completion for `#!python session.create_client("logs").update_scheduled_query` method.
