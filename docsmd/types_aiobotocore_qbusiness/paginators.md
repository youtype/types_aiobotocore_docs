...
def paginate(
    ...
    *,
    ...
    userId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListAttachmentsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    applicationId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListDataAccessorsResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListDataAccessorsRequestListDataAccessorsPaginateTypeDef = {  # (1)
    "applicationId": ...,
}
...
1. See [:material-code-braces: ListDataAccessorsRequestListDataAccessorsPaginateTypeDef](./type_defs.md#listdataaccessorsrequestlistdataaccessorspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    pluginId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListPluginActionsResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListPluginActionsRequestListPluginActionsPaginateTypeDef = {  # (1)
    "applicationId": ...,
    "pluginId": ...,
}
...
1. See [:material-code-braces: ListPluginActionsRequestListPluginActionsPaginateTypeDef](./type_defs.md#listpluginactionsrequestlistpluginactionspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListPluginTypeActionsResponseTypeDef]:  # (3)
    ...
```
...
kwargs: ListPluginTypeActionsRequestListPluginTypeActionsPaginateTypeDef = {  # (1)
    "pluginType": ...,
}
...
1. See [:material-code-braces: ListPluginTypeActionsRequestListPluginTypeActionsPaginateTypeDef](./type_defs.md#listplugintypeactionsrequestlistplugintypeactionspaginatetypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListPluginTypeMetadataResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListPluginTypeMetadataRequestListPluginTypeMetadataPaginateTypeDef = {  # (1)
    "PaginationConfig": ...,
}
...
1. See [:material-code-braces: ListPluginTypeMetadataRequestListPluginTypeMetadataPaginateTypeDef](./type_defs.md#listplugintypemetadatarequestlistplugintypemetadatapaginatetypedef) 
...
) -> AsyncIterator[SearchRelevantContentResponseTypeDef]:  # (4)
    ...
```
...
kwargs: SearchRelevantContentRequestSearchRelevantContentPaginateTypeDef = {  # (1)
    "applicationId": ...,
    "queryText": ...,
    "contentSource": ...,
}
...
1. See [:material-code-braces: SearchRelevantContentRequestSearchRelevantContentPaginateTypeDef](./type_defs.md#searchrelevantcontentrequestsearchrelevantcontentpaginatetypedef) 
