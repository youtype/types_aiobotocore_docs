<a id="literals-for-aiobotocore-iotjobsdataplane-module"></a>

# Literals for aiobotocore IoTJobsDataPlane module
...
- [Literals for aiobotocore IoTJobsDataPlane module](#literals-for-aiobotocore-iotjobsdataplane-module)
...
```python
from types_aiobotocore_iot_jobs_data.literals import IoTJobsDataPlaneServiceName
```
...
```python
from types_aiobotocore_iot_jobs_data.literals import ServiceName
```
...
```python
from types_aiobotocore_iot_jobs_data.literals import ResourceServiceName
```
