...
Type annotations and code completion for `#!python session.create_client("s3tables").delete_table_bucket_metrics_configuration` method.
...
await def delete_table_bucket_metrics_configuration(
    self,
    *,
    tableBucketARN: str,
) -> EmptyResponseMetadataTypeDef:  # (1)
...
Type annotations and code completion for `#!python session.create_client("s3tables").delete_table_bucket_replication` method.
...
await def delete_table_bucket_replication(
    self,
    *,
    tableBucketARN: str,
    versionToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("s3tables").delete_table_replication` method.
...
await def delete_table_replication(
    self,
    *,
    tableArn: str,
    versionToken: str,
...
Type annotations and code completion for `#!python session.create_client("s3tables").get_table_bucket_metrics_configuration` method.
...
await def get_table_bucket_metrics_configuration(
    self,
    *,
    tableBucketARN: str,
...
Type annotations and code completion for `#!python session.create_client("s3tables").get_table_bucket_replication` method.
...
await def get_table_bucket_replication(
    self,
    *,
    tableBucketARN: str,
...
Type annotations and code completion for `#!python session.create_client("s3tables").get_table_bucket_storage_class` method.
...
await def get_table_bucket_storage_class(
    self,
    *,
    tableBucketARN: str,
...
Type annotations and code completion for `#!python session.create_client("s3tables").get_table_record_expiration_configuration` method.
...
await def get_table_record_expiration_configuration(
    self,
    *,
    tableArn: str,
...
Type annotations and code completion for `#!python session.create_client("s3tables").get_table_record_expiration_job_status` method.
...
await def get_table_record_expiration_job_status(
    self,
    *,
    tableArn: str,
...
Type annotations and code completion for `#!python session.create_client("s3tables").get_table_replication` method.
...
await def get_table_replication(
    self,
    *,
    tableArn: str,
...
Type annotations and code completion for `#!python session.create_client("s3tables").get_table_replication_status` method.
...
await def get_table_replication_status(
    self,
    *,
    tableArn: str,
...
Type annotations and code completion for `#!python session.create_client("s3tables").get_table_storage_class` method.
...
await def get_table_storage_class(
    self,
    *,
    tableBucketARN: str,
    namespace: str,
...
Type annotations and code completion for `#!python session.create_client("s3tables").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.create_client("s3tables").put_table_bucket_metrics_configuration` method.
...
await def put_table_bucket_metrics_configuration(
    self,
    *,
    tableBucketARN: str,
) -> EmptyResponseMetadataTypeDef:  # (1)
...
Type annotations and code completion for `#!python session.create_client("s3tables").put_table_bucket_replication` method.
...
await def put_table_bucket_replication(
    self,
    *,
    tableBucketARN: str,
...
Type annotations and code completion for `#!python session.create_client("s3tables").put_table_bucket_storage_class` method.
...
await def put_table_bucket_storage_class(
    self,
    *,
    tableBucketARN: str,
...
Type annotations and code completion for `#!python session.create_client("s3tables").put_table_record_expiration_configuration` method.
...
await def put_table_record_expiration_configuration(
    self,
    *,
    tableArn: str,
...
Type annotations and code completion for `#!python session.create_client("s3tables").put_table_replication` method.
...
await def put_table_replication(
    self,
    *,
    tableArn: str,
...
Type annotations and code completion for `#!python session.create_client("s3tables").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("s3tables").untag_resource` method.
