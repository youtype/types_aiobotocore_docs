...
Type annotations and code completion for `#!python session.create_client("emr-serverless").get_paginator("list_sessions")`.
...
from types_aiobotocore_emr_serverless.paginator import ListSessionsPaginator
