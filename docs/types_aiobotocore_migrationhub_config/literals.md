<a id="literals-for-aiobotocore-migrationhubconfig-module"></a>

# Literals for aiobotocore MigrationHubConfig module
...
- [Literals for aiobotocore MigrationHubConfig module](#literals-for-aiobotocore-migrationhubconfig-module)
...
```python
from types_aiobotocore_migrationhub_config.literals import MigrationHubConfigServiceName
```
...
```python
from types_aiobotocore_migrationhub_config.literals import ServiceName
```
...
```python
from types_aiobotocore_migrationhub_config.literals import ResourceServiceName
```
