...
await def create_service(
    ...
    *,
    ...
    volumeConfigurations: Sequence[ServiceVolumeConfigurationUnionTypeDef] = ...,  # (14)
...
15. See [:material-code-braces: CreateServiceResponseTypeDef](./type_defs.md#createserviceresponsetypedef) 
...
await def update_service(
    ...
    *,
    ...
    volumeConfigurations: Sequence[ServiceVolumeConfigurationTypeDef] = ...,  # (10)
) -> UpdateServiceResponseTypeDef:  # (11)
    ...
```
...
11. See [:material-code-braces: UpdateServiceResponseTypeDef](./type_defs.md#updateserviceresponsetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ecs.html#ECS.Client.__aenter__)
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ecs.html#ECS.Client.__aexit__)
