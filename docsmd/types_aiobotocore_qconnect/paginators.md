...
) -> AsyncIterator[ListAIGuardrailVersionsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    assistantId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListAIGuardrailsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListMessageTemplateVersionsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    knowledgeBaseId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListMessageTemplatesResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[SearchMessageTemplatesResponseTypeDef]:  # (3)
    ...
```
