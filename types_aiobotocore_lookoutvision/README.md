<a id="type-annotations-for-aiobotocore-lookoutforvision-module"></a>

# Type annotations for aiobotocore LookoutforVision module
...
pip install 'types-aiobotocore[lookoutvision]'

# install as a standalone
pip install types-aiobotocore-lookoutvision
```

- [Type annotations for aiobotocore LookoutforVision module](#type-annotations-for-aiobotocore-lookoutforvision-module)
...
Type annotations for `aiobotocore.create_client("lookoutvision")` as
...
```python
from types_aiobotocore_lookoutvision.paginators import ListDatasetEntriesPaginator, ...
```
