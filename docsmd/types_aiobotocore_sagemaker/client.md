...
await def update_cluster(
    ...
    *,
    ...
    ClusterRole: str = ...,
    AutoScaling: ClusterAutoScalingConfigTypeDef = ...,  # (5)
) -> UpdateClusterResponseTypeDef:  # (6)
    ...
```
...
5. See [:material-code-braces: ClusterAutoScalingConfigTypeDef](./type_defs.md#clusterautoscalingconfigtypedef)
6. See [:material-code-braces: UpdateClusterResponseTypeDef](./type_defs.md#updateclusterresponsetypedef)
