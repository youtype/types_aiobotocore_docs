...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ecr.html#ECR.Paginator.DescribeRepositoryCreationTemplates)
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeRepositoryCreationTemplatesResponseTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: DescribeRepositoryCreationTemplatesRequestDescribeRepositoryCreationTemplatesPaginateTypeDef](./type_defs.md#describerepositorycreationtemplatesrequestdescriberepositorycreationtemplatespaginatetypedef) 
