<a id="literals-for-aiobotocore-worklink-module"></a>

# Literals for aiobotocore WorkLink module
...
- [Literals for aiobotocore WorkLink module](#literals-for-aiobotocore-worklink-module)
...
```python
from types_aiobotocore_worklink.literals import DeviceStatusType
```
...
```python
from types_aiobotocore_worklink.literals import DomainStatusType
```
...
```python
from types_aiobotocore_worklink.literals import FleetStatusType
```
...
```python
from types_aiobotocore_worklink.literals import IdentityProviderTypeType
```
...
```python
from types_aiobotocore_worklink.literals import WorkLinkServiceName
```
...
```python
from types_aiobotocore_worklink.literals import ServiceName
```
...
```python
from types_aiobotocore_worklink.literals import ResourceServiceName
```
