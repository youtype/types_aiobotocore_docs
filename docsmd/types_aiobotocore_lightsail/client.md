...
Type annotations and code completion for `#!python session.create_client("lightsail").close` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").delete_domain_entry` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").delete_key_pair` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_auto_snapshots` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_distribution_bundles` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_export_snapshot_records` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_instance` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_instance_access_details` method.
...
await def get_instance_access_details(
    self,
    *,
    instanceName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_instance_metric_data` method.
...
await def get_instance_metric_data(
    self,
    *,
    instanceName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_instance_port_states` method.
...
await def get_instance_port_states(
    self,
    *,
    instanceName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_instance_snapshot` method.
...
await def get_instance_snapshot(
    self,
    *,
    instanceSnapshotName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_instance_snapshots` method.
...
await def get_instance_snapshots(
    self,
    *,
    pageToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_instance_state` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_instances` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_key_pair` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_key_pairs` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_load_balancer` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_load_balancer_metric_data` method.
...
await def get_load_balancer_metric_data(
    self,
    *,
    loadBalancerName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_load_balancer_tls_certificates` method.
...
await def get_load_balancer_tls_certificates(
    self,
    *,
    loadBalancerName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_load_balancer_tls_policies` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_load_balancers` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_operation` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_operations` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_operations_for_resource` method.
...
await def get_operations_for_resource(
    self,
    *,
    resourceName: str,
    pageToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_regions` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_relational_database` method.
...
await def get_relational_database(
    self,
    *,
    relationalDatabaseName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_relational_database_blueprints` method.
...
await def get_relational_database_blueprints(
    self,
    *,
    pageToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_relational_database_bundles` method.
...
await def get_relational_database_bundles(
    self,
    *,
    pageToken: str = ...,
    includeInactive: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_relational_database_events` method.
...
await def get_relational_database_events(
    self,
    *,
    relationalDatabaseName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_relational_database_log_events` method.
...
await def get_relational_database_log_events(
    self,
    *,
    relationalDatabaseName: str,
    logStreamName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_relational_database_log_streams` method.
...
await def get_relational_database_log_streams(
    self,
    *,
    relationalDatabaseName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_relational_database_master_user_password` method.
...
await def get_relational_database_master_user_password(
    self,
    *,
    relationalDatabaseName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_relational_database_metric_data` method.
...
await def get_relational_database_metric_data(
    self,
    *,
    relationalDatabaseName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_relational_database_parameters` method.
...
await def get_relational_database_parameters(
    self,
    *,
    relationalDatabaseName: str,
    pageToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_relational_database_snapshot` method.
...
await def get_relational_database_snapshot(
    self,
    *,
    relationalDatabaseSnapshotName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_relational_database_snapshots` method.
...
await def get_relational_database_snapshots(
    self,
    *,
    pageToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_relational_databases` method.
...
await def get_relational_databases(
    self,
    *,
    pageToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_setup_history` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/lightsail.html#Lightsail.Client.get_setup_history)

```python
# get_setup_history method definition

await def get_setup_history(
    self,
    *,
    resourceName: str,
    pageToken: str = ...,
...
1. See [:material-code-braces: GetSetupHistoryRequestRequestTypeDef](./type_defs.md#getsetuphistoryrequestrequesttypedef) 

### get\_static\_ip

Returns information about an Amazon Lightsail static IP.

Type annotations and code completion for `#!python session.create_client("lightsail").get_static_ip` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_static_ips` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").import_key_pair` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").is_vpc_peered` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").open_instance_public_ports` method.
...
await def open_instance_public_ports(
    self,
    *,
    portInfo: PortInfoTypeDef,  # (1)
    instanceName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").peer_vpc` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").put_alarm` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").put_instance_public_ports` method.
...
await def put_instance_public_ports(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("lightsail").reboot_instance` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").reboot_relational_database` method.
...
await def reboot_relational_database(
    self,
    *,
    relationalDatabaseName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").register_container_image` method.
...
await def register_container_image(
    self,
    *,
    serviceName: str,
    label: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").release_static_ip` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").reset_distribution_cache` method.
...
await def reset_distribution_cache(
    self,
    *,
    distributionName: str = ...,
...
Type annotations and code completion for `#!python session.create_client("lightsail").send_contact_method_verification` method.
...
await def send_contact_method_verification(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("lightsail").set_ip_address_type` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").set_resource_access_for_bucket` method.
...
await def set_resource_access_for_bucket(
    self,
    *,
    resourceName: str,
    bucketName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").setup_instance_https` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/lightsail.html#Lightsail.Client.setup_instance_https)

```python
# setup_instance_https method definition

await def setup_instance_https(
    self,
    *,
    instanceName: str,
    emailAddress: str,
...
1. See [:material-code-braces: SetupInstanceHttpsRequestRequestTypeDef](./type_defs.md#setupinstancehttpsrequestrequesttypedef) 
...
Type annotations and code completion for `#!python session.create_client("lightsail").start_gui_session` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").start_instance` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").start_relational_database` method.
...
await def start_relational_database(
    self,
    *,
    relationalDatabaseName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").stop_gui_session` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").stop_instance` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").stop_relational_database` method.
...
await def stop_relational_database(
    self,
    *,
    relationalDatabaseName: str,
    relationalDatabaseSnapshotName: str = ...,
...
Type annotations and code completion for `#!python session.create_client("lightsail").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").test_alarm` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").unpeer_vpc` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").untag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").update_bucket` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").update_bucket_bundle` method.
...
await def update_bucket_bundle(
    self,
    *,
    bucketName: str,
    bundleId: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").update_container_service` method.
...
await def update_container_service(
    self,
    *,
    serviceName: str,
    power: ContainerServicePowerNameType = ...,  # (1)
...
Type annotations and code completion for `#!python session.create_client("lightsail").update_distribution` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").update_distribution_bundle` method.
...
await def update_distribution_bundle(
    self,
    *,
    distributionName: str = ...,
    bundleId: str = ...,
...
Type annotations and code completion for `#!python session.create_client("lightsail").update_domain_entry` method.
...
Type annotations and code completion for `#!python session.create_client("lightsail").update_instance_metadata_options` method.
...
await def update_instance_metadata_options(
    self,
    *,
    instanceName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").update_load_balancer_attribute` method.
...
await def update_load_balancer_attribute(
    self,
    *,
    loadBalancerName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").update_relational_database` method.
...
await def update_relational_database(
    self,
    *,
    relationalDatabaseName: str,
    masterUserPassword: str = ...,
...
Type annotations and code completion for `#!python session.create_client("lightsail").update_relational_database_parameters` method.
...
await def update_relational_database_parameters(
    self,
    *,
    relationalDatabaseName: str,
...
Type annotations and code completion for `#!python session.create_client("lightsail").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/lightsail.html#Lightsail.Client.__aenter__)
...
Type annotations and code completion for `#!python session.create_client("lightsail").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/lightsail.html#Lightsail.Client.__aexit__)
...
Type annotations and code completion for `#!python session.create_client("lightsail").get_paginator` method with overloads.
