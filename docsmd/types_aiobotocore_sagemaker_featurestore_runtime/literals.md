...
> [Index](../README.md) > [SageMakerFeatureStoreRuntime](./README.md) > Literals
...
from types_aiobotocore_sagemaker_featurestore_runtime.literals import ExpirationTimeResponseType
...
from types_aiobotocore_sagemaker_featurestore_runtime.literals import TtlDurationUnitType
...
```python
# SageMakerFeatureStoreRuntimeServiceName usage example
...
```python
# SageMakerFeatureStoreRuntimeServiceName definition
SageMakerFeatureStoreRuntimeServiceName = Literal[
...
from types_aiobotocore_sagemaker_featurestore_runtime.literals import ResourceServiceName
