...
Type annotations and code completion for `#!python session.create_client("mediaconvert").get_jobs_query_results` method.
...
await def get_jobs_query_results(
    self,
    *,
    Id: str,
...
Type annotations and code completion for `#!python session.create_client("mediaconvert").start_jobs_query` method.
