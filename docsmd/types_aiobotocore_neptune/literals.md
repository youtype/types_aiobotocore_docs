...
from types_aiobotocore_neptune.literals import DescribeGlobalClustersPaginatorName
...
from types_aiobotocore_neptune.literals import FailoverStatusType
...
```python
# NeptuneServiceName usage example
