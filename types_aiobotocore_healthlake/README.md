<a id="type-annotations-for-aiobotocore-healthlake-module"></a>
...
pip install 'types-aiobotocore[healthlake]'
...
Type annotations for `aiobotocore.create_client("healthlake")` as
