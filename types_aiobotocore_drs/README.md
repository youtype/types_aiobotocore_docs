<a id="type-annotations-for-aiobotocore-drs-module"></a>
...
Type annotations for `aiobotocore.create_client("drs")` as
[drsClient](./client.md)
...
```python
from types_aiobotocore_drs.paginators import DescribeJobLogItemsPaginator, ...
```
