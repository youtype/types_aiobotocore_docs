...
) -> AsyncIterator[DescribeWorkspaceDirectoriesResultTypeDef]:  # (3)
    ...
```
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/workspaces.html#WorkSpaces.Paginator.ListAccountLinks)
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListAccountLinksResultTypeDef]:  # (3)
    ...
```
