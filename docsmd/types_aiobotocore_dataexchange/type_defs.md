...
```python title="Usage Example"
from types_aiobotocore_dataexchange.type_defs import RevokeRevisionRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_dataexchange.type_defs import ListDataSetRevisionsRequestListDataSetRevisionsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_dataexchange.type_defs import ListDataSetsRequestListDataSetsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_dataexchange.type_defs import ListEventActionsRequestListEventActionsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_dataexchange.type_defs import ListJobsRequestListJobsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_dataexchange.type_defs import ListRevisionAssetsRequestListRevisionAssetsPaginateTypeDef
