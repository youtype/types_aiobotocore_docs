...
await def create_workflow(
    ...
    *,
    ...
    readmePath: str = ...,
    definitionRepository: DefinitionRepositoryTypeDef = ...,  # (5)
...
await def create_workflow_version(
    ...
    *,
    ...
    definitionRepository: DefinitionRepositoryTypeDef = ...,  # (5)
    readmeUri: str = ...,
) -> CreateWorkflowVersionResponseTypeDef:  # (6)
    ...
```
...
4. See [:material-code-brackets: StorageTypeType](./literals.md#storagetypetype)
5. See [:material-code-braces: DefinitionRepositoryTypeDef](./type_defs.md#definitionrepositorytypedef)
6. See [:material-code-braces: CreateWorkflowVersionResponseTypeDef](./type_defs.md#createworkflowversionresponsetypedef)
