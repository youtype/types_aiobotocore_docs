...
Type annotations and code completion for `#!python session.create_client("braket").close` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/braket/client/close.html)
