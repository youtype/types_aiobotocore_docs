...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/deadline.html#DeadlineCloud.Waiter.FleetActive)
...
1. See [:material-code-braces: GetFleetRequestFleetActiveWaitTypeDef](./type_defs.md#getfleetrequestfleetactivewaittypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/deadline.html#DeadlineCloud.Waiter.JobCreateComplete)
...
1. See [:material-code-braces: GetJobRequestJobCreateCompleteWaitTypeDef](./type_defs.md#getjobrequestjobcreatecompletewaittypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/deadline.html#DeadlineCloud.Waiter.LicenseEndpointDeleted)
...
1. See [:material-code-braces: GetLicenseEndpointRequestLicenseEndpointDeletedWaitTypeDef](./type_defs.md#getlicenseendpointrequestlicenseendpointdeletedwaittypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/deadline.html#DeadlineCloud.Waiter.LicenseEndpointValid)
...
1. See [:material-code-braces: GetLicenseEndpointRequestLicenseEndpointValidWaitTypeDef](./type_defs.md#getlicenseendpointrequestlicenseendpointvalidwaittypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/deadline.html#DeadlineCloud.Waiter.QueueFleetAssociationStopped)
...
1. See [:material-code-braces: GetQueueFleetAssociationRequestQueueFleetAssociationStoppedWaitTypeDef](./type_defs.md#getqueuefleetassociationrequestqueuefleetassociationstoppedwaittypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/deadline.html#DeadlineCloud.Waiter.QueueScheduling)
...
1. See [:material-code-braces: GetQueueRequestQueueSchedulingWaitTypeDef](./type_defs.md#getqueuerequestqueueschedulingwaittypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/deadline.html#DeadlineCloud.Waiter.QueueSchedulingBlocked)
...
1. See [:material-code-braces: GetQueueRequestQueueSchedulingBlockedWaitTypeDef](./type_defs.md#getqueuerequestqueueschedulingblockedwaittypedef) 
