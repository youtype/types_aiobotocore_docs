...
Type annotations and code completion for `#!python session.create_client("nova-act")`
...
This class provides code completion for `#!python session.create_client("nova-act").exceptions` structure.

```python
# NovaActServiceClient.exceptions usage example
...
```python
# NovaActServiceClient usage type checking example

from types_aiobotocore_nova_act.client import Exceptions
...
Type annotations and code completion for `#!python session.create_client("nova-act").can_paginate` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").generate_presigned_url` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").create_act` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").create_session` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").create_workflow_definition` method.
...
await def create_workflow_definition(
    self,
    *,
    name: str,
    description: str = ...,
...
Type annotations and code completion for `#!python session.create_client("nova-act").create_workflow_run` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").delete_workflow_definition` method.
...
await def delete_workflow_definition(
    self,
    *,
    workflowDefinitionName: str,
...
Type annotations and code completion for `#!python session.create_client("nova-act").delete_workflow_run` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").get_workflow_definition` method.
...
await def get_workflow_definition(
    self,
    *,
    workflowDefinitionName: str,
...
Type annotations and code completion for `#!python session.create_client("nova-act").get_workflow_run` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").invoke_act_step` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").list_acts` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").list_models` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").list_sessions` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").list_workflow_definitions` method.
...
await def list_workflow_definitions(
    self,
    *,
    maxResults: int = ...,
    nextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("nova-act").list_workflow_runs` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").update_act` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").update_workflow_run` method.
...
Type annotations and code completion for `#!python session.create_client("nova-act").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/nova-act.html#NovaActService.Client)
...
Type annotations and code completion for `#!python session.create_client("nova-act").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/nova-act.html#NovaActService.Client)
...
Type annotations and code completion for `#!python session.create_client("nova-act").get_paginator` method with overloads.
