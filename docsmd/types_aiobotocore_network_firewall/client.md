...
Type annotations and code completion for `#!python session.create_client("network-firewall").attach_rule_groups_to_proxy_configuration` method.
...
await def attach_rule_groups_to_proxy_configuration(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("network-firewall").create_proxy` method.
...
Type annotations and code completion for `#!python session.create_client("network-firewall").create_proxy_configuration` method.
...
await def create_proxy_configuration(
    self,
    *,
    ProxyConfigurationName: str,
...
Type annotations and code completion for `#!python session.create_client("network-firewall").create_proxy_rule_group` method.
...
await def create_proxy_rule_group(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("network-firewall").create_proxy_rules` method.
...
Type annotations and code completion for `#!python session.create_client("network-firewall").delete_proxy` method.
...
Type annotations and code completion for `#!python session.create_client("network-firewall").delete_proxy_configuration` method.
...
await def delete_proxy_configuration(
    self,
    *,
    ProxyConfigurationName: str = ...,
    ProxyConfigurationArn: str = ...,
...
Type annotations and code completion for `#!python session.create_client("network-firewall").delete_proxy_rule_group` method.
...
await def delete_proxy_rule_group(
    self,
    *,
    ProxyRuleGroupName: str = ...,
    ProxyRuleGroupArn: str = ...,
...
Type annotations and code completion for `#!python session.create_client("network-firewall").delete_proxy_rules` method.
...
Type annotations and code completion for `#!python session.create_client("network-firewall").describe_firewall_metadata` method.
...
Type annotations and code completion for `#!python session.create_client("network-firewall").describe_proxy` method.
...
Type annotations and code completion for `#!python session.create_client("network-firewall").describe_proxy_configuration` method.
...
await def describe_proxy_configuration(
    self,
    *,
    ProxyConfigurationName: str = ...,
    ProxyConfigurationArn: str = ...,
...
Type annotations and code completion for `#!python session.create_client("network-firewall").describe_proxy_rule` method.
...
Type annotations and code completion for `#!python session.create_client("network-firewall").describe_proxy_rule_group` method.
...
await def describe_proxy_rule_group(
    self,
    *,
    ProxyRuleGroupName: str = ...,
    ProxyRuleGroupArn: str = ...,
...
Type annotations and code completion for `#!python session.create_client("network-firewall").detach_rule_groups_from_proxy_configuration` method.
...
await def detach_rule_groups_from_proxy_configuration(
    self,
    *,
    UpdateToken: str,
    ProxyConfigurationName: str = ...,
...
Type annotations and code completion for `#!python session.create_client("network-firewall").list_proxies` method.
...
Type annotations and code completion for `#!python session.create_client("network-firewall").list_proxy_configurations` method.
...
await def list_proxy_configurations(
    self,
    *,
    NextToken: str = ...,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("network-firewall").list_proxy_rule_groups` method.
...
await def list_proxy_rule_groups(
    self,
    *,
    NextToken: str = ...,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("network-firewall").update_proxy` method.
...
Type annotations and code completion for `#!python session.create_client("network-firewall").update_proxy_configuration` method.
...
await def update_proxy_configuration(
    self,
    *,
    DefaultRulePhaseActions: ProxyConfigDefaultRulePhaseActionsRequestTypeDef,  # (1)
    UpdateToken: str,
...
Type annotations and code completion for `#!python session.create_client("network-firewall").update_proxy_rule` method.
...
Type annotations and code completion for `#!python session.create_client("network-firewall").update_proxy_rule_group_priorities` method.
...
await def update_proxy_rule_group_priorities(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("network-firewall").update_proxy_rule_priorities` method.
...
await def update_proxy_rule_priorities(
    self,
    *,
