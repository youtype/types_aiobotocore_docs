<a id="type-annotations-for-aiobotocore-lookoutequipment-module"></a>

# Type annotations for aiobotocore LookoutEquipment module
...
pip install 'types-aiobotocore[lookoutequipment]'

# install as a standalone
pip install types-aiobotocore-lookoutequipment
```

- [Type annotations for aiobotocore LookoutEquipment module](#type-annotations-for-aiobotocore-lookoutequipment-module)
...
Type annotations for `aiobotocore.create_client("lookoutequipment")` as
