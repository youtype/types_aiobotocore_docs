...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListConfigurationRecordersResponseTypeDef]:  # (3)
    ...
```
...
kwargs: ListConfigurationRecordersRequestListConfigurationRecordersPaginateTypeDef = {  # (1)
    "Filters": ...,
}
...
1. See [:material-code-braces: ListConfigurationRecordersRequestListConfigurationRecordersPaginateTypeDef](./type_defs.md#listconfigurationrecordersrequestlistconfigurationrecorderspaginatetypedef) 
