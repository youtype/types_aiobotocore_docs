...
1. See `List[TagConditionTypeDef]`
2. See `List[OrConditionOutputTypeDef]`
...
1. See `Sequence[TagConditionTypeDef]`
2. See `Sequence[OrConditionTypeDef]`
3. See [:material-code-braces: TagConditionTypeDef](./type_defs.md#tagconditiontypedef)
...
1. See `List[RuntimeSessionDataTypeDef]`
2. See [:material-code-brackets: SessionDataNamespaceType](./literals.md#sessiondatanamespacetype)
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
1. See `List[MessageTemplateAttachmentTypeDef]`
2. See `List[MessageTemplateAttributeTypeType]`
...
1. See `List[MessageTemplateAttributeTypeType]`
...
1. See `Mapping[AIAgentTypeType, AIAgentConfigurationDataTypeDef]`
...
1. See [:material-code-braces: AIAgentConfigurationUnionTypeDef](#aiagentconfigurationuniontypedef)
