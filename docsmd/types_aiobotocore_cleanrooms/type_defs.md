...
class StartProtectedJobInputTypeDef(TypedDict):
    ...
    computeConfiguration: NotRequired[ProtectedJobComputeConfigurationTypeDef],  # (4)
```
...
class ProtectedJobTypeDef(TypedDict):
    ...
    computeConfiguration: NotRequired[ProtectedJobComputeConfigurationTypeDef],  # (7)
```
...
7. See [:material-code-braces: ProtectedJobComputeConfigurationTypeDef](./type_defs.md#protectedjobcomputeconfigurationtypedef)
