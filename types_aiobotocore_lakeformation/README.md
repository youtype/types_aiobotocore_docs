<a id="type-annotations-for-aiobotocore-lakeformation-module"></a>

# Type annotations for aiobotocore LakeFormation module
...
pip install 'types-aiobotocore[lakeformation]'

# install as a standalone
pip install types-aiobotocore-lakeformation
```

- [Type annotations for aiobotocore LakeFormation module](#type-annotations-for-aiobotocore-lakeformation-module)
...
Type annotations for `aiobotocore.create_client("lakeformation")` as
...
```python
from types_aiobotocore_lakeformation.paginators import GetWorkUnitsPaginator, ...
```
