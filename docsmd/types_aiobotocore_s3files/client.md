...
Type annotations and code completion for `#!python session.create_client("s3files")`
...
This class provides code completion for `#!python session.create_client("s3files").exceptions` structure.

```python
# S3FilesClient.exceptions usage example
...
```python
# S3FilesClient usage type checking example

from types_aiobotocore_s3files.client import Exceptions
...
Type annotations and code completion for `#!python session.create_client("s3files").can_paginate` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").generate_presigned_url` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").create_access_point` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").create_file_system` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").create_mount_target` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").delete_access_point` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").delete_file_system` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").delete_file_system_policy` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").delete_mount_target` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").get_access_point` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").get_file_system` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").get_file_system_policy` method.
...
await def get_file_system_policy(
    self,
    *,
    fileSystemId: str,
...
Type annotations and code completion for `#!python session.create_client("s3files").get_mount_target` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").get_synchronization_configuration` method.
...
await def get_synchronization_configuration(
    self,
    *,
    fileSystemId: str,
...
Type annotations and code completion for `#!python session.create_client("s3files").list_access_points` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").list_file_systems` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").list_mount_targets` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").put_file_system_policy` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").put_synchronization_configuration` method.
...
await def put_synchronization_configuration(
    self,
    *,
    fileSystemId: str,
...
Type annotations and code completion for `#!python session.create_client("s3files").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").untag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").update_mount_target` method.
...
Type annotations and code completion for `#!python session.create_client("s3files").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3files.html#S3Files.Client)
...
Type annotations and code completion for `#!python session.create_client("s3files").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3files.html#S3Files.Client)
...
Type annotations and code completion for `#!python session.create_client("s3files").get_paginator` method with overloads.
