...
) -> AsyncIterator[ListConnectInstanceIntegrationsResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListConnectInstanceIntegrationsRequestListConnectInstanceIntegrationsPaginateTypeDef = {  # (1)
    "connectInstanceId": ...,
}
...
1. See [:material-code-braces: ListConnectInstanceIntegrationsRequestListConnectInstanceIntegrationsPaginateTypeDef](./type_defs.md#listconnectinstanceintegrationsrequestlistconnectinstanceintegrationspaginatetypedef) 
