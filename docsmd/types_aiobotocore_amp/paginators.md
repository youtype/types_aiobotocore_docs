...
Type annotations and code completion for `#!python session.create_client("amp").get_paginator("list_anomaly_detectors")`.
...
3. item: `AioPageIterator[ListAnomalyDetectorsResponseTypeDef]`
...
) -> aiobotocore.paginate.AioPageIterator[ListAnomalyDetectorsResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `AioPageIterator[ListAnomalyDetectorsResponseTypeDef]`
