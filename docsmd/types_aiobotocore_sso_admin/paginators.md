...
Type annotations and code completion for `#!python session.create_client("sso-admin").get_paginator("list_regions")`.
...
from types_aiobotocore_sso_admin.paginator import ListRegionsPaginator
