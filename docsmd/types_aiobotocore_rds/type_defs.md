...
class CreateDBInstanceMessageTypeDef(TypedDict):
    ...
    EngineLifecycleSupport: NotRequired[str],
    MasterUserAuthenticationType: NotRequired[MasterUserAuthenticationTypeType],  # (4)
```
...
class CreateDBProxyRequestTypeDef(TypedDict):
    ...
    EndpointNetworkType: NotRequired[EndpointNetworkTypeType],  # (4)
    TargetConnectionNetworkType: NotRequired[TargetConnectionNetworkTypeType],  # (5)
```

1. See [:material-code-brackets: EngineFamilyType](./literals.md#enginefamilytype)
2. See `Sequence[UserAuthConfigTypeDef]`
3. See `Sequence[TagTypeDef]`
4. See [:material-code-brackets: EndpointNetworkTypeType](./literals.md#endpointnetworktypetype)
5. See [:material-code-brackets: TargetConnectionNetworkTypeType](./literals.md#targetconnectionnetworktypetype)
