...
async with session.create_client("organizations") as client:
    try:
        ...
        client.InvalidResponsibilityTransferTransitionException,
        ...
        client.ResponsibilityTransferAlreadyInStatusException,
        client.ResponsibilityTransferNotFoundException,
...
Type annotations and code completion for `#!python session.create_client("organizations").create_account` method.
...
Type annotations and code completion for `#!python session.create_client("organizations").describe_effective_policy` method.
...
Type annotations and code completion for `#!python session.create_client("organizations").describe_responsibility_transfer` method.
...
await def describe_responsibility_transfer(
    self,
    *,
    Id: str,
...
Type annotations and code completion for `#!python session.create_client("organizations").invite_organization_to_transfer_responsibility` method.
...
await def invite_organization_to_transfer_responsibility(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("organizations").list_inbound_responsibility_transfers` method.
...
await def list_inbound_responsibility_transfers(
    self,
    *,
    Type: ResponsibilityTransferTypeType,  # (1)
    Id: str = ...,
...
Type annotations and code completion for `#!python session.create_client("organizations").list_outbound_responsibility_transfers` method.
...
await def list_outbound_responsibility_transfers(
    self,
    *,
    Type: ResponsibilityTransferTypeType,  # (1)
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("organizations").terminate_responsibility_transfer` method.
...
await def terminate_responsibility_transfer(
    self,
    *,
    Id: str,
...
Type annotations and code completion for `#!python session.create_client("organizations").update_responsibility_transfer` method.
...
await def update_responsibility_transfer(
    self,
    *,
    Id: str,
    Name: str,
