...
Type annotations and code completion for `#!python session.create_client("iotsitewise").put_asset_model_interface_relationship` method.
...
await def put_asset_model_interface_relationship(
    self,
    *,
    assetModelId: str,
    interfaceAssetModelId: str,
...
Type annotations and code completion for `#!python session.create_client("iotsitewise").update_computation_model` method.
...
await def update_computation_model(
    self,
    *,
    computationModelId: str,
    computationModelName: str,
...
Type annotations and code completion for `#!python session.create_client("iotsitewise").update_dataset` method.
