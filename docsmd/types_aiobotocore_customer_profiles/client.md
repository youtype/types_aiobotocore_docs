...
Type annotations and code completion for `#!python session.create_client("customer-profiles").create_recommender` method.
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").create_recommender_filter` method.
...
await def create_recommender_filter(
    self,
    *,
    DomainName: str,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").create_recommender_schema` method.
...
await def create_recommender_schema(
    self,
    *,
    DomainName: str,
    RecommenderSchemaName: str,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").delete_domain_object_type` method.
...
await def delete_domain_object_type(
    self,
    *,
    DomainName: str,
    ObjectTypeName: str,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").delete_recommender` method.
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").delete_recommender_filter` method.
...
await def delete_recommender_filter(
    self,
    *,
    DomainName: str,
    RecommenderFilterName: str,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").delete_recommender_schema` method.
...
await def delete_recommender_schema(
    self,
    *,
    DomainName: str,
    RecommenderSchemaName: str,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").get_domain_object_type` method.
...
await def get_domain_object_type(
    self,
    *,
    DomainName: str,
    ObjectTypeName: str,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").get_object_type_attribute_statistics` method.
...
await def get_object_type_attribute_statistics(
    self,
    *,
    DomainName: str,
    ObjectTypeName: str,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").get_profile_history_record` method.
...
await def get_profile_history_record(
    self,
    *,
    DomainName: str,
    ProfileId: str,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").get_profile_recommendations` method.
...
await def get_profile_recommendations(
    self,
    *,
    DomainName: str,
    ProfileId: str,
...
) -> GetProfileRecommendationsResponseTypeDef:  # (4)
    ...
```
...
4. See [:material-code-braces: GetProfileRecommendationsResponseTypeDef](./type_defs.md#getprofilerecommendationsresponsetypedef)
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").get_recommender` method.
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").get_recommender_filter` method.
...
await def get_recommender_filter(
    self,
    *,
    DomainName: str,
    RecommenderFilterName: str,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").get_recommender_schema` method.
...
await def get_recommender_schema(
    self,
    *,
    DomainName: str,
    RecommenderSchemaName: str,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").list_domain_object_types` method.
...
await def list_domain_object_types(
    self,
    *,
    DomainName: str,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").list_object_type_attribute_values` method.
...
await def list_object_type_attribute_values(
    self,
    *,
    DomainName: str,
    ObjectTypeName: str,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").list_profile_history_records` method.
...
await def list_profile_history_records(
    self,
    *,
    DomainName: str,
    ProfileId: str,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").list_recommender_filters` method.
...
await def list_recommender_filters(
    self,
    *,
    DomainName: str,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").list_recommender_recipes` method.
...
await def list_recommender_recipes(
    self,
    *,
    MaxResults: int = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").list_recommender_schemas` method.
...
await def list_recommender_schemas(
    self,
    *,
    DomainName: str,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").list_recommenders` method.
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").list_upload_jobs` method.
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").put_domain_object_type` method.
...
await def put_domain_object_type(
    self,
    *,
    DomainName: str,
    ObjectTypeName: str,
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").start_recommender` method.
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").stop_recommender` method.
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").update_recommender` method.
