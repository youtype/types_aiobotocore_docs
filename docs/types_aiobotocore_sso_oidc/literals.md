<a id="literals-for-aiobotocore-ssooidc-module"></a>

# Literals for aiobotocore SSOOIDC module

> [Index](../README.md) > [SSOOIDC](./README.md) > Literals
...
- [Literals for aiobotocore SSOOIDC module](#literals-for-aiobotocore-ssooidc-module)
...
```python
from types_aiobotocore_sso_oidc.literals import ResourceServiceName
```
