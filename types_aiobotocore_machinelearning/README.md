<a id="type-annotations-for-aiobotocore-machinelearning-module"></a>
...
pip install 'types-aiobotocore[machinelearning]'
...
Type annotations for `aiobotocore.create_client("machinelearning")` as
...
```python
from types_aiobotocore_machinelearning.paginators import DescribeBatchPredictionsPaginator, ...
```
...
```python
from types_aiobotocore_machinelearning.waiters import BatchPredictionAvailableWaiter, ...
```
