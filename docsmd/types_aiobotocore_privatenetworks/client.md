...
Type annotations and code completion for `#!python session.create_client("privatenetworks").close` method.
...
Type annotations and code completion for `#!python session.create_client("privatenetworks").ping` method.
