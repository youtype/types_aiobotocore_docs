...
```python
# KinesisVideoSignalingChannelsServiceName usage example
from types_aiobotocore_kinesis_video_signaling.literals import KinesisVideoSignalingChannelsServiceName

def get_value() -> KinesisVideoSignalingChannelsServiceName:
    return "kinesis-video-signaling"
```

```python
# KinesisVideoSignalingChannelsServiceName definition
KinesisVideoSignalingChannelsServiceName = Literal[
...
from types_aiobotocore_kinesis_video_signaling.literals import RegionName
