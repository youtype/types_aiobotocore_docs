...
4. See `Sequence[ContactInitiationMethodType]`
...
class ContactTypeDef(TypedDict):
    ...
    ContactDetails: NotRequired[ContactDetailsTypeDef],  # (20)
...
20. See [:material-code-braces: ContactDetailsTypeDef](./type_defs.md#contactdetailstypedef)
