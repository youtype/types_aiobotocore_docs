...
```python title="Usage Example"
from types_aiobotocore_appconfig.type_defs import CreateExtensionAssociationRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_appconfig.type_defs import DeleteExtensionAssociationRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_appconfig.type_defs import DeleteExtensionRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_appconfig.type_defs import GetExtensionAssociationRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_appconfig.type_defs import GetExtensionRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_appconfig.type_defs import ListExtensionAssociationsRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_appconfig.type_defs import ListExtensionsRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_appconfig.type_defs import UpdateExtensionAssociationRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_appconfig.type_defs import CreateExtensionRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_appconfig.type_defs import UpdateExtensionRequestRequestTypeDef
