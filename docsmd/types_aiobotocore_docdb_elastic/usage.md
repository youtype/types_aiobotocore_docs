...
from types_aiobotocore_docdb_elastic.type_defs import ApplyPendingMaintenanceActionInputRequestTypeDef
...
async with session.create_client("docdb-elastic") as client:
    ...
    kwargs: ApplyPendingMaintenanceActionInputRequestTypeDef = {...}
