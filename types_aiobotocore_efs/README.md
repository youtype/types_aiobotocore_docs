<a id="type-annotations-for-aiobotocore-efs-module"></a>

# Type annotations for aiobotocore EFS module
...
pip install 'types-aiobotocore[efs]'

# install as a standalone
pip install types-aiobotocore-efs
```

- [Type annotations for aiobotocore EFS module](#type-annotations-for-aiobotocore-efs-module)
  - [EFSClient](#efsclient)
    - [Methods](#methods)
...
Type annotations for `aiobotocore.create_client("efs")` as
[EFSClient](./client.md)
...
```python
from types_aiobotocore_efs.paginators import DescribeFileSystemsPaginator, ...
```
