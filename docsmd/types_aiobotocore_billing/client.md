...
async with session.create_client("billing") as client:
    try:
        ...
        client.BillingViewHealthStatusException,
        client.ClientError,
...
Type annotations and code completion for `#!python session.create_client("billing").associate_source_views` method.
...
await def associate_source_views(
    self,
    *,
    arn: str,
...
Type annotations and code completion for `#!python session.create_client("billing").disassociate_source_views` method.
...
await def disassociate_source_views(
    self,
    *,
    arn: str,
    sourceViews: Sequence[str],
