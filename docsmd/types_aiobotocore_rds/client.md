...
Type annotations and code completion for `#!python session.create_client("rds").close` method.
...
5. See [:material-code-brackets: ClusterScalabilityTypeType](./literals.md#clusterscalabilitytypetype) 
6. See [:material-code-braces: CreateDBClusterResultTypeDef](./type_defs.md#createdbclusterresulttypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.create_db_shard_group)
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.create_integration)
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.create_tenant_database)
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.delete_db_cluster_automated_backup)
...
Type annotations and code completion for `#!python session.create_client("rds").delete_db_cluster_parameter_group` method.
...
Type annotations and code completion for `#!python session.create_client("rds").delete_db_instance_automated_backup` method.
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.delete_db_shard_group)
...
Type annotations and code completion for `#!python session.create_client("rds").delete_event_subscription` method.
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.delete_integration)
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.delete_tenant_database)
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.describe_db_cluster_automated_backups)
...
Type annotations and code completion for `#!python session.create_client("rds").describe_db_parameters` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_db_proxies` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_db_proxy_endpoints` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_db_proxy_target_groups` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_db_proxy_targets` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_db_recommendations` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.describe_db_recommendations)
...
Type annotations and code completion for `#!python session.create_client("rds").describe_db_security_groups` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_db_shard_groups` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.describe_db_shard_groups)
...
Type annotations and code completion for `#!python session.create_client("rds").describe_db_snapshot_attributes` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_db_snapshot_tenant_databases` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.describe_db_snapshot_tenant_databases)
...
Type annotations and code completion for `#!python session.create_client("rds").describe_db_snapshots` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_db_subnet_groups` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_engine_default_cluster_parameters` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_engine_default_parameters` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_event_categories` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_event_subscriptions` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_events` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_export_tasks` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_global_clusters` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_integrations` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.describe_integrations)
...
Type annotations and code completion for `#!python session.create_client("rds").describe_option_group_options` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_option_groups` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_orderable_db_instance_options` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_pending_maintenance_actions` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_reserved_db_instances` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_reserved_db_instances_offerings` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_source_regions` method.
...
Type annotations and code completion for `#!python session.create_client("rds").describe_tenant_databases` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.describe_tenant_databases)
...
Type annotations and code completion for `#!python session.create_client("rds").describe_valid_db_instance_modifications` method.
...
Type annotations and code completion for `#!python session.create_client("rds").disable_http_endpoint` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.disable_http_endpoint)
...
Type annotations and code completion for `#!python session.create_client("rds").download_db_log_file_portion` method.
...
Type annotations and code completion for `#!python session.create_client("rds").enable_http_endpoint` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.enable_http_endpoint)
...
Type annotations and code completion for `#!python session.create_client("rds").failover_db_cluster` method.
...
Type annotations and code completion for `#!python session.create_client("rds").failover_global_cluster` method.
...
Type annotations and code completion for `#!python session.create_client("rds").generate_db_auth_token` method.
...
Type annotations and code completion for `#!python session.create_client("rds").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_current_db_cluster_capacity` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_custom_db_engine_version` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_cluster` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_cluster_endpoint` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_cluster_parameter_group` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_cluster_snapshot_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_instance` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_parameter_group` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_proxy` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_proxy_endpoint` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_proxy_target_group` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_recommendation` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.modify_db_recommendation)
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_shard_group` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.modify_db_shard_group)
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_snapshot` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_snapshot_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_db_subnet_group` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_event_subscription` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_global_cluster` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_integration` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.modify_integration)
...
Type annotations and code completion for `#!python session.create_client("rds").modify_option_group` method.
...
Type annotations and code completion for `#!python session.create_client("rds").modify_tenant_database` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.modify_tenant_database)
...
Type annotations and code completion for `#!python session.create_client("rds").promote_read_replica` method.
...
Type annotations and code completion for `#!python session.create_client("rds").promote_read_replica_db_cluster` method.
...
Type annotations and code completion for `#!python session.create_client("rds").purchase_reserved_db_instances_offering` method.
...
Type annotations and code completion for `#!python session.create_client("rds").reboot_db_cluster` method.
...
Type annotations and code completion for `#!python session.create_client("rds").reboot_db_instance` method.
...
Type annotations and code completion for `#!python session.create_client("rds").reboot_db_shard_group` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.reboot_db_shard_group)
...
Type annotations and code completion for `#!python session.create_client("rds").register_db_proxy_targets` method.
...
Type annotations and code completion for `#!python session.create_client("rds").remove_from_global_cluster` method.
...
Type annotations and code completion for `#!python session.create_client("rds").remove_role_from_db_cluster` method.
...
Type annotations and code completion for `#!python session.create_client("rds").remove_role_from_db_instance` method.
...
Type annotations and code completion for `#!python session.create_client("rds").remove_source_identifier_from_subscription` method.
...
Type annotations and code completion for `#!python session.create_client("rds").remove_tags_from_resource` method.
...
Type annotations and code completion for `#!python session.create_client("rds").reset_db_cluster_parameter_group` method.
...
Type annotations and code completion for `#!python session.create_client("rds").reset_db_parameter_group` method.
...
Type annotations and code completion for `#!python session.create_client("rds").restore_db_cluster_from_s3` method.
...
Type annotations and code completion for `#!python session.create_client("rds").restore_db_cluster_from_snapshot` method.
...
Type annotations and code completion for `#!python session.create_client("rds").restore_db_cluster_to_point_in_time` method.
...
Type annotations and code completion for `#!python session.create_client("rds").restore_db_instance_from_db_snapshot` method.
...
Type annotations and code completion for `#!python session.create_client("rds").restore_db_instance_from_s3` method.
...
Type annotations and code completion for `#!python session.create_client("rds").restore_db_instance_to_point_in_time` method.
...
Type annotations and code completion for `#!python session.create_client("rds").revoke_db_security_group_ingress` method.
...
Type annotations and code completion for `#!python session.create_client("rds").start_activity_stream` method.
...
Type annotations and code completion for `#!python session.create_client("rds").start_db_cluster` method.
...
Type annotations and code completion for `#!python session.create_client("rds").start_db_instance` method.
...
Type annotations and code completion for `#!python session.create_client("rds").start_db_instance_automated_backups_replication` method.
...
Type annotations and code completion for `#!python session.create_client("rds").start_export_task` method.
...
Type annotations and code completion for `#!python session.create_client("rds").stop_activity_stream` method.
...
Type annotations and code completion for `#!python session.create_client("rds").stop_db_cluster` method.
...
Type annotations and code completion for `#!python session.create_client("rds").stop_db_instance` method.
...
Type annotations and code completion for `#!python session.create_client("rds").stop_db_instance_automated_backups_replication` method.
...
Type annotations and code completion for `#!python session.create_client("rds").switchover_blue_green_deployment` method.
...
Type annotations and code completion for `#!python session.create_client("rds").switchover_global_cluster` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.switchover_global_cluster)
...
Type annotations and code completion for `#!python session.create_client("rds").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.__aenter__)
...
Type annotations and code completion for `#!python session.create_client("rds").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.__aexit__)
