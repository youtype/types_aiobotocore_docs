...
```python title="Usage Example"
from types_aiobotocore_fsx.type_defs import DescribeBackupsRequestDescribeBackupsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_fsx.type_defs import DescribeFileSystemsRequestDescribeFileSystemsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_fsx.type_defs import ListTagsForResourceRequestListTagsForResourcePaginateTypeDef
