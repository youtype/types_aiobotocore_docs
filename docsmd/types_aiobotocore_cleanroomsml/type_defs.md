...
2. See [:material-code-braces: LogsConfigurationPolicyOutputTypeDef](./type_defs.md#logsconfigurationpolicyoutputtypedef) 
...
1. See [:material-code-braces: TrainedModelExportsConfigurationPolicyTypeDef](./type_defs.md#trainedmodelexportsconfigurationpolicytypedef) 
...
1. See [:material-code-braces: TrainedModelInferenceJobsConfigurationPolicyTypeDef](./type_defs.md#trainedmodelinferencejobsconfigurationpolicytypedef) 
2. See [:material-code-braces: TrainedModelInferenceJobsConfigurationPolicyOutputTypeDef](./type_defs.md#trainedmodelinferencejobsconfigurationpolicyoutputtypedef) 
...
2. See [:material-code-braces: TrainedModelsConfigurationPolicyOutputTypeDef](./type_defs.md#trainedmodelsconfigurationpolicyoutputtypedef) 
...
2. See [:material-code-braces: ProtectedQueryInputParametersOutputTypeDef](./type_defs.md#protectedqueryinputparametersoutputtypedef) 
...
2. See [:material-code-braces: PrivacyConfigurationPoliciesOutputTypeDef](./type_defs.md#privacyconfigurationpoliciesoutputtypedef) 
...
2. See [:material-code-braces: InputChannelDataSourceOutputTypeDef](./type_defs.md#inputchanneldatasourceoutputtypedef) 
...
```python
# ListCollaborationConfiguredModelAlgorithmAssociationsRequestListCollaborationConfiguredModelAlgorithmAssociationsPaginateTypeDef definition

class ListCollaborationConfiguredModelAlgorithmAssociationsRequestListCollaborationConfiguredModelAlgorithmAssociationsPaginateTypeDef(TypedDict):
    collaborationIdentifier: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListCollaborationMLInputChannelsRequestListCollaborationMLInputChannelsPaginateTypeDef definition

class ListCollaborationMLInputChannelsRequestListCollaborationMLInputChannelsPaginateTypeDef(TypedDict):
    collaborationIdentifier: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListCollaborationTrainedModelExportJobsRequestListCollaborationTrainedModelExportJobsPaginateTypeDef definition

class ListCollaborationTrainedModelExportJobsRequestListCollaborationTrainedModelExportJobsPaginateTypeDef(TypedDict):
    collaborationIdentifier: str,
    trainedModelArn: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListCollaborationTrainedModelInferenceJobsRequestListCollaborationTrainedModelInferenceJobsPaginateTypeDef definition

class ListCollaborationTrainedModelInferenceJobsRequestListCollaborationTrainedModelInferenceJobsPaginateTypeDef(TypedDict):
    collaborationIdentifier: str,
    trainedModelArn: NotRequired[str],
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListCollaborationTrainedModelsRequestListCollaborationTrainedModelsPaginateTypeDef definition
...
```python
# ListConfiguredModelAlgorithmAssociationsRequestListConfiguredModelAlgorithmAssociationsPaginateTypeDef definition

class ListConfiguredModelAlgorithmAssociationsRequestListConfiguredModelAlgorithmAssociationsPaginateTypeDef(TypedDict):
    membershipIdentifier: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListConfiguredModelAlgorithmsRequestListConfiguredModelAlgorithmsPaginateTypeDef definition
...
```python
# ListMLInputChannelsRequestListMLInputChannelsPaginateTypeDef definition
...
```python
# ListTrainedModelInferenceJobsRequestListTrainedModelInferenceJobsPaginateTypeDef definition
...
```python
# ListTrainedModelsRequestListTrainedModelsPaginateTypeDef definition
...
1. See [:material-code-braces: LogsConfigurationPolicyTypeDef](./type_defs.md#logsconfigurationpolicytypedef) [:material-code-braces: LogsConfigurationPolicyOutputTypeDef](./type_defs.md#logsconfigurationpolicyoutputtypedef) 
2. See [:material-code-braces: MetricsConfigurationPolicyTypeDef](./type_defs.md#metricsconfigurationpolicytypedef) 
...
1. See [:material-code-braces: ProtectedQuerySQLParametersTypeDef](./type_defs.md#protectedquerysqlparameterstypedef) [:material-code-braces: ProtectedQuerySQLParametersOutputTypeDef](./type_defs.md#protectedquerysqlparametersoutputtypedef) 
2. See [:material-code-braces: ComputeConfigurationTypeDef](./type_defs.md#computeconfigurationtypedef) 
...
1. See [:material-code-braces: TrainedModelsConfigurationPolicyTypeDef](./type_defs.md#trainedmodelsconfigurationpolicytypedef) [:material-code-braces: TrainedModelsConfigurationPolicyOutputTypeDef](./type_defs.md#trainedmodelsconfigurationpolicyoutputtypedef) 
2. See [:material-code-braces: TrainedModelExportsConfigurationPolicyTypeDef](./type_defs.md#trainedmodelexportsconfigurationpolicytypedef) [:material-code-braces: TrainedModelExportsConfigurationPolicyOutputTypeDef](./type_defs.md#trainedmodelexportsconfigurationpolicyoutputtypedef) 
3. See [:material-code-braces: TrainedModelInferenceJobsConfigurationPolicyTypeDef](./type_defs.md#trainedmodelinferencejobsconfigurationpolicytypedef) [:material-code-braces: TrainedModelInferenceJobsConfigurationPolicyOutputTypeDef](./type_defs.md#trainedmodelinferencejobsconfigurationpolicyoutputtypedef) 
...
1. See [:material-code-braces: ProtectedQueryInputParametersTypeDef](./type_defs.md#protectedqueryinputparameterstypedef) [:material-code-braces: ProtectedQueryInputParametersOutputTypeDef](./type_defs.md#protectedqueryinputparametersoutputtypedef) 
...
1. See [:material-code-braces: PrivacyConfigurationPoliciesTypeDef](./type_defs.md#privacyconfigurationpoliciestypedef) [:material-code-braces: PrivacyConfigurationPoliciesOutputTypeDef](./type_defs.md#privacyconfigurationpoliciesoutputtypedef) 
## InputChannelTypeDef
...
1. See [:material-code-braces: InputChannelDataSourceTypeDef](./type_defs.md#inputchanneldatasourcetypedef) [:material-code-braces: InputChannelDataSourceOutputTypeDef](./type_defs.md#inputchanneldatasourceoutputtypedef) 
