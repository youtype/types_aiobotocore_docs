...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/finspace.html#finspace.Paginator.ListKxEnvironments)
...
) -> AsyncIterator[ListKxEnvironmentsResponseTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListKxEnvironmentsRequestListKxEnvironmentsPaginateTypeDef](./type_defs.md#listkxenvironmentsrequestlistkxenvironmentspaginatetypedef) 
