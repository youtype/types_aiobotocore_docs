...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/transfer.html#Transfer.Paginator.ListFileTransferResults)
...
def paginate(
    ...
    *,
    ...
    TransferId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListFileTransferResultsResponseTypeDef]:  # (2)
    ...
```
