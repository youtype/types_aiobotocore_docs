...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/migrationhubstrategy.html#MigrationHubStrategyRecommendations.Paginator.ListAnalyzableServers)
...
) -> AsyncIterator[ListAnalyzableServersResponseTypeDef]:  # (3)
    ...
```
