...
class InvokeInlineAgentRequestTypeDef(TypedDict):
    ...
    promptOverrideConfiguration: NotRequired[PromptOverrideConfigurationTypeDef],  # (11)
    streamingConfigurations: NotRequired[StreamingConfigurationsTypeDef],  # (12)
```
...
11. See [:material-code-braces: PromptOverrideConfigurationTypeDef](./type_defs.md#promptoverrideconfigurationtypedef)
12. See [:material-code-braces: StreamingConfigurationsTypeDef](./type_defs.md#streamingconfigurationstypedef)
