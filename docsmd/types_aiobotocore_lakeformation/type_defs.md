...
```python title="Usage Example"
from types_aiobotocore_lakeformation.type_defs import AssumeDecoratedRoleWithSAMLRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_lakeformation.type_defs import GetWorkUnitsRequestGetWorkUnitsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_lakeformation.type_defs import ListLFTagsRequestListLFTagsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_lakeformation.type_defs import SearchDatabasesByLFTagsRequestSearchDatabasesByLFTagsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_lakeformation.type_defs import SearchTablesByLFTagsRequestSearchTablesByLFTagsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_lakeformation.type_defs import ListDataCellsFilterRequestListDataCellsFilterPaginateTypeDef
