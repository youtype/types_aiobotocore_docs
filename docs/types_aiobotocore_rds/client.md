<a id="rdsclient-for-aiobotocore-rds-module"></a>
...
Asynchronous method. Use `await authorize_db_security_group_ingress(...)` for a
synchronous call.
...
Asynchronous method. Use `await delete_db_proxy(...)` for a synchronous call.
...
Asynchronous method. Use `await delete_installation_media(...)` for a
synchronous call.
...
Asynchronous method. Use `await describe_option_groups(...)` for a synchronous
call.
...
Asynchronous method. Use `await describe_reserved_db_instances(...)` for a
synchronous call.
...
Asynchronous method. Use `await describe_reserved_db_instances_offerings(...)`
for a synchronous call.
...
Asynchronous method. Use `await describe_source_regions(...)` for a synchronous
call.
...
Asynchronous method. Use `await download_db_log_file_portion(...)` for a
synchronous call.
...
Asynchronous method. Use `await failover_global_cluster(...)` for a synchronous
call.
...
Asynchronous method. Use `await generate_db_auth_token(...)` for a synchronous
call.
...
Asynchronous method. Use `await import_installation_media(...)` for a
synchronous call.
...
Asynchronous method. Use `await modify_certificates(...)` for a synchronous
call.
...
Asynchronous method. Use `await modify_current_db_cluster_capacity(...)` for a
synchronous call.
...
Asynchronous method. Use `await modify_custom_db_engine_version(...)` for a
synchronous call.
...
Asynchronous method. Use `await modify_db_proxy(...)` for a synchronous call.
...
Asynchronous method. Use `await modify_db_proxy_endpoint(...)` for a
synchronous call.
...
Asynchronous method. Use `await modify_db_proxy_target_group(...)` for a
synchronous call.
...
Asynchronous method. Use `await modify_db_snapshot(...)` for a synchronous
call.
...
Asynchronous method. Use `await modify_db_snapshot_attribute(...)` for a
synchronous call.
...
Asynchronous method. Use `await modify_option_group(...)` for a synchronous
call.
...
Asynchronous method. Use `await promote_read_replica(...)` for a synchronous
call.
...
Asynchronous method. Use `await purchase_reserved_db_instances_offering(...)`
for a synchronous call.
...
Asynchronous method. Use `await reboot_db_cluster(...)` for a synchronous call.
...
Asynchronous method. Use `await register_db_proxy_targets(...)` for a
synchronous call.
...
Asynchronous method. Use `await remove_role_from_db_instance(...)` for a
synchronous call.
...
Asynchronous method. Use `await restore_db_cluster_from_s3(...)` for a
synchronous call.
...
Asynchronous method. Use `await restore_db_instance_from_db_snapshot(...)` for
a synchronous call.
...
Asynchronous method. Use `await restore_db_instance_from_s3(...)` for a
synchronous call.
...
Asynchronous method. Use `await restore_db_instance_to_point_in_time(...)` for
a synchronous call.
...
Asynchronous method. Use `await revoke_db_security_group_ingress(...)` for a
synchronous call.
...
Asynchronous method. Use `await start_activity_stream(...)` for a synchronous
call.
...
Asynchronous method. Use `await start_db_instance(...)` for a synchronous call.
...
Asynchronous method. Use
`await start_db_instance_automated_backups_replication(...)` for a synchronous
call.
...
Asynchronous method. Use `await stop_activity_stream(...)` for a synchronous
call.
...
Asynchronous method. Use `await stop_db_instance(...)` for a synchronous call.
...
Asynchronous method. Use
`await stop_db_instance_automated_backups_replication(...)` for a synchronous
call.
...
Boto3 documentation:
[RDS.Client.\_\_aenter\_\_](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.__aenter__)
...
Boto3 documentation:
[RDS.Client.\_\_aexit\_\_](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Client.__aexit__)
