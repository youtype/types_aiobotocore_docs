...
) -> AsyncIterator[ListBlueprintsResponseTypeDef]:  # (5)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> AsyncIterator[ListDataAutomationProjectsResponseTypeDef]:  # (5)
    ...
```
...
kwargs: ListDataAutomationProjectsRequestListDataAutomationProjectsPaginateTypeDef = {  # (1)
    "projectStageFilter": ...,
}
...
1. See [:material-code-braces: ListDataAutomationProjectsRequestListDataAutomationProjectsPaginateTypeDef](./type_defs.md#listdataautomationprojectsrequestlistdataautomationprojectspaginatetypedef) 
