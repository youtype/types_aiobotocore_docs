...
def paginate(
    ...
    *,
    ...
    ContactFlowId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListContactFlowVersionsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListHoursOfOperationOverridesResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListHoursOfOperationOverridesRequestListHoursOfOperationOverridesPaginateTypeDef = {  # (1)
    "InstanceId": ...,
    "HoursOfOperationId": ...,
}
...
1. See [:material-code-braces: ListHoursOfOperationOverridesRequestListHoursOfOperationOverridesPaginateTypeDef](./type_defs.md#listhoursofoperationoverridesrequestlisthoursofoperationoverridespaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[SearchHoursOfOperationOverridesResponseTypeDef]:  # (4)
    ...
```
...
kwargs: SearchHoursOfOperationOverridesRequestSearchHoursOfOperationOverridesPaginateTypeDef = {  # (1)
    "InstanceId": ...,
}
...
1. See [:material-code-braces: SearchHoursOfOperationOverridesRequestSearchHoursOfOperationOverridesPaginateTypeDef](./type_defs.md#searchhoursofoperationoverridesrequestsearchhoursofoperationoverridespaginatetypedef) 
