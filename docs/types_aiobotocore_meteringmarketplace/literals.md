<a id="literals-for-aiobotocore-marketplacemetering-module"></a>

# Literals for aiobotocore MarketplaceMetering module
...
- [Literals for aiobotocore MarketplaceMetering module](#literals-for-aiobotocore-marketplacemetering-module)
...
```python
from types_aiobotocore_meteringmarketplace.literals import MarketplaceMeteringServiceName
```
...
```python
from types_aiobotocore_meteringmarketplace.literals import ServiceName
```
...
```python
from types_aiobotocore_meteringmarketplace.literals import ResourceServiceName
```
