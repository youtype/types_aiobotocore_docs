...
```python
# ListPlacementsPaginatorName definition

ListPlacementsPaginatorName = Literal[
    "list_placements",
]
```
...
```python
# IoT1ClickProjectsServiceName usage example

from types_aiobotocore_iot1click_projects.literals import IoT1ClickProjectsServiceName

def get_value() -> IoT1ClickProjectsServiceName:
    return "iot1click-projects"
```

```python
# IoT1ClickProjectsServiceName definition

IoT1ClickProjectsServiceName = Literal[
    "iot1click-projects",
]
```
## ServiceName
...
from types_aiobotocore_iot1click_projects.literals import RegionName
