...
Type annotations and code completion for `#!python session.create_client("kinesis").describe_account_settings` method.
...
Type annotations and code completion for `#!python session.create_client("kinesis").update_account_settings` method.
...
Type annotations and code completion for `#!python session.create_client("kinesis").update_max_record_size` method.
...
await def update_max_record_size(
    self,
    *,
    MaxRecordSizeInKiB: int,
    StreamARN: str = ...,
...
Type annotations and code completion for `#!python session.create_client("kinesis").update_stream_warm_throughput` method.
...
await def update_stream_warm_throughput(
    self,
    *,
    WarmThroughputMiBps: int,
    StreamARN: str = ...,
