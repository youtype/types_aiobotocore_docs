...
Type annotations and code completion for `#!python session.create_client("iot").describe_encryption_configuration` method.
...
await def describe_encryption_configuration(
    self,
...
Type annotations and code completion for `#!python session.create_client("iot").update_encryption_configuration` method.
...
await def update_encryption_configuration(
    self,
    *,
