...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation-runtime").invoke_data_automation` method.
...
await def invoke_data_automation(
    self,
    *,
...
) -> InvokeDataAutomationResponseTypeDef:  # (5)
    ...
```
...
5. See [:material-code-braces: InvokeDataAutomationResponseTypeDef](./type_defs.md#invokedataautomationresponsetypedef)
