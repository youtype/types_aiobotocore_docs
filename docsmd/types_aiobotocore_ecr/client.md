...
async with session.create_client("ecr") as client:
    try:
        do_something(client)
            ...
            client.BlockedByOrganizationPolicyException,
        client.ClientError,
        client.EmptyUploadException,
        client.ExclusionAlreadyExistsException,
        client.ExclusionNotFoundException,
        client.ImageAlreadyExistsException,
        client.ImageArchivedException,
        client.ImageDigestDoesNotMatchException,
        client.ImageNotFoundException,
        client.ImageStorageClassUpdateNotSupportedException,
        ...
        client.SigningConfigurationNotFoundException,
        ...
        client.UnableToListUpstreamImageReferrersException,
...
Type annotations and code completion for `#!python session.create_client("ecr").delete_signing_configuration` method.
...
await def delete_signing_configuration(
    self,
...
Type annotations and code completion for `#!python session.create_client("ecr").deregister_pull_time_update_exclusion` method.
...
await def deregister_pull_time_update_exclusion(
    self,
    *,
    principalArn: str,
...
Type annotations and code completion for `#!python session.create_client("ecr").describe_image_signing_status` method.
...
await def describe_image_signing_status(
    self,
    *,
    repositoryName: str,
    imageId: ImageIdentifierTypeDef,  # (1)
...
Type annotations and code completion for `#!python session.create_client("ecr").get_signing_configuration` method.
...
await def get_signing_configuration(
    self,
...
Type annotations and code completion for `#!python session.create_client("ecr").list_image_referrers` method.
...
await def list_image_referrers(
    self,
    *,
    repositoryName: str,
...
Type annotations and code completion for `#!python session.create_client("ecr").list_pull_time_update_exclusions` method.
...
await def list_pull_time_update_exclusions(
    self,
    *,
    maxResults: int = ...,
    nextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ecr").put_signing_configuration` method.
...
await def put_signing_configuration(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ecr").register_pull_time_update_exclusion` method.
...
await def register_pull_time_update_exclusion(
    self,
    *,
    principalArn: str,
...
Type annotations and code completion for `#!python session.create_client("ecr").update_image_storage_class` method.
...
await def update_image_storage_class(
    self,
    *,
    repositoryName: str,
    imageId: ImageIdentifierTypeDef,  # (1)
