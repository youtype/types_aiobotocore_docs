...
Type annotations and code completion for `#!python session.create_client("sagemaker").batch_reboot_cluster_nodes` method.
...
await def batch_reboot_cluster_nodes(
    self,
    *,
    ClusterName: str,
    NodeIds: Sequence[str] = ...,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").batch_replace_cluster_nodes` method.
...
await def batch_replace_cluster_nodes(
    self,
    *,
    ClusterName: str,
    NodeIds: Sequence[str] = ...,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").create_ai_benchmark_job` method.
...
await def create_ai_benchmark_job(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").create_ai_recommendation_job` method.
...
await def create_ai_recommendation_job(
    self,
    *,
...
) -> CreateAIRecommendationJobResponseTypeDef:  # (7)
    ...
```
...
7. See [:material-code-braces: CreateAIRecommendationJobResponseTypeDef](./type_defs.md#createairecommendationjobresponsetypedef)
...
Type annotations and code completion for `#!python session.create_client("sagemaker").create_ai_workload_config` method.
...
await def create_ai_workload_config(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").create_mlflow_app` method.
...
Type annotations and code completion for `#!python session.create_client("sagemaker").create_presigned_mlflow_app_url` method.
...
await def create_presigned_mlflow_app_url(
    self,
    *,
    Arn: str,
    ExpiresInSeconds: int = ...,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").delete_ai_benchmark_job` method.
...
await def delete_ai_benchmark_job(
    self,
    *,
    AIBenchmarkJobName: str,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").delete_ai_recommendation_job` method.
...
await def delete_ai_recommendation_job(
    self,
    *,
    AIRecommendationJobName: str,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").delete_ai_workload_config` method.
...
await def delete_ai_workload_config(
    self,
    *,
    AIWorkloadConfigName: str,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").delete_mlflow_app` method.
...
Type annotations and code completion for `#!python session.create_client("sagemaker").delete_processing_job` method.
...
await def delete_processing_job(
    self,
    *,
    ProcessingJobName: str,
) -> EmptyResponseMetadataTypeDef:  # (1)
...
Type annotations and code completion for `#!python session.create_client("sagemaker").delete_training_job` method.
...
Type annotations and code completion for `#!python session.create_client("sagemaker").describe_ai_benchmark_job` method.
...
await def describe_ai_benchmark_job(
    self,
    *,
    AIBenchmarkJobName: str,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").describe_ai_recommendation_job` method.
...
await def describe_ai_recommendation_job(
    self,
    *,
    AIRecommendationJobName: str,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").describe_ai_workload_config` method.
...
await def describe_ai_workload_config(
    self,
    *,
    AIWorkloadConfigName: str,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").describe_cluster_event` method.
...
await def describe_cluster_event(
    self,
    *,
    EventId: str,
    ClusterName: str,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").describe_mlflow_app` method.
...
Type annotations and code completion for `#!python session.create_client("sagemaker").describe_reserved_capacity` method.
...
await def describe_reserved_capacity(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").describe_training_plan_extension_history` method.
...
await def describe_training_plan_extension_history(
    self,
    *,
    TrainingPlanArn: str,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").detach_cluster_node_volume` method.
...
await def detach_cluster_node_volume(
    self,
    *,
    ClusterArn: str,
    NodeId: str,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").extend_training_plan` method.
...
await def extend_training_plan(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").list_ai_benchmark_jobs` method.
...
await def list_ai_benchmark_jobs(
    self,
    *,
    MaxResults: int = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").list_ai_recommendation_jobs` method.
...
await def list_ai_recommendation_jobs(
    self,
    *,
    MaxResults: int = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").list_ai_workload_configs` method.
...
await def list_ai_workload_configs(
    self,
    *,
    MaxResults: int = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").list_cluster_events` method.
...
Type annotations and code completion for `#!python session.create_client("sagemaker").list_mlflow_apps` method.
...
Type annotations and code completion for `#!python session.create_client("sagemaker").list_pipeline_versions` method.
...
await def list_pipeline_versions(
    self,
    *,
    PipelineName: str,
    CreatedAfter: TimestampTypeDef = ...,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").list_ultra_servers_by_reserved_capacity` method.
...
await def list_ultra_servers_by_reserved_capacity(
    self,
    *,
    ReservedCapacityArn: str,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").start_cluster_health_check` method.
...
await def start_cluster_health_check(
    self,
    *,
    ClusterName: str,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").start_session` method.
...
Type annotations and code completion for `#!python session.create_client("sagemaker").stop_ai_benchmark_job` method.
...
await def stop_ai_benchmark_job(
    self,
    *,
    AIBenchmarkJobName: str,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").stop_ai_recommendation_job` method.
...
await def stop_ai_recommendation_job(
    self,
    *,
    AIRecommendationJobName: str,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").update_hub_content` method.
...
Type annotations and code completion for `#!python session.create_client("sagemaker").update_hub_content_reference` method.
...
await def update_hub_content_reference(
    self,
    *,
    HubName: str,
    HubContentName: str,
...
Type annotations and code completion for `#!python session.create_client("sagemaker").update_mlflow_app` method.
...
Type annotations and code completion for `#!python session.create_client("sagemaker").update_pipeline_version` method.
...
await def update_pipeline_version(
    self,
    *,
    PipelineArn: str,
    PipelineVersionId: int,
