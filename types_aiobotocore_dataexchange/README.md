<a id="type-annotations-for-aiobotocore-dataexchange-module"></a>
...
Type annotations for `aiobotocore.create_client("dataexchange")` as
...
```python
from types_aiobotocore_dataexchange.paginators import ListDataSetRevisionsPaginator, ...
```
