...
## DescribeConnectorOperationRequestRequestTypeDef

```python
# DescribeConnectorOperationRequestRequestTypeDef definition

class DescribeConnectorOperationRequestRequestTypeDef(TypedDict):
...
## ListConnectorOperationsRequestRequestTypeDef

```python
# ListConnectorOperationsRequestRequestTypeDef definition

class ListConnectorOperationsRequestRequestTypeDef(TypedDict):
    connectorArn: str,
