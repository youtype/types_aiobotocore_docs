...
```python
# ListEngagementByAcceptingInvitationTasksRequestListEngagementByAcceptingInvitationTasksPaginateTypeDef definition

class ListEngagementByAcceptingInvitationTasksRequestListEngagementByAcceptingInvitationTasksPaginateTypeDef(TypedDict):
    Catalog: str,
    EngagementInvitationIdentifier: NotRequired[Sequence[str]],
    OpportunityIdentifier: NotRequired[Sequence[str]],
    Sort: NotRequired[ListTasksSortBaseTypeDef],  # (1)
...
```python
# ListEngagementFromOpportunityTasksRequestListEngagementFromOpportunityTasksPaginateTypeDef definition

class ListEngagementFromOpportunityTasksRequestListEngagementFromOpportunityTasksPaginateTypeDef(TypedDict):
    Catalog: str,
    EngagementIdentifier: NotRequired[Sequence[str]],
    OpportunityIdentifier: NotRequired[Sequence[str]],
    Sort: NotRequired[ListTasksSortBaseTypeDef],  # (1)
...
```python
# ListEngagementMembersRequestListEngagementMembersPaginateTypeDef definition

class ListEngagementMembersRequestListEngagementMembersPaginateTypeDef(TypedDict):
    Catalog: str,
    Identifier: str,
...
```python
# ListEngagementResourceAssociationsRequestListEngagementResourceAssociationsPaginateTypeDef definition

class ListEngagementResourceAssociationsRequestListEngagementResourceAssociationsPaginateTypeDef(TypedDict):
    Catalog: str,
    CreatedBy: NotRequired[str],
    EngagementIdentifier: NotRequired[str],
    ResourceIdentifier: NotRequired[str],
...
```python
# ListResourceSnapshotsRequestListResourceSnapshotsPaginateTypeDef definition

class ListResourceSnapshotsRequestListResourceSnapshotsPaginateTypeDef(TypedDict):
    Catalog: str,
    EngagementIdentifier: str,
    CreatedBy: NotRequired[str],
    ResourceIdentifier: NotRequired[str],
...
```python
# ListResourceSnapshotJobsRequestListResourceSnapshotJobsPaginateTypeDef definition

class ListResourceSnapshotJobsRequestListResourceSnapshotJobsPaginateTypeDef(TypedDict):
    Catalog: str,
    EngagementIdentifier: NotRequired[str],
