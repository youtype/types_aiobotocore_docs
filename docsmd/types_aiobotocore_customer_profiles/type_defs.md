...
```python
# FilterAttributeDimensionUnionTypeDef definition

FilterAttributeDimensionUnionTypeDef = Union[
    FilterAttributeDimensionTypeDef,  # (1)
    FilterAttributeDimensionOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: FilterAttributeDimensionTypeDef](./type_defs.md#filterattributedimensiontypedef) 
2. See [:material-code-braces: FilterAttributeDimensionOutputTypeDef](./type_defs.md#filterattributedimensionoutputtypedef) 
...
```python
# FilterDimensionUnionTypeDef definition

FilterDimensionUnionTypeDef = Union[
    FilterDimensionTypeDef,  # (1)
    FilterDimensionOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: FilterDimensionTypeDef](./type_defs.md#filterdimensiontypedef) 
...
1. See [:material-code-braces: FilterGroupTypeDef](./type_defs.md#filtergrouptypedef) 
...
```python
# BatchGetProfileRequestRequestTypeDef definition
...
```python
# CreateSegmentSnapshotRequestRequestTypeDef definition
...
```python
# DeleteEventTriggerRequestRequestTypeDef definition
...
```python
# DeleteSegmentDefinitionRequestRequestTypeDef definition
...
```python
# GetEventTriggerRequestRequestTypeDef definition
...
```python
# GetSegmentDefinitionRequestRequestTypeDef definition
...
```python
# GetSegmentEstimateRequestRequestTypeDef definition
...
```python
# GetSegmentMembershipRequestRequestTypeDef definition
...
```python
# GetSegmentSnapshotRequestRequestTypeDef definition
...
```python
# ListEventTriggersRequestRequestTypeDef definition
...
```python
# ListObjectTypeAttributesRequestRequestTypeDef definition
...
```python
# ListSegmentDefinitionsRequestRequestTypeDef definition
...
```python
# ProfileAttributeValuesRequestRequestTypeDef definition
...
```python
# GetSimilarProfilesRequestGetSimilarProfilesPaginateTypeDef definition

class GetSimilarProfilesRequestGetSimilarProfilesPaginateTypeDef(TypedDict):
    DomainName: str,
    MatchType: MatchTypeType,  # (1)
    SearchKey: str,
    SearchValue: str,
...
```python
# ListEventTriggersRequestListEventTriggersPaginateTypeDef definition

class ListEventTriggersRequestListEventTriggersPaginateTypeDef(TypedDict):
    DomainName: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListObjectTypeAttributesRequestListObjectTypeAttributesPaginateTypeDef definition

class ListObjectTypeAttributesRequestListObjectTypeAttributesPaginateTypeDef(TypedDict):
    DomainName: str,
    ObjectTypeName: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListRuleBasedMatchesRequestListRuleBasedMatchesPaginateTypeDef definition

class ListRuleBasedMatchesRequestListRuleBasedMatchesPaginateTypeDef(TypedDict):
    DomainName: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListSegmentDefinitionsRequestListSegmentDefinitionsPaginateTypeDef definition

class ListSegmentDefinitionsRequestListSegmentDefinitionsPaginateTypeDef(TypedDict):
    DomainName: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# BatchGetCalculatedAttributeForProfileRequestRequestTypeDef definition
...
class FilterDimensionTypeDef(TypedDict):
    Attributes: Mapping[str, FilterAttributeDimensionUnionTypeDef],  # (1)
```

1. See [:material-code-braces: FilterAttributeDimensionTypeDef](./type_defs.md#filterattributedimensiontypedef) [:material-code-braces: FilterAttributeDimensionOutputTypeDef](./type_defs.md#filterattributedimensionoutputtypedef) 
...
class FilterGroupTypeDef(TypedDict):
    Type: TypeType,  # (1)
    Dimensions: Sequence[FilterDimensionUnionTypeDef],  # (2)
```

1. See [:material-code-brackets: TypeType](./literals.md#typetype) 
2. See [:material-code-braces: FilterDimensionTypeDef](./type_defs.md#filterdimensiontypedef) [:material-code-braces: FilterDimensionOutputTypeDef](./type_defs.md#filterdimensionoutputtypedef) 
...
```python
# UpdateEventTriggerRequestRequestTypeDef definition
...
class UpdateEventTriggerRequestRequestTypeDef(TypedDict):
    ...
    ObjectTypeName: NotRequired[str],
    Description: NotRequired[str],
    EventTriggerConditions: NotRequired[Sequence[EventTriggerConditionTypeDef]],  # (1)
    SegmentFilter: NotRequired[str],
    EventTriggerLimits: NotRequired[EventTriggerLimitsTypeDef],  # (2)
```
...
class FilterTypeDef(TypedDict):
    Include: IncludeType,  # (1)
    Groups: Sequence[FilterGroupUnionTypeDef],  # (2)
```

1. See [:material-code-brackets: IncludeType](./literals.md#includetype) 
2. See [:material-code-braces: FilterGroupTypeDef](./type_defs.md#filtergrouptypedef) [:material-code-braces: FilterGroupOutputTypeDef](./type_defs.md#filtergroupoutputtypedef) 
## CreateEventTriggerRequestRequestTypeDef

```python
# CreateEventTriggerRequestRequestTypeDef definition
...
class CreateCalculatedAttributeDefinitionRequestRequestTypeDef(TypedDict):
    ...
    Filter: NotRequired[FilterTypeDef],  # (4)
    Tags: NotRequired[Mapping[str, str]],
```
...
```python
# CreateSegmentEstimateRequestRequestTypeDef definition
...
```python
# CreateSegmentDefinitionRequestRequestTypeDef definition
