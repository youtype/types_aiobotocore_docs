...
Type annotations and code completion for `#!python session.create_client("sso-admin").add_region` method.
...
Type annotations and code completion for `#!python session.create_client("sso-admin").describe_region` method.
...
Type annotations and code completion for `#!python session.create_client("sso-admin").list_regions` method.
...
Type annotations and code completion for `#!python session.create_client("sso-admin").remove_region` method.
