<a id="literals-for-aiobotocore-sts-module"></a>

# Literals for aiobotocore STS module

> [Index](../README.md) > [STS](./README.md) > Literals
...
- [Literals for aiobotocore STS module](#literals-for-aiobotocore-sts-module)
...
```python
from types_aiobotocore_sts.literals import ResourceServiceName
```
