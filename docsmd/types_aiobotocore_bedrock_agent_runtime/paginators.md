...
) -> AsyncIterator[RerankResponseTypeDef]:  # (5)
    ...
```
...
kwargs: RerankRequestRerankPaginateTypeDef = {  # (1)
    "queries": ...,
...
1. See [:material-code-braces: RerankRequestRerankPaginateTypeDef](./type_defs.md#rerankrequestrerankpaginatetypedef) 
## RetrievePaginator
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> AsyncIterator[RetrieveResponseTypeDef]:  # (5)
    ...
```
