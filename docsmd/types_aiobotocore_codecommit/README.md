...
- [ListFileCommitHistoryRequestRequestTypeDef](./type_defs.md#listfilecommithistoryrequestrequesttypedef)
...
- [UpdateRepositoryEncryptionKeyInputRequestTypeDef](./type_defs.md#updaterepositoryencryptionkeyinputrequesttypedef)
