...
```python
# ListDataIntegrationFlowsRequestListDataIntegrationFlowsPaginateTypeDef definition

class ListDataIntegrationFlowsRequestListDataIntegrationFlowsPaginateTypeDef(TypedDict):
    instanceId: str,
...
```python
# ListDataLakeDatasetsRequestListDataLakeDatasetsPaginateTypeDef definition

class ListDataLakeDatasetsRequestListDataLakeDatasetsPaginateTypeDef(TypedDict):
    instanceId: str,
    namespace: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
