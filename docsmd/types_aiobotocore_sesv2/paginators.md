...
) -> AsyncIterator[ListMultiRegionEndpointsResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListMultiRegionEndpointsRequestListMultiRegionEndpointsPaginateTypeDef = {  # (1)
    "PaginationConfig": ...,
}
...
1. See [:material-code-braces: ListMultiRegionEndpointsRequestListMultiRegionEndpointsPaginateTypeDef](./type_defs.md#listmultiregionendpointsrequestlistmultiregionendpointspaginatetypedef) 
