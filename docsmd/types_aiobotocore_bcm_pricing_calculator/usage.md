...
from types_aiobotocore_bcm_pricing_calculator.type_defs import BatchCreateBillScenarioCommitmentModificationRequestRequestTypeDef
...
async with session.create_client("bcm-pricing-calculator") as client:
    ...
    kwargs: BatchCreateBillScenarioCommitmentModificationRequestRequestTypeDef = {...}
