...
1. See [:material-code-brackets: ColumnStatisticsStateType](./literals.md#columnstatisticsstatetype) 
## ColumnTypeDef
...
class TableOptimizerConfigurationTypeDef(TypedDict):
    ...
    retentionConfiguration: NotRequired[RetentionConfigurationTypeDef],  # (1)
    orphanFileDeletionConfiguration: NotRequired[OrphanFileDeletionConfigurationTypeDef],  # (2)
```

1. See [:material-code-braces: RetentionConfigurationTypeDef](./type_defs.md#retentionconfigurationtypedef) 
2. See [:material-code-braces: OrphanFileDeletionConfigurationTypeDef](./type_defs.md#orphanfiledeletionconfigurationtypedef) 
