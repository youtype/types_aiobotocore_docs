<a id="literals-for-aiobotocore-marketplacecommerceanalytics-module"></a>

# Literals for aiobotocore MarketplaceCommerceAnalytics module
...
- [Literals for aiobotocore MarketplaceCommerceAnalytics module](#literals-for-aiobotocore-marketplacecommerceanalytics-module)
...
```python
from types_aiobotocore_marketplacecommerceanalytics.literals import SupportDataSetTypeType
```
...
```python
from types_aiobotocore_marketplacecommerceanalytics.literals import MarketplaceCommerceAnalyticsServiceName
```
...
```python
from types_aiobotocore_marketplacecommerceanalytics.literals import ServiceName
```
...
```python
from types_aiobotocore_marketplacecommerceanalytics.literals import ResourceServiceName
```
