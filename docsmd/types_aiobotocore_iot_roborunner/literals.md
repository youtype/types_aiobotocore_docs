...
> [Index](../README.md) > [IoTRoboRunner](./README.md) > Literals
...
from types_aiobotocore_iot_roborunner.literals import ListDestinationsPaginatorName
...
from types_aiobotocore_iot_roborunner.literals import ListSitesPaginatorName
...
```python
# ListWorkerFleetsPaginatorName usage example

from types_aiobotocore_iot_roborunner.literals import ListWorkerFleetsPaginatorName

def get_value() -> ListWorkerFleetsPaginatorName:
    return "list_worker_fleets"
```

```python
# ListWorkerFleetsPaginatorName definition

ListWorkerFleetsPaginatorName = Literal[
    "list_worker_fleets",
]
```
...
from types_aiobotocore_iot_roborunner.literals import ListWorkersPaginatorName
...
```python
# IoTRoboRunnerServiceName usage example

from types_aiobotocore_iot_roborunner.literals import IoTRoboRunnerServiceName

def get_value() -> IoTRoboRunnerServiceName:
    return "iot-roborunner"
```

```python
# IoTRoboRunnerServiceName definition

IoTRoboRunnerServiceName = Literal[
    "iot-roborunner",
]
```
## ServiceName
...
from types_aiobotocore_iot_roborunner.literals import ServiceName
...
from types_aiobotocore_iot_roborunner.literals import ResourceServiceName
...
from types_aiobotocore_iot_roborunner.literals import PaginatorName
...
from types_aiobotocore_iot_roborunner.literals import RegionName
