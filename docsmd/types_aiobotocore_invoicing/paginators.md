...
) -> AsyncIterator[ListInvoiceUnitsResponseTypeDef]:  # (3)
    ...
```
...
kwargs: ListInvoiceUnitsRequestListInvoiceUnitsPaginateTypeDef = {  # (1)
    "Filters": ...,
}
...
1. See [:material-code-braces: ListInvoiceUnitsRequestListInvoiceUnitsPaginateTypeDef](./type_defs.md#listinvoiceunitsrequestlistinvoiceunitspaginatetypedef) 
