...
from types_aiobotocore_kinesisanalytics.literals import InputStartingPositionType
...
from types_aiobotocore_kinesisanalytics.literals import RecordFormatTypeType
...
```python
# KinesisAnalyticsServiceName usage example
from types_aiobotocore_kinesisanalytics.literals import KinesisAnalyticsServiceName

def get_value() -> KinesisAnalyticsServiceName:
    return "kinesisanalytics"
```

```python
# KinesisAnalyticsServiceName definition
KinesisAnalyticsServiceName = Literal[
    "kinesisanalytics",
]
```
## ServiceName
...
from types_aiobotocore_kinesisanalytics.literals import ServiceName
...
from types_aiobotocore_kinesisanalytics.literals import ResourceServiceName
...
from types_aiobotocore_kinesisanalytics.literals import RegionName
