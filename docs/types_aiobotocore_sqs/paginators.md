...
`AsyncIterator`\[[ListDeadLetterSourceQueuesResultTypeDef](./type_defs.md#listdeadlettersourcequeuesresulttypedef)\].
...
`AsyncIterator`\[[ListQueuesResultTypeDef](./type_defs.md#listqueuesresulttypedef)\].
