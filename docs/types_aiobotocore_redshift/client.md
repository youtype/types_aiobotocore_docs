<a id="redshiftclient-for-aiobotocore-redshift-module"></a>
...
Asynchronous method. Use `await modify_cluster_iam_roles(...)` for a
synchronous call.
...
Asynchronous method. Use `await modify_cluster_maintenance(...)` for a
synchronous call.
...
Asynchronous method. Use `await modify_cluster_parameter_group(...)` for a
synchronous call.
...
Asynchronous method. Use `await modify_cluster_snapshot(...)` for a synchronous
call.
...
Asynchronous method. Use `await modify_cluster_snapshot_schedule(...)` for a
synchronous call.
...
Asynchronous method. Use `await modify_cluster_subnet_group(...)` for a
synchronous call.
...
Asynchronous method. Use `await modify_endpoint_access(...)` for a synchronous
call.
...
Asynchronous method. Use `await modify_scheduled_action(...)` for a synchronous
call.
...
Asynchronous method. Use `await modify_snapshot_copy_retention_period(...)` for
a synchronous call.
...
Asynchronous method. Use `await modify_snapshot_schedule(...)` for a
synchronous call.
...
Asynchronous method. Use `await modify_usage_limit(...)` for a synchronous
call.
...
Asynchronous method. Use `await pause_cluster(...)` for a synchronous call.
...
Asynchronous method. Use `await purchase_reserved_node_offering(...)` for a
synchronous call.
...
Asynchronous method. Use `await reboot_cluster(...)` for a synchronous call.
...
Asynchronous method. Use `await reject_data_share(...)` for a synchronous call.
...
Asynchronous method. Use `await reset_cluster_parameter_group(...)` for a
synchronous call.
...
Asynchronous method. Use `await resize_cluster(...)` for a synchronous call.
...
Asynchronous method. Use `await restore_from_cluster_snapshot(...)` for a
synchronous call.
...
Asynchronous method. Use `await restore_table_from_cluster_snapshot(...)` for a
synchronous call.
...
Asynchronous method. Use `await resume_cluster(...)` for a synchronous call.
...
Asynchronous method. Use `await revoke_cluster_security_group_ingress(...)` for
a synchronous call.
...
Asynchronous method. Use `await revoke_endpoint_access(...)` for a synchronous
call.
...
Asynchronous method. Use `await revoke_snapshot_access(...)` for a synchronous
call.
...
Asynchronous method. Use `await rotate_encryption_key(...)` for a synchronous
call.
...
Asynchronous method. Use `await update_partner_status(...)` for a synchronous
call.
...
Boto3 documentation:
[Redshift.Client.\_\_aenter\_\_](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/redshift.html#Redshift.Client.__aenter__)
...
Boto3 documentation:
[Redshift.Client.\_\_aexit\_\_](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/redshift.html#Redshift.Client.__aexit__)
