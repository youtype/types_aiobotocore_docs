...
from types_aiobotocore_polly.type_defs import FlushStreamConfigurationTypeDef
...
from types_aiobotocore_polly.type_defs import ServiceFailureExceptionTypeDef
...
from types_aiobotocore_polly.type_defs import ServiceQuotaExceededExceptionTypeDef
...
from types_aiobotocore_polly.type_defs import StreamClosedEventTypeDef
...
from types_aiobotocore_polly.type_defs import ThrottlingReasonTypeDef
...
from types_aiobotocore_polly.type_defs import ValidationExceptionFieldTypeDef
...
from types_aiobotocore_polly.type_defs import TextEventTypeDef
...
from types_aiobotocore_polly.type_defs import ThrottlingExceptionTypeDef
...
from types_aiobotocore_polly.type_defs import ValidationExceptionTypeDef
...
from types_aiobotocore_polly.type_defs import StartSpeechSynthesisStreamActionStreamTypeDef
...
from types_aiobotocore_polly.type_defs import StartSpeechSynthesisStreamEventStreamTypeDef
...
from types_aiobotocore_polly.type_defs import StartSpeechSynthesisStreamInputTypeDef
...
class StartSpeechSynthesisStreamInputTypeDef(TypedDict):
    ...
    LexiconNames: NotRequired[Sequence[str]],
    SampleRate: NotRequired[str],
    ActionStream: NotRequired[aiobotocore.eventstream.AioEventStream[StartSpeechSynthesisStreamActionStreamTypeDef]],  # (5)
```
...
4. See [:material-code-brackets: LanguageCodeType](./literals.md#languagecodetype)
5. See `AioEventStream[StartSpeechSynthesisStreamActionStreamTypeDef]`
...
from types_aiobotocore_polly.type_defs import StartSpeechSynthesisStreamOutputTypeDef
...
class StartSpeechSynthesisStreamOutputTypeDef(TypedDict):
    EventStream: aiobotocore.eventstream.AioEventStream[StartSpeechSynthesisStreamEventStreamTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See `AioEventStream[StartSpeechSynthesisStreamEventStreamTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
