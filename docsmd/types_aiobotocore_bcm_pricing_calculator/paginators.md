...
) -> AsyncIterator[ListBillEstimateCommitmentsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    billEstimateId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListBillEstimateInputCommitmentModificationsResponseTypeDef]:  # (2)
    ...
```
...
) -> AsyncIterator[ListBillEstimateInputUsageModificationsResponsePaginatorTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListBillEstimateLineItemsResponseTypeDef]:  # (3)
    ...
```
...
) -> AsyncIterator[ListBillEstimatesResponseTypeDef]:  # (5)
    ...
```
...
def paginate(
    ...
    *,
    billScenarioId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListBillScenarioCommitmentModificationsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    filters: Sequence[ListUsageFilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListBillScenarioUsageModificationsResponsePaginatorTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    expiresAtFilter: FilterTimestampTypeDef = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> AsyncIterator[ListBillScenariosResponseTypeDef]:  # (5)
    ...
```
...
def paginate(
    ...
    *,
    ...
    filters: Sequence[ListUsageFilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListWorkloadEstimateUsageResponsePaginatorTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> AsyncIterator[ListWorkloadEstimatesResponseTypeDef]:  # (5)
    ...
```
