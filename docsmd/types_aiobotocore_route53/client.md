...
Type annotations and code completion for `#!python session.create_client("route53").close` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/route53.html#Route53.Client.close)
...
Type annotations and code completion for `#!python session.create_client("route53").disassociate_vpc_from_hosted_zone` method.
...
Type annotations and code completion for `#!python session.create_client("route53").get_health_check_count` method.
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/route53.html#Route53.Client.__aenter__)
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/route53.html#Route53.Client.__aexit__)
