...
class CreateDBClusterMessageRequestTypeDef(TypedDict):
    ...
    ClusterScalabilityType: NotRequired[ClusterScalabilityTypeType],  # (5)
    DBSystemId: NotRequired[str],
...
```python
# DescribeBlueGreenDeploymentsRequestDescribeBlueGreenDeploymentsPaginateTypeDef definition
...
```python
# DescribeDBClusterAutomatedBackupsMessageDescribeDBClusterAutomatedBackupsPaginateTypeDef definition

class DescribeDBClusterAutomatedBackupsMessageDescribeDBClusterAutomatedBackupsPaginateTypeDef(TypedDict):
    DbClusterResourceId: NotRequired[str],
    DBClusterIdentifier: NotRequired[str],
    Filters: NotRequired[Sequence[FilterTypeDef]],  # (1)
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (2)
...
```python
# DescribeDBClusterBacktracksMessageDescribeDBClusterBacktracksPaginateTypeDef definition
...
```python
# DescribeDBInstanceAutomatedBackupsMessageDescribeDBInstanceAutomatedBackupsPaginateTypeDef definition
...
```python
# DescribeDBLogFilesMessageDescribeDBLogFilesPaginateTypeDef definition
...
```python
# DescribeDBProxiesRequestDescribeDBProxiesPaginateTypeDef definition
...
```python
# DescribeDBProxyEndpointsRequestDescribeDBProxyEndpointsPaginateTypeDef definition
...
```python
# DescribeDBProxyTargetGroupsRequestDescribeDBProxyTargetGroupsPaginateTypeDef definition
...
```python
# DescribeDBProxyTargetsRequestDescribeDBProxyTargetsPaginateTypeDef definition
...
```python
# DescribeDBRecommendationsMessageDescribeDBRecommendationsPaginateTypeDef definition

class DescribeDBRecommendationsMessageDescribeDBRecommendationsPaginateTypeDef(TypedDict):
    LastUpdatedAfter: NotRequired[TimestampTypeDef],
    LastUpdatedBefore: NotRequired[TimestampTypeDef],
    Locale: NotRequired[str],
    Filters: NotRequired[Sequence[FilterTypeDef]],  # (1)
...
```python
# DescribeDBSecurityGroupsMessageDescribeDBSecurityGroupsPaginateTypeDef definition
...
```python
# DescribeDBSnapshotTenantDatabasesMessageDescribeDBSnapshotTenantDatabasesPaginateTypeDef definition

class DescribeDBSnapshotTenantDatabasesMessageDescribeDBSnapshotTenantDatabasesPaginateTypeDef(TypedDict):
    DBInstanceIdentifier: NotRequired[str],
    DBSnapshotIdentifier: NotRequired[str],
    SnapshotType: NotRequired[str],
    Filters: NotRequired[Sequence[FilterTypeDef]],  # (1)
...
```python
# DescribeDBSnapshotsMessageDescribeDBSnapshotsPaginateTypeDef definition
...
```python
# DescribeEngineDefaultClusterParametersMessageDescribeEngineDefaultClusterParametersPaginateTypeDef definition
...
```python
# DescribeExportTasksMessageDescribeExportTasksPaginateTypeDef definition
...
```python
# DescribeOptionGroupOptionsMessageDescribeOptionGroupOptionsPaginateTypeDef definition
...
```python
# DescribeOptionGroupsMessageDescribeOptionGroupsPaginateTypeDef definition
...
```python
# DescribeReservedDBInstancesMessageDescribeReservedDBInstancesPaginateTypeDef definition
...
```python
# DescribeReservedDBInstancesOfferingsMessageDescribeReservedDBInstancesOfferingsPaginateTypeDef definition
...
```python
# DescribeSourceRegionsMessageDescribeSourceRegionsPaginateTypeDef definition
...
```python
# DescribeTenantDatabasesMessageDescribeTenantDatabasesPaginateTypeDef definition

class DescribeTenantDatabasesMessageDescribeTenantDatabasesPaginateTypeDef(TypedDict):
    DBInstanceIdentifier: NotRequired[str],
    TenantDBName: NotRequired[str],
    Filters: NotRequired[Sequence[FilterTypeDef]],  # (1)
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (2)
...
```python
# DescribeDBClusterSnapshotsMessageDBClusterSnapshotAvailableWaitTypeDef definition
...
```python
# DescribeDBClusterSnapshotsMessageDBClusterSnapshotDeletedWaitTypeDef definition
...
```python
# DescribeDBClustersMessageDBClusterAvailableWaitTypeDef definition
...
```python
# DescribeDBClustersMessageDBClusterDeletedWaitTypeDef definition
...
```python
# DescribeDBSnapshotsMessageDBSnapshotAvailableWaitTypeDef definition
...
```python
# DescribeDBSnapshotsMessageDBSnapshotCompletedWaitTypeDef definition
...
```python
# DescribeDBSnapshotsMessageDBSnapshotDeletedWaitTypeDef definition
...
```python
# DescribeTenantDatabasesMessageTenantDatabaseAvailableWaitTypeDef definition

class DescribeTenantDatabasesMessageTenantDatabaseAvailableWaitTypeDef(TypedDict):
    DBInstanceIdentifier: NotRequired[str],
    TenantDBName: NotRequired[str],
    Filters: NotRequired[Sequence[FilterTypeDef]],  # (1)
    Marker: NotRequired[str],
...
```python
# DescribeTenantDatabasesMessageTenantDatabaseDeletedWaitTypeDef definition

class DescribeTenantDatabasesMessageTenantDatabaseDeletedWaitTypeDef(TypedDict):
    DBInstanceIdentifier: NotRequired[str],
    TenantDBName: NotRequired[str],
    Filters: NotRequired[Sequence[FilterTypeDef]],  # (1)
    Marker: NotRequired[str],
...
class DBClusterTypeDef(TypedDict):
    ...
    NetworkType: NotRequired[str],
    DBSystemId: NotRequired[str],
    MasterUserSecret: NotRequired[MasterUserSecretTypeDef],  # (15)
    IOOptimizedNextAllowedModificationTime: NotRequired[datetime],
    LocalWriteForwardingStatus: NotRequired[LocalWriteForwardingStatusType],  # (16)
    AwsBackupRecoveryPointArn: NotRequired[str],
    LimitlessDatabase: NotRequired[LimitlessDatabaseTypeDef],  # (17)
    StorageThroughput: NotRequired[int],
    ClusterScalabilityType: NotRequired[ClusterScalabilityTypeType],  # (18)
    CertificateDetails: NotRequired[CertificateDetailsTypeDef],  # (19)
    EngineLifecycleSupport: NotRequired[str],
```
...
14. See [:material-code-braces: ServerlessV2ScalingConfigurationInfoTypeDef](./type_defs.md#serverlessv2scalingconfigurationinfotypedef) 
15. See [:material-code-braces: MasterUserSecretTypeDef](./type_defs.md#masterusersecrettypedef) 
16. See [:material-code-brackets: LocalWriteForwardingStatusType](./literals.md#localwriteforwardingstatustype) 
17. See [:material-code-braces: LimitlessDatabaseTypeDef](./type_defs.md#limitlessdatabasetypedef) 
18. See [:material-code-brackets: ClusterScalabilityTypeType](./literals.md#clusterscalabilitytypetype) 
19. See [:material-code-braces: CertificateDetailsTypeDef](./type_defs.md#certificatedetailstypedef) 
