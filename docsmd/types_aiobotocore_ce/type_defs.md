...
```python
# CostCategoryResourceAssociationTypeDef TypedDict usage example

from types_aiobotocore_ce.type_defs import CostCategoryResourceAssociationTypeDef


def get_value() -> CostCategoryResourceAssociationTypeDef:
    return {
        "ResourceArn": ...,
    }


# CostCategoryResourceAssociationTypeDef definition
...
```python
# ListCostCategoryResourceAssociationsRequestTypeDef TypedDict usage example

from types_aiobotocore_ce.type_defs import ListCostCategoryResourceAssociationsRequestTypeDef


def get_value() -> ListCostCategoryResourceAssociationsRequestTypeDef:
    return {
        "CostCategoryArn": ...,
    }


# ListCostCategoryResourceAssociationsRequestTypeDef definition
...
```python
# ListCostCategoryResourceAssociationsResponseTypeDef TypedDict usage example

from types_aiobotocore_ce.type_defs import ListCostCategoryResourceAssociationsResponseTypeDef


def get_value() -> ListCostCategoryResourceAssociationsResponseTypeDef:
    return {
        "CostCategoryResourceAssociations": ...,
    }


# ListCostCategoryResourceAssociationsResponseTypeDef definition

class ListCostCategoryResourceAssociationsResponseTypeDef(TypedDict):
    CostCategoryResourceAssociations: list[CostCategoryResourceAssociationTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    NextToken: NotRequired[str],
```

1. See `list[CostCategoryResourceAssociationTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
```python
# ListCommitmentPurchaseAnalysesRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_ce.type_defs import ListCommitmentPurchaseAnalysesRequestPaginateTypeDef


def get_value() -> ListCommitmentPurchaseAnalysesRequestPaginateTypeDef:
    return {
        "AnalysisStatus": ...,
    }


# ListCommitmentPurchaseAnalysesRequestPaginateTypeDef definition
...
```python
# ListCostAllocationTagBackfillHistoryRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_ce.type_defs import ListCostAllocationTagBackfillHistoryRequestPaginateTypeDef


def get_value() -> ListCostAllocationTagBackfillHistoryRequestPaginateTypeDef:
    return {
        "PaginationConfig": ...,
    }


# ListCostAllocationTagBackfillHistoryRequestPaginateTypeDef definition
...
```python
# ListCostAllocationTagsRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_ce.type_defs import ListCostAllocationTagsRequestPaginateTypeDef


def get_value() -> ListCostAllocationTagsRequestPaginateTypeDef:
    return {
        "Status": ...,
    }


# ListCostAllocationTagsRequestPaginateTypeDef definition

class ListCostAllocationTagsRequestPaginateTypeDef(TypedDict):
    Status: NotRequired[CostAllocationTagStatusType],  # (1)
    TagKeys: NotRequired[Sequence[str]],
    Type: NotRequired[CostAllocationTagTypeType],  # (2)
...
```python
# ListCostCategoryDefinitionsRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_ce.type_defs import ListCostCategoryDefinitionsRequestPaginateTypeDef


def get_value() -> ListCostCategoryDefinitionsRequestPaginateTypeDef:
    return {
        "EffectiveOn": ...,
    }


# ListCostCategoryDefinitionsRequestPaginateTypeDef definition
...
```python
# ListCostCategoryResourceAssociationsRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_ce.type_defs import ListCostCategoryResourceAssociationsRequestPaginateTypeDef


def get_value() -> ListCostCategoryResourceAssociationsRequestPaginateTypeDef:
    return {
        "CostCategoryArn": ...,
    }


# ListCostCategoryResourceAssociationsRequestPaginateTypeDef definition
...
```python
# ListSavingsPlansPurchaseRecommendationGenerationRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_ce.type_defs import ListSavingsPlansPurchaseRecommendationGenerationRequestPaginateTypeDef


def get_value() -> ListSavingsPlansPurchaseRecommendationGenerationRequestPaginateTypeDef:
    return {
        "GenerationStatus": ...,
    }


# ListSavingsPlansPurchaseRecommendationGenerationRequestPaginateTypeDef definition
...
1. See `dict[str, MetricValueTypeDef]`
...
from types_aiobotocore_ce.type_defs import CostAndUsageComparisonTypeDef
...
2. See `dict[str, ComparisonMetricValueTypeDef]`
...
from types_aiobotocore_ce.type_defs import CostComparisonDriverTypeDef
...
class CostComparisonDriverTypeDef(TypedDict):
    ...
    Metrics: NotRequired[dict[str, ComparisonMetricValueTypeDef]],  # (2)
    CostDrivers: NotRequired[list[CostDriverTypeDef]],  # (3)
```

1. See [:material-code-braces: ExpressionOutputTypeDef](./type_defs.md#expressionoutputtypedef)
2. See `dict[str, ComparisonMetricValueTypeDef]`
3. See `list[CostDriverTypeDef]`
...
from types_aiobotocore_ce.type_defs import AnomalyMonitorPaginatorTypeDef
...
1. See [:material-code-brackets: MonitorTypeType](./literals.md#monitortypetype)
2. See [:material-code-brackets: MonitorDimensionType](./literals.md#monitordimensiontype)
3. See [:material-code-braces: ExpressionPaginatorOutputTypeDef](./type_defs.md#expressionpaginatoroutputtypedef)
...
from types_aiobotocore_ce.type_defs import AnomalySubscriptionPaginatorTypeDef
...
class AnomalySubscriptionPaginatorTypeDef(TypedDict):
    ...
    AccountId: NotRequired[str],
    Threshold: NotRequired[float],
    ThresholdExpression: NotRequired[ExpressionPaginatorOutputTypeDef],  # (3)
```
...
from types_aiobotocore_ce.type_defs import CostAndUsageComparisonPaginatorTypeDef
...
1. See [:material-code-braces: ExpressionPaginatorOutputTypeDef](./type_defs.md#expressionpaginatoroutputtypedef)
2. See `dict[str, ComparisonMetricValueTypeDef]`
...
from types_aiobotocore_ce.type_defs import CostComparisonDriverPaginatorTypeDef
...
1. See [:material-code-braces: DateIntervalTypeDef](./type_defs.md#dateintervaltypedef)
2. See `dict[str, MetricValueTypeDef]`
3. See `list[GroupTypeDef]`
...
1. See [:material-code-braces: DateIntervalTypeDef](./type_defs.md#dateintervaltypedef)
2. See `list[ReservationUtilizationGroupTypeDef]`
...
from types_aiobotocore_ce.type_defs import GetSavingsPlanPurchaseRecommendationDetailsResponseTypeDef
...
from types_aiobotocore_ce.type_defs import AnalysisDetailsTypeDef
...
1. See `list[SavingsPlansCoverageTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
6. See `list[SavingsPlansPurchaseRecommendationDetailTypeDef]`
...
from types_aiobotocore_ce.type_defs import CommitmentPurchaseAnalysisConfigurationOutputTypeDef
...
from types_aiobotocore_ce.type_defs import CommitmentPurchaseAnalysisConfigurationTypeDef
...
1. See `list[SavingsPlansUtilizationByTimeTypeDef]`
...
1. See `list[SavingsPlansUtilizationDetailTypeDef]`
2. See [:material-code-braces: SavingsPlansUtilizationAggregatesTypeDef](./type_defs.md#savingsplansutilizationaggregatestypedef)
...
1. See [:material-code-braces: DateIntervalTypeDef](./type_defs.md#dateintervaltypedef)
2. See `list[ReservationCoverageGroupTypeDef]`
...
1. See `list[AnomalyMonitorOutputTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
1. See `list[AnomalySubscriptionOutputTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_ce.type_defs import GetCostAndUsageComparisonsResponseTypeDef
...
1. See `list[CostAndUsageComparisonTypeDef]`
2. See `dict[str, ComparisonMetricValueTypeDef]`
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
2. See `list[CostCategoryRuleOutputTypeDef]`
3. See `list[CostCategorySplitChargeRuleOutputTypeDef]`
4. See `list[CostCategoryProcessingStatusTypeDef]`
...
from types_aiobotocore_ce.type_defs import GetCostComparisonDriversResponseTypeDef
...
1. See `list[CostComparisonDriverTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_ce.type_defs import GetAnomalyMonitorsResponsePaginatorTypeDef
...
1. See `list[AnomalyMonitorPaginatorTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_ce.type_defs import GetAnomalySubscriptionsResponsePaginatorTypeDef
...
1. See `list[AnomalySubscriptionPaginatorTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_ce.type_defs import GetCostAndUsageComparisonsResponsePaginatorTypeDef
...
1. See `list[CostAndUsageComparisonPaginatorTypeDef]`
2. See `dict[str, ComparisonMetricValueTypeDef]`
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_ce.type_defs import GetCostComparisonDriversResponsePaginatorTypeDef
...
1. See `list[CostComparisonDriverPaginatorTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
1. See `list[TagValuesOutputTypeDef]`
...
from types_aiobotocore_ce.type_defs import GetCostAndUsageComparisonsRequestPaginateTypeDef
...
from types_aiobotocore_ce.type_defs import GetCostComparisonDriversRequestPaginateTypeDef
...
```python
# GetReservationPurchaseRecommendationRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_ce.type_defs import GetReservationPurchaseRecommendationRequestPaginateTypeDef


def get_value() -> GetReservationPurchaseRecommendationRequestPaginateTypeDef:
    return {
        "Service": ...,
    }


# GetReservationPurchaseRecommendationRequestPaginateTypeDef definition

class GetReservationPurchaseRecommendationRequestPaginateTypeDef(TypedDict):
    Service: str,
    AccountId: NotRequired[str],
    Filter: NotRequired[ExpressionPaginatorUnionTypeDef],  # (1)
...
```python
# GetRightsizingRecommendationRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_ce.type_defs import GetRightsizingRecommendationRequestPaginateTypeDef


def get_value() -> GetRightsizingRecommendationRequestPaginateTypeDef:
    return {
        "Service": ...,
    }


# GetRightsizingRecommendationRequestPaginateTypeDef definition
...
1. See `Sequence[SubscriberTypeDef]`
2. See [:material-code-brackets: AnomalySubscriptionFrequencyType](./literals.md#anomalysubscriptionfrequencytype)
3. See [:material-code-braces: ExpressionTypeDef](./type_defs.md#expressiontypedef)
...
1. See `list[GroupDefinitionTypeDef]`
2. See `list[ResultByTimeTypeDef]`
3. See `list[DimensionValuesWithAttributesTypeDef]`
4. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
1. See `list[UtilizationByTimeTypeDef]`
...
6. See `list[ReservationPurchaseRecommendationDetailTypeDef]`
...
from types_aiobotocore_ce.type_defs import AnalysisSummaryTypeDef
...
from types_aiobotocore_ce.type_defs import GetCommitmentPurchaseAnalysisResponseTypeDef
...
1. See `list[CoverageByTimeTypeDef]`
...
1. See `list[TargetInstanceTypeDef]`
...
from types_aiobotocore_ce.type_defs import GetCostAndUsageComparisonsRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetCostAndUsageRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetCostAndUsageWithResourcesRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetCostCategoriesRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetCostComparisonDriversRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetCostForecastRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetDimensionValuesRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetReservationCoverageRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetReservationPurchaseRecommendationRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetReservationUtilizationRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetRightsizingRecommendationRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetSavingsPlansCoverageRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetSavingsPlansPurchaseRecommendationRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetSavingsPlansUtilizationDetailsRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetSavingsPlansUtilizationRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetTagsRequestTypeDef
...
from types_aiobotocore_ce.type_defs import GetUsageForecastRequestTypeDef
...
from types_aiobotocore_ce.type_defs import UpdateAnomalySubscriptionRequestTypeDef
...
2. See `list[ReservationPurchaseRecommendationTypeDef]`
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_ce.type_defs import ListCommitmentPurchaseAnalysesResponseTypeDef
...
1. See `list[AnalysisSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_ce.type_defs import StartCommitmentPurchaseAnalysisRequestTypeDef
...
5. See `list[FindingReasonCodeType]`
...
from types_aiobotocore_ce.type_defs import CreateAnomalySubscriptionRequestTypeDef
...
3. See `list[RightsizingRecommendationTypeDef]`
...
from types_aiobotocore_ce.type_defs import CreateCostCategoryDefinitionRequestTypeDef
...
from types_aiobotocore_ce.type_defs import UpdateCostCategoryDefinitionRequestTypeDef
