...
Type annotations and code completion for `#!python session.create_client("cloudwatch").delete_alarm_mute_rule` method.
...
await def delete_alarm_mute_rule(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("cloudwatch").describe_alarm_contributors` method.
...
await def describe_alarm_contributors(
    self,
    *,
    AlarmName: str,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("cloudwatch").get_alarm_mute_rule` method.
...
Type annotations and code completion for `#!python session.create_client("cloudwatch").get_otel_enrichment` method.
...
Type annotations and code completion for `#!python session.create_client("cloudwatch").list_alarm_mute_rules` method.
...
await def list_alarm_mute_rules(
    self,
    *,
    AlarmName: str = ...,
...
Type annotations and code completion for `#!python session.create_client("cloudwatch").put_alarm_mute_rule` method.
...
Type annotations and code completion for `#!python session.create_client("cloudwatch").put_anomaly_detector` method.
...
8. See [:material-code-braces: EmptyResponseMetadataTypeDef](./type_defs.md#emptyresponsemetadatatypedef)
...
Type annotations and code completion for `#!python session.create_client("cloudwatch").start_otel_enrichment` method.
...
await def start_otel_enrichment(
    self,
) -> dict[str, Any]:
    ...
```
...
Type annotations and code completion for `#!python session.create_client("cloudwatch").stop_otel_enrichment` method.
...
await def stop_otel_enrichment(
    self,
) -> dict[str, Any]:
    ...
```
