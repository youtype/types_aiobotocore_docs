...
from types_aiobotocore_ssm_quicksetup.type_defs import CreateConfigurationManagerInputRequestTypeDef
...
async with session.create_client("ssm-quicksetup") as client:
    ...
    kwargs: CreateConfigurationManagerInputRequestTypeDef = {...}
