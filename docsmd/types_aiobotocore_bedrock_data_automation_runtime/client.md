...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation-runtime").close` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock-data-automation-runtime/client/close.html)
...
1. See [:material-code-braces: GetDataAutomationStatusRequestRequestTypeDef](./type_defs.md#getdataautomationstatusrequestrequesttypedef) 
...
1. See [:material-code-braces: InvokeDataAutomationAsyncRequestRequestTypeDef](./type_defs.md#invokedataautomationasyncrequestrequesttypedef) 
