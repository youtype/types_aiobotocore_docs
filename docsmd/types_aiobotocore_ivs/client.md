...
Type annotations and code completion for `#!python session.create_client("ivs").create_ad_configuration` method.
...
await def create_ad_configuration(
    self,
    *,
    mediaTailorPlaybackConfigurations: Sequence[MediaTailorPlaybackConfigurationTypeDef],  # (1)
    name: str = ...,
    tags: Mapping[str, str] = ...,
) -> CreateAdConfigurationResponseTypeDef:  # (2)
    ...
```

1. See `Sequence[MediaTailorPlaybackConfigurationTypeDef]`
2. See [:material-code-braces: CreateAdConfigurationResponseTypeDef](./type_defs.md#createadconfigurationresponsetypedef)
...
Type annotations and code completion for `#!python session.create_client("ivs").delete_ad_configuration` method.
...
await def delete_ad_configuration(
    self,
    *,
    arn: str,
...
Type annotations and code completion for `#!python session.create_client("ivs").get_ad_configuration` method.
...
await def get_ad_configuration(
    self,
    *,
    arn: str,
...
Type annotations and code completion for `#!python session.create_client("ivs").insert_ad_break` method.
...
Type annotations and code completion for `#!python session.create_client("ivs").list_ad_configurations` method.
...
await def list_ad_configurations(
    self,
    *,
    nextToken: str = ...,
    maxResults: int = ...,
