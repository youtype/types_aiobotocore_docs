...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/dms.html#DatabaseMigrationService.Paginator.DescribeDataMigrations)
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DescribeDataMigrationsResponseTypeDef]:  # (3)
    ...
```
...
1. See [:material-code-braces: DescribeDataMigrationsMessageDescribeDataMigrationsPaginateTypeDef](./type_defs.md#describedatamigrationsmessagedescribedatamigrationspaginatetypedef) 
