...
Type annotations for `aiobotocore.create_client("sagemaker-a2i-runtime")` as
...
```python
from types_aiobotocore_sagemaker_a2i_runtime.paginators import ListHumanLoopsPaginator, ...
```
