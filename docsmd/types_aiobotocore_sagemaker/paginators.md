...
Type annotations and code completion for `#!python session.create_client("sagemaker").get_paginator("describe_training_plan_extension_history")`.
...
) -> aiobotocore.paginate.AioPageIterator[DescribeTrainingPlanExtensionHistoryResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `AioPageIterator[DescribeTrainingPlanExtensionHistoryResponseTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("sagemaker").get_paginator("list_ai_benchmark_jobs")`.
...
from types_aiobotocore_sagemaker.paginator import ListAIBenchmarkJobsPaginator

session = get_session()
async with session.create_client("sagemaker") as client:  # (1)
    paginator: ListAIBenchmarkJobsPaginator = client.get_paginator("list_ai_benchmark_jobs")  # (2)
    async for item in paginator.paginate(...):
        item: ListAIBenchmarkJobsResponseTypeDef
        print(item)  # (3)
```

1. client: [SageMakerClient](./client.md)
2. paginator: [ListAIBenchmarkJobsPaginator](./paginators.md#listaibenchmarkjobspaginator)
3. item: `AioPageIterator[ListAIBenchmarkJobsResponseTypeDef]`
...
) -> aiobotocore.paginate.AioPageIterator[ListAIBenchmarkJobsResponseTypeDef]:  # (5)
    ...
```
...
5. See `AioPageIterator[ListAIBenchmarkJobsResponseTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("sagemaker").get_paginator("list_ai_recommendation_jobs")`.
...
from types_aiobotocore_sagemaker.paginator import ListAIRecommendationJobsPaginator

session = get_session()
async with session.create_client("sagemaker") as client:  # (1)
    paginator: ListAIRecommendationJobsPaginator = client.get_paginator("list_ai_recommendation_jobs")  # (2)
    async for item in paginator.paginate(...):
        item: ListAIRecommendationJobsResponseTypeDef
        print(item)  # (3)
```

1. client: [SageMakerClient](./client.md)
2. paginator: [ListAIRecommendationJobsPaginator](./paginators.md#listairecommendationjobspaginator)
3. item: `AioPageIterator[ListAIRecommendationJobsResponseTypeDef]`
...
def paginate(
    ...
    *,
    ...
    SortOrder: SortOrderType = ...,  # (3)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> aiobotocore.paginate.AioPageIterator[ListAIRecommendationJobsResponseTypeDef]:  # (5)
    ...
```
...
3. See [:material-code-brackets: SortOrderType](./literals.md#sortordertype)
4. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
5. See `AioPageIterator[ListAIRecommendationJobsResponseTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("sagemaker").get_paginator("list_ai_workload_configs")`.
...
from types_aiobotocore_sagemaker.paginator import ListAIWorkloadConfigsPaginator

session = get_session()
async with session.create_client("sagemaker") as client:  # (1)
    paginator: ListAIWorkloadConfigsPaginator = client.get_paginator("list_ai_workload_configs")  # (2)
    async for item in paginator.paginate(...):
        item: ListAIWorkloadConfigsResponseTypeDef
        print(item)  # (3)
```

1. client: [SageMakerClient](./client.md)
2. paginator: [ListAIWorkloadConfigsPaginator](./paginators.md#listaiworkloadconfigspaginator)
3. item: `AioPageIterator[ListAIWorkloadConfigsResponseTypeDef]`
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> aiobotocore.paginate.AioPageIterator[ListAIWorkloadConfigsResponseTypeDef]:  # (4)
    ...
```
...
3. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
4. See `AioPageIterator[ListAIWorkloadConfigsResponseTypeDef]`
