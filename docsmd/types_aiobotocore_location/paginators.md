...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/location.html#LocationService.Paginator.ForecastGeofenceEvents)
...
) -> AsyncIterator[ForecastGeofenceEventsResponseTypeDef]:  # (5)
    ...
```
...
kwargs: ForecastGeofenceEventsRequestForecastGeofenceEventsPaginateTypeDef = {  # (1)
    "CollectionName": ...,
    "DeviceState": ...,
}
...
1. See [:material-code-braces: ForecastGeofenceEventsRequestForecastGeofenceEventsPaginateTypeDef](./type_defs.md#forecastgeofenceeventsrequestforecastgeofenceeventspaginatetypedef) 
...
) -> AsyncIterator[ListDevicePositionsResponseTypeDef]:  # (3)
    ...
```
