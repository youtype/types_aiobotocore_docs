...
Type annotations and code completion for `#!python session.create_client("route53globalresolver")`
...
This class provides code completion for `#!python session.create_client("route53globalresolver").exceptions` structure.

```python
# Route53GlobalResolverClient.exceptions usage example
...
```python
# Route53GlobalResolverClient usage type checking example

from types_aiobotocore_route53globalresolver.client import Exceptions
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").can_paginate` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").generate_presigned_url` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").associate_hosted_zone` method.
...
await def associate_hosted_zone(
    self,
    *,
    hostedZoneId: str,
    resourceArn: str,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").batch_create_firewall_rule` method.
...
await def batch_create_firewall_rule(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").batch_delete_firewall_rule` method.
...
await def batch_delete_firewall_rule(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").batch_update_firewall_rule` method.
...
await def batch_update_firewall_rule(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").create_access_source` method.
...
await def create_access_source(
    self,
    *,
    cidr: str,
    dnsViewId: str,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").create_access_token` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").create_dns_view` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").create_firewall_domain_list` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").create_firewall_rule` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").create_global_resolver` method.
...
await def create_global_resolver(
    self,
    *,
    name: str,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").delete_access_source` method.
...
await def delete_access_source(
    self,
    *,
    accessSourceId: str,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").delete_access_token` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").delete_dns_view` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").delete_firewall_domain_list` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").delete_firewall_rule` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").delete_global_resolver` method.
...
await def delete_global_resolver(
    self,
    *,
    globalResolverId: str,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").disable_dns_view` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").disassociate_hosted_zone` method.
...
await def disassociate_hosted_zone(
    self,
    *,
    hostedZoneId: str,
    resourceArn: str,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").enable_dns_view` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").get_access_source` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").get_access_token` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").get_dns_view` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").get_firewall_domain_list` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").get_firewall_rule` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").get_global_resolver` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").get_hosted_zone_association` method.
...
await def get_hosted_zone_association(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").get_managed_firewall_domain_list` method.
...
await def get_managed_firewall_domain_list(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").import_firewall_domains` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").list_access_sources` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").list_access_tokens` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").list_dns_views` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").list_firewall_domain_lists` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").list_firewall_domains` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").list_firewall_rules` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").list_global_resolvers` method.
...
await def list_global_resolvers(
    self,
    *,
    maxResults: int = ...,
    nextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").list_hosted_zone_associations` method.
...
await def list_hosted_zone_associations(
    self,
    *,
    resourceArn: str,
    maxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").list_managed_firewall_domain_lists` method.
...
await def list_managed_firewall_domain_lists(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").untag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").update_access_source` method.
...
await def update_access_source(
    self,
    *,
    accessSourceId: str,
    cidr: str = ...,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").update_access_token` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").update_dns_view` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").update_firewall_domains` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").update_firewall_rule` method.
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").update_global_resolver` method.
...
await def update_global_resolver(
    self,
    *,
    globalResolverId: str,
    name: str = ...,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").update_hosted_zone_association` method.
...
await def update_hosted_zone_association(
    self,
    *,
    hostedZoneAssociationId: str,
    name: str = ...,
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/route53globalresolver.html#Route53GlobalResolver.Client)
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/route53globalresolver.html#Route53GlobalResolver.Client)
...
Type annotations and code completion for `#!python session.create_client("route53globalresolver").get_paginator` method with overloads.
