...
```python
HoneycodeClient.exceptions usage example
...
```python
HoneycodeClient usage type checking example
...
Type annotations and code completion for `#!python session.create_client("honeycode").batch_delete_table_rows` method.
