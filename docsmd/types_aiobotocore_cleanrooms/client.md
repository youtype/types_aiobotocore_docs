...
Type annotations and code completion for `#!python session.create_client("cleanrooms").update_collaboration_change_request` method.
...
await def update_collaboration_change_request(
    self,
    *,
    collaborationIdentifier: str,
    changeRequestIdentifier: str,
