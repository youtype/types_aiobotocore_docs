...
1. See [:material-code-braces: AwsAmazonMqBrokerLdapServerMetadataDetailsTypeDef](./type_defs.md#awsamazonmqbrokerldapservermetadatadetailstypedef) 
2. See [:material-code-braces: AwsAmazonMqBrokerLdapServerMetadataDetailsOutputTypeDef](./type_defs.md#awsamazonmqbrokerldapservermetadatadetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsApiGatewayCanarySettingsTypeDef](./type_defs.md#awsapigatewaycanarysettingstypedef) 
2. See [:material-code-braces: AwsApiGatewayCanarySettingsOutputTypeDef](./type_defs.md#awsapigatewaycanarysettingsoutputtypedef) 
...
2. See [:material-code-braces: AwsApiGatewayEndpointConfigurationOutputTypeDef](./type_defs.md#awsapigatewayendpointconfigurationoutputtypedef) 
...
2. See [:material-code-braces: AwsBackupBackupPlanAdvancedBackupSettingsDetailsOutputTypeDef](./type_defs.md#awsbackupbackupplanadvancedbackupsettingsdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsBackupBackupVaultNotificationsDetailsOutputTypeDef](./type_defs.md#awsbackupbackupvaultnotificationsdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsCloudFrontDistributionOriginGroupFailoverStatusCodesOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupfailoverstatuscodesoutputtypedef) 
...
2. See [:material-code-braces: AwsCloudFrontDistributionOriginSslProtocolsOutputTypeDef](./type_defs.md#awscloudfrontdistributionoriginsslprotocolsoutputtypedef) 
...
1. See [:material-code-braces: AwsCodeBuildProjectVpcConfigTypeDef](./type_defs.md#awscodebuildprojectvpcconfigtypedef) 
2. See [:material-code-braces: AwsCodeBuildProjectVpcConfigOutputTypeDef](./type_defs.md#awscodebuildprojectvpcconfigoutputtypedef) 
...
2. See [:material-code-braces: AwsCorsConfigurationOutputTypeDef](./type_defs.md#awscorsconfigurationoutputtypedef) 
...
1. See [:material-code-braces: AwsDynamoDbTableProjectionTypeDef](./type_defs.md#awsdynamodbtableprojectiontypedef) 
2. See [:material-code-braces: AwsDynamoDbTableProjectionOutputTypeDef](./type_defs.md#awsdynamodbtableprojectionoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2TransitGatewayDetailsTypeDef](./type_defs.md#awsec2transitgatewaydetailstypedef) 
2. See [:material-code-braces: AwsEc2TransitGatewayDetailsOutputTypeDef](./type_defs.md#awsec2transitgatewaydetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsEc2VpnConnectionOptionsTunnelOptionsDetailsOutputTypeDef](./type_defs.md#awsec2vpnconnectionoptionstunneloptionsdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsEcrContainerImageDetailsOutputTypeDef](./type_defs.md#awsecrcontainerimagedetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsEcsServiceNetworkConfigurationAwsVpcConfigurationDetailsOutputTypeDef](./type_defs.md#awsecsservicenetworkconfigurationawsvpcconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsFirelensConfigurationDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsfirelensconfigurationdetailstypedef) 
2. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsFirelensConfigurationDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsfirelensconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionshealthcheckdetailstypedef) 
2. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionshealthcheckdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersCapabilitiesDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparameterscapabilitiesdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparametersdevicesdetailstypedef) 
2. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparametersdevicesdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersTmpfsDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparameterstmpfsdetailstypedef) 
2. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersTmpfsDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparameterstmpfsdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitionvolumesdockervolumeconfigurationdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsEfsAccessPointPosixUserDetailsOutputTypeDef](./type_defs.md#awsefsaccesspointposixuserdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsEksClusterLoggingClusterLoggingDetailsOutputTypeDef](./type_defs.md#awseksclusterloggingclusterloggingdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsEksClusterResourcesVpcConfigDetailsOutputTypeDef](./type_defs.md#awseksclusterresourcesvpcconfigdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsElasticsearchDomainVPCOptionsTypeDef](./type_defs.md#awselasticsearchdomainvpcoptionstypedef) 
2. See [:material-code-braces: AwsElasticsearchDomainVPCOptionsOutputTypeDef](./type_defs.md#awselasticsearchdomainvpcoptionsoutputtypedef) 
...
2. See [:material-code-braces: AwsElbLoadBalancerBackendServerDescriptionOutputTypeDef](./type_defs.md#awselbloadbalancerbackendserverdescriptionoutputtypedef) 
...
1. See [:material-code-braces: AwsLambdaFunctionVpcConfigTypeDef](./type_defs.md#awslambdafunctionvpcconfigtypedef) 
2. See [:material-code-braces: AwsLambdaFunctionVpcConfigOutputTypeDef](./type_defs.md#awslambdafunctionvpcconfigoutputtypedef) 
...
1. See [:material-code-braces: AwsLambdaLayerVersionDetailsTypeDef](./type_defs.md#awslambdalayerversiondetailstypedef) 
2. See [:material-code-braces: AwsLambdaLayerVersionDetailsOutputTypeDef](./type_defs.md#awslambdalayerversiondetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationTlsDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationtlsdetailstypedef) 
2. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationTlsDetailsOutputTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationtlsdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsOpenSearchServiceDomainVpcOptionsDetailsTypeDef](./type_defs.md#awsopensearchservicedomainvpcoptionsdetailstypedef) 
2. See [:material-code-braces: AwsOpenSearchServiceDomainVpcOptionsDetailsOutputTypeDef](./type_defs.md#awsopensearchservicedomainvpcoptionsdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsRdsDbClusterSnapshotDbClusterSnapshotAttributeOutputTypeDef](./type_defs.md#awsrdsdbclustersnapshotdbclustersnapshotattributeoutputtypedef) 
...
1. See [:material-code-braces: AwsRdsEventSubscriptionDetailsTypeDef](./type_defs.md#awsrdseventsubscriptiondetailstypedef) 
2. See [:material-code-braces: AwsRdsEventSubscriptionDetailsOutputTypeDef](./type_defs.md#awsrdseventsubscriptiondetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsRdsPendingCloudWatchLogsExportsOutputTypeDef](./type_defs.md#awsrdspendingcloudwatchlogsexportsoutputtypedef) 
...
1. See [:material-code-braces: GeneratorDetailsTypeDef](./type_defs.md#generatordetailstypedef) 
2. See [:material-code-braces: GeneratorDetailsOutputTypeDef](./type_defs.md#generatordetailsoutputtypedef) 
...
2. See [:material-code-braces: IndicatorOutputTypeDef](./type_defs.md#indicatoroutputtypedef) 
...
2. See [:material-code-braces: ParameterValueOutputTypeDef](./type_defs.md#parametervalueoutputtypedef) 
...
2. See [:material-code-braces: RuleGroupSourceListDetailsOutputTypeDef](./type_defs.md#rulegroupsourcelistdetailsoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceStatefulRulesOptionsDetailsTypeDef](./type_defs.md#rulegroupsourcestatefulrulesoptionsdetailstypedef) 
2. See [:material-code-braces: RuleGroupSourceStatefulRulesOptionsDetailsOutputTypeDef](./type_defs.md#rulegroupsourcestatefulrulesoptionsdetailsoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceStatelessRuleMatchAttributesTcpFlagsTypeDef](./type_defs.md#rulegroupsourcestatelessrulematchattributestcpflagstypedef) 
2. See [:material-code-braces: RuleGroupSourceStatelessRuleMatchAttributesTcpFlagsOutputTypeDef](./type_defs.md#rulegroupsourcestatelessrulematchattributestcpflagsoutputtypedef) 
...
2. See [:material-code-braces: RuleGroupVariablesIpSetsDetailsOutputTypeDef](./type_defs.md#rulegroupvariablesipsetsdetailsoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupVariablesPortSetsDetailsTypeDef](./type_defs.md#rulegroupvariablesportsetsdetailstypedef) 
2. See [:material-code-braces: RuleGroupVariablesPortSetsDetailsOutputTypeDef](./type_defs.md#rulegroupvariablesportsetsdetailsoutputtypedef) 
...
1. See [:material-code-braces: SecurityControlParameterTypeDef](./type_defs.md#securitycontrolparametertypedef) 
2. See [:material-code-braces: SecurityControlParameterOutputTypeDef](./type_defs.md#securitycontrolparameteroutputtypedef) 
...
1. See [:material-code-braces: CvssTypeDef](./type_defs.md#cvsstypedef) 
2. See [:material-code-braces: CvssOutputTypeDef](./type_defs.md#cvssoutputtypedef) 
...
1. See [:material-code-braces: AutomationRulesFindingFieldsUpdateTypeDef](./type_defs.md#automationrulesfindingfieldsupdatetypedef) 
2. See [:material-code-braces: AutomationRulesFindingFieldsUpdateOutputTypeDef](./type_defs.md#automationrulesfindingfieldsupdateoutputtypedef) 
...
1. See [:material-code-braces: AwsApiGatewayV2StageDetailsTypeDef](./type_defs.md#awsapigatewayv2stagedetailstypedef) 
2. See [:material-code-braces: AwsApiGatewayV2StageDetailsOutputTypeDef](./type_defs.md#awsapigatewayv2stagedetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsAutoScalingAutoScalingGroupMixedInstancesPolicyLaunchTemplateDetailsTypeDef](./type_defs.md#awsautoscalingautoscalinggroupmixedinstancespolicylaunchtemplatedetailstypedef) 
2. See [:material-code-braces: AwsAutoScalingAutoScalingGroupMixedInstancesPolicyLaunchTemplateDetailsOutputTypeDef](./type_defs.md#awsautoscalingautoscalinggroupmixedinstancespolicylaunchtemplatedetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsCertificateManagerCertificateDomainValidationOptionOutputTypeDef](./type_defs.md#awscertificatemanagercertificatedomainvalidationoptionoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFormationStackDetailsTypeDef](./type_defs.md#awscloudformationstackdetailstypedef) 
2. See [:material-code-braces: AwsCloudFormationStackDetailsOutputTypeDef](./type_defs.md#awscloudformationstackdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsCloudFrontDistributionCacheBehaviorsOutputTypeDef](./type_defs.md#awscloudfrontdistributioncachebehaviorsoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudWatchAlarmDetailsTypeDef](./type_defs.md#awscloudwatchalarmdetailstypedef) 
2. See [:material-code-braces: AwsCloudWatchAlarmDetailsOutputTypeDef](./type_defs.md#awscloudwatchalarmdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsCodeBuildProjectEnvironmentTypeDef](./type_defs.md#awscodebuildprojectenvironmenttypedef) 
2. See [:material-code-braces: AwsCodeBuildProjectEnvironmentOutputTypeDef](./type_defs.md#awscodebuildprojectenvironmentoutputtypedef) 
...
1. See [:material-code-braces: AwsDmsReplicationInstanceDetailsTypeDef](./type_defs.md#awsdmsreplicationinstancedetailstypedef) 
2. See [:material-code-braces: AwsDmsReplicationInstanceDetailsOutputTypeDef](./type_defs.md#awsdmsreplicationinstancedetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsEc2InstanceDetailsOutputTypeDef](./type_defs.md#awsec2instancedetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2LaunchTemplateDataInstanceRequirementsDetailsTypeDef](./type_defs.md#awsec2launchtemplatedatainstancerequirementsdetailstypedef) 
2. See [:material-code-braces: AwsEc2LaunchTemplateDataInstanceRequirementsDetailsOutputTypeDef](./type_defs.md#awsec2launchtemplatedatainstancerequirementsdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2LaunchTemplateDataNetworkInterfaceSetDetailsTypeDef](./type_defs.md#awsec2launchtemplatedatanetworkinterfacesetdetailstypedef) 
2. See [:material-code-braces: AwsEc2LaunchTemplateDataNetworkInterfaceSetDetailsOutputTypeDef](./type_defs.md#awsec2launchtemplatedatanetworkinterfacesetdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2NetworkInterfaceDetailsTypeDef](./type_defs.md#awsec2networkinterfacedetailstypedef) 
2. See [:material-code-braces: AwsEc2NetworkInterfaceDetailsOutputTypeDef](./type_defs.md#awsec2networkinterfacedetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsEc2SecurityGroupIpPermissionOutputTypeDef](./type_defs.md#awsec2securitygroupippermissionoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2SubnetDetailsTypeDef](./type_defs.md#awsec2subnetdetailstypedef) 
2. See [:material-code-braces: AwsEc2SubnetDetailsOutputTypeDef](./type_defs.md#awsec2subnetdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2VolumeDetailsTypeDef](./type_defs.md#awsec2volumedetailstypedef) 
2. See [:material-code-braces: AwsEc2VolumeDetailsOutputTypeDef](./type_defs.md#awsec2volumedetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2VpcDetailsTypeDef](./type_defs.md#awsec2vpcdetailstypedef) 
2. See [:material-code-braces: AwsEc2VpcDetailsOutputTypeDef](./type_defs.md#awsec2vpcdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2VpcEndpointServiceDetailsTypeDef](./type_defs.md#awsec2vpcendpointservicedetailstypedef) 
2. See [:material-code-braces: AwsEc2VpcEndpointServiceDetailsOutputTypeDef](./type_defs.md#awsec2vpcendpointservicedetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsEc2VpcPeeringConnectionVpcInfoDetailsOutputTypeDef](./type_defs.md#awsec2vpcpeeringconnectionvpcinfodetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsContainerDetailsTypeDef](./type_defs.md#awsecscontainerdetailstypedef) 
2. See [:material-code-braces: AwsEcsContainerDetailsOutputTypeDef](./type_defs.md#awsecscontainerdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslogconfigurationdetailstypedef) 
2. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslogconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionProxyConfigurationDetailsTypeDef](./type_defs.md#awsecstaskdefinitionproxyconfigurationdetailstypedef) 
2. See [:material-code-braces: AwsEcsTaskDefinitionProxyConfigurationDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitionproxyconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsElasticBeanstalkEnvironmentDetailsTypeDef](./type_defs.md#awselasticbeanstalkenvironmentdetailstypedef) 
2. See [:material-code-braces: AwsElasticBeanstalkEnvironmentDetailsOutputTypeDef](./type_defs.md#awselasticbeanstalkenvironmentdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsElbLoadBalancerPoliciesTypeDef](./type_defs.md#awselbloadbalancerpoliciestypedef) 
2. See [:material-code-braces: AwsElbLoadBalancerPoliciesOutputTypeDef](./type_defs.md#awselbloadbalancerpoliciesoutputtypedef) 
...
1. See [:material-code-braces: AwsElbLoadBalancerAttributesTypeDef](./type_defs.md#awselbloadbalancerattributestypedef) 
2. See [:material-code-braces: AwsElbLoadBalancerAttributesOutputTypeDef](./type_defs.md#awselbloadbalancerattributesoutputtypedef) 
...
1. See [:material-code-braces: AwsElbLoadBalancerListenerDescriptionTypeDef](./type_defs.md#awselbloadbalancerlistenerdescriptiontypedef) 
2. See [:material-code-braces: AwsElbLoadBalancerListenerDescriptionOutputTypeDef](./type_defs.md#awselbloadbalancerlistenerdescriptionoutputtypedef) 
...
1. See [:material-code-braces: AwsElbv2LoadBalancerDetailsTypeDef](./type_defs.md#awselbv2loadbalancerdetailstypedef) 
2. See [:material-code-braces: AwsElbv2LoadBalancerDetailsOutputTypeDef](./type_defs.md#awselbv2loadbalancerdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsIamGroupDetailsTypeDef](./type_defs.md#awsiamgroupdetailstypedef) 
2. See [:material-code-braces: AwsIamGroupDetailsOutputTypeDef](./type_defs.md#awsiamgroupdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsIamInstanceProfileTypeDef](./type_defs.md#awsiaminstanceprofiletypedef) 
2. See [:material-code-braces: AwsIamInstanceProfileOutputTypeDef](./type_defs.md#awsiaminstanceprofileoutputtypedef) 
...
1. See [:material-code-braces: AwsIamPolicyDetailsTypeDef](./type_defs.md#awsiampolicydetailstypedef) 
2. See [:material-code-braces: AwsIamPolicyDetailsOutputTypeDef](./type_defs.md#awsiampolicydetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsIamUserDetailsTypeDef](./type_defs.md#awsiamuserdetailstypedef) 
2. See [:material-code-braces: AwsIamUserDetailsOutputTypeDef](./type_defs.md#awsiamuserdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsLambdaFunctionEnvironmentTypeDef](./type_defs.md#awslambdafunctionenvironmenttypedef) 
2. See [:material-code-braces: AwsLambdaFunctionEnvironmentOutputTypeDef](./type_defs.md#awslambdafunctionenvironmentoutputtypedef) 
...
1. See [:material-code-braces: AwsNetworkFirewallFirewallDetailsTypeDef](./type_defs.md#awsnetworkfirewallfirewalldetailstypedef) 
2. See [:material-code-braces: AwsNetworkFirewallFirewallDetailsOutputTypeDef](./type_defs.md#awsnetworkfirewallfirewalldetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsRdsDbClusterDetailsTypeDef](./type_defs.md#awsrdsdbclusterdetailstypedef) 
2. See [:material-code-braces: AwsRdsDbClusterDetailsOutputTypeDef](./type_defs.md#awsrdsdbclusterdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsRdsDbSnapshotDetailsTypeDef](./type_defs.md#awsrdsdbsnapshotdetailstypedef) 
2. See [:material-code-braces: AwsRdsDbSnapshotDetailsOutputTypeDef](./type_defs.md#awsrdsdbsnapshotdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsRdsDbSecurityGroupDetailsTypeDef](./type_defs.md#awsrdsdbsecuritygroupdetailstypedef) 
2. See [:material-code-braces: AwsRdsDbSecurityGroupDetailsOutputTypeDef](./type_defs.md#awsrdsdbsecuritygroupdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsRedshiftClusterClusterParameterGroupTypeDef](./type_defs.md#awsredshiftclusterclusterparametergrouptypedef) 
2. See [:material-code-braces: AwsRedshiftClusterClusterParameterGroupOutputTypeDef](./type_defs.md#awsredshiftclusterclusterparametergroupoutputtypedef) 
...
2. See [:material-code-braces: AwsS3BucketNotificationConfigurationS3KeyFilterOutputTypeDef](./type_defs.md#awss3bucketnotificationconfigurations3keyfilteroutputtypedef) 
...
1. See [:material-code-braces: AwsSageMakerNotebookInstanceDetailsTypeDef](./type_defs.md#awssagemakernotebookinstancedetailstypedef) 
2. See [:material-code-braces: AwsSageMakerNotebookInstanceDetailsOutputTypeDef](./type_defs.md#awssagemakernotebookinstancedetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsSnsTopicDetailsTypeDef](./type_defs.md#awssnstopicdetailstypedef) 
2. See [:material-code-braces: AwsSnsTopicDetailsOutputTypeDef](./type_defs.md#awssnstopicdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafRateBasedRuleDetailsTypeDef](./type_defs.md#awswafratebasedruledetailstypedef) 
2. See [:material-code-braces: AwsWafRateBasedRuleDetailsOutputTypeDef](./type_defs.md#awswafratebasedruledetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafRegionalRateBasedRuleDetailsTypeDef](./type_defs.md#awswafregionalratebasedruledetailstypedef) 
2. See [:material-code-braces: AwsWafRegionalRateBasedRuleDetailsOutputTypeDef](./type_defs.md#awswafregionalratebasedruledetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafRegionalRuleDetailsTypeDef](./type_defs.md#awswafregionalruledetailstypedef) 
2. See [:material-code-braces: AwsWafRegionalRuleDetailsOutputTypeDef](./type_defs.md#awswafregionalruledetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafRuleDetailsTypeDef](./type_defs.md#awswafruledetailstypedef) 
2. See [:material-code-braces: AwsWafRuleDetailsOutputTypeDef](./type_defs.md#awswafruledetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsWafWebAclRuleOutputTypeDef](./type_defs.md#awswafwebaclruleoutputtypedef) 
...
2. See [:material-code-braces: AwsWafv2CustomRequestHandlingDetailsOutputTypeDef](./type_defs.md#awswafv2customrequesthandlingdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsWafv2CustomResponseDetailsOutputTypeDef](./type_defs.md#awswafv2customresponsedetailsoutputtypedef) 
...
1. See [:material-code-braces: VulnerabilityCodeVulnerabilitiesTypeDef](./type_defs.md#vulnerabilitycodevulnerabilitiestypedef) 
2. See [:material-code-braces: VulnerabilityCodeVulnerabilitiesOutputTypeDef](./type_defs.md#vulnerabilitycodevulnerabilitiesoutputtypedef) 
...
1. See [:material-code-braces: ContainerDetailsTypeDef](./type_defs.md#containerdetailstypedef) 
2. See [:material-code-braces: ContainerDetailsOutputTypeDef](./type_defs.md#containerdetailsoutputtypedef) 
...
2. See [:material-code-braces: ThreatOutputTypeDef](./type_defs.md#threatoutputtypedef) 
...
1. See [:material-code-braces: FindingProviderFieldsTypeDef](./type_defs.md#findingproviderfieldstypedef) 
2. See [:material-code-braces: FindingProviderFieldsOutputTypeDef](./type_defs.md#findingproviderfieldsoutputtypedef) 
...
2. See [:material-code-braces: NetworkPathComponentDetailsOutputTypeDef](./type_defs.md#networkpathcomponentdetailsoutputtypedef) 
...
2. See [:material-code-braces: StatelessCustomPublishMetricActionOutputTypeDef](./type_defs.md#statelesscustompublishmetricactionoutputtypedef) 
...
2. See [:material-code-braces: AwsApiCallActionOutputTypeDef](./type_defs.md#awsapicallactionoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2RouteTableDetailsTypeDef](./type_defs.md#awsec2routetabledetailstypedef) 
2. See [:material-code-braces: AwsEc2RouteTableDetailsOutputTypeDef](./type_defs.md#awsec2routetabledetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsAmazonMqBrokerDetailsTypeDef](./type_defs.md#awsamazonmqbrokerdetailstypedef) 
2. See [:material-code-braces: AwsAmazonMqBrokerDetailsOutputTypeDef](./type_defs.md#awsamazonmqbrokerdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsApiGatewayStageDetailsTypeDef](./type_defs.md#awsapigatewaystagedetailstypedef) 
2. See [:material-code-braces: AwsApiGatewayStageDetailsOutputTypeDef](./type_defs.md#awsapigatewaystagedetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsApiGatewayRestApiDetailsTypeDef](./type_defs.md#awsapigatewayrestapidetailstypedef) 
2. See [:material-code-braces: AwsApiGatewayRestApiDetailsOutputTypeDef](./type_defs.md#awsapigatewayrestapidetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsAppSyncGraphQlApiDetailsTypeDef](./type_defs.md#awsappsyncgraphqlapidetailstypedef) 
2. See [:material-code-braces: AwsAppSyncGraphQlApiDetailsOutputTypeDef](./type_defs.md#awsappsyncgraphqlapidetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsAutoScalingLaunchConfigurationDetailsTypeDef](./type_defs.md#awsautoscalinglaunchconfigurationdetailstypedef) 
2. See [:material-code-braces: AwsAutoScalingLaunchConfigurationDetailsOutputTypeDef](./type_defs.md#awsautoscalinglaunchconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsBackupBackupPlanRuleDetailsTypeDef](./type_defs.md#awsbackupbackupplanruledetailstypedef) 
2. See [:material-code-braces: AwsBackupBackupPlanRuleDetailsOutputTypeDef](./type_defs.md#awsbackupbackupplanruledetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsBackupBackupVaultDetailsTypeDef](./type_defs.md#awsbackupbackupvaultdetailstypedef) 
2. See [:material-code-braces: AwsBackupBackupVaultDetailsOutputTypeDef](./type_defs.md#awsbackupbackupvaultdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsCertificateManagerCertificateRenewalSummaryTypeDef](./type_defs.md#awscertificatemanagercertificaterenewalsummarytypedef) 
2. See [:material-code-braces: AwsCertificateManagerCertificateRenewalSummaryOutputTypeDef](./type_defs.md#awscertificatemanagercertificaterenewalsummaryoutputtypedef) 
...
2. See [:material-code-braces: AwsCloudFrontDistributionOriginGroupFailoverOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupfailoveroutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginCustomOriginConfigTypeDef](./type_defs.md#awscloudfrontdistributionorigincustomoriginconfigtypedef) 
2. See [:material-code-braces: AwsCloudFrontDistributionOriginCustomOriginConfigOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigincustomoriginconfigoutputtypedef) 
...
1. See [:material-code-braces: AwsApiGatewayV2ApiDetailsTypeDef](./type_defs.md#awsapigatewayv2apidetailstypedef) 
2. See [:material-code-braces: AwsApiGatewayV2ApiDetailsOutputTypeDef](./type_defs.md#awsapigatewayv2apidetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsDynamoDbTableGlobalSecondaryIndexTypeDef](./type_defs.md#awsdynamodbtableglobalsecondaryindextypedef) 
2. See [:material-code-braces: AwsDynamoDbTableGlobalSecondaryIndexOutputTypeDef](./type_defs.md#awsdynamodbtableglobalsecondaryindexoutputtypedef) 
...
1. See [:material-code-braces: AwsDynamoDbTableLocalSecondaryIndexTypeDef](./type_defs.md#awsdynamodbtablelocalsecondaryindextypedef) 
2. See [:material-code-braces: AwsDynamoDbTableLocalSecondaryIndexOutputTypeDef](./type_defs.md#awsdynamodbtablelocalsecondaryindexoutputtypedef) 
...
1. See [:material-code-braces: AwsDynamoDbTableReplicaTypeDef](./type_defs.md#awsdynamodbtablereplicatypedef) 
2. See [:material-code-braces: AwsDynamoDbTableReplicaOutputTypeDef](./type_defs.md#awsdynamodbtablereplicaoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2ClientVpnEndpointDetailsTypeDef](./type_defs.md#awsec2clientvpnendpointdetailstypedef) 
2. See [:material-code-braces: AwsEc2ClientVpnEndpointDetailsOutputTypeDef](./type_defs.md#awsec2clientvpnendpointdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2NetworkAclDetailsTypeDef](./type_defs.md#awsec2networkacldetailstypedef) 
2. See [:material-code-braces: AwsEc2NetworkAclDetailsOutputTypeDef](./type_defs.md#awsec2networkacldetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2VpnConnectionOptionsDetailsTypeDef](./type_defs.md#awsec2vpnconnectionoptionsdetailstypedef) 
2. See [:material-code-braces: AwsEc2VpnConnectionOptionsDetailsOutputTypeDef](./type_defs.md#awsec2vpnconnectionoptionsdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsServiceNetworkConfigurationDetailsTypeDef](./type_defs.md#awsecsservicenetworkconfigurationdetailstypedef) 
2. See [:material-code-braces: AwsEcsServiceNetworkConfigurationDetailsOutputTypeDef](./type_defs.md#awsecsservicenetworkconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparametersdetailstypedef) 
2. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparametersdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionVolumesDetailsTypeDef](./type_defs.md#awsecstaskdefinitionvolumesdetailstypedef) 
2. See [:material-code-braces: AwsEcsTaskDefinitionVolumesDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitionvolumesdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEfsAccessPointDetailsTypeDef](./type_defs.md#awsefsaccesspointdetailstypedef) 
2. See [:material-code-braces: AwsEfsAccessPointDetailsOutputTypeDef](./type_defs.md#awsefsaccesspointdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEksClusterLoggingDetailsTypeDef](./type_defs.md#awseksclusterloggingdetailstypedef) 
2. See [:material-code-braces: AwsEksClusterLoggingDetailsOutputTypeDef](./type_defs.md#awseksclusterloggingdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsElasticsearchDomainDetailsTypeDef](./type_defs.md#awselasticsearchdomaindetailstypedef) 
2. See [:material-code-braces: AwsElasticsearchDomainDetailsOutputTypeDef](./type_defs.md#awselasticsearchdomaindetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationdetailstypedef) 
2. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationDetailsOutputTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsOpenSearchServiceDomainDetailsTypeDef](./type_defs.md#awsopensearchservicedomaindetailstypedef) 
2. See [:material-code-braces: AwsOpenSearchServiceDomainDetailsOutputTypeDef](./type_defs.md#awsopensearchservicedomaindetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsRdsDbClusterSnapshotDetailsTypeDef](./type_defs.md#awsrdsdbclustersnapshotdetailstypedef) 
2. See [:material-code-braces: AwsRdsDbClusterSnapshotDetailsOutputTypeDef](./type_defs.md#awsrdsdbclustersnapshotdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsRdsDbSubnetGroupTypeDef](./type_defs.md#awsrdsdbsubnetgrouptypedef) 
2. See [:material-code-braces: AwsRdsDbSubnetGroupOutputTypeDef](./type_defs.md#awsrdsdbsubnetgroupoutputtypedef) 
...
1. See [:material-code-braces: AwsRdsDbPendingModifiedValuesTypeDef](./type_defs.md#awsrdsdbpendingmodifiedvaluestypedef) 
2. See [:material-code-braces: AwsRdsDbPendingModifiedValuesOutputTypeDef](./type_defs.md#awsrdsdbpendingmodifiedvaluesoutputtypedef) 
...
1. See [:material-code-braces: AwsRoute53HostedZoneDetailsTypeDef](./type_defs.md#awsroute53hostedzonedetailstypedef) 
2. See [:material-code-braces: AwsRoute53HostedZoneDetailsOutputTypeDef](./type_defs.md#awsroute53hostedzonedetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateDetailsOutputTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesfilterpredicatedetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsS3BucketServerSideEncryptionConfigurationOutputTypeDef](./type_defs.md#awss3bucketserversideencryptionconfigurationoutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketWebsiteConfigurationTypeDef](./type_defs.md#awss3bucketwebsiteconfigurationtypedef) 
2. See [:material-code-braces: AwsS3BucketWebsiteConfigurationOutputTypeDef](./type_defs.md#awss3bucketwebsiteconfigurationoutputtypedef) 
...
2. See [:material-code-braces: AwsStepFunctionStateMachineLoggingConfigurationDetailsOutputTypeDef](./type_defs.md#awsstepfunctionstatemachineloggingconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafRegionalRuleGroupDetailsTypeDef](./type_defs.md#awswafregionalrulegroupdetailstypedef) 
2. See [:material-code-braces: AwsWafRegionalRuleGroupDetailsOutputTypeDef](./type_defs.md#awswafregionalrulegroupdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafRegionalWebAclDetailsTypeDef](./type_defs.md#awswafregionalwebacldetailstypedef) 
2. See [:material-code-braces: AwsWafRegionalWebAclDetailsOutputTypeDef](./type_defs.md#awswafregionalwebacldetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafRuleGroupDetailsTypeDef](./type_defs.md#awswafrulegroupdetailstypedef) 
2. See [:material-code-braces: AwsWafRuleGroupDetailsOutputTypeDef](./type_defs.md#awswafrulegroupdetailsoutputtypedef) 
...
2. See [:material-code-braces: AutomationRulesFindingFiltersOutputTypeDef](./type_defs.md#automationrulesfindingfiltersoutputtypedef) 
...
1. See [:material-code-braces: SignalTypeDef](./type_defs.md#signaltypedef) 
2. See [:material-code-braces: SignalOutputTypeDef](./type_defs.md#signaloutputtypedef) 
...
2. See [:material-code-braces: OccurrencesOutputTypeDef](./type_defs.md#occurrencesoutputtypedef) 
...
1. See [:material-code-braces: ParameterConfigurationTypeDef](./type_defs.md#parameterconfigurationtypedef) 
2. See [:material-code-braces: ParameterConfigurationOutputTypeDef](./type_defs.md#parameterconfigurationoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceStatefulRulesDetailsTypeDef](./type_defs.md#rulegroupsourcestatefulrulesdetailstypedef) 
2. See [:material-code-braces: RuleGroupSourceStatefulRulesDetailsOutputTypeDef](./type_defs.md#rulegroupsourcestatefulrulesdetailsoutputtypedef) 
...
2. See [:material-code-braces: RuleGroupSourceStatelessRuleMatchAttributesOutputTypeDef](./type_defs.md#rulegroupsourcestatelessrulematchattributesoutputtypedef) 
...
2. See [:material-code-braces: RuleGroupVariablesOutputTypeDef](./type_defs.md#rulegroupvariablesoutputtypedef) 
...
2. See [:material-code-braces: ComplianceOutputTypeDef](./type_defs.md#complianceoutputtypedef) 
...
1. See [:material-code-braces: PortProbeActionTypeDef](./type_defs.md#portprobeactiontypedef) 
2. See [:material-code-braces: PortProbeActionOutputTypeDef](./type_defs.md#portprobeactionoutputtypedef) 
...
1. See [:material-code-braces: AutomationRulesActionTypeDef](./type_defs.md#automationrulesactiontypedef) 
2. See [:material-code-braces: AutomationRulesActionOutputTypeDef](./type_defs.md#automationrulesactionoutputtypedef) 
...
2. See [:material-code-braces: AwsAutoScalingAutoScalingGroupMixedInstancesPolicyDetailsOutputTypeDef](./type_defs.md#awsautoscalingautoscalinggroupmixedinstancespolicydetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsCodeBuildProjectDetailsTypeDef](./type_defs.md#awscodebuildprojectdetailstypedef) 
2. See [:material-code-braces: AwsCodeBuildProjectDetailsOutputTypeDef](./type_defs.md#awscodebuildprojectdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsEc2LaunchTemplateDataDetailsOutputTypeDef](./type_defs.md#awsec2launchtemplatedatadetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2SecurityGroupDetailsTypeDef](./type_defs.md#awsec2securitygroupdetailstypedef) 
2. See [:material-code-braces: AwsEc2SecurityGroupDetailsOutputTypeDef](./type_defs.md#awsec2securitygroupdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2VpcPeeringConnectionDetailsTypeDef](./type_defs.md#awsec2vpcpeeringconnectiondetailstypedef) 
2. See [:material-code-braces: AwsEc2VpcPeeringConnectionDetailsOutputTypeDef](./type_defs.md#awsec2vpcpeeringconnectiondetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsClusterDetailsTypeDef](./type_defs.md#awsecsclusterdetailstypedef) 
2. See [:material-code-braces: AwsEcsClusterDetailsOutputTypeDef](./type_defs.md#awsecsclusterdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDetailsTypeDef](./type_defs.md#awsecstaskdetailstypedef) 
2. See [:material-code-braces: AwsEcsTaskDetailsOutputTypeDef](./type_defs.md#awsecstaskdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsElbLoadBalancerDetailsTypeDef](./type_defs.md#awselbloadbalancerdetailstypedef) 
2. See [:material-code-braces: AwsElbLoadBalancerDetailsOutputTypeDef](./type_defs.md#awselbloadbalancerdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEventsEndpointDetailsTypeDef](./type_defs.md#awseventsendpointdetailstypedef) 
2. See [:material-code-braces: AwsEventsEndpointDetailsOutputTypeDef](./type_defs.md#awseventsendpointdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsIamRoleDetailsTypeDef](./type_defs.md#awsiamroledetailstypedef) 
2. See [:material-code-braces: AwsIamRoleDetailsOutputTypeDef](./type_defs.md#awsiamroledetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsLambdaFunctionDetailsTypeDef](./type_defs.md#awslambdafunctiondetailstypedef) 
2. See [:material-code-braces: AwsLambdaFunctionDetailsOutputTypeDef](./type_defs.md#awslambdafunctiondetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsRedshiftClusterDetailsTypeDef](./type_defs.md#awsredshiftclusterdetailstypedef) 
2. See [:material-code-braces: AwsRedshiftClusterDetailsOutputTypeDef](./type_defs.md#awsredshiftclusterdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsS3BucketNotificationConfigurationFilterOutputTypeDef](./type_defs.md#awss3bucketnotificationconfigurationfilteroutputtypedef) 
...
1. See [:material-code-braces: AwsWafWebAclDetailsTypeDef](./type_defs.md#awswafwebacldetailstypedef) 
2. See [:material-code-braces: AwsWafWebAclDetailsOutputTypeDef](./type_defs.md#awswafwebacldetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsWafv2ActionAllowDetailsOutputTypeDef](./type_defs.md#awswafv2actionallowdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2RulesActionCaptchaDetailsTypeDef](./type_defs.md#awswafv2rulesactioncaptchadetailstypedef) 
2. See [:material-code-braces: AwsWafv2RulesActionCaptchaDetailsOutputTypeDef](./type_defs.md#awswafv2rulesactioncaptchadetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2RulesActionCountDetailsTypeDef](./type_defs.md#awswafv2rulesactioncountdetailstypedef) 
2. See [:material-code-braces: AwsWafv2RulesActionCountDetailsOutputTypeDef](./type_defs.md#awswafv2rulesactioncountdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2ActionBlockDetailsTypeDef](./type_defs.md#awswafv2actionblockdetailstypedef) 
2. See [:material-code-braces: AwsWafv2ActionBlockDetailsOutputTypeDef](./type_defs.md#awswafv2actionblockdetailsoutputtypedef) 
...
2. See [:material-code-braces: VulnerabilityOutputTypeDef](./type_defs.md#vulnerabilityoutputtypedef) 
...
2. See [:material-code-braces: NetworkHeaderOutputTypeDef](./type_defs.md#networkheaderoutputtypedef) 
...
2. See [:material-code-braces: StatelessCustomActionDefinitionOutputTypeDef](./type_defs.md#statelesscustomactiondefinitionoutputtypedef) 
...
2. See [:material-code-braces: AwsBackupBackupPlanBackupPlanDetailsOutputTypeDef](./type_defs.md#awsbackupbackupplanbackupplandetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsCertificateManagerCertificateDetailsTypeDef](./type_defs.md#awscertificatemanagercertificatedetailstypedef) 
2. See [:material-code-braces: AwsCertificateManagerCertificateDetailsOutputTypeDef](./type_defs.md#awscertificatemanagercertificatedetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsCloudFrontDistributionOriginGroupOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupoutputtypedef) 
...
2. See [:material-code-braces: AwsCloudFrontDistributionOriginItemOutputTypeDef](./type_defs.md#awscloudfrontdistributionoriginitemoutputtypedef) 
...
1. See [:material-code-braces: AwsDynamoDbTableDetailsTypeDef](./type_defs.md#awsdynamodbtabledetailstypedef) 
2. See [:material-code-braces: AwsDynamoDbTableDetailsOutputTypeDef](./type_defs.md#awsdynamodbtabledetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2VpnConnectionDetailsTypeDef](./type_defs.md#awsec2vpnconnectiondetailstypedef) 
2. See [:material-code-braces: AwsEc2VpnConnectionDetailsOutputTypeDef](./type_defs.md#awsec2vpnconnectiondetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsServiceDetailsTypeDef](./type_defs.md#awsecsservicedetailstypedef) 
2. See [:material-code-braces: AwsEcsServiceDetailsOutputTypeDef](./type_defs.md#awsecsservicedetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEksClusterDetailsTypeDef](./type_defs.md#awseksclusterdetailstypedef) 
2. See [:material-code-braces: AwsEksClusterDetailsOutputTypeDef](./type_defs.md#awseksclusterdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsGuardDutyDetectorDetailsTypeDef](./type_defs.md#awsguarddutydetectordetailstypedef) 
2. See [:material-code-braces: AwsGuardDutyDetectorDetailsOutputTypeDef](./type_defs.md#awsguarddutydetectordetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsMskClusterClusterInfoDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfodetailstypedef) 
2. See [:material-code-braces: AwsMskClusterClusterInfoDetailsOutputTypeDef](./type_defs.md#awsmskclusterclusterinfodetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsRdsDbInstanceDetailsTypeDef](./type_defs.md#awsrdsdbinstancedetailstypedef) 
2. See [:material-code-braces: AwsRdsDbInstanceDetailsOutputTypeDef](./type_defs.md#awsrdsdbinstancedetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesFilterDetailsTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesfilterdetailstypedef) 
2. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesFilterDetailsOutputTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesfilterdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsStepFunctionStateMachineDetailsTypeDef](./type_defs.md#awsstepfunctionstatemachinedetailstypedef) 
2. See [:material-code-braces: AwsStepFunctionStateMachineDetailsOutputTypeDef](./type_defs.md#awsstepfunctionstatemachinedetailsoutputtypedef) 
...
1. See [:material-code-braces: SequenceTypeDef](./type_defs.md#sequencetypedef) 
2. See [:material-code-braces: SequenceOutputTypeDef](./type_defs.md#sequenceoutputtypedef) 
...
2. See [:material-code-braces: CustomDataIdentifiersDetectionsOutputTypeDef](./type_defs.md#customdataidentifiersdetectionsoutputtypedef) 
...
2. See [:material-code-braces: SensitiveDataDetectionsOutputTypeDef](./type_defs.md#sensitivedatadetectionsoutputtypedef) 
...
1. See [:material-code-braces: SecurityControlCustomParameterTypeDef](./type_defs.md#securitycontrolcustomparametertypedef) 
2. See [:material-code-braces: SecurityControlCustomParameterOutputTypeDef](./type_defs.md#securitycontrolcustomparameteroutputtypedef) 
...
2. See [:material-code-braces: RuleGroupSourceStatelessRuleDefinitionOutputTypeDef](./type_defs.md#rulegroupsourcestatelessruledefinitionoutputtypedef) 
...
2. See [:material-code-braces: AwsAutoScalingAutoScalingGroupDetailsOutputTypeDef](./type_defs.md#awsautoscalingautoscalinggroupdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2LaunchTemplateDetailsTypeDef](./type_defs.md#awsec2launchtemplatedetailstypedef) 
2. See [:material-code-braces: AwsEc2LaunchTemplateDetailsOutputTypeDef](./type_defs.md#awsec2launchtemplatedetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsS3BucketNotificationConfigurationDetailOutputTypeDef](./type_defs.md#awss3bucketnotificationconfigurationdetailoutputtypedef) 
...
2. See [:material-code-braces: AwsWafv2RulesActionDetailsOutputTypeDef](./type_defs.md#awswafv2rulesactiondetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2WebAclActionDetailsTypeDef](./type_defs.md#awswafv2webaclactiondetailstypedef) 
2. See [:material-code-braces: AwsWafv2WebAclActionDetailsOutputTypeDef](./type_defs.md#awswafv2webaclactiondetailsoutputtypedef) 
...
1. See [:material-code-braces: NetworkPathComponentTypeDef](./type_defs.md#networkpathcomponenttypedef) 
2. See [:material-code-braces: NetworkPathComponentOutputTypeDef](./type_defs.md#networkpathcomponentoutputtypedef) 
...
1. See [:material-code-braces: FirewallPolicyStatelessCustomActionsDetailsTypeDef](./type_defs.md#firewallpolicystatelesscustomactionsdetailstypedef) 
2. See [:material-code-braces: FirewallPolicyStatelessCustomActionsDetailsOutputTypeDef](./type_defs.md#firewallpolicystatelesscustomactionsdetailsoutputtypedef) 
...
2. See [:material-code-braces: RuleGroupSourceCustomActionsDetailsOutputTypeDef](./type_defs.md#rulegroupsourcecustomactionsdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsBackupBackupPlanDetailsTypeDef](./type_defs.md#awsbackupbackupplandetailstypedef) 
2. See [:material-code-braces: AwsBackupBackupPlanDetailsOutputTypeDef](./type_defs.md#awsbackupbackupplandetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginGroupsTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupstypedef) 
2. See [:material-code-braces: AwsCloudFrontDistributionOriginGroupsOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupsoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginsTypeDef](./type_defs.md#awscloudfrontdistributionoriginstypedef) 
2. See [:material-code-braces: AwsCloudFrontDistributionOriginsOutputTypeDef](./type_defs.md#awscloudfrontdistributionoriginsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionDetailsTypeDef](./type_defs.md#awsecstaskdefinitiondetailstypedef) 
2. See [:material-code-braces: AwsEcsTaskDefinitionDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitiondetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsMskClusterDetailsTypeDef](./type_defs.md#awsmskclusterdetailstypedef) 
2. See [:material-code-braces: AwsMskClusterDetailsOutputTypeDef](./type_defs.md#awsmskclusterdetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesDetailsOutputTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesdetailsoutputtypedef) 
...
2. See [:material-code-braces: DetectionOutputTypeDef](./type_defs.md#detectionoutputtypedef) 
...
1. See [:material-code-braces: CustomDataIdentifiersResultTypeDef](./type_defs.md#customdataidentifiersresulttypedef) 
2. See [:material-code-braces: CustomDataIdentifiersResultOutputTypeDef](./type_defs.md#customdataidentifiersresultoutputtypedef) 
...
1. See [:material-code-braces: SensitiveDataResultTypeDef](./type_defs.md#sensitivedataresulttypedef) 
2. See [:material-code-braces: SensitiveDataResultOutputTypeDef](./type_defs.md#sensitivedataresultoutputtypedef) 
...
1. See [:material-code-braces: SecurityControlsConfigurationTypeDef](./type_defs.md#securitycontrolsconfigurationtypedef) 
2. See [:material-code-braces: SecurityControlsConfigurationOutputTypeDef](./type_defs.md#securitycontrolsconfigurationoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceStatelessRulesDetailsTypeDef](./type_defs.md#rulegroupsourcestatelessrulesdetailstypedef) 
2. See [:material-code-braces: RuleGroupSourceStatelessRulesDetailsOutputTypeDef](./type_defs.md#rulegroupsourcestatelessrulesdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketNotificationConfigurationTypeDef](./type_defs.md#awss3bucketnotificationconfigurationtypedef) 
2. See [:material-code-braces: AwsS3BucketNotificationConfigurationOutputTypeDef](./type_defs.md#awss3bucketnotificationconfigurationoutputtypedef) 
...
2. See [:material-code-braces: AwsWafv2RulesDetailsOutputTypeDef](./type_defs.md#awswafv2rulesdetailsoutputtypedef) 
...
2. See [:material-code-braces: FirewallPolicyDetailsOutputTypeDef](./type_defs.md#firewallpolicydetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionDetailsTypeDef](./type_defs.md#awscloudfrontdistributiondetailstypedef) 
2. See [:material-code-braces: AwsCloudFrontDistributionDetailsOutputTypeDef](./type_defs.md#awscloudfrontdistributiondetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationDetailsTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationdetailstypedef) 
2. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationDetailsOutputTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2RuleGroupDetailsTypeDef](./type_defs.md#awswafv2rulegroupdetailstypedef) 
2. See [:material-code-braces: AwsWafv2RuleGroupDetailsOutputTypeDef](./type_defs.md#awswafv2rulegroupdetailsoutputtypedef) 
...
2. See [:material-code-braces: ClassificationResultOutputTypeDef](./type_defs.md#classificationresultoutputtypedef) 
...
1. See [:material-code-braces: SecurityHubPolicyTypeDef](./type_defs.md#securityhubpolicytypedef) 
2. See [:material-code-braces: SecurityHubPolicyOutputTypeDef](./type_defs.md#securityhubpolicyoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceStatelessRulesAndCustomActionsDetailsTypeDef](./type_defs.md#rulegroupsourcestatelessrulesandcustomactionsdetailstypedef) 
2. See [:material-code-braces: RuleGroupSourceStatelessRulesAndCustomActionsDetailsOutputTypeDef](./type_defs.md#rulegroupsourcestatelessrulesandcustomactionsdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2WebAclDetailsTypeDef](./type_defs.md#awswafv2webacldetailstypedef) 
2. See [:material-code-braces: AwsWafv2WebAclDetailsOutputTypeDef](./type_defs.md#awswafv2webacldetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsNetworkFirewallFirewallPolicyDetailsTypeDef](./type_defs.md#awsnetworkfirewallfirewallpolicydetailstypedef) 
2. See [:material-code-braces: AwsNetworkFirewallFirewallPolicyDetailsOutputTypeDef](./type_defs.md#awsnetworkfirewallfirewallpolicydetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketDetailsTypeDef](./type_defs.md#awss3bucketdetailstypedef) 
2. See [:material-code-braces: AwsS3BucketDetailsOutputTypeDef](./type_defs.md#awss3bucketdetailsoutputtypedef) 
...
1. See [:material-code-braces: DataClassificationDetailsTypeDef](./type_defs.md#dataclassificationdetailstypedef) 
2. See [:material-code-braces: DataClassificationDetailsOutputTypeDef](./type_defs.md#dataclassificationdetailsoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceTypeDef](./type_defs.md#rulegroupsourcetypedef) 
2. See [:material-code-braces: RuleGroupSourceOutputTypeDef](./type_defs.md#rulegroupsourceoutputtypedef) 
...
2. See [:material-code-braces: RuleGroupDetailsOutputTypeDef](./type_defs.md#rulegroupdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsNetworkFirewallRuleGroupDetailsTypeDef](./type_defs.md#awsnetworkfirewallrulegroupdetailstypedef) 
2. See [:material-code-braces: AwsNetworkFirewallRuleGroupDetailsOutputTypeDef](./type_defs.md#awsnetworkfirewallrulegroupdetailsoutputtypedef) 
...
2. See [:material-code-braces: ResourceDetailsOutputTypeDef](./type_defs.md#resourcedetailsoutputtypedef) 
...
2. See [:material-code-braces: AwsSecurityFindingOutputTypeDef](./type_defs.md#awssecurityfindingoutputtypedef) 
...
1. See [:material-code-brackets: ActorSessionMfaStatusType](./literals.md#actorsessionmfastatustype) 
## UserAccountTypeDef
...
2. See [:material-code-brackets: ConfigurationPolicyAssociationStatusType](./literals.md#configurationpolicyassociationstatustype) 
...
3. See [:material-code-brackets: ConfigurationPolicyAssociationStatusType](./literals.md#configurationpolicyassociationstatustype) 
...
1. See [:material-code-brackets: OrganizationConfigurationConfigurationTypeType](./literals.md#organizationconfigurationconfigurationtypetype) 
2. See [:material-code-brackets: OrganizationConfigurationStatusType](./literals.md#organizationconfigurationstatustype) 
...
1. See [:material-code-brackets: ConnectionDirectionType](./literals.md#connectiondirectiontype) 
...
1. See [:material-code-braces: UserAccountTypeDef](./type_defs.md#useraccounttypedef) 
## CvssOutputTypeDef
...
1. See [:material-code-braces: AwsApiGatewayEndpointConfigurationOutputTypeDef](./type_defs.md#awsapigatewayendpointconfigurationoutputtypedef) 
...
3. See [:material-code-braces: AwsApiGatewayCanarySettingsOutputTypeDef](./type_defs.md#awsapigatewaycanarysettingsoutputtypedef) 
...
1. See [:material-code-braces: AwsCorsConfigurationOutputTypeDef](./type_defs.md#awscorsconfigurationoutputtypedef) 
...
1. See [:material-code-braces: AwsBackupBackupVaultNotificationsDetailsOutputTypeDef](./type_defs.md#awsbackupbackupvaultnotificationsdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginSslProtocolsOutputTypeDef](./type_defs.md#awscloudfrontdistributionoriginsslprotocolsoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginGroupFailoverStatusCodesOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupfailoverstatuscodesoutputtypedef) 
...
1. See [:material-code-braces: AwsDmsReplicationInstanceReplicationSubnetGroupDetailsTypeDef](./type_defs.md#awsdmsreplicationinstancereplicationsubnetgroupdetailstypedef) 
2. See [:material-code-braces: AwsDmsReplicationInstanceVpcSecurityGroupsDetailsTypeDef](./type_defs.md#awsdmsreplicationinstancevpcsecuritygroupsdetailstypedef) 
...
1. See [:material-code-braces: AwsEc2ClientVpnEndpointAuthenticationOptionsActiveDirectoryDetailsTypeDef](./type_defs.md#awsec2clientvpnendpointauthenticationoptionsactivedirectorydetailstypedef) 
2. See [:material-code-braces: AwsEc2ClientVpnEndpointAuthenticationOptionsMutualAuthenticationDetailsTypeDef](./type_defs.md#awsec2clientvpnendpointauthenticationoptionsmutualauthenticationdetailstypedef) 
3. See [:material-code-braces: AwsEc2ClientVpnEndpointAuthenticationOptionsFederatedAuthenticationDetailsTypeDef](./type_defs.md#awsec2clientvpnendpointauthenticationoptionsfederatedauthenticationdetailstypedef) 
...
1. See [:material-code-braces: AwsEc2ClientVpnEndpointClientConnectOptionsStatusDetailsTypeDef](./type_defs.md#awsec2clientvpnendpointclientconnectoptionsstatusdetailstypedef) 
...
1. See [:material-code-braces: AwsEc2VpnConnectionOptionsTunnelOptionsDetailsOutputTypeDef](./type_defs.md#awsec2vpnconnectionoptionstunneloptionsdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsServiceNetworkConfigurationAwsVpcConfigurationDetailsOutputTypeDef](./type_defs.md#awsecsservicenetworkconfigurationawsvpcconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersCapabilitiesDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparameterscapabilitiesdetailsoutputtypedef) 
2. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparametersdevicesdetailsoutputtypedef) 
3. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersTmpfsDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparameterstmpfsdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEksClusterLoggingClusterLoggingDetailsOutputTypeDef](./type_defs.md#awseksclusterloggingclusterloggingdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEventsEndpointRoutingConfigFailoverConfigPrimaryDetailsTypeDef](./type_defs.md#awseventsendpointroutingconfigfailoverconfigprimarydetailstypedef) 
2. See [:material-code-braces: AwsEventsEndpointRoutingConfigFailoverConfigSecondaryDetailsTypeDef](./type_defs.md#awseventsendpointroutingconfigfailoverconfigsecondarydetailstypedef) 
...
1. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationSaslIamDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationsasliamdetailstypedef) 
2. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationSaslScramDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationsaslscramdetailstypedef) 
...
1. See [:material-code-braces: AwsMskClusterClusterInfoEncryptionInfoEncryptionInTransitDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoencryptioninfoencryptionintransitdetailstypedef) 
2. See [:material-code-braces: AwsMskClusterClusterInfoEncryptionInfoEncryptionAtRestDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoencryptioninfoencryptionatrestdetailstypedef) 
...
1. See [:material-code-braces: AwsRdsDbClusterSnapshotDbClusterSnapshotAttributeOutputTypeDef](./type_defs.md#awsrdsdbclustersnapshotdbclustersnapshotattributeoutputtypedef) 
...
1. See [:material-code-braces: AwsRdsPendingCloudWatchLogsExportsOutputTypeDef](./type_defs.md#awsrdspendingcloudwatchlogsexportsoutputtypedef) 
...
1. See [:material-code-braces: AwsRoute53HostedZoneConfigDetailsTypeDef](./type_defs.md#awsroute53hostedzoneconfigdetailstypedef) 
...
1. See [:material-code-braces: CloudWatchLogsLogGroupArnConfigDetailsTypeDef](./type_defs.md#cloudwatchlogsloggrouparnconfigdetailstypedef) 
...
1. See [:material-code-braces: AwsS3AccountPublicAccessBlockDetailsTypeDef](./type_defs.md#awss3accountpublicaccessblockdetailstypedef) 
2. See [:material-code-braces: AwsS3AccessPointVpcConfigurationDetailsTypeDef](./type_defs.md#awss3accesspointvpcconfigurationdetailstypedef) 
...
1. See [:material-code-braces: ConfigurationPolicyAssociationSummaryTypeDef](./type_defs.md#configurationpolicyassociationsummarytypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
1. See [:material-code-braces: CodeVulnerabilitiesFilePathTypeDef](./type_defs.md#codevulnerabilitiesfilepathtypedef) 
...
4. See [:material-code-braces: SecurityControlParameterOutputTypeDef](./type_defs.md#securitycontrolparameteroutputtypedef) 
...
1. See [:material-code-braces: IntegerConfigurationOptionsTypeDef](./type_defs.md#integerconfigurationoptionstypedef) 
2. See [:material-code-braces: IntegerListConfigurationOptionsTypeDef](./type_defs.md#integerlistconfigurationoptionstypedef) 
3. See [:material-code-braces: DoubleConfigurationOptionsTypeDef](./type_defs.md#doubleconfigurationoptionstypedef) 
4. See [:material-code-braces: StringConfigurationOptionsTypeDef](./type_defs.md#stringconfigurationoptionstypedef) 
5. See [:material-code-braces: StringListConfigurationOptionsTypeDef](./type_defs.md#stringlistconfigurationoptionstypedef) 
6. See [:material-code-braces: BooleanConfigurationOptionsTypeDef](./type_defs.md#booleanconfigurationoptionstypedef) 
7. See [:material-code-braces: EnumConfigurationOptionsTypeDef](./type_defs.md#enumconfigurationoptionstypedef) 
8. See [:material-code-braces: EnumListConfigurationOptionsTypeDef](./type_defs.md#enumlistconfigurationoptionstypedef) 
...
1. See [:material-code-braces: ConfigurationPolicySummaryTypeDef](./type_defs.md#configurationpolicysummarytypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
1. See [:material-code-braces: IndicatorOutputTypeDef](./type_defs.md#indicatoroutputtypedef) 
...
2. See [:material-code-braces: NetworkAutonomousSystemTypeDef](./type_defs.md#networkautonomoussystemtypedef) 
...
5. See [:material-code-braces: RuleGroupSourceStatelessRuleMatchAttributesTcpFlagsOutputTypeDef](./type_defs.md#rulegroupsourcestatelessrulematchattributestcpflagsoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupVariablesIpSetsDetailsOutputTypeDef](./type_defs.md#rulegroupvariablesipsetsdetailsoutputtypedef) 
2. See [:material-code-braces: RuleGroupVariablesPortSetsDetailsOutputTypeDef](./type_defs.md#rulegroupvariablesportsetsdetailsoutputtypedef) 
## StandardTypeDef
...
1. See [:material-code-braces: ActorUserTypeDef](./type_defs.md#actorusertypedef) 
2. See [:material-code-braces: ActorSessionTypeDef](./type_defs.md#actorsessiontypedef) 
...
1. See [:material-code-braces: AwsAmazonMqBrokerEncryptionOptionsDetailsTypeDef](./type_defs.md#awsamazonmqbrokerencryptionoptionsdetailstypedef) 
2. See [:material-code-braces: AwsAmazonMqBrokerLdapServerMetadataDetailsTypeDef](./type_defs.md#awsamazonmqbrokerldapservermetadatadetailstypedef) [:material-code-braces: AwsAmazonMqBrokerLdapServerMetadataDetailsOutputTypeDef](./type_defs.md#awsamazonmqbrokerldapservermetadatadetailsoutputtypedef) 
3. See [:material-code-braces: AwsAmazonMqBrokerLogsDetailsTypeDef](./type_defs.md#awsamazonmqbrokerlogsdetailstypedef) 
4. See [:material-code-braces: AwsAmazonMqBrokerMaintenanceWindowStartTimeDetailsTypeDef](./type_defs.md#awsamazonmqbrokermaintenancewindowstarttimedetailstypedef) 
5. See [:material-code-braces: AwsAmazonMqBrokerUsersDetailsTypeDef](./type_defs.md#awsamazonmqbrokerusersdetailstypedef) 
...
1. See [:material-code-braces: AwsApiGatewayMethodSettingsTypeDef](./type_defs.md#awsapigatewaymethodsettingstypedef) 
2. See [:material-code-braces: AwsApiGatewayAccessLogSettingsTypeDef](./type_defs.md#awsapigatewayaccesslogsettingstypedef) 
3. See [:material-code-braces: AwsApiGatewayCanarySettingsTypeDef](./type_defs.md#awsapigatewaycanarysettingstypedef) [:material-code-braces: AwsApiGatewayCanarySettingsOutputTypeDef](./type_defs.md#awsapigatewaycanarysettingsoutputtypedef) 
...
1. See [:material-code-braces: AwsApiGatewayEndpointConfigurationTypeDef](./type_defs.md#awsapigatewayendpointconfigurationtypedef) [:material-code-braces: AwsApiGatewayEndpointConfigurationOutputTypeDef](./type_defs.md#awsapigatewayendpointconfigurationoutputtypedef) 
...
1. See [:material-code-braces: AwsBackupBackupVaultNotificationsDetailsTypeDef](./type_defs.md#awsbackupbackupvaultnotificationsdetailstypedef) [:material-code-braces: AwsBackupBackupVaultNotificationsDetailsOutputTypeDef](./type_defs.md#awsbackupbackupvaultnotificationsdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsCertificateManagerCertificateDomainValidationOptionOutputTypeDef](./type_defs.md#awscertificatemanagercertificatedomainvalidationoptionoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginGroupFailoverOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupfailoveroutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginGroupFailoverStatusCodesTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupfailoverstatuscodestypedef) [:material-code-braces: AwsCloudFrontDistributionOriginGroupFailoverStatusCodesOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupfailoverstatuscodesoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginSslProtocolsTypeDef](./type_defs.md#awscloudfrontdistributionoriginsslprotocolstypedef) [:material-code-braces: AwsCloudFrontDistributionOriginSslProtocolsOutputTypeDef](./type_defs.md#awscloudfrontdistributionoriginsslprotocolsoutputtypedef) 
...
5. See [:material-code-braces: AwsCodeBuildProjectVpcConfigOutputTypeDef](./type_defs.md#awscodebuildprojectvpcconfigoutputtypedef) 
...
1. See [:material-code-braces: AwsCorsConfigurationTypeDef](./type_defs.md#awscorsconfigurationtypedef) [:material-code-braces: AwsCorsConfigurationOutputTypeDef](./type_defs.md#awscorsconfigurationoutputtypedef) 
...
1. See [:material-code-braces: AwsDynamoDbTableKeySchemaTypeDef](./type_defs.md#awsdynamodbtablekeyschematypedef) 
2. See [:material-code-braces: AwsDynamoDbTableProjectionTypeDef](./type_defs.md#awsdynamodbtableprojectiontypedef) [:material-code-braces: AwsDynamoDbTableProjectionOutputTypeDef](./type_defs.md#awsdynamodbtableprojectionoutputtypedef) 
3. See [:material-code-braces: AwsDynamoDbTableProvisionedThroughputTypeDef](./type_defs.md#awsdynamodbtableprovisionedthroughputtypedef) 
...
1. See [:material-code-braces: AwsEc2ClientVpnEndpointAuthenticationOptionsDetailsTypeDef](./type_defs.md#awsec2clientvpnendpointauthenticationoptionsdetailstypedef) 
2. See [:material-code-braces: AwsEc2ClientVpnEndpointConnectionLogOptionsDetailsTypeDef](./type_defs.md#awsec2clientvpnendpointconnectionlogoptionsdetailstypedef) 
3. See [:material-code-braces: AwsEc2ClientVpnEndpointClientConnectOptionsDetailsTypeDef](./type_defs.md#awsec2clientvpnendpointclientconnectoptionsdetailstypedef) 
4. See [:material-code-braces: AwsEc2ClientVpnEndpointClientLoginBannerOptionsDetailsTypeDef](./type_defs.md#awsec2clientvpnendpointclientloginbanneroptionsdetailstypedef) 
...
11. See [:material-code-braces: AwsEc2LaunchTemplateDataInstanceRequirementsDetailsOutputTypeDef](./type_defs.md#awsec2launchtemplatedatainstancerequirementsdetailsoutputtypedef) 
...
16. See [:material-code-braces: AwsEc2LaunchTemplateDataNetworkInterfaceSetDetailsOutputTypeDef](./type_defs.md#awsec2launchtemplatedatanetworkinterfacesetdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2SecurityGroupIpPermissionOutputTypeDef](./type_defs.md#awsec2securitygroupippermissionoutputtypedef) 
2. See [:material-code-braces: AwsEc2SecurityGroupIpPermissionOutputTypeDef](./type_defs.md#awsec2securitygroupippermissionoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2VpcPeeringConnectionVpcInfoDetailsOutputTypeDef](./type_defs.md#awsec2vpcpeeringconnectionvpcinfodetailsoutputtypedef) 
2. See [:material-code-braces: AwsEc2VpcPeeringConnectionVpcInfoDetailsOutputTypeDef](./type_defs.md#awsec2vpcpeeringconnectionvpcinfodetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2VpnConnectionOptionsTunnelOptionsDetailsTypeDef](./type_defs.md#awsec2vpnconnectionoptionstunneloptionsdetailstypedef) [:material-code-braces: AwsEc2VpnConnectionOptionsTunnelOptionsDetailsOutputTypeDef](./type_defs.md#awsec2vpnconnectionoptionstunneloptionsdetailsoutputtypedef) 
...
5. See [:material-code-braces: AwsEcsServiceNetworkConfigurationDetailsOutputTypeDef](./type_defs.md#awsecsservicenetworkconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsServiceNetworkConfigurationAwsVpcConfigurationDetailsTypeDef](./type_defs.md#awsecsservicenetworkconfigurationawsvpcconfigurationdetailstypedef) [:material-code-braces: AwsEcsServiceNetworkConfigurationAwsVpcConfigurationDetailsOutputTypeDef](./type_defs.md#awsecsservicenetworkconfigurationawsvpcconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersCapabilitiesDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparameterscapabilitiesdetailstypedef) [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersCapabilitiesDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparameterscapabilitiesdetailsoutputtypedef) 
2. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparametersdevicesdetailstypedef) [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDevicesDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparametersdevicesdetailsoutputtypedef) 
3. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersTmpfsDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparameterstmpfsdetailstypedef) [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersTmpfsDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparameterstmpfsdetailsoutputtypedef) 
...
5. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsFirelensConfigurationDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsfirelensconfigurationdetailsoutputtypedef) 
6. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionshealthcheckdetailsoutputtypedef) 
7. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparametersdetailsoutputtypedef) 
8. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslogconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitionvolumesdockervolumeconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetailsTypeDef](./type_defs.md#awsecstaskdefinitionvolumesdockervolumeconfigurationdetailstypedef) [:material-code-braces: AwsEcsTaskDefinitionVolumesDockerVolumeConfigurationDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitionvolumesdockervolumeconfigurationdetailsoutputtypedef) 
2. See [:material-code-braces: AwsEcsTaskDefinitionVolumesEfsVolumeConfigurationDetailsTypeDef](./type_defs.md#awsecstaskdefinitionvolumesefsvolumeconfigurationdetailstypedef) 
3. See [:material-code-braces: AwsEcsTaskDefinitionVolumesHostDetailsTypeDef](./type_defs.md#awsecstaskdefinitionvolumeshostdetailstypedef) 
...
1. See [:material-code-braces: AwsEfsAccessPointPosixUserDetailsOutputTypeDef](./type_defs.md#awsefsaccesspointposixuserdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEfsAccessPointPosixUserDetailsTypeDef](./type_defs.md#awsefsaccesspointposixuserdetailstypedef) [:material-code-braces: AwsEfsAccessPointPosixUserDetailsOutputTypeDef](./type_defs.md#awsefsaccesspointposixuserdetailsoutputtypedef) 
2. See [:material-code-braces: AwsEfsAccessPointRootDirectoryDetailsTypeDef](./type_defs.md#awsefsaccesspointrootdirectorydetailstypedef) 
...
1. See [:material-code-braces: AwsEksClusterResourcesVpcConfigDetailsOutputTypeDef](./type_defs.md#awseksclusterresourcesvpcconfigdetailsoutputtypedef) 
2. See [:material-code-braces: AwsEksClusterLoggingDetailsOutputTypeDef](./type_defs.md#awseksclusterloggingdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEksClusterLoggingClusterLoggingDetailsTypeDef](./type_defs.md#awseksclusterloggingclusterloggingdetailstypedef) [:material-code-braces: AwsEksClusterLoggingClusterLoggingDetailsOutputTypeDef](./type_defs.md#awseksclusterloggingclusterloggingdetailsoutputtypedef) 
...
7. See [:material-code-braces: AwsElasticsearchDomainVPCOptionsOutputTypeDef](./type_defs.md#awselasticsearchdomainvpcoptionsoutputtypedef) 
...
5. See [:material-code-braces: AwsElasticsearchDomainNodeToNodeEncryptionOptionsTypeDef](./type_defs.md#awselasticsearchdomainnodetonodeencryptionoptionstypedef) 
6. See [:material-code-braces: AwsElasticsearchDomainServiceSoftwareOptionsTypeDef](./type_defs.md#awselasticsearchdomainservicesoftwareoptionstypedef) 
7. See [:material-code-braces: AwsElasticsearchDomainVPCOptionsTypeDef](./type_defs.md#awselasticsearchdomainvpcoptionstypedef) [:material-code-braces: AwsElasticsearchDomainVPCOptionsOutputTypeDef](./type_defs.md#awselasticsearchdomainvpcoptionsoutputtypedef) 
...
1. See [:material-code-braces: AwsElbLoadBalancerBackendServerDescriptionOutputTypeDef](./type_defs.md#awselbloadbalancerbackendserverdescriptionoutputtypedef) 
...
4. See [:material-code-braces: AwsElbLoadBalancerListenerDescriptionOutputTypeDef](./type_defs.md#awselbloadbalancerlistenerdescriptionoutputtypedef) 
5. See [:material-code-braces: AwsElbLoadBalancerAttributesOutputTypeDef](./type_defs.md#awselbloadbalancerattributesoutputtypedef) 
6. See [:material-code-braces: AwsElbLoadBalancerPoliciesOutputTypeDef](./type_defs.md#awselbloadbalancerpoliciesoutputtypedef) 
...
1. See [:material-code-braces: AwsEventsEndpointRoutingConfigFailoverConfigDetailsTypeDef](./type_defs.md#awseventsendpointroutingconfigfailoverconfigdetailstypedef) 
...
3. See [:material-code-braces: AwsLambdaFunctionEnvironmentOutputTypeDef](./type_defs.md#awslambdafunctionenvironmentoutputtypedef) 
...
6. See [:material-code-braces: AwsLambdaFunctionVpcConfigOutputTypeDef](./type_defs.md#awslambdafunctionvpcconfigoutputtypedef) 
...
1. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationSaslDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationsasldetailstypedef) 
2. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationUnauthenticatedDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationunauthenticateddetailstypedef) 
3. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationTlsDetailsOutputTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationtlsdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationSaslDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationsasldetailstypedef) 
2. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationUnauthenticatedDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationunauthenticateddetailstypedef) 
3. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationTlsDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationtlsdetailstypedef) [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationTlsDetailsOutputTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationtlsdetailsoutputtypedef) 
...
6. See [:material-code-braces: AwsOpenSearchServiceDomainVpcOptionsDetailsOutputTypeDef](./type_defs.md#awsopensearchservicedomainvpcoptionsdetailsoutputtypedef) 
...
4. See [:material-code-braces: AwsOpenSearchServiceDomainClusterConfigDetailsTypeDef](./type_defs.md#awsopensearchservicedomainclusterconfigdetailstypedef) 
5. See [:material-code-braces: AwsOpenSearchServiceDomainDomainEndpointOptionsDetailsTypeDef](./type_defs.md#awsopensearchservicedomaindomainendpointoptionsdetailstypedef) 
6. See [:material-code-braces: AwsOpenSearchServiceDomainVpcOptionsDetailsTypeDef](./type_defs.md#awsopensearchservicedomainvpcoptionsdetailstypedef) [:material-code-braces: AwsOpenSearchServiceDomainVpcOptionsDetailsOutputTypeDef](./type_defs.md#awsopensearchservicedomainvpcoptionsdetailsoutputtypedef) 
7. See [:material-code-braces: AwsOpenSearchServiceDomainLogPublishingOptionsDetailsTypeDef](./type_defs.md#awsopensearchservicedomainlogpublishingoptionsdetailstypedef) 
8. See [:material-code-braces: AwsOpenSearchServiceDomainAdvancedSecurityOptionsDetailsTypeDef](./type_defs.md#awsopensearchservicedomainadvancedsecurityoptionsdetailstypedef) 
...
1. See [:material-code-braces: AwsRdsDbClusterSnapshotDbClusterSnapshotAttributeTypeDef](./type_defs.md#awsrdsdbclustersnapshotdbclustersnapshotattributetypedef) [:material-code-braces: AwsRdsDbClusterSnapshotDbClusterSnapshotAttributeOutputTypeDef](./type_defs.md#awsrdsdbclustersnapshotdbclustersnapshotattributeoutputtypedef) 
...
1. See [:material-code-braces: AwsRdsPendingCloudWatchLogsExportsTypeDef](./type_defs.md#awsrdspendingcloudwatchlogsexportstypedef) [:material-code-braces: AwsRdsPendingCloudWatchLogsExportsOutputTypeDef](./type_defs.md#awsrdspendingcloudwatchlogsexportsoutputtypedef) 
2. See [:material-code-braces: AwsRdsDbProcessorFeatureTypeDef](./type_defs.md#awsrdsdbprocessorfeaturetypedef) 
...
1. See [:material-code-braces: AwsRoute53HostedZoneObjectDetailsTypeDef](./type_defs.md#awsroute53hostedzoneobjectdetailstypedef) 
2. See [:material-code-braces: AwsRoute53HostedZoneVpcDetailsTypeDef](./type_defs.md#awsroute53hostedzonevpcdetailstypedef) 
3. See [:material-code-braces: AwsRoute53QueryLoggingConfigDetailsTypeDef](./type_defs.md#awsroute53queryloggingconfigdetailstypedef) 
...
1. See [:material-code-braces: AwsS3BucketNotificationConfigurationS3KeyFilterOutputTypeDef](./type_defs.md#awss3bucketnotificationconfigurations3keyfilteroutputtypedef) 
...
1. See [:material-code-braces: AwsWafWebAclRuleOutputTypeDef](./type_defs.md#awswafwebaclruleoutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2CustomRequestHandlingDetailsOutputTypeDef](./type_defs.md#awswafv2customrequesthandlingdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2CustomResponseDetailsOutputTypeDef](./type_defs.md#awswafv2customresponsedetailsoutputtypedef) 
...
5. See [:material-code-brackets: VulnerabilityExploitAvailableType](./literals.md#vulnerabilityexploitavailabletype) 
6. See [:material-code-braces: VulnerabilityCodeVulnerabilitiesOutputTypeDef](./type_defs.md#vulnerabilitycodevulnerabilitiesoutputtypedef) 
...
1. See [:material-code-braces: ConfigurationOptionsTypeDef](./type_defs.md#configurationoptionstypedef) 
...
98. See [:material-code-braces: StringFilterTypeDef](./type_defs.md#stringfiltertypedef) 
99. See [:material-code-braces: StringFilterTypeDef](./type_defs.md#stringfiltertypedef) 
100. See [:material-code-braces: StringFilterTypeDef](./type_defs.md#stringfiltertypedef) 
101. See [:material-code-braces: StringFilterTypeDef](./type_defs.md#stringfiltertypedef) 
102. See [:material-code-braces: StringFilterTypeDef](./type_defs.md#stringfiltertypedef) 
103. See [:material-code-braces: StringFilterTypeDef](./type_defs.md#stringfiltertypedef) 
104. See [:material-code-braces: StringFilterTypeDef](./type_defs.md#stringfiltertypedef) 
...
class SignalTypeDef(TypedDict):
    ...
    SignalIndicators: NotRequired[Sequence[IndicatorUnionTypeDef]],  # (1)
    Name: NotRequired[str],
    CreatedAt: NotRequired[int],
    UpdatedAt: NotRequired[int],
    FirstSeenAt: NotRequired[int],
...
1. See [:material-code-braces: IndicatorTypeDef](./type_defs.md#indicatortypedef) [:material-code-braces: IndicatorOutputTypeDef](./type_defs.md#indicatoroutputtypedef) 
...
1. See [:material-code-braces: NetworkPathComponentDetailsOutputTypeDef](./type_defs.md#networkpathcomponentdetailsoutputtypedef) 
2. See [:material-code-braces: NetworkPathComponentDetailsOutputTypeDef](./type_defs.md#networkpathcomponentdetailsoutputtypedef) 
...
1. See [:material-code-braces: ParameterConfigurationOutputTypeDef](./type_defs.md#parameterconfigurationoutputtypedef) 
...
3. See [:material-code-brackets: UpdateStatusType](./literals.md#updatestatustype) 
4. See [:material-code-braces: ParameterConfigurationOutputTypeDef](./type_defs.md#parameterconfigurationoutputtypedef) 
...
1. See [:material-code-brackets: ParameterValueTypeType](./literals.md#parametervaluetypetype) 
2. See [:material-code-braces: ParameterValueTypeDef](./type_defs.md#parametervaluetypedef) [:material-code-braces: ParameterValueOutputTypeDef](./type_defs.md#parametervalueoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceStatefulRulesHeaderDetailsTypeDef](./type_defs.md#rulegroupsourcestatefulrulesheaderdetailstypedef) 
2. See [:material-code-braces: RuleGroupSourceStatefulRulesOptionsDetailsTypeDef](./type_defs.md#rulegroupsourcestatefulrulesoptionsdetailstypedef) [:material-code-braces: RuleGroupSourceStatefulRulesOptionsDetailsOutputTypeDef](./type_defs.md#rulegroupsourcestatefulrulesoptionsdetailsoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceStatelessRuleMatchAttributesOutputTypeDef](./type_defs.md#rulegroupsourcestatelessrulematchattributesoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupVariablesIpSetsDetailsTypeDef](./type_defs.md#rulegroupvariablesipsetsdetailstypedef) [:material-code-braces: RuleGroupVariablesIpSetsDetailsOutputTypeDef](./type_defs.md#rulegroupvariablesipsetsdetailsoutputtypedef) 
2. See [:material-code-braces: RuleGroupVariablesPortSetsDetailsTypeDef](./type_defs.md#rulegroupvariablesportsetsdetailstypedef) [:material-code-braces: RuleGroupVariablesPortSetsDetailsOutputTypeDef](./type_defs.md#rulegroupvariablesportsetsdetailsoutputtypedef) 
## ComplianceTypeDef
...
2. See [:material-code-braces: StatusReasonTypeDef](./type_defs.md#statusreasontypedef) 
3. See [:material-code-braces: AssociatedStandardTypeDef](./type_defs.md#associatedstandardtypedef) 
4. See [:material-code-braces: SecurityControlParameterTypeDef](./type_defs.md#securitycontrolparametertypedef) [:material-code-braces: SecurityControlParameterOutputTypeDef](./type_defs.md#securitycontrolparameteroutputtypedef) 
...
1. See [:material-code-braces: StatelessCustomPublishMetricActionOutputTypeDef](./type_defs.md#statelesscustompublishmetricactionoutputtypedef) 
...
2. See [:material-code-braces: NetworkEndpointTypeDef](./type_defs.md#networkendpointtypedef) 
3. See [:material-code-braces: SignalOutputTypeDef](./type_defs.md#signaloutputtypedef) 
4. See [:material-code-braces: IndicatorOutputTypeDef](./type_defs.md#indicatoroutputtypedef) 
...
1. See [:material-code-brackets: AutomationRulesActionTypeType](./literals.md#automationrulesactiontypetype) 
2. See [:material-code-braces: AutomationRulesFindingFieldsUpdateTypeDef](./type_defs.md#automationrulesfindingfieldsupdatetypedef) [:material-code-braces: AutomationRulesFindingFieldsUpdateOutputTypeDef](./type_defs.md#automationrulesfindingfieldsupdateoutputtypedef) 
...
1. See [:material-code-braces: AwsAutoScalingAutoScalingGroupMixedInstancesPolicyDetailsOutputTypeDef](./type_defs.md#awsautoscalingautoscalinggroupmixedinstancespolicydetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsAutoScalingAutoScalingGroupMixedInstancesPolicyInstancesDistributionDetailsTypeDef](./type_defs.md#awsautoscalingautoscalinggroupmixedinstancespolicyinstancesdistributiondetailstypedef) 
2. See [:material-code-braces: AwsAutoScalingAutoScalingGroupMixedInstancesPolicyLaunchTemplateDetailsTypeDef](./type_defs.md#awsautoscalingautoscalinggroupmixedinstancespolicylaunchtemplatedetailstypedef) [:material-code-braces: AwsAutoScalingAutoScalingGroupMixedInstancesPolicyLaunchTemplateDetailsOutputTypeDef](./type_defs.md#awsautoscalingautoscalinggroupmixedinstancespolicylaunchtemplatedetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsBackupBackupPlanAdvancedBackupSettingsDetailsOutputTypeDef](./type_defs.md#awsbackupbackupplanadvancedbackupsettingsdetailsoutputtypedef) 
2. See [:material-code-braces: AwsBackupBackupPlanRuleDetailsOutputTypeDef](./type_defs.md#awsbackupbackupplanruledetailsoutputtypedef) 
...
5. See [:material-code-braces: AwsCertificateManagerCertificateRenewalSummaryOutputTypeDef](./type_defs.md#awscertificatemanagercertificaterenewalsummaryoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginItemOutputTypeDef](./type_defs.md#awscloudfrontdistributionoriginitemoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginGroupOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupoutputtypedef) 
...
1. See [:material-code-braces: AwsCodeBuildProjectArtifactsDetailsTypeDef](./type_defs.md#awscodebuildprojectartifactsdetailstypedef) 
2. See [:material-code-braces: AwsCodeBuildProjectEnvironmentTypeDef](./type_defs.md#awscodebuildprojectenvironmenttypedef) [:material-code-braces: AwsCodeBuildProjectEnvironmentOutputTypeDef](./type_defs.md#awscodebuildprojectenvironmentoutputtypedef) 
3. See [:material-code-braces: AwsCodeBuildProjectSourceTypeDef](./type_defs.md#awscodebuildprojectsourcetypedef) 
4. See [:material-code-braces: AwsCodeBuildProjectLogsConfigDetailsTypeDef](./type_defs.md#awscodebuildprojectlogsconfigdetailstypedef) 
5. See [:material-code-braces: AwsCodeBuildProjectVpcConfigTypeDef](./type_defs.md#awscodebuildprojectvpcconfigtypedef) [:material-code-braces: AwsCodeBuildProjectVpcConfigOutputTypeDef](./type_defs.md#awscodebuildprojectvpcconfigoutputtypedef) 
6. See [:material-code-braces: AwsCodeBuildProjectArtifactsDetailsTypeDef](./type_defs.md#awscodebuildprojectartifactsdetailstypedef) 
...
3. See [:material-code-braces: AwsDynamoDbTableGlobalSecondaryIndexOutputTypeDef](./type_defs.md#awsdynamodbtableglobalsecondaryindexoutputtypedef) 
4. See [:material-code-braces: AwsDynamoDbTableKeySchemaTypeDef](./type_defs.md#awsdynamodbtablekeyschematypedef) 
5. See [:material-code-braces: AwsDynamoDbTableLocalSecondaryIndexOutputTypeDef](./type_defs.md#awsdynamodbtablelocalsecondaryindexoutputtypedef) 
...
7. See [:material-code-braces: AwsDynamoDbTableReplicaOutputTypeDef](./type_defs.md#awsdynamodbtablereplicaoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2LaunchTemplateDataDetailsOutputTypeDef](./type_defs.md#awsec2launchtemplatedatadetailsoutputtypedef) 
...
9. See [:material-code-braces: AwsEc2LaunchTemplateDataIamInstanceProfileDetailsTypeDef](./type_defs.md#awsec2launchtemplatedataiaminstanceprofiledetailstypedef) 
10. See [:material-code-braces: AwsEc2LaunchTemplateDataInstanceMarketOptionsDetailsTypeDef](./type_defs.md#awsec2launchtemplatedatainstancemarketoptionsdetailstypedef) 
11. See [:material-code-braces: AwsEc2LaunchTemplateDataInstanceRequirementsDetailsTypeDef](./type_defs.md#awsec2launchtemplatedatainstancerequirementsdetailstypedef) [:material-code-braces: AwsEc2LaunchTemplateDataInstanceRequirementsDetailsOutputTypeDef](./type_defs.md#awsec2launchtemplatedatainstancerequirementsdetailsoutputtypedef) 
12. See [:material-code-braces: AwsEc2LaunchTemplateDataLicenseSetDetailsTypeDef](./type_defs.md#awsec2launchtemplatedatalicensesetdetailstypedef) 
13. See [:material-code-braces: AwsEc2LaunchTemplateDataMaintenanceOptionsDetailsTypeDef](./type_defs.md#awsec2launchtemplatedatamaintenanceoptionsdetailstypedef) 
14. See [:material-code-braces: AwsEc2LaunchTemplateDataMetadataOptionsDetailsTypeDef](./type_defs.md#awsec2launchtemplatedatametadataoptionsdetailstypedef) 
15. See [:material-code-braces: AwsEc2LaunchTemplateDataMonitoringDetailsTypeDef](./type_defs.md#awsec2launchtemplatedatamonitoringdetailstypedef) 
16. See [:material-code-braces: AwsEc2LaunchTemplateDataNetworkInterfaceSetDetailsTypeDef](./type_defs.md#awsec2launchtemplatedatanetworkinterfacesetdetailstypedef) [:material-code-braces: AwsEc2LaunchTemplateDataNetworkInterfaceSetDetailsOutputTypeDef](./type_defs.md#awsec2launchtemplatedatanetworkinterfacesetdetailsoutputtypedef) 
17. See [:material-code-braces: AwsEc2LaunchTemplateDataPlacementDetailsTypeDef](./type_defs.md#awsec2launchtemplatedataplacementdetailstypedef) 
18. See [:material-code-braces: AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetailsTypeDef](./type_defs.md#awsec2launchtemplatedataprivatednsnameoptionsdetailstypedef) 
...
1. See [:material-code-braces: AwsEc2SecurityGroupIpPermissionTypeDef](./type_defs.md#awsec2securitygroupippermissiontypedef) [:material-code-braces: AwsEc2SecurityGroupIpPermissionOutputTypeDef](./type_defs.md#awsec2securitygroupippermissionoutputtypedef) 
...
1. See [:material-code-braces: AwsEc2VpcPeeringConnectionVpcInfoDetailsTypeDef](./type_defs.md#awsec2vpcpeeringconnectionvpcinfodetailstypedef) [:material-code-braces: AwsEc2VpcPeeringConnectionVpcInfoDetailsOutputTypeDef](./type_defs.md#awsec2vpcpeeringconnectionvpcinfodetailsoutputtypedef) 
2. See [:material-code-braces: AwsEc2VpcPeeringConnectionVpcInfoDetailsTypeDef](./type_defs.md#awsec2vpcpeeringconnectionvpcinfodetailstypedef) [:material-code-braces: AwsEc2VpcPeeringConnectionVpcInfoDetailsOutputTypeDef](./type_defs.md#awsec2vpcpeeringconnectionvpcinfodetailsoutputtypedef) 
3. See [:material-code-braces: AwsEc2VpcPeeringConnectionStatusDetailsTypeDef](./type_defs.md#awsec2vpcpeeringconnectionstatusdetailstypedef) 
...
1. See [:material-code-braces: AwsEcsTaskVolumeDetailsTypeDef](./type_defs.md#awsecstaskvolumedetailstypedef) 
2. See [:material-code-braces: AwsEcsContainerDetailsTypeDef](./type_defs.md#awsecscontainerdetailstypedef) [:material-code-braces: AwsEcsContainerDetailsOutputTypeDef](./type_defs.md#awsecscontainerdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsdetailsoutputtypedef) 
...
4. See [:material-code-braces: AwsEcsTaskDefinitionProxyConfigurationDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitionproxyconfigurationdetailsoutputtypedef) 
5. See [:material-code-braces: AwsEcsTaskDefinitionVolumesDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitionvolumesdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsElbLoadBalancerBackendServerDescriptionTypeDef](./type_defs.md#awselbloadbalancerbackendserverdescriptiontypedef) [:material-code-braces: AwsElbLoadBalancerBackendServerDescriptionOutputTypeDef](./type_defs.md#awselbloadbalancerbackendserverdescriptionoutputtypedef) 
2. See [:material-code-braces: AwsElbLoadBalancerHealthCheckTypeDef](./type_defs.md#awselbloadbalancerhealthchecktypedef) 
3. See [:material-code-braces: AwsElbLoadBalancerInstanceTypeDef](./type_defs.md#awselbloadbalancerinstancetypedef) 
4. See [:material-code-braces: AwsElbLoadBalancerListenerDescriptionTypeDef](./type_defs.md#awselbloadbalancerlistenerdescriptiontypedef) [:material-code-braces: AwsElbLoadBalancerListenerDescriptionOutputTypeDef](./type_defs.md#awselbloadbalancerlistenerdescriptionoutputtypedef) 
5. See [:material-code-braces: AwsElbLoadBalancerAttributesTypeDef](./type_defs.md#awselbloadbalancerattributestypedef) [:material-code-braces: AwsElbLoadBalancerAttributesOutputTypeDef](./type_defs.md#awselbloadbalancerattributesoutputtypedef) 
6. See [:material-code-braces: AwsElbLoadBalancerPoliciesTypeDef](./type_defs.md#awselbloadbalancerpoliciestypedef) [:material-code-braces: AwsElbLoadBalancerPoliciesOutputTypeDef](./type_defs.md#awselbloadbalancerpoliciesoutputtypedef) 
7. See [:material-code-braces: AwsElbLoadBalancerSourceSecurityGroupTypeDef](./type_defs.md#awselbloadbalancersourcesecuritygrouptypedef) 
...
1. See [:material-code-braces: AwsEventsEndpointEventBusesDetailsTypeDef](./type_defs.md#awseventsendpointeventbusesdetailstypedef) 
2. See [:material-code-braces: AwsEventsEndpointReplicationConfigDetailsTypeDef](./type_defs.md#awseventsendpointreplicationconfigdetailstypedef) 
3. See [:material-code-braces: AwsEventsEndpointRoutingConfigDetailsTypeDef](./type_defs.md#awseventsendpointroutingconfigdetailstypedef) 
...
1. See [:material-code-braces: AwsIamAttachedManagedPolicyTypeDef](./type_defs.md#awsiamattachedmanagedpolicytypedef) 
2. See [:material-code-braces: AwsIamInstanceProfileTypeDef](./type_defs.md#awsiaminstanceprofiletypedef) [:material-code-braces: AwsIamInstanceProfileOutputTypeDef](./type_defs.md#awsiaminstanceprofileoutputtypedef) 
3. See [:material-code-braces: AwsIamPermissionsBoundaryTypeDef](./type_defs.md#awsiampermissionsboundarytypedef) 
4. See [:material-code-braces: AwsIamRolePolicyTypeDef](./type_defs.md#awsiamrolepolicytypedef) 
...
1. See [:material-code-braces: AwsLambdaFunctionCodeTypeDef](./type_defs.md#awslambdafunctioncodetypedef) 
2. See [:material-code-braces: AwsLambdaFunctionDeadLetterConfigTypeDef](./type_defs.md#awslambdafunctiondeadletterconfigtypedef) 
3. See [:material-code-braces: AwsLambdaFunctionEnvironmentTypeDef](./type_defs.md#awslambdafunctionenvironmenttypedef) [:material-code-braces: AwsLambdaFunctionEnvironmentOutputTypeDef](./type_defs.md#awslambdafunctionenvironmentoutputtypedef) 
4. See [:material-code-braces: AwsLambdaFunctionLayerTypeDef](./type_defs.md#awslambdafunctionlayertypedef) 
5. See [:material-code-braces: AwsLambdaFunctionTracingConfigTypeDef](./type_defs.md#awslambdafunctiontracingconfigtypedef) 
6. See [:material-code-braces: AwsLambdaFunctionVpcConfigTypeDef](./type_defs.md#awslambdafunctionvpcconfigtypedef) [:material-code-braces: AwsLambdaFunctionVpcConfigOutputTypeDef](./type_defs.md#awslambdafunctionvpcconfigoutputtypedef) 
...
1. See [:material-code-braces: AwsMskClusterClusterInfoEncryptionInfoDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoencryptioninfodetailstypedef) 
2. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationDetailsOutputTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationdetailsoutputtypedef) 
...
5. See [:material-code-braces: AwsRdsDbSubnetGroupOutputTypeDef](./type_defs.md#awsrdsdbsubnetgroupoutputtypedef) 
6. See [:material-code-braces: AwsRdsDbPendingModifiedValuesOutputTypeDef](./type_defs.md#awsrdsdbpendingmodifiedvaluesoutputtypedef) 
...
1. See [:material-code-braces: AwsRedshiftClusterClusterNodeTypeDef](./type_defs.md#awsredshiftclusterclusternodetypedef) 
2. See [:material-code-braces: AwsRedshiftClusterClusterParameterGroupTypeDef](./type_defs.md#awsredshiftclusterclusterparametergrouptypedef) [:material-code-braces: AwsRedshiftClusterClusterParameterGroupOutputTypeDef](./type_defs.md#awsredshiftclusterclusterparametergroupoutputtypedef) 
3. See [:material-code-braces: AwsRedshiftClusterClusterSecurityGroupTypeDef](./type_defs.md#awsredshiftclusterclustersecuritygrouptypedef) 
4. See [:material-code-braces: AwsRedshiftClusterClusterSnapshotCopyStatusTypeDef](./type_defs.md#awsredshiftclusterclustersnapshotcopystatustypedef) 
5. See [:material-code-braces: AwsRedshiftClusterDeferredMaintenanceWindowTypeDef](./type_defs.md#awsredshiftclusterdeferredmaintenancewindowtypedef) 
6. See [:material-code-braces: AwsRedshiftClusterElasticIpStatusTypeDef](./type_defs.md#awsredshiftclusterelasticipstatustypedef) 
...
1. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateDetailsOutputTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesfilterpredicatedetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketNotificationConfigurationFilterOutputTypeDef](./type_defs.md#awss3bucketnotificationconfigurationfilteroutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketNotificationConfigurationS3KeyFilterTypeDef](./type_defs.md#awss3bucketnotificationconfigurations3keyfiltertypedef) [:material-code-braces: AwsS3BucketNotificationConfigurationS3KeyFilterOutputTypeDef](./type_defs.md#awss3bucketnotificationconfigurations3keyfilteroutputtypedef) 
...
1. See [:material-code-braces: AwsStepFunctionStateMachineLoggingConfigurationDetailsOutputTypeDef](./type_defs.md#awsstepfunctionstatemachineloggingconfigurationdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafWebAclRuleTypeDef](./type_defs.md#awswafwebaclruletypedef) [:material-code-braces: AwsWafWebAclRuleOutputTypeDef](./type_defs.md#awswafwebaclruleoutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2CustomRequestHandlingDetailsTypeDef](./type_defs.md#awswafv2customrequesthandlingdetailstypedef) [:material-code-braces: AwsWafv2CustomRequestHandlingDetailsOutputTypeDef](./type_defs.md#awswafv2customrequesthandlingdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2ActionAllowDetailsOutputTypeDef](./type_defs.md#awswafv2actionallowdetailsoutputtypedef) 
2. See [:material-code-braces: AwsWafv2ActionBlockDetailsOutputTypeDef](./type_defs.md#awswafv2actionblockdetailsoutputtypedef) 
3. See [:material-code-braces: AwsWafv2RulesActionCaptchaDetailsOutputTypeDef](./type_defs.md#awswafv2rulesactioncaptchadetailsoutputtypedef) 
4. See [:material-code-braces: AwsWafv2RulesActionCountDetailsOutputTypeDef](./type_defs.md#awswafv2rulesactioncountdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2CustomResponseDetailsTypeDef](./type_defs.md#awswafv2customresponsedetailstypedef) [:material-code-braces: AwsWafv2CustomResponseDetailsOutputTypeDef](./type_defs.md#awswafv2customresponsedetailsoutputtypedef) 
...
1. See [:material-code-braces: SoftwarePackageTypeDef](./type_defs.md#softwarepackagetypedef) 
2. See [:material-code-braces: CvssTypeDef](./type_defs.md#cvsstypedef) [:material-code-braces: CvssOutputTypeDef](./type_defs.md#cvssoutputtypedef) 
3. See [:material-code-braces: VulnerabilityVendorTypeDef](./type_defs.md#vulnerabilityvendortypedef) 
4. See [:material-code-brackets: VulnerabilityFixAvailableType](./literals.md#vulnerabilityfixavailabletype) 
5. See [:material-code-brackets: VulnerabilityExploitAvailableType](./literals.md#vulnerabilityexploitavailabletype) 
6. See [:material-code-braces: VulnerabilityCodeVulnerabilitiesTypeDef](./type_defs.md#vulnerabilitycodevulnerabilitiestypedef) [:material-code-braces: VulnerabilityCodeVulnerabilitiesOutputTypeDef](./type_defs.md#vulnerabilitycodevulnerabilitiesoutputtypedef) 
...
3. See [:material-code-brackets: SecurityControlPropertyType](./literals.md#securitycontrolpropertytype) 
4. See [:material-code-braces: ParameterDefinitionTypeDef](./type_defs.md#parameterdefinitiontypedef) 
...
1. See [:material-code-braces: ConfigurationPolicyAssociationSummaryTypeDef](./type_defs.md#configurationpolicyassociationsummarytypedef) 
2. See [:material-code-braces: UnprocessedConfigurationPolicyAssociationTypeDef](./type_defs.md#unprocessedconfigurationpolicyassociationtypedef) 
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
1. See [:material-code-brackets: RuleStatusType](./literals.md#rulestatustype) 
2. See [:material-code-braces: AutomationRulesFindingFiltersOutputTypeDef](./type_defs.md#automationrulesfindingfiltersoutputtypedef) 
3. See [:material-code-braces: AutomationRulesActionOutputTypeDef](./type_defs.md#automationrulesactionoutputtypedef) 
## InsightTypeDef
...
1. See [:material-code-braces: AwsSecurityFindingFiltersOutputTypeDef](./type_defs.md#awssecurityfindingfiltersoutputtypedef) 
...
1. See [:material-code-braces: NetworkHeaderOutputTypeDef](./type_defs.md#networkheaderoutputtypedef) 
2. See [:material-code-braces: NetworkHeaderOutputTypeDef](./type_defs.md#networkheaderoutputtypedef) 
...
1. See [:material-code-braces: NetworkPathComponentDetailsTypeDef](./type_defs.md#networkpathcomponentdetailstypedef) [:material-code-braces: NetworkPathComponentDetailsOutputTypeDef](./type_defs.md#networkpathcomponentdetailsoutputtypedef) 
2. See [:material-code-braces: NetworkPathComponentDetailsTypeDef](./type_defs.md#networkpathcomponentdetailstypedef) [:material-code-braces: NetworkPathComponentDetailsOutputTypeDef](./type_defs.md#networkpathcomponentdetailsoutputtypedef) 
...
1. See [:material-code-braces: OccurrencesOutputTypeDef](./type_defs.md#occurrencesoutputtypedef) 
...
1. See [:material-code-braces: SecurityControlCustomParameterOutputTypeDef](./type_defs.md#securitycontrolcustomparameteroutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceStatelessRuleDefinitionOutputTypeDef](./type_defs.md#rulegroupsourcestatelessruledefinitionoutputtypedef) 
...
1. See [:material-code-braces: StatelessCustomActionDefinitionOutputTypeDef](./type_defs.md#statelesscustomactiondefinitionoutputtypedef) 
...
1. See [:material-code-braces: StatelessCustomPublishMetricActionTypeDef](./type_defs.md#statelesscustompublishmetricactiontypedef) [:material-code-braces: StatelessCustomPublishMetricActionOutputTypeDef](./type_defs.md#statelesscustompublishmetricactionoutputtypedef) 
## ActionOutputTypeDef
...
4. See [:material-code-braces: PortProbeActionOutputTypeDef](./type_defs.md#portprobeactionoutputtypedef) 
...
1. See [:material-code-braces: SequenceOutputTypeDef](./type_defs.md#sequenceoutputtypedef) 
...
1. See [:material-code-braces: AwsBackupBackupPlanBackupPlanDetailsOutputTypeDef](./type_defs.md#awsbackupbackupplanbackupplandetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsBackupBackupPlanAdvancedBackupSettingsDetailsTypeDef](./type_defs.md#awsbackupbackupplanadvancedbackupsettingsdetailstypedef) [:material-code-braces: AwsBackupBackupPlanAdvancedBackupSettingsDetailsOutputTypeDef](./type_defs.md#awsbackupbackupplanadvancedbackupsettingsdetailsoutputtypedef) 
2. See [:material-code-braces: AwsBackupBackupPlanRuleDetailsTypeDef](./type_defs.md#awsbackupbackupplanruledetailstypedef) [:material-code-braces: AwsBackupBackupPlanRuleDetailsOutputTypeDef](./type_defs.md#awsbackupbackupplanruledetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsCertificateManagerCertificateDomainValidationOptionTypeDef](./type_defs.md#awscertificatemanagercertificatedomainvalidationoptiontypedef) [:material-code-braces: AwsCertificateManagerCertificateDomainValidationOptionOutputTypeDef](./type_defs.md#awscertificatemanagercertificatedomainvalidationoptionoutputtypedef) 
2. See [:material-code-braces: AwsCertificateManagerCertificateExtendedKeyUsageTypeDef](./type_defs.md#awscertificatemanagercertificateextendedkeyusagetypedef) 
3. See [:material-code-braces: AwsCertificateManagerCertificateKeyUsageTypeDef](./type_defs.md#awscertificatemanagercertificatekeyusagetypedef) 
4. See [:material-code-braces: AwsCertificateManagerCertificateOptionsTypeDef](./type_defs.md#awscertificatemanagercertificateoptionstypedef) 
5. See [:material-code-braces: AwsCertificateManagerCertificateRenewalSummaryTypeDef](./type_defs.md#awscertificatemanagercertificaterenewalsummarytypedef) [:material-code-braces: AwsCertificateManagerCertificateRenewalSummaryOutputTypeDef](./type_defs.md#awscertificatemanagercertificaterenewalsummaryoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionCacheBehaviorsOutputTypeDef](./type_defs.md#awscloudfrontdistributioncachebehaviorsoutputtypedef) 
...
4. See [:material-code-braces: AwsCloudFrontDistributionOriginsOutputTypeDef](./type_defs.md#awscloudfrontdistributionoriginsoutputtypedef) 
5. See [:material-code-braces: AwsCloudFrontDistributionOriginGroupsOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupsoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginGroupFailoverTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupfailovertypedef) [:material-code-braces: AwsCloudFrontDistributionOriginGroupFailoverOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupfailoveroutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginS3OriginConfigTypeDef](./type_defs.md#awscloudfrontdistributionorigins3originconfigtypedef) 
2. See [:material-code-braces: AwsCloudFrontDistributionOriginCustomOriginConfigTypeDef](./type_defs.md#awscloudfrontdistributionorigincustomoriginconfigtypedef) [:material-code-braces: AwsCloudFrontDistributionOriginCustomOriginConfigOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigincustomoriginconfigoutputtypedef) 
...
1. See [:material-code-braces: AwsDynamoDbTableAttributeDefinitionTypeDef](./type_defs.md#awsdynamodbtableattributedefinitiontypedef) 
2. See [:material-code-braces: AwsDynamoDbTableBillingModeSummaryTypeDef](./type_defs.md#awsdynamodbtablebillingmodesummarytypedef) 
3. See [:material-code-braces: AwsDynamoDbTableGlobalSecondaryIndexTypeDef](./type_defs.md#awsdynamodbtableglobalsecondaryindextypedef) [:material-code-braces: AwsDynamoDbTableGlobalSecondaryIndexOutputTypeDef](./type_defs.md#awsdynamodbtableglobalsecondaryindexoutputtypedef) 
4. See [:material-code-braces: AwsDynamoDbTableKeySchemaTypeDef](./type_defs.md#awsdynamodbtablekeyschematypedef) 
5. See [:material-code-braces: AwsDynamoDbTableLocalSecondaryIndexTypeDef](./type_defs.md#awsdynamodbtablelocalsecondaryindextypedef) [:material-code-braces: AwsDynamoDbTableLocalSecondaryIndexOutputTypeDef](./type_defs.md#awsdynamodbtablelocalsecondaryindexoutputtypedef) 
6. See [:material-code-braces: AwsDynamoDbTableProvisionedThroughputTypeDef](./type_defs.md#awsdynamodbtableprovisionedthroughputtypedef) 
7. See [:material-code-braces: AwsDynamoDbTableReplicaTypeDef](./type_defs.md#awsdynamodbtablereplicatypedef) [:material-code-braces: AwsDynamoDbTableReplicaOutputTypeDef](./type_defs.md#awsdynamodbtablereplicaoutputtypedef) 
8. See [:material-code-braces: AwsDynamoDbTableRestoreSummaryTypeDef](./type_defs.md#awsdynamodbtablerestoresummarytypedef) 
9. See [:material-code-braces: AwsDynamoDbTableSseDescriptionTypeDef](./type_defs.md#awsdynamodbtablessedescriptiontypedef) 
10. See [:material-code-braces: AwsDynamoDbTableStreamSpecificationTypeDef](./type_defs.md#awsdynamodbtablestreamspecificationtypedef) 
...
1. See [:material-code-braces: AwsEc2VpnConnectionVgwTelemetryDetailsTypeDef](./type_defs.md#awsec2vpnconnectionvgwtelemetrydetailstypedef) 
2. See [:material-code-braces: AwsEc2VpnConnectionOptionsDetailsTypeDef](./type_defs.md#awsec2vpnconnectionoptionsdetailstypedef) [:material-code-braces: AwsEc2VpnConnectionOptionsDetailsOutputTypeDef](./type_defs.md#awsec2vpnconnectionoptionsdetailsoutputtypedef) 
3. See [:material-code-braces: AwsEc2VpnConnectionRoutesDetailsTypeDef](./type_defs.md#awsec2vpnconnectionroutesdetailstypedef) 
...
3. See [:material-code-braces: AwsEcsServiceDeploymentControllerDetailsTypeDef](./type_defs.md#awsecsservicedeploymentcontrollerdetailstypedef) 
4. See [:material-code-braces: AwsEcsServiceLoadBalancersDetailsTypeDef](./type_defs.md#awsecsserviceloadbalancersdetailstypedef) 
5. See [:material-code-braces: AwsEcsServiceNetworkConfigurationDetailsTypeDef](./type_defs.md#awsecsservicenetworkconfigurationdetailstypedef) [:material-code-braces: AwsEcsServiceNetworkConfigurationDetailsOutputTypeDef](./type_defs.md#awsecsservicenetworkconfigurationdetailsoutputtypedef) 
6. See [:material-code-braces: AwsEcsServicePlacementConstraintsDetailsTypeDef](./type_defs.md#awsecsserviceplacementconstraintsdetailstypedef) 
7. See [:material-code-braces: AwsEcsServicePlacementStrategiesDetailsTypeDef](./type_defs.md#awsecsserviceplacementstrategiesdetailstypedef) 
8. See [:material-code-braces: AwsEcsServiceServiceRegistriesDetailsTypeDef](./type_defs.md#awsecsserviceserviceregistriesdetailstypedef) 
...
3. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsEnvironmentFilesDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsenvironmentfilesdetailstypedef) 
4. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsExtraHostsDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsextrahostsdetailstypedef) 
5. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsFirelensConfigurationDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsfirelensconfigurationdetailstypedef) [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsFirelensConfigurationDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsfirelensconfigurationdetailsoutputtypedef) 
6. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionshealthcheckdetailstypedef) [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsHealthCheckDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionshealthcheckdetailsoutputtypedef) 
7. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparametersdetailstypedef) [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLinuxParametersDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslinuxparametersdetailsoutputtypedef) 
8. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslogconfigurationdetailstypedef) [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsLogConfigurationDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionslogconfigurationdetailsoutputtypedef) 
9. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsMountPointsDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsmountpointsdetailstypedef) 
10. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsPortMappingsDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsportmappingsdetailstypedef) 
11. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsRepositoryCredentialsDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsrepositorycredentialsdetailstypedef) 
12. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsResourceRequirementsDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsresourcerequirementsdetailstypedef) 
...
1. See [:material-code-braces: AwsEksClusterResourcesVpcConfigDetailsTypeDef](./type_defs.md#awseksclusterresourcesvpcconfigdetailstypedef) [:material-code-braces: AwsEksClusterResourcesVpcConfigDetailsOutputTypeDef](./type_defs.md#awseksclusterresourcesvpcconfigdetailsoutputtypedef) 
2. See [:material-code-braces: AwsEksClusterLoggingDetailsTypeDef](./type_defs.md#awseksclusterloggingdetailstypedef) [:material-code-braces: AwsEksClusterLoggingDetailsOutputTypeDef](./type_defs.md#awseksclusterloggingdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsMskClusterClusterInfoDetailsOutputTypeDef](./type_defs.md#awsmskclusterclusterinfodetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsMskClusterClusterInfoEncryptionInfoDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoencryptioninfodetailstypedef) 
2. See [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationdetailstypedef) [:material-code-braces: AwsMskClusterClusterInfoClientAuthenticationDetailsOutputTypeDef](./type_defs.md#awsmskclusterclusterinfoclientauthenticationdetailsoutputtypedef) 
...
3. See [:material-code-braces: AwsRdsDbInstanceVpcSecurityGroupTypeDef](./type_defs.md#awsrdsdbinstancevpcsecuritygrouptypedef) 
4. See [:material-code-braces: AwsRdsDbParameterGroupTypeDef](./type_defs.md#awsrdsdbparametergrouptypedef) 
5. See [:material-code-braces: AwsRdsDbSubnetGroupTypeDef](./type_defs.md#awsrdsdbsubnetgrouptypedef) [:material-code-braces: AwsRdsDbSubnetGroupOutputTypeDef](./type_defs.md#awsrdsdbsubnetgroupoutputtypedef) 
6. See [:material-code-braces: AwsRdsDbPendingModifiedValuesTypeDef](./type_defs.md#awsrdsdbpendingmodifiedvaluestypedef) [:material-code-braces: AwsRdsDbPendingModifiedValuesOutputTypeDef](./type_defs.md#awsrdsdbpendingmodifiedvaluesoutputtypedef) 
7. See [:material-code-braces: AwsRdsDbOptionGroupMembershipTypeDef](./type_defs.md#awsrdsdboptiongroupmembershiptypedef) 
8. See [:material-code-braces: AwsRdsDbStatusInfoTypeDef](./type_defs.md#awsrdsdbstatusinfotypedef) 
9. See [:material-code-braces: AwsRdsDbDomainMembershipTypeDef](./type_defs.md#awsrdsdbdomainmembershiptypedef) 
10. See [:material-code-braces: AwsRdsDbProcessorFeatureTypeDef](./type_defs.md#awsrdsdbprocessorfeaturetypedef) 
...
1. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateDetailsTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesfilterpredicatedetailstypedef) [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesFilterPredicateDetailsOutputTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesfilterpredicatedetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketNotificationConfigurationDetailOutputTypeDef](./type_defs.md#awss3bucketnotificationconfigurationdetailoutputtypedef) 
...
1. See [:material-code-braces: AwsStepFunctionStateMachineLoggingConfigurationDetailsTypeDef](./type_defs.md#awsstepfunctionstatemachineloggingconfigurationdetailstypedef) [:material-code-braces: AwsStepFunctionStateMachineLoggingConfigurationDetailsOutputTypeDef](./type_defs.md#awsstepfunctionstatemachineloggingconfigurationdetailsoutputtypedef) 
2. See [:material-code-braces: AwsStepFunctionStateMachineTracingConfigurationDetailsTypeDef](./type_defs.md#awsstepfunctionstatemachinetracingconfigurationdetailstypedef) 
...
1. See [:material-code-braces: AwsWafv2RulesActionDetailsOutputTypeDef](./type_defs.md#awswafv2rulesactiondetailsoutputtypedef) 
...
class SequenceTypeDef(TypedDict):
    ...
    SequenceIndicators: NotRequired[Sequence[IndicatorTypeDef]],  # (4)
```

1. See [:material-code-braces: ActorTypeDef](./type_defs.md#actortypedef) 
2. See [:material-code-braces: NetworkEndpointTypeDef](./type_defs.md#networkendpointtypedef) 
3. See [:material-code-braces: SignalTypeDef](./type_defs.md#signaltypedef) [:material-code-braces: SignalOutputTypeDef](./type_defs.md#signaloutputtypedef) 
4. See [:material-code-braces: IndicatorTypeDef](./type_defs.md#indicatortypedef) 
...
1. See [:material-code-braces: CustomDataIdentifiersDetectionsOutputTypeDef](./type_defs.md#customdataidentifiersdetectionsoutputtypedef) 
...
1. See [:material-code-braces: SensitiveDataDetectionsOutputTypeDef](./type_defs.md#sensitivedatadetectionsoutputtypedef) 
...
1. See [:material-code-braces: OccurrencesTypeDef](./type_defs.md#occurrencestypedef) [:material-code-braces: OccurrencesOutputTypeDef](./type_defs.md#occurrencesoutputtypedef) 
...
1. See [:material-code-braces: SecurityControlsConfigurationOutputTypeDef](./type_defs.md#securitycontrolsconfigurationoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceStatelessRuleMatchAttributesTypeDef](./type_defs.md#rulegroupsourcestatelessrulematchattributestypedef) [:material-code-braces: RuleGroupSourceStatelessRuleMatchAttributesOutputTypeDef](./type_defs.md#rulegroupsourcestatelessrulematchattributesoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceCustomActionsDetailsOutputTypeDef](./type_defs.md#rulegroupsourcecustomactionsdetailsoutputtypedef) 
2. See [:material-code-braces: RuleGroupSourceStatelessRulesDetailsOutputTypeDef](./type_defs.md#rulegroupsourcestatelessrulesdetailsoutputtypedef) 
## ActionTypeDef
...
1. See [:material-code-braces: NetworkConnectionActionTypeDef](./type_defs.md#networkconnectionactiontypedef) 
2. See [:material-code-braces: AwsApiCallActionTypeDef](./type_defs.md#awsapicallactiontypedef) [:material-code-braces: AwsApiCallActionOutputTypeDef](./type_defs.md#awsapicallactionoutputtypedef) 
3. See [:material-code-braces: DnsRequestActionTypeDef](./type_defs.md#dnsrequestactiontypedef) 
4. See [:material-code-braces: PortProbeActionTypeDef](./type_defs.md#portprobeactiontypedef) [:material-code-braces: PortProbeActionOutputTypeDef](./type_defs.md#portprobeactionoutputtypedef) 
...
1. See [:material-code-brackets: RuleStatusType](./literals.md#rulestatustype) 
2. See [:material-code-braces: AutomationRulesFindingFiltersTypeDef](./type_defs.md#automationrulesfindingfilterstypedef) [:material-code-braces: AutomationRulesFindingFiltersOutputTypeDef](./type_defs.md#automationrulesfindingfiltersoutputtypedef) 
3. See [:material-code-braces: AutomationRulesActionTypeDef](./type_defs.md#automationrulesactiontypedef) [:material-code-braces: AutomationRulesActionOutputTypeDef](./type_defs.md#automationrulesactionoutputtypedef) 
...
1. See [:material-code-braces: AwsAutoScalingAutoScalingGroupMixedInstancesPolicyDetailsTypeDef](./type_defs.md#awsautoscalingautoscalinggroupmixedinstancespolicydetailstypedef) [:material-code-braces: AwsAutoScalingAutoScalingGroupMixedInstancesPolicyDetailsOutputTypeDef](./type_defs.md#awsautoscalingautoscalinggroupmixedinstancespolicydetailsoutputtypedef) 
2. See [:material-code-braces: AwsAutoScalingAutoScalingGroupAvailabilityZonesListDetailsTypeDef](./type_defs.md#awsautoscalingautoscalinggroupavailabilityzoneslistdetailstypedef) 
3. See [:material-code-braces: AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecificationTypeDef](./type_defs.md#awsautoscalingautoscalinggrouplaunchtemplatelaunchtemplatespecificationtypedef) 
...
1. See [:material-code-braces: AwsEc2LaunchTemplateDataDetailsTypeDef](./type_defs.md#awsec2launchtemplatedatadetailstypedef) [:material-code-braces: AwsEc2LaunchTemplateDataDetailsOutputTypeDef](./type_defs.md#awsec2launchtemplatedatadetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesDetailsOutputTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketNotificationConfigurationFilterTypeDef](./type_defs.md#awss3bucketnotificationconfigurationfiltertypedef) [:material-code-braces: AwsS3BucketNotificationConfigurationFilterOutputTypeDef](./type_defs.md#awss3bucketnotificationconfigurationfilteroutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2RulesDetailsOutputTypeDef](./type_defs.md#awswafv2rulesdetailsoutputtypedef) 
2. See [:material-code-braces: AwsWafv2VisibilityConfigDetailsTypeDef](./type_defs.md#awswafv2visibilityconfigdetailstypedef) 
...
2. See [:material-code-braces: AwsWafv2WebAclActionDetailsOutputTypeDef](./type_defs.md#awswafv2webaclactiondetailsoutputtypedef) 
3. See [:material-code-braces: AwsWafv2RulesDetailsOutputTypeDef](./type_defs.md#awswafv2rulesdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2ActionAllowDetailsTypeDef](./type_defs.md#awswafv2actionallowdetailstypedef) [:material-code-braces: AwsWafv2ActionAllowDetailsOutputTypeDef](./type_defs.md#awswafv2actionallowdetailsoutputtypedef) 
2. See [:material-code-braces: AwsWafv2ActionBlockDetailsTypeDef](./type_defs.md#awswafv2actionblockdetailstypedef) [:material-code-braces: AwsWafv2ActionBlockDetailsOutputTypeDef](./type_defs.md#awswafv2actionblockdetailsoutputtypedef) 
3. See [:material-code-braces: AwsWafv2RulesActionCaptchaDetailsTypeDef](./type_defs.md#awswafv2rulesactioncaptchadetailstypedef) [:material-code-braces: AwsWafv2RulesActionCaptchaDetailsOutputTypeDef](./type_defs.md#awswafv2rulesactioncaptchadetailsoutputtypedef) 
4. See [:material-code-braces: AwsWafv2RulesActionCountDetailsTypeDef](./type_defs.md#awswafv2rulesactioncountdetailstypedef) [:material-code-braces: AwsWafv2RulesActionCountDetailsOutputTypeDef](./type_defs.md#awswafv2rulesactioncountdetailsoutputtypedef) 
...
1. See [:material-code-braces: NetworkHeaderTypeDef](./type_defs.md#networkheadertypedef) [:material-code-braces: NetworkHeaderOutputTypeDef](./type_defs.md#networkheaderoutputtypedef) 
2. See [:material-code-braces: NetworkHeaderTypeDef](./type_defs.md#networkheadertypedef) [:material-code-braces: NetworkHeaderOutputTypeDef](./type_defs.md#networkheaderoutputtypedef) 
...
2. See [:material-code-braces: SensitiveDataResultOutputTypeDef](./type_defs.md#sensitivedataresultoutputtypedef) 
3. See [:material-code-braces: CustomDataIdentifiersResultOutputTypeDef](./type_defs.md#customdataidentifiersresultoutputtypedef) 
## PolicyOutputTypeDef
...
1. See [:material-code-braces: SecurityHubPolicyOutputTypeDef](./type_defs.md#securityhubpolicyoutputtypedef) 
...
1. See [:material-code-braces: FirewallPolicyDetailsOutputTypeDef](./type_defs.md#firewallpolicydetailsoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceListDetailsOutputTypeDef](./type_defs.md#rulegroupsourcelistdetailsoutputtypedef) 
2. See [:material-code-braces: RuleGroupSourceStatefulRulesDetailsOutputTypeDef](./type_defs.md#rulegroupsourcestatefulrulesdetailsoutputtypedef) 
3. See [:material-code-braces: RuleGroupSourceStatelessRulesAndCustomActionsDetailsOutputTypeDef](./type_defs.md#rulegroupsourcestatelessrulesandcustomactionsdetailsoutputtypedef) 
...
1. See [:material-code-braces: StatelessCustomActionDefinitionTypeDef](./type_defs.md#statelesscustomactiondefinitiontypedef) [:material-code-braces: StatelessCustomActionDefinitionOutputTypeDef](./type_defs.md#statelesscustomactiondefinitionoutputtypedef) 
...
1. See [:material-code-braces: AwsBackupBackupPlanBackupPlanDetailsTypeDef](./type_defs.md#awsbackupbackupplanbackupplandetailstypedef) [:material-code-braces: AwsBackupBackupPlanBackupPlanDetailsOutputTypeDef](./type_defs.md#awsbackupbackupplanbackupplandetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginGroupTypeDef](./type_defs.md#awscloudfrontdistributionorigingrouptypedef) [:material-code-braces: AwsCloudFrontDistributionOriginGroupOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupoutputtypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionOriginItemTypeDef](./type_defs.md#awscloudfrontdistributionoriginitemtypedef) [:material-code-braces: AwsCloudFrontDistributionOriginItemOutputTypeDef](./type_defs.md#awscloudfrontdistributionoriginitemoutputtypedef) 
...
1. See [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsDetailsTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsdetailstypedef) [:material-code-braces: AwsEcsTaskDefinitionContainerDefinitionsDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitioncontainerdefinitionsdetailsoutputtypedef) 
2. See [:material-code-braces: AwsEcsTaskDefinitionInferenceAcceleratorsDetailsTypeDef](./type_defs.md#awsecstaskdefinitioninferenceacceleratorsdetailstypedef) 
3. See [:material-code-braces: AwsEcsTaskDefinitionPlacementConstraintsDetailsTypeDef](./type_defs.md#awsecstaskdefinitionplacementconstraintsdetailstypedef) 
4. See [:material-code-braces: AwsEcsTaskDefinitionProxyConfigurationDetailsTypeDef](./type_defs.md#awsecstaskdefinitionproxyconfigurationdetailstypedef) [:material-code-braces: AwsEcsTaskDefinitionProxyConfigurationDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitionproxyconfigurationdetailsoutputtypedef) 
5. See [:material-code-braces: AwsEcsTaskDefinitionVolumesDetailsTypeDef](./type_defs.md#awsecstaskdefinitionvolumesdetailstypedef) [:material-code-braces: AwsEcsTaskDefinitionVolumesDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitionvolumesdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsMskClusterClusterInfoDetailsTypeDef](./type_defs.md#awsmskclusterclusterinfodetailstypedef) [:material-code-braces: AwsMskClusterClusterInfoDetailsOutputTypeDef](./type_defs.md#awsmskclusterclusterinfodetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketServerSideEncryptionConfigurationOutputTypeDef](./type_defs.md#awss3bucketserversideencryptionconfigurationoutputtypedef) 
2. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationDetailsOutputTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationdetailsoutputtypedef) 
...
5. See [:material-code-braces: AwsS3BucketWebsiteConfigurationOutputTypeDef](./type_defs.md#awss3bucketwebsiteconfigurationoutputtypedef) 
6. See [:material-code-braces: AwsS3BucketNotificationConfigurationOutputTypeDef](./type_defs.md#awss3bucketnotificationconfigurationoutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesAbortIncompleteMultipartUploadDetailsTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesabortincompletemultipartuploaddetailstypedef) 
2. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesFilterDetailsTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesfilterdetailstypedef) [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesFilterDetailsOutputTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesfilterdetailsoutputtypedef) 
3. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesNoncurrentVersionTransitionsDetailsTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesnoncurrentversiontransitionsdetailstypedef) 
4. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesTransitionsDetailsTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulestransitionsdetailstypedef) 
## DetectionTypeDef
...
1. See [:material-code-braces: SequenceTypeDef](./type_defs.md#sequencetypedef) [:material-code-braces: SequenceOutputTypeDef](./type_defs.md#sequenceoutputtypedef) 
...
1. See [:material-code-braces: ClassificationResultOutputTypeDef](./type_defs.md#classificationresultoutputtypedef) 
...
1. See [:material-code-braces: CustomDataIdentifiersDetectionsTypeDef](./type_defs.md#customdataidentifiersdetectionstypedef) [:material-code-braces: CustomDataIdentifiersDetectionsOutputTypeDef](./type_defs.md#customdataidentifiersdetectionsoutputtypedef) 
...
1. See [:material-code-braces: SensitiveDataDetectionsTypeDef](./type_defs.md#sensitivedatadetectionstypedef) [:material-code-braces: SensitiveDataDetectionsOutputTypeDef](./type_defs.md#sensitivedatadetectionsoutputtypedef) 
...
1. See [:material-code-braces: SecurityControlCustomParameterTypeDef](./type_defs.md#securitycontrolcustomparametertypedef) [:material-code-braces: SecurityControlCustomParameterOutputTypeDef](./type_defs.md#securitycontrolcustomparameteroutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceStatelessRuleDefinitionTypeDef](./type_defs.md#rulegroupsourcestatelessruledefinitiontypedef) [:material-code-braces: RuleGroupSourceStatelessRuleDefinitionOutputTypeDef](./type_defs.md#rulegroupsourcestatelessruledefinitionoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupVariablesOutputTypeDef](./type_defs.md#rulegroupvariablesoutputtypedef) 
2. See [:material-code-braces: RuleGroupSourceOutputTypeDef](./type_defs.md#rulegroupsourceoutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketNotificationConfigurationDetailTypeDef](./type_defs.md#awss3bucketnotificationconfigurationdetailtypedef) [:material-code-braces: AwsS3BucketNotificationConfigurationDetailOutputTypeDef](./type_defs.md#awss3bucketnotificationconfigurationdetailoutputtypedef) 
...
1. See [:material-code-braces: AwsWafv2RulesActionDetailsTypeDef](./type_defs.md#awswafv2rulesactiondetailstypedef) [:material-code-braces: AwsWafv2RulesActionDetailsOutputTypeDef](./type_defs.md#awswafv2rulesactiondetailsoutputtypedef) 
2. See [:material-code-braces: AwsWafv2VisibilityConfigDetailsTypeDef](./type_defs.md#awswafv2visibilityconfigdetailstypedef) 
...
1. See [:material-code-braces: RuleGroupDetailsOutputTypeDef](./type_defs.md#rulegroupdetailsoutputtypedef) 
...
1. See [:material-code-braces: FirewallPolicyStatefulRuleGroupReferencesDetailsTypeDef](./type_defs.md#firewallpolicystatefulrulegroupreferencesdetailstypedef) 
2. See [:material-code-braces: FirewallPolicyStatelessCustomActionsDetailsTypeDef](./type_defs.md#firewallpolicystatelesscustomactionsdetailstypedef) [:material-code-braces: FirewallPolicyStatelessCustomActionsDetailsOutputTypeDef](./type_defs.md#firewallpolicystatelesscustomactionsdetailsoutputtypedef) 
3. See [:material-code-braces: FirewallPolicyStatelessRuleGroupReferencesDetailsTypeDef](./type_defs.md#firewallpolicystatelessrulegroupreferencesdetailstypedef) 
...
1. See [:material-code-braces: AwsCloudFrontDistributionCacheBehaviorsTypeDef](./type_defs.md#awscloudfrontdistributioncachebehaviorstypedef) [:material-code-braces: AwsCloudFrontDistributionCacheBehaviorsOutputTypeDef](./type_defs.md#awscloudfrontdistributioncachebehaviorsoutputtypedef) 
2. See [:material-code-braces: AwsCloudFrontDistributionDefaultCacheBehaviorTypeDef](./type_defs.md#awscloudfrontdistributiondefaultcachebehaviortypedef) 
3. See [:material-code-braces: AwsCloudFrontDistributionLoggingTypeDef](./type_defs.md#awscloudfrontdistributionloggingtypedef) 
4. See [:material-code-braces: AwsCloudFrontDistributionOriginsTypeDef](./type_defs.md#awscloudfrontdistributionoriginstypedef) [:material-code-braces: AwsCloudFrontDistributionOriginsOutputTypeDef](./type_defs.md#awscloudfrontdistributionoriginsoutputtypedef) 
5. See [:material-code-braces: AwsCloudFrontDistributionOriginGroupsTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupstypedef) [:material-code-braces: AwsCloudFrontDistributionOriginGroupsOutputTypeDef](./type_defs.md#awscloudfrontdistributionorigingroupsoutputtypedef) 
6. See [:material-code-braces: AwsCloudFrontDistributionViewerCertificateTypeDef](./type_defs.md#awscloudfrontdistributionviewercertificatetypedef) 
...
1. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesDetailsTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesdetailstypedef) [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationRulesDetailsOutputTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationrulesdetailsoutputtypedef) 
...
1. See [:material-code-braces: ClassificationStatusTypeDef](./type_defs.md#classificationstatustypedef) 
2. See [:material-code-braces: SensitiveDataResultTypeDef](./type_defs.md#sensitivedataresulttypedef) [:material-code-braces: SensitiveDataResultOutputTypeDef](./type_defs.md#sensitivedataresultoutputtypedef) 
3. See [:material-code-braces: CustomDataIdentifiersResultTypeDef](./type_defs.md#customdataidentifiersresulttypedef) [:material-code-braces: CustomDataIdentifiersResultOutputTypeDef](./type_defs.md#customdataidentifiersresultoutputtypedef) 
...
1. See [:material-code-braces: SecurityControlsConfigurationTypeDef](./type_defs.md#securitycontrolsconfigurationtypedef) [:material-code-braces: SecurityControlsConfigurationOutputTypeDef](./type_defs.md#securitycontrolsconfigurationoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceCustomActionsDetailsTypeDef](./type_defs.md#rulegroupsourcecustomactionsdetailstypedef) [:material-code-braces: RuleGroupSourceCustomActionsDetailsOutputTypeDef](./type_defs.md#rulegroupsourcecustomactionsdetailsoutputtypedef) 
2. See [:material-code-braces: RuleGroupSourceStatelessRulesDetailsTypeDef](./type_defs.md#rulegroupsourcestatelessrulesdetailstypedef) [:material-code-braces: RuleGroupSourceStatelessRulesDetailsOutputTypeDef](./type_defs.md#rulegroupsourcestatelessrulesdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsAutoScalingAutoScalingGroupDetailsOutputTypeDef](./type_defs.md#awsautoscalingautoscalinggroupdetailsoutputtypedef) 
2. See [:material-code-braces: AwsCodeBuildProjectDetailsOutputTypeDef](./type_defs.md#awscodebuildprojectdetailsoutputtypedef) 
3. See [:material-code-braces: AwsCloudFrontDistributionDetailsOutputTypeDef](./type_defs.md#awscloudfrontdistributiondetailsoutputtypedef) 
4. See [:material-code-braces: AwsEc2InstanceDetailsOutputTypeDef](./type_defs.md#awsec2instancedetailsoutputtypedef) 
5. See [:material-code-braces: AwsEc2NetworkInterfaceDetailsOutputTypeDef](./type_defs.md#awsec2networkinterfacedetailsoutputtypedef) 
6. See [:material-code-braces: AwsEc2SecurityGroupDetailsOutputTypeDef](./type_defs.md#awsec2securitygroupdetailsoutputtypedef) 
7. See [:material-code-braces: AwsEc2VolumeDetailsOutputTypeDef](./type_defs.md#awsec2volumedetailsoutputtypedef) 
8. See [:material-code-braces: AwsEc2VpcDetailsOutputTypeDef](./type_defs.md#awsec2vpcdetailsoutputtypedef) 
9. See [:material-code-braces: AwsEc2EipDetailsTypeDef](./type_defs.md#awsec2eipdetailstypedef) 
10. See [:material-code-braces: AwsEc2SubnetDetailsOutputTypeDef](./type_defs.md#awsec2subnetdetailsoutputtypedef) 
11. See [:material-code-braces: AwsEc2NetworkAclDetailsOutputTypeDef](./type_defs.md#awsec2networkacldetailsoutputtypedef) 
12. See [:material-code-braces: AwsElbv2LoadBalancerDetailsOutputTypeDef](./type_defs.md#awselbv2loadbalancerdetailsoutputtypedef) 
13. See [:material-code-braces: AwsElasticBeanstalkEnvironmentDetailsOutputTypeDef](./type_defs.md#awselasticbeanstalkenvironmentdetailsoutputtypedef) 
14. See [:material-code-braces: AwsElasticsearchDomainDetailsOutputTypeDef](./type_defs.md#awselasticsearchdomaindetailsoutputtypedef) 
15. See [:material-code-braces: AwsS3BucketDetailsOutputTypeDef](./type_defs.md#awss3bucketdetailsoutputtypedef) 
...
20. See [:material-code-braces: AwsIamUserDetailsOutputTypeDef](./type_defs.md#awsiamuserdetailsoutputtypedef) 
21. See [:material-code-braces: AwsIamPolicyDetailsOutputTypeDef](./type_defs.md#awsiampolicydetailsoutputtypedef) 
22. See [:material-code-braces: AwsApiGatewayV2StageDetailsOutputTypeDef](./type_defs.md#awsapigatewayv2stagedetailsoutputtypedef) 
23. See [:material-code-braces: AwsApiGatewayV2ApiDetailsOutputTypeDef](./type_defs.md#awsapigatewayv2apidetailsoutputtypedef) 
24. See [:material-code-braces: AwsDynamoDbTableDetailsOutputTypeDef](./type_defs.md#awsdynamodbtabledetailsoutputtypedef) 
25. See [:material-code-braces: AwsApiGatewayStageDetailsOutputTypeDef](./type_defs.md#awsapigatewaystagedetailsoutputtypedef) 
26. See [:material-code-braces: AwsApiGatewayRestApiDetailsOutputTypeDef](./type_defs.md#awsapigatewayrestapidetailsoutputtypedef) 
...
29. See [:material-code-braces: AwsCertificateManagerCertificateDetailsOutputTypeDef](./type_defs.md#awscertificatemanagercertificatedetailsoutputtypedef) 
30. See [:material-code-braces: AwsRedshiftClusterDetailsOutputTypeDef](./type_defs.md#awsredshiftclusterdetailsoutputtypedef) 
31. See [:material-code-braces: AwsElbLoadBalancerDetailsOutputTypeDef](./type_defs.md#awselbloadbalancerdetailsoutputtypedef) 
32. See [:material-code-braces: AwsIamGroupDetailsOutputTypeDef](./type_defs.md#awsiamgroupdetailsoutputtypedef) 
33. See [:material-code-braces: AwsIamRoleDetailsOutputTypeDef](./type_defs.md#awsiamroledetailsoutputtypedef) 
34. See [:material-code-braces: AwsKmsKeyDetailsTypeDef](./type_defs.md#awskmskeydetailstypedef) 
35. See [:material-code-braces: AwsLambdaFunctionDetailsOutputTypeDef](./type_defs.md#awslambdafunctiondetailsoutputtypedef) 
36. See [:material-code-braces: AwsLambdaLayerVersionDetailsOutputTypeDef](./type_defs.md#awslambdalayerversiondetailsoutputtypedef) 
37. See [:material-code-braces: AwsRdsDbInstanceDetailsOutputTypeDef](./type_defs.md#awsrdsdbinstancedetailsoutputtypedef) 
38. See [:material-code-braces: AwsSnsTopicDetailsOutputTypeDef](./type_defs.md#awssnstopicdetailsoutputtypedef) 
39. See [:material-code-braces: AwsSqsQueueDetailsTypeDef](./type_defs.md#awssqsqueuedetailstypedef) 
40. See [:material-code-braces: AwsWafWebAclDetailsOutputTypeDef](./type_defs.md#awswafwebacldetailsoutputtypedef) 
41. See [:material-code-braces: AwsRdsDbSnapshotDetailsOutputTypeDef](./type_defs.md#awsrdsdbsnapshotdetailsoutputtypedef) 
42. See [:material-code-braces: AwsRdsDbClusterSnapshotDetailsOutputTypeDef](./type_defs.md#awsrdsdbclustersnapshotdetailsoutputtypedef) 
43. See [:material-code-braces: AwsRdsDbClusterDetailsOutputTypeDef](./type_defs.md#awsrdsdbclusterdetailsoutputtypedef) 
44. See [:material-code-braces: AwsEcsClusterDetailsOutputTypeDef](./type_defs.md#awsecsclusterdetailsoutputtypedef) 
45. See [:material-code-braces: AwsEcsContainerDetailsOutputTypeDef](./type_defs.md#awsecscontainerdetailsoutputtypedef) 
46. See [:material-code-braces: AwsEcsTaskDefinitionDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitiondetailsoutputtypedef) 
47. See [:material-code-braces: ContainerDetailsOutputTypeDef](./type_defs.md#containerdetailsoutputtypedef) 
48. See [:material-code-braces: AwsRdsEventSubscriptionDetailsOutputTypeDef](./type_defs.md#awsrdseventsubscriptiondetailsoutputtypedef) 
49. See [:material-code-braces: AwsEcsServiceDetailsOutputTypeDef](./type_defs.md#awsecsservicedetailsoutputtypedef) 
50. See [:material-code-braces: AwsAutoScalingLaunchConfigurationDetailsOutputTypeDef](./type_defs.md#awsautoscalinglaunchconfigurationdetailsoutputtypedef) 
51. See [:material-code-braces: AwsEc2VpnConnectionDetailsOutputTypeDef](./type_defs.md#awsec2vpnconnectiondetailsoutputtypedef) 
52. See [:material-code-braces: AwsEcrContainerImageDetailsOutputTypeDef](./type_defs.md#awsecrcontainerimagedetailsoutputtypedef) 
53. See [:material-code-braces: AwsOpenSearchServiceDomainDetailsOutputTypeDef](./type_defs.md#awsopensearchservicedomaindetailsoutputtypedef) 
54. See [:material-code-braces: AwsEc2VpcEndpointServiceDetailsOutputTypeDef](./type_defs.md#awsec2vpcendpointservicedetailsoutputtypedef) 
55. See [:material-code-braces: AwsXrayEncryptionConfigDetailsTypeDef](./type_defs.md#awsxrayencryptionconfigdetailstypedef) 
56. See [:material-code-braces: AwsWafRateBasedRuleDetailsOutputTypeDef](./type_defs.md#awswafratebasedruledetailsoutputtypedef) 
57. See [:material-code-braces: AwsWafRegionalRateBasedRuleDetailsOutputTypeDef](./type_defs.md#awswafregionalratebasedruledetailsoutputtypedef) 
58. See [:material-code-braces: AwsEcrRepositoryDetailsTypeDef](./type_defs.md#awsecrrepositorydetailstypedef) 
59. See [:material-code-braces: AwsEksClusterDetailsOutputTypeDef](./type_defs.md#awseksclusterdetailsoutputtypedef) 
60. See [:material-code-braces: AwsNetworkFirewallFirewallPolicyDetailsOutputTypeDef](./type_defs.md#awsnetworkfirewallfirewallpolicydetailsoutputtypedef) 
61. See [:material-code-braces: AwsNetworkFirewallFirewallDetailsOutputTypeDef](./type_defs.md#awsnetworkfirewallfirewalldetailsoutputtypedef) 
62. See [:material-code-braces: AwsNetworkFirewallRuleGroupDetailsOutputTypeDef](./type_defs.md#awsnetworkfirewallrulegroupdetailsoutputtypedef) 
63. See [:material-code-braces: AwsRdsDbSecurityGroupDetailsOutputTypeDef](./type_defs.md#awsrdsdbsecuritygroupdetailsoutputtypedef) 
64. See [:material-code-braces: AwsKinesisStreamDetailsTypeDef](./type_defs.md#awskinesisstreamdetailstypedef) 
65. See [:material-code-braces: AwsEc2TransitGatewayDetailsOutputTypeDef](./type_defs.md#awsec2transitgatewaydetailsoutputtypedef) 
66. See [:material-code-braces: AwsEfsAccessPointDetailsOutputTypeDef](./type_defs.md#awsefsaccesspointdetailsoutputtypedef) 
67. See [:material-code-braces: AwsCloudFormationStackDetailsOutputTypeDef](./type_defs.md#awscloudformationstackdetailsoutputtypedef) 
68. See [:material-code-braces: AwsCloudWatchAlarmDetailsOutputTypeDef](./type_defs.md#awscloudwatchalarmdetailsoutputtypedef) 
69. See [:material-code-braces: AwsEc2VpcPeeringConnectionDetailsOutputTypeDef](./type_defs.md#awsec2vpcpeeringconnectiondetailsoutputtypedef) 
70. See [:material-code-braces: AwsWafRegionalRuleGroupDetailsOutputTypeDef](./type_defs.md#awswafregionalrulegroupdetailsoutputtypedef) 
71. See [:material-code-braces: AwsWafRegionalRuleDetailsOutputTypeDef](./type_defs.md#awswafregionalruledetailsoutputtypedef) 
72. See [:material-code-braces: AwsWafRegionalWebAclDetailsOutputTypeDef](./type_defs.md#awswafregionalwebacldetailsoutputtypedef) 
73. See [:material-code-braces: AwsWafRuleDetailsOutputTypeDef](./type_defs.md#awswafruledetailsoutputtypedef) 
74. See [:material-code-braces: AwsWafRuleGroupDetailsOutputTypeDef](./type_defs.md#awswafrulegroupdetailsoutputtypedef) 
75. See [:material-code-braces: AwsEcsTaskDetailsOutputTypeDef](./type_defs.md#awsecstaskdetailsoutputtypedef) 
76. See [:material-code-braces: AwsBackupBackupVaultDetailsOutputTypeDef](./type_defs.md#awsbackupbackupvaultdetailsoutputtypedef) 
77. See [:material-code-braces: AwsBackupBackupPlanDetailsOutputTypeDef](./type_defs.md#awsbackupbackupplandetailsoutputtypedef) 
78. See [:material-code-braces: AwsBackupRecoveryPointDetailsTypeDef](./type_defs.md#awsbackuprecoverypointdetailstypedef) 
79. See [:material-code-braces: AwsEc2LaunchTemplateDetailsOutputTypeDef](./type_defs.md#awsec2launchtemplatedetailsoutputtypedef) 
80. See [:material-code-braces: AwsSageMakerNotebookInstanceDetailsOutputTypeDef](./type_defs.md#awssagemakernotebookinstancedetailsoutputtypedef) 
81. See [:material-code-braces: AwsWafv2WebAclDetailsOutputTypeDef](./type_defs.md#awswafv2webacldetailsoutputtypedef) 
82. See [:material-code-braces: AwsWafv2RuleGroupDetailsOutputTypeDef](./type_defs.md#awswafv2rulegroupdetailsoutputtypedef) 
83. See [:material-code-braces: AwsEc2RouteTableDetailsOutputTypeDef](./type_defs.md#awsec2routetabledetailsoutputtypedef) 
84. See [:material-code-braces: AwsAmazonMqBrokerDetailsOutputTypeDef](./type_defs.md#awsamazonmqbrokerdetailsoutputtypedef) 
85. See [:material-code-braces: AwsAppSyncGraphQlApiDetailsOutputTypeDef](./type_defs.md#awsappsyncgraphqlapidetailsoutputtypedef) 
86. See [:material-code-braces: AwsEventSchemasRegistryDetailsTypeDef](./type_defs.md#awseventschemasregistrydetailstypedef) 
87. See [:material-code-braces: AwsGuardDutyDetectorDetailsOutputTypeDef](./type_defs.md#awsguarddutydetectordetailsoutputtypedef) 
88. See [:material-code-braces: AwsStepFunctionStateMachineDetailsOutputTypeDef](./type_defs.md#awsstepfunctionstatemachinedetailsoutputtypedef) 
89. See [:material-code-braces: AwsAthenaWorkGroupDetailsTypeDef](./type_defs.md#awsathenaworkgroupdetailstypedef) 
90. See [:material-code-braces: AwsEventsEventbusDetailsTypeDef](./type_defs.md#awseventseventbusdetailstypedef) 
91. See [:material-code-braces: AwsDmsEndpointDetailsTypeDef](./type_defs.md#awsdmsendpointdetailstypedef) 
92. See [:material-code-braces: AwsEventsEndpointDetailsOutputTypeDef](./type_defs.md#awseventsendpointdetailsoutputtypedef) 
93. See [:material-code-braces: AwsDmsReplicationTaskDetailsTypeDef](./type_defs.md#awsdmsreplicationtaskdetailstypedef) 
94. See [:material-code-braces: AwsDmsReplicationInstanceDetailsOutputTypeDef](./type_defs.md#awsdmsreplicationinstancedetailsoutputtypedef) 
95. See [:material-code-braces: AwsRoute53HostedZoneDetailsOutputTypeDef](./type_defs.md#awsroute53hostedzonedetailsoutputtypedef) 
96. See [:material-code-braces: AwsMskClusterDetailsOutputTypeDef](./type_defs.md#awsmskclusterdetailsoutputtypedef) 
97. See [:material-code-braces: AwsS3AccessPointDetailsTypeDef](./type_defs.md#awss3accesspointdetailstypedef) 
98. See [:material-code-braces: AwsEc2ClientVpnEndpointDetailsOutputTypeDef](./type_defs.md#awsec2clientvpnendpointdetailsoutputtypedef) 
...
class AwsWafv2WebAclDetailsTypeDef(TypedDict):
    ...
    Description: NotRequired[str],
    Rules: NotRequired[Sequence[AwsWafv2RulesDetailsUnionTypeDef]],  # (3)
    VisibilityConfig: NotRequired[AwsWafv2VisibilityConfigDetailsTypeDef],  # (4)
```

1. See [:material-code-braces: AwsWafv2WebAclCaptchaConfigDetailsTypeDef](./type_defs.md#awswafv2webaclcaptchaconfigdetailstypedef) 
2. See [:material-code-braces: AwsWafv2WebAclActionDetailsTypeDef](./type_defs.md#awswafv2webaclactiondetailstypedef) [:material-code-braces: AwsWafv2WebAclActionDetailsOutputTypeDef](./type_defs.md#awswafv2webaclactiondetailsoutputtypedef) 
3. See [:material-code-braces: AwsWafv2RulesDetailsTypeDef](./type_defs.md#awswafv2rulesdetailstypedef) [:material-code-braces: AwsWafv2RulesDetailsOutputTypeDef](./type_defs.md#awswafv2rulesdetailsoutputtypedef) 
4. See [:material-code-braces: AwsWafv2VisibilityConfigDetailsTypeDef](./type_defs.md#awswafv2visibilityconfigdetailstypedef) 
...
2. See [:material-code-braces: DataClassificationDetailsOutputTypeDef](./type_defs.md#dataclassificationdetailsoutputtypedef) 
3. See [:material-code-braces: ResourceDetailsOutputTypeDef](./type_defs.md#resourcedetailsoutputtypedef) 
...
1. See [:material-code-braces: FirewallPolicyDetailsTypeDef](./type_defs.md#firewallpolicydetailstypedef) [:material-code-braces: FirewallPolicyDetailsOutputTypeDef](./type_defs.md#firewallpolicydetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsS3BucketServerSideEncryptionConfigurationTypeDef](./type_defs.md#awss3bucketserversideencryptionconfigurationtypedef) [:material-code-braces: AwsS3BucketServerSideEncryptionConfigurationOutputTypeDef](./type_defs.md#awss3bucketserversideencryptionconfigurationoutputtypedef) 
2. See [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationDetailsTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationdetailstypedef) [:material-code-braces: AwsS3BucketBucketLifecycleConfigurationDetailsOutputTypeDef](./type_defs.md#awss3bucketbucketlifecycleconfigurationdetailsoutputtypedef) 
3. See [:material-code-braces: AwsS3AccountPublicAccessBlockDetailsTypeDef](./type_defs.md#awss3accountpublicaccessblockdetailstypedef) 
4. See [:material-code-braces: AwsS3BucketLoggingConfigurationTypeDef](./type_defs.md#awss3bucketloggingconfigurationtypedef) 
5. See [:material-code-braces: AwsS3BucketWebsiteConfigurationTypeDef](./type_defs.md#awss3bucketwebsiteconfigurationtypedef) [:material-code-braces: AwsS3BucketWebsiteConfigurationOutputTypeDef](./type_defs.md#awss3bucketwebsiteconfigurationoutputtypedef) 
6. See [:material-code-braces: AwsS3BucketNotificationConfigurationTypeDef](./type_defs.md#awss3bucketnotificationconfigurationtypedef) [:material-code-braces: AwsS3BucketNotificationConfigurationOutputTypeDef](./type_defs.md#awss3bucketnotificationconfigurationoutputtypedef) 
7. See [:material-code-braces: AwsS3BucketBucketVersioningConfigurationTypeDef](./type_defs.md#awss3bucketbucketversioningconfigurationtypedef) 
8. See [:material-code-braces: AwsS3BucketObjectLockConfigurationTypeDef](./type_defs.md#awss3bucketobjectlockconfigurationtypedef) 
...
1. See [:material-code-braces: ClassificationResultTypeDef](./type_defs.md#classificationresulttypedef) [:material-code-braces: ClassificationResultOutputTypeDef](./type_defs.md#classificationresultoutputtypedef) 
## PolicyTypeDef
...
1. See [:material-code-braces: SecurityHubPolicyTypeDef](./type_defs.md#securityhubpolicytypedef) [:material-code-braces: SecurityHubPolicyOutputTypeDef](./type_defs.md#securityhubpolicyoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupSourceListDetailsTypeDef](./type_defs.md#rulegroupsourcelistdetailstypedef) [:material-code-braces: RuleGroupSourceListDetailsOutputTypeDef](./type_defs.md#rulegroupsourcelistdetailsoutputtypedef) 
2. See [:material-code-braces: RuleGroupSourceStatefulRulesDetailsTypeDef](./type_defs.md#rulegroupsourcestatefulrulesdetailstypedef) [:material-code-braces: RuleGroupSourceStatefulRulesDetailsOutputTypeDef](./type_defs.md#rulegroupsourcestatefulrulesdetailsoutputtypedef) 
3. See [:material-code-braces: RuleGroupSourceStatelessRulesAndCustomActionsDetailsTypeDef](./type_defs.md#rulegroupsourcestatelessrulesandcustomactionsdetailstypedef) [:material-code-braces: RuleGroupSourceStatelessRulesAndCustomActionsDetailsOutputTypeDef](./type_defs.md#rulegroupsourcestatelessrulesandcustomactionsdetailsoutputtypedef) 
...
5. See [:material-code-braces: NetworkPathComponentOutputTypeDef](./type_defs.md#networkpathcomponentoutputtypedef) 
6. See [:material-code-braces: ProcessDetailsTypeDef](./type_defs.md#processdetailstypedef) 
7. See [:material-code-braces: ThreatOutputTypeDef](./type_defs.md#threatoutputtypedef) 
8. See [:material-code-braces: ThreatIntelIndicatorTypeDef](./type_defs.md#threatintelindicatortypedef) 
9. See [:material-code-braces: ResourceOutputTypeDef](./type_defs.md#resourceoutputtypedef) 
10. See [:material-code-braces: ComplianceOutputTypeDef](./type_defs.md#complianceoutputtypedef) 
...
17. See [:material-code-braces: VulnerabilityOutputTypeDef](./type_defs.md#vulnerabilityoutputtypedef) 
18. See [:material-code-braces: PatchSummaryTypeDef](./type_defs.md#patchsummarytypedef) 
19. See [:material-code-braces: ActionOutputTypeDef](./type_defs.md#actionoutputtypedef) 
20. See [:material-code-braces: FindingProviderFieldsOutputTypeDef](./type_defs.md#findingproviderfieldsoutputtypedef) 
21. See [:material-code-braces: GeneratorDetailsOutputTypeDef](./type_defs.md#generatordetailsoutputtypedef) 
22. See [:material-code-braces: DetectionOutputTypeDef](./type_defs.md#detectionoutputtypedef) 
...
1. See [:material-code-braces: AwsSecurityFindingOutputTypeDef](./type_defs.md#awssecurityfindingoutputtypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
1. See [:material-code-braces: RuleGroupVariablesTypeDef](./type_defs.md#rulegroupvariablestypedef) [:material-code-braces: RuleGroupVariablesOutputTypeDef](./type_defs.md#rulegroupvariablesoutputtypedef) 
2. See [:material-code-braces: RuleGroupSourceTypeDef](./type_defs.md#rulegroupsourcetypedef) [:material-code-braces: RuleGroupSourceOutputTypeDef](./type_defs.md#rulegroupsourceoutputtypedef) 
...
1. See [:material-code-braces: RuleGroupDetailsTypeDef](./type_defs.md#rulegroupdetailstypedef) [:material-code-braces: RuleGroupDetailsOutputTypeDef](./type_defs.md#rulegroupdetailsoutputtypedef) 
...
1. See [:material-code-braces: AwsAutoScalingAutoScalingGroupDetailsTypeDef](./type_defs.md#awsautoscalingautoscalinggroupdetailstypedef) [:material-code-braces: AwsAutoScalingAutoScalingGroupDetailsOutputTypeDef](./type_defs.md#awsautoscalingautoscalinggroupdetailsoutputtypedef) 
2. See [:material-code-braces: AwsCodeBuildProjectDetailsTypeDef](./type_defs.md#awscodebuildprojectdetailstypedef) [:material-code-braces: AwsCodeBuildProjectDetailsOutputTypeDef](./type_defs.md#awscodebuildprojectdetailsoutputtypedef) 
3. See [:material-code-braces: AwsCloudFrontDistributionDetailsTypeDef](./type_defs.md#awscloudfrontdistributiondetailstypedef) [:material-code-braces: AwsCloudFrontDistributionDetailsOutputTypeDef](./type_defs.md#awscloudfrontdistributiondetailsoutputtypedef) 
4. See [:material-code-braces: AwsEc2InstanceDetailsTypeDef](./type_defs.md#awsec2instancedetailstypedef) [:material-code-braces: AwsEc2InstanceDetailsOutputTypeDef](./type_defs.md#awsec2instancedetailsoutputtypedef) 
5. See [:material-code-braces: AwsEc2NetworkInterfaceDetailsTypeDef](./type_defs.md#awsec2networkinterfacedetailstypedef) [:material-code-braces: AwsEc2NetworkInterfaceDetailsOutputTypeDef](./type_defs.md#awsec2networkinterfacedetailsoutputtypedef) 
6. See [:material-code-braces: AwsEc2SecurityGroupDetailsTypeDef](./type_defs.md#awsec2securitygroupdetailstypedef) [:material-code-braces: AwsEc2SecurityGroupDetailsOutputTypeDef](./type_defs.md#awsec2securitygroupdetailsoutputtypedef) 
7. See [:material-code-braces: AwsEc2VolumeDetailsTypeDef](./type_defs.md#awsec2volumedetailstypedef) [:material-code-braces: AwsEc2VolumeDetailsOutputTypeDef](./type_defs.md#awsec2volumedetailsoutputtypedef) 
8. See [:material-code-braces: AwsEc2VpcDetailsTypeDef](./type_defs.md#awsec2vpcdetailstypedef) [:material-code-braces: AwsEc2VpcDetailsOutputTypeDef](./type_defs.md#awsec2vpcdetailsoutputtypedef) 
9. See [:material-code-braces: AwsEc2EipDetailsTypeDef](./type_defs.md#awsec2eipdetailstypedef) 
10. See [:material-code-braces: AwsEc2SubnetDetailsTypeDef](./type_defs.md#awsec2subnetdetailstypedef) [:material-code-braces: AwsEc2SubnetDetailsOutputTypeDef](./type_defs.md#awsec2subnetdetailsoutputtypedef) 
11. See [:material-code-braces: AwsEc2NetworkAclDetailsTypeDef](./type_defs.md#awsec2networkacldetailstypedef) [:material-code-braces: AwsEc2NetworkAclDetailsOutputTypeDef](./type_defs.md#awsec2networkacldetailsoutputtypedef) 
12. See [:material-code-braces: AwsElbv2LoadBalancerDetailsTypeDef](./type_defs.md#awselbv2loadbalancerdetailstypedef) [:material-code-braces: AwsElbv2LoadBalancerDetailsOutputTypeDef](./type_defs.md#awselbv2loadbalancerdetailsoutputtypedef) 
13. See [:material-code-braces: AwsElasticBeanstalkEnvironmentDetailsTypeDef](./type_defs.md#awselasticbeanstalkenvironmentdetailstypedef) [:material-code-braces: AwsElasticBeanstalkEnvironmentDetailsOutputTypeDef](./type_defs.md#awselasticbeanstalkenvironmentdetailsoutputtypedef) 
14. See [:material-code-braces: AwsElasticsearchDomainDetailsTypeDef](./type_defs.md#awselasticsearchdomaindetailstypedef) [:material-code-braces: AwsElasticsearchDomainDetailsOutputTypeDef](./type_defs.md#awselasticsearchdomaindetailsoutputtypedef) 
15. See [:material-code-braces: AwsS3BucketDetailsTypeDef](./type_defs.md#awss3bucketdetailstypedef) [:material-code-braces: AwsS3BucketDetailsOutputTypeDef](./type_defs.md#awss3bucketdetailsoutputtypedef) 
16. See [:material-code-braces: AwsS3AccountPublicAccessBlockDetailsTypeDef](./type_defs.md#awss3accountpublicaccessblockdetailstypedef) 
17. See [:material-code-braces: AwsS3ObjectDetailsTypeDef](./type_defs.md#awss3objectdetailstypedef) 
18. See [:material-code-braces: AwsSecretsManagerSecretDetailsTypeDef](./type_defs.md#awssecretsmanagersecretdetailstypedef) 
19. See [:material-code-braces: AwsIamAccessKeyDetailsTypeDef](./type_defs.md#awsiamaccesskeydetailstypedef) 
20. See [:material-code-braces: AwsIamUserDetailsTypeDef](./type_defs.md#awsiamuserdetailstypedef) [:material-code-braces: AwsIamUserDetailsOutputTypeDef](./type_defs.md#awsiamuserdetailsoutputtypedef) 
21. See [:material-code-braces: AwsIamPolicyDetailsTypeDef](./type_defs.md#awsiampolicydetailstypedef) [:material-code-braces: AwsIamPolicyDetailsOutputTypeDef](./type_defs.md#awsiampolicydetailsoutputtypedef) 
22. See [:material-code-braces: AwsApiGatewayV2StageDetailsTypeDef](./type_defs.md#awsapigatewayv2stagedetailstypedef) [:material-code-braces: AwsApiGatewayV2StageDetailsOutputTypeDef](./type_defs.md#awsapigatewayv2stagedetailsoutputtypedef) 
23. See [:material-code-braces: AwsApiGatewayV2ApiDetailsTypeDef](./type_defs.md#awsapigatewayv2apidetailstypedef) [:material-code-braces: AwsApiGatewayV2ApiDetailsOutputTypeDef](./type_defs.md#awsapigatewayv2apidetailsoutputtypedef) 
24. See [:material-code-braces: AwsDynamoDbTableDetailsTypeDef](./type_defs.md#awsdynamodbtabledetailstypedef) [:material-code-braces: AwsDynamoDbTableDetailsOutputTypeDef](./type_defs.md#awsdynamodbtabledetailsoutputtypedef) 
25. See [:material-code-braces: AwsApiGatewayStageDetailsTypeDef](./type_defs.md#awsapigatewaystagedetailstypedef) [:material-code-braces: AwsApiGatewayStageDetailsOutputTypeDef](./type_defs.md#awsapigatewaystagedetailsoutputtypedef) 
26. See [:material-code-braces: AwsApiGatewayRestApiDetailsTypeDef](./type_defs.md#awsapigatewayrestapidetailstypedef) [:material-code-braces: AwsApiGatewayRestApiDetailsOutputTypeDef](./type_defs.md#awsapigatewayrestapidetailsoutputtypedef) 
27. See [:material-code-braces: AwsCloudTrailTrailDetailsTypeDef](./type_defs.md#awscloudtrailtraildetailstypedef) 
28. See [:material-code-braces: AwsSsmPatchComplianceDetailsTypeDef](./type_defs.md#awsssmpatchcompliancedetailstypedef) 
29. See [:material-code-braces: AwsCertificateManagerCertificateDetailsTypeDef](./type_defs.md#awscertificatemanagercertificatedetailstypedef) [:material-code-braces: AwsCertificateManagerCertificateDetailsOutputTypeDef](./type_defs.md#awscertificatemanagercertificatedetailsoutputtypedef) 
30. See [:material-code-braces: AwsRedshiftClusterDetailsTypeDef](./type_defs.md#awsredshiftclusterdetailstypedef) [:material-code-braces: AwsRedshiftClusterDetailsOutputTypeDef](./type_defs.md#awsredshiftclusterdetailsoutputtypedef) 
31. See [:material-code-braces: AwsElbLoadBalancerDetailsTypeDef](./type_defs.md#awselbloadbalancerdetailstypedef) [:material-code-braces: AwsElbLoadBalancerDetailsOutputTypeDef](./type_defs.md#awselbloadbalancerdetailsoutputtypedef) 
32. See [:material-code-braces: AwsIamGroupDetailsTypeDef](./type_defs.md#awsiamgroupdetailstypedef) [:material-code-braces: AwsIamGroupDetailsOutputTypeDef](./type_defs.md#awsiamgroupdetailsoutputtypedef) 
33. See [:material-code-braces: AwsIamRoleDetailsTypeDef](./type_defs.md#awsiamroledetailstypedef) [:material-code-braces: AwsIamRoleDetailsOutputTypeDef](./type_defs.md#awsiamroledetailsoutputtypedef) 
34. See [:material-code-braces: AwsKmsKeyDetailsTypeDef](./type_defs.md#awskmskeydetailstypedef) 
35. See [:material-code-braces: AwsLambdaFunctionDetailsTypeDef](./type_defs.md#awslambdafunctiondetailstypedef) [:material-code-braces: AwsLambdaFunctionDetailsOutputTypeDef](./type_defs.md#awslambdafunctiondetailsoutputtypedef) 
36. See [:material-code-braces: AwsLambdaLayerVersionDetailsTypeDef](./type_defs.md#awslambdalayerversiondetailstypedef) [:material-code-braces: AwsLambdaLayerVersionDetailsOutputTypeDef](./type_defs.md#awslambdalayerversiondetailsoutputtypedef) 
37. See [:material-code-braces: AwsRdsDbInstanceDetailsTypeDef](./type_defs.md#awsrdsdbinstancedetailstypedef) [:material-code-braces: AwsRdsDbInstanceDetailsOutputTypeDef](./type_defs.md#awsrdsdbinstancedetailsoutputtypedef) 
38. See [:material-code-braces: AwsSnsTopicDetailsTypeDef](./type_defs.md#awssnstopicdetailstypedef) [:material-code-braces: AwsSnsTopicDetailsOutputTypeDef](./type_defs.md#awssnstopicdetailsoutputtypedef) 
39. See [:material-code-braces: AwsSqsQueueDetailsTypeDef](./type_defs.md#awssqsqueuedetailstypedef) 
40. See [:material-code-braces: AwsWafWebAclDetailsTypeDef](./type_defs.md#awswafwebacldetailstypedef) [:material-code-braces: AwsWafWebAclDetailsOutputTypeDef](./type_defs.md#awswafwebacldetailsoutputtypedef) 
41. See [:material-code-braces: AwsRdsDbSnapshotDetailsTypeDef](./type_defs.md#awsrdsdbsnapshotdetailstypedef) [:material-code-braces: AwsRdsDbSnapshotDetailsOutputTypeDef](./type_defs.md#awsrdsdbsnapshotdetailsoutputtypedef) 
42. See [:material-code-braces: AwsRdsDbClusterSnapshotDetailsTypeDef](./type_defs.md#awsrdsdbclustersnapshotdetailstypedef) [:material-code-braces: AwsRdsDbClusterSnapshotDetailsOutputTypeDef](./type_defs.md#awsrdsdbclustersnapshotdetailsoutputtypedef) 
43. See [:material-code-braces: AwsRdsDbClusterDetailsTypeDef](./type_defs.md#awsrdsdbclusterdetailstypedef) [:material-code-braces: AwsRdsDbClusterDetailsOutputTypeDef](./type_defs.md#awsrdsdbclusterdetailsoutputtypedef) 
44. See [:material-code-braces: AwsEcsClusterDetailsTypeDef](./type_defs.md#awsecsclusterdetailstypedef) [:material-code-braces: AwsEcsClusterDetailsOutputTypeDef](./type_defs.md#awsecsclusterdetailsoutputtypedef) 
45. See [:material-code-braces: AwsEcsContainerDetailsTypeDef](./type_defs.md#awsecscontainerdetailstypedef) [:material-code-braces: AwsEcsContainerDetailsOutputTypeDef](./type_defs.md#awsecscontainerdetailsoutputtypedef) 
46. See [:material-code-braces: AwsEcsTaskDefinitionDetailsTypeDef](./type_defs.md#awsecstaskdefinitiondetailstypedef) [:material-code-braces: AwsEcsTaskDefinitionDetailsOutputTypeDef](./type_defs.md#awsecstaskdefinitiondetailsoutputtypedef) 
47. See [:material-code-braces: ContainerDetailsTypeDef](./type_defs.md#containerdetailstypedef) [:material-code-braces: ContainerDetailsOutputTypeDef](./type_defs.md#containerdetailsoutputtypedef) 
48. See [:material-code-braces: AwsRdsEventSubscriptionDetailsTypeDef](./type_defs.md#awsrdseventsubscriptiondetailstypedef) [:material-code-braces: AwsRdsEventSubscriptionDetailsOutputTypeDef](./type_defs.md#awsrdseventsubscriptiondetailsoutputtypedef) 
49. See [:material-code-braces: AwsEcsServiceDetailsTypeDef](./type_defs.md#awsecsservicedetailstypedef) [:material-code-braces: AwsEcsServiceDetailsOutputTypeDef](./type_defs.md#awsecsservicedetailsoutputtypedef) 
50. See [:material-code-braces: AwsAutoScalingLaunchConfigurationDetailsTypeDef](./type_defs.md#awsautoscalinglaunchconfigurationdetailstypedef) [:material-code-braces: AwsAutoScalingLaunchConfigurationDetailsOutputTypeDef](./type_defs.md#awsautoscalinglaunchconfigurationdetailsoutputtypedef) 
51. See [:material-code-braces: AwsEc2VpnConnectionDetailsTypeDef](./type_defs.md#awsec2vpnconnectiondetailstypedef) [:material-code-braces: AwsEc2VpnConnectionDetailsOutputTypeDef](./type_defs.md#awsec2vpnconnectiondetailsoutputtypedef) 
52. See [:material-code-braces: AwsEcrContainerImageDetailsTypeDef](./type_defs.md#awsecrcontainerimagedetailstypedef) [:material-code-braces: AwsEcrContainerImageDetailsOutputTypeDef](./type_defs.md#awsecrcontainerimagedetailsoutputtypedef) 
53. See [:material-code-braces: AwsOpenSearchServiceDomainDetailsTypeDef](./type_defs.md#awsopensearchservicedomaindetailstypedef) [:material-code-braces: AwsOpenSearchServiceDomainDetailsOutputTypeDef](./type_defs.md#awsopensearchservicedomaindetailsoutputtypedef) 
54. See [:material-code-braces: AwsEc2VpcEndpointServiceDetailsTypeDef](./type_defs.md#awsec2vpcendpointservicedetailstypedef) [:material-code-braces: AwsEc2VpcEndpointServiceDetailsOutputTypeDef](./type_defs.md#awsec2vpcendpointservicedetailsoutputtypedef) 
55. See [:material-code-braces: AwsXrayEncryptionConfigDetailsTypeDef](./type_defs.md#awsxrayencryptionconfigdetailstypedef) 
56. See [:material-code-braces: AwsWafRateBasedRuleDetailsTypeDef](./type_defs.md#awswafratebasedruledetailstypedef) [:material-code-braces: AwsWafRateBasedRuleDetailsOutputTypeDef](./type_defs.md#awswafratebasedruledetailsoutputtypedef) 
57. See [:material-code-braces: AwsWafRegionalRateBasedRuleDetailsTypeDef](./type_defs.md#awswafregionalratebasedruledetailstypedef) [:material-code-braces: AwsWafRegionalRateBasedRuleDetailsOutputTypeDef](./type_defs.md#awswafregionalratebasedruledetailsoutputtypedef) 
58. See [:material-code-braces: AwsEcrRepositoryDetailsTypeDef](./type_defs.md#awsecrrepositorydetailstypedef) 
59. See [:material-code-braces: AwsEksClusterDetailsTypeDef](./type_defs.md#awseksclusterdetailstypedef) [:material-code-braces: AwsEksClusterDetailsOutputTypeDef](./type_defs.md#awseksclusterdetailsoutputtypedef) 
60. See [:material-code-braces: AwsNetworkFirewallFirewallPolicyDetailsTypeDef](./type_defs.md#awsnetworkfirewallfirewallpolicydetailstypedef) [:material-code-braces: AwsNetworkFirewallFirewallPolicyDetailsOutputTypeDef](./type_defs.md#awsnetworkfirewallfirewallpolicydetailsoutputtypedef) 
61. See [:material-code-braces: AwsNetworkFirewallFirewallDetailsTypeDef](./type_defs.md#awsnetworkfirewallfirewalldetailstypedef) [:material-code-braces: AwsNetworkFirewallFirewallDetailsOutputTypeDef](./type_defs.md#awsnetworkfirewallfirewalldetailsoutputtypedef) 
62. See [:material-code-braces: AwsNetworkFirewallRuleGroupDetailsTypeDef](./type_defs.md#awsnetworkfirewallrulegroupdetailstypedef) [:material-code-braces: AwsNetworkFirewallRuleGroupDetailsOutputTypeDef](./type_defs.md#awsnetworkfirewallrulegroupdetailsoutputtypedef) 
63. See [:material-code-braces: AwsRdsDbSecurityGroupDetailsTypeDef](./type_defs.md#awsrdsdbsecuritygroupdetailstypedef) [:material-code-braces: AwsRdsDbSecurityGroupDetailsOutputTypeDef](./type_defs.md#awsrdsdbsecuritygroupdetailsoutputtypedef) 
64. See [:material-code-braces: AwsKinesisStreamDetailsTypeDef](./type_defs.md#awskinesisstreamdetailstypedef) 
65. See [:material-code-braces: AwsEc2TransitGatewayDetailsTypeDef](./type_defs.md#awsec2transitgatewaydetailstypedef) [:material-code-braces: AwsEc2TransitGatewayDetailsOutputTypeDef](./type_defs.md#awsec2transitgatewaydetailsoutputtypedef) 
66. See [:material-code-braces: AwsEfsAccessPointDetailsTypeDef](./type_defs.md#awsefsaccesspointdetailstypedef) [:material-code-braces: AwsEfsAccessPointDetailsOutputTypeDef](./type_defs.md#awsefsaccesspointdetailsoutputtypedef) 
67. See [:material-code-braces: AwsCloudFormationStackDetailsTypeDef](./type_defs.md#awscloudformationstackdetailstypedef) [:material-code-braces: AwsCloudFormationStackDetailsOutputTypeDef](./type_defs.md#awscloudformationstackdetailsoutputtypedef) 
68. See [:material-code-braces: AwsCloudWatchAlarmDetailsTypeDef](./type_defs.md#awscloudwatchalarmdetailstypedef) [:material-code-braces: AwsCloudWatchAlarmDetailsOutputTypeDef](./type_defs.md#awscloudwatchalarmdetailsoutputtypedef) 
69. See [:material-code-braces: AwsEc2VpcPeeringConnectionDetailsTypeDef](./type_defs.md#awsec2vpcpeeringconnectiondetailstypedef) [:material-code-braces: AwsEc2VpcPeeringConnectionDetailsOutputTypeDef](./type_defs.md#awsec2vpcpeeringconnectiondetailsoutputtypedef) 
70. See [:material-code-braces: AwsWafRegionalRuleGroupDetailsTypeDef](./type_defs.md#awswafregionalrulegroupdetailstypedef) [:material-code-braces: AwsWafRegionalRuleGroupDetailsOutputTypeDef](./type_defs.md#awswafregionalrulegroupdetailsoutputtypedef) 
71. See [:material-code-braces: AwsWafRegionalRuleDetailsTypeDef](./type_defs.md#awswafregionalruledetailstypedef) [:material-code-braces: AwsWafRegionalRuleDetailsOutputTypeDef](./type_defs.md#awswafregionalruledetailsoutputtypedef) 
72. See [:material-code-braces: AwsWafRegionalWebAclDetailsTypeDef](./type_defs.md#awswafregionalwebacldetailstypedef) [:material-code-braces: AwsWafRegionalWebAclDetailsOutputTypeDef](./type_defs.md#awswafregionalwebacldetailsoutputtypedef) 
73. See [:material-code-braces: AwsWafRuleDetailsTypeDef](./type_defs.md#awswafruledetailstypedef) [:material-code-braces: AwsWafRuleDetailsOutputTypeDef](./type_defs.md#awswafruledetailsoutputtypedef) 
74. See [:material-code-braces: AwsWafRuleGroupDetailsTypeDef](./type_defs.md#awswafrulegroupdetailstypedef) [:material-code-braces: AwsWafRuleGroupDetailsOutputTypeDef](./type_defs.md#awswafrulegroupdetailsoutputtypedef) 
75. See [:material-code-braces: AwsEcsTaskDetailsTypeDef](./type_defs.md#awsecstaskdetailstypedef) [:material-code-braces: AwsEcsTaskDetailsOutputTypeDef](./type_defs.md#awsecstaskdetailsoutputtypedef) 
76. See [:material-code-braces: AwsBackupBackupVaultDetailsTypeDef](./type_defs.md#awsbackupbackupvaultdetailstypedef) [:material-code-braces: AwsBackupBackupVaultDetailsOutputTypeDef](./type_defs.md#awsbackupbackupvaultdetailsoutputtypedef) 
77. See [:material-code-braces: AwsBackupBackupPlanDetailsTypeDef](./type_defs.md#awsbackupbackupplandetailstypedef) [:material-code-braces: AwsBackupBackupPlanDetailsOutputTypeDef](./type_defs.md#awsbackupbackupplandetailsoutputtypedef) 
78. See [:material-code-braces: AwsBackupRecoveryPointDetailsTypeDef](./type_defs.md#awsbackuprecoverypointdetailstypedef) 
79. See [:material-code-braces: AwsEc2LaunchTemplateDetailsTypeDef](./type_defs.md#awsec2launchtemplatedetailstypedef) [:material-code-braces: AwsEc2LaunchTemplateDetailsOutputTypeDef](./type_defs.md#awsec2launchtemplatedetailsoutputtypedef) 
80. See [:material-code-braces: AwsSageMakerNotebookInstanceDetailsTypeDef](./type_defs.md#awssagemakernotebookinstancedetailstypedef) [:material-code-braces: AwsSageMakerNotebookInstanceDetailsOutputTypeDef](./type_defs.md#awssagemakernotebookinstancedetailsoutputtypedef) 
81. See [:material-code-braces: AwsWafv2WebAclDetailsTypeDef](./type_defs.md#awswafv2webacldetailstypedef) [:material-code-braces: AwsWafv2WebAclDetailsOutputTypeDef](./type_defs.md#awswafv2webacldetailsoutputtypedef) 
82. See [:material-code-braces: AwsWafv2RuleGroupDetailsTypeDef](./type_defs.md#awswafv2rulegroupdetailstypedef) [:material-code-braces: AwsWafv2RuleGroupDetailsOutputTypeDef](./type_defs.md#awswafv2rulegroupdetailsoutputtypedef) 
83. See [:material-code-braces: AwsEc2RouteTableDetailsTypeDef](./type_defs.md#awsec2routetabledetailstypedef) [:material-code-braces: AwsEc2RouteTableDetailsOutputTypeDef](./type_defs.md#awsec2routetabledetailsoutputtypedef) 
84. See [:material-code-braces: AwsAmazonMqBrokerDetailsTypeDef](./type_defs.md#awsamazonmqbrokerdetailstypedef) [:material-code-braces: AwsAmazonMqBrokerDetailsOutputTypeDef](./type_defs.md#awsamazonmqbrokerdetailsoutputtypedef) 
85. See [:material-code-braces: AwsAppSyncGraphQlApiDetailsTypeDef](./type_defs.md#awsappsyncgraphqlapidetailstypedef) [:material-code-braces: AwsAppSyncGraphQlApiDetailsOutputTypeDef](./type_defs.md#awsappsyncgraphqlapidetailsoutputtypedef) 
86. See [:material-code-braces: AwsEventSchemasRegistryDetailsTypeDef](./type_defs.md#awseventschemasregistrydetailstypedef) 
87. See [:material-code-braces: AwsGuardDutyDetectorDetailsTypeDef](./type_defs.md#awsguarddutydetectordetailstypedef) [:material-code-braces: AwsGuardDutyDetectorDetailsOutputTypeDef](./type_defs.md#awsguarddutydetectordetailsoutputtypedef) 
88. See [:material-code-braces: AwsStepFunctionStateMachineDetailsTypeDef](./type_defs.md#awsstepfunctionstatemachinedetailstypedef) [:material-code-braces: AwsStepFunctionStateMachineDetailsOutputTypeDef](./type_defs.md#awsstepfunctionstatemachinedetailsoutputtypedef) 
89. See [:material-code-braces: AwsAthenaWorkGroupDetailsTypeDef](./type_defs.md#awsathenaworkgroupdetailstypedef) 
90. See [:material-code-braces: AwsEventsEventbusDetailsTypeDef](./type_defs.md#awseventseventbusdetailstypedef) 
91. See [:material-code-braces: AwsDmsEndpointDetailsTypeDef](./type_defs.md#awsdmsendpointdetailstypedef) 
92. See [:material-code-braces: AwsEventsEndpointDetailsTypeDef](./type_defs.md#awseventsendpointdetailstypedef) [:material-code-braces: AwsEventsEndpointDetailsOutputTypeDef](./type_defs.md#awseventsendpointdetailsoutputtypedef) 
93. See [:material-code-braces: AwsDmsReplicationTaskDetailsTypeDef](./type_defs.md#awsdmsreplicationtaskdetailstypedef) 
94. See [:material-code-braces: AwsDmsReplicationInstanceDetailsTypeDef](./type_defs.md#awsdmsreplicationinstancedetailstypedef) [:material-code-braces: AwsDmsReplicationInstanceDetailsOutputTypeDef](./type_defs.md#awsdmsreplicationinstancedetailsoutputtypedef) 
95. See [:material-code-braces: AwsRoute53HostedZoneDetailsTypeDef](./type_defs.md#awsroute53hostedzonedetailstypedef) [:material-code-braces: AwsRoute53HostedZoneDetailsOutputTypeDef](./type_defs.md#awsroute53hostedzonedetailsoutputtypedef) 
96. See [:material-code-braces: AwsMskClusterDetailsTypeDef](./type_defs.md#awsmskclusterdetailstypedef) [:material-code-braces: AwsMskClusterDetailsOutputTypeDef](./type_defs.md#awsmskclusterdetailsoutputtypedef) 
97. See [:material-code-braces: AwsS3AccessPointDetailsTypeDef](./type_defs.md#awss3accesspointdetailstypedef) 
98. See [:material-code-braces: AwsEc2ClientVpnEndpointDetailsTypeDef](./type_defs.md#awsec2clientvpnendpointdetailstypedef) [:material-code-braces: AwsEc2ClientVpnEndpointDetailsOutputTypeDef](./type_defs.md#awsec2clientvpnendpointdetailsoutputtypedef) 
## ResourceTypeDef
...
1. See [:material-code-brackets: PartitionType](./literals.md#partitiontype) 
2. See [:material-code-braces: DataClassificationDetailsTypeDef](./type_defs.md#dataclassificationdetailstypedef) [:material-code-braces: DataClassificationDetailsOutputTypeDef](./type_defs.md#dataclassificationdetailsoutputtypedef) 
3. See [:material-code-braces: ResourceDetailsTypeDef](./type_defs.md#resourcedetailstypedef) [:material-code-braces: ResourceDetailsOutputTypeDef](./type_defs.md#resourcedetailsoutputtypedef) 
...
3. See [:material-code-braces: MalwareTypeDef](./type_defs.md#malwaretypedef) 
4. See [:material-code-braces: NetworkTypeDef](./type_defs.md#networktypedef) 
5. See [:material-code-braces: NetworkPathComponentTypeDef](./type_defs.md#networkpathcomponenttypedef) [:material-code-braces: NetworkPathComponentOutputTypeDef](./type_defs.md#networkpathcomponentoutputtypedef) 
6. See [:material-code-braces: ProcessDetailsTypeDef](./type_defs.md#processdetailstypedef) 
7. See [:material-code-braces: ThreatTypeDef](./type_defs.md#threattypedef) [:material-code-braces: ThreatOutputTypeDef](./type_defs.md#threatoutputtypedef) 
8. See [:material-code-braces: ThreatIntelIndicatorTypeDef](./type_defs.md#threatintelindicatortypedef) 
9. See [:material-code-braces: ResourceTypeDef](./type_defs.md#resourcetypedef) [:material-code-braces: ResourceOutputTypeDef](./type_defs.md#resourceoutputtypedef) 
10. See [:material-code-braces: ComplianceTypeDef](./type_defs.md#compliancetypedef) [:material-code-braces: ComplianceOutputTypeDef](./type_defs.md#complianceoutputtypedef) 
11. See [:material-code-brackets: VerificationStateType](./literals.md#verificationstatetype) 
12. See [:material-code-brackets: WorkflowStateType](./literals.md#workflowstatetype) 
13. See [:material-code-braces: WorkflowTypeDef](./type_defs.md#workflowtypedef) 
14. See [:material-code-brackets: RecordStateType](./literals.md#recordstatetype) 
15. See [:material-code-braces: RelatedFindingTypeDef](./type_defs.md#relatedfindingtypedef) 
16. See [:material-code-braces: NoteTypeDef](./type_defs.md#notetypedef) 
17. See [:material-code-braces: VulnerabilityTypeDef](./type_defs.md#vulnerabilitytypedef) [:material-code-braces: VulnerabilityOutputTypeDef](./type_defs.md#vulnerabilityoutputtypedef) 
18. See [:material-code-braces: PatchSummaryTypeDef](./type_defs.md#patchsummarytypedef) 
19. See [:material-code-braces: ActionTypeDef](./type_defs.md#actiontypedef) [:material-code-braces: ActionOutputTypeDef](./type_defs.md#actionoutputtypedef) 
20. See [:material-code-braces: FindingProviderFieldsTypeDef](./type_defs.md#findingproviderfieldstypedef) [:material-code-braces: FindingProviderFieldsOutputTypeDef](./type_defs.md#findingproviderfieldsoutputtypedef) 
21. See [:material-code-braces: GeneratorDetailsTypeDef](./type_defs.md#generatordetailstypedef) [:material-code-braces: GeneratorDetailsOutputTypeDef](./type_defs.md#generatordetailsoutputtypedef) 
22. See [:material-code-braces: DetectionTypeDef](./type_defs.md#detectiontypedef) [:material-code-braces: DetectionOutputTypeDef](./type_defs.md#detectionoutputtypedef) 
