...
51. See [:material-code-braces: DynamicTransformUnionTypeDef](#dynamictransformuniontypedef)
52. See [:material-code-braces: EvaluateDataQualityUnionTypeDef](#evaluatedataqualityuniontypedef)
53. See [:material-code-braces: S3CatalogHudiSourceUnionTypeDef](#s3cataloghudisourceuniontypedef)
54. See [:material-code-braces: CatalogHudiSourceUnionTypeDef](#cataloghudisourceuniontypedef)
55. See [:material-code-braces: S3HudiSourceUnionTypeDef](#s3hudisourceuniontypedef)
56. See [:material-code-braces: S3HudiCatalogTargetUnionTypeDef](#s3hudicatalogtargetuniontypedef)
57. See [:material-code-braces: S3HudiDirectTargetUnionTypeDef](#s3hudidirecttargetuniontypedef)
58. See [:material-code-braces: DirectJDBCSourceTypeDef](./type_defs.md#directjdbcsourcetypedef)
59. See [:material-code-braces: S3CatalogDeltaSourceUnionTypeDef](#s3catalogdeltasourceuniontypedef)
60. See [:material-code-braces: CatalogDeltaSourceUnionTypeDef](#catalogdeltasourceuniontypedef)
61. See [:material-code-braces: S3DeltaSourceUnionTypeDef](#s3deltasourceuniontypedef)
62. See [:material-code-braces: S3DeltaCatalogTargetUnionTypeDef](#s3deltacatalogtargetuniontypedef)
63. See [:material-code-braces: S3DeltaDirectTargetUnionTypeDef](#s3deltadirecttargetuniontypedef)
64. See [:material-code-braces: AmazonRedshiftSourceUnionTypeDef](#amazonredshiftsourceuniontypedef)
65. See [:material-code-braces: AmazonRedshiftTargetUnionTypeDef](#amazonredshifttargetuniontypedef)
66. See [:material-code-braces: EvaluateDataQualityMultiFrameUnionTypeDef](#evaluatedataqualitymultiframeuniontypedef)
67. See [:material-code-braces: RecipeUnionTypeDef](#recipeuniontypedef)
68. See [:material-code-braces: SnowflakeSourceUnionTypeDef](#snowflakesourceuniontypedef)
69. See [:material-code-braces: SnowflakeTargetUnionTypeDef](#snowflaketargetuniontypedef)
70. See [:material-code-braces: ConnectorDataSourceUnionTypeDef](#connectordatasourceuniontypedef)
71. See [:material-code-braces: ConnectorDataTargetUnionTypeDef](#connectordatatargetuniontypedef)
