...
await def create_guardrail(
    ...
    *,
    ...
    crossRegionConfig: GuardrailCrossRegionConfigTypeDef = ...,  # (6)
    kmsKeyId: str = ...,
    tags: Sequence[TagTypeDef] = ...,  # (7)
    clientRequestToken: str = ...,
) -> CreateGuardrailResponseTypeDef:  # (8)
    ...
```
...
8. See [:material-code-braces: CreateGuardrailResponseTypeDef](./type_defs.md#createguardrailresponsetypedef)
...
await def update_guardrail(
    ...
    *,
    ...
    crossRegionConfig: GuardrailCrossRegionConfigTypeDef = ...,  # (6)
    kmsKeyId: str = ...,
) -> UpdateGuardrailResponseTypeDef:  # (7)
    ...
```
...
5. See [:material-code-braces: GuardrailContextualGroundingPolicyConfigTypeDef](./type_defs.md#guardrailcontextualgroundingpolicyconfigtypedef)
6. See [:material-code-braces: GuardrailCrossRegionConfigTypeDef](./type_defs.md#guardrailcrossregionconfigtypedef)
7. See [:material-code-braces: UpdateGuardrailResponseTypeDef](./type_defs.md#updateguardrailresponsetypedef)
