...
Type annotations and code completion for  `#!python session.create_client("lightsail")` as [LightsailClient](./client.md)
...
from `#!python session.create_client("lightsail").get_paginator("...")`.
...
- [CreateGUISessionAccessDetailsRequestRequestTypeDef](./type_defs.md#createguisessionaccessdetailsrequestrequesttypedef)
...
- [GetSetupHistoryRequestRequestTypeDef](./type_defs.md#getsetuphistoryrequestrequesttypedef)
...
- [SetupInstanceHttpsRequestRequestTypeDef](./type_defs.md#setupinstancehttpsrequestrequesttypedef)
- [StartGUISessionRequestRequestTypeDef](./type_defs.md#startguisessionrequestrequesttypedef)
...
- [StopGUISessionRequestRequestTypeDef](./type_defs.md#stopguisessionrequestrequesttypedef)
...
- [UpdateInstanceMetadataOptionsRequestRequestTypeDef](./type_defs.md#updateinstancemetadataoptionsrequestrequesttypedef)
...
- [CookieObjectUnionTypeDef](./type_defs.md#cookieobjectuniontypedef)
...
- [GetCostEstimateRequestRequestTypeDef](./type_defs.md#getcostestimaterequestrequesttypedef)
...
- [HeaderObjectUnionTypeDef](./type_defs.md#headerobjectuniontypedef)
...
- [QueryStringObjectUnionTypeDef](./type_defs.md#querystringobjectuniontypedef)
