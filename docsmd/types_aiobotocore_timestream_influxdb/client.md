...
) -> CreateDbClusterOutputTypeDef:  # (8)
    ...
```
...
8. See [:material-code-braces: CreateDbClusterOutputTypeDef](./type_defs.md#createdbclusteroutputtypedef)
...
) -> CreateDbInstanceOutputTypeDef:  # (7)
    ...
```
...
7. See [:material-code-braces: CreateDbInstanceOutputTypeDef](./type_defs.md#createdbinstanceoutputtypedef)
...
Type annotations and code completion for `#!python session.create_client("timestream-influxdb").get_db_cluster` method.
...
Type annotations and code completion for `#!python session.create_client("timestream-influxdb").reboot_db_cluster` method.
...
Type annotations and code completion for `#!python session.create_client("timestream-influxdb").reboot_db_instance` method.
...
) -> UpdateDbClusterOutputTypeDef:  # (5)
    ...
```
...
5. See [:material-code-braces: UpdateDbClusterOutputTypeDef](./type_defs.md#updatedbclusteroutputtypedef)
...
await def update_db_instance(
    ...
    *,
    ...
    allocatedStorage: int = ...,
    maintenanceSchedule: MaintenanceScheduleTypeDef = ...,  # (5)
) -> UpdateDbInstanceOutputTypeDef:  # (6)
    ...
```
...
5. See [:material-code-braces: MaintenanceScheduleTypeDef](./type_defs.md#maintenancescheduletypedef)
6. See [:material-code-braces: UpdateDbInstanceOutputTypeDef](./type_defs.md#updatedbinstanceoutputtypedef)
