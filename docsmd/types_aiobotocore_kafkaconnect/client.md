...
kwargs: DescribeConnectorOperationRequestRequestTypeDef = {  # (1)
...
1. See [:material-code-braces: DescribeConnectorOperationRequestRequestTypeDef](./type_defs.md#describeconnectoroperationrequestrequesttypedef) 
...
Type annotations and code completion for `#!python session.create_client("kafkaconnect").list_connector_operations` method.
...
kwargs: ListConnectorOperationsRequestRequestTypeDef = {  # (1)
    "connectorArn": ...,
}
...
1. See [:material-code-braces: ListConnectorOperationsRequestRequestTypeDef](./type_defs.md#listconnectoroperationsrequestrequesttypedef) 
