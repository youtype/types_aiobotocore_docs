...
Type annotations and code completion for `#!python session.create_client("connectcampaignsv2").delete_campaign_entry_limits` method.
...
await def delete_campaign_entry_limits(
    self,
    *,
    id: str,
) -> EmptyResponseMetadataTypeDef:  # (1)
...
Type annotations and code completion for `#!python session.create_client("connectcampaignsv2").get_campaign_state_batch` method.
...
Type annotations and code completion for `#!python session.create_client("connectcampaignsv2").update_campaign_entry_limits` method.
...
await def update_campaign_entry_limits(
    self,
    *,
    id: str,
