...
2. See [:material-code-braces: CriterionAdditionalPropertiesOutputTypeDef](./type_defs.md#criterionadditionalpropertiesoutputtypedef) 
...
2. See [:material-code-braces: SimpleCriterionForJobOutputTypeDef](./type_defs.md#simplecriterionforjoboutputtypedef) 
...
2. See [:material-code-braces: SimpleScopeTermOutputTypeDef](./type_defs.md#simplescopetermoutputtypedef) 
...
1. See [:material-code-braces: TagCriterionForJobTypeDef](./type_defs.md#tagcriterionforjobtypedef) 
...
1. See [:material-code-braces: TagScopeTermTypeDef](./type_defs.md#tagscopetermtypedef) 
...
2. See [:material-code-braces: CriteriaForJobOutputTypeDef](./type_defs.md#criteriaforjoboutputtypedef) 
...
2. See [:material-code-braces: JobScopeTermOutputTypeDef](./type_defs.md#jobscopetermoutputtypedef) 
...
2. See [:material-code-braces: S3BucketCriteriaForJobOutputTypeDef](./type_defs.md#s3bucketcriteriaforjoboutputtypedef) 
...
1. See [:material-code-braces: ScopingTypeDef](./type_defs.md#scopingtypedef) 
2. See [:material-code-braces: ScopingOutputTypeDef](./type_defs.md#scopingoutputtypedef) 
...
```python
# ListAutomatedDiscoveryAccountsRequestListAutomatedDiscoveryAccountsPaginateTypeDef definition

class ListAutomatedDiscoveryAccountsRequestListAutomatedDiscoveryAccountsPaginateTypeDef(TypedDict):
    accountIds: NotRequired[Sequence[str]],
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
1. See [:material-code-braces: CriterionAdditionalPropertiesTypeDef](./type_defs.md#criterionadditionalpropertiestypedef) [:material-code-braces: CriterionAdditionalPropertiesOutputTypeDef](./type_defs.md#criterionadditionalpropertiesoutputtypedef) 
## ListClassificationJobsRequestListClassificationJobsPaginateTypeDef

```python
# ListClassificationJobsRequestListClassificationJobsPaginateTypeDef definition
...
1. See [:material-code-braces: SimpleCriterionForJobTypeDef](./type_defs.md#simplecriterionforjobtypedef) [:material-code-braces: SimpleCriterionForJobOutputTypeDef](./type_defs.md#simplecriterionforjoboutputtypedef) 
2. See [:material-code-braces: TagCriterionForJobTypeDef](./type_defs.md#tagcriterionforjobtypedef) [:material-code-braces: TagCriterionForJobOutputTypeDef](./type_defs.md#tagcriterionforjoboutputtypedef) 
...
1. See [:material-code-braces: SimpleScopeTermTypeDef](./type_defs.md#simplescopetermtypedef) [:material-code-braces: SimpleScopeTermOutputTypeDef](./type_defs.md#simplescopetermoutputtypedef) 
2. See [:material-code-braces: TagScopeTermTypeDef](./type_defs.md#tagscopetermtypedef) [:material-code-braces: TagScopeTermOutputTypeDef](./type_defs.md#tagscopetermoutputtypedef) 
...
1. See [:material-code-braces: CriteriaForJobTypeDef](./type_defs.md#criteriaforjobtypedef) [:material-code-braces: CriteriaForJobOutputTypeDef](./type_defs.md#criteriaforjoboutputtypedef) 
...
1. See [:material-code-braces: JobScopeTermTypeDef](./type_defs.md#jobscopetermtypedef) [:material-code-braces: JobScopeTermOutputTypeDef](./type_defs.md#jobscopetermoutputtypedef) 
...
1. See [:material-code-braces: CriteriaBlockForJobTypeDef](./type_defs.md#criteriablockforjobtypedef) [:material-code-braces: CriteriaBlockForJobOutputTypeDef](./type_defs.md#criteriablockforjoboutputtypedef) 
2. See [:material-code-braces: CriteriaBlockForJobTypeDef](./type_defs.md#criteriablockforjobtypedef) [:material-code-braces: CriteriaBlockForJobOutputTypeDef](./type_defs.md#criteriablockforjoboutputtypedef) 
## ScopingTypeDef
...
1. See [:material-code-braces: JobScopingBlockTypeDef](./type_defs.md#jobscopingblocktypedef) [:material-code-braces: JobScopingBlockOutputTypeDef](./type_defs.md#jobscopingblockoutputtypedef) 
2. See [:material-code-braces: JobScopingBlockTypeDef](./type_defs.md#jobscopingblocktypedef) [:material-code-braces: JobScopingBlockOutputTypeDef](./type_defs.md#jobscopingblockoutputtypedef) 
...
1. See [:material-code-braces: S3BucketCriteriaForJobTypeDef](./type_defs.md#s3bucketcriteriaforjobtypedef) [:material-code-braces: S3BucketCriteriaForJobOutputTypeDef](./type_defs.md#s3bucketcriteriaforjoboutputtypedef) 
2. See [:material-code-braces: S3BucketDefinitionForJobTypeDef](./type_defs.md#s3bucketdefinitionforjobtypedef) [:material-code-braces: S3BucketDefinitionForJobOutputTypeDef](./type_defs.md#s3bucketdefinitionforjoboutputtypedef) 
3. See [:material-code-braces: ScopingTypeDef](./type_defs.md#scopingtypedef) [:material-code-braces: ScopingOutputTypeDef](./type_defs.md#scopingoutputtypedef) 
