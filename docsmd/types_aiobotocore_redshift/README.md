...
Type annotations and code completion for  `#!python session.create_client("redshift")` as [RedshiftClient](./client.md)
...
from `#!python session.create_client("redshift").get_paginator("...")`.
...
Type annotations and code completion for
[waiters](./waiters.md)
from `#!python session.create_client("redshift").get_waiter("...")`.
