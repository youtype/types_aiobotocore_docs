...
async with session.create_client("kafka") as client:
    try:
        ...
        client.ClientError,
        client.ClusterConnectivityException,
        client.ConflictException,
        client.ControllerMovedException,
        client.ForbiddenException,
        client.GroupSubscribedToTopicException,
        client.InternalServerErrorException,
        client.KafkaRequestException,
        client.KafkaTimeoutException,
        client.NotControllerException,
        client.NotFoundException,
        client.ReassignmentInProgressException,
        client.ServiceUnavailableException,
        client.TooManyRequestsException,
        client.TopicExistsException,
        client.UnauthorizedException,
        client.UnknownTopicOrPartitionException,
    ) as e:
        print(e)
```
...
Type annotations and code completion for `#!python session.create_client("kafka").create_topic` method.
...
Type annotations and code completion for `#!python session.create_client("kafka").delete_topic` method.
...
Type annotations and code completion for `#!python session.create_client("kafka").describe_topic` method.
...
Type annotations and code completion for `#!python session.create_client("kafka").describe_topic_partitions` method.
...
await def describe_topic_partitions(
    self,
    *,
    ClusterArn: str,
    TopicName: str,
...
Type annotations and code completion for `#!python session.create_client("kafka").list_topics` method.
...
Type annotations and code completion for `#!python session.create_client("kafka").update_rebalancing` method.
...
Type annotations and code completion for `#!python session.create_client("kafka").update_topic` method.
