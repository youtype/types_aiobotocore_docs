...
Type annotations and code completion for `#!python session.create_client("redshift-serverless").get_identity_center_auth_token` method.
...
Type annotations and code completion for `#!python session.create_client("redshift-serverless").get_track` method.
...
Type annotations and code completion for `#!python session.create_client("redshift-serverless").update_lakehouse_configuration` method.
...
await def update_lakehouse_configuration(
    self,
    *,
    namespaceName: str,
    catalogName: str = ...,
