...
2. See [:material-code-braces: FieldPatternsOutputTypeDef](./type_defs.md#fieldpatternsoutputtypedef) 
...
2. See [:material-code-braces: PathsOutputTypeDef](./type_defs.md#pathsoutputtypedef) 
...
1. See [:material-code-braces: QueryStringNamesTypeDef](./type_defs.md#querystringnamestypedef) 
...
1. See [:material-code-braces: ResponseHeadersPolicyAccessControlAllowHeadersTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolallowheaderstypedef) 
...
1. See [:material-code-braces: ResponseHeadersPolicyAccessControlAllowMethodsTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolallowmethodstypedef) 
2. See [:material-code-braces: ResponseHeadersPolicyAccessControlAllowMethodsOutputTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolallowmethodsoutputtypedef) 
...
2. See [:material-code-braces: ResponseHeadersPolicyAccessControlAllowOriginsOutputTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolalloworiginsoutputtypedef) 
...
1. See [:material-code-braces: ResponseHeadersPolicyAccessControlExposeHeadersTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolexposeheaderstypedef) 
2. See [:material-code-braces: ResponseHeadersPolicyAccessControlExposeHeadersOutputTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolexposeheadersoutputtypedef) 
...
2. See [:material-code-braces: StagingDistributionDnsNamesOutputTypeDef](./type_defs.md#stagingdistributiondnsnamesoutputtypedef) 
...
2. See [:material-code-braces: ContentTypeProfilesOutputTypeDef](./type_defs.md#contenttypeprofilesoutputtypedef) 
...
1. See [:material-code-braces: KeyValueStoreAssociationsTypeDef](./type_defs.md#keyvaluestoreassociationstypedef) 
...
2. See [:material-code-braces: QueryArgProfilesOutputTypeDef](./type_defs.md#queryargprofilesoutputtypedef) 
...
1. See [:material-code-braces: ResponseHeadersPolicyCustomHeadersConfigTypeDef](./type_defs.md#responseheaderspolicycustomheadersconfigtypedef) 
2. See [:material-code-braces: ResponseHeadersPolicyCustomHeadersConfigOutputTypeDef](./type_defs.md#responseheaderspolicycustomheadersconfigoutputtypedef) 
...
1. See [:material-code-braces: ResponseHeadersPolicyRemoveHeadersConfigTypeDef](./type_defs.md#responseheaderspolicyremoveheadersconfigtypedef) 
2. See [:material-code-braces: ResponseHeadersPolicyRemoveHeadersConfigOutputTypeDef](./type_defs.md#responseheaderspolicyremoveheadersconfigoutputtypedef) 
...
1. See [:material-code-braces: CachePolicyCookiesConfigTypeDef](./type_defs.md#cachepolicycookiesconfigtypedef) 
...
1. See [:material-code-braces: OriginRequestPolicyCookiesConfigTypeDef](./type_defs.md#originrequestpolicycookiesconfigtypedef) 
...
2. See [:material-code-braces: EncryptionEntityOutputTypeDef](./type_defs.md#encryptionentityoutputtypedef) 
...
2. See [:material-code-braces: CachePolicyHeadersConfigOutputTypeDef](./type_defs.md#cachepolicyheadersconfigoutputtypedef) 
...
2. See [:material-code-braces: OriginRequestPolicyHeadersConfigOutputTypeDef](./type_defs.md#originrequestpolicyheadersconfigoutputtypedef) 
...
1. See [:material-code-braces: CachePolicyQueryStringsConfigTypeDef](./type_defs.md#cachepolicyquerystringsconfigtypedef) 
2. See [:material-code-braces: CachePolicyQueryStringsConfigOutputTypeDef](./type_defs.md#cachepolicyquerystringsconfigoutputtypedef) 
...
1. See [:material-code-braces: OriginRequestPolicyQueryStringsConfigTypeDef](./type_defs.md#originrequestpolicyquerystringsconfigtypedef) 
2. See [:material-code-braces: OriginRequestPolicyQueryStringsConfigOutputTypeDef](./type_defs.md#originrequestpolicyquerystringsconfigoutputtypedef) 
...
2. See [:material-code-braces: ResponseHeadersPolicyCorsConfigOutputTypeDef](./type_defs.md#responseheaderspolicycorsconfigoutputtypedef) 
...
1. See [:material-code-braces: ContentTypeProfileConfigTypeDef](./type_defs.md#contenttypeprofileconfigtypedef) 
...
2. See [:material-code-braces: QueryArgProfileConfigOutputTypeDef](./type_defs.md#queryargprofileconfigoutputtypedef) 
...
2. See [:material-code-braces: EncryptionEntitiesOutputTypeDef](./type_defs.md#encryptionentitiesoutputtypedef) 
...
2. See [:material-code-braces: ParametersInCacheKeyAndForwardedToOriginOutputTypeDef](./type_defs.md#parametersincachekeyandforwardedtooriginoutputtypedef) 
...
1. See [:material-code-braces: FieldPatternsTypeDef](./type_defs.md#fieldpatternstypedef) [:material-code-braces: FieldPatternsOutputTypeDef](./type_defs.md#fieldpatternsoutputtypedef) 
## RestrictionsTypeDef
...
1. See [:material-code-braces: PathsTypeDef](./type_defs.md#pathstypedef) [:material-code-braces: PathsOutputTypeDef](./type_defs.md#pathsoutputtypedef) 
...
1. See [:material-code-brackets: CachePolicyQueryStringBehaviorType](./literals.md#cachepolicyquerystringbehaviortype) 
2. See [:material-code-braces: QueryStringNamesTypeDef](./type_defs.md#querystringnamestypedef) [:material-code-braces: QueryStringNamesOutputTypeDef](./type_defs.md#querystringnamesoutputtypedef) 
...
1. See [:material-code-braces: ResponseHeadersPolicyAccessControlAllowOriginsTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolalloworiginstypedef) [:material-code-braces: ResponseHeadersPolicyAccessControlAllowOriginsOutputTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolalloworiginsoutputtypedef) 
2. See [:material-code-braces: ResponseHeadersPolicyAccessControlAllowHeadersTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolallowheaderstypedef) [:material-code-braces: ResponseHeadersPolicyAccessControlAllowHeadersOutputTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolallowheadersoutputtypedef) 
3. See [:material-code-braces: ResponseHeadersPolicyAccessControlAllowMethodsTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolallowmethodstypedef) [:material-code-braces: ResponseHeadersPolicyAccessControlAllowMethodsOutputTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolallowmethodsoutputtypedef) 
4. See [:material-code-braces: ResponseHeadersPolicyAccessControlExposeHeadersTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolexposeheaderstypedef) [:material-code-braces: ResponseHeadersPolicyAccessControlExposeHeadersOutputTypeDef](./type_defs.md#responseheaderspolicyaccesscontrolexposeheadersoutputtypedef) 
...
1. See [:material-code-braces: ContentTypeProfilesTypeDef](./type_defs.md#contenttypeprofilestypedef) [:material-code-braces: ContentTypeProfilesOutputTypeDef](./type_defs.md#contenttypeprofilesoutputtypedef) 
...
1. See [:material-code-braces: StagingDistributionDnsNamesTypeDef](./type_defs.md#stagingdistributiondnsnamestypedef) [:material-code-braces: StagingDistributionDnsNamesOutputTypeDef](./type_defs.md#stagingdistributiondnsnamesoutputtypedef) 
2. See [:material-code-braces: TrafficConfigTypeDef](./type_defs.md#trafficconfigtypedef) 
...
1. See [:material-code-brackets: FunctionRuntimeType](./literals.md#functionruntimetype) 
2. See [:material-code-braces: KeyValueStoreAssociationsTypeDef](./type_defs.md#keyvaluestoreassociationstypedef) [:material-code-braces: KeyValueStoreAssociationsOutputTypeDef](./type_defs.md#keyvaluestoreassociationsoutputtypedef) 
...
1. See [:material-code-braces: QueryArgProfilesTypeDef](./type_defs.md#queryargprofilestypedef) [:material-code-braces: QueryArgProfilesOutputTypeDef](./type_defs.md#queryargprofilesoutputtypedef) 
...
1. See [:material-code-braces: EncryptionEntityTypeDef](./type_defs.md#encryptionentitytypedef) [:material-code-braces: EncryptionEntityOutputTypeDef](./type_defs.md#encryptionentityoutputtypedef) 
...
1. See [:material-code-braces: CachePolicyHeadersConfigTypeDef](./type_defs.md#cachepolicyheadersconfigtypedef) [:material-code-braces: CachePolicyHeadersConfigOutputTypeDef](./type_defs.md#cachepolicyheadersconfigoutputtypedef) 
2. See [:material-code-braces: CachePolicyCookiesConfigTypeDef](./type_defs.md#cachepolicycookiesconfigtypedef) [:material-code-braces: CachePolicyCookiesConfigOutputTypeDef](./type_defs.md#cachepolicycookiesconfigoutputtypedef) 
3. See [:material-code-braces: CachePolicyQueryStringsConfigTypeDef](./type_defs.md#cachepolicyquerystringsconfigtypedef) [:material-code-braces: CachePolicyQueryStringsConfigOutputTypeDef](./type_defs.md#cachepolicyquerystringsconfigoutputtypedef) 
...
1. See [:material-code-braces: OriginRequestPolicyHeadersConfigTypeDef](./type_defs.md#originrequestpolicyheadersconfigtypedef) [:material-code-braces: OriginRequestPolicyHeadersConfigOutputTypeDef](./type_defs.md#originrequestpolicyheadersconfigoutputtypedef) 
2. See [:material-code-braces: OriginRequestPolicyCookiesConfigTypeDef](./type_defs.md#originrequestpolicycookiesconfigtypedef) [:material-code-braces: OriginRequestPolicyCookiesConfigOutputTypeDef](./type_defs.md#originrequestpolicycookiesconfigoutputtypedef) 
3. See [:material-code-braces: OriginRequestPolicyQueryStringsConfigTypeDef](./type_defs.md#originrequestpolicyquerystringsconfigtypedef) [:material-code-braces: OriginRequestPolicyQueryStringsConfigOutputTypeDef](./type_defs.md#originrequestpolicyquerystringsconfigoutputtypedef) 
...
1. See [:material-code-braces: ResponseHeadersPolicyCorsConfigTypeDef](./type_defs.md#responseheaderspolicycorsconfigtypedef) [:material-code-braces: ResponseHeadersPolicyCorsConfigOutputTypeDef](./type_defs.md#responseheaderspolicycorsconfigoutputtypedef) 
2. See [:material-code-braces: ResponseHeadersPolicySecurityHeadersConfigTypeDef](./type_defs.md#responseheaderspolicysecurityheadersconfigtypedef) 
3. See [:material-code-braces: ResponseHeadersPolicyServerTimingHeadersConfigTypeDef](./type_defs.md#responseheaderspolicyservertimingheadersconfigtypedef) 
4. See [:material-code-braces: ResponseHeadersPolicyCustomHeadersConfigTypeDef](./type_defs.md#responseheaderspolicycustomheadersconfigtypedef) [:material-code-braces: ResponseHeadersPolicyCustomHeadersConfigOutputTypeDef](./type_defs.md#responseheaderspolicycustomheadersconfigoutputtypedef) 
5. See [:material-code-braces: ResponseHeadersPolicyRemoveHeadersConfigTypeDef](./type_defs.md#responseheaderspolicyremoveheadersconfigtypedef) [:material-code-braces: ResponseHeadersPolicyRemoveHeadersConfigOutputTypeDef](./type_defs.md#responseheaderspolicyremoveheadersconfigoutputtypedef) 
...
1. See [:material-code-braces: QueryArgProfileConfigTypeDef](./type_defs.md#queryargprofileconfigtypedef) [:material-code-braces: QueryArgProfileConfigOutputTypeDef](./type_defs.md#queryargprofileconfigoutputtypedef) 
2. See [:material-code-braces: ContentTypeProfileConfigTypeDef](./type_defs.md#contenttypeprofileconfigtypedef) [:material-code-braces: ContentTypeProfileConfigOutputTypeDef](./type_defs.md#contenttypeprofileconfigoutputtypedef) 
...
1. See [:material-code-braces: EncryptionEntitiesTypeDef](./type_defs.md#encryptionentitiestypedef) [:material-code-braces: EncryptionEntitiesOutputTypeDef](./type_defs.md#encryptionentitiesoutputtypedef) 
## OriginsTypeDef
...
1. See [:material-code-braces: ParametersInCacheKeyAndForwardedToOriginTypeDef](./type_defs.md#parametersincachekeyandforwardedtoorigintypedef) [:material-code-braces: ParametersInCacheKeyAndForwardedToOriginOutputTypeDef](./type_defs.md#parametersincachekeyandforwardedtooriginoutputtypedef) 
