...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListComputeOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ContainerGroupDefinitionName: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListContainerFleetsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    Name: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListContainerGroupDefinitionVersionsOutputTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    FleetId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListFleetDeploymentsOutputTypeDef]:  # (2)
    ...
```
