...
Type annotations and code completion for `#!python session.create_client("amp").get_waiter("anomaly_detector_active")`.
...
Type annotations and code completion for `#!python session.create_client("amp").get_waiter("anomaly_detector_deleted")`.
...
from types_aiobotocore_amp.waiter import AnomalyDetectorDeletedWaiter
