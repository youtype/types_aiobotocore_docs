<a id="chimeclient-for-aiobotocore-chime-module"></a>
...
Asynchronous method. Use `await create_proxy_session(...)` for a synchronous
call.
...
Asynchronous method. Use `await get_voice_connector_group(...)` for a
synchronous call.
...
Asynchronous method. Use `await get_voice_connector_logging_configuration(...)`
for a synchronous call.
...
Asynchronous method. Use `await get_voice_connector_origination(...)` for a
synchronous call.
...
Asynchronous method. Use `await get_voice_connector_proxy(...)` for a
synchronous call.
...
Asynchronous method. Use
`await get_voice_connector_streaming_configuration(...)` for a synchronous
call.
...
Asynchronous method. Use `await get_voice_connector_termination(...)` for a
synchronous call.
...
Asynchronous method. Use `await get_voice_connector_termination_health(...)`
for a synchronous call.
...
Asynchronous method. Use `await invite_users(...)` for a synchronous call.
...
Asynchronous method. Use `await list_attendee_tags(...)` for a synchronous
call.
...
Asynchronous method. Use `await list_media_capture_pipelines(...)` for a
synchronous call.
...
Asynchronous method. Use `await list_meeting_tags(...)` for a synchronous call.
...
Asynchronous method. Use `await list_meetings(...)` for a synchronous call.
...
Asynchronous method. Use `await list_phone_number_orders(...)` for a
synchronous call.
...
Asynchronous method. Use `await list_proxy_sessions(...)` for a synchronous
call.
...
Asynchronous method. Use `await list_room_memberships(...)` for a synchronous
call.
...
Asynchronous method. Use `await list_rooms(...)` for a synchronous call.
...
Asynchronous method. Use `await list_sip_media_applications(...)` for a
synchronous call.
...
Asynchronous method. Use `await list_sip_rules(...)` for a synchronous call.
...
Asynchronous method. Use `await list_supported_phone_number_countries(...)` for
a synchronous call.
...
Asynchronous method. Use `await list_voice_connector_groups(...)` for a
synchronous call.
...
Asynchronous method. Use
`await list_voice_connector_termination_credentials(...)` for a synchronous
call.
...
Asynchronous method. Use `await list_voice_connectors(...)` for a synchronous
call.
...
Asynchronous method. Use `await logout_user(...)` for a synchronous call.
...
Asynchronous method. Use `await put_app_instance_streaming_configurations(...)`
for a synchronous call.
...
Asynchronous method. Use `await put_events_configuration(...)` for a
synchronous call.
...
Asynchronous method. Use `await put_retention_settings(...)` for a synchronous
call.
...
Asynchronous method. Use
`await put_sip_media_application_logging_configuration(...)` for a synchronous
call.
...
Asynchronous method. Use
`await put_voice_connector_emergency_calling_configuration(...)` for a
synchronous call.
...
Asynchronous method. Use `await put_voice_connector_logging_configuration(...)`
for a synchronous call.
...
Asynchronous method. Use `await put_voice_connector_origination(...)` for a
synchronous call.
...
Asynchronous method. Use `await put_voice_connector_proxy(...)` for a
synchronous call.
...
Asynchronous method. Use
`await put_voice_connector_streaming_configuration(...)` for a synchronous
call.
...
Asynchronous method. Use `await put_voice_connector_termination(...)` for a
synchronous call.
...
Asynchronous method. Use
`await put_voice_connector_termination_credentials(...)` for a synchronous
call.
...
Asynchronous method. Use `await redact_conversation_message(...)` for a
synchronous call.
...
Asynchronous method. Use `await redact_room_message(...)` for a synchronous
call.
...
Asynchronous method. Use `await regenerate_security_token(...)` for a
synchronous call.
...
Asynchronous method. Use `await reset_personal_pin(...)` for a synchronous
call.
...
Asynchronous method. Use `await restore_phone_number(...)` for a synchronous
call.
...
Asynchronous method. Use `await search_available_phone_numbers(...)` for a
synchronous call.
...
Asynchronous method. Use `await tag_attendee(...)` for a synchronous call.
...
Asynchronous method. Use `await tag_meeting(...)` for a synchronous call.
...
Asynchronous method. Use `await untag_attendee(...)` for a synchronous call.
...
Asynchronous method. Use `await untag_meeting(...)` for a synchronous call.
...
Asynchronous method. Use `await update_phone_number(...)` for a synchronous
call.
...
Asynchronous method. Use `await update_phone_number_settings(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_proxy_session(...)` for a synchronous
call.
...
Asynchronous method. Use `await update_room_membership(...)` for a synchronous
call.
...
Asynchronous method. Use `await update_sip_media_application(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_sip_media_application_call(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_sip_rule(...)` for a synchronous call.
...
Asynchronous method. Use `await update_voice_connector(...)` for a synchronous
call.
...
Asynchronous method. Use `await update_voice_connector_group(...)` for a
synchronous call.
...
Boto3 documentation:
[Chime.Client.\_\_aenter\_\_](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/chime.html#Chime.Client.__aenter__)
...
Boto3 documentation:
[Chime.Client.\_\_aexit\_\_](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/chime.html#Chime.Client.__aexit__)
