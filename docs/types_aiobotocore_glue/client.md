...
Type annotations for
`session.create_client("glue").get_unfiltered_partition_metadata` method.
...
Asynchronous method. Use `await get_unfiltered_partition_metadata(...)` for a
synchronous call.
...
Type annotations for
`session.create_client("glue").get_unfiltered_partitions_metadata` method.
...
Asynchronous method. Use `await get_unfiltered_partitions_metadata(...)` for a
synchronous call.
...
Type annotations for
`session.create_client("glue").get_unfiltered_table_metadata` method.
...
Asynchronous method. Use `await get_unfiltered_table_metadata(...)` for a
synchronous call.
...
Boto3 documentation:
[Glue.Client.\_\_aenter\_\_](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/glue.html#Glue.Client.__aenter__)
...
Boto3 documentation:
[Glue.Client.\_\_aexit\_\_](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/glue.html#Glue.Client.__aexit__)
