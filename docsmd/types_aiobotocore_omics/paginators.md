...
Type annotations and code completion for `#!python session.create_client("omics").get_paginator("list_batch")`.
...
from types_aiobotocore_omics.paginator import ListBatchPaginator

session = get_session()
async with session.create_client("omics") as client:  # (1)
    paginator: ListBatchPaginator = client.get_paginator("list_batch")  # (2)
    async for item in paginator.paginate(...):
        item: ListBatchResponseTypeDef
        print(item)  # (3)
```

1. client: [OmicsClient](./client.md)
2. paginator: [ListBatchPaginator](./paginators.md#listbatchpaginator)
3. item: `AioPageIterator[ListBatchResponseTypeDef]`
...
def paginate(
    ...
    *,
    ...
    runGroupId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> aiobotocore.paginate.AioPageIterator[ListBatchResponseTypeDef]:  # (3)
    ...
```

1. See [:material-code-brackets: BatchStatusType](./literals.md#batchstatustype)
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `AioPageIterator[ListBatchResponseTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("omics").get_paginator("list_configurations")`.
...
from types_aiobotocore_omics.paginator import ListConfigurationsPaginator
...
Type annotations and code completion for `#!python session.create_client("omics").get_paginator("list_runs_in_batch")`.
...
from types_aiobotocore_omics.paginator import ListRunsInBatchPaginator

session = get_session()
async with session.create_client("omics") as client:  # (1)
    paginator: ListRunsInBatchPaginator = client.get_paginator("list_runs_in_batch")  # (2)
    async for item in paginator.paginate(...):
        item: ListRunsInBatchResponseTypeDef
        print(item)  # (3)
```

1. client: [OmicsClient](./client.md)
2. paginator: [ListRunsInBatchPaginator](./paginators.md#listrunsinbatchpaginator)
3. item: `AioPageIterator[ListRunsInBatchResponseTypeDef]`
...
def paginate(
    ...
    *,
    ...
    runId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> aiobotocore.paginate.AioPageIterator[ListRunsInBatchResponseTypeDef]:  # (3)
    ...
```

1. See [:material-code-brackets: SubmissionStatusType](./literals.md#submissionstatustype)
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `AioPageIterator[ListRunsInBatchResponseTypeDef]`
