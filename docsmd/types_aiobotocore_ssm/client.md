...
async with session.create_client("ssm") as client:
    try:
        ...
        client.NoLongerSupportedException,
...
Type annotations and code completion for `#!python session.create_client("ssm").start_access_request` method.
...
await def start_access_request(
    self,
    *,
    Reason: str,
    Targets: Sequence[TargetUnionTypeDef],  # (1)
