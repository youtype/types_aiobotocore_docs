...
- `rollback_configuration`: `Awaitable`[[RollbackConfigurationResponseTypeDef](./type_defs.md#rollbackconfigurationresponsetypedef)]
...
- `drift_information`: `Awaitable`[[StackDriftInformationResponseTypeDef](./type_defs.md#stackdriftinformationresponsetypedef)]
...
- `drift_information`: `Awaitable`[[StackResourceDriftInformationResponseTypeDef](./type_defs.md#stackresourcedriftinformationresponsetypedef)]
...
- `resource_status`: `Awaitable`[[ResourceStatusType](./literals.md#resourcestatustype)]
- `resource_status_reason`: `Awaitable`[`str`]
- `drift_information`: `Awaitable`[[StackResourceDriftInformationSummaryResponseTypeDef](./type_defs.md#stackresourcedriftinformationsummaryresponsetypedef)]
- `module_info`: `Awaitable`[[ModuleInfoResponseTypeDef](./type_defs.md#moduleinforesponsetypedef)]
- `stack_name`: `str`
- `logical_id`: `str`
