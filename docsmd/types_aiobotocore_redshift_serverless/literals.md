...
from types_aiobotocore_redshift_serverless.literals import LakehouseIdcRegistrationType
...
from types_aiobotocore_redshift_serverless.literals import LakehouseRegistrationType
...
from types_aiobotocore_redshift_serverless.literals import ListManagedWorkgroupsPaginatorName
...
```python
# ListReservationOfferingsPaginatorName usage example
from types_aiobotocore_redshift_serverless.literals import ListReservationOfferingsPaginatorName

def get_value() -> ListReservationOfferingsPaginatorName:
    return "list_reservation_offerings"
```

```python
# ListReservationOfferingsPaginatorName definition
ListReservationOfferingsPaginatorName = Literal[
...
from types_aiobotocore_redshift_serverless.literals import ListReservationsPaginatorName
...
from types_aiobotocore_redshift_serverless.literals import ListScheduledActionsPaginatorName
...
from types_aiobotocore_redshift_serverless.literals import ListSnapshotCopyConfigurationsPaginatorName
...
from types_aiobotocore_redshift_serverless.literals import ListTableRestoreStatusPaginatorName
...
```python
# ListTracksPaginatorName usage example
from types_aiobotocore_redshift_serverless.literals import ListTracksPaginatorName

def get_value() -> ListTracksPaginatorName:
    return "list_tracks"
```

```python
# ListTracksPaginatorName definition
ListTracksPaginatorName = Literal[
    "list_tracks",
]
```
...
from types_aiobotocore_redshift_serverless.literals import ManagedWorkgroupStatusType
...
from types_aiobotocore_redshift_serverless.literals import OfferingTypeType
...
from types_aiobotocore_redshift_serverless.literals import PerformanceTargetStatusType
...
from types_aiobotocore_redshift_serverless.literals import StateType
