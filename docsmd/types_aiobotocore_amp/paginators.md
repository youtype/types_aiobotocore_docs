...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/amp.html#PrometheusService.Paginator.ListScrapers)
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListScrapersResponseTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListScrapersRequestListScrapersPaginateTypeDef](./type_defs.md#listscrapersrequestlistscraperspaginatetypedef) 
