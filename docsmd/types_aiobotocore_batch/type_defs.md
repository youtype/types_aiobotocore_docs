...
2. See [:material-code-brackets: ServiceJobTypeType](./literals.md#servicejobtypetype)
3. See [:material-code-brackets: ServiceJobStatusType](./literals.md#servicejobstatustype)
...
2. See [:material-code-braces: LatestServiceJobAttemptTypeDef](./type_defs.md#latestservicejobattempttypedef)
3. See [:material-code-braces: ServiceJobRetryStrategyOutputTypeDef](./type_defs.md#servicejobretrystrategyoutputtypedef)
4. See [:material-code-brackets: ServiceJobTypeType](./literals.md#servicejobtypetype)
5. See [:material-code-brackets: ServiceJobStatusType](./literals.md#servicejobstatustype)
6. See [:material-code-braces: ServiceJobTimeoutTypeDef](./type_defs.md#servicejobtimeouttypedef)
