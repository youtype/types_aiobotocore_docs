...
async with session.create_client("sts") as client:
    try:
        ...
        client.ExpiredTradeInTokenException,
        ...
        client.JWTPayloadSizeExceededException,
        client.MalformedPolicyDocumentException,
        client.OutboundWebIdentityFederationDisabledException,
        client.PackedPolicyTooLargeException,
        client.RegionDisabledException,
        client.SessionDurationEscalationException,
    ) as e:
        print(e)
```
...
Type annotations and code completion for `#!python session.create_client("sts").get_delegated_access_token` method.
...
await def get_delegated_access_token(
    self,
    *,
    TradeInToken: str,
...
Type annotations and code completion for `#!python session.create_client("sts").get_web_identity_token` method.
...
await def get_web_identity_token(
    self,
    *,
