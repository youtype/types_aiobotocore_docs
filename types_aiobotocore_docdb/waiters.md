...
`aiobotocore.create_client("docdb").get_waiter("db_instance_available")`.
...
def get_db_instance_available_waiter() -> DBInstanceAvailableWaiter:
    return Session().create_client("docdb").get_waiter("db_instance_available")
```
...
Type annotations for
`aiobotocore.create_client("docdb").get_waiter("db_instance_deleted")`.
...
def get_db_instance_deleted_waiter() -> DBInstanceDeletedWaiter:
    return Session().create_client("docdb").get_waiter("db_instance_deleted")
```
