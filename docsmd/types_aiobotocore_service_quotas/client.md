...
Type annotations and code completion for `#!python session.create_client("service-quotas").get_auto_management_configuration` method.
...
await def get_auto_management_configuration(
    self,
...
Type annotations and code completion for `#!python session.create_client("service-quotas").get_quota_utilization_report` method.
...
await def get_quota_utilization_report(
    self,
    *,
    ReportId: str,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("service-quotas").start_auto_management` method.
...
await def start_auto_management(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("service-quotas").start_quota_utilization_report` method.
...
await def start_quota_utilization_report(
    self,
...
Type annotations and code completion for `#!python session.create_client("service-quotas").stop_auto_management` method.
...
await def stop_auto_management(
    self,
) -> dict[str, Any]:
    ...
```
...
Type annotations and code completion for `#!python session.create_client("service-quotas").update_auto_management` method.
...
await def update_auto_management(
    self,
    *,
