...
3. item: [:material-code-braces: DescribeChangeSetOutputStackResourceSummaryTypeDef](./type_defs.md#describechangesetoutputstackresourcesummarytypedef) 
...
1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeChangeSetOutputStackResourceSummaryTypeDef](./type_defs.md#describechangesetoutputstackresourcesummarytypedef) 
...
3. item: [:material-code-braces: DescribeStacksOutputStackResourceSummaryTypeDef](./type_defs.md#describestacksoutputstackresourcesummarytypedef) 
...
1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeStacksOutputStackResourceSummaryTypeDef](./type_defs.md#describestacksoutputstackresourcesummarytypedef) 
...
3. item: [:material-code-braces: ListStackSetOperationsOutputStackResourceSummaryTypeDef](./type_defs.md#liststacksetoperationsoutputstackresourcesummarytypedef) 
...
3. See [:material-code-braces: ListStackSetOperationsOutputStackResourceSummaryTypeDef](./type_defs.md#liststacksetoperationsoutputstackresourcesummarytypedef) 
