...
Type annotations and code completion for `#!python session.create_client("partnercentral-account")`
...
This class provides code completion for `#!python session.create_client("partnercentral-account").exceptions` structure.

```python
# PartnerCentralAccountAPIClient.exceptions usage example
...
```python
# PartnerCentralAccountAPIClient usage type checking example

from types_aiobotocore_partnercentral_account.client import Exceptions
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").can_paginate` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").generate_presigned_url` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").accept_connection_invitation` method.
...
await def accept_connection_invitation(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").associate_aws_training_certification_email_domain` method.
...
await def associate_aws_training_certification_email_domain(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").cancel_connection` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").cancel_connection_invitation` method.
...
await def cancel_connection_invitation(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").cancel_profile_update_task` method.
...
await def cancel_profile_update_task(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").create_connection_invitation` method.
...
await def create_connection_invitation(
    self,
    *,
    Catalog: str,
    ClientToken: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").create_partner` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").disassociate_aws_training_certification_email_domain` method.
...
await def disassociate_aws_training_certification_email_domain(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").get_alliance_lead_contact` method.
...
await def get_alliance_lead_contact(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").get_connection` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").get_connection_invitation` method.
...
await def get_connection_invitation(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").get_connection_preferences` method.
...
await def get_connection_preferences(
    self,
    *,
    Catalog: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").get_partner` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").get_profile_update_task` method.
...
await def get_profile_update_task(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").get_profile_visibility` method.
...
await def get_profile_visibility(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").get_verification` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").list_connection_invitations` method.
...
await def list_connection_invitations(
    self,
    *,
    Catalog: str,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").list_connections` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").list_partners` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").put_alliance_lead_contact` method.
...
await def put_alliance_lead_contact(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").put_profile_visibility` method.
...
await def put_profile_visibility(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").reject_connection_invitation` method.
...
await def reject_connection_invitation(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").send_email_verification_code` method.
...
await def send_email_verification_code(
    self,
    *,
    Catalog: str,
    Email: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").start_profile_update_task` method.
...
await def start_profile_update_task(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").start_verification` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").untag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").update_connection_preferences` method.
...
await def update_connection_preferences(
    self,
    *,
    Catalog: str,
    Revision: int,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/partnercentral-account.html#PartnerCentralAccountAPI.Client)
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/partnercentral-account.html#PartnerCentralAccountAPI.Client)
...
Type annotations and code completion for `#!python session.create_client("partnercentral-account").get_paginator` method with overloads.
