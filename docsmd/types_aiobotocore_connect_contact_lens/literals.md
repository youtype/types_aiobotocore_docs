...
from types_aiobotocore_connect_contact_lens.literals import PostContactSummaryStatusType
...
```python
# ConnectContactLensServiceName usage example
from types_aiobotocore_connect_contact_lens.literals import ConnectContactLensServiceName

def get_value() -> ConnectContactLensServiceName:
    return "connect-contact-lens"
```

```python
# ConnectContactLensServiceName definition
ConnectContactLensServiceName = Literal[
...
from types_aiobotocore_connect_contact_lens.literals import ServiceName
...
from types_aiobotocore_connect_contact_lens.literals import ResourceServiceName
...
from types_aiobotocore_connect_contact_lens.literals import RegionName
