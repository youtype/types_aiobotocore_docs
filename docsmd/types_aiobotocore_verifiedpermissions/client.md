...
Type annotations and code completion for `#!python session.create_client("verifiedpermissions").create_policy_store_alias` method.
...
await def create_policy_store_alias(
    self,
    *,
    aliasName: str,
    policyStoreId: str,
...
Type annotations and code completion for `#!python session.create_client("verifiedpermissions").delete_policy_store_alias` method.
...
await def delete_policy_store_alias(
    self,
    *,
    aliasName: str,
) -> dict[str, Any]:
...
Type annotations and code completion for `#!python session.create_client("verifiedpermissions").get_policy_store_alias` method.
...
await def get_policy_store_alias(
    self,
    *,
    aliasName: str,
...
Type annotations and code completion for `#!python session.create_client("verifiedpermissions").list_policy_store_aliases` method.
...
await def list_policy_store_aliases(
    self,
    *,
    nextToken: str = ...,
    maxResults: int = ...,
