...
```python
# ListSearchJobBackupsInputListSearchJobBackupsPaginateTypeDef definition

class ListSearchJobBackupsInputListSearchJobBackupsPaginateTypeDef(TypedDict):
    SearchJobIdentifier: str,
...
```python
# ListSearchJobResultsInputListSearchJobResultsPaginateTypeDef definition

class ListSearchJobResultsInputListSearchJobResultsPaginateTypeDef(TypedDict):
    SearchJobIdentifier: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListSearchJobsInputListSearchJobsPaginateTypeDef definition

class ListSearchJobsInputListSearchJobsPaginateTypeDef(TypedDict):
    ByStatus: NotRequired[SearchJobStateType],  # (1)
...
```python
# ListSearchResultExportJobsInputListSearchResultExportJobsPaginateTypeDef definition

class ListSearchResultExportJobsInputListSearchResultExportJobsPaginateTypeDef(TypedDict):
    Status: NotRequired[ExportJobStatusType],  # (1)
    SearchJobIdentifier: NotRequired[str],
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (2)
```
