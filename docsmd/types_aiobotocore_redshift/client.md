...
async with session.create_client("redshift") as client:
    try:
        ...
        client.RedshiftInvalidParameterFault,
...
Type annotations and code completion for `#!python session.create_client("redshift").get_identity_center_auth_token` method.
...
await def get_identity_center_auth_token(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("redshift").modify_lakehouse_configuration` method.
...
await def modify_lakehouse_configuration(
    self,
    *,
    ClusterIdentifier: str,
...
Type annotations and code completion for `#!python session.create_client("redshift").register_namespace` method.
