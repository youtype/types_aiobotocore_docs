...
Type annotations and code completion for `#!python session.create_client("batch").create_quota_share` method.
...
Type annotations and code completion for `#!python session.create_client("batch").delete_quota_share` method.
...
Type annotations and code completion for `#!python session.create_client("batch").describe_consumable_resource` method.
...
Type annotations and code completion for `#!python session.create_client("batch").describe_quota_share` method.
...
await def describe_quota_share(
    self,
    *,
    quotaShareArn: str,
...
Type annotations and code completion for `#!python session.create_client("batch").describe_service_job` method.
...
Type annotations and code completion for `#!python session.create_client("batch").list_quota_shares` method.
...
Type annotations and code completion for `#!python session.create_client("batch").update_quota_share` method.
...
Type annotations and code completion for `#!python session.create_client("batch").update_service_job` method.
