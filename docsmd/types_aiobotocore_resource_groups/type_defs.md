...
```python title="Usage Example"
from types_aiobotocore_resource_groups.type_defs import ListGroupsInputListGroupsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_resource_groups.type_defs import SearchResourcesInputSearchResourcesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_resource_groups.type_defs import ListGroupResourcesInputListGroupResourcesPaginateTypeDef
