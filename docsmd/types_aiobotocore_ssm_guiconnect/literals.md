...
> [Index](../README.md) > [SSMGUIConnect](./README.md) > Literals
...
```python
# SSMGUIConnectServiceName definition
SSMGUIConnectServiceName = Literal[
    "ssm-guiconnect",
]
```
## ServiceName
...
from types_aiobotocore_ssm_guiconnect.literals import ServiceName
...
from types_aiobotocore_ssm_guiconnect.literals import ResourceServiceName
