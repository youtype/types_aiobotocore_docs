...
```python
# ListAccountRolesPaginatorName definition

ListAccountRolesPaginatorName = Literal[
    "list_account_roles",
]
```
...
from types_aiobotocore_sso.literals import ListAccountsPaginatorName
...
```python
# SSOServiceName usage example

from types_aiobotocore_sso.literals import SSOServiceName

def get_value() -> SSOServiceName:
    return "sso"
```

```python
# SSOServiceName definition

SSOServiceName = Literal[
    "sso",
]
```
## ServiceName
...
from types_aiobotocore_sso.literals import ServiceName
...
from types_aiobotocore_sso.literals import ResourceServiceName
...
from types_aiobotocore_sso.literals import RegionName
