...
> [Index](../README.md) > [BedrockAgentCoreDataPlaneFrontingLayer](./README.md) > Literals
...
```python
# BedrockAgentCoreDataPlaneFrontingLayerServiceName usage example
from types_aiobotocore_bedrock_agentcore.literals import BedrockAgentCoreDataPlaneFrontingLayerServiceName

def get_value() -> BedrockAgentCoreDataPlaneFrontingLayerServiceName:
    return "bedrock-agentcore"
```

```python
# BedrockAgentCoreDataPlaneFrontingLayerServiceName definition
BedrockAgentCoreDataPlaneFrontingLayerServiceName = Literal[
    "bedrock-agentcore",
]
```
## ServiceName
