<a id="type-annotations-for-aiobotocore-robomaker-module"></a>
...
Type annotations for `aiobotocore.create_client("robomaker")` as
...
```python
from types_aiobotocore_robomaker.paginators import ListDeploymentJobsPaginator, ...
```
