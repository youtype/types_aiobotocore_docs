...
kwargs: DescribeAcceleratorOfferingsRequestTypeDef = {  # (1)
    "locationType": ...,
}
...
1. See [:material-code-braces: DescribeAcceleratorOfferingsRequestTypeDef](./type_defs.md#describeacceleratorofferingsrequesttypedef) 
...
kwargs: DescribeAcceleratorsRequestTypeDef = {  # (1)
    "acceleratorIds": ...,
}
...
1. See [:material-code-braces: DescribeAcceleratorsRequestTypeDef](./type_defs.md#describeacceleratorsrequesttypedef) 
