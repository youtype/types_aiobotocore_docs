...
Type annotations and code completion for `#!python session.create_client("cloudwatch").get_waiter("alarm_mute_rule_exists")`.
...
from types_aiobotocore_cloudwatch.waiter import AlarmMuteRuleExistsWaiter
