...
Type annotations and code completion for `#!python session.create_client("mobile").close` method.
...
Type annotations and code completion for `#!python session.create_client("mobile").__aexit__` method.
