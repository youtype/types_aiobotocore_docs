...
```python
# DescribeAcceleratorsPaginatorName definition

DescribeAcceleratorsPaginatorName = Literal[
...
from types_aiobotocore_elastic_inference.literals import LocationTypeType
...
```python
# ElasticInferenceServiceName usage example

from types_aiobotocore_elastic_inference.literals import ElasticInferenceServiceName

def get_value() -> ElasticInferenceServiceName:
    return "elastic-inference"
```

```python
# ElasticInferenceServiceName definition

ElasticInferenceServiceName = Literal[
    "elastic-inference",
]
```
## ServiceName
...
from types_aiobotocore_elastic_inference.literals import ServiceName
...
from types_aiobotocore_elastic_inference.literals import ResourceServiceName
...
from types_aiobotocore_elastic_inference.literals import RegionName
