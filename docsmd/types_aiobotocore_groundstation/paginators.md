...
Type annotations and code completion for `#!python session.create_client("groundstation").get_paginator("list_antennas")`.
...
from types_aiobotocore_groundstation.paginator import ListAntennasPaginator
...
3. item: `AioPageIterator[ListAntennasResponseTypeDef]`
...
) -> aiobotocore.paginate.AioPageIterator[ListAntennasResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `AioPageIterator[ListAntennasResponseTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("groundstation").get_paginator("list_contact_versions")`.
...
from types_aiobotocore_groundstation.paginator import ListContactVersionsPaginator

session = get_session()
async with session.create_client("groundstation") as client:  # (1)
    paginator: ListContactVersionsPaginator = client.get_paginator("list_contact_versions")  # (2)
    async for item in paginator.paginate(...):
        item: ListContactVersionsResponseTypeDef
        print(item)  # (3)
```

1. client: [GroundStationClient](./client.md)
2. paginator: [ListContactVersionsPaginator](./paginators.md#listcontactversionspaginator)
3. item: `AioPageIterator[ListContactVersionsResponseTypeDef]`
...
def paginate(
    ...
    *,
    contactId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> aiobotocore.paginate.AioPageIterator[ListContactVersionsResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `AioPageIterator[ListContactVersionsResponseTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("groundstation").get_paginator("list_ground_station_reservations")`.
...
from types_aiobotocore_groundstation.paginator import ListGroundStationReservationsPaginator

session = get_session()
async with session.create_client("groundstation") as client:  # (1)
    paginator: ListGroundStationReservationsPaginator = client.get_paginator("list_ground_station_reservations")  # (2)
    async for item in paginator.paginate(...):
        item: ListGroundStationReservationsResponseTypeDef
        print(item)  # (3)
```

1. client: [GroundStationClient](./client.md)
2. paginator: [ListGroundStationReservationsPaginator](./paginators.md#listgroundstationreservationspaginator)
3. item: `AioPageIterator[ListGroundStationReservationsResponseTypeDef]`
...
) -> aiobotocore.paginate.AioPageIterator[ListGroundStationReservationsResponseTypeDef]:  # (3)
    ...
```

1. See `Sequence[ReservationTypeType]`
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `AioPageIterator[ListGroundStationReservationsResponseTypeDef]`
