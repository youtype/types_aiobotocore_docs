...
```python
# ListConnectionsInputListConnectionsPaginateTypeDef definition

class ListConnectionsInputListConnectionsPaginateTypeDef(TypedDict):
    domainIdentifier: str,
    projectIdentifier: str,
    environmentIdentifier: NotRequired[str],
    name: NotRequired[str],
...
```python
# ListJobRunsInputListJobRunsPaginateTypeDef definition

class ListJobRunsInputListJobRunsPaginateTypeDef(TypedDict):
    domainIdentifier: str,
    jobIdentifier: str,
    sortOrder: NotRequired[SortOrderType],  # (1)
    status: NotRequired[JobRunStatusType],  # (2)
...
```python
# ListLineageEventsInputListLineageEventsPaginateTypeDef definition

class ListLineageEventsInputListLineageEventsPaginateTypeDef(TypedDict):
    domainIdentifier: str,
    processingStatus: NotRequired[LineageEventProcessingStatusType],  # (1)
    sortOrder: NotRequired[SortOrderType],  # (2)
    timestampAfter: NotRequired[TimestampTypeDef],
...
```python
# ListProjectProfilesInputListProjectProfilesPaginateTypeDef definition

class ListProjectProfilesInputListProjectProfilesPaginateTypeDef(TypedDict):
    domainIdentifier: str,
    name: NotRequired[str],
    sortBy: NotRequired[SortFieldProjectType],  # (1)
    sortOrder: NotRequired[SortOrderType],  # (2)
