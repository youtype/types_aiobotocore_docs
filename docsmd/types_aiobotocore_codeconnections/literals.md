...
> [Index](../README.md) > [CodeConnections](./README.md) > Literals
...
from types_aiobotocore_codeconnections.literals import BlockerTypeType
...
from types_aiobotocore_codeconnections.literals import ConnectionStatusType
...
from types_aiobotocore_codeconnections.literals import ProviderTypeType
...
from types_aiobotocore_codeconnections.literals import PublishDeploymentStatusType
...
```python
# PullRequestCommentType usage example
from types_aiobotocore_codeconnections.literals import PullRequestCommentType

def get_value() -> PullRequestCommentType:
    return "DISABLED"
```

```python
# PullRequestCommentType definition
PullRequestCommentType = Literal[
    "DISABLED",
    "ENABLED",
]
```
...
from types_aiobotocore_codeconnections.literals import RepositorySyncStatusType
...
from types_aiobotocore_codeconnections.literals import ResourceSyncStatusType
...
from types_aiobotocore_codeconnections.literals import SyncConfigurationTypeType
...
from types_aiobotocore_codeconnections.literals import TriggerResourceUpdateOnType
...
```python
# CodeConnectionsServiceName usage example
from types_aiobotocore_codeconnections.literals import CodeConnectionsServiceName

def get_value() -> CodeConnectionsServiceName:
    return "codeconnections"
```

```python
# CodeConnectionsServiceName definition
CodeConnectionsServiceName = Literal[
    "codeconnections",
]
```
## ServiceName
...
from types_aiobotocore_codeconnections.literals import ServiceName
...
from types_aiobotocore_codeconnections.literals import ResourceServiceName
