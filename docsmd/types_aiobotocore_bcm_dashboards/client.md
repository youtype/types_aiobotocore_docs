...
Type annotations and code completion for `#!python session.create_client("bcm-dashboards").create_scheduled_report` method.
...
await def create_scheduled_report(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("bcm-dashboards").delete_scheduled_report` method.
...
await def delete_scheduled_report(
    self,
    *,
    arn: str,
...
Type annotations and code completion for `#!python session.create_client("bcm-dashboards").execute_scheduled_report` method.
...
await def execute_scheduled_report(
    self,
    *,
    arn: str,
    clientToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("bcm-dashboards").get_scheduled_report` method.
...
await def get_scheduled_report(
    self,
    *,
    arn: str,
...
Type annotations and code completion for `#!python session.create_client("bcm-dashboards").list_scheduled_reports` method.
...
await def list_scheduled_reports(
    self,
    *,
    nextToken: str = ...,
    maxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("bcm-dashboards").update_scheduled_report` method.
...
await def update_scheduled_report(
    self,
    *,
    arn: str,
    name: str = ...,
