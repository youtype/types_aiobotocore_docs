<a id="literals-for-aiobotocore-ec2instanceconnect-module"></a>

# Literals for aiobotocore EC2InstanceConnect module

> [Index](../README.md) > [EC2InstanceConnect](./README.md) > Literals
...
- [Literals for aiobotocore EC2InstanceConnect module](#literals-for-aiobotocore-ec2instanceconnect-module)
...
```python
from types_aiobotocore_ec2_instance_connect.literals import ResourceServiceName
```
