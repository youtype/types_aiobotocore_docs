...
```python
# DescribeEntityRequestDescribeEntityPaginateTypeDef definition
...
```python
# ListConnectionTypesRequestListConnectionTypesPaginateTypeDef definition
...
5. See [:material-code-braces: PrincipalPermissionsTypeDef](./type_defs.md#principalpermissionstypedef) 
