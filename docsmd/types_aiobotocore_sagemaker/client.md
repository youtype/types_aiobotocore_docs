...
await def create_cluster(
    ...
    *,
    ...
    NodeProvisioningMode: ClusterNodeProvisioningModeType = ...,  # (7)
...
7. See [:material-code-brackets: ClusterNodeProvisioningModeType](./literals.md#clusternodeprovisioningmodetype)
...
1. See [:material-code-braces: AlgorithmSpecificationUnionTypeDef](#algorithmspecificationuniontypedef)
2. See [:material-code-braces: OutputDataConfigTypeDef](./type_defs.md#outputdataconfigtypedef)
3. See [:material-code-braces: ResourceConfigUnionTypeDef](#resourceconfiguniontypedef)
4. See [:material-code-braces: StoppingConditionTypeDef](./type_defs.md#stoppingconditiontypedef)
5. See `Sequence[ChannelUnionTypeDef]`
...
await def search_training_plan_offerings(
    ...
    *,
    DurationHours: int,
    TargetResources: Sequence[SageMakerResourceNameType],  # (1)
    InstanceType: ReservedCapacityInstanceTypeType = ...,  # (2)
    InstanceCount: int = ...,
    UltraServerType: str = ...,
...
1. See `Sequence[SageMakerResourceNameType]`
2. See [:material-code-brackets: ReservedCapacityInstanceTypeType](./literals.md#reservedcapacityinstancetypetype)
...
await def update_cluster(
    ...
    *,
    ...
    InstanceGroups: Sequence[ClusterInstanceGroupSpecificationTypeDef] = ...,  # (1)
    RestrictedInstanceGroups: Sequence[ClusterRestrictedInstanceGroupSpecificationTypeDef] = ...,  # (2)
    NodeRecovery: ClusterNodeRecoveryType = ...,  # (3)
...
1. See `Sequence[ClusterInstanceGroupSpecificationTypeDef]`
2. See `Sequence[ClusterRestrictedInstanceGroupSpecificationTypeDef]`
3. See [:material-code-brackets: ClusterNodeRecoveryType](./literals.md#clusternoderecoverytype)
...
1. See [:material-code-brackets: ModelApprovalStatusType](./literals.md#modelapprovalstatustype)
2. See `Sequence[AdditionalInferenceSpecificationDefinitionUnionTypeDef]`
3. See [:material-code-braces: InferenceSpecificationUnionTypeDef](#inferencespecificationuniontypedef)
...
1. See [:material-code-brackets: InstanceTypeType](./literals.md#instancetypetype)
2. See `Sequence[NotebookInstanceAcceleratorTypeType]`
