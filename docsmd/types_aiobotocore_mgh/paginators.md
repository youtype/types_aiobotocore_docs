...
def paginate(
    ...
    *,
    ...
    MigrationTaskName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListMigrationTaskUpdatesResultTypeDef]:  # (2)
    ...
```
...
kwargs: ListMigrationTaskUpdatesRequestListMigrationTaskUpdatesPaginateTypeDef = {  # (1)
    "ProgressUpdateStream": ...,
    "MigrationTaskName": ...,
}
...
1. See [:material-code-braces: ListMigrationTaskUpdatesRequestListMigrationTaskUpdatesPaginateTypeDef](./type_defs.md#listmigrationtaskupdatesrequestlistmigrationtaskupdatespaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    MigrationTaskName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListSourceResourcesResultTypeDef]:  # (2)
    ...
```
...
kwargs: ListSourceResourcesRequestListSourceResourcesPaginateTypeDef = {  # (1)
    "ProgressUpdateStream": ...,
    "MigrationTaskName": ...,
}
...
1. See [:material-code-braces: ListSourceResourcesRequestListSourceResourcesPaginateTypeDef](./type_defs.md#listsourceresourcesrequestlistsourceresourcespaginatetypedef) 
