...
```python
# ListAppAssessmentResourceDriftsRequestListAppAssessmentResourceDriftsPaginateTypeDef definition

class ListAppAssessmentResourceDriftsRequestListAppAssessmentResourceDriftsPaginateTypeDef(TypedDict):
    assessmentArn: str,
...
```python
# ListResourceGroupingRecommendationsRequestListResourceGroupingRecommendationsPaginateTypeDef definition

class ListResourceGroupingRecommendationsRequestListResourceGroupingRecommendationsPaginateTypeDef(TypedDict):
    appArn: NotRequired[str],
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListMetricsRequestListMetricsPaginateTypeDef definition
