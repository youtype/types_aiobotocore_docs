...
Type annotations and code completion for  `#!python session.create_client("nimble")` as [NimbleStudioClient](./client.md)
...
- [ListStreamingSessionBackupsPaginator](./paginators.md#liststreamingsessionbackupspaginator)
...
- [AutomaticTerminationModeType](./literals.md#automaticterminationmodetype)
...
- [ListStreamingSessionBackupsPaginatorName](./literals.md#liststreamingsessionbackupspaginatorname)
...
- [SessionBackupModeType](./literals.md#sessionbackupmodetype)
- [SessionPersistenceModeType](./literals.md#sessionpersistencemodetype)
...
- [VolumeRetentionModeType](./literals.md#volumeretentionmodetype)
...
- [GetStreamingSessionBackupRequestRequestTypeDef](./type_defs.md#getstreamingsessionbackuprequestrequesttypedef)
- [StreamingSessionBackupTypeDef](./type_defs.md#streamingsessionbackuptypedef)
...
- [ListStreamingSessionBackupsRequestRequestTypeDef](./type_defs.md#liststreamingsessionbackupsrequestrequesttypedef)
...
- [StreamConfigurationSessionBackupTypeDef](./type_defs.md#streamconfigurationsessionbackuptypedef)
...
- [GetStreamingSessionBackupResponseTypeDef](./type_defs.md#getstreamingsessionbackupresponsetypedef)
- [ListStreamingSessionBackupsResponseTypeDef](./type_defs.md#liststreamingsessionbackupsresponsetypedef)
...
- [ListStreamingSessionBackupsRequestListStreamingSessionBackupsPaginateTypeDef](./type_defs.md#liststreamingsessionbackupsrequestliststreamingsessionbackupspaginatetypedef)
