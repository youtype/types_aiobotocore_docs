<a id="type-annotations-for-aiobotocore-cloudwatch-module"></a>

# Type annotations for aiobotocore CloudWatch module
...
- [Type annotations for aiobotocore CloudWatch module](#type-annotations-for-aiobotocore-cloudwatch-module)
...
Type annotations for collections from `aiobotocore.resource("cloudwatch").*`.
