...
Type annotations and code completion for `#!python session.create_client("launch-wizard").get_paginator("list_deployment_pattern_versions")`.
...
) -> aiobotocore.paginate.AioPageIterator[ListDeploymentPatternVersionsOutputTypeDef]:  # (3)
    ...
```

1. See `Sequence[DeploymentPatternVersionFilterTypeDef]`
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `AioPageIterator[ListDeploymentPatternVersionsOutputTypeDef]`
