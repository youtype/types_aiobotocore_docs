...
Type annotations and code completion for  `#!python session.create_client("pinpoint")` as [PinpointClient](./client.md)
...
- [GetJourneyRunExecutionActivityMetricsRequestRequestTypeDef](./type_defs.md#getjourneyrunexecutionactivitymetricsrequestrequesttypedef)
- [JourneyRunExecutionActivityMetricsResponseTypeDef](./type_defs.md#journeyrunexecutionactivitymetricsresponsetypedef)
- [GetJourneyRunExecutionMetricsRequestRequestTypeDef](./type_defs.md#getjourneyrunexecutionmetricsrequestrequesttypedef)
- [JourneyRunExecutionMetricsResponseTypeDef](./type_defs.md#journeyrunexecutionmetricsresponsetypedef)
- [GetJourneyRunsRequestRequestTypeDef](./type_defs.md#getjourneyrunsrequestrequesttypedef)
