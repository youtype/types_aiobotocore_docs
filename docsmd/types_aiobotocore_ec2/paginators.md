...
3. item: [:material-code-braces: DescribeSecurityGroupsResultVpcAddressTypeDef](./type_defs.md#describesecuritygroupsresultvpcaddresstypedef) 
...
1. See [:material-code-braces: FilterTypeDef](./type_defs.md#filtertypedef) 
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
3. See [:material-code-braces: DescribeSecurityGroupsResultVpcAddressTypeDef](./type_defs.md#describesecuritygroupsresultvpcaddresstypedef) 
...
3. item: [:material-code-braces: DescribeSpotFleetRequestsResponseVpcAddressTypeDef](./type_defs.md#describespotfleetrequestsresponsevpcaddresstypedef) 
...
1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
2. See [:material-code-braces: DescribeSpotFleetRequestsResponseVpcAddressTypeDef](./type_defs.md#describespotfleetrequestsresponsevpcaddresstypedef) 
