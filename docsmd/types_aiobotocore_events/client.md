...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/events.html#EventBridge.Client.update_event_bus)
...
1. See [:material-code-braces: UpdateEventBusRequestRequestTypeDef](./type_defs.md#updateeventbusrequestrequesttypedef) 
