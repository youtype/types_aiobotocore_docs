...
```python title="Usage Example"
from types_aiobotocore_acm.type_defs import DescribeCertificateRequestCertificateValidatedWaitTypeDef
...
```python title="Usage Example"
from types_aiobotocore_acm.type_defs import ListCertificatesRequestListCertificatesPaginateTypeDef
