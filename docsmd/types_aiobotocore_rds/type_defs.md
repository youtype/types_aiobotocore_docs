...
class DBClusterTypeDef(TypedDict):
    ...
    LocalWriteForwardingStatus: NotRequired[LocalWriteForwardingStatusType],  # (14)
```
...
14. See [:material-code-brackets: LocalWriteForwardingStatusType](./literals.md#localwriteforwardingstatustype) 
