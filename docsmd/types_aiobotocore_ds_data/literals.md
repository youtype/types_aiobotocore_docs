...
> [Index](../README.md) > [DirectoryServiceData](./README.md) > Literals
...
```python
# GroupScopeType definition
GroupScopeType = Literal[
    "BuiltinLocal",
    "DomainLocal",
    "Global",
    "Universal",
...
from types_aiobotocore_ds_data.literals import GroupTypeType
...
from types_aiobotocore_ds_data.literals import ListGroupMembersPaginatorName
...
```python
# ListGroupsForMemberPaginatorName usage example
from types_aiobotocore_ds_data.literals import ListGroupsForMemberPaginatorName

def get_value() -> ListGroupsForMemberPaginatorName:
    return "list_groups_for_member"
```

```python
# ListGroupsForMemberPaginatorName definition
ListGroupsForMemberPaginatorName = Literal[
...
from types_aiobotocore_ds_data.literals import ListGroupsPaginatorName
...
from types_aiobotocore_ds_data.literals import ListUsersPaginatorName
...
from types_aiobotocore_ds_data.literals import MemberTypeType
...
from types_aiobotocore_ds_data.literals import SearchGroupsPaginatorName
...
from types_aiobotocore_ds_data.literals import SearchUsersPaginatorName
...
from types_aiobotocore_ds_data.literals import UpdateTypeType
...
```python
# DirectoryServiceDataServiceName usage example
from types_aiobotocore_ds_data.literals import DirectoryServiceDataServiceName

def get_value() -> DirectoryServiceDataServiceName:
    return "ds-data"
```

```python
# DirectoryServiceDataServiceName definition
DirectoryServiceDataServiceName = Literal[
    "ds-data",
]
```
## ServiceName
...
from types_aiobotocore_ds_data.literals import ServiceName
...
from types_aiobotocore_ds_data.literals import ResourceServiceName
...
from types_aiobotocore_ds_data.literals import PaginatorName
