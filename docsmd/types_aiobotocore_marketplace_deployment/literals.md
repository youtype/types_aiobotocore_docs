...
> [Index](../README.md) > [MarketplaceDeploymentService](./README.md) > Literals
...
```python
# MarketplaceDeploymentServiceServiceName definition
MarketplaceDeploymentServiceServiceName = Literal[
...
from types_aiobotocore_marketplace_deployment.literals import ServiceName
...
from types_aiobotocore_marketplace_deployment.literals import ResourceServiceName
