...
def paginate(
    ...
    *,
    ...
    agentVersion: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListAgentCollaboratorsResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListAgentCollaboratorsRequestListAgentCollaboratorsPaginateTypeDef = {  # (1)
    "agentId": ...,
    "agentVersion": ...,
}
...
1. See [:material-code-braces: ListAgentCollaboratorsRequestListAgentCollaboratorsPaginateTypeDef](./type_defs.md#listagentcollaboratorsrequestlistagentcollaboratorspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    knowledgeBaseId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListKnowledgeBaseDocumentsResponseTypeDef]:  # (2)
    ...
```
