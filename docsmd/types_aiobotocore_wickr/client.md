...
Type annotations and code completion for `#!python session.create_client("wickr")`
...
This class provides code completion for `#!python session.create_client("wickr").exceptions` structure.

```python
# WickrAdminAPIClient.exceptions usage example
...
async with session.create_client("wickr") as client:
    try:
        ...
        client.ClientError,
        client.ForbiddenError,
        client.InternalServerError,
        client.RateLimitError,
        client.ResourceNotFoundError,
...
```python
# WickrAdminAPIClient usage type checking example

from types_aiobotocore_wickr.client import Exceptions
...
Type annotations and code completion for `#!python session.create_client("wickr").can_paginate` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").generate_presigned_url` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").batch_create_user` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").batch_delete_user` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").batch_lookup_user_uname` method.
...
await def batch_lookup_user_uname(
    self,
    *,
    networkId: str,
    unames: Sequence[str],
...
Type annotations and code completion for `#!python session.create_client("wickr").batch_reinvite_user` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").batch_reset_devices_for_user` method.
...
await def batch_reset_devices_for_user(
    self,
    *,
    networkId: str,
    userId: str,
...
Type annotations and code completion for `#!python session.create_client("wickr").batch_toggle_user_suspend_status` method.
...
await def batch_toggle_user_suspend_status(
    self,
    *,
    networkId: str,
    suspend: bool,
...
Type annotations and code completion for `#!python session.create_client("wickr").create_bot` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").create_data_retention_bot` method.
...
await def create_data_retention_bot(
    self,
    *,
    networkId: str,
...
Type annotations and code completion for `#!python session.create_client("wickr").create_data_retention_bot_challenge` method.
...
await def create_data_retention_bot_challenge(
    self,
    *,
    networkId: str,
...
Type annotations and code completion for `#!python session.create_client("wickr").create_network` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").create_security_group` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").delete_bot` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").delete_data_retention_bot` method.
...
await def delete_data_retention_bot(
    self,
    *,
    networkId: str,
...
Type annotations and code completion for `#!python session.create_client("wickr").delete_network` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").delete_security_group` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").get_bot` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").get_bots_count` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").get_data_retention_bot` method.
...
await def get_data_retention_bot(
    self,
    *,
    networkId: str,
...
Type annotations and code completion for `#!python session.create_client("wickr").get_guest_user_history_count` method.
...
await def get_guest_user_history_count(
    self,
    *,
    networkId: str,
...
Type annotations and code completion for `#!python session.create_client("wickr").get_network` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").get_network_settings` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").get_oidc_info` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").get_opentdf_config` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").get_security_group` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").get_user` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").get_users_count` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").list_blocked_guest_users` method.
...
await def list_blocked_guest_users(
    self,
    *,
    networkId: str,
    maxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("wickr").list_bots` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").list_devices_for_user` method.
...
await def list_devices_for_user(
    self,
    *,
    networkId: str,
    userId: str,
...
Type annotations and code completion for `#!python session.create_client("wickr").list_guest_users` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").list_networks` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").list_security_group_users` method.
...
await def list_security_group_users(
    self,
    *,
    networkId: str,
    groupId: str,
...
Type annotations and code completion for `#!python session.create_client("wickr").list_security_groups` method.
...
await def list_security_groups(
    self,
    *,
    networkId: str,
    nextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("wickr").list_users` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").register_oidc_config` method.
...
await def register_oidc_config(
    self,
    *,
    networkId: str,
    companyId: str,
...
Type annotations and code completion for `#!python session.create_client("wickr").register_oidc_config_test` method.
...
await def register_oidc_config_test(
    self,
    *,
    networkId: str,
    issuer: str,
...
Type annotations and code completion for `#!python session.create_client("wickr").register_opentdf_config` method.
...
await def register_opentdf_config(
    self,
    *,
    networkId: str,
    clientId: str,
...
Type annotations and code completion for `#!python session.create_client("wickr").update_bot` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").update_data_retention` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").update_guest_user` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").update_network` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").update_network_settings` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").update_security_group` method.
...
await def update_security_group(
    self,
    *,
    networkId: str,
    groupId: str,
...
Type annotations and code completion for `#!python session.create_client("wickr").update_user` method.
...
Type annotations and code completion for `#!python session.create_client("wickr").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/wickr.html#WickrAdminAPI.Client)
...
Type annotations and code completion for `#!python session.create_client("wickr").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/wickr.html#WickrAdminAPI.Client)
...
Type annotations and code completion for `#!python session.create_client("wickr").get_paginator` method with overloads.
