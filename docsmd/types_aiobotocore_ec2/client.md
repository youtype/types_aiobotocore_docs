...
) -> CreateClientVpnEndpointResultTypeDef:  # (9)
    ...
```
...
9. See [:material-code-braces: CreateClientVpnEndpointResultTypeDef](./type_defs.md#createclientvpnendpointresulttypedef)
