...
```python
# CloudRemovalConfigInputUnionTypeDef definition

CloudRemovalConfigInputUnionTypeDef = Union[
    CloudRemovalConfigInputTypeDef,  # (1)
    CloudRemovalConfigInputOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: CloudRemovalConfigInputTypeDef](./type_defs.md#cloudremovalconfiginputtypedef) 
...
```python
# GeoMosaicConfigInputUnionTypeDef definition

GeoMosaicConfigInputUnionTypeDef = Union[
    GeoMosaicConfigInputTypeDef,  # (1)
    GeoMosaicConfigInputOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: GeoMosaicConfigInputTypeDef](./type_defs.md#geomosaicconfiginputtypedef) 
2. See [:material-code-braces: GeoMosaicConfigInputOutputTypeDef](./type_defs.md#geomosaicconfiginputoutputtypedef) 
...
```python
# TemporalStatisticsConfigInputUnionTypeDef definition

TemporalStatisticsConfigInputUnionTypeDef = Union[
    TemporalStatisticsConfigInputTypeDef,  # (1)
    TemporalStatisticsConfigInputOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: TemporalStatisticsConfigInputTypeDef](./type_defs.md#temporalstatisticsconfiginputtypedef) 
2. See [:material-code-braces: TemporalStatisticsConfigInputOutputTypeDef](./type_defs.md#temporalstatisticsconfiginputoutputtypedef) 

## ZonalStatisticsConfigInputUnionTypeDef

```python
# ZonalStatisticsConfigInputUnionTypeDef definition

ZonalStatisticsConfigInputUnionTypeDef = Union[
    ZonalStatisticsConfigInputTypeDef,  # (1)
    ZonalStatisticsConfigInputOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: ZonalStatisticsConfigInputTypeDef](./type_defs.md#zonalstatisticsconfiginputtypedef) 
2. See [:material-code-braces: ZonalStatisticsConfigInputOutputTypeDef](./type_defs.md#zonalstatisticsconfiginputoutputtypedef) 

## CustomIndicesInputUnionTypeDef

```python
# CustomIndicesInputUnionTypeDef definition

CustomIndicesInputUnionTypeDef = Union[
    CustomIndicesInputTypeDef,  # (1)
    CustomIndicesInputOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: CustomIndicesInputTypeDef](./type_defs.md#customindicesinputtypedef) 
2. See [:material-code-braces: CustomIndicesInputOutputTypeDef](./type_defs.md#customindicesinputoutputtypedef) 

## ResamplingConfigInputUnionTypeDef

```python
# ResamplingConfigInputUnionTypeDef definition

ResamplingConfigInputUnionTypeDef = Union[
    ResamplingConfigInputTypeDef,  # (1)
    ResamplingConfigInputOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: ResamplingConfigInputTypeDef](./type_defs.md#resamplingconfiginputtypedef) 
2. See [:material-code-braces: ResamplingConfigInputOutputTypeDef](./type_defs.md#resamplingconfiginputoutputtypedef) 

## StackConfigInputUnionTypeDef

```python
# StackConfigInputUnionTypeDef definition

StackConfigInputUnionTypeDef = Union[
    StackConfigInputTypeDef,  # (1)
    StackConfigInputOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: StackConfigInputTypeDef](./type_defs.md#stackconfiginputtypedef) 
2. See [:material-code-braces: StackConfigInputOutputTypeDef](./type_defs.md#stackconfiginputoutputtypedef) 
...
```python
# BandMathConfigInputUnionTypeDef definition

BandMathConfigInputUnionTypeDef = Union[
    BandMathConfigInputTypeDef,  # (1)
    BandMathConfigInputOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: BandMathConfigInputTypeDef](./type_defs.md#bandmathconfiginputtypedef) 
2. See [:material-code-braces: BandMathConfigInputOutputTypeDef](./type_defs.md#bandmathconfiginputoutputtypedef) 
...
class BandMathConfigInputTypeDef(TypedDict):
    CustomIndices: NotRequired[CustomIndicesInputUnionTypeDef],  # (1)
    PredefinedIndices: NotRequired[Sequence[str]],
```

1. See [:material-code-braces: CustomIndicesInputTypeDef](./type_defs.md#customindicesinputtypedef) [:material-code-braces: CustomIndicesInputOutputTypeDef](./type_defs.md#customindicesinputoutputtypedef) 
...
class JobConfigInputTypeDef(TypedDict):
    BandMathConfig: NotRequired[BandMathConfigInputUnionTypeDef],  # (1)
    CloudMaskingConfig: NotRequired[Mapping[str, Any]],
    CloudRemovalConfig: NotRequired[CloudRemovalConfigInputUnionTypeDef],  # (2)
    GeoMosaicConfig: NotRequired[GeoMosaicConfigInputUnionTypeDef],  # (3)
    LandCoverSegmentationConfig: NotRequired[Mapping[str, Any]],
    ResamplingConfig: NotRequired[ResamplingConfigInputUnionTypeDef],  # (4)
    StackConfig: NotRequired[StackConfigInputUnionTypeDef],  # (5)
    TemporalStatisticsConfig: NotRequired[TemporalStatisticsConfigInputUnionTypeDef],  # (6)
    ZonalStatisticsConfig: NotRequired[ZonalStatisticsConfigInputUnionTypeDef],  # (7)
```

1. See [:material-code-braces: BandMathConfigInputTypeDef](./type_defs.md#bandmathconfiginputtypedef) [:material-code-braces: BandMathConfigInputOutputTypeDef](./type_defs.md#bandmathconfiginputoutputtypedef) 
2. See [:material-code-braces: CloudRemovalConfigInputTypeDef](./type_defs.md#cloudremovalconfiginputtypedef) [:material-code-braces: CloudRemovalConfigInputOutputTypeDef](./type_defs.md#cloudremovalconfiginputoutputtypedef) 
3. See [:material-code-braces: GeoMosaicConfigInputTypeDef](./type_defs.md#geomosaicconfiginputtypedef) [:material-code-braces: GeoMosaicConfigInputOutputTypeDef](./type_defs.md#geomosaicconfiginputoutputtypedef) 
4. See [:material-code-braces: ResamplingConfigInputTypeDef](./type_defs.md#resamplingconfiginputtypedef) [:material-code-braces: ResamplingConfigInputOutputTypeDef](./type_defs.md#resamplingconfiginputoutputtypedef) 
5. See [:material-code-braces: StackConfigInputTypeDef](./type_defs.md#stackconfiginputtypedef) [:material-code-braces: StackConfigInputOutputTypeDef](./type_defs.md#stackconfiginputoutputtypedef) 
6. See [:material-code-braces: TemporalStatisticsConfigInputTypeDef](./type_defs.md#temporalstatisticsconfiginputtypedef) [:material-code-braces: TemporalStatisticsConfigInputOutputTypeDef](./type_defs.md#temporalstatisticsconfiginputoutputtypedef) 
7. See [:material-code-braces: ZonalStatisticsConfigInputTypeDef](./type_defs.md#zonalstatisticsconfiginputtypedef) [:material-code-braces: ZonalStatisticsConfigInputOutputTypeDef](./type_defs.md#zonalstatisticsconfiginputoutputtypedef) 
