...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/securitylake.html#SecurityLake.Paginator.GetDataLakeSources)
...
) -> AsyncIterator[GetDataLakeSourcesResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListDataLakeExceptionsResponseTypeDef]:  # (2)
    ...
```
...
) -> AsyncIterator[ListLogSourcesResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListSubscribersResponseTypeDef]:  # (2)
    ...
```
