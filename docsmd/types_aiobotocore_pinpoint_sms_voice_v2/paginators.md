...
Type annotations and code completion for `#!python session.create_client("pinpoint-sms-voice-v2").get_paginator("describe_notify_configurations")`.
...
from types_aiobotocore_pinpoint_sms_voice_v2.paginator import DescribeNotifyConfigurationsPaginator

session = get_session()
async with session.create_client("pinpoint-sms-voice-v2") as client:  # (1)
    paginator: DescribeNotifyConfigurationsPaginator = client.get_paginator("describe_notify_configurations")  # (2)
    async for item in paginator.paginate(...):
        item: DescribeNotifyConfigurationsResultTypeDef
        print(item)  # (3)
```

1. client: [PinpointSMSVoiceV2Client](./client.md)
2. paginator: [DescribeNotifyConfigurationsPaginator](./paginators.md#describenotifyconfigurationspaginator)
3. item: `AioPageIterator[DescribeNotifyConfigurationsResultTypeDef]`
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> aiobotocore.paginate.AioPageIterator[DescribeNotifyConfigurationsResultTypeDef]:  # (3)
    ...
```

1. See `Sequence[NotifyConfigurationFilterTypeDef]`
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `AioPageIterator[DescribeNotifyConfigurationsResultTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("pinpoint-sms-voice-v2").get_paginator("describe_notify_templates")`.
...
from types_aiobotocore_pinpoint_sms_voice_v2.paginator import DescribeNotifyTemplatesPaginator

session = get_session()
async with session.create_client("pinpoint-sms-voice-v2") as client:  # (1)
    paginator: DescribeNotifyTemplatesPaginator = client.get_paginator("describe_notify_templates")  # (2)
    async for item in paginator.paginate(...):
        item: DescribeNotifyTemplatesResultTypeDef
        print(item)  # (3)
```

1. client: [PinpointSMSVoiceV2Client](./client.md)
2. paginator: [DescribeNotifyTemplatesPaginator](./paginators.md#describenotifytemplatespaginator)
3. item: `AioPageIterator[DescribeNotifyTemplatesResultTypeDef]`
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> aiobotocore.paginate.AioPageIterator[DescribeNotifyTemplatesResultTypeDef]:  # (3)
    ...
```

1. See `Sequence[NotifyTemplateFilterTypeDef]`
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `AioPageIterator[DescribeNotifyTemplatesResultTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("pinpoint-sms-voice-v2").get_paginator("describe_rcs_agent_country_launch_status")`.
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> aiobotocore.paginate.AioPageIterator[DescribeRcsAgentCountryLaunchStatusResultTypeDef]:  # (3)
    ...
```

1. See `Sequence[CountryLaunchStatusFilterTypeDef]`
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `AioPageIterator[DescribeRcsAgentCountryLaunchStatusResultTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("pinpoint-sms-voice-v2").get_paginator("describe_rcs_agents")`.
...
from types_aiobotocore_pinpoint_sms_voice_v2.paginator import DescribeRcsAgentsPaginator

session = get_session()
async with session.create_client("pinpoint-sms-voice-v2") as client:  # (1)
    paginator: DescribeRcsAgentsPaginator = client.get_paginator("describe_rcs_agents")  # (2)
    async for item in paginator.paginate(...):
        item: DescribeRcsAgentsResultTypeDef
        print(item)  # (3)
```

1. client: [PinpointSMSVoiceV2Client](./client.md)
2. paginator: [DescribeRcsAgentsPaginator](./paginators.md#describercsagentspaginator)
3. item: `AioPageIterator[DescribeRcsAgentsResultTypeDef]`
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> aiobotocore.paginate.AioPageIterator[DescribeRcsAgentsResultTypeDef]:  # (4)
    ...
```
...
3. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
4. See `AioPageIterator[DescribeRcsAgentsResultTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("pinpoint-sms-voice-v2").get_paginator("list_notify_countries")`.
...
from types_aiobotocore_pinpoint_sms_voice_v2.paginator import ListNotifyCountriesPaginator

session = get_session()
async with session.create_client("pinpoint-sms-voice-v2") as client:  # (1)
    paginator: ListNotifyCountriesPaginator = client.get_paginator("list_notify_countries")  # (2)
    async for item in paginator.paginate(...):
        item: ListNotifyCountriesResultTypeDef
        print(item)  # (3)
```

1. client: [PinpointSMSVoiceV2Client](./client.md)
2. paginator: [ListNotifyCountriesPaginator](./paginators.md#listnotifycountriespaginator)
3. item: `AioPageIterator[ListNotifyCountriesResultTypeDef]`
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> aiobotocore.paginate.AioPageIterator[ListNotifyCountriesResultTypeDef]:  # (5)
    ...
```
...
4. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
5. See `AioPageIterator[ListNotifyCountriesResultTypeDef]`
