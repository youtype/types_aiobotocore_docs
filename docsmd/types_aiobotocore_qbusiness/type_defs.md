...
```python
# ListDataAccessorsRequestListDataAccessorsPaginateTypeDef definition

class ListDataAccessorsRequestListDataAccessorsPaginateTypeDef(TypedDict):
    applicationId: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListPluginActionsRequestListPluginActionsPaginateTypeDef definition

class ListPluginActionsRequestListPluginActionsPaginateTypeDef(TypedDict):
    applicationId: str,
    pluginId: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListPluginTypeActionsRequestListPluginTypeActionsPaginateTypeDef definition

class ListPluginTypeActionsRequestListPluginTypeActionsPaginateTypeDef(TypedDict):
    pluginType: PluginTypeType,  # (1)
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (2)
```
...
```python
# ListPluginTypeMetadataRequestListPluginTypeMetadataPaginateTypeDef definition

class ListPluginTypeMetadataRequestListPluginTypeMetadataPaginateTypeDef(TypedDict):
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# SearchRelevantContentRequestSearchRelevantContentPaginateTypeDef definition

class SearchRelevantContentRequestSearchRelevantContentPaginateTypeDef(TypedDict):
    applicationId: str,
    queryText: str,
