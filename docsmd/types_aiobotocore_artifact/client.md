...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/artifact/client/close.html)
...
kwargs: ListCustomerAgreementsRequestRequestTypeDef = {  # (1)
    "maxResults": ...,
}
...
1. See [:material-code-braces: ListCustomerAgreementsRequestRequestTypeDef](./type_defs.md#listcustomeragreementsrequestrequesttypedef) 
