...
) -> AsyncIterator[DescribeClientAuthenticationSettingsResultTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DescribeLDAPSSettingsResultTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    RegionName: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeRegionsResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    RegionName: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DescribeUpdateDirectoryResultTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    DirectoryId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListCertificatesResultTypeDef]:  # (2)
    ...
```
