...
Type annotations and code completion for `#!python session.create_client("customer-profiles").get_paginator("list_recommender_filters")`.
...
from types_aiobotocore_customer_profiles.paginator import ListRecommenderFiltersPaginator

session = get_session()
async with session.create_client("customer-profiles") as client:  # (1)
    paginator: ListRecommenderFiltersPaginator = client.get_paginator("list_recommender_filters")  # (2)
    async for item in paginator.paginate(...):
        item: ListRecommenderFiltersResponseTypeDef
        print(item)  # (3)
```

1. client: [CustomerProfilesClient](./client.md)
2. paginator: [ListRecommenderFiltersPaginator](./paginators.md#listrecommenderfilterspaginator)
3. item: `AioPageIterator[ListRecommenderFiltersResponseTypeDef]`
...
def paginate(
    ...
    *,
    DomainName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> aiobotocore.paginate.AioPageIterator[ListRecommenderFiltersResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `AioPageIterator[ListRecommenderFiltersResponseTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("customer-profiles").get_paginator("list_recommender_schemas")`.
...
from types_aiobotocore_customer_profiles.paginator import ListRecommenderSchemasPaginator

session = get_session()
async with session.create_client("customer-profiles") as client:  # (1)
    paginator: ListRecommenderSchemasPaginator = client.get_paginator("list_recommender_schemas")  # (2)
    async for item in paginator.paginate(...):
        item: ListRecommenderSchemasResponseTypeDef
        print(item)  # (3)
```

1. client: [CustomerProfilesClient](./client.md)
2. paginator: [ListRecommenderSchemasPaginator](./paginators.md#listrecommenderschemaspaginator)
3. item: `AioPageIterator[ListRecommenderSchemasResponseTypeDef]`
...
def paginate(
    ...
    *,
    DomainName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> aiobotocore.paginate.AioPageIterator[ListRecommenderSchemasResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `AioPageIterator[ListRecommenderSchemasResponseTypeDef]`
