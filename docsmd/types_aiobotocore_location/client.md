...
Type annotations and code completion for `#!python session.create_client("location").cancel_job` method.
...
Type annotations and code completion for `#!python session.create_client("location").get_job` method.
...
Type annotations and code completion for `#!python session.create_client("location").list_jobs` method.
...
Type annotations and code completion for `#!python session.create_client("location").start_job` method.
...
Type annotations and code completion for `#!python session.create_client("location").get_waiter` method with overloads.
