<a id="type-annotations-for-aiobotocore-iot-module"></a>

# Type annotations for aiobotocore IoT module
...
- [Type annotations for aiobotocore IoT module](#type-annotations-for-aiobotocore-iot-module)
  - [IoTClient](#iotclient)
    - [Methods](#methods)
...
Type annotations for `aiobotocore.create_client("iot")` as
[IoTClient](./client.md)
...
```python
from types_aiobotocore_iot.paginators import GetBehaviorModelTrainingSummariesPaginator, ...
```
