...
Type annotations and code completion for  `#!python session.create_client("iot")` as [IoTClient](./client.md)
...
from `#!python session.create_client("iot").get_paginator("...")`.
...
def get_get_behavior_model_training_summaries_paginator() -> GetBehaviorModelTrainingSummariesPaginator:
    return client.get_paginator("get_behavior_model_training_summaries"))
```
...
- [GetThingConnectivityDataRequestRequestTypeDef](./type_defs.md#getthingconnectivitydatarequestrequesttypedef)
