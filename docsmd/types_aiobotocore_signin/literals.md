...
> [Index](../README.md) > [SignInService](./README.md) > Literals
...
```python
# SignInServiceServiceName definition
SignInServiceServiceName = Literal[
    "signin",
]
```
## ServiceName
...
from types_aiobotocore_signin.literals import ServiceName
...
from types_aiobotocore_signin.literals import ResourceServiceName
