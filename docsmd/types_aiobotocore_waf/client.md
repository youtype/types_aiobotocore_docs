...
Type annotations and code completion for `#!python session.create_client("waf").close` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/waf.html#WAF.Client.close)
...
Type annotations and code completion for `#!python session.create_client("waf").get_ip_set` method.
