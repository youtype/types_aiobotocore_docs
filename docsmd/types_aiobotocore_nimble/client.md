...
```python
NimbleStudioClient usage type checking example
...
Type annotations and code completion for `#!python session.create_client("nimble").create_studio` method.
...
Type annotations and code completion for `#!python session.create_client("nimble").get_streaming_session_backup` method.
...
Type annotations and code completion for `#!python session.create_client("nimble").list_streaming_images` method.
...
Type annotations and code completion for `#!python session.create_client("nimble").list_streaming_session_backups` method.
