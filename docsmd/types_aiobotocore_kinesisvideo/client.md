...
Type annotations and code completion for `#!python session.create_client("kinesisvideo").describe_stream_storage_configuration` method.
...
await def describe_stream_storage_configuration(
    self,
    *,
    StreamName: str = ...,
    StreamARN: str = ...,
...
Type annotations and code completion for `#!python session.create_client("kinesisvideo").update_stream_storage_configuration` method.
...
await def update_stream_storage_configuration(
    self,
    *,
    CurrentVersion: str,
    StreamStorageConfiguration: StreamStorageConfigurationTypeDef,  # (1)
