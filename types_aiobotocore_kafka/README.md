<a id="type-annotations-for-aiobotocore-kafka-module"></a>

# Type annotations for aiobotocore Kafka module
...
pip install 'types-aiobotocore[kafka]'

# install as a standalone
pip install types-aiobotocore-kafka
```

- [Type annotations for aiobotocore Kafka module](#type-annotations-for-aiobotocore-kafka-module)
...
Type annotations for `aiobotocore.create_client("kafka")` as
[KafkaClient](./client.md)
...
```python
from types_aiobotocore_kafka.paginators import ListClusterOperationsPaginator, ...
```
