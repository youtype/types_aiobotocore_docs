...
Type annotations and code completion for `#!python session.create_client("osis").create_pipeline_endpoint` method.
...
await def create_pipeline_endpoint(
    self,
    *,
    PipelineArn: str,
...
Type annotations and code completion for `#!python session.create_client("osis").delete_pipeline_endpoint` method.
...
await def delete_pipeline_endpoint(
    self,
    *,
    EndpointId: str,
) -> dict[str, Any]:
...
Type annotations and code completion for `#!python session.create_client("osis").delete_resource_policy` method.
...
Type annotations and code completion for `#!python session.create_client("osis").get_resource_policy` method.
...
Type annotations and code completion for `#!python session.create_client("osis").list_pipeline_endpoint_connections` method.
...
await def list_pipeline_endpoint_connections(
    self,
    *,
    MaxResults: int = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("osis").list_pipeline_endpoints` method.
...
await def list_pipeline_endpoints(
    self,
    *,
    MaxResults: int = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("osis").put_resource_policy` method.
...
Type annotations and code completion for `#!python session.create_client("osis").revoke_pipeline_endpoint_connections` method.
...
await def revoke_pipeline_endpoint_connections(
    self,
    *,
    PipelineArn: str,
...
Type annotations and code completion for `#!python session.create_client("osis").get_paginator` method with overloads.
