<a id="literals-for-aiobotocore-apigatewaymanagementapi-module"></a>

# Literals for aiobotocore ApiGatewayManagementApi module

> [Index](../README.md) > [ApiGatewayManagementApi](./README.md) > Literals
...
- [Literals for aiobotocore ApiGatewayManagementApi module](#literals-for-aiobotocore-apigatewaymanagementapi-module)
...
```python
from types_aiobotocore_apigatewaymanagementapi.literals import ResourceServiceName
```
