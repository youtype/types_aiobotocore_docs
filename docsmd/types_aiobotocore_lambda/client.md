...
async with session.create_client("lambda") as client:
    try:
        do_something(client)
            ...
            client.CallbackTimeoutException,
        client.CapacityProviderLimitExceededException,
        client.ClientError,
        client.CodeSigningConfigNotFoundException,
        client.CodeStorageExceededException,
        client.CodeVerificationFailedException,
        client.DurableExecutionAlreadyStartedException,
        ...
        client.FunctionVersionsPerCapacityProviderLimitExceededException,
        ...
        client.NoPublishedVersionException,
        ...
        client.S3FilesMountConnectivityException,
        client.S3FilesMountFailureException,
        client.S3FilesMountTimeoutException,
        client.SerializedRequestEntityTooLargeException,
...
Type annotations and code completion for `#!python session.create_client("lambda").checkpoint_durable_execution` method.
...
await def checkpoint_durable_execution(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("lambda").create_capacity_provider` method.
...
Type annotations and code completion for `#!python session.create_client("lambda").delete_capacity_provider` method.
...
Type annotations and code completion for `#!python session.create_client("lambda").delete_function` method.
...
Type annotations and code completion for `#!python session.create_client("lambda").get_capacity_provider` method.
...
await def get_capacity_provider(
    self,
    *,
    CapacityProviderName: str,
...
Type annotations and code completion for `#!python session.create_client("lambda").get_durable_execution` method.
...
await def get_durable_execution(
    self,
    *,
    DurableExecutionArn: str,
...
Type annotations and code completion for `#!python session.create_client("lambda").get_durable_execution_history` method.
...
await def get_durable_execution_history(
    self,
    *,
    DurableExecutionArn: str,
...
Type annotations and code completion for `#!python session.create_client("lambda").get_durable_execution_state` method.
...
await def get_durable_execution_state(
    self,
    *,
    DurableExecutionArn: str,
    CheckpointToken: str,
...
Type annotations and code completion for `#!python session.create_client("lambda").get_event_source_mapping` method.
...
Type annotations and code completion for `#!python session.create_client("lambda").get_function_scaling_config` method.
...
await def get_function_scaling_config(
    self,
    *,
    FunctionName: str,
    Qualifier: str,
...
Type annotations and code completion for `#!python session.create_client("lambda").list_capacity_providers` method.
...
await def list_capacity_providers(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("lambda").list_durable_executions_by_function` method.
...
await def list_durable_executions_by_function(
    self,
    *,
    FunctionName: str,
    Qualifier: str = ...,
...
Type annotations and code completion for `#!python session.create_client("lambda").list_function_versions_by_capacity_provider` method.
...
await def list_function_versions_by_capacity_provider(
    self,
    *,
    CapacityProviderName: str,
    Marker: str = ...,
...
Type annotations and code completion for `#!python session.create_client("lambda").put_function_scaling_config` method.
...
await def put_function_scaling_config(
    self,
    *,
    FunctionName: str,
    Qualifier: str,
...
Type annotations and code completion for `#!python session.create_client("lambda").send_durable_execution_callback_failure` method.
...
await def send_durable_execution_callback_failure(
    self,
    *,
    CallbackId: str,
...
Type annotations and code completion for `#!python session.create_client("lambda").send_durable_execution_callback_heartbeat` method.
...
await def send_durable_execution_callback_heartbeat(
    self,
    *,
    CallbackId: str,
) -> dict[str, Any]:
...
Type annotations and code completion for `#!python session.create_client("lambda").send_durable_execution_callback_success` method.
...
await def send_durable_execution_callback_success(
    self,
    *,
    CallbackId: str,
    Result: BlobTypeDef = ...,
...
Type annotations and code completion for `#!python session.create_client("lambda").stop_durable_execution` method.
...
await def stop_durable_execution(
    self,
    *,
    DurableExecutionArn: str,
    Error: ErrorObjectUnionTypeDef = ...,  # (1)
...
Type annotations and code completion for `#!python session.create_client("lambda").update_capacity_provider` method.
