...
Type annotations and code completion for `#!python session.create_client("pinpoint").close` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint.html#Pinpoint.Client.close)
...
Type annotations and code completion for `#!python session.create_client("pinpoint").delete_baidu_channel` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").delete_email_template` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").delete_gcm_channel` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").delete_push_template` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").delete_sms_channel` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").delete_voice_channel` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").get_apns_channel` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").get_apns_voip_sandbox_channel` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").get_baidu_channel` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").get_email_template` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").get_export_job` method.
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint.html#Pinpoint.Client.get_journey_run_execution_activity_metrics)
...
1. See [:material-code-braces: GetJourneyRunExecutionActivityMetricsRequestRequestTypeDef](./type_defs.md#getjourneyrunexecutionactivitymetricsrequestrequesttypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint.html#Pinpoint.Client.get_journey_run_execution_metrics)
...
1. See [:material-code-braces: GetJourneyRunExecutionMetricsRequestRequestTypeDef](./type_defs.md#getjourneyrunexecutionmetricsrequestrequesttypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint.html#Pinpoint.Client.get_journey_runs)
...
1. See [:material-code-braces: GetJourneyRunsRequestRequestTypeDef](./type_defs.md#getjourneyrunsrequestrequesttypedef) 
...
Type annotations and code completion for `#!python session.create_client("pinpoint").untag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_adm_channel` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_apns_channel` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_apns_sandbox_channel` method.
...
await def update_apns_sandbox_channel(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_apns_voip_channel` method.
...
await def update_apns_voip_channel(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_apns_voip_sandbox_channel` method.
...
await def update_apns_voip_sandbox_channel(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_application_settings` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_baidu_channel` method.
...
await def update_baidu_channel(
    self,
    *,
    ApplicationId: str,
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_campaign` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_email_channel` method.
...
await def update_email_channel(
    self,
    *,
    ApplicationId: str,
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_email_template` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_endpoint` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_endpoints_batch` method.
...
await def update_endpoints_batch(
    self,
    *,
    ApplicationId: str,
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_gcm_channel` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_in_app_template` method.
...
await def update_in_app_template(
    self,
    *,
    InAppTemplateRequest: InAppTemplateRequestTypeDef,  # (1)
    TemplateName: str,
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_journey` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_journey_state` method.
...
await def update_journey_state(
    self,
    *,
    ApplicationId: str,
    JourneyId: str,
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_push_template` method.
...
await def update_push_template(
    self,
    *,
    PushNotificationTemplateRequest: PushNotificationTemplateRequestTypeDef,  # (1)
    TemplateName: str,
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_recommender_configuration` method.
...
await def update_recommender_configuration(
    self,
    *,
    RecommenderId: str,
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_segment` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_sms_channel` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_sms_template` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_template_active_version` method.
...
await def update_template_active_version(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_voice_channel` method.
...
await def update_voice_channel(
    self,
    *,
    ApplicationId: str,
...
Type annotations and code completion for `#!python session.create_client("pinpoint").update_voice_template` method.
...
await def update_voice_template(
    self,
    *,
    TemplateName: str,
    VoiceTemplateRequest: VoiceTemplateRequestTypeDef,  # (1)
...
Type annotations and code completion for `#!python session.create_client("pinpoint").verify_otp_message` method.
...
Type annotations and code completion for `#!python session.create_client("pinpoint").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint.html#Pinpoint.Client.__aenter__)
...
Type annotations and code completion for `#!python session.create_client("pinpoint").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint.html#Pinpoint.Client.__aexit__)
