...
Type annotations and code completion for `#!python session.create_client("s3vectors").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.create_client("s3vectors").put_vectors` method.
...
Type annotations and code completion for `#!python session.create_client("s3vectors").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("s3vectors").untag_resource` method.
