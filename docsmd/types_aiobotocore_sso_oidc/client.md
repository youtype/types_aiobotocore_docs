...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sso-oidc.html#SSOOIDC.Client.create_token_with_iam)
...
1. See [:material-code-braces: CreateTokenWithIAMRequestRequestTypeDef](./type_defs.md#createtokenwithiamrequestrequesttypedef) 
