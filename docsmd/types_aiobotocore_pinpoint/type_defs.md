...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateBaiduChannelRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateEmailTemplateRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateSmsTemplateRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateVoiceTemplateRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateEmailChannelRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateGcmChannelRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateJourneyStateRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import TagResourceRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import PhoneNumberValidateRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import PutEventStreamRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import RemoveAttributesRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateSmsChannelRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import SendOTPMessageRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateTemplateActiveVersionRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateRecommenderConfigurationRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateVoiceChannelRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import VerifyOTPMessageRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateApplicationSettingsRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdatePushTemplateRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateEndpointRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateEndpointsBatchRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import PutEventsRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateInAppTemplateRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import SendMessagesRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import SendUsersMessagesRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateSegmentRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateCampaignRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_pinpoint.type_defs import UpdateJourneyRequestRequestTypeDef
