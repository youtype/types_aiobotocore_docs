...
Type annotations and code completion for `#!python session.create_client("location").get_paginator("list_jobs")`.
...
from types_aiobotocore_location.paginator import ListJobsPaginator
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> aiobotocore.paginate.AioPageIterator[ListJobsResponseTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: JobsFilterTypeDef](./type_defs.md#jobsfiltertypedef)
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `AioPageIterator[ListJobsResponseTypeDef]`
