...
async with session.create_client("ecs") as client:
    try:
        ...
        client.ClusterContainsCapacityProviderException,
        ...
        client.DaemonNotActiveException,
        client.DaemonNotFoundException,
...
Type annotations and code completion for `#!python session.create_client("ecs").create_daemon` method.
...
Type annotations and code completion for `#!python session.create_client("ecs").create_express_gateway_service` method.
...
await def create_express_gateway_service(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ecs").delete_daemon` method.
...
Type annotations and code completion for `#!python session.create_client("ecs").delete_daemon_task_definition` method.
...
await def delete_daemon_task_definition(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ecs").delete_express_gateway_service` method.
...
await def delete_express_gateway_service(
    self,
    *,
    serviceArn: str,
...
Type annotations and code completion for `#!python session.create_client("ecs").describe_daemon` method.
...
Type annotations and code completion for `#!python session.create_client("ecs").describe_daemon_deployments` method.
...
await def describe_daemon_deployments(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ecs").describe_daemon_revisions` method.
...
await def describe_daemon_revisions(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ecs").describe_daemon_task_definition` method.
...
await def describe_daemon_task_definition(
    self,
    *,
    daemonTaskDefinition: str,
...
Type annotations and code completion for `#!python session.create_client("ecs").describe_express_gateway_service` method.
...
await def describe_express_gateway_service(
    self,
    *,
    serviceArn: str,
...
Type annotations and code completion for `#!python session.create_client("ecs").list_daemon_deployments` method.
...
await def list_daemon_deployments(
    self,
    *,
    daemonArn: str,
...
Type annotations and code completion for `#!python session.create_client("ecs").list_daemon_task_definitions` method.
...
await def list_daemon_task_definitions(
    self,
    *,
    familyPrefix: str = ...,
    family: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ecs").list_daemons` method.
...
Type annotations and code completion for `#!python session.create_client("ecs").register_daemon_task_definition` method.
...
await def register_daemon_task_definition(
    self,
    *,
    family: str,
    ...
    tags: Sequence[TagTypeDef] = ...,  # (3)
) -> RegisterDaemonTaskDefinitionResponseTypeDef:  # (4)
    ...
```
...
3. See `Sequence[TagTypeDef]`
4. See [:material-code-braces: RegisterDaemonTaskDefinitionResponseTypeDef](./type_defs.md#registerdaemontaskdefinitionresponsetypedef)
...
Type annotations and code completion for `#!python session.create_client("ecs").update_daemon` method.
...
Type annotations and code completion for `#!python session.create_client("ecs").update_express_gateway_service` method.
...
await def update_express_gateway_service(
    self,
    *,
    serviceArn: str,
    executionRoleArn: str = ...,
