...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListManagedViewsOutputTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListManagedViewsInputListManagedViewsPaginateTypeDef](./type_defs.md#listmanagedviewsinputlistmanagedviewspaginatetypedef) 
