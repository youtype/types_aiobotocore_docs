...
Type annotations and code completion for `#!python session.create_client("emr-serverless").get_resource_dashboard` method.
...
await def get_resource_dashboard(
    self,
    *,
    applicationId: str,
    resourceId: str,
...
Type annotations and code completion for `#!python session.create_client("emr-serverless").get_session` method.
...
Type annotations and code completion for `#!python session.create_client("emr-serverless").get_session_endpoint` method.
...
await def get_session_endpoint(
    self,
    *,
    applicationId: str,
    sessionId: str,
...
Type annotations and code completion for `#!python session.create_client("emr-serverless").list_sessions` method.
...
Type annotations and code completion for `#!python session.create_client("emr-serverless").start_session` method.
...
Type annotations and code completion for `#!python session.create_client("emr-serverless").terminate_session` method.
