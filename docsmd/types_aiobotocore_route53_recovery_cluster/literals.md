...
> [Index](../README.md) > [Route53RecoveryCluster](./README.md) > Literals
...
```python
# RoutingControlStateType usage example
...
```python
# RoutingControlStateType definition

RoutingControlStateType = Literal[
    "Off",
    "On",
]
```
...
```python
# Route53RecoveryClusterServiceName usage example

from types_aiobotocore_route53_recovery_cluster.literals import Route53RecoveryClusterServiceName

def get_value() -> Route53RecoveryClusterServiceName:
    return "route53-recovery-cluster"
```

```python
# Route53RecoveryClusterServiceName definition

Route53RecoveryClusterServiceName = Literal[
...
from types_aiobotocore_route53_recovery_cluster.literals import ServiceName
...
from types_aiobotocore_route53_recovery_cluster.literals import ResourceServiceName
