...
await def create_db_proxy(
    ...
    *,
    ...
    EndpointNetworkType: EndpointNetworkTypeType = ...,  # (4)
    TargetConnectionNetworkType: TargetConnectionNetworkTypeType = ...,  # (5)
) -> CreateDBProxyResponseTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: CreateDBProxyResponseTypeDef](./type_defs.md#createdbproxyresponsetypedef)
...
Type annotations and code completion for `#!python session.create_client("rds").describe_db_major_engine_versions` method.
...
await def describe_db_major_engine_versions(
    self,
    *,
    Engine: str = ...,
    MajorEngineVersion: str = ...,
...
) -> ModifyDBInstanceResultTypeDef:  # (7)
    ...
```
...
7. See [:material-code-braces: ModifyDBInstanceResultTypeDef](./type_defs.md#modifydbinstanceresulttypedef)
