...
Type annotations and code completion for `#!python session.create_client("dms").cancel_metadata_model_conversion` method.
...
await def cancel_metadata_model_conversion(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("dms").cancel_metadata_model_creation` method.
...
await def cancel_metadata_model_creation(
    self,
    *,
    MigrationProjectIdentifier: str,
    RequestIdentifier: str,
...
Type annotations and code completion for `#!python session.create_client("dms").describe_metadata_model` method.
...
await def describe_metadata_model(
    self,
    *,
    SelectionRules: str,
    MigrationProjectIdentifier: str,
...
Type annotations and code completion for `#!python session.create_client("dms").describe_metadata_model_children` method.
...
await def describe_metadata_model_children(
    self,
    *,
    SelectionRules: str,
    MigrationProjectIdentifier: str,
...
Type annotations and code completion for `#!python session.create_client("dms").describe_metadata_model_creations` method.
...
await def describe_metadata_model_creations(
    self,
    *,
    MigrationProjectIdentifier: str,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
...
Type annotations and code completion for `#!python session.create_client("dms").get_target_selection_rules` method.
...
await def get_target_selection_rules(
    self,
    *,
    MigrationProjectIdentifier: str,
    SelectionRules: str,
...
Type annotations and code completion for `#!python session.create_client("dms").start_metadata_model_creation` method.
...
await def start_metadata_model_creation(
    self,
    *,
    MigrationProjectIdentifier: str,
    SelectionRules: str,
