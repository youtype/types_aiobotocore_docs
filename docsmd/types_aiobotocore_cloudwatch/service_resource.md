...
- `evaluation_state`: `Awaitable`[[EvaluationStateType](./literals.md#evaluationstatetype)]
- `state_transitioned_timestamp`: `Awaitable`[`datetime.datetime`]
- `evaluation_criteria`: `Awaitable`[[EvaluationCriteriaTypeDef](./type_defs.md#evaluationcriteriatypedef)]
