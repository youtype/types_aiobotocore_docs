...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/voice-id.html#VoiceID.Client.associate_fraudster)
...
1. See [:material-code-braces: AssociateFraudsterRequestRequestTypeDef](./type_defs.md#associatefraudsterrequestrequesttypedef) 
...
Type annotations and code completion for `#!python session.create_client("voice-id").close` method.
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/voice-id.html#VoiceID.Client.create_watchlist)
...
1. See [:material-code-braces: CreateWatchlistRequestRequestTypeDef](./type_defs.md#createwatchlistrequestrequesttypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/voice-id.html#VoiceID.Client.delete_watchlist)
...
1. See [:material-code-braces: DeleteWatchlistRequestRequestTypeDef](./type_defs.md#deletewatchlistrequestrequesttypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/voice-id.html#VoiceID.Client.describe_watchlist)
...
1. See [:material-code-braces: DescribeWatchlistRequestRequestTypeDef](./type_defs.md#describewatchlistrequestrequesttypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/voice-id.html#VoiceID.Client.disassociate_fraudster)
...
1. See [:material-code-braces: DisassociateFraudsterRequestRequestTypeDef](./type_defs.md#disassociatefraudsterrequestrequesttypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/voice-id.html#VoiceID.Client.list_fraudsters)
...
1. See [:material-code-braces: ListFraudstersRequestRequestTypeDef](./type_defs.md#listfraudstersrequestrequesttypedef) 
...
Type annotations and code completion for `#!python session.create_client("voice-id").list_watchlists` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/voice-id.html#VoiceID.Client.list_watchlists)
...
1. See [:material-code-braces: ListWatchlistsRequestRequestTypeDef](./type_defs.md#listwatchlistsrequestrequesttypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/voice-id.html#VoiceID.Client.update_watchlist)
...
1. See [:material-code-braces: UpdateWatchlistRequestRequestTypeDef](./type_defs.md#updatewatchlistrequestrequesttypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/voice-id.html#VoiceID.Client.__aenter__)
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/voice-id.html#VoiceID.Client.__aexit__)
