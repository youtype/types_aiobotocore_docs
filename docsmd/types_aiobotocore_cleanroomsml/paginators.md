...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListCollaborationConfiguredModelAlgorithmAssociationsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    collaborationIdentifier: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListCollaborationMLInputChannelsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    trainedModelArn: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListCollaborationTrainedModelExportJobsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    trainedModelArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListCollaborationTrainedModelInferenceJobsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    collaborationIdentifier: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListCollaborationTrainedModelsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListConfiguredModelAlgorithmAssociationsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListConfiguredModelAlgorithmsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    membershipIdentifier: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListMLInputChannelsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    trainedModelArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListTrainedModelInferenceJobsResponseTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    membershipIdentifier: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListTrainedModelsResponseTypeDef]:  # (2)
    ...
```
