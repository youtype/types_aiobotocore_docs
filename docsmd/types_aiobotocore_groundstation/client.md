...
Type annotations and code completion for `#!python session.create_client("groundstation").create_dataflow_endpoint_group_v2` method.
...
await def create_dataflow_endpoint_group_v2(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("groundstation").describe_contact_version` method.
...
await def describe_contact_version(
    self,
    *,
    contactId: str,
    versionId: int,
...
Type annotations and code completion for `#!python session.create_client("groundstation").get_agent_task_response_url` method.
...
await def get_agent_task_response_url(
    self,
    *,
    agentId: str,
    taskId: str,
...
Type annotations and code completion for `#!python session.create_client("groundstation").list_antennas` method.
...
Type annotations and code completion for `#!python session.create_client("groundstation").list_contact_versions` method.
...
await def list_contact_versions(
    self,
    *,
    contactId: str,
    maxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("groundstation").list_ground_station_reservations` method.
...
await def list_ground_station_reservations(
    self,
    *,
    groundStationId: str,
    startTime: TimestampTypeDef,
...
Type annotations and code completion for `#!python session.create_client("groundstation").update_contact` method.
