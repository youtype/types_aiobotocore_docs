...
Type annotations and code completion for `#!python session.create_client("ec2").get_waiter("secondary_network_create_complete")`.
...
from types_aiobotocore_ec2.waiter import SecondaryNetworkCreateCompleteWaiter
...
Type annotations and code completion for `#!python session.create_client("ec2").get_waiter("secondary_network_delete_complete")`.
...
from types_aiobotocore_ec2.waiter import SecondaryNetworkDeleteCompleteWaiter
...
Type annotations and code completion for `#!python session.create_client("ec2").get_waiter("secondary_subnet_create_complete")`.
...
from types_aiobotocore_ec2.waiter import SecondarySubnetCreateCompleteWaiter
...
Type annotations and code completion for `#!python session.create_client("ec2").get_waiter("secondary_subnet_delete_complete")`.
...
from types_aiobotocore_ec2.waiter import SecondarySubnetDeleteCompleteWaiter
