...
> [Index](../README.md) > [IdentityStore](./README.md) > Literals
...
```python
# ListGroupMembershipsForMemberPaginatorName definition
...
from types_aiobotocore_identitystore.literals import ListGroupMembershipsPaginatorName
...
from types_aiobotocore_identitystore.literals import ListGroupsPaginatorName
...
from types_aiobotocore_identitystore.literals import ListUsersPaginatorName
...
from types_aiobotocore_identitystore.literals import UserStatusType
...
```python
# IdentityStoreServiceName usage example
...
```python
# IdentityStoreServiceName definition
IdentityStoreServiceName = Literal[
    "identitystore",
]
```
## ServiceName
...
from types_aiobotocore_identitystore.literals import ResourceServiceName
...
from types_aiobotocore_identitystore.literals import PaginatorName
...
from types_aiobotocore_identitystore.literals import RegionName
