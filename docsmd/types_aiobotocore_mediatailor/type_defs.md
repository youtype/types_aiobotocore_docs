...
from types_aiobotocore_mediatailor.type_defs import CustomOutputConfigurationUnionTypeDef
...
from types_aiobotocore_mediatailor.type_defs import HttpRequestConfigurationUnionTypeDef
...
from types_aiobotocore_mediatailor.type_defs import AdDecisionServerConfigurationUnionTypeDef
...
from types_aiobotocore_mediatailor.type_defs import SequentialExecutorConfigurationUnionTypeDef
...
from types_aiobotocore_mediatailor.type_defs import HttpRequestOutputTypeDef
...
from types_aiobotocore_mediatailor.type_defs import HttpRequestTypeDef
...
from types_aiobotocore_mediatailor.type_defs import CustomOutputConfigurationOutputTypeDef
...
from types_aiobotocore_mediatailor.type_defs import CustomOutputConfigurationTypeDef
...
from types_aiobotocore_mediatailor.type_defs import DeleteFunctionRequestTypeDef
...
from types_aiobotocore_mediatailor.type_defs import FunctionRefTypeDef
...
from types_aiobotocore_mediatailor.type_defs import HttpRequestConfigurationOutputTypeDef
...
from types_aiobotocore_mediatailor.type_defs import GetFunctionRequestTypeDef
...
from types_aiobotocore_mediatailor.type_defs import HttpRequestConfigurationTypeDef
...
from types_aiobotocore_mediatailor.type_defs import ListFunctionsRequestTypeDef
...
from types_aiobotocore_mediatailor.type_defs import TrafficShapingTpsConfigurationTypeDef
...
from types_aiobotocore_mediatailor.type_defs import AdDecisionServerConfigurationOutputTypeDef
...
from types_aiobotocore_mediatailor.type_defs import AdDecisionServerConfigurationTypeDef
...
from types_aiobotocore_mediatailor.type_defs import SequentialExecutorConfigurationOutputTypeDef
...
from types_aiobotocore_mediatailor.type_defs import SequentialExecutorConfigurationTypeDef
...
from types_aiobotocore_mediatailor.type_defs import ListFunctionsRequestPaginateTypeDef
...
class GetPlaybackConfigurationResponseTypeDef(TypedDict):
    ...
    FunctionMapping: dict[EventNameType, str],  # (12)
...
class PlaybackConfigurationTypeDef(TypedDict):
    ...
    FunctionMapping: NotRequired[dict[EventNameType, str]],  # (12)
```
...
from types_aiobotocore_mediatailor.type_defs import FunctionTypeDef
...
class FunctionTypeDef(TypedDict):
    ...
    SequentialExecutorConfiguration: NotRequired[SequentialExecutorConfigurationOutputTypeDef],  # (4)
    Tags: NotRequired[dict[str, str]],
    Arn: NotRequired[str],
```
...
4. See [:material-code-braces: SequentialExecutorConfigurationOutputTypeDef](./type_defs.md#sequentialexecutorconfigurationoutputtypedef)
...
from types_aiobotocore_mediatailor.type_defs import GetFunctionResponseTypeDef
...
class GetFunctionResponseTypeDef(TypedDict):
    ...
    SequentialExecutorConfiguration: SequentialExecutorConfigurationOutputTypeDef,  # (4)
    Tags: dict[str, str],
    Arn: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (5)
```
...
from types_aiobotocore_mediatailor.type_defs import PutFunctionResponseTypeDef
...
class PutPlaybackConfigurationRequestTypeDef(TypedDict):
    ...
    FunctionMapping: NotRequired[Mapping[EventNameType, str]],  # (10)
```
...
10. See `Mapping[EventNameType, str]`
...
from types_aiobotocore_mediatailor.type_defs import ListFunctionsResponseTypeDef
...
from types_aiobotocore_mediatailor.type_defs import PutFunctionRequestTypeDef
...
class PutFunctionRequestTypeDef(TypedDict):
    ...
    SequentialExecutorConfiguration: NotRequired[SequentialExecutorConfigurationUnionTypeDef],  # (4)
    Tags: NotRequired[Mapping[str, str]],
```
...
4. See [:material-code-braces: SequentialExecutorConfigurationUnionTypeDef](#sequentialexecutorconfigurationuniontypedef)
...
from types_aiobotocore_mediatailor.type_defs import UpdateProgramResponseTypeDef
...
from types_aiobotocore_mediatailor.type_defs import AlternateMediaTypeDef
...
from types_aiobotocore_mediatailor.type_defs import AudienceMediaTypeDef
...
from types_aiobotocore_mediatailor.type_defs import CreateProgramRequestTypeDef
...
from types_aiobotocore_mediatailor.type_defs import UpdateProgramRequestTypeDef
