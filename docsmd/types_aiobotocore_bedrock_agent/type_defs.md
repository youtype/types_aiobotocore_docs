...
class PromptVariantOutputTypeDef(TypedDict):
    name: str,
    templateConfiguration: PromptTemplateConfigurationOutputTypeDef,  # (3)
    templateType: PromptTemplateTypeType,  # (4)
    inferenceConfiguration: NotRequired[PromptInferenceConfigurationOutputTypeDef],  # (1)
    metadata: NotRequired[List[PromptMetadataEntryTypeDef]],  # (2)
    modelId: NotRequired[str],
```

1. See [:material-code-braces: PromptInferenceConfigurationOutputTypeDef](./type_defs.md#promptinferenceconfigurationoutputtypedef) 
2. See [:material-code-braces: PromptMetadataEntryTypeDef](./type_defs.md#promptmetadataentrytypedef) 
3. See [:material-code-braces: PromptTemplateConfigurationOutputTypeDef](./type_defs.md#prompttemplateconfigurationoutputtypedef) 
4. See [:material-code-brackets: PromptTemplateTypeType](./literals.md#prompttemplatetypetype) 
...
1. See [:material-code-braces: TextPromptTemplateConfigurationTypeDef](./type_defs.md#textprompttemplateconfigurationtypedef) [:material-code-braces: TextPromptTemplateConfigurationOutputTypeDef](./type_defs.md#textprompttemplateconfigurationoutputtypedef) 
...
class PromptVariantTypeDef(TypedDict):
    name: str,
    templateConfiguration: PromptTemplateConfigurationUnionTypeDef,  # (3)
    templateType: PromptTemplateTypeType,  # (4)
    inferenceConfiguration: NotRequired[PromptInferenceConfigurationUnionTypeDef],  # (1)
    metadata: NotRequired[Sequence[PromptMetadataEntryTypeDef]],  # (2)
    modelId: NotRequired[str],
```

1. See [:material-code-braces: PromptInferenceConfigurationTypeDef](./type_defs.md#promptinferenceconfigurationtypedef) [:material-code-braces: PromptInferenceConfigurationOutputTypeDef](./type_defs.md#promptinferenceconfigurationoutputtypedef) 
2. See [:material-code-braces: PromptMetadataEntryTypeDef](./type_defs.md#promptmetadataentrytypedef) 
3. See [:material-code-braces: PromptTemplateConfigurationTypeDef](./type_defs.md#prompttemplateconfigurationtypedef) [:material-code-braces: PromptTemplateConfigurationOutputTypeDef](./type_defs.md#prompttemplateconfigurationoutputtypedef) 
4. See [:material-code-brackets: PromptTemplateTypeType](./literals.md#prompttemplatetypetype) 
...
class PromptFlowNodeConfigurationTypeDef(TypedDict):
    sourceConfiguration: PromptFlowNodeSourceConfigurationUnionTypeDef,  # (1)
```

1. See [:material-code-braces: PromptFlowNodeSourceConfigurationTypeDef](./type_defs.md#promptflownodesourceconfigurationtypedef) [:material-code-braces: PromptFlowNodeSourceConfigurationOutputTypeDef](./type_defs.md#promptflownodesourceconfigurationoutputtypedef) 
