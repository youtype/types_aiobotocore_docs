...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.accept_capacity_reservation_billing_ownership)
...
Amazon Web Services organizations payer
account.
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.associate_capacity_reservation_billing_owner)
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.associate_ipam_byoasn)
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.create_capacity_reservation_by_splitting)
...
Type annotations and code completion for `#!python session.create_client("ec2").create_fpga_image` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_image` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_instance_connect_endpoint` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.create_instance_connect_endpoint)
...
Type annotations and code completion for `#!python session.create_client("ec2").create_instance_event_window` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_instance_export_task` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_internet_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_ipam` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_ipam_external_resource_verification_token` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.create_ipam_external_resource_verification_token)

```python
# create_ipam_external_resource_verification_token method definition

await def create_ipam_external_resource_verification_token(
    self,
    *,
    IpamId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").create_ipam_pool` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_ipam_resource_discovery` method.
...
await def create_ipam_resource_discovery(
    self,
    *,
    DryRun: bool = ...,
    Description: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").create_ipam_scope` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_launch_template` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_launch_template_version` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_local_gateway_route` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_local_gateway_route_table` method.
...
await def create_local_gateway_route_table(
    self,
    *,
    LocalGatewayId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").create_local_gateway_route_table_virtual_interface_group_association` method.
...
await def create_local_gateway_route_table_virtual_interface_group_association(
    self,
    *,
    LocalGatewayRouteTableId: str,
    LocalGatewayVirtualInterfaceGroupId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").create_local_gateway_route_table_vpc_association` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_managed_prefix_list` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_nat_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_network_acl` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_network_acl_entry` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_network_insights_access_scope` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_network_insights_path` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_network_interface` method.
...
await def create_network_interface(
    ...
    *,
    ...
    PrivateIpAddress: str = ...,
    Groups: Sequence[str] = ...,
    PrivateIpAddresses: Sequence[PrivateIpAddressSpecificationTypeDef] = ...,  # (6)
    SecondaryPrivateIpAddressCount: int = ...,
    Ipv6Addresses: Sequence[InstanceIpv6AddressTypeDef] = ...,  # (7)
    Ipv6AddressCount: int = ...,
    DryRun: bool = ...,
...
6. See [:material-code-braces: PrivateIpAddressSpecificationTypeDef](./type_defs.md#privateipaddressspecificationtypedef) 
7. See [:material-code-braces: InstanceIpv6AddressTypeDef](./type_defs.md#instanceipv6addresstypedef) 
8. See [:material-code-braces: CreateNetworkInterfaceResultTypeDef](./type_defs.md#createnetworkinterfaceresulttypedef) 
...
Type annotations and code completion for `#!python session.create_client("ec2").create_network_interface_permission` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_placement_group` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_public_ipv4_pool` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_replace_root_volume_task` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_reserved_instances_listing` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_restore_image_task` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_route` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_route_table` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_security_group` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_snapshot` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_snapshots` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_spot_datafeed_subscription` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_store_image_task` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_subnet` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_subnet_cidr_reservation` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_tags` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_traffic_mirror_filter` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_traffic_mirror_filter_rule` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_traffic_mirror_session` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_traffic_mirror_target` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_transit_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_transit_gateway_connect` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_transit_gateway_connect_peer` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_transit_gateway_multicast_domain` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_transit_gateway_peering_attachment` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_transit_gateway_policy_table` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_transit_gateway_prefix_list_reference` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_transit_gateway_route` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_transit_gateway_route_table` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_transit_gateway_route_table_announcement` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_transit_gateway_vpc_attachment` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_verified_access_endpoint` method.
...
await def create_verified_access_endpoint(
    self,
    *,
...
7. See [:material-code-braces: CreateVerifiedAccessEndpointResultTypeDef](./type_defs.md#createverifiedaccessendpointresulttypedef) 
...
Type annotations and code completion for `#!python session.create_client("ec2").create_verified_access_group` method.
...
await def create_verified_access_group(
    self,
    *,
    VerifiedAccessInstanceId: str,
    Description: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").create_verified_access_instance` method.
...
await def create_verified_access_instance(
    self,
    *,
    Description: str = ...,
    TagSpecifications: Sequence[TagSpecificationTypeDef] = ...,  # (1)
...
Type annotations and code completion for `#!python session.create_client("ec2").create_verified_access_trust_provider` method.
...
await def create_verified_access_trust_provider(
    self,
    *,
...
8. See [:material-code-braces: CreateVerifiedAccessTrustProviderResultTypeDef](./type_defs.md#createverifiedaccesstrustproviderresulttypedef) 
...
Type annotations and code completion for `#!python session.create_client("ec2").create_volume` method.
...
2. See [:material-code-braces: TagSpecificationTypeDef](./type_defs.md#tagspecificationtypedef) 
3. See [:material-code-braces: VolumeResponseTypeDef](./type_defs.md#volumeresponsetypedef) 
...
Type annotations and code completion for `#!python session.create_client("ec2").create_vpc` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_vpc_endpoint` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_vpc_endpoint_connection_notification` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_vpc_peering_connection` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_vpn_connection` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_vpn_connection_route` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_vpn_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_carrier_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_client_vpn_endpoint` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_client_vpn_route` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_coip_cidr` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_coip_pool` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_customer_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_dhcp_options` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_egress_only_internet_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_fleets` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_flow_logs` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_fpga_image` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_instance_connect_endpoint` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.delete_instance_connect_endpoint)

```python
# delete_instance_connect_endpoint method definition

await def delete_instance_connect_endpoint(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_instance_event_window` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_internet_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_ipam` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_ipam_external_resource_verification_token` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.delete_ipam_external_resource_verification_token)

```python
# delete_ipam_external_resource_verification_token method definition

await def delete_ipam_external_resource_verification_token(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_ipam_pool` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_ipam_resource_discovery` method.
...
await def delete_ipam_resource_discovery(
    self,
    *,
    IpamResourceDiscoveryId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_ipam_scope` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_key_pair` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_launch_template` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_launch_template_versions` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_local_gateway_route` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_local_gateway_route_table` method.
...
await def delete_local_gateway_route_table(
    self,
    *,
    LocalGatewayRouteTableId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_local_gateway_route_table_virtual_interface_group_association` method.
...
await def delete_local_gateway_route_table_virtual_interface_group_association(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_local_gateway_route_table_vpc_association` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_managed_prefix_list` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_nat_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_network_acl` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_network_acl_entry` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_network_insights_access_scope` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_network_insights_access_scope_analysis` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_network_insights_analysis` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_network_insights_path` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_network_interface` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_network_interface_permission` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_placement_group` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_public_ipv4_pool` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_queued_reserved_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_route` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_route_table` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_security_group` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_snapshot` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_spot_datafeed_subscription` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_subnet` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_subnet_cidr_reservation` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_tags` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_traffic_mirror_filter` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_traffic_mirror_filter_rule` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_traffic_mirror_session` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_traffic_mirror_target` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_transit_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_transit_gateway_connect` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_transit_gateway_connect_peer` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_transit_gateway_multicast_domain` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_transit_gateway_peering_attachment` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_transit_gateway_policy_table` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_transit_gateway_prefix_list_reference` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_transit_gateway_route` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_transit_gateway_route_table` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_transit_gateway_route_table_announcement` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_transit_gateway_vpc_attachment` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_verified_access_endpoint` method.
...
await def delete_verified_access_endpoint(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_verified_access_group` method.
...
await def delete_verified_access_group(
    self,
    *,
    VerifiedAccessGroupId: str,
    ClientToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_verified_access_instance` method.
...
await def delete_verified_access_instance(
    self,
    *,
    VerifiedAccessInstanceId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_verified_access_trust_provider` method.
...
await def delete_verified_access_trust_provider(
    self,
    *,
    VerifiedAccessTrustProviderId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_volume` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_vpc` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_vpc_endpoint_connection_notifications` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_vpc_endpoint_service_configurations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_vpc_endpoints` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_vpc_peering_connection` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_vpn_connection` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_vpn_connection_route` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_vpn_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").deprovision_byoip_cidr` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").deprovision_ipam_byoasn` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.deprovision_ipam_byoasn)

```python
# deprovision_ipam_byoasn method definition

await def deprovision_ipam_byoasn(
    self,
    *,
    IpamId: str,
    Asn: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").deprovision_ipam_pool_cidr` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").deprovision_public_ipv4_pool_cidr` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").deregister_image` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").deregister_instance_event_notification_attributes` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").deregister_transit_gateway_multicast_group_members` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").deregister_transit_gateway_multicast_group_sources` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_account_attributes` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_address_transfers` method.
...
await def describe_address_transfers(
    self,
    *,
    AllocationIds: Sequence[str] = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_addresses` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_addresses_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_aggregate_id_format` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_availability_zones` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_aws_network_performance_metric_subscriptions` method.
...
await def describe_aws_network_performance_metric_subscriptions(
    self,
    *,
    MaxResults: int = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_bundle_tasks` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_byoip_cidrs` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_capacity_block_offerings` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.describe_capacity_block_offerings)

```python
# describe_capacity_block_offerings method definition

await def describe_capacity_block_offerings(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_capacity_reservation_billing_requests` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.describe_capacity_reservation_billing_requests)

```python
# describe_capacity_reservation_billing_requests method definition

await def describe_capacity_reservation_billing_requests(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_capacity_reservation_fleets` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_capacity_reservations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_carrier_gateways` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_classic_link_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_client_vpn_authorization_rules` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_client_vpn_connections` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_client_vpn_endpoints` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_client_vpn_routes` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_client_vpn_target_networks` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_coip_pools` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_conversion_tasks` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_customer_gateways` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_dhcp_options` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_egress_only_internet_gateways` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_elastic_gpus` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_export_image_tasks` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_export_tasks` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_fast_launch_images` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_fast_snapshot_restores` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_fleet_history` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_fleet_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_fleets` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_flow_logs` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_fpga_image_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_fpga_images` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_host_reservation_offerings` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_host_reservations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_hosts` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_iam_instance_profile_associations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_id_format` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_identity_id_format` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_image_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_images` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_import_image_tasks` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_import_snapshot_tasks` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_instance_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_instance_connect_endpoints` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.describe_instance_connect_endpoints)

```python
# describe_instance_connect_endpoints method definition

await def describe_instance_connect_endpoints(
    self,
    *,
    DryRun: bool = ...,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_instance_credit_specifications` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_instance_event_notification_attributes` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_instance_event_windows` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_instance_image_metadata` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.describe_instance_image_metadata)

```python
# describe_instance_image_metadata method definition

await def describe_instance_image_metadata(
    self,
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    InstanceIds: Sequence[str] = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_instance_status` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_instance_topology` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.describe_instance_topology)

```python
# describe_instance_topology method definition

await def describe_instance_topology(
    self,
    *,
    DryRun: bool = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_instance_type_offerings` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_instance_types` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_internet_gateways` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_ipam_byoasn` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.describe_ipam_byoasn)

```python
# describe_ipam_byoasn method definition

await def describe_ipam_byoasn(
    self,
    *,
    DryRun: bool = ...,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_ipam_external_resource_verification_tokens` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.describe_ipam_external_resource_verification_tokens)

```python
# describe_ipam_external_resource_verification_tokens method definition

await def describe_ipam_external_resource_verification_tokens(
    self,
    *,
    DryRun: bool = ...,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_ipam_pools` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_ipam_resource_discoveries` method.
...
await def describe_ipam_resource_discoveries(
    self,
    *,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_ipam_resource_discovery_associations` method.
...
await def describe_ipam_resource_discovery_associations(
    self,
    *,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_ipam_scopes` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_ipams` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_ipv6_pools` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_key_pairs` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_launch_template_versions` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_launch_templates` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_local_gateway_route_table_virtual_interface_group_associations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_local_gateway_route_table_vpc_associations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_local_gateway_route_tables` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_local_gateway_virtual_interface_groups` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_local_gateway_virtual_interfaces` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_local_gateways` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_locked_snapshots` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.describe_locked_snapshots)

```python
# describe_locked_snapshots method definition

await def describe_locked_snapshots(
    self,
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_mac_hosts` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.describe_mac_hosts)

```python
# describe_mac_hosts method definition

await def describe_mac_hosts(
    self,
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    HostIds: Sequence[str] = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_managed_prefix_lists` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_moving_addresses` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_nat_gateways` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_network_acls` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_network_insights_access_scope_analyses` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_network_insights_access_scopes` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_network_insights_analyses` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_network_insights_paths` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_network_interface_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_network_interface_permissions` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_network_interfaces` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_placement_groups` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_prefix_lists` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_principal_id_format` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_public_ipv4_pools` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_regions` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_replace_root_volume_tasks` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_reserved_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_reserved_instances_listings` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_reserved_instances_modifications` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_reserved_instances_offerings` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_route_tables` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_scheduled_instance_availability` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_scheduled_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_security_group_references` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_security_group_rules` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_security_groups` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_snapshot_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_snapshot_tier_status` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_snapshots` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_spot_datafeed_subscription` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_spot_fleet_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_spot_fleet_request_history` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_spot_fleet_requests` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_spot_instance_requests` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_spot_price_history` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_stale_security_groups` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_store_image_tasks` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_subnets` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_tags` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_traffic_mirror_filter_rules` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.describe_traffic_mirror_filter_rules)

```python
# describe_traffic_mirror_filter_rules method definition

await def describe_traffic_mirror_filter_rules(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_traffic_mirror_filters` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_traffic_mirror_sessions` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_traffic_mirror_targets` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_transit_gateway_attachments` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_transit_gateway_connect_peers` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_transit_gateway_connects` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_transit_gateway_multicast_domains` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_transit_gateway_peering_attachments` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_transit_gateway_policy_tables` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_transit_gateway_route_table_announcements` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_transit_gateway_route_tables` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_transit_gateway_vpc_attachments` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_transit_gateways` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_trunk_interface_associations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_verified_access_endpoints` method.
...
await def describe_verified_access_endpoints(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_verified_access_groups` method.
...
await def describe_verified_access_groups(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_verified_access_instance_logging_configurations` method.
...
await def describe_verified_access_instance_logging_configurations(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_verified_access_instances` method.
...
await def describe_verified_access_instances(
    self,
    *,
    VerifiedAccessInstanceIds: Sequence[str] = ...,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_verified_access_trust_providers` method.
...
await def describe_verified_access_trust_providers(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_volume_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_volume_status` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_volumes` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_volumes_modifications` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpc_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpc_classic_link` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpc_classic_link_dns_support` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpc_endpoint_connection_notifications` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpc_endpoint_connections` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpc_endpoint_service_configurations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpc_endpoint_service_permissions` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpc_endpoint_services` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpc_endpoints` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpc_peering_connections` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpcs` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpn_connections` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpn_gateways` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").detach_classic_link_vpc` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").detach_internet_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").detach_network_interface` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").detach_verified_access_trust_provider` method.
...
await def detach_verified_access_trust_provider(
    self,
    *,
    VerifiedAccessInstanceId: str,
    VerifiedAccessTrustProviderId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").detach_volume` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").detach_vpn_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_address_transfer` method.
...
await def disable_address_transfer(
    self,
    *,
    AllocationId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_aws_network_performance_metric_subscription` method.
...
await def disable_aws_network_performance_metric_subscription(
    self,
    *,
    Source: str = ...,
    Destination: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_ebs_encryption_by_default` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_fast_launch` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_fast_snapshot_restores` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_image` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.disable_image)

```python
# disable_image method definition

await def disable_image(
    self,
    *,
    ImageId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_image_block_public_access` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.disable_image_block_public_access)

```python
# disable_image_block_public_access method definition

await def disable_image_block_public_access(
    self,
    *,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_image_deprecation` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_image_deregistration_protection` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.disable_image_deregistration_protection)

```python
# disable_image_deregistration_protection method definition

await def disable_image_deregistration_protection(
    self,
    *,
    ImageId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_ipam_organization_admin_account` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_serial_console_access` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_snapshot_block_public_access` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.disable_snapshot_block_public_access)

```python
# disable_snapshot_block_public_access method definition

await def disable_snapshot_block_public_access(
    self,
    *,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_transit_gateway_route_table_propagation` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_vgw_route_propagation` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_vpc_classic_link` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_vpc_classic_link_dns_support` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_address` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_capacity_reservation_billing_owner` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.disassociate_capacity_reservation_billing_owner)

```python
# disassociate_capacity_reservation_billing_owner method definition

await def disassociate_capacity_reservation_billing_owner(
    self,
    *,
    CapacityReservationId: str,
    UnusedReservationBillingOwnerId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_client_vpn_target_network` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_enclave_certificate_iam_role` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_iam_instance_profile` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_instance_event_window` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_ipam_byoasn` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.disassociate_ipam_byoasn)

```python
# disassociate_ipam_byoasn method definition

await def disassociate_ipam_byoasn(
    self,
    *,
    Asn: str,
    Cidr: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_ipam_resource_discovery` method.
...
await def disassociate_ipam_resource_discovery(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_nat_gateway_address` method.
...
await def disassociate_nat_gateway_address(
    self,
    *,
    NatGatewayId: str,
    AssociationIds: Sequence[str],
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_route_table` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_subnet_cidr_block` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_transit_gateway_multicast_domain` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_transit_gateway_policy_table` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_transit_gateway_route_table` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_trunk_interface` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_vpc_cidr_block` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_address_transfer` method.
...
await def enable_address_transfer(
    self,
    *,
    AllocationId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_aws_network_performance_metric_subscription` method.
...
await def enable_aws_network_performance_metric_subscription(
    self,
    *,
    Source: str = ...,
    Destination: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_ebs_encryption_by_default` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_fast_launch` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_fast_snapshot_restores` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_image` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.enable_image)

```python
# enable_image method definition

await def enable_image(
    self,
    *,
    ImageId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_image_block_public_access` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.enable_image_block_public_access)

```python
# enable_image_block_public_access method definition

await def enable_image_block_public_access(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_image_deprecation` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_image_deregistration_protection` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.enable_image_deregistration_protection)

```python
# enable_image_deregistration_protection method definition

await def enable_image_deregistration_protection(
    self,
    *,
    ImageId: str,
    WithCooldown: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_ipam_organization_admin_account` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_reachability_analyzer_organization_sharing` method.
...
await def enable_reachability_analyzer_organization_sharing(
    self,
    *,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_serial_console_access` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_snapshot_block_public_access` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.enable_snapshot_block_public_access)

```python
# enable_snapshot_block_public_access method definition

await def enable_snapshot_block_public_access(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_transit_gateway_route_table_propagation` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_vgw_route_propagation` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_volume_io` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_vpc_classic_link` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_vpc_classic_link_dns_support` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").export_client_vpn_client_certificate_revocation_list` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").export_client_vpn_client_configuration` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").export_image` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").export_transit_gateway_routes` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_associated_enclave_certificate_iam_roles` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_associated_ipv6_pool_cidrs` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_aws_network_performance_data` method.
...
await def get_aws_network_performance_data(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_capacity_reservation_usage` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_coip_pool_usage` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_console_output` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_console_screenshot` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_default_credit_specification` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_ebs_default_kms_key_id` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_ebs_encryption_by_default` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_flow_logs_integration_template` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_groups_for_capacity_reservation` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_host_reservation_purchase_preview` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_image_block_public_access_state` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.get_image_block_public_access_state)

```python
# get_image_block_public_access_state method definition

await def get_image_block_public_access_state(
    self,
    *,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_instance_metadata_defaults` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.get_instance_metadata_defaults)

```python
# get_instance_metadata_defaults method definition

await def get_instance_metadata_defaults(
    self,
    *,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_instance_tpm_ek_pub` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.get_instance_tpm_ek_pub)

```python
# get_instance_tpm_ek_pub method definition

await def get_instance_tpm_ek_pub(
    self,
    *,
    InstanceId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_instance_types_from_instance_requirements` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_instance_uefi_data` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_ipam_address_history` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_ipam_discovered_accounts` method.
...
await def get_ipam_discovered_accounts(
    self,
    *,
    IpamResourceDiscoveryId: str,
    DiscoveryRegion: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_ipam_discovered_public_addresses` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.get_ipam_discovered_public_addresses)

```python
# get_ipam_discovered_public_addresses method definition

await def get_ipam_discovered_public_addresses(
    self,
    *,
    IpamResourceDiscoveryId: str,
    AddressRegion: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_ipam_discovered_resource_cidrs` method.
...
await def get_ipam_discovered_resource_cidrs(
    self,
    *,
    IpamResourceDiscoveryId: str,
    ResourceRegion: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_ipam_pool_allocations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_ipam_pool_cidrs` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_ipam_resource_cidrs` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_launch_template_data` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_managed_prefix_list_associations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_managed_prefix_list_entries` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_network_insights_access_scope_analysis_findings` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_network_insights_access_scope_content` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_password_data` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_reserved_instances_exchange_quote` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_security_groups_for_vpc` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.get_security_groups_for_vpc)

```python
# get_security_groups_for_vpc method definition

await def get_security_groups_for_vpc(
    self,
    *,
    VpcId: str,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_serial_console_access_status` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_snapshot_block_public_access_state` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.get_snapshot_block_public_access_state)

```python
# get_snapshot_block_public_access_state method definition

await def get_snapshot_block_public_access_state(
    self,
    *,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_spot_placement_scores` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_subnet_cidr_reservations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_transit_gateway_attachment_propagations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_transit_gateway_multicast_domain_associations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_transit_gateway_policy_table_associations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_transit_gateway_policy_table_entries` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_transit_gateway_prefix_list_references` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_transit_gateway_route_table_associations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_transit_gateway_route_table_propagations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_verified_access_endpoint_policy` method.
...
await def get_verified_access_endpoint_policy(
    self,
    *,
    VerifiedAccessEndpointId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_verified_access_group_policy` method.
...
await def get_verified_access_group_policy(
    self,
    *,
    VerifiedAccessGroupId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_vpn_connection_device_sample_configuration` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_vpn_connection_device_types` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_vpn_tunnel_replacement_status` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.get_vpn_tunnel_replacement_status)

```python
# get_vpn_tunnel_replacement_status method definition

await def get_vpn_tunnel_replacement_status(
    self,
    *,
    VpnConnectionId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").import_client_vpn_client_certificate_revocation_list` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").import_image` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").import_instance` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").import_key_pair` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").import_snapshot` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").import_volume` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").list_images_in_recycle_bin` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").list_snapshots_in_recycle_bin` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").lock_snapshot` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.lock_snapshot)

```python
# lock_snapshot method definition

await def lock_snapshot(
    self,
    *,
    SnapshotId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_address_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_availability_zone_group` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_capacity_reservation` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_capacity_reservation_fleet` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_client_vpn_endpoint` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_default_credit_specification` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_ebs_default_kms_key_id` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_fleet` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_fpga_image_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_hosts` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_id_format` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_identity_id_format` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_image_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_instance_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_instance_capacity_reservation_attributes` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_instance_cpu_options` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.modify_instance_cpu_options)

```python
# modify_instance_cpu_options method definition

await def modify_instance_cpu_options(
    self,
    *,
    InstanceId: str,
    CoreCount: int,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_instance_credit_specification` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_instance_event_start_time` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_instance_event_window` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_instance_metadata_defaults` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.modify_instance_metadata_defaults)

```python
# modify_instance_metadata_defaults method definition

await def modify_instance_metadata_defaults(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_instance_metadata_options` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_instance_placement` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_ipam` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_ipam_pool` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_ipam_resource_cidr` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_ipam_resource_discovery` method.
...
await def modify_ipam_resource_discovery(
    self,
    *,
    IpamResourceDiscoveryId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_ipam_scope` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_launch_template` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_local_gateway_route` method.
...
await def modify_local_gateway_route(
    self,
    *,
    LocalGatewayRouteTableId: str,
    DestinationCidrBlock: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_managed_prefix_list` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_network_interface_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_private_dns_name_options` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_reserved_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_security_group_rules` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_snapshot_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_snapshot_tier` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_spot_fleet_request` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_subnet_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_traffic_mirror_filter_network_services` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_traffic_mirror_filter_rule` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_traffic_mirror_session` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_transit_gateway` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_transit_gateway_prefix_list_reference` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_transit_gateway_vpc_attachment` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_verified_access_endpoint` method.
...
await def modify_verified_access_endpoint(
    self,
    *,
    VerifiedAccessEndpointId: str,
    VerifiedAccessGroupId: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_verified_access_endpoint_policy` method.
...
await def modify_verified_access_endpoint_policy(
    self,
    *,
    VerifiedAccessEndpointId: str,
    PolicyEnabled: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_verified_access_group` method.
...
await def modify_verified_access_group(
    self,
    *,
    VerifiedAccessGroupId: str,
    VerifiedAccessInstanceId: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_verified_access_group_policy` method.
...
await def modify_verified_access_group_policy(
    self,
    *,
    VerifiedAccessGroupId: str,
    PolicyEnabled: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_verified_access_instance` method.
...
await def modify_verified_access_instance(
    self,
    *,
    VerifiedAccessInstanceId: str,
    Description: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_verified_access_instance_logging_configuration` method.
...
await def modify_verified_access_instance_logging_configuration(
    self,
    *,
    VerifiedAccessInstanceId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_verified_access_trust_provider` method.
...
await def modify_verified_access_trust_provider(
    self,
    *,
    VerifiedAccessTrustProviderId: str,
...
4. See [:material-code-braces: ModifyVerifiedAccessTrustProviderResultTypeDef](./type_defs.md#modifyverifiedaccesstrustproviderresulttypedef) 
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_volume` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_volume_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_vpc_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_vpc_endpoint` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_vpc_endpoint_connection_notification` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_vpc_endpoint_service_configuration` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_vpc_endpoint_service_payer_responsibility` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_vpc_peering_connection_options` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_vpc_tenancy` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_vpn_connection` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_vpn_connection_options` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_vpn_tunnel_certificate` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_vpn_tunnel_options` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").monitor_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").move_address_to_vpc` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").move_byoip_cidr_to_ipam` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").move_capacity_reservation_instances` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.move_capacity_reservation_instances)

```python
# move_capacity_reservation_instances method definition

await def move_capacity_reservation_instances(
    self,
    *,
    SourceCapacityReservationId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").provision_byoip_cidr` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").provision_ipam_byoasn` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.provision_ipam_byoasn)

```python
# provision_ipam_byoasn method definition

await def provision_ipam_byoasn(
    self,
    *,
    IpamId: str,
    Asn: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").provision_ipam_pool_cidr` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").provision_public_ipv4_pool_cidr` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").purchase_capacity_block` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.purchase_capacity_block)

```python
# purchase_capacity_block method definition

await def purchase_capacity_block(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").purchase_host_reservation` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").purchase_reserved_instances_offering` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").purchase_scheduled_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").reboot_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").register_image` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").register_instance_event_notification_attributes` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").register_transit_gateway_multicast_group_members` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").register_transit_gateway_multicast_group_sources` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").reject_capacity_reservation_billing_ownership` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.reject_capacity_reservation_billing_ownership)

```python
# reject_capacity_reservation_billing_ownership method definition

await def reject_capacity_reservation_billing_ownership(
    self,
    *,
    CapacityReservationId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").reject_transit_gateway_multicast_domain_associations` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").reject_transit_gateway_peering_attachment` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").reject_transit_gateway_vpc_attachment` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").reject_vpc_endpoint_connections` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").reject_vpc_peering_connection` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").release_address` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").release_hosts` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").release_ipam_pool_allocation` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").replace_iam_instance_profile_association` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").replace_network_acl_association` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").replace_network_acl_entry` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").replace_route` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").replace_route_table_association` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").replace_transit_gateway_route` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").replace_vpn_tunnel` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.replace_vpn_tunnel)

```python
# replace_vpn_tunnel method definition

await def replace_vpn_tunnel(
    self,
    *,
    VpnConnectionId: str,
    VpnTunnelOutsideIpAddress: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").report_instance_status` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").request_spot_fleet` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").request_spot_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").reset_address_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").reset_ebs_default_kms_key_id` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").reset_fpga_image_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").reset_image_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").reset_instance_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").reset_network_interface_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").reset_snapshot_attribute` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").restore_address_to_classic` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").restore_image_from_recycle_bin` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").restore_managed_prefix_list_version` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").restore_snapshot_from_recycle_bin` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").restore_snapshot_tier` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").revoke_client_vpn_ingress` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").revoke_security_group_egress` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").revoke_security_group_ingress` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").run_instances` method.
...
await def run_instances(
    ...
    *,
    ...
    InstanceInitiatedShutdownBehavior: ShutdownBehaviorType = ...,  # (20)
    PrivateIpAddress: str = ...,
    ClientToken: str = ...,
    AdditionalInfo: str = ...,
    NetworkInterfaces: Sequence[InstanceNetworkInterfaceSpecificationUnionTypeDef] = ...,  # (21)
    IamInstanceProfile: IamInstanceProfileSpecificationTypeDef = ...,  # (22)
    EbsOptimized: bool = ...,
...
20. See [:material-code-brackets: ShutdownBehaviorType](./literals.md#shutdownbehaviortype) 
21. See [:material-code-braces: InstanceNetworkInterfaceSpecificationTypeDef](./type_defs.md#instancenetworkinterfacespecificationtypedef) [:material-code-braces: InstanceNetworkInterfaceSpecificationOutputTypeDef](./type_defs.md#instancenetworkinterfacespecificationoutputtypedef) 
22. See [:material-code-braces: IamInstanceProfileSpecificationTypeDef](./type_defs.md#iaminstanceprofilespecificationtypedef) 
23. See [:material-code-braces: ReservationResponseTypeDef](./type_defs.md#reservationresponsetypedef) 
...
Type annotations and code completion for `#!python session.create_client("ec2").run_scheduled_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").search_local_gateway_routes` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").search_transit_gateway_multicast_groups` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").search_transit_gateway_routes` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").send_diagnostic_interrupt` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").start_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").start_network_insights_access_scope_analysis` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").start_network_insights_analysis` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").start_vpc_endpoint_service_private_dns_verification` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").stop_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").terminate_client_vpn_connections` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").terminate_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").unassign_ipv6_addresses` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").unassign_private_ip_addresses` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").unassign_private_nat_gateway_address` method.
...
await def unassign_private_nat_gateway_address(
    self,
    *,
    NatGatewayId: str,
    PrivateIpAddresses: Sequence[str],
...
Type annotations and code completion for `#!python session.create_client("ec2").unlock_snapshot` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.unlock_snapshot)

```python
# unlock_snapshot method definition

await def unlock_snapshot(
    self,
    *,
    SnapshotId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").unmonitor_instances` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").update_security_group_rule_descriptions_egress` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").update_security_group_rule_descriptions_ingress` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").withdraw_byoip_cidr` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.__aenter__)
...
Type annotations and code completion for `#!python session.create_client("ec2").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2.html#EC2.Client.__aexit__)
...
Type annotations and code completion for `#!python session.create_client("ec2").get_paginator` method with overloads.
...
Type annotations and code completion for `#!python session.create_client("ec2").get_waiter` method with overloads.
