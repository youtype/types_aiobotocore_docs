...
Type annotations for `aiobotocore.create_client("alexaforbusiness")` as
...
```python
from types_aiobotocore_alexaforbusiness.paginators import ListBusinessReportSchedulesPaginator, ...
```
