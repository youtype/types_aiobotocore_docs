...
```python title="Usage Example"
from types_aiobotocore_mediatailor.type_defs import CreateLiveSourceRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_mediatailor.type_defs import DeleteLiveSourceRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_mediatailor.type_defs import DescribeLiveSourceRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_mediatailor.type_defs import GetChannelScheduleRequestGetChannelSchedulePaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_mediatailor.type_defs import ListAlertsRequestListAlertsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_mediatailor.type_defs import ListChannelsRequestListChannelsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_mediatailor.type_defs import ListLiveSourcesRequestListLiveSourcesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_mediatailor.type_defs import ListLiveSourcesRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_mediatailor.type_defs import ListPlaybackConfigurationsRequestListPlaybackConfigurationsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_mediatailor.type_defs import ListPrefetchSchedulesRequestListPrefetchSchedulesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_mediatailor.type_defs import ListSourceLocationsRequestListSourceLocationsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_mediatailor.type_defs import ListVodSourcesRequestListVodSourcesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_mediatailor.type_defs import UpdateLiveSourceRequestRequestTypeDef
