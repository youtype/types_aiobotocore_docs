...
) -> CreateElasticsearchDomainResponseTypeDef:  # (14)
    ...
```
...
14. See [:material-code-braces: CreateElasticsearchDomainResponseTypeDef](./type_defs.md#createelasticsearchdomainresponsetypedef)
...
) -> UpdateElasticsearchDomainConfigResponseTypeDef:  # (13)
    ...
```
...
13. See [:material-code-braces: UpdateElasticsearchDomainConfigResponseTypeDef](./type_defs.md#updateelasticsearchdomainconfigresponsetypedef)
