...
```python
# MessageAttributeValueQueueTypeDef definition

class MessageAttributeValueQueueTypeDef(TypedDict):
    DataType: str,
    StringValue: NotRequired[str],
...
```python
# SendMessageBatchRequestEntryQueueTypeDef definition

class SendMessageBatchRequestEntryQueueTypeDef(TypedDict):
    Id: str,
    MessageBody: str,
    DelaySeconds: NotRequired[int],
    MessageAttributes: NotRequired[Mapping[str, MessageAttributeValueQueueTypeDef]],  # (1)
...
1. See [:material-code-braces: MessageAttributeValueQueueTypeDef](./type_defs.md#messageattributevaluequeuetypedef) 
...
class SendMessageBatchRequestQueueSendMessagesTypeDef(TypedDict):
    Entries: Sequence[SendMessageBatchRequestEntryQueueTypeDef],  # (1)
```

1. See [:material-code-braces: SendMessageBatchRequestEntryQueueTypeDef](./type_defs.md#sendmessagebatchrequestentryqueuetypedef) 
