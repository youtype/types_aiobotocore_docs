...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").accept_agreement_cancellation_request` method.
...
await def accept_agreement_cancellation_request(
    self,
    *,
    agreementId: str,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").accept_agreement_payment_request` method.
...
await def accept_agreement_payment_request(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").accept_agreement_request` method.
...
await def accept_agreement_request(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").batch_create_billing_adjustment_request` method.
...
await def batch_create_billing_adjustment_request(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").cancel_agreement` method.
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").cancel_agreement_cancellation_request` method.
...
await def cancel_agreement_cancellation_request(
    self,
    *,
    agreementId: str,
    agreementCancellationRequestId: str,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").cancel_agreement_payment_request` method.
...
await def cancel_agreement_payment_request(
    self,
    *,
    paymentRequestId: str,
    agreementId: str,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").create_agreement_request` method.
...
await def create_agreement_request(
    self,
    *,
    intent: IntentType,  # (1)
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").get_agreement_cancellation_request` method.
...
await def get_agreement_cancellation_request(
    self,
    *,
    agreementCancellationRequestId: str,
    agreementId: str,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").get_agreement_entitlements` method.
...
await def get_agreement_entitlements(
    self,
    *,
    agreementId: str,
    maxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").get_agreement_payment_request` method.
...
await def get_agreement_payment_request(
    self,
    *,
    paymentRequestId: str,
    agreementId: str,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").get_billing_adjustment_request` method.
...
await def get_billing_adjustment_request(
    self,
    *,
    agreementId: str,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").list_agreement_cancellation_requests` method.
...
await def list_agreement_cancellation_requests(
    self,
    *,
    partyType: str,
    agreementId: str = ...,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").list_agreement_charges` method.
...
await def list_agreement_charges(
    self,
    *,
    catalog: str = ...,
    agreementId: str = ...,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").list_agreement_invoice_line_items` method.
...
await def list_agreement_invoice_line_items(
    self,
    *,
    agreementId: str,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").list_agreement_payment_requests` method.
...
await def list_agreement_payment_requests(
    self,
    *,
    partyType: str,
    agreementType: str = ...,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").list_billing_adjustment_requests` method.
...
await def list_billing_adjustment_requests(
    self,
    *,
    agreementId: str = ...,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").reject_agreement_cancellation_request` method.
...
await def reject_agreement_cancellation_request(
    self,
    *,
    agreementId: str,
    agreementCancellationRequestId: str,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").reject_agreement_payment_request` method.
...
await def reject_agreement_payment_request(
    self,
    *,
    paymentRequestId: str,
    agreementId: str,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").send_agreement_cancellation_request` method.
...
await def send_agreement_cancellation_request(
    self,
    *,
    agreementId: str,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").send_agreement_payment_request` method.
...
await def send_agreement_payment_request(
    self,
    *,
    agreementId: str,
    termId: str,
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").update_purchase_orders` method.
...
await def update_purchase_orders(
    self,
    *,
    purchaseOrders: Sequence[PurchaseOrderTypeDef],  # (1)
) -> dict[str, Any]:
...
Type annotations and code completion for `#!python session.create_client("marketplace-agreement").get_paginator` method with overloads.
