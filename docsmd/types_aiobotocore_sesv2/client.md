...
Type annotations and code completion for `#!python session.create_client("sesv2").get_email_address_insights` method.
...
await def get_email_address_insights(
    self,
    *,
    EmailAddress: str,
...
Type annotations and code completion for `#!python session.create_client("sesv2").get_reputation_entity` method.
...
Type annotations and code completion for `#!python session.create_client("sesv2").update_reputation_entity_customer_managed_status` method.
...
await def update_reputation_entity_customer_managed_status(
    self,
    *,
    ReputationEntityType: ReputationEntityTypeType,  # (1)
    ReputationEntityReference: str,
...
Type annotations and code completion for `#!python session.create_client("sesv2").update_reputation_entity_policy` method.
...
await def update_reputation_entity_policy(
    self,
    *,
    ReputationEntityType: ReputationEntityTypeType,  # (1)
    ReputationEntityReference: str,
...
Type annotations and code completion for `#!python session.create_client("sesv2").get_paginator` method with overloads.
