...
```python title="Usage Example"
from types_aiobotocore_efs.type_defs import DescribeFileSystemsRequestDescribeFileSystemsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_efs.type_defs import DescribeMountTargetsRequestDescribeMountTargetsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_efs.type_defs import DescribeTagsRequestDescribeTagsPaginateTypeDef
