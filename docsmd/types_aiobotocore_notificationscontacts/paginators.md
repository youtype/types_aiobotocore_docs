...
) -> AsyncIterator[ListEmailContactsResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListEmailContactsRequestListEmailContactsPaginateTypeDef = {  # (1)
    "PaginationConfig": ...,
}
...
1. See [:material-code-braces: ListEmailContactsRequestListEmailContactsPaginateTypeDef](./type_defs.md#listemailcontactsrequestlistemailcontactspaginatetypedef) 
