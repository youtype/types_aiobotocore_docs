...
) -> AsyncIterator[ListMetricsResponseTypeDef]:  # (5)
    ...
```
...
kwargs: ListMetricsRequestListMetricsPaginateTypeDef = {  # (1)
    "conditions": ...,
}
...
1. See [:material-code-braces: ListMetricsRequestListMetricsPaginateTypeDef](./type_defs.md#listmetricsrequestlistmetricspaginatetypedef) 
