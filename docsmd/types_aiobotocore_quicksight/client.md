...
async with session.create_client("quicksight") as client:
    try:
        ...
        client.InvalidDataSetParameterValueException,
...
Type annotations and code completion for `#!python session.create_client("quicksight").create_action_connector` method.
...
await def create_action_connector(
    self,
    *,
    AwsAccountId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").delete_account_custom_permission` method.
...
await def delete_account_custom_permission(
    self,
    *,
    AwsAccountId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").delete_action_connector` method.
...
await def delete_action_connector(
    self,
    *,
    AwsAccountId: str,
    ActionConnectorId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").describe_account_custom_permission` method.
...
await def describe_account_custom_permission(
    self,
    *,
    AwsAccountId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").describe_action_connector` method.
...
await def describe_action_connector(
    self,
    *,
    AwsAccountId: str,
    ActionConnectorId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").describe_action_connector_permissions` method.
...
await def describe_action_connector_permissions(
    self,
    *,
    AwsAccountId: str,
    ActionConnectorId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").describe_automation_job` method.
...
await def describe_automation_job(
    self,
    *,
    AwsAccountId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").describe_self_upgrade_configuration` method.
...
await def describe_self_upgrade_configuration(
    self,
    *,
    AwsAccountId: str,
    Namespace: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").get_flow_metadata` method.
...
Type annotations and code completion for `#!python session.create_client("quicksight").get_flow_permissions` method.
...
await def get_flow_permissions(
    self,
    *,
    AwsAccountId: str,
    FlowId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").get_identity_context` method.
...
await def get_identity_context(
    self,
    *,
    AwsAccountId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").list_action_connectors` method.
...
await def list_action_connectors(
    self,
    *,
    AwsAccountId: str,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("quicksight").list_flows` method.
...
Type annotations and code completion for `#!python session.create_client("quicksight").list_self_upgrades` method.
...
Type annotations and code completion for `#!python session.create_client("quicksight").search_action_connectors` method.
...
await def search_action_connectors(
    self,
    *,
    AwsAccountId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").search_flows` method.
...
Type annotations and code completion for `#!python session.create_client("quicksight").start_automation_job` method.
...
await def start_automation_job(
    self,
    *,
    AwsAccountId: str,
    AutomationGroupId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").update_account_custom_permission` method.
...
await def update_account_custom_permission(
    self,
    *,
    CustomPermissionsName: str,
    AwsAccountId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").update_action_connector` method.
...
await def update_action_connector(
    self,
    *,
    AwsAccountId: str,
    ActionConnectorId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").update_action_connector_permissions` method.
...
await def update_action_connector_permissions(
    self,
    *,
    AwsAccountId: str,
    ActionConnectorId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").update_flow_permissions` method.
...
await def update_flow_permissions(
    self,
    *,
    AwsAccountId: str,
    FlowId: str,
...
Type annotations and code completion for `#!python session.create_client("quicksight").update_self_upgrade` method.
...
Type annotations and code completion for `#!python session.create_client("quicksight").update_self_upgrade_configuration` method.
...
await def update_self_upgrade_configuration(
    self,
    *,
    AwsAccountId: str,
    Namespace: str,
