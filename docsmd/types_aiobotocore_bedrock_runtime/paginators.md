...
) -> AsyncIterator[ListAsyncInvokesResponseTypeDef]:  # (5)
    ...
```
...
1. See [:material-code-braces: ListAsyncInvokesRequestListAsyncInvokesPaginateTypeDef](./type_defs.md#listasyncinvokesrequestlistasyncinvokespaginatetypedef) 
