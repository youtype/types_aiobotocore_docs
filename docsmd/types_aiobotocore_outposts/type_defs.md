...
class GetCapacityTaskOutputTypeDef(TypedDict):
    ...
    DryRun: bool,
    CapacityTaskStatus: CapacityTaskStatusType,  # (2)
    Failed: CapacityTaskFailureTypeDef,  # (3)
...
2. See [:material-code-brackets: CapacityTaskStatusType](./literals.md#capacitytaskstatustype) 
3. See [:material-code-braces: CapacityTaskFailureTypeDef](./type_defs.md#capacitytaskfailuretypedef) 
