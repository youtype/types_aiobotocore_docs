...
) -> AsyncIterator[ListRequestedServiceQuotaChangeHistoryByQuotaResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    ...
    QuotaRequestedAtLevel: AppliedLevelEnumType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[ListRequestedServiceQuotaChangeHistoryResponseTypeDef]:  # (4)
    ...
```
...
) -> AsyncIterator[ListServiceQuotasResponseTypeDef]:  # (3)
    ...
```
