...
```python
# StackSetOperationPreferencesStackResourceSummaryTypeDef definition

class StackSetOperationPreferencesStackResourceSummaryTypeDef(TypedDict):
    RegionConcurrencyType: NotRequired[RegionConcurrencyTypeType],  # (1)
...
```python
# RollbackConfigurationStackResourceSummaryTypeDef definition

class RollbackConfigurationStackResourceSummaryTypeDef(TypedDict):
...
```python
# StackSetOperationSummaryStackResourceSummaryTypeDef definition

class StackSetOperationSummaryStackResourceSummaryTypeDef(TypedDict):
    OperationId: NotRequired[str],
    ...
    OperationPreferences: NotRequired[StackSetOperationPreferencesStackResourceSummaryTypeDef],  # (4)
```
...
4. See [:material-code-braces: StackSetOperationPreferencesStackResourceSummaryTypeDef](./type_defs.md#stacksetoperationpreferencesstackresourcesummarytypedef) 
...
```python
# StackStackResourceSummaryTypeDef definition

class StackStackResourceSummaryTypeDef(TypedDict):
    StackName: str,
    CreationTime: datetime,
    ...
    DeletionTime: NotRequired[datetime],
    LastUpdatedTime: NotRequired[datetime],
    RollbackConfiguration: NotRequired[RollbackConfigurationStackResourceSummaryTypeDef],  # (2)
    StackStatusReason: NotRequired[str],
    DisableRollback: NotRequired[bool],
...
1. See [:material-code-braces: ParameterTypeDef](./type_defs.md#parametertypedef) 
2. See [:material-code-braces: RollbackConfigurationStackResourceSummaryTypeDef](./type_defs.md#rollbackconfigurationstackresourcesummarytypedef) 
...
```python
# ListStackSetOperationsOutputStackResourceSummaryTypeDef definition

class ListStackSetOperationsOutputStackResourceSummaryTypeDef(TypedDict):
    Summaries: List[StackSetOperationSummaryStackResourceSummaryTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: StackSetOperationSummaryStackResourceSummaryTypeDef](./type_defs.md#stacksetoperationsummarystackresourcesummarytypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
```python
# DescribeStacksOutputStackResourceSummaryTypeDef definition

class DescribeStacksOutputStackResourceSummaryTypeDef(TypedDict):
    Stacks: List[StackStackResourceSummaryTypeDef],  # (1)
    NextToken: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: StackStackResourceSummaryTypeDef](./type_defs.md#stackstackresourcesummarytypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
```python
# DescribeChangeSetOutputStackResourceSummaryTypeDef definition

class DescribeChangeSetOutputStackResourceSummaryTypeDef(TypedDict):
    ChangeSetName: str,
    ChangeSetId: str,
    StackId: str,
    StackName: str,
    ...
    RollbackConfiguration: RollbackConfigurationStackResourceSummaryTypeDef,  # (4)
...
4. See [:material-code-braces: RollbackConfigurationStackResourceSummaryTypeDef](./type_defs.md#rollbackconfigurationstackresourcesummarytypedef) 
