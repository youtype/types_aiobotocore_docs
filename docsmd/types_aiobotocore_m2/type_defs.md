...
```python
# ListBatchJobDefinitionsRequestListBatchJobDefinitionsPaginateTypeDef definition
...
```python
# ListDataSetImportHistoryRequestListDataSetImportHistoryPaginateTypeDef definition
...
```python
# ListEngineVersionsRequestListEngineVersionsPaginateTypeDef definition
...
```python
# ListBatchJobExecutionsRequestListBatchJobExecutionsPaginateTypeDef definition
