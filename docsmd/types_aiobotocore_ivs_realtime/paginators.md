...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ivs-realtime.html#Ivsrealtime.Paginator.ListIngestConfigurations)
...
) -> AsyncIterator[ListIngestConfigurationsResponseTypeDef]:  # (3)
    ...
```
...
kwargs: ListIngestConfigurationsRequestListIngestConfigurationsPaginateTypeDef = {  # (1)
    "filterByStageArn": ...,
}
...
1. See [:material-code-braces: ListIngestConfigurationsRequestListIngestConfigurationsPaginateTypeDef](./type_defs.md#listingestconfigurationsrequestlistingestconfigurationspaginatetypedef) 
## ListPublicKeysPaginator

Type annotations and code completion for `#!python session.create_client("ivs-realtime").get_paginator("list_public_keys")`.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ivs-realtime.html#Ivsrealtime.Paginator.ListPublicKeys)
