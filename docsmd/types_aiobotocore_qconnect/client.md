...
async with session.create_client("qconnect") as client:
    try:
        ...
        client.UnprocessableContentException,
...
Type annotations and code completion for `#!python session.create_client("qconnect").list_spans` method.
...
Type annotations and code completion for `#!python session.create_client("qconnect").retrieve` method.
...
await def update_assistant_ai_agent(
    ...
    *,
    ...
    orchestratorConfigurationList: Sequence[OrchestratorConfigurationEntryTypeDef] = ...,  # (3)
) -> UpdateAssistantAIAgentResponseTypeDef:  # (4)
    ...
```
...
3. See `Sequence[OrchestratorConfigurationEntryTypeDef]`
4. See [:material-code-braces: UpdateAssistantAIAgentResponseTypeDef](./type_defs.md#updateassistantaiagentresponsetypedef)
...
Type annotations and code completion for `#!python session.create_client("qconnect").update_message_template_metadata` method.
