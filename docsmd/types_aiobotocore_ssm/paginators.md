...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[DescribeInstancePropertiesResultTypeDef]:  # (4)
    ...
```
...
kwargs: DescribeInstancePropertiesRequestDescribeInstancePropertiesPaginateTypeDef = {  # (1)
...
1. See [:material-code-braces: DescribeInstancePropertiesRequestDescribeInstancePropertiesPaginateTypeDef](./type_defs.md#describeinstancepropertiesrequestdescribeinstancepropertiespaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListNodesResultTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[ListNodesSummaryResultTypeDef]:  # (4)
    ...
```
...
kwargs: ListNodesSummaryRequestListNodesSummaryPaginateTypeDef = {  # (1)
    "Aggregators": ...,
}
...
1. See [:material-code-braces: ListNodesSummaryRequestListNodesSummaryPaginateTypeDef](./type_defs.md#listnodessummaryrequestlistnodessummarypaginatetypedef) 
