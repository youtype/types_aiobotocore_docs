<a id="cognitoidentityproviderclient-for-aiobotocore-cognitoidentityprovider-module"></a>
...
Asynchronous method. Use `await admin_link_provider_for_user(...)` for a
synchronous call.
...
Asynchronous method. Use `await admin_list_groups_for_user(...)` for a
synchronous call.
...
Asynchronous method. Use `await admin_respond_to_auth_challenge(...)` for a
synchronous call.
...
Asynchronous method. Use `await confirm_forgot_password(...)` for a synchronous
call.
...
Asynchronous method. Use `await describe_user_pool_domain(...)` for a
synchronous call.
...
Asynchronous method. Use `await get_identity_provider_by_identifier(...)` for a
synchronous call.
...
Asynchronous method. Use `await list_user_import_jobs(...)` for a synchronous
call.
...
Asynchronous method. Use `await respond_to_auth_challenge(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_auth_event_feedback(...)` for a
synchronous call.
...
Asynchronous method. Use `await update_user_attributes(...)` for a synchronous
call.
...
Asynchronous method. Use `await update_user_pool(...)` for a synchronous call.
...
Asynchronous method. Use `await update_user_pool_client(...)` for a synchronous
call.
...
Asynchronous method. Use `await update_user_pool_domain(...)` for a synchronous
call.
...
Asynchronous method. Use `await verify_software_token(...)` for a synchronous
call.
...
Asynchronous method. Use `await verify_user_attribute(...)` for a synchronous
call.
...
Boto3 documentation:
[CognitoIdentityProvider.Client.\_\_aenter\_\_](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cognito-idp.html#CognitoIdentityProvider.Client.__aenter__)
...
Boto3 documentation:
[CognitoIdentityProvider.Client.\_\_aexit\_\_](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cognito-idp.html#CognitoIdentityProvider.Client.__aexit__)
