...
3. See [:material-code-braces: ProjectFleetTypeDef](./type_defs.md#projectfleettypedef) 
4. See [:material-code-braces: EnvironmentVariableTypeDef](./type_defs.md#environmentvariabletypedef) 
5. See [:material-code-braces: RegistryCredentialTypeDef](./type_defs.md#registrycredentialtypedef) 
6. See [:material-code-brackets: ImagePullCredentialsTypeType](./literals.md#imagepullcredentialstypetype) 
...
class FleetTypeDef(TypedDict):
    ...
    proxyConfiguration: NotRequired[ProxyConfigurationOutputTypeDef],  # (7)
...
4. See [:material-code-braces: ScalingConfigurationOutputTypeDef](./type_defs.md#scalingconfigurationoutputtypedef) 
