<a id="literals-for-aiobotocore-personalizeevents-module"></a>

# Literals for aiobotocore PersonalizeEvents module

> [Index](../README.md) > [PersonalizeEvents](./README.md) > Literals
...
- [Literals for aiobotocore PersonalizeEvents module](#literals-for-aiobotocore-personalizeevents-module)
...
```python
from types_aiobotocore_personalize_events.literals import ResourceServiceName
```
