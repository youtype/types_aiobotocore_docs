...
class GetRunResponseTypeDef(TypedDict):
    ...
    statusMessage: str,
    tags: Dict[str, str],
    accelerators: AcceleratorsType,  # (4)
    retentionMode: RunRetentionModeType,  # (5)
    failureReason: str,
    logLocation: RunLogLocationTypeDef,  # (6)
    uuid: str,
    runOutputUri: str,
    storageType: StorageTypeType,  # (7)
    workflowOwnerId: str,
...
4. See [:material-code-brackets: AcceleratorsType](./literals.md#acceleratorstype) 
5. See [:material-code-brackets: RunRetentionModeType](./literals.md#runretentionmodetype) 
6. See [:material-code-braces: RunLogLocationTypeDef](./type_defs.md#runloglocationtypedef) 
7. See [:material-code-brackets: StorageTypeType](./literals.md#storagetypetype) 
