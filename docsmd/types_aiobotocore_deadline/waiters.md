...
Type annotations and code completion for `#!python session.create_client("deadline").get_waiter("job_complete")`.
...
from types_aiobotocore_deadline.waiter import JobCompleteWaiter
...
Type annotations and code completion for `#!python session.create_client("deadline").get_waiter("job_succeeded")`.
...
from types_aiobotocore_deadline.waiter import JobSucceededWaiter
