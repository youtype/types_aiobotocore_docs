...
Type annotations and code completion for `#!python session.create_client("resource-explorer-2").create_resource_explorer_setup` method.
...
await def create_resource_explorer_setup(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("resource-explorer-2").delete_resource_explorer_setup` method.
...
await def delete_resource_explorer_setup(
    self,
    *,
    RegionList: Sequence[str] = ...,
...
Type annotations and code completion for `#!python session.create_client("resource-explorer-2").get_resource_explorer_setup` method.
...
await def get_resource_explorer_setup(
    self,
    *,
    TaskId: str,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("resource-explorer-2").get_service_index` method.
...
Type annotations and code completion for `#!python session.create_client("resource-explorer-2").get_service_view` method.
...
Type annotations and code completion for `#!python session.create_client("resource-explorer-2").list_service_indexes` method.
...
await def list_service_indexes(
    self,
    *,
    Regions: Sequence[str] = ...,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("resource-explorer-2").list_service_views` method.
...
Type annotations and code completion for `#!python session.create_client("resource-explorer-2").list_streaming_access_for_services` method.
...
await def list_streaming_access_for_services(
    self,
    *,
    MaxResults: int = ...,
    NextToken: str = ...,
