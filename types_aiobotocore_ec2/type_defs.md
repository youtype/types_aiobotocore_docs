...
```python
from types_aiobotocore_ec2.type_defs import AcceptVpcPeeringConnectionRequestVpcPeeringConnectionTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AssignPrivateIpAddressesRequestNetworkInterfaceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AssociateAddressRequestClassicAddressTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AssociateAddressRequestVpcAddressTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AssociateDhcpOptionsRequestDhcpOptionsTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AssociateDhcpOptionsRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AssociateRouteTableRequestRouteTableTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AttachClassicLinkVpcRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AttachClassicLinkVpcRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AttachInternetGatewayRequestInternetGatewayTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AttachInternetGatewayRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AttachNetworkInterfaceRequestNetworkInterfaceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AttachVolumeRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AttachVolumeRequestVolumeTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AuthorizeSecurityGroupEgressRequestSecurityGroupTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import AuthorizeSecurityGroupIngressRequestSecurityGroupTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CopySnapshotRequestSnapshotTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateDhcpOptionsRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateImageRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateInternetGatewayRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateKeyPairRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateNetworkAclEntryRequestNetworkAclTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateNetworkAclRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateNetworkAclRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateNetworkInterfaceRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateNetworkInterfaceRequestSubnetTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreatePlacementGroupRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateRouteRequestRouteTableTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateRouteTableRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateRouteTableRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateSecurityGroupRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateSecurityGroupRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateSnapshotRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateSnapshotRequestVolumeTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateSubnetRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateSubnetRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateTagsRequestDhcpOptionsTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateTagsRequestImageTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateTagsRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateTagsRequestInternetGatewayTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateTagsRequestNetworkAclTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateTagsRequestNetworkInterfaceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateTagsRequestRouteTableTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateTagsRequestSecurityGroupTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateTagsRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateTagsRequestSnapshotTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateTagsRequestSubnetTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateTagsRequestVolumeTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateTagsRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateVolumeRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateVpcPeeringConnectionRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateVpcPeeringConnectionRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import CreateVpcRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteDhcpOptionsRequestDhcpOptionsTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteInternetGatewayRequestInternetGatewayTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteKeyPairRequestKeyPairInfoTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteKeyPairRequestKeyPairTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteNetworkAclEntryRequestNetworkAclTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteNetworkAclRequestNetworkAclTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteNetworkInterfaceRequestNetworkInterfaceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeletePlacementGroupRequestPlacementGroupTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteRouteRequestRouteTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteRouteTableRequestRouteTableTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteSecurityGroupRequestSecurityGroupTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteSnapshotRequestSnapshotTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteSubnetRequestSubnetTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteTagsRequestTagTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteVolumeRequestVolumeTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteVpcPeeringConnectionRequestVpcPeeringConnectionTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeleteVpcRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DeregisterImageRequestImageTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DescribeImageAttributeRequestImageTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DescribeInstanceAttributeRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DescribeNetworkInterfaceAttributeRequestNetworkInterfaceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DescribeSnapshotAttributeRequestSnapshotTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DescribeVolumeAttributeRequestVolumeTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DescribeVolumeStatusRequestVolumeTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DescribeVpcAttributeRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DetachClassicLinkVpcRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DetachClassicLinkVpcRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DetachInternetGatewayRequestInternetGatewayTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DetachInternetGatewayRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DetachNetworkInterfaceRequestNetworkInterfaceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DetachVolumeRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DetachVolumeRequestVolumeTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DisableVpcClassicLinkRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DisassociateAddressRequestClassicAddressTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DisassociateAddressRequestNetworkInterfaceAssociationTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DisassociateRouteTableRequestRouteTableAssociationTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import DisassociateRouteTableRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import EnableVolumeIORequestVolumeTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import EnableVpcClassicLinkRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import GetConsoleOutputRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import GetPasswordDataRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ImportKeyPairRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ModifyImageAttributeRequestImageTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ModifyInstanceAttributeRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ModifyNetworkInterfaceAttributeRequestNetworkInterfaceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ModifySnapshotAttributeRequestSnapshotTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ModifyVolumeAttributeRequestVolumeTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ModifyVpcAttributeRequestVpcTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import MonitorInstancesRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import RebootInstancesRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import RegisterImageRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import RejectVpcPeeringConnectionRequestVpcPeeringConnectionTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ReleaseAddressRequestClassicAddressTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ReleaseAddressRequestVpcAddressTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ReplaceNetworkAclAssociationRequestNetworkAclTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ReplaceNetworkAclEntryRequestNetworkAclTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ReplaceRouteRequestRouteTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ReplaceRouteTableAssociationRequestRouteTableAssociationTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ReportInstanceStatusRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ResetImageAttributeRequestImageTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ResetInstanceAttributeRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ResetNetworkInterfaceAttributeRequestNetworkInterfaceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import ResetSnapshotAttributeRequestSnapshotTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import RevokeSecurityGroupEgressRequestSecurityGroupTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import RevokeSecurityGroupIngressRequestSecurityGroupTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import RunInstancesRequestServiceResourceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import RunInstancesRequestSubnetTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import StartInstancesRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import StopInstancesRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import TerminateInstancesRequestInstanceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import UnassignPrivateIpAddressesRequestNetworkInterfaceTypeDef
```
...
```python
from types_aiobotocore_ec2.type_defs import UnmonitorInstancesRequestInstanceTypeDef
```
