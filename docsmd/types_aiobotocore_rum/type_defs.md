...
```python title="Usage Example"
from types_aiobotocore_rum.type_defs import ListAppMonitorsRequestListAppMonitorsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_rum.type_defs import GetAppMonitorDataRequestGetAppMonitorDataPaginateTypeDef
