...
```python
# BackupRetentionTypeType usage example
...
```python
# BackupRetentionTypeType definition
...
from types_aiobotocore_cloudhsmv2.literals import ClusterModeType
...
from types_aiobotocore_cloudhsmv2.literals import NetworkTypeType
...
```python
# CloudHSMV2ServiceName usage example
...
```python
# CloudHSMV2ServiceName definition
