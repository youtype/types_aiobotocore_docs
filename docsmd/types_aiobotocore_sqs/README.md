...
- [MessageAttributeValueQueueTypeDef](./type_defs.md#messageattributevaluequeuetypedef)
...
- [SendMessageBatchRequestEntryQueueTypeDef](./type_defs.md#sendmessagebatchrequestentryqueuetypedef)
