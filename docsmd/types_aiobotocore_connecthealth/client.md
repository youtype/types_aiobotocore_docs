...
Type annotations and code completion for `#!python session.create_client("connecthealth")`
...
This class provides code completion for `#!python session.create_client("connecthealth").exceptions` structure.

```python
# ConnectHealthClient.exceptions usage example
...
```python
# ConnectHealthClient usage type checking example

from types_aiobotocore_connecthealth.client import Exceptions
...
Type annotations and code completion for `#!python session.create_client("connecthealth").can_paginate` method.
...
Type annotations and code completion for `#!python session.create_client("connecthealth").generate_presigned_url` method.
...
Type annotations and code completion for `#!python session.create_client("connecthealth").activate_subscription` method.
...
await def activate_subscription(
    self,
    *,
    domainId: str,
    subscriptionId: str,
...
Type annotations and code completion for `#!python session.create_client("connecthealth").create_domain` method.
...
Type annotations and code completion for `#!python session.create_client("connecthealth").create_subscription` method.
...
Type annotations and code completion for `#!python session.create_client("connecthealth").deactivate_subscription` method.
...
await def deactivate_subscription(
    self,
    *,
    domainId: str,
    subscriptionId: str,
...
Type annotations and code completion for `#!python session.create_client("connecthealth").delete_domain` method.
...
Type annotations and code completion for `#!python session.create_client("connecthealth").get_domain` method.
...
Type annotations and code completion for `#!python session.create_client("connecthealth").get_medical_scribe_listening_session` method.
...
await def get_medical_scribe_listening_session(
    self,
    *,
    sessionId: str,
    domainId: str,
...
Type annotations and code completion for `#!python session.create_client("connecthealth").get_patient_insights_job` method.
...
await def get_patient_insights_job(
    self,
    *,
    domainId: str,
    jobId: str,
...
Type annotations and code completion for `#!python session.create_client("connecthealth").get_subscription` method.
...
Type annotations and code completion for `#!python session.create_client("connecthealth").list_domains` method.
...
Type annotations and code completion for `#!python session.create_client("connecthealth").list_subscriptions` method.
...
Type annotations and code completion for `#!python session.create_client("connecthealth").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.create_client("connecthealth").start_medical_scribe_listening_session` method.
...
await def start_medical_scribe_listening_session(
    self,
    *,
    sessionId: str,
    domainId: str,
    ...
    inputStream: aiobotocore.eventstream.AioEventStream[MedicalScribeInputStreamTypeDef] = ...,  # (3)
...
Type annotations and code completion for `#!python session.create_client("connecthealth").start_patient_insights_job` method.
...
await def start_patient_insights_job(
    self,
    *,
    domainId: str,
...
Type annotations and code completion for `#!python session.create_client("connecthealth").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("connecthealth").untag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("connecthealth").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/connecthealth.html#ConnectHealth.Client)
...
Type annotations and code completion for `#!python session.create_client("connecthealth").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/connecthealth.html#ConnectHealth.Client)
...
Type annotations and code completion for `#!python session.create_client("connecthealth").get_paginator` method with overloads.
