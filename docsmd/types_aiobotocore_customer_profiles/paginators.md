...
) -> AsyncIterator[GetSimilarProfilesResponseTypeDef]:  # (3)
    ...
```
...
1. See [:material-code-braces: GetSimilarProfilesRequestGetSimilarProfilesPaginateTypeDef](./type_defs.md#getsimilarprofilesrequestgetsimilarprofilespaginatetypedef) 
...
def paginate(
    ...
    *,
    DomainName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListEventTriggersResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListEventTriggersRequestListEventTriggersPaginateTypeDef = {  # (1)
    "DomainName": ...,
}
...
1. See [:material-code-braces: ListEventTriggersRequestListEventTriggersPaginateTypeDef](./type_defs.md#listeventtriggersrequestlisteventtriggerspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    ObjectTypeName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListObjectTypeAttributesResponseTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListObjectTypeAttributesRequestListObjectTypeAttributesPaginateTypeDef](./type_defs.md#listobjecttypeattributesrequestlistobjecttypeattributespaginatetypedef) 
...
def paginate(
    ...
    *,
    DomainName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListRuleBasedMatchesResponseTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListRuleBasedMatchesRequestListRuleBasedMatchesPaginateTypeDef](./type_defs.md#listrulebasedmatchesrequestlistrulebasedmatchespaginatetypedef) 
...
def paginate(
    ...
    *,
    DomainName: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListSegmentDefinitionsResponseTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListSegmentDefinitionsRequestListSegmentDefinitionsPaginateTypeDef](./type_defs.md#listsegmentdefinitionsrequestlistsegmentdefinitionspaginatetypedef) 
