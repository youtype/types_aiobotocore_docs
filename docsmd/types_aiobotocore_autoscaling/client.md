...
async with session.create_client("autoscaling") as client:
    try:
        ...
        client.ClientError,
        client.IdempotentParameterMismatchError,
...
await def create_auto_scaling_group(
    ...
    *,
    ...
    InstanceLifecyclePolicy: InstanceLifecyclePolicyTypeDef = ...,  # (10)
) -> EmptyResponseMetadataTypeDef:  # (11)
    ...
```
...
11. See [:material-code-braces: EmptyResponseMetadataTypeDef](./type_defs.md#emptyresponsemetadatatypedef)
...
Type annotations and code completion for `#!python session.create_client("autoscaling").launch_instances` method.
