...
```python
# ListBillEstimateCommitmentsRequestListBillEstimateCommitmentsPaginateTypeDef definition

class ListBillEstimateCommitmentsRequestListBillEstimateCommitmentsPaginateTypeDef(TypedDict):
    billEstimateId: str,
...
```python
# ListBillEstimateInputCommitmentModificationsRequestListBillEstimateInputCommitmentModificationsPaginateTypeDef definition

class ListBillEstimateInputCommitmentModificationsRequestListBillEstimateInputCommitmentModificationsPaginateTypeDef(TypedDict):
    billEstimateId: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListBillScenarioCommitmentModificationsRequestListBillScenarioCommitmentModificationsPaginateTypeDef definition

class ListBillScenarioCommitmentModificationsRequestListBillScenarioCommitmentModificationsPaginateTypeDef(TypedDict):
    billScenarioId: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListBillEstimateInputUsageModificationsRequestListBillEstimateInputUsageModificationsPaginateTypeDef definition

class ListBillEstimateInputUsageModificationsRequestListBillEstimateInputUsageModificationsPaginateTypeDef(TypedDict):
    billEstimateId: str,
...
```python
# ListBillScenarioUsageModificationsRequestListBillScenarioUsageModificationsPaginateTypeDef definition

class ListBillScenarioUsageModificationsRequestListBillScenarioUsageModificationsPaginateTypeDef(TypedDict):
    billScenarioId: str,
    filters: NotRequired[Sequence[ListUsageFilterTypeDef]],  # (1)
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (2)
```
...
```python
# ListWorkloadEstimateUsageRequestListWorkloadEstimateUsagePaginateTypeDef definition

class ListWorkloadEstimateUsageRequestListWorkloadEstimateUsagePaginateTypeDef(TypedDict):
    workloadEstimateId: str,
    filters: NotRequired[Sequence[ListUsageFilterTypeDef]],  # (1)
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (2)
```
...
```python
# ListBillEstimateLineItemsRequestListBillEstimateLineItemsPaginateTypeDef definition

class ListBillEstimateLineItemsRequestListBillEstimateLineItemsPaginateTypeDef(TypedDict):
    billEstimateId: str,
...
```python
# ListBillEstimatesRequestListBillEstimatesPaginateTypeDef definition

class ListBillEstimatesRequestListBillEstimatesPaginateTypeDef(TypedDict):
...
```python
# ListBillScenariosRequestListBillScenariosPaginateTypeDef definition

class ListBillScenariosRequestListBillScenariosPaginateTypeDef(TypedDict):
...
```python
# ListWorkloadEstimatesRequestListWorkloadEstimatesPaginateTypeDef definition

class ListWorkloadEstimatesRequestListWorkloadEstimatesPaginateTypeDef(TypedDict):
