...
> [Index](../README.md) > [CodeStar](./README.md) > Literals
...
from types_aiobotocore_codestar.literals import ListResourcesPaginatorName
...
```python
# ListTeamMembersPaginatorName usage example

from types_aiobotocore_codestar.literals import ListTeamMembersPaginatorName

def get_value() -> ListTeamMembersPaginatorName:
    return "list_team_members"
```

```python
# ListTeamMembersPaginatorName definition

ListTeamMembersPaginatorName = Literal[
    "list_team_members",
]
```
...
from types_aiobotocore_codestar.literals import ListUserProfilesPaginatorName
...
```python
# CodeStarServiceName usage example

from types_aiobotocore_codestar.literals import CodeStarServiceName

def get_value() -> CodeStarServiceName:
    return "codestar"
```

```python
# CodeStarServiceName definition

CodeStarServiceName = Literal[
    "codestar",
]
```
## ServiceName
...
from types_aiobotocore_codestar.literals import ServiceName
...
from types_aiobotocore_codestar.literals import ResourceServiceName
...
from types_aiobotocore_codestar.literals import RegionName
