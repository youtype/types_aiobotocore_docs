<a id="type-annotations-for-aiobotocore-directoryservice-module"></a>

# Type annotations for aiobotocore DirectoryService module
...
pip install 'types-aiobotocore[ds]'

# install as a standalone
pip install types-aiobotocore-ds
```

- [Type annotations for aiobotocore DirectoryService module](#type-annotations-for-aiobotocore-directoryservice-module)
...
Type annotations for `aiobotocore.create_client("ds")` as
...
```python
from types_aiobotocore_ds.paginators import DescribeDirectoriesPaginator, ...
```
