...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/resource-explorer-2.html#ResourceExplorer.Paginator.ListIndexesForMembers)
...
) -> AsyncIterator[ListIndexesForMembersOutputTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListIndexesForMembersInputListIndexesForMembersPaginateTypeDef](./type_defs.md#listindexesformembersinputlistindexesformemberspaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/resource-explorer-2.html#ResourceExplorer.Paginator.ListResources)
...
def paginate(
    ...
    *,
    ...
    ViewArn: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListResourcesOutputTypeDef]:  # (3)
    ...
```
