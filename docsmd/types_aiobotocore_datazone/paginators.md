...
Type annotations and code completion for `#!python session.create_client("datazone").get_paginator("list_notebook_runs")`.
...
from types_aiobotocore_datazone.paginator import ListNotebookRunsPaginator

session = get_session()
async with session.create_client("datazone") as client:  # (1)
    paginator: ListNotebookRunsPaginator = client.get_paginator("list_notebook_runs")  # (2)
    async for item in paginator.paginate(...):
        item: ListNotebookRunsOutputTypeDef
        print(item)  # (3)
```

1. client: [DataZoneClient](./client.md)
2. paginator: [ListNotebookRunsPaginator](./paginators.md#listnotebookrunspaginator)
3. item: `AioPageIterator[ListNotebookRunsOutputTypeDef]`
...
def paginate(
    ...
    *,
    ...
    sortOrder: SortOrderType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> aiobotocore.paginate.AioPageIterator[ListNotebookRunsOutputTypeDef]:  # (4)
    ...
```
...
2. See [:material-code-brackets: SortOrderType](./literals.md#sortordertype)
3. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
4. See `AioPageIterator[ListNotebookRunsOutputTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("datazone").get_paginator("query_graph")`.
...
3. item: `AioPageIterator[QueryGraphOutputTypeDef]`
...
3. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
4. See `AioPageIterator[QueryGraphOutputTypeDef]`
