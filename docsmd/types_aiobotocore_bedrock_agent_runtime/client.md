...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock-agent-runtime/client/close.html)
...
await def invoke_agent(
    ...
    *,
    ...
    sourceArn: str = ...,
    streamingConfigurations: StreamingConfigurationsTypeDef = ...,  # (2)
) -> InvokeAgentResponseTypeDef:  # (3)
    ...
```
...
3. See [:material-code-braces: InvokeAgentResponseTypeDef](./type_defs.md#invokeagentresponsetypedef) 
...
await def invoke_inline_agent(
    ...
    *,
    ...
    enableTrace: bool = ...,
    endSession: bool = ...,
    guardrailConfiguration: GuardrailConfigurationWithArnTypeDef = ...,  # (2)
    idleSessionTTLInSeconds: int = ...,
    inlineSessionState: InlineSessionStateTypeDef = ...,  # (3)
    inputText: str = ...,
    knowledgeBases: Sequence[KnowledgeBaseTypeDef] = ...,  # (4)
    promptOverrideConfiguration: PromptOverrideConfigurationTypeDef = ...,  # (5)
) -> InvokeInlineAgentResponseTypeDef:  # (6)
    ...
```
...
6. See [:material-code-braces: InvokeInlineAgentResponseTypeDef](./type_defs.md#invokeinlineagentresponsetypedef) 
...
Type annotations and code completion for `#!python session.create_client("bedrock-agent-runtime").retrieve_and_generate_stream` method.
