...
Type annotations and code completion for `#!python session.create_client("partnercentral-selling").create_engagement_context` method.
...
await def create_engagement_context(
    self,
    *,
    Catalog: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-selling").create_engagement_invitation` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-selling").list_engagement_invitations` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-selling").list_opportunity_from_engagement_tasks` method.
...
await def list_opportunity_from_engagement_tasks(
    self,
    *,
    Catalog: str,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-selling").start_opportunity_from_engagement_task` method.
...
await def start_opportunity_from_engagement_task(
    self,
    *,
    Catalog: str,
    ClientToken: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-selling").update_engagement_context` method.
...
await def update_engagement_context(
    self,
    *,
    Catalog: str,
    EngagementIdentifier: str,
