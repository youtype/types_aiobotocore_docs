<a id="literals-for-aiobotocore-cloudsearchdomain-module"></a>

# Literals for aiobotocore CloudSearchDomain module
...
- [Literals for aiobotocore CloudSearchDomain module](#literals-for-aiobotocore-cloudsearchdomain-module)
...
```python
from types_aiobotocore_cloudsearchdomain.literals import QueryParserType
```
...
```python
from types_aiobotocore_cloudsearchdomain.literals import CloudSearchDomainServiceName
```
...
```python
from types_aiobotocore_cloudsearchdomain.literals import ServiceName
```
...
```python
from types_aiobotocore_cloudsearchdomain.literals import ResourceServiceName
```
