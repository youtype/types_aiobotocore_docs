<a id="type-annotations-for-aiobotocore-connectwisdomservice-module"></a>
...
pip install 'types-aiobotocore[wisdom]'
...
Type annotations for `aiobotocore.create_client("wisdom")` as
...
```python
from types_aiobotocore_wisdom.paginators import ListAssistantAssociationsPaginator, ...
```
