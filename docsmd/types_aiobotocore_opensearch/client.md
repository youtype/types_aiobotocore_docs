...
) -> CreateDomainResponseTypeDef:  # (19)
    ...
```
...
19. See [:material-code-braces: CreateDomainResponseTypeDef](./type_defs.md#createdomainresponsetypedef)
...
Type annotations and code completion for `#!python session.create_client("opensearch").create_index` method.
...
Type annotations and code completion for `#!python session.create_client("opensearch").delete_direct_query_data_source` method.
...
Type annotations and code completion for `#!python session.create_client("opensearch").delete_index` method.
...
Type annotations and code completion for `#!python session.create_client("opensearch").deregister_capability` method.
...
await def deregister_capability(
    self,
    *,
    applicationId: str,
    capabilityName: str,
...
Type annotations and code completion for `#!python session.create_client("opensearch").describe_insight_details` method.
...
await def describe_insight_details(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("opensearch").get_capability` method.
...
Type annotations and code completion for `#!python session.create_client("opensearch").get_default_application_setting` method.
...
await def get_default_application_setting(
    self,
...
Type annotations and code completion for `#!python session.create_client("opensearch").get_index` method.
...
Type annotations and code completion for `#!python session.create_client("opensearch").list_insights` method.
...
Type annotations and code completion for `#!python session.create_client("opensearch").put_default_application_setting` method.
...
await def put_default_application_setting(
    self,
    *,
    applicationArn: str,
    setAsDefault: bool,
...
Type annotations and code completion for `#!python session.create_client("opensearch").register_capability` method.
...
Type annotations and code completion for `#!python session.create_client("opensearch").rollback_service_software_update` method.
...
await def rollback_service_software_update(
    self,
    *,
    DomainName: str,
...
await def update_domain_config(
    ...
    *,
    ...
    AIMLOptions: AIMLOptionsInputTypeDef = ...,  # (17)
    DeploymentStrategyOptions: DeploymentStrategyOptionsTypeDef = ...,  # (18)
) -> UpdateDomainConfigResponseTypeDef:  # (19)
    ...
```
...
17. See [:material-code-braces: AIMLOptionsInputTypeDef](./type_defs.md#aimloptionsinputtypedef)
18. See [:material-code-braces: DeploymentStrategyOptionsTypeDef](./type_defs.md#deploymentstrategyoptionstypedef)
19. See [:material-code-braces: UpdateDomainConfigResponseTypeDef](./type_defs.md#updatedomainconfigresponsetypedef)
...
Type annotations and code completion for `#!python session.create_client("opensearch").update_index` method.
