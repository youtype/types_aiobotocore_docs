...
```python
# QueryTransactionStatusType usage example

from types_aiobotocore_managedblockchain_query.literals import QueryTransactionStatusType

def get_value() -> QueryTransactionStatusType:
    return "FAILED"
```

```python
# QueryTransactionStatusType definition

QueryTransactionStatusType = Literal[
    "FAILED",
    "FINAL",
]
```
