...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless")`
...
This class provides code completion for `#!python session.create_client("mwaa-serverless").exceptions` structure.

```python
# MWAAServerlessClient.exceptions usage example
...
```python
# MWAAServerlessClient usage type checking example

from types_aiobotocore_mwaa_serverless.client import Exceptions
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").can_paginate` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").generate_presigned_url` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").create_workflow` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").delete_workflow` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").get_task_instance` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").get_workflow` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").get_workflow_run` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").list_task_instances` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").list_workflow_runs` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").list_workflow_versions` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").list_workflows` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").start_workflow_run` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").stop_workflow_run` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").untag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").update_workflow` method.
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/mwaa-serverless.html#MWAAServerless.Client)
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/mwaa-serverless.html#MWAAServerless.Client)
...
Type annotations and code completion for `#!python session.create_client("mwaa-serverless").get_paginator` method with overloads.
