<a id="type-annotations-for-aiobotocore-nimblestudio-module"></a>
...
Type annotations for `aiobotocore.create_client("nimble")` as
...
```python
from types_aiobotocore_nimble.paginators import ListEulaAcceptancesPaginator, ...
```
...
```python
from types_aiobotocore_nimble.waiters import LaunchProfileDeletedWaiter, ...
```
