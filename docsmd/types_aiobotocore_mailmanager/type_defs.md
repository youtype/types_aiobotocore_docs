...
4. See [:material-code-braces: RelayActionTypeDef](./type_defs.md#relayactiontypedef) 
5. See [:material-code-braces: ReplaceRecipientActionOutputTypeDef](./type_defs.md#replacerecipientactionoutputtypedef) 
6. See [:material-code-braces: SendActionTypeDef](./type_defs.md#sendactiontypedef) 
7. See [:material-code-braces: S3ActionTypeDef](./type_defs.md#s3actiontypedef) 
...
class RuleActionTypeDef(TypedDict):
    ...
    Relay: NotRequired[RelayActionTypeDef],  # (4)
    ReplaceRecipient: NotRequired[ReplaceRecipientActionUnionTypeDef],  # (5)
    Send: NotRequired[SendActionTypeDef],  # (6)
    WriteToS3: NotRequired[S3ActionTypeDef],  # (7)
```
...
3. See [:material-code-braces: DeliverToMailboxActionTypeDef](./type_defs.md#delivertomailboxactiontypedef) 
4. See [:material-code-braces: RelayActionTypeDef](./type_defs.md#relayactiontypedef) 
5. See [:material-code-braces: ReplaceRecipientActionTypeDef](./type_defs.md#replacerecipientactiontypedef) [:material-code-braces: ReplaceRecipientActionOutputTypeDef](./type_defs.md#replacerecipientactionoutputtypedef) 
6. See [:material-code-braces: SendActionTypeDef](./type_defs.md#sendactiontypedef) 
7. See [:material-code-braces: S3ActionTypeDef](./type_defs.md#s3actiontypedef) 
...
1. See [:material-code-braces: ArchiveBooleanExpressionTypeDef](./type_defs.md#archivebooleanexpressiontypedef) 
2. See [:material-code-braces: ArchiveStringExpressionTypeDef](./type_defs.md#archivestringexpressiontypedef) [:material-code-braces: ArchiveStringExpressionOutputTypeDef](./type_defs.md#archivestringexpressionoutputtypedef) 
...
1. See [:material-code-braces: ArchiveFilterConditionTypeDef](./type_defs.md#archivefilterconditiontypedef) [:material-code-braces: ArchiveFilterConditionOutputTypeDef](./type_defs.md#archivefilterconditionoutputtypedef) 
...
3. See [:material-code-braces: RuleConditionTypeDef](./type_defs.md#ruleconditiontypedef) 
