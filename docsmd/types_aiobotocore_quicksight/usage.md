...
from types_aiobotocore_quicksight.type_defs import BatchCreateTopicReviewedAnswerRequestRequestTypeDef
...
async with session.create_client("quicksight") as client:
    ...
    kwargs: BatchCreateTopicReviewedAnswerRequestRequestTypeDef = {...}
