...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits")`
...
This class provides code completion for `#!python session.create_client("partnercentral-benefits").exceptions` structure.

```python
# PartnerCentralBenefitsClient.exceptions usage example
...
```python
# PartnerCentralBenefitsClient usage type checking example

from types_aiobotocore_partnercentral_benefits.client import Exceptions
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").can_paginate` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").generate_presigned_url` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").amend_benefit_application` method.
...
await def amend_benefit_application(
    self,
    *,
    Catalog: str,
    ClientToken: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").associate_benefit_application_resource` method.
...
await def associate_benefit_application_resource(
    self,
    *,
    Catalog: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").cancel_benefit_application` method.
...
await def cancel_benefit_application(
    self,
    *,
    Catalog: str,
    ClientToken: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").create_benefit_application` method.
...
await def create_benefit_application(
    self,
    *,
    Catalog: str,
    ClientToken: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").disassociate_benefit_application_resource` method.
...
await def disassociate_benefit_application_resource(
    self,
    *,
    Catalog: str,
    BenefitApplicationIdentifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").get_benefit` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").get_benefit_allocation` method.
...
await def get_benefit_allocation(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").get_benefit_application` method.
...
await def get_benefit_application(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").list_benefit_allocations` method.
...
await def list_benefit_allocations(
    self,
    *,
    Catalog: str,
    FulfillmentTypes: Sequence[FulfillmentTypeType] = ...,  # (1)
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").list_benefit_applications` method.
...
await def list_benefit_applications(
    self,
    *,
    Catalog: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").list_benefits` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").recall_benefit_application` method.
...
await def recall_benefit_application(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").submit_benefit_application` method.
...
await def submit_benefit_application(
    self,
    *,
    Catalog: str,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").untag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").update_benefit_application` method.
...
await def update_benefit_application(
    self,
    *,
    Catalog: str,
    ClientToken: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/partnercentral-benefits.html#PartnerCentralBenefits.Client)
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/partnercentral-benefits.html#PartnerCentralBenefits.Client)
...
Type annotations and code completion for `#!python session.create_client("partnercentral-benefits").get_paginator` method with overloads.
