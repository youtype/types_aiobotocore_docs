...
Type annotations and code completion for `#!python session.create_client("lakeformation").get_temporary_data_location_credentials` method.
...
await def get_temporary_data_location_credentials(
    self,
    *,
    DurationSeconds: int = ...,
