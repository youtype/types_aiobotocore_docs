...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/sts/client/close.html)
...
kwargs: AssumeRootRequestRequestTypeDef = {  # (1)
    "TargetPrincipal": ...,
    "TaskPolicyArn": ...,
}
...
1. See [:material-code-braces: AssumeRootRequestRequestTypeDef](./type_defs.md#assumerootrequestrequesttypedef) 
