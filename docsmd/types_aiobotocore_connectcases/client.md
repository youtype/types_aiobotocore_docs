...
Type annotations and code completion for `#!python session.create_client("connectcases").search_all_related_items` method.
...
await def search_all_related_items(
    self,
    *,
    domainId: str,
    maxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("connectcases").update_related_item` method.
