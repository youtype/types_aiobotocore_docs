...
class QueryLoggingConfigurationMetadataTypeDef(TypedDict):
    createdAt: datetime.datetime,
    destinations: List[LoggingDestinationTypeDef],  # (1)
    modifiedAt: datetime.datetime,
    status: QueryLoggingConfigurationStatusTypeDef,  # (2)
    workspace: str,
```

1. See `List[LoggingDestinationTypeDef]`
2. See [:material-code-braces: QueryLoggingConfigurationStatusTypeDef](./type_defs.md#queryloggingconfigurationstatustypedef)
