...
Type annotations and code completion for  `#!python session.create_client("alexaforbusiness")` as [AlexaForBusinessClient](./client.md)
...
- [CreateProactiveJoinTypeDef](./type_defs.md#createproactivejointypedef)
...
- [ProactiveJoinTypeDef](./type_defs.md#proactivejointypedef)
...
- [UpdateProactiveJoinTypeDef](./type_defs.md#updateproactivejointypedef)
