...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Paginator.DescribeDBClusterAutomatedBackups)
...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DBClusterAutomatedBackupMessageTypeDef]:  # (3)
    ...
```
...
kwargs: DescribeDBClusterAutomatedBackupsMessageDescribeDBClusterAutomatedBackupsPaginateTypeDef = {  # (1)
    "DbClusterResourceId": ...,
}
...
1. See [:material-code-braces: DescribeDBClusterAutomatedBackupsMessageDescribeDBClusterAutomatedBackupsPaginateTypeDef](./type_defs.md#describedbclusterautomatedbackupsmessagedescribedbclusterautomatedbackupspaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Paginator.DescribeDBRecommendations)
...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DBRecommendationsMessageTypeDef]:  # (3)
    ...
```
...
kwargs: DescribeDBRecommendationsMessageDescribeDBRecommendationsPaginateTypeDef = {  # (1)
    "LastUpdatedAfter": ...,
}
...
1. See [:material-code-braces: DescribeDBRecommendationsMessageDescribeDBRecommendationsPaginateTypeDef](./type_defs.md#describedbrecommendationsmessagedescribedbrecommendationspaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Paginator.DescribeDBSnapshotTenantDatabases)
...
def paginate(
    ...
    *,
    ...
    DbiResourceId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DBSnapshotTenantDatabasesMessageTypeDef]:  # (3)
    ...
```
...
kwargs: DescribeDBSnapshotTenantDatabasesMessageDescribeDBSnapshotTenantDatabasesPaginateTypeDef = {  # (1)
    "DBInstanceIdentifier": ...,
}
...
1. See [:material-code-braces: DescribeDBSnapshotTenantDatabasesMessageDescribeDBSnapshotTenantDatabasesPaginateTypeDef](./type_defs.md#describedbsnapshottenantdatabasesmessagedescribedbsnapshottenantdatabasespaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Paginator.DescribeIntegrations)
...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DescribeIntegrationsResponseTypeDef]:  # (3)
    ...
```
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/rds.html#RDS.Paginator.DescribeTenantDatabases)
...
def paginate(
    ...
    *,
    ...
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[TenantDatabasesMessageTypeDef]:  # (3)
    ...
```
...
kwargs: DescribeTenantDatabasesMessageDescribeTenantDatabasesPaginateTypeDef = {  # (1)
    "DBInstanceIdentifier": ...,
}
...
1. See [:material-code-braces: DescribeTenantDatabasesMessageDescribeTenantDatabasesPaginateTypeDef](./type_defs.md#describetenantdatabasesmessagedescribetenantdatabasespaginatetypedef) 
