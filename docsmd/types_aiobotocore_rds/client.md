...
async with session.create_client("rds") as client:
    try:
        ...
        client.VpcEncryptionControlViolationException,
    ) as e:
        print(e)
```
...
Type annotations and code completion for `#!python session.create_client("rds").describe_serverless_v2_platform_versions` method.
...
await def describe_serverless_v2_platform_versions(
    self,
    *,
