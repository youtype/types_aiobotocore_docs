...
```python
# ListBundlesPaginatorName definition

ListBundlesPaginatorName = Literal[
    "list_bundles",
]
```
...
from types_aiobotocore_mobile.literals import ListProjectsPaginatorName
...
from types_aiobotocore_mobile.literals import PlatformType
...
```python
# ProjectStateType usage example

from types_aiobotocore_mobile.literals import ProjectStateType

def get_value() -> ProjectStateType:
    return "IMPORTING"
```

```python
# ProjectStateType definition
...
```python
# MobileServiceName usage example

from types_aiobotocore_mobile.literals import MobileServiceName

def get_value() -> MobileServiceName:
    return "mobile"
```

```python
# MobileServiceName definition

MobileServiceName = Literal[
    "mobile",
]
```
## ServiceName
...
from types_aiobotocore_mobile.literals import ServiceName
...
from types_aiobotocore_mobile.literals import ResourceServiceName
