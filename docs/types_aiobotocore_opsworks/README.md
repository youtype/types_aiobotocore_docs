<a id="type-annotations-for-aiobotocore-opsworks-module"></a>

# Type annotations for aiobotocore OpsWorks module
...
- [Type annotations for aiobotocore OpsWorks module](#type-annotations-for-aiobotocore-opsworks-module)
...
Type annotations for collections from `aiobotocore.resource("opsworks").*`.
