...
class DomainStatusTypeDef(TypedDict):
    ...
    AutoTuneOptions: NotRequired[AutoTuneOptionsOutputTypeDef],  # (13)
    ChangeProgressDetails: NotRequired[ChangeProgressDetailsTypeDef],  # (14)
    ...
    DomainProcessingStatus: NotRequired[DomainProcessingStatusTypeType],  # (17)
    ModifyingProperties: NotRequired[List[ModifyingPropertiesTypeDef]],  # (18)
    AIMLOptions: NotRequired[AIMLOptionsOutputTypeDef],  # (19)
```
...
13. See [:material-code-braces: AutoTuneOptionsOutputTypeDef](./type_defs.md#autotuneoptionsoutputtypedef) 
14. See [:material-code-braces: ChangeProgressDetailsTypeDef](./type_defs.md#changeprogressdetailstypedef) 
...
17. See [:material-code-brackets: DomainProcessingStatusTypeType](./literals.md#domainprocessingstatustypetype) 
18. See [:material-code-braces: ModifyingPropertiesTypeDef](./type_defs.md#modifyingpropertiestypedef) 
19. See [:material-code-braces: AIMLOptionsOutputTypeDef](./type_defs.md#aimloptionsoutputtypedef) 
...
class CreateDomainRequestRequestTypeDef(TypedDict):
    ...
    AutoTuneOptions: NotRequired[AutoTuneOptionsInputTypeDef],  # (13)
    ...
    AIMLOptions: NotRequired[AIMLOptionsInputTypeDef],  # (16)
```
...
class UpdateDomainConfigRequestRequestTypeDef(TypedDict):
    ...
    AdvancedSecurityOptions: NotRequired[AdvancedSecurityOptionsInputTypeDef],  # (11)
    AutoTuneOptions: NotRequired[AutoTuneOptionsTypeDef],  # (12)
    DryRun: NotRequired[bool],
    DryRunMode: NotRequired[DryRunModeType],  # (13)
    OffPeakWindowOptions: NotRequired[OffPeakWindowOptionsTypeDef],  # (14)
    SoftwareUpdateOptions: NotRequired[SoftwareUpdateOptionsTypeDef],  # (15)
    AIMLOptions: NotRequired[AIMLOptionsInputTypeDef],  # (16)
```
...
class DomainConfigTypeDef(TypedDict):
    ...
    AutoTuneOptions: NotRequired[AutoTuneOptionsStatusTypeDef],  # (15)
    ChangeProgressDetails: NotRequired[ChangeProgressDetailsTypeDef],  # (16)
    OffPeakWindowOptions: NotRequired[OffPeakWindowOptionsStatusTypeDef],  # (17)
    SoftwareUpdateOptions: NotRequired[SoftwareUpdateOptionsStatusTypeDef],  # (18)
    ModifyingProperties: NotRequired[List[ModifyingPropertiesTypeDef]],  # (19)
    AIMLOptions: NotRequired[AIMLOptionsStatusTypeDef],  # (20)
```
...
15. See [:material-code-braces: AutoTuneOptionsStatusTypeDef](./type_defs.md#autotuneoptionsstatustypedef) 
16. See [:material-code-braces: ChangeProgressDetailsTypeDef](./type_defs.md#changeprogressdetailstypedef) 
17. See [:material-code-braces: OffPeakWindowOptionsStatusTypeDef](./type_defs.md#offpeakwindowoptionsstatustypedef) 
18. See [:material-code-braces: SoftwareUpdateOptionsStatusTypeDef](./type_defs.md#softwareupdateoptionsstatustypedef) 
19. See [:material-code-braces: ModifyingPropertiesTypeDef](./type_defs.md#modifyingpropertiestypedef) 
20. See [:material-code-braces: AIMLOptionsStatusTypeDef](./type_defs.md#aimloptionsstatustypedef) 
