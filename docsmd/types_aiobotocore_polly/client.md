...
Type annotations and code completion for `#!python session.create_client("polly").start_speech_synthesis_stream` method.
...
await def start_speech_synthesis_stream(
    self,
    *,
    Engine: EngineType,  # (1)
    ...
    SampleRate: str = ...,
    ActionStream: aiobotocore.eventstream.AioEventStream[StartSpeechSynthesisStreamActionStreamTypeDef] = ...,  # (5)
