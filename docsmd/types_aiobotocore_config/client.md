...
Type annotations and code completion for `#!python session.create_client("config").close` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/config/client/close.html)
...
Type annotations and code completion for `#!python session.create_client("config").deliver_config_snapshot` method.
...
Type annotations and code completion for `#!python session.create_client("config").describe_organization_config_rules` method.
...
Type annotations and code completion for `#!python session.create_client("config").get_aggregate_config_rule_compliance_summary` method.
...
Type annotations and code completion for `#!python session.create_client("config").put_remediation_configurations` method.
...
Type annotations and code completion for `#!python session.create_client("config").put_remediation_exceptions` method.
...
Type annotations and code completion for `#!python session.create_client("config").put_resource_config` method.
...
Type annotations and code completion for `#!python session.create_client("config").put_retention_configuration` method.
...
Type annotations and code completion for `#!python session.create_client("config").put_service_linked_configuration_recorder` method.
...
await def put_service_linked_configuration_recorder(
    self,
    *,
    ServicePrincipal: str,
    Tags: Sequence[TagTypeDef] = ...,  # (1)
...
Type annotations and code completion for `#!python session.create_client("config").put_stored_query` method.
...
Type annotations and code completion for `#!python session.create_client("config").select_aggregate_resource_config` method.
...
Type annotations and code completion for `#!python session.create_client("config").select_resource_config` method.
...
Type annotations and code completion for `#!python session.create_client("config").start_config_rules_evaluation` method.
...
Type annotations and code completion for `#!python session.create_client("config").start_configuration_recorder` method.
...
Type annotations and code completion for `#!python session.create_client("config").start_remediation_execution` method.
...
Type annotations and code completion for `#!python session.create_client("config").start_resource_evaluation` method.
...
await def start_resource_evaluation(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("config").stop_configuration_recorder` method.
...
Type annotations and code completion for `#!python session.create_client("config").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("config").untag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("config").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/config.html#ConfigService.Client)
...
Type annotations and code completion for `#!python session.create_client("config").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/config.html#ConfigService.Client)
...
Type annotations and code completion for `#!python session.create_client("config").get_paginator` method with overloads.
