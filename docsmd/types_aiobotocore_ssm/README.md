...
Type annotations and code completion for  `#!python session.create_client("ssm")` as [SSMClient](./client.md)
...
from `#!python session.create_client("ssm").get_paginator("...")`.
...
Type annotations and code completion for
[waiters](./waiters.md)
from `#!python session.create_client("ssm").get_waiter("...")`.
