...
Type annotations and code completion for `#!python session.create_client("launch-wizard").get_deployment_pattern_version` method.
...
await def get_deployment_pattern_version(
    self,
    *,
    workloadName: str,
    deploymentPatternName: str,
...
Type annotations and code completion for `#!python session.create_client("launch-wizard").list_deployment_pattern_versions` method.
...
await def list_deployment_pattern_versions(
    self,
    *,
    workloadName: str,
    deploymentPatternName: str,
...
Type annotations and code completion for `#!python session.create_client("launch-wizard").update_deployment` method.
