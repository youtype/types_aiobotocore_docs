...
) -> AsyncIterator[ListCommandExecutionsResponseTypeDef]:  # (7)
    ...
```
...
kwargs: ListCommandExecutionsRequestListCommandExecutionsPaginateTypeDef = {  # (1)
    "namespace": ...,
}
...
1. See [:material-code-braces: ListCommandExecutionsRequestListCommandExecutionsPaginateTypeDef](./type_defs.md#listcommandexecutionsrequestlistcommandexecutionspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[ListCommandsResponseTypeDef]:  # (4)
    ...
```
...
1. See [:material-code-braces: ListManagedJobTemplatesRequestListManagedJobTemplatesPaginateTypeDef](./type_defs.md#listmanagedjobtemplatesrequestlistmanagedjobtemplatespaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListPrincipalThingsV2ResponseTypeDef]:  # (3)
    ...
```
...
kwargs: ListPrincipalThingsV2RequestListPrincipalThingsV2PaginateTypeDef = {  # (1)
    "principal": ...,
}
...
1. See [:material-code-braces: ListPrincipalThingsV2RequestListPrincipalThingsV2PaginateTypeDef](./type_defs.md#listprincipalthingsv2requestlistprincipalthingsv2paginatetypedef) 
...
1. See [:material-code-braces: ListRelatedResourcesForAuditFindingRequestListRelatedResourcesForAuditFindingPaginateTypeDef](./type_defs.md#listrelatedresourcesforauditfindingrequestlistrelatedresourcesforauditfindingpaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListSbomValidationResultsResponseTypeDef]:  # (3)
    ...
```
...
kwargs: ListSbomValidationResultsRequestListSbomValidationResultsPaginateTypeDef = {  # (1)
    "packageName": ...,
    "versionName": ...,
}
...
1. See [:material-code-braces: ListSbomValidationResultsRequestListSbomValidationResultsPaginateTypeDef](./type_defs.md#listsbomvalidationresultsrequestlistsbomvalidationresultspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    thingPrincipalType: ThingPrincipalTypeType = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListThingPrincipalsV2ResponseTypeDef]:  # (3)
    ...
```
...
kwargs: ListThingPrincipalsV2RequestListThingPrincipalsV2PaginateTypeDef = {  # (1)
    "thingName": ...,
}
...
1. See [:material-code-braces: ListThingPrincipalsV2RequestListThingPrincipalsV2PaginateTypeDef](./type_defs.md#listthingprincipalsv2requestlistthingprincipalsv2paginatetypedef) 
