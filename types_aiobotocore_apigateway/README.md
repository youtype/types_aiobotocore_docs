...
pip install 'types-aiobotocore[apigateway]'
...
Type annotations for `aiobotocore.create_client("apigateway")` as
...
```python
from types_aiobotocore_apigateway.paginators import GetApiKeysPaginator, ...
```
