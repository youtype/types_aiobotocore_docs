...
1. See [:material-code-braces: CodegenGenericDataRelationshipTypeTypeDef](./type_defs.md#codegengenericdatarelationshiptypetypedef) 
...
1. See [:material-code-braces: ApiConfigurationTypeDef](./type_defs.md#apiconfigurationtypedef) 
...
1. See [:material-code-braces: PredicatePaginatorTypeDef](./type_defs.md#predicatepaginatortypedef) 
...
1. See [:material-code-braces: ComponentBindingPropertiesValuePropertiesOutputTypeDef](./type_defs.md#componentbindingpropertiesvaluepropertiesoutputtypedef) 
...
1. See [:material-code-braces: ThemeValueTypeDef](./type_defs.md#themevaluetypedef) [:material-code-braces: ThemeValueOutputTypeDef](./type_defs.md#themevalueoutputtypedef) 
...
1. See [:material-code-braces: FormInputValuePropertyTypeDef](./type_defs.md#forminputvaluepropertytypedef) [:material-code-braces: FormInputValuePropertyOutputTypeDef](./type_defs.md#forminputvaluepropertyoutputtypedef) 
2. See [:material-code-braces: FormInputValuePropertyTypeDef](./type_defs.md#forminputvaluepropertytypedef) [:material-code-braces: FormInputValuePropertyOutputTypeDef](./type_defs.md#forminputvaluepropertyoutputtypedef) 
...
1. See [:material-code-braces: ThemePaginatorTypeDef](./type_defs.md#themepaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
## CodegenJobTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import CodegenJobTypeDef
...
1. See [:material-code-braces: CodegenJobRenderConfigOutputTypeDef](./type_defs.md#codegenjobrenderconfigoutputtypedef) 
2. See [:material-code-braces: CodegenJobGenericDataSchemaOutputTypeDef](./type_defs.md#codegenjobgenericdataschemaoutputtypedef) 
...
6. See [:material-code-braces: CodegenDependencyTypeDef](./type_defs.md#codegendependencytypedef) 
## CodegenGenericDataNonModelTypeDef

```python
# CodegenGenericDataNonModelTypeDef TypedDict usage example

from types_aiobotocore_amplifyuibuilder.type_defs import CodegenGenericDataNonModelTypeDef
...
1. See [:material-code-braces: CodegenGenericDataFieldTypeDef](./type_defs.md#codegengenericdatafieldtypedef) [:material-code-braces: CodegenGenericDataFieldOutputTypeDef](./type_defs.md#codegengenericdatafieldoutputtypedef) 
...
1. See [:material-code-braces: ComponentPropertyTypeDef](./type_defs.md#componentpropertytypedef) [:material-code-braces: ComponentPropertyOutputTypeDef](./type_defs.md#componentpropertyoutputtypedef) 
## ComponentEventOutputTypeDef

```python
# ComponentEventOutputTypeDef TypedDict usage example

from types_aiobotocore_amplifyuibuilder.type_defs import ComponentEventOutputTypeDef
...
1. See [:material-code-braces: ActionParametersOutputTypeDef](./type_defs.md#actionparametersoutputtypedef) 
## ComponentEventPaginatorTypeDef

```python
# ComponentEventPaginatorTypeDef TypedDict usage example

from types_aiobotocore_amplifyuibuilder.type_defs import ComponentEventPaginatorTypeDef
...
1. See [:material-code-braces: ActionParametersPaginatorTypeDef](./type_defs.md#actionparameterspaginatortypedef) 
## FieldInputConfigOutputTypeDef

```python
# FieldInputConfigOutputTypeDef TypedDict usage example

from types_aiobotocore_amplifyuibuilder.type_defs import FieldInputConfigOutputTypeDef
...
1. See [:material-code-braces: ValueMappingsOutputTypeDef](./type_defs.md#valuemappingsoutputtypedef) 
2. See [:material-code-braces: FileUploaderFieldConfigOutputTypeDef](./type_defs.md#fileuploaderfieldconfigoutputtypedef) 
...
from types_aiobotocore_amplifyuibuilder.type_defs import FieldInputConfigPaginatorTypeDef
...
1. See [:material-code-braces: ValueMappingsPaginatorTypeDef](./type_defs.md#valuemappingspaginatortypedef) 
2. See [:material-code-braces: FileUploaderFieldConfigOutputTypeDef](./type_defs.md#fileuploaderfieldconfigoutputtypedef) 
...
1. See [:material-code-braces: ComponentBindingPropertiesValuePropertiesTypeDef](./type_defs.md#componentbindingpropertiesvaluepropertiestypedef) [:material-code-braces: ComponentBindingPropertiesValuePropertiesOutputTypeDef](./type_defs.md#componentbindingpropertiesvaluepropertiesoutputtypedef) 
...
1. See [:material-code-braces: ThemeValuesTypeDef](./type_defs.md#themevaluestypedef) [:material-code-braces: ThemeValuesOutputTypeDef](./type_defs.md#themevaluesoutputtypedef) 
...
from types_aiobotocore_amplifyuibuilder.type_defs import CodegenJobRenderConfigTypeDef
...
1. See [:material-code-braces: ReactStartCodegenJobDataTypeDef](./type_defs.md#reactstartcodegenjobdatatypedef) [:material-code-braces: ReactStartCodegenJobDataOutputTypeDef](./type_defs.md#reactstartcodegenjobdataoutputtypedef) 
## GetCodegenJobResponseTypeDef

```python
# GetCodegenJobResponseTypeDef TypedDict usage example

from types_aiobotocore_amplifyuibuilder.type_defs import GetCodegenJobResponseTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import StartCodegenJobResponseTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import ComponentChildOutputTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import ComponentChildPaginatorTypeDef
...
1. See [:material-code-braces: ComponentPropertyPaginatorTypeDef](./type_defs.md#componentpropertypaginatortypedef) 
2. See [:material-code-braces: ComponentEventPaginatorTypeDef](./type_defs.md#componenteventpaginatortypedef) 
## FieldConfigOutputTypeDef

```python
# FieldConfigOutputTypeDef TypedDict usage example

from types_aiobotocore_amplifyuibuilder.type_defs import FieldConfigOutputTypeDef
...
1. See [:material-code-braces: FieldPositionTypeDef](./type_defs.md#fieldpositiontypedef) 
2. See [:material-code-braces: FieldInputConfigOutputTypeDef](./type_defs.md#fieldinputconfigoutputtypedef) 
3. See [:material-code-braces: FieldValidationConfigurationOutputTypeDef](./type_defs.md#fieldvalidationconfigurationoutputtypedef) 
## FieldConfigPaginatorTypeDef

```python
# FieldConfigPaginatorTypeDef TypedDict usage example

from types_aiobotocore_amplifyuibuilder.type_defs import FieldConfigPaginatorTypeDef
...
1. See [:material-code-braces: FieldPositionTypeDef](./type_defs.md#fieldpositiontypedef) 
2. See [:material-code-braces: FieldInputConfigPaginatorTypeDef](./type_defs.md#fieldinputconfigpaginatortypedef) 
3. See [:material-code-braces: FieldValidationConfigurationOutputTypeDef](./type_defs.md#fieldvalidationconfigurationoutputtypedef) 
...
from types_aiobotocore_amplifyuibuilder.type_defs import ValueMappingsTypeDef
...
1. See [:material-code-braces: ValueMappingTypeDef](./type_defs.md#valuemappingtypedef) [:material-code-braces: ValueMappingOutputTypeDef](./type_defs.md#valuemappingoutputtypedef) 
2. See [:material-code-braces: FormInputBindingPropertiesValueTypeDef](./type_defs.md#forminputbindingpropertiesvaluetypedef) 
...
from types_aiobotocore_amplifyuibuilder.type_defs import CreateThemeRequestTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import UpdateThemeRequestTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import CodegenJobGenericDataSchemaTypeDef
...
1. See [:material-code-brackets: CodegenJobGenericDataSourceTypeType](./literals.md#codegenjobgenericdatasourcetypetype) 
2. See [:material-code-braces: CodegenGenericDataModelTypeDef](./type_defs.md#codegengenericdatamodeltypedef) [:material-code-braces: CodegenGenericDataModelOutputTypeDef](./type_defs.md#codegengenericdatamodeloutputtypedef) 
3. See [:material-code-braces: CodegenGenericDataEnumTypeDef](./type_defs.md#codegengenericdataenumtypedef) [:material-code-braces: CodegenGenericDataEnumOutputTypeDef](./type_defs.md#codegengenericdataenumoutputtypedef) 
4. See [:material-code-braces: CodegenGenericDataNonModelTypeDef](./type_defs.md#codegengenericdatanonmodeltypedef) [:material-code-braces: CodegenGenericDataNonModelOutputTypeDef](./type_defs.md#codegengenericdatanonmodeloutputtypedef) 
...
1. See [:material-code-braces: ComponentPropertyTypeDef](./type_defs.md#componentpropertytypedef) [:material-code-braces: ComponentPropertyOutputTypeDef](./type_defs.md#componentpropertyoutputtypedef) 
2. See [:material-code-braces: ComponentPropertyTypeDef](./type_defs.md#componentpropertytypedef) [:material-code-braces: ComponentPropertyOutputTypeDef](./type_defs.md#componentpropertyoutputtypedef) 
3. See [:material-code-braces: ComponentPropertyTypeDef](./type_defs.md#componentpropertytypedef) [:material-code-braces: ComponentPropertyOutputTypeDef](./type_defs.md#componentpropertyoutputtypedef) 
4. See [:material-code-braces: ComponentPropertyTypeDef](./type_defs.md#componentpropertytypedef) [:material-code-braces: ComponentPropertyOutputTypeDef](./type_defs.md#componentpropertyoutputtypedef) 
5. See [:material-code-braces: ComponentPropertyTypeDef](./type_defs.md#componentpropertytypedef) [:material-code-braces: ComponentPropertyOutputTypeDef](./type_defs.md#componentpropertyoutputtypedef) 
6. See [:material-code-braces: ComponentPropertyTypeDef](./type_defs.md#componentpropertytypedef) [:material-code-braces: ComponentPropertyOutputTypeDef](./type_defs.md#componentpropertyoutputtypedef) 
7. See [:material-code-braces: ComponentPropertyTypeDef](./type_defs.md#componentpropertytypedef) 
8. See [:material-code-braces: MutationActionSetStateParameterTypeDef](./type_defs.md#mutationactionsetstateparametertypedef) [:material-code-braces: MutationActionSetStateParameterOutputTypeDef](./type_defs.md#mutationactionsetstateparameteroutputtypedef) 
## ComponentTypeDef
...
1. See [:material-code-braces: ComponentPropertyOutputTypeDef](./type_defs.md#componentpropertyoutputtypedef) 
2. See [:material-code-braces: ComponentChildOutputTypeDef](./type_defs.md#componentchildoutputtypedef) 
3. See [:material-code-braces: ComponentVariantOutputTypeDef](./type_defs.md#componentvariantoutputtypedef) 
4. See [:material-code-braces: ComponentBindingPropertiesValueOutputTypeDef](./type_defs.md#componentbindingpropertiesvalueoutputtypedef) 
5. See [:material-code-braces: ComponentDataConfigurationOutputTypeDef](./type_defs.md#componentdataconfigurationoutputtypedef) 
6. See [:material-code-braces: ComponentEventOutputTypeDef](./type_defs.md#componenteventoutputtypedef) 
## ComponentPaginatorTypeDef

```python
# ComponentPaginatorTypeDef TypedDict usage example

from types_aiobotocore_amplifyuibuilder.type_defs import ComponentPaginatorTypeDef
...
1. See [:material-code-braces: ComponentPropertyPaginatorTypeDef](./type_defs.md#componentpropertypaginatortypedef) 
2. See [:material-code-braces: ComponentChildPaginatorTypeDef](./type_defs.md#componentchildpaginatortypedef) 
3. See [:material-code-braces: ComponentVariantOutputTypeDef](./type_defs.md#componentvariantoutputtypedef) 
4. See [:material-code-braces: ComponentBindingPropertiesValuePaginatorTypeDef](./type_defs.md#componentbindingpropertiesvaluepaginatortypedef) 
5. See [:material-code-braces: ComponentDataConfigurationPaginatorTypeDef](./type_defs.md#componentdataconfigurationpaginatortypedef) 
6. See [:material-code-braces: ComponentEventPaginatorTypeDef](./type_defs.md#componenteventpaginatortypedef) 
## FormTypeDef

```python
# FormTypeDef TypedDict usage example

from types_aiobotocore_amplifyuibuilder.type_defs import FormTypeDef
...
4. See [:material-code-braces: FieldConfigOutputTypeDef](./type_defs.md#fieldconfigoutputtypedef) 
...
from types_aiobotocore_amplifyuibuilder.type_defs import FormPaginatorTypeDef
...
2. See [:material-code-braces: FormStyleTypeDef](./type_defs.md#formstyletypedef) 
3. See [:material-code-braces: FormDataTypeConfigTypeDef](./type_defs.md#formdatatypeconfigtypedef) 
4. See [:material-code-braces: FieldConfigPaginatorTypeDef](./type_defs.md#fieldconfigpaginatortypedef) 
5. See [:material-code-braces: SectionalElementTypeDef](./type_defs.md#sectionalelementtypedef) 
6. See [:material-code-braces: FormCTATypeDef](./type_defs.md#formctatypedef) 
7. See [:material-code-brackets: LabelDecoratorType](./literals.md#labeldecoratortype) 
...
1. See [:material-code-braces: ComponentPaginatorTypeDef](./type_defs.md#componentpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
from types_aiobotocore_amplifyuibuilder.type_defs import CreateFormResponseTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import ExportFormsResponseTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import GetFormResponseTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import UpdateFormResponseTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import ExportFormsResponsePaginatorTypeDef
...
1. See [:material-code-braces: FormPaginatorTypeDef](./type_defs.md#formpaginatortypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
from types_aiobotocore_amplifyuibuilder.type_defs import FieldInputConfigTypeDef
...
1. See [:material-code-braces: ValueMappingsTypeDef](./type_defs.md#valuemappingstypedef) [:material-code-braces: ValueMappingsOutputTypeDef](./type_defs.md#valuemappingsoutputtypedef) 
2. See [:material-code-braces: FileUploaderFieldConfigTypeDef](./type_defs.md#fileuploaderfieldconfigtypedef) [:material-code-braces: FileUploaderFieldConfigOutputTypeDef](./type_defs.md#fileuploaderfieldconfigoutputtypedef) 
## StartCodegenJobDataTypeDef

```python
# StartCodegenJobDataTypeDef TypedDict usage example

from types_aiobotocore_amplifyuibuilder.type_defs import StartCodegenJobDataTypeDef
...
1. See [:material-code-braces: CodegenJobRenderConfigTypeDef](./type_defs.md#codegenjobrenderconfigtypedef) [:material-code-braces: CodegenJobRenderConfigOutputTypeDef](./type_defs.md#codegenjobrenderconfigoutputtypedef) 
2. See [:material-code-braces: CodegenJobGenericDataSchemaTypeDef](./type_defs.md#codegenjobgenericdataschematypedef) [:material-code-braces: CodegenJobGenericDataSchemaOutputTypeDef](./type_defs.md#codegenjobgenericdataschemaoutputtypedef) 
3. See [:material-code-braces: CodegenFeatureFlagsTypeDef](./type_defs.md#codegenfeatureflagstypedef) 
...
1. See [:material-code-braces: ActionParametersTypeDef](./type_defs.md#actionparameterstypedef) [:material-code-braces: ActionParametersOutputTypeDef](./type_defs.md#actionparametersoutputtypedef) 
## StartCodegenJobRequestTypeDef

```python
# StartCodegenJobRequestTypeDef TypedDict usage example

from types_aiobotocore_amplifyuibuilder.type_defs import StartCodegenJobRequestTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import FieldConfigTypeDef
...
1. See [:material-code-braces: FieldPositionTypeDef](./type_defs.md#fieldpositiontypedef) 
2. See [:material-code-braces: FieldInputConfigTypeDef](./type_defs.md#fieldinputconfigtypedef) [:material-code-braces: FieldInputConfigOutputTypeDef](./type_defs.md#fieldinputconfigoutputtypedef) 
3. See [:material-code-braces: FieldValidationConfigurationTypeDef](./type_defs.md#fieldvalidationconfigurationtypedef) [:material-code-braces: FieldValidationConfigurationOutputTypeDef](./type_defs.md#fieldvalidationconfigurationoutputtypedef) 
...
1. See [:material-code-braces: ComponentPropertyTypeDef](./type_defs.md#componentpropertytypedef) [:material-code-braces: ComponentPropertyOutputTypeDef](./type_defs.md#componentpropertyoutputtypedef) 
2. See [:material-code-braces: ComponentChildTypeDef](./type_defs.md#componentchildtypedef) [:material-code-braces: ComponentChildOutputTypeDef](./type_defs.md#componentchildoutputtypedef) 
3. See [:material-code-braces: ComponentVariantTypeDef](./type_defs.md#componentvarianttypedef) [:material-code-braces: ComponentVariantOutputTypeDef](./type_defs.md#componentvariantoutputtypedef) 
4. See [:material-code-braces: ComponentBindingPropertiesValueTypeDef](./type_defs.md#componentbindingpropertiesvaluetypedef) [:material-code-braces: ComponentBindingPropertiesValueOutputTypeDef](./type_defs.md#componentbindingpropertiesvalueoutputtypedef) 
5. See [:material-code-braces: ComponentDataConfigurationTypeDef](./type_defs.md#componentdataconfigurationtypedef) [:material-code-braces: ComponentDataConfigurationOutputTypeDef](./type_defs.md#componentdataconfigurationoutputtypedef) 
6. See [:material-code-braces: ComponentEventTypeDef](./type_defs.md#componenteventtypedef) [:material-code-braces: ComponentEventOutputTypeDef](./type_defs.md#componenteventoutputtypedef) 
...
from types_aiobotocore_amplifyuibuilder.type_defs import CreateFormDataTypeDef
...
1. See [:material-code-braces: FormDataTypeConfigTypeDef](./type_defs.md#formdatatypeconfigtypedef) 
2. See [:material-code-brackets: FormActionTypeType](./literals.md#formactiontypetype) 
3. See [:material-code-braces: FieldConfigTypeDef](./type_defs.md#fieldconfigtypedef) [:material-code-braces: FieldConfigOutputTypeDef](./type_defs.md#fieldconfigoutputtypedef) 
...
from types_aiobotocore_amplifyuibuilder.type_defs import UpdateFormDataTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import UpdateComponentRequestTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import CreateFormRequestTypeDef
...
from types_aiobotocore_amplifyuibuilder.type_defs import UpdateFormRequestTypeDef
