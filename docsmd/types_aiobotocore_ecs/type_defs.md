...
1. See [:material-code-braces: DeploymentAlarmsTypeDef](./type_defs.md#deploymentalarmstypedef) 
...
2. See [:material-code-braces: ContainerOverrideOutputTypeDef](./type_defs.md#containeroverrideoutputtypedef) 
...
2. See [:material-code-braces: ServiceConnectServiceOutputTypeDef](./type_defs.md#serviceconnectserviceoutputtypedef) 
...
1. See [:material-code-braces: DeploymentCircuitBreakerTypeDef](./type_defs.md#deploymentcircuitbreakertypedef) 
2. See [:material-code-braces: DeploymentAlarmsTypeDef](./type_defs.md#deploymentalarmstypedef) [:material-code-braces: DeploymentAlarmsOutputTypeDef](./type_defs.md#deploymentalarmsoutputtypedef) 
...
class ContainerDefinitionOutputTypeDef(TypedDict):
    ...
    extraHosts: NotRequired[List[HostEntryTypeDef]],  # (11)
    ...
    ulimits: NotRequired[List[UlimitTypeDef]],  # (12)
    logConfiguration: NotRequired[LogConfigurationOutputTypeDef],  # (13)
    healthCheck: NotRequired[HealthCheckOutputTypeDef],  # (14)
    systemControls: NotRequired[List[SystemControlTypeDef]],  # (15)
    resourceRequirements: NotRequired[List[ResourceRequirementTypeDef]],  # (16)
    firelensConfiguration: NotRequired[FirelensConfigurationOutputTypeDef],  # (17)
...
11. See [:material-code-braces: HostEntryTypeDef](./type_defs.md#hostentrytypedef) 
12. See [:material-code-braces: UlimitTypeDef](./type_defs.md#ulimittypedef) 
13. See [:material-code-braces: LogConfigurationOutputTypeDef](./type_defs.md#logconfigurationoutputtypedef) 
14. See [:material-code-braces: HealthCheckOutputTypeDef](./type_defs.md#healthcheckoutputtypedef) 
15. See [:material-code-braces: SystemControlTypeDef](./type_defs.md#systemcontroltypedef) 
16. See [:material-code-braces: ResourceRequirementTypeDef](./type_defs.md#resourcerequirementtypedef) 
17. See [:material-code-braces: FirelensConfigurationOutputTypeDef](./type_defs.md#firelensconfigurationoutputtypedef) 
...
1. See [:material-code-braces: ContainerOverrideTypeDef](./type_defs.md#containeroverridetypedef) [:material-code-braces: ContainerOverrideOutputTypeDef](./type_defs.md#containeroverrideoutputtypedef) 
2. See [:material-code-braces: InferenceAcceleratorOverrideTypeDef](./type_defs.md#inferenceacceleratoroverridetypedef) 
3. See [:material-code-braces: EphemeralStorageTypeDef](./type_defs.md#ephemeralstoragetypedef) 
...
1. See [:material-code-braces: ServiceConnectServiceTypeDef](./type_defs.md#serviceconnectservicetypedef) [:material-code-braces: ServiceConnectServiceOutputTypeDef](./type_defs.md#serviceconnectserviceoutputtypedef) 
2. See [:material-code-braces: LogConfigurationTypeDef](./type_defs.md#logconfigurationtypedef) [:material-code-braces: LogConfigurationOutputTypeDef](./type_defs.md#logconfigurationoutputtypedef) 
...
class ContainerDefinitionTypeDef(TypedDict):
    ...
    extraHosts: NotRequired[Sequence[HostEntryTypeDef]],  # (11)
    dockerSecurityOptions: NotRequired[Sequence[str]],
    interactive: NotRequired[bool],
    pseudoTerminal: NotRequired[bool],
    dockerLabels: NotRequired[Mapping[str, str]],
    ulimits: NotRequired[Sequence[UlimitTypeDef]],  # (12)
    logConfiguration: NotRequired[LogConfigurationUnionTypeDef],  # (13)
    healthCheck: NotRequired[HealthCheckUnionTypeDef],  # (14)
    systemControls: NotRequired[Sequence[SystemControlTypeDef]],  # (15)
    resourceRequirements: NotRequired[Sequence[ResourceRequirementTypeDef]],  # (16)
    firelensConfiguration: NotRequired[FirelensConfigurationUnionTypeDef],  # (17)
...
11. See [:material-code-braces: HostEntryTypeDef](./type_defs.md#hostentrytypedef) 
12. See [:material-code-braces: UlimitTypeDef](./type_defs.md#ulimittypedef) 
13. See [:material-code-braces: LogConfigurationTypeDef](./type_defs.md#logconfigurationtypedef) [:material-code-braces: LogConfigurationOutputTypeDef](./type_defs.md#logconfigurationoutputtypedef) 
14. See [:material-code-braces: HealthCheckTypeDef](./type_defs.md#healthchecktypedef) [:material-code-braces: HealthCheckOutputTypeDef](./type_defs.md#healthcheckoutputtypedef) 
15. See [:material-code-braces: SystemControlTypeDef](./type_defs.md#systemcontroltypedef) 
16. See [:material-code-braces: ResourceRequirementTypeDef](./type_defs.md#resourcerequirementtypedef) 
17. See [:material-code-braces: FirelensConfigurationTypeDef](./type_defs.md#firelensconfigurationtypedef) [:material-code-braces: FirelensConfigurationOutputTypeDef](./type_defs.md#firelensconfigurationoutputtypedef) 
...
class UpdateServiceRequestRequestTypeDef(TypedDict):
    ...
    volumeConfigurations: NotRequired[Sequence[ServiceVolumeConfigurationTypeDef]],  # (10)
```
...
10. See [:material-code-braces: ServiceVolumeConfigurationTypeDef](./type_defs.md#servicevolumeconfigurationtypedef) 
...
class CreateServiceRequestRequestTypeDef(TypedDict):
    ...
    volumeConfigurations: NotRequired[Sequence[ServiceVolumeConfigurationUnionTypeDef]],  # (14)
```
...
14. See [:material-code-braces: ServiceVolumeConfigurationTypeDef](./type_defs.md#servicevolumeconfigurationtypedef) [:material-code-braces: ServiceVolumeConfigurationOutputTypeDef](./type_defs.md#servicevolumeconfigurationoutputtypedef) 
