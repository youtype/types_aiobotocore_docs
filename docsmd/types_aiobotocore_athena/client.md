...
Type annotations and code completion for `#!python session.create_client("athena").get_resource_dashboard` method.
...
Type annotations and code completion for `#!python session.create_client("athena").get_session_endpoint` method.
