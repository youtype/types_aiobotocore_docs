...
Type annotations and code completion for `#!python session.create_client("mediatailor").get_paginator("list_functions")`.
...
from types_aiobotocore_mediatailor.paginator import ListFunctionsPaginator
