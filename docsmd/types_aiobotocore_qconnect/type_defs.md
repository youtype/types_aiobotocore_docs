...
6. See [:material-code-brackets: OriginType](./literals.md#origintype)
7. See [:material-code-brackets: StatusType](./literals.md#statustype)
...
5. See `List[MessageTemplateAttributeTypeType]`
6. See `List[MessageTemplateAttachmentTypeDef]`
...
2. See `List[MessageTemplateAttachmentTypeDef]`
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
