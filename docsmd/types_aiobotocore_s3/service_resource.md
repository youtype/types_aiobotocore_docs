...
- `cors_rules`: `Awaitable`[`List`[[CORSRuleBucketCorsTypeDef](./type_defs.md#corsrulebucketcorstypedef)]]
- `bucket_name`: `str`
...
- `rules`: `Awaitable`[`List`[[RuleBucketLifecycleTypeDef](./type_defs.md#rulebucketlifecycletypedef)]]
- `bucket_name`: `str`
...
- `rules`: `Awaitable`[`List`[[LifecycleRuleBucketLifecycleConfigurationTypeDef](./type_defs.md#lifecyclerulebucketlifecycleconfigurationtypedef)]]
- `bucket_name`: `str`
...
- `logging_enabled`: `Awaitable`[[LoggingEnabledResponseTypeDef](./type_defs.md#loggingenabledresponsetypedef)]
- `bucket_name`: `str`
...
- `topic_configurations`: `Awaitable`[`List`[[TopicConfigurationBucketNotificationTypeDef](./type_defs.md#topicconfigurationbucketnotificationtypedef)]]
- `queue_configurations`: `Awaitable`[`List`[[QueueConfigurationBucketNotificationTypeDef](./type_defs.md#queueconfigurationbucketnotificationtypedef)]]
- `lambda_function_configurations`: `Awaitable`[`List`[[LambdaFunctionConfigurationBucketNotificationTypeDef](./type_defs.md#lambdafunctionconfigurationbucketnotificationtypedef)]]
...
- `redirect_all_requests_to`: `Awaitable`[[RedirectAllRequestsToResponseTypeDef](./type_defs.md#redirectallrequeststoresponsetypedef)]
- `index_document`: `Awaitable`[[IndexDocumentResponseTypeDef](./type_defs.md#indexdocumentresponsetypedef)]
- `error_document`: `Awaitable`[[ErrorDocumentResponseTypeDef](./type_defs.md#errordocumentresponsetypedef)]
...
- `owner`: `Awaitable`[[OwnerTypeDef](./type_defs.md#ownertypedef)]
- `initiator`: `Awaitable`[[InitiatorResponseTypeDef](./type_defs.md#initiatorresponsetypedef)]
...
- `last_modified`: `Awaitable`[`datetime`]
- `owner`: `Awaitable`[[OwnerResponseTypeDef](./type_defs.md#ownerresponsetypedef)]
- `restore_status`: `Awaitable`[[RestoreStatusResponseTypeDef](./type_defs.md#restorestatusresponsetypedef)]
- `bucket_name`: `str`
- `object_key`: `str`
- `id`: `str`
