...
```python title="Usage Example"
from types_aiobotocore_service_quotas.type_defs import ListAWSDefaultServiceQuotasRequestListAWSDefaultServiceQuotasPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_service_quotas.type_defs import ListRequestedServiceQuotaChangeHistoryByQuotaRequestListRequestedServiceQuotaChangeHistoryByQuotaPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_service_quotas.type_defs import ListRequestedServiceQuotaChangeHistoryRequestListRequestedServiceQuotaChangeHistoryPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_service_quotas.type_defs import ListServiceQuotaIncreaseRequestsInTemplateRequestListServiceQuotaIncreaseRequestsInTemplatePaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_service_quotas.type_defs import ListServiceQuotasRequestListServiceQuotasPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_service_quotas.type_defs import ListServicesRequestListServicesPaginateTypeDef
