...
Type annotations and code completion for `#!python session.create_client("payment-cryptography").add_key_replication_regions` method.
...
await def add_key_replication_regions(
    self,
    *,
    KeyIdentifier: str,
...
Type annotations and code completion for `#!python session.create_client("payment-cryptography").associate_mpa_team` method.
...
Type annotations and code completion for `#!python session.create_client("payment-cryptography").delete_resource_policy` method.
...
Type annotations and code completion for `#!python session.create_client("payment-cryptography").disable_default_key_replication_regions` method.
...
await def disable_default_key_replication_regions(
    self,
    *,
    ReplicationRegions: Sequence[str],
...
Type annotations and code completion for `#!python session.create_client("payment-cryptography").disassociate_mpa_team` method.
...
await def disassociate_mpa_team(
    self,
    *,
    Action: MpaOperationType,  # (1)
    RequesterComment: str = ...,
...
Type annotations and code completion for `#!python session.create_client("payment-cryptography").enable_default_key_replication_regions` method.
...
await def enable_default_key_replication_regions(
    self,
    *,
    ReplicationRegions: Sequence[str],
...
Type annotations and code completion for `#!python session.create_client("payment-cryptography").get_certificate_signing_request` method.
...
await def get_certificate_signing_request(
    self,
    *,
    KeyIdentifier: str,
...
Type annotations and code completion for `#!python session.create_client("payment-cryptography").get_default_key_replication_regions` method.
...
await def get_default_key_replication_regions(
    self,
...
Type annotations and code completion for `#!python session.create_client("payment-cryptography").get_mpa_team_association` method.
...
await def get_mpa_team_association(
    self,
    *,
    Action: MpaOperationType,  # (1)
...
Type annotations and code completion for `#!python session.create_client("payment-cryptography").get_resource_policy` method.
...
Type annotations and code completion for `#!python session.create_client("payment-cryptography").put_resource_policy` method.
...
Type annotations and code completion for `#!python session.create_client("payment-cryptography").remove_key_replication_regions` method.
...
await def remove_key_replication_regions(
    self,
    *,
    KeyIdentifier: str,
    ReplicationRegions: Sequence[str],
