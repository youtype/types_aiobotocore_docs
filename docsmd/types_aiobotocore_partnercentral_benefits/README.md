...
Type annotations and code completion for  `#!python session.create_client("partnercentral-benefits")` as [PartnerCentralBenefitsClient](./client.md)
...
from `#!python session.create_client("partnercentral-benefits").get_paginator("...")`.
