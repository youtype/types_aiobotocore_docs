<a id="type-annotations-for-aiobotocore-securityhub-module"></a>

# Type annotations for aiobotocore SecurityHub module
...
- [Type annotations for aiobotocore SecurityHub module](#type-annotations-for-aiobotocore-securityhub-module)
...
Type annotations for `aiobotocore.create_client("securityhub")` as
...
```python
from types_aiobotocore_securityhub.paginators import DescribeActionTargetsPaginator, ...
```
