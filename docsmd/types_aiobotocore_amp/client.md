...
Type annotations and code completion for `#!python session.create_client("amp").create_anomaly_detector` method.
...
Type annotations and code completion for `#!python session.create_client("amp").delete_anomaly_detector` method.
...
Type annotations and code completion for `#!python session.create_client("amp").delete_scraper_logging_configuration` method.
...
await def delete_scraper_logging_configuration(
    self,
    *,
    scraperId: str,
    clientToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("amp").describe_anomaly_detector` method.
...
Type annotations and code completion for `#!python session.create_client("amp").describe_scraper_logging_configuration` method.
...
await def describe_scraper_logging_configuration(
    self,
    *,
    scraperId: str,
...
Type annotations and code completion for `#!python session.create_client("amp").list_anomaly_detectors` method.
...
Type annotations and code completion for `#!python session.create_client("amp").put_anomaly_detector` method.
...
Type annotations and code completion for `#!python session.create_client("amp").update_scraper_logging_configuration` method.
...
await def update_scraper_logging_configuration(
    self,
    *,
    scraperId: str,
