<a id="typed-dictionaries-for-aiobotocore-dynamodb-module"></a>
...
```python
from types_aiobotocore_dynamodb.type_defs import ScanInputTableTypeDef
```
...
```python
from types_aiobotocore_dynamodb.type_defs import UpdateItemInputTableTypeDef
```
...
```python
from types_aiobotocore_dynamodb.type_defs import UpdateTableInputTableTypeDef
```
