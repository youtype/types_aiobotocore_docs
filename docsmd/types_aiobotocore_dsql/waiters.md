...
1. See [:material-code-braces: GetClusterInputClusterActiveWaitTypeDef](./type_defs.md#getclusterinputclusteractivewaittypedef) 
...
1. See [:material-code-braces: GetClusterInputClusterNotExistsWaitTypeDef](./type_defs.md#getclusterinputclusternotexistswaittypedef) 
