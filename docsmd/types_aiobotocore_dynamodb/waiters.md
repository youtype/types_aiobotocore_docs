...
Type annotations and code completion for `#!python session.create_client("dynamodb").get_waiter("contributor_insights_enabled")`.
...
from types_aiobotocore_dynamodb.waiter import ContributorInsightsEnabledWaiter
...
Type annotations and code completion for `#!python session.create_client("dynamodb").get_waiter("export_completed")`.
...
from types_aiobotocore_dynamodb.waiter import ExportCompletedWaiter
...
Type annotations and code completion for `#!python session.create_client("dynamodb").get_waiter("import_completed")`.
...
from types_aiobotocore_dynamodb.waiter import ImportCompletedWaiter
...
Type annotations and code completion for `#!python session.create_client("dynamodb").get_waiter("kinesis_streaming_destination_active")`.
...
from types_aiobotocore_dynamodb.waiter import KinesisStreamingDestinationActiveWaiter
