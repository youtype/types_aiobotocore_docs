<a id="swfclient-for-aiobotocore-swf-module"></a>
...
Asynchronous method. Use `await describe_activity_type(...)` for a synchronous
call.
...
Asynchronous method. Use `await respond_activity_task_completed(...)` for a
synchronous call.
