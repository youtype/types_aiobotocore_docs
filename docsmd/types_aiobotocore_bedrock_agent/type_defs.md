...
8. See [:material-code-brackets: KnowledgeBaseStorageTypeType](./literals.md#knowledgebasestoragetypetype)
...
class FlowNodeConfigurationOutputTypeDef(TypedDict):
    ...
    prompt: NotRequired[PromptFlowNodeConfigurationOutputTypeDef],  # (7)
    retrieval: NotRequired[RetrievalFlowNodeConfigurationTypeDef],  # (8)
    storage: NotRequired[StorageFlowNodeConfigurationTypeDef],  # (9)
```
...
7. See [:material-code-braces: PromptFlowNodeConfigurationOutputTypeDef](./type_defs.md#promptflownodeconfigurationoutputtypedef)
8. See [:material-code-braces: RetrievalFlowNodeConfigurationTypeDef](./type_defs.md#retrievalflownodeconfigurationtypedef)
9. See [:material-code-braces: StorageFlowNodeConfigurationTypeDef](./type_defs.md#storageflownodeconfigurationtypedef)
...
class FlowNodeConfigurationTypeDef(TypedDict):
    ...
    prompt: NotRequired[PromptFlowNodeConfigurationTypeDef],  # (7)
    retrieval: NotRequired[RetrievalFlowNodeConfigurationTypeDef],  # (8)
    storage: NotRequired[StorageFlowNodeConfigurationTypeDef],  # (9)
```
...
5. See [:material-code-braces: LambdaFunctionFlowNodeConfigurationTypeDef](./type_defs.md#lambdafunctionflownodeconfigurationtypedef)
6. See [:material-code-braces: LexFlowNodeConfigurationTypeDef](./type_defs.md#lexflownodeconfigurationtypedef)
7. See [:material-code-braces: PromptFlowNodeConfigurationTypeDef](./type_defs.md#promptflownodeconfigurationtypedef)
8. See [:material-code-braces: RetrievalFlowNodeConfigurationTypeDef](./type_defs.md#retrievalflownodeconfigurationtypedef)
9. See [:material-code-braces: StorageFlowNodeConfigurationTypeDef](./type_defs.md#storageflownodeconfigurationtypedef)
