...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ssm-quicksetup/client/close.html)
...
kwargs: GetConfigurationInputRequestTypeDef = {  # (1)
    "ConfigurationId": ...,
}
...
1. See [:material-code-braces: GetConfigurationInputRequestTypeDef](./type_defs.md#getconfigurationinputrequesttypedef) 
...
kwargs: ListConfigurationsInputRequestTypeDef = {  # (1)
...
1. See [:material-code-braces: ListConfigurationsInputRequestTypeDef](./type_defs.md#listconfigurationsinputrequesttypedef) 
