...
Type annotations and code completion for `#!python session.create_client("appstream").associate_software_to_image_builder` method.
...
await def associate_software_to_image_builder(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("appstream").create_export_image_task` method.
...
await def create_export_image_task(
    self,
    *,
    ImageName: str,
    AmiName: str,
...
Type annotations and code completion for `#!python session.create_client("appstream").create_imported_image` method.
...
await def create_imported_image(
    self,
    *,
    Name: str,
    SourceAmiId: str,
...
Type annotations and code completion for `#!python session.create_client("appstream").describe_app_license_usage` method.
...
await def describe_app_license_usage(
    self,
    *,
    BillingPeriod: str,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("appstream").describe_software_associations` method.
...
await def describe_software_associations(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("appstream").disassociate_software_from_image_builder` method.
...
await def disassociate_software_from_image_builder(
    self,
    *,
    ImageBuilderName: str,
    SoftwareNames: Sequence[str],
...
Type annotations and code completion for `#!python session.create_client("appstream").drain_session_instance` method.
...
await def drain_session_instance(
    self,
    *,
    SessionId: str,
) -> dict[str, Any]:
...
Type annotations and code completion for `#!python session.create_client("appstream").get_export_image_task` method.
...
await def get_export_image_task(
    self,
    *,
    TaskId: str = ...,
...
Type annotations and code completion for `#!python session.create_client("appstream").list_export_image_tasks` method.
...
await def list_export_image_tasks(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("appstream").start_software_deployment_to_image_builder` method.
...
await def start_software_deployment_to_image_builder(
    self,
    *,
    ImageBuilderName: str,
