...
kwargs: ImportDiskImageRequestRequestTypeDef = {  # (1)
    "name": ...,
    "semanticVersion": ...,
    "platform": ...,
    "osVersion": ...,
...
1. See [:material-code-braces: ImportDiskImageRequestRequestTypeDef](./type_defs.md#importdiskimagerequestrequesttypedef) 
