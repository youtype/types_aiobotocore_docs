...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import AssociatePhoneNumberContactFlowRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ClaimPhoneNumberRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import DeleteTaskTemplateRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import DescribePhoneNumberRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import DisassociatePhoneNumberContactFlowRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import GetTaskTemplateRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListPhoneNumbersV2RequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListTaskTemplatesRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import PutUserStatusRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ReleasePhoneNumberRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ResumeContactRecordingRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import SearchAvailablePhoneNumbersRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import SearchVocabulariesRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import StopContactRecordingRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import StopContactRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import StopContactStreamingRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import SuspendContactRecordingRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import TagResourceRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import TransferContactRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UntagResourceRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateAgentStatusRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateContactAttributesRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateContactFlowContentRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateContactFlowMetadataRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateContactFlowModuleContentRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateContactFlowModuleMetadataRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateContactFlowNameRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateContactScheduleRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateInstanceAttributeRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdatePhoneNumberRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateQueueHoursOfOperationRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateQueueMaxContactsRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateQueueNameRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateQueueStatusRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateQuickConnectNameRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateRoutingProfileDefaultOutboundQueueRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateRoutingProfileNameRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateSecurityProfileRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateUserHierarchyGroupNameRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateUserHierarchyRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateUserRoutingProfileRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateUserSecurityProfilesRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import StartOutboundVoiceContactRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import StartContactStreamingRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateQueueOutboundCallerConfigRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateRoutingProfileConcurrencyRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateUserIdentityInfoRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateUserPhoneConfigRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListAgentStatusRequestListAgentStatusesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListApprovedOriginsRequestListApprovedOriginsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListBotsRequestListBotsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListContactFlowModulesRequestListContactFlowModulesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListContactFlowsRequestListContactFlowsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListContactReferencesRequestListContactReferencesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListDefaultVocabulariesRequestListDefaultVocabulariesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListHoursOfOperationsRequestListHoursOfOperationsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListInstanceAttributesRequestListInstanceAttributesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListInstanceStorageConfigsRequestListInstanceStorageConfigsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListInstancesRequestListInstancesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListIntegrationAssociationsRequestListIntegrationAssociationsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListLambdaFunctionsRequestListLambdaFunctionsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListLexBotsRequestListLexBotsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListPhoneNumbersRequestListPhoneNumbersPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListPhoneNumbersV2RequestListPhoneNumbersV2PaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListPromptsRequestListPromptsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListQueueQuickConnectsRequestListQueueQuickConnectsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListQueuesRequestListQueuesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListQuickConnectsRequestListQuickConnectsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListRoutingProfileQueuesRequestListRoutingProfileQueuesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListRoutingProfilesRequestListRoutingProfilesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListSecurityKeysRequestListSecurityKeysPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListSecurityProfilePermissionsRequestListSecurityProfilePermissionsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListSecurityProfilesRequestListSecurityProfilesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListTaskTemplatesRequestListTaskTemplatesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListUseCasesRequestListUseCasesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListUserHierarchyGroupsRequestListUserHierarchyGroupsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import ListUsersRequestListUsersPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import SearchAvailablePhoneNumbersRequestSearchAvailablePhoneNumbersPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import SearchVocabulariesRequestSearchVocabulariesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import StartChatContactRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import StartTaskContactRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateContactRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import StartContactRecordingRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import GetCurrentUserDataRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateRoutingProfileQueuesRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateUserHierarchyStructureRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import GetMetricDataRequestGetMetricDataPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateHoursOfOperationRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateQuickConnectConfigRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import SearchSecurityProfilesRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import SearchSecurityProfilesRequestSearchSecurityProfilesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import SearchUsersRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import SearchUsersRequestSearchUsersPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateInstanceStorageConfigRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import CreateTaskTemplateRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_connect.type_defs import UpdateTaskTemplateRequestRequestTypeDef
