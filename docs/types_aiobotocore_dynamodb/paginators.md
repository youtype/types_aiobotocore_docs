...
`AsyncIterator`\[[ListBackupsOutputTypeDef](./type_defs.md#listbackupsoutputtypedef)\].
...
`AsyncIterator`\[[ListTablesOutputTypeDef](./type_defs.md#listtablesoutputtypedef)\].
...
`AsyncIterator`\[[ListTagsOfResourceOutputTypeDef](./type_defs.md#listtagsofresourceoutputtypedef)\].
...
`AsyncIterator`\[[QueryOutputTypeDef](./type_defs.md#queryoutputtypedef)\].
...
`AsyncIterator`\[[ScanOutputTypeDef](./type_defs.md#scanoutputtypedef)\].
