...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").copy_blueprint_stage` method.
...
await def copy_blueprint_stage(
    self,
    *,
    blueprintArn: str,
...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").create_data_automation_library` method.
...
await def create_data_automation_library(
    self,
    *,
    libraryName: str,
...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").delete_data_automation_library` method.
...
await def delete_data_automation_library(
    self,
    *,
    libraryArn: str,
...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").get_blueprint_optimization_status` method.
...
await def get_blueprint_optimization_status(
    self,
    *,
    invocationArn: str,
...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").get_data_automation_library` method.
...
await def get_data_automation_library(
    self,
    *,
    libraryArn: str,
...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").get_data_automation_library_entity` method.
...
await def get_data_automation_library_entity(
    self,
    *,
    libraryArn: str,
...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").get_data_automation_library_ingestion_job` method.
...
await def get_data_automation_library_ingestion_job(
    self,
    *,
    libraryArn: str,
    jobArn: str,
...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").invoke_blueprint_optimization_async` method.
...
await def invoke_blueprint_optimization_async(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").invoke_data_automation_library_ingestion_job` method.
...
await def invoke_data_automation_library_ingestion_job(
    self,
    *,
    libraryArn: str,
...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").list_data_automation_libraries` method.
...
await def list_data_automation_libraries(
    self,
    *,
    maxResults: int = ...,
    nextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").list_data_automation_library_entities` method.
...
await def list_data_automation_library_entities(
    self,
    *,
    libraryArn: str,
    entityType: EntityTypeType,  # (1)
...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").list_data_automation_library_ingestion_jobs` method.
...
await def list_data_automation_library_ingestion_jobs(
    self,
    *,
    libraryArn: str,
    maxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").untag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("bedrock-data-automation").update_data_automation_library` method.
...
await def update_data_automation_library(
    self,
    *,
    libraryArn: str,
    libraryDescription: str = ...,
