...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/application-signals.html#CloudWatchApplicationSignals.Paginator.ListServiceDependencies)
...
) -> AsyncIterator[ListServiceDependenciesOutputTypeDef]:  # (2)
    ...
```
...
kwargs: ListServiceDependenciesInputListServiceDependenciesPaginateTypeDef = {  # (1)
    "StartTime": ...,
    "EndTime": ...,
    "KeyAttributes": ...,
}
...
1. See [:material-code-braces: ListServiceDependenciesInputListServiceDependenciesPaginateTypeDef](./type_defs.md#listservicedependenciesinputlistservicedependenciespaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/application-signals.html#CloudWatchApplicationSignals.Paginator.ListServiceDependents)
...
def paginate(
    ...
    *,
    ...
    KeyAttributes: Mapping[str, str],
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListServiceDependentsOutputTypeDef]:  # (2)
    ...
```
...
kwargs: ListServiceDependentsInputListServiceDependentsPaginateTypeDef = {  # (1)
    "StartTime": ...,
    "EndTime": ...,
    "KeyAttributes": ...,
}
...
1. See [:material-code-braces: ListServiceDependentsInputListServiceDependentsPaginateTypeDef](./type_defs.md#listservicedependentsinputlistservicedependentspaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/application-signals.html#CloudWatchApplicationSignals.Paginator.ListServiceLevelObjectives)
...
def paginate(
    ...
    *,
    ...
    OperationName: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListServiceLevelObjectivesOutputTypeDef]:  # (2)
    ...
```
...
kwargs: ListServiceLevelObjectivesInputListServiceLevelObjectivesPaginateTypeDef = {  # (1)
    "KeyAttributes": ...,
}
...
1. See [:material-code-braces: ListServiceLevelObjectivesInputListServiceLevelObjectivesPaginateTypeDef](./type_defs.md#listservicelevelobjectivesinputlistservicelevelobjectivespaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/application-signals.html#CloudWatchApplicationSignals.Paginator.ListServiceOperations)
...
def paginate(
    ...
    *,
    ...
    KeyAttributes: Mapping[str, str],
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListServiceOperationsOutputTypeDef]:  # (2)
    ...
```
...
kwargs: ListServiceOperationsInputListServiceOperationsPaginateTypeDef = {  # (1)
    "StartTime": ...,
    "EndTime": ...,
    "KeyAttributes": ...,
}
...
1. See [:material-code-braces: ListServiceOperationsInputListServiceOperationsPaginateTypeDef](./type_defs.md#listserviceoperationsinputlistserviceoperationspaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/application-signals.html#CloudWatchApplicationSignals.Paginator.ListServices)
