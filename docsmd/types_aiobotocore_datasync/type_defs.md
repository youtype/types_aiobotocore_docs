...
```python title="Usage Example"
from types_aiobotocore_datasync.type_defs import ListAgentsRequestListAgentsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_datasync.type_defs import ListTagsForResourceRequestListTagsForResourcePaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_datasync.type_defs import ListTaskExecutionsRequestListTaskExecutionsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_datasync.type_defs import ListLocationsRequestListLocationsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_datasync.type_defs import ListTasksRequestListTasksPaginateTypeDef
