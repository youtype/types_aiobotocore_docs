...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/license-manager-linux-subscriptions.html#LicenseManagerLinuxSubscriptions.Paginator.ListRegisteredSubscriptionProviders)
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListRegisteredSubscriptionProvidersResponseTypeDef]:  # (3)
    ...
```
...
1. See [:material-code-braces: ListRegisteredSubscriptionProvidersRequestListRegisteredSubscriptionProvidersPaginateTypeDef](./type_defs.md#listregisteredsubscriptionprovidersrequestlistregisteredsubscriptionproviderspaginatetypedef) 
