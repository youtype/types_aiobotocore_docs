...
```python
# ListDevEnvironmentSessionsRequestListDevEnvironmentSessionsPaginateTypeDef definition

class ListDevEnvironmentSessionsRequestListDevEnvironmentSessionsPaginateTypeDef(TypedDict):
    spaceName: str,
    projectName: str,
    devEnvironmentId: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
...
```python
# ListWorkflowRunsRequestListWorkflowRunsPaginateTypeDef definition

class ListWorkflowRunsRequestListWorkflowRunsPaginateTypeDef(TypedDict):
    spaceName: str,
    projectName: str,
    workflowId: NotRequired[str],
    sortBy: NotRequired[Sequence[Mapping[str, Any]]],
