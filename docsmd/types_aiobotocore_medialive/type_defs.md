...
1. See [:material-code-braces: H264ColorSpaceSettingsTypeDef](./type_defs.md#h264colorspacesettingstypedef) 
2. See [:material-code-braces: H264ColorSpaceSettingsOutputTypeDef](./type_defs.md#h264colorspacesettingsoutputtypedef) 
...
1. See [:material-code-braces: MotionGraphicsSettingsTypeDef](./type_defs.md#motiongraphicssettingstypedef) 
...
1. See [:material-code-braces: RtmpGroupSettingsTypeDef](./type_defs.md#rtmpgroupsettingstypedef) 
2. See [:material-code-braces: RtmpGroupSettingsOutputTypeDef](./type_defs.md#rtmpgroupsettingsoutputtypedef) 
...
2. See [:material-code-braces: AudioChannelMappingOutputTypeDef](./type_defs.md#audiochannelmappingoutputtypedef) 
...
1. See [:material-code-braces: AudioCodecSettingsTypeDef](./type_defs.md#audiocodecsettingstypedef) 
2. See [:material-code-braces: AudioCodecSettingsOutputTypeDef](./type_defs.md#audiocodecsettingsoutputtypedef) 
...
1. See [:material-code-braces: Av1ColorSpaceSettingsTypeDef](./type_defs.md#av1colorspacesettingstypedef) 
...
1. See [:material-code-braces: H265ColorSpaceSettingsTypeDef](./type_defs.md#h265colorspacesettingstypedef) 
2. See [:material-code-braces: H265ColorSpaceSettingsOutputTypeDef](./type_defs.md#h265colorspacesettingsoutputtypedef) 
...
1. See [:material-code-braces: ColorCorrectionSettingsTypeDef](./type_defs.md#colorcorrectionsettingstypedef) 
2. See [:material-code-braces: ColorCorrectionSettingsOutputTypeDef](./type_defs.md#colorcorrectionsettingsoutputtypedef) 
...
1. See [:material-code-braces: OutputLockingSettingsTypeDef](./type_defs.md#outputlockingsettingstypedef) 
2. See [:material-code-braces: OutputLockingSettingsOutputTypeDef](./type_defs.md#outputlockingsettingsoutputtypedef) 
...
2. See [:material-code-braces: ArchiveContainerSettingsOutputTypeDef](./type_defs.md#archivecontainersettingsoutputtypedef) 
...
1. See [:material-code-braces: H264SettingsTypeDef](./type_defs.md#h264settingstypedef) 
...
1. See [:material-code-braces: MotionGraphicsConfigurationTypeDef](./type_defs.md#motiongraphicsconfigurationtypedef) 
2. See [:material-code-braces: MotionGraphicsConfigurationOutputTypeDef](./type_defs.md#motiongraphicsconfigurationoutputtypedef) 
...
1. See [:material-code-braces: RemixSettingsTypeDef](./type_defs.md#remixsettingstypedef) 
2. See [:material-code-braces: RemixSettingsOutputTypeDef](./type_defs.md#remixsettingsoutputtypedef) 
...
1. See [:material-code-braces: HlsGroupSettingsTypeDef](./type_defs.md#hlsgroupsettingstypedef) 
2. See [:material-code-braces: HlsGroupSettingsOutputTypeDef](./type_defs.md#hlsgroupsettingsoutputtypedef) 
...
2. See [:material-code-braces: Av1SettingsOutputTypeDef](./type_defs.md#av1settingsoutputtypedef) 
...
1. See [:material-code-braces: H265SettingsTypeDef](./type_defs.md#h265settingstypedef) 
2. See [:material-code-braces: H265SettingsOutputTypeDef](./type_defs.md#h265settingsoutputtypedef) 
...
1. See [:material-code-braces: GlobalConfigurationTypeDef](./type_defs.md#globalconfigurationtypedef) 
2. See [:material-code-braces: GlobalConfigurationOutputTypeDef](./type_defs.md#globalconfigurationoutputtypedef) 
...
1. See [:material-code-braces: CaptionDescriptionTypeDef](./type_defs.md#captiondescriptiontypedef) 
2. See [:material-code-braces: CaptionDescriptionOutputTypeDef](./type_defs.md#captiondescriptionoutputtypedef) 
...
2. See [:material-code-braces: ArchiveOutputSettingsOutputTypeDef](./type_defs.md#archiveoutputsettingsoutputtypedef) 
...
1. See [:material-code-braces: HlsOutputSettingsTypeDef](./type_defs.md#hlsoutputsettingstypedef) 
2. See [:material-code-braces: HlsOutputSettingsOutputTypeDef](./type_defs.md#hlsoutputsettingsoutputtypedef) 
...
2. See [:material-code-braces: AudioDescriptionOutputTypeDef](./type_defs.md#audiodescriptionoutputtypedef) 
...
2. See [:material-code-braces: VideoCodecSettingsOutputTypeDef](./type_defs.md#videocodecsettingsoutputtypedef) 
...
2. See [:material-code-braces: OutputSettingsOutputTypeDef](./type_defs.md#outputsettingsoutputtypedef) 
...
1. See [:material-code-braces: VideoDescriptionTypeDef](./type_defs.md#videodescriptiontypedef) 
2. See [:material-code-braces: VideoDescriptionOutputTypeDef](./type_defs.md#videodescriptionoutputtypedef) 
...
1. See [:material-code-braces: OutputGroupTypeDef](./type_defs.md#outputgrouptypedef) 
2. See [:material-code-braces: OutputGroupOutputTypeDef](./type_defs.md#outputgroupoutputtypedef) 
...
```python
# DescribeChannelPlacementGroupRequestChannelPlacementGroupAssignedWaitTypeDef definition
...
```python
# DescribeChannelPlacementGroupRequestChannelPlacementGroupDeletedWaitTypeDef definition
...
```python
# DescribeChannelPlacementGroupRequestChannelPlacementGroupUnassignedWaitTypeDef definition
...
```python
# DescribeNodeRequestNodeDeregisteredWaitTypeDef definition
...
```python
# DescribeNodeRequestNodeRegisteredWaitTypeDef definition
...
```python
# GetSignalMapRequestSignalMapCreatedWaitTypeDef definition
...
```python
# GetSignalMapRequestSignalMapMonitorDeletedWaitTypeDef definition
...
```python
# GetSignalMapRequestSignalMapMonitorDeployedWaitTypeDef definition
...
```python
# GetSignalMapRequestSignalMapUpdatedWaitTypeDef definition
...
```python
# ListChannelPlacementGroupsRequestListChannelPlacementGroupsPaginateTypeDef definition
...
```python
# ListCloudWatchAlarmTemplateGroupsRequestListCloudWatchAlarmTemplateGroupsPaginateTypeDef definition

class ListCloudWatchAlarmTemplateGroupsRequestListCloudWatchAlarmTemplateGroupsPaginateTypeDef(TypedDict):
    Scope: NotRequired[str],
    SignalMapIdentifier: NotRequired[str],
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListCloudWatchAlarmTemplatesRequestListCloudWatchAlarmTemplatesPaginateTypeDef definition
...
```python
# ListEventBridgeRuleTemplateGroupsRequestListEventBridgeRuleTemplateGroupsPaginateTypeDef definition

class ListEventBridgeRuleTemplateGroupsRequestListEventBridgeRuleTemplateGroupsPaginateTypeDef(TypedDict):
    SignalMapIdentifier: NotRequired[str],
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListEventBridgeRuleTemplatesRequestListEventBridgeRuleTemplatesPaginateTypeDef definition
...
```python
# ListSignalMapsRequestListSignalMapsPaginateTypeDef definition
...
2. See [:material-code-brackets: AfdSignalingType](./literals.md#afdsignalingtype) 
3. See [:material-code-brackets: H264ColorMetadataType](./literals.md#h264colormetadatatype) 
4. See [:material-code-braces: H264ColorSpaceSettingsTypeDef](./type_defs.md#h264colorspacesettingstypedef) [:material-code-braces: H264ColorSpaceSettingsOutputTypeDef](./type_defs.md#h264colorspacesettingsoutputtypedef) 
5. See [:material-code-brackets: H264EntropyEncodingType](./literals.md#h264entropyencodingtype) 
6. See [:material-code-braces: H264FilterSettingsTypeDef](./type_defs.md#h264filtersettingstypedef) 
7. See [:material-code-brackets: FixedAfdType](./literals.md#fixedafdtype) 
8. See [:material-code-brackets: H264FlickerAqType](./literals.md#h264flickeraqtype) 
...
1. See [:material-code-brackets: MotionGraphicsInsertionType](./literals.md#motiongraphicsinsertiontype) 
2. See [:material-code-braces: MotionGraphicsSettingsTypeDef](./type_defs.md#motiongraphicssettingstypedef) [:material-code-braces: MotionGraphicsSettingsOutputTypeDef](./type_defs.md#motiongraphicssettingsoutputtypedef) 
...
1. See [:material-code-braces: AudioChannelMappingTypeDef](./type_defs.md#audiochannelmappingtypedef) [:material-code-braces: AudioChannelMappingOutputTypeDef](./type_defs.md#audiochannelmappingoutputtypedef) 
...
1. See [:material-code-brackets: AfdSignalingType](./literals.md#afdsignalingtype) 
2. See [:material-code-braces: Av1ColorSpaceSettingsTypeDef](./type_defs.md#av1colorspacesettingstypedef) [:material-code-braces: Av1ColorSpaceSettingsOutputTypeDef](./type_defs.md#av1colorspacesettingsoutputtypedef) 
3. See [:material-code-brackets: FixedAfdType](./literals.md#fixedafdtype) 
4. See [:material-code-brackets: Av1GopSizeUnitsType](./literals.md#av1gopsizeunitstype) 
5. See [:material-code-brackets: Av1LevelType](./literals.md#av1leveltype) 
6. See [:material-code-brackets: Av1LookAheadRateControlType](./literals.md#av1lookaheadratecontroltype) 
...
3. See [:material-code-brackets: H265AlternativeTransferFunctionType](./literals.md#h265alternativetransferfunctiontype) 
4. See [:material-code-brackets: H265ColorMetadataType](./literals.md#h265colormetadatatype) 
5. See [:material-code-braces: H265ColorSpaceSettingsTypeDef](./type_defs.md#h265colorspacesettingstypedef) [:material-code-braces: H265ColorSpaceSettingsOutputTypeDef](./type_defs.md#h265colorspacesettingsoutputtypedef) 
6. See [:material-code-braces: H265FilterSettingsTypeDef](./type_defs.md#h265filtersettingstypedef) 
7. See [:material-code-brackets: FixedAfdType](./literals.md#fixedafdtype) 
8. See [:material-code-brackets: H265FlickerAqType](./literals.md#h265flickeraqtype) 
9. See [:material-code-brackets: H265GopSizeUnitsType](./literals.md#h265gopsizeunitstype) 
...
4. See [:material-code-brackets: GlobalConfigurationOutputTimingSourceType](./literals.md#globalconfigurationoutputtimingsourcetype) 
5. See [:material-code-brackets: GlobalConfigurationLowFramerateInputsType](./literals.md#globalconfigurationlowframerateinputstype) 
6. See [:material-code-braces: OutputLockingSettingsTypeDef](./type_defs.md#outputlockingsettingstypedef) [:material-code-braces: OutputLockingSettingsOutputTypeDef](./type_defs.md#outputlockingsettingsoutputtypedef) 
...
1. See [:material-code-brackets: AccessibilityTypeType](./literals.md#accessibilitytypetype) 
2. See [:material-code-braces: CaptionDestinationSettingsTypeDef](./type_defs.md#captiondestinationsettingstypedef) [:material-code-braces: CaptionDestinationSettingsOutputTypeDef](./type_defs.md#captiondestinationsettingsoutputtypedef) 
3. See [:material-code-brackets: DashRoleCaptionType](./literals.md#dashrolecaptiontype) 
4. See [:material-code-brackets: DvbDashAccessibilityType](./literals.md#dvbdashaccessibilitytype) 
...
1. See [:material-code-braces: ArchiveContainerSettingsTypeDef](./type_defs.md#archivecontainersettingstypedef) [:material-code-braces: ArchiveContainerSettingsOutputTypeDef](./type_defs.md#archivecontainersettingsoutputtypedef) 
...
1. See [:material-code-brackets: HlsH265PackagingTypeType](./literals.md#hlsh265packagingtypetype) 
2. See [:material-code-braces: HlsSettingsTypeDef](./type_defs.md#hlssettingstypedef) [:material-code-braces: HlsSettingsOutputTypeDef](./type_defs.md#hlssettingsoutputtypedef) 
...
3. See [:material-code-brackets: AudioDescriptionAudioTypeControlType](./literals.md#audiodescriptionaudiotypecontroltype) 
4. See [:material-code-braces: AudioWatermarkSettingsTypeDef](./type_defs.md#audiowatermarksettingstypedef) 
5. See [:material-code-braces: AudioCodecSettingsTypeDef](./type_defs.md#audiocodecsettingstypedef) [:material-code-braces: AudioCodecSettingsOutputTypeDef](./type_defs.md#audiocodecsettingsoutputtypedef) 
6. See [:material-code-brackets: AudioDescriptionLanguageCodeControlType](./literals.md#audiodescriptionlanguagecodecontroltype) 
7. See [:material-code-braces: RemixSettingsTypeDef](./type_defs.md#remixsettingstypedef) [:material-code-braces: RemixSettingsOutputTypeDef](./type_defs.md#remixsettingsoutputtypedef) 
8. See [:material-code-brackets: DashRoleAudioType](./literals.md#dashroleaudiotype) 
9. See [:material-code-brackets: DvbDashAccessibilityType](./literals.md#dvbdashaccessibilitytype) 
...
1. See [:material-code-braces: ArchiveGroupSettingsTypeDef](./type_defs.md#archivegroupsettingstypedef) 
2. See [:material-code-braces: FrameCaptureGroupSettingsTypeDef](./type_defs.md#framecapturegroupsettingstypedef) 
3. See [:material-code-braces: HlsGroupSettingsTypeDef](./type_defs.md#hlsgroupsettingstypedef) [:material-code-braces: HlsGroupSettingsOutputTypeDef](./type_defs.md#hlsgroupsettingsoutputtypedef) 
4. See [:material-code-braces: MediaPackageGroupSettingsTypeDef](./type_defs.md#mediapackagegroupsettingstypedef) 
5. See [:material-code-braces: MsSmoothGroupSettingsTypeDef](./type_defs.md#mssmoothgroupsettingstypedef) 
6. See [:material-code-braces: RtmpGroupSettingsTypeDef](./type_defs.md#rtmpgroupsettingstypedef) [:material-code-braces: RtmpGroupSettingsOutputTypeDef](./type_defs.md#rtmpgroupsettingsoutputtypedef) 
7. See [:material-code-braces: UdpGroupSettingsTypeDef](./type_defs.md#udpgroupsettingstypedef) 
8. See [:material-code-braces: CmafIngestGroupSettingsTypeDef](./type_defs.md#cmafingestgroupsettingstypedef) 
9. See [:material-code-braces: SrtGroupSettingsTypeDef](./type_defs.md#srtgroupsettingstypedef) 
...
1. See [:material-code-braces: FrameCaptureSettingsTypeDef](./type_defs.md#framecapturesettingstypedef) 
2. See [:material-code-braces: H264SettingsTypeDef](./type_defs.md#h264settingstypedef) [:material-code-braces: H264SettingsOutputTypeDef](./type_defs.md#h264settingsoutputtypedef) 
3. See [:material-code-braces: H265SettingsTypeDef](./type_defs.md#h265settingstypedef) [:material-code-braces: H265SettingsOutputTypeDef](./type_defs.md#h265settingsoutputtypedef) 
4. See [:material-code-braces: Mpeg2SettingsTypeDef](./type_defs.md#mpeg2settingstypedef) 
5. See [:material-code-braces: Av1SettingsTypeDef](./type_defs.md#av1settingstypedef) [:material-code-braces: Av1SettingsOutputTypeDef](./type_defs.md#av1settingsoutputtypedef) 
...
1. See [:material-code-braces: ArchiveOutputSettingsTypeDef](./type_defs.md#archiveoutputsettingstypedef) [:material-code-braces: ArchiveOutputSettingsOutputTypeDef](./type_defs.md#archiveoutputsettingsoutputtypedef) 
2. See [:material-code-braces: FrameCaptureOutputSettingsTypeDef](./type_defs.md#framecaptureoutputsettingstypedef) 
3. See [:material-code-braces: HlsOutputSettingsTypeDef](./type_defs.md#hlsoutputsettingstypedef) [:material-code-braces: HlsOutputSettingsOutputTypeDef](./type_defs.md#hlsoutputsettingsoutputtypedef) 
4. See [:material-code-braces: MsSmoothOutputSettingsTypeDef](./type_defs.md#mssmoothoutputsettingstypedef) 
5. See [:material-code-braces: MultiplexOutputSettingsTypeDef](./type_defs.md#multiplexoutputsettingstypedef) 
6. See [:material-code-braces: RtmpOutputSettingsTypeDef](./type_defs.md#rtmpoutputsettingstypedef) 
7. See [:material-code-braces: UdpOutputSettingsTypeDef](./type_defs.md#udpoutputsettingstypedef) 
...
1. See [:material-code-braces: VideoCodecSettingsTypeDef](./type_defs.md#videocodecsettingstypedef) [:material-code-braces: VideoCodecSettingsOutputTypeDef](./type_defs.md#videocodecsettingsoutputtypedef) 
2. See [:material-code-brackets: VideoDescriptionRespondToAfdType](./literals.md#videodescriptionrespondtoafdtype) 
3. See [:material-code-brackets: VideoDescriptionScalingBehaviorType](./literals.md#videodescriptionscalingbehaviortype) 
...
1. See [:material-code-braces: OutputSettingsTypeDef](./type_defs.md#outputsettingstypedef) [:material-code-braces: OutputSettingsOutputTypeDef](./type_defs.md#outputsettingsoutputtypedef) 
...
1. See [:material-code-braces: OutputGroupSettingsTypeDef](./type_defs.md#outputgroupsettingstypedef) [:material-code-braces: OutputGroupSettingsOutputTypeDef](./type_defs.md#outputgroupsettingsoutputtypedef) 
2. See [:material-code-braces: OutputTypeDef](./type_defs.md#outputtypedef) [:material-code-braces: ExtraOutputTypeDef](./type_defs.md#extraoutputtypedef) 
...
1. See [:material-code-braces: AudioDescriptionTypeDef](./type_defs.md#audiodescriptiontypedef) [:material-code-braces: AudioDescriptionOutputTypeDef](./type_defs.md#audiodescriptionoutputtypedef) 
2. See [:material-code-braces: AvailBlankingTypeDef](./type_defs.md#availblankingtypedef) 
3. See [:material-code-braces: AvailConfigurationTypeDef](./type_defs.md#availconfigurationtypedef) 
4. See [:material-code-braces: BlackoutSlateTypeDef](./type_defs.md#blackoutslatetypedef) 
5. See [:material-code-braces: CaptionDescriptionTypeDef](./type_defs.md#captiondescriptiontypedef) [:material-code-braces: CaptionDescriptionOutputTypeDef](./type_defs.md#captiondescriptionoutputtypedef) 
6. See [:material-code-braces: FeatureActivationsTypeDef](./type_defs.md#featureactivationstypedef) 
7. See [:material-code-braces: GlobalConfigurationTypeDef](./type_defs.md#globalconfigurationtypedef) [:material-code-braces: GlobalConfigurationOutputTypeDef](./type_defs.md#globalconfigurationoutputtypedef) 
8. See [:material-code-braces: MotionGraphicsConfigurationTypeDef](./type_defs.md#motiongraphicsconfigurationtypedef) [:material-code-braces: MotionGraphicsConfigurationOutputTypeDef](./type_defs.md#motiongraphicsconfigurationoutputtypedef) 
9. See [:material-code-braces: NielsenConfigurationTypeDef](./type_defs.md#nielsenconfigurationtypedef) 
10. See [:material-code-braces: OutputGroupTypeDef](./type_defs.md#outputgrouptypedef) [:material-code-braces: OutputGroupOutputTypeDef](./type_defs.md#outputgroupoutputtypedef) 
11. See [:material-code-braces: TimecodeConfigTypeDef](./type_defs.md#timecodeconfigtypedef) 
12. See [:material-code-braces: VideoDescriptionTypeDef](./type_defs.md#videodescriptiontypedef) [:material-code-braces: VideoDescriptionOutputTypeDef](./type_defs.md#videodescriptionoutputtypedef) 
13. See [:material-code-braces: ThumbnailConfigurationTypeDef](./type_defs.md#thumbnailconfigurationtypedef) 
14. See [:material-code-braces: ColorCorrectionSettingsTypeDef](./type_defs.md#colorcorrectionsettingstypedef) [:material-code-braces: ColorCorrectionSettingsOutputTypeDef](./type_defs.md#colorcorrectionsettingsoutputtypedef) 
