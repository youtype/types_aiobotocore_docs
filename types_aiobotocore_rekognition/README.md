<a id="type-annotations-for-aiobotocore-rekognition-module"></a>

# Type annotations for aiobotocore Rekognition module
...
- [Type annotations for aiobotocore Rekognition module](#type-annotations-for-aiobotocore-rekognition-module)
...
Type annotations for `aiobotocore.create_client("rekognition")` as
...
```python
from types_aiobotocore_rekognition.paginators import DescribeProjectVersionsPaginator, ...
```
...
```python
from types_aiobotocore_rekognition.waiters import ProjectVersionRunningWaiter, ...
```
