...
1. See [:material-code-braces: DateTimeConverterTypeDef](./type_defs.md#datetimeconvertertypedef)
...
1. See [:material-code-braces: UpperCaseStringTypeDef](./type_defs.md#uppercasestringtypedef)
...
1. See [:material-code-braces: SplitStringTypeDef](./type_defs.md#splitstringtypedef)
...
```python
# GroupingIdentifierTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import GroupingIdentifierTypeDef


def get_value() -> GroupingIdentifierTypeDef:
    return {
        "key": ...,
    }


# GroupingIdentifierTypeDef definition
...
from types_aiobotocore_logs.type_defs import DataSourceTypeDef
...
from types_aiobotocore_logs.type_defs import CancelImportTaskRequestTypeDef
...
from types_aiobotocore_logs.type_defs import ImportStatisticsTypeDef
...
```python
# DeliverySourceConfigurationSchemaTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import DeliverySourceConfigurationSchemaTypeDef


def get_value() -> DeliverySourceConfigurationSchemaTypeDef:
    return {
        "keyName": ...,
    }


# DeliverySourceConfigurationSchemaTypeDef definition

class DeliverySourceConfigurationSchemaTypeDef(TypedDict):
    keyName: str,
    valueType: DeliverySourceConfigurationSchemaValueTypeType,  # (1)
    defaultValue: str,
...
1. See [:material-code-brackets: DeliverySourceConfigurationSchemaValueTypeType](./literals.md#deliverysourceconfigurationschemavaluetypetype)
...
```python
# S3TablesIntegrationTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import S3TablesIntegrationTypeDef


def get_value() -> S3TablesIntegrationTypeDef:
    return {
        "datasourceName": ...,
    }


# S3TablesIntegrationTypeDef definition
...
from types_aiobotocore_logs.type_defs import ImportFilterTypeDef
...
```python
# CreateLookupTableRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import CreateLookupTableRequestTypeDef


def get_value() -> CreateLookupTableRequestTypeDef:
    return {
        "lookupTableName": ...,
    }


# CreateLookupTableRequestTypeDef definition
...
```python
# DataSourceFilterTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import DataSourceFilterTypeDef


def get_value() -> DataSourceFilterTypeDef:
    return {
        "name": ...,
    }


# DataSourceFilterTypeDef definition

class DataSourceFilterTypeDef(TypedDict):
    name: str,
    type: NotRequired[str],
```
...
```python
# DeleteLookupTableRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import DeleteLookupTableRequestTypeDef


def get_value() -> DeleteLookupTableRequestTypeDef:
    return {
        "lookupTableArn": ...,
    }


# DeleteLookupTableRequestTypeDef definition
...
from types_aiobotocore_logs.type_defs import DeleteScheduledQueryRequestTypeDef
...
class DeliverySourceTypeDef(TypedDict):
    ...
    status: NotRequired[DeliverySourceStatusType],  # (1)
    statusReason: NotRequired[DeliverySourceStatusReasonType],  # (2)
```

1. See [:material-code-brackets: DeliverySourceStatusType](./literals.md#deliverysourcestatustype)
2. See [:material-code-brackets: DeliverySourceStatusReasonType](./literals.md#deliverysourcestatusreasontype)
...
```python
# DescribeImportTaskBatchesRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import DescribeImportTaskBatchesRequestTypeDef


def get_value() -> DescribeImportTaskBatchesRequestTypeDef:
    return {
        "importId": ...,
    }


# DescribeImportTaskBatchesRequestTypeDef definition

class DescribeImportTaskBatchesRequestTypeDef(TypedDict):
    importId: str,
    batchImportStatus: NotRequired[Sequence[ImportStatusType]],  # (1)
    limit: NotRequired[int],
    nextToken: NotRequired[str],
```
...
```python
# ImportBatchTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import ImportBatchTypeDef


def get_value() -> ImportBatchTypeDef:
    return {
        "batchId": ...,
    }


# ImportBatchTypeDef definition

class ImportBatchTypeDef(TypedDict):
    batchId: str,
    status: ImportStatusType,  # (1)
...
from types_aiobotocore_logs.type_defs import DescribeImportTasksRequestTypeDef
...
```python
# DescribeLookupTablesRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import DescribeLookupTablesRequestTypeDef


def get_value() -> DescribeLookupTablesRequestTypeDef:
    return {
        "lookupTableNamePrefix": ...,
    }


# DescribeLookupTablesRequestTypeDef definition
...
```python
# LookupTableTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import LookupTableTypeDef


def get_value() -> LookupTableTypeDef:
    return {
        "lookupTableArn": ...,
    }


# LookupTableTypeDef definition
...
from types_aiobotocore_logs.type_defs import S3ConfigurationTypeDef
...
```python
# DisassociateSourceFromS3TableIntegrationRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import DisassociateSourceFromS3TableIntegrationRequestTypeDef


def get_value() -> DisassociateSourceFromS3TableIntegrationRequestTypeDef:
    return {
        "identifier": ...,
    }


# DisassociateSourceFromS3TableIntegrationRequestTypeDef definition
...
```python
# GetLogFieldsRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import GetLogFieldsRequestTypeDef


def get_value() -> GetLogFieldsRequestTypeDef:
    return {
        "dataSourceName": ...,
    }


# GetLogFieldsRequestTypeDef definition
...
```python
# GetLookupTableRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import GetLookupTableRequestTypeDef


def get_value() -> GetLookupTableRequestTypeDef:
    return {
        "lookupTableArn": ...,
    }


# GetLookupTableRequestTypeDef definition
...
```python
# GetScheduledQueryHistoryRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import GetScheduledQueryHistoryRequestTypeDef


def get_value() -> GetScheduledQueryHistoryRequestTypeDef:
    return {
        "identifier": ...,
    }


# GetScheduledQueryHistoryRequestTypeDef definition

class GetScheduledQueryHistoryRequestTypeDef(TypedDict):
    identifier: str,
    startTime: int,
    endTime: int,
    executionStatuses: NotRequired[Sequence[ExecutionStatusType]],  # (1)
    maxResults: NotRequired[int],
    nextToken: NotRequired[str],
```
...
```python
# GetScheduledQueryRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import GetScheduledQueryRequestTypeDef


def get_value() -> GetScheduledQueryRequestTypeDef:
    return {
        "identifier": ...,
    }


# GetScheduledQueryRequestTypeDef definition
...
from types_aiobotocore_logs.type_defs import TagFilterTypeDef
...
from types_aiobotocore_logs.type_defs import ListScheduledQueriesRequestTypeDef
...
class ListScheduledQueriesRequestTypeDef(TypedDict):
    maxResults: NotRequired[int],
    nextToken: NotRequired[str],
    state: NotRequired[ScheduledQueryStateType],  # (1)
```
...
```python
# ListSourcesForS3TableIntegrationRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import ListSourcesForS3TableIntegrationRequestTypeDef


def get_value() -> ListSourcesForS3TableIntegrationRequestTypeDef:
    return {
        "integrationArn": ...,
    }


# ListSourcesForS3TableIntegrationRequestTypeDef definition
...
```python
# LogFieldTypeTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import LogFieldTypeTypeDef


def get_value() -> LogFieldTypeTypeDef:
    return {
        "type": ...,
    }


# LogFieldTypeTypeDef definition

class LogFieldTypeTypeDef(TypedDict):
    type: NotRequired[str],
...
```python
# PutBearerTokenAuthenticationRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import PutBearerTokenAuthenticationRequestTypeDef


def get_value() -> PutBearerTokenAuthenticationRequestTypeDef:
    return {
        "logGroupIdentifier": ...,
    }


# PutBearerTokenAuthenticationRequestTypeDef definition
...
```python
# PutLogGroupDeletionProtectionRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import PutLogGroupDeletionProtectionRequestTypeDef


def get_value() -> PutLogGroupDeletionProtectionRequestTypeDef:
    return {
        "logGroupIdentifier": ...,
    }


# PutLogGroupDeletionProtectionRequestTypeDef definition
...
```python
# QueryParameterTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import QueryParameterTypeDef


def get_value() -> QueryParameterTypeDef:
    return {
        "name": ...,
    }


# QueryParameterTypeDef definition
...
```python
# ScheduledQueryDestinationTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import ScheduledQueryDestinationTypeDef


def get_value() -> ScheduledQueryDestinationTypeDef:
    return {
        "destinationType": ...,
    }


# ScheduledQueryDestinationTypeDef definition

class ScheduledQueryDestinationTypeDef(TypedDict):
    destinationType: NotRequired[ScheduledQueryDestinationTypeType],  # (1)
...
1. See [:material-code-brackets: ScheduledQueryDestinationTypeType](./literals.md#scheduledquerydestinationtypetype)
...
```python
# UpdateLookupTableRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import UpdateLookupTableRequestTypeDef


def get_value() -> UpdateLookupTableRequestTypeDef:
    return {
        "lookupTableArn": ...,
    }


# UpdateLookupTableRequestTypeDef definition
...
```python
# AggregateLogGroupSummaryTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import AggregateLogGroupSummaryTypeDef


def get_value() -> AggregateLogGroupSummaryTypeDef:
    return {
        "logGroupCount": ...,
    }


# AggregateLogGroupSummaryTypeDef definition

class AggregateLogGroupSummaryTypeDef(TypedDict):
    logGroupCount: NotRequired[int],
    groupingIdentifiers: NotRequired[list[GroupingIdentifierTypeDef]],  # (1)
```

1. See `list[GroupingIdentifierTypeDef]`
...
```python
# AssociateSourceToS3TableIntegrationRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import AssociateSourceToS3TableIntegrationRequestTypeDef


def get_value() -> AssociateSourceToS3TableIntegrationRequestTypeDef:
    return {
        "integrationArn": ...,
    }


# AssociateSourceToS3TableIntegrationRequestTypeDef definition
...
```python
# S3TableIntegrationSourceTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import S3TableIntegrationSourceTypeDef


def get_value() -> S3TableIntegrationSourceTypeDef:
    return {
        "identifier": ...,
    }


# S3TableIntegrationSourceTypeDef definition

class S3TableIntegrationSourceTypeDef(TypedDict):
    identifier: NotRequired[str],
    dataSource: NotRequired[DataSourceTypeDef],  # (1)
    status: NotRequired[S3TableIntegrationSourceStatusType],  # (2)
...
1. See [:material-code-braces: DataSourceTypeDef](./type_defs.md#datasourcetypedef)
2. See [:material-code-brackets: S3TableIntegrationSourceStatusType](./literals.md#s3tableintegrationsourcestatustype)

## AssociateSourceToS3TableIntegrationResponseTypeDef

```python
# AssociateSourceToS3TableIntegrationResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import AssociateSourceToS3TableIntegrationResponseTypeDef


def get_value() -> AssociateSourceToS3TableIntegrationResponseTypeDef:
    return {
        "identifier": ...,
    }


# AssociateSourceToS3TableIntegrationResponseTypeDef definition
...
```python
# CreateImportTaskResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import CreateImportTaskResponseTypeDef


def get_value() -> CreateImportTaskResponseTypeDef:
    return {
        "importId": ...,
    }


# CreateImportTaskResponseTypeDef definition
...
```python
# CreateLookupTableResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import CreateLookupTableResponseTypeDef


def get_value() -> CreateLookupTableResponseTypeDef:
    return {
        "lookupTableArn": ...,
    }


# CreateLookupTableResponseTypeDef definition
...
from types_aiobotocore_logs.type_defs import CreateScheduledQueryResponseTypeDef
...
```python
# DisassociateSourceFromS3TableIntegrationResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import DisassociateSourceFromS3TableIntegrationResponseTypeDef


def get_value() -> DisassociateSourceFromS3TableIntegrationResponseTypeDef:
    return {
        "identifier": ...,
    }


# DisassociateSourceFromS3TableIntegrationResponseTypeDef definition
...
```python
# GetLookupTableResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import GetLookupTableResponseTypeDef


def get_value() -> GetLookupTableResponseTypeDef:
    return {
        "lookupTableArn": ...,
    }


# GetLookupTableResponseTypeDef definition
...
```python
# UpdateLookupTableResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import UpdateLookupTableResponseTypeDef


def get_value() -> UpdateLookupTableResponseTypeDef:
    return {
        "lookupTableArn": ...,
    }


# UpdateLookupTableResponseTypeDef definition
...
```python
# CancelImportTaskResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import CancelImportTaskResponseTypeDef


def get_value() -> CancelImportTaskResponseTypeDef:
    return {
        "importId": ...,
    }


# CancelImportTaskResponseTypeDef definition

class CancelImportTaskResponseTypeDef(TypedDict):
    importId: str,
    importStatistics: ImportStatisticsTypeDef,  # (1)
...
1. See [:material-code-braces: ImportStatisticsTypeDef](./type_defs.md#importstatisticstypedef)
...
```python
# CreateImportTaskRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import CreateImportTaskRequestTypeDef


def get_value() -> CreateImportTaskRequestTypeDef:
    return {
        "importSourceArn": ...,
    }


# CreateImportTaskRequestTypeDef definition

class CreateImportTaskRequestTypeDef(TypedDict):
    importSourceArn: str,
    importRoleArn: str,
    importFilter: NotRequired[ImportFilterTypeDef],  # (1)
```
...
from types_aiobotocore_logs.type_defs import ImportTypeDef
...
class ImportTypeDef(TypedDict):
    ...
    importStatistics: NotRequired[ImportStatisticsTypeDef],  # (2)
    importFilter: NotRequired[ImportFilterTypeDef],  # (3)
    creationTime: NotRequired[int],
    lastUpdatedTime: NotRequired[int],
    errorMessage: NotRequired[str],
```
...
1. See [:material-code-brackets: ImportStatusType](./literals.md#importstatustype)
2. See [:material-code-braces: ImportStatisticsTypeDef](./type_defs.md#importstatisticstypedef)
3. See [:material-code-braces: ImportFilterTypeDef](./type_defs.md#importfiltertypedef)

## ListAggregateLogGroupSummariesRequestTypeDef

```python
# ListAggregateLogGroupSummariesRequestTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import ListAggregateLogGroupSummariesRequestTypeDef


def get_value() -> ListAggregateLogGroupSummariesRequestTypeDef:
    return {
        "groupBy": ...,
    }


# ListAggregateLogGroupSummariesRequestTypeDef definition

class ListAggregateLogGroupSummariesRequestTypeDef(TypedDict):
    groupBy: ListAggregateLogGroupSummariesGroupByType,  # (1)
    accountIdentifiers: NotRequired[Sequence[str]],
    includeLinkedAccounts: NotRequired[bool],
    logGroupClass: NotRequired[LogGroupClassType],  # (2)
    logGroupNamePattern: NotRequired[str],
    dataSources: NotRequired[Sequence[DataSourceFilterTypeDef]],  # (3)
    nextToken: NotRequired[str],
    limit: NotRequired[int],
```
...
from types_aiobotocore_logs.type_defs import DeliveryDestinationTypeDef
...
from types_aiobotocore_logs.type_defs import PutDeliveryDestinationRequestTypeDef
...
class PutDeliveryDestinationRequestTypeDef(TypedDict):
    ...
    deliveryDestinationConfiguration: NotRequired[DeliveryDestinationConfigurationTypeDef],  # (2)
    deliveryDestinationType: NotRequired[DeliveryDestinationTypeType],  # (3)
    tags: NotRequired[Mapping[str, str]],
```
...
from types_aiobotocore_logs.type_defs import DescribeDeliverySourcesResponseTypeDef
...
1. See `list[DeliverySourceTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import GetDeliverySourceResponseTypeDef
...
from types_aiobotocore_logs.type_defs import PutDeliverySourceResponseTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeConfigurationTemplatesRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeDeliveriesRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeDeliveryDestinationsRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeDeliverySourcesRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeDestinationsRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeExportTasksRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeLogGroupsRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeLogStreamsRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeMetricFiltersRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeQueriesRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeResourcePoliciesRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeSubscriptionFiltersRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import FilterLogEventsRequestPaginateTypeDef
...
```python
# GetScheduledQueryHistoryRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import GetScheduledQueryHistoryRequestPaginateTypeDef


def get_value() -> GetScheduledQueryHistoryRequestPaginateTypeDef:
    return {
        "identifier": ...,
    }


# GetScheduledQueryHistoryRequestPaginateTypeDef definition
...
```python
# ListAggregateLogGroupSummariesRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import ListAggregateLogGroupSummariesRequestPaginateTypeDef


def get_value() -> ListAggregateLogGroupSummariesRequestPaginateTypeDef:
    return {
        "groupBy": ...,
    }


# ListAggregateLogGroupSummariesRequestPaginateTypeDef definition
...
from types_aiobotocore_logs.type_defs import ListAnomaliesRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import ListLogAnomalyDetectorsRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import ListLogGroupsForQueryRequestPaginateTypeDef
...
from types_aiobotocore_logs.type_defs import ListScheduledQueriesRequestPaginateTypeDef
...
```python
# ListSourcesForS3TableIntegrationRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import ListSourcesForS3TableIntegrationRequestPaginateTypeDef


def get_value() -> ListSourcesForS3TableIntegrationRequestPaginateTypeDef:
    return {
        "integrationArn": ...,
    }


# ListSourcesForS3TableIntegrationRequestPaginateTypeDef definition
...
from types_aiobotocore_logs.type_defs import DescribeFieldIndexesResponseTypeDef
...
1. See `list[FieldIndexTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## DescribeImportTaskBatchesResponseTypeDef

```python
# DescribeImportTaskBatchesResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import DescribeImportTaskBatchesResponseTypeDef


def get_value() -> DescribeImportTaskBatchesResponseTypeDef:
    return {
        "importSourceArn": ...,
    }


# DescribeImportTaskBatchesResponseTypeDef definition

class DescribeImportTaskBatchesResponseTypeDef(TypedDict):
    importSourceArn: str,
    importId: str,
    importBatches: list[ImportBatchTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[ImportBatchTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import DescribeIndexPoliciesResponseTypeDef
...
from types_aiobotocore_logs.type_defs import PutIndexPolicyResponseTypeDef
...
1. See [:material-code-braces: IndexPolicyTypeDef](./type_defs.md#indexpolicytypedef)
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
1. See `list[LogStreamTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## DescribeLookupTablesResponseTypeDef

```python
# DescribeLookupTablesResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import DescribeLookupTablesResponseTypeDef


def get_value() -> DescribeLookupTablesResponseTypeDef:
    return {
        "lookupTables": ...,
    }


# DescribeLookupTablesResponseTypeDef definition

class DescribeLookupTablesResponseTypeDef(TypedDict):
    lookupTables: list[LookupTableTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[LookupTableTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
1. See `list[SubscriptionFilterTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import DestinationConfigurationTypeDef
...
1. See `list[FilteredLogEventTypeDef]`
2. See `list[SearchedLogStreamTypeDef]`
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import GetDeliveryDestinationPolicyResponseTypeDef
...
from types_aiobotocore_logs.type_defs import PutDeliveryDestinationPolicyResponseTypeDef
...
1. See `list[OutputLogEventTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
1. See `list[LogGroupFieldTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## GetLogObjectResponseStreamTypeDef

```python
# GetLogObjectResponseStreamTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import GetLogObjectResponseStreamTypeDef


def get_value() -> GetLogObjectResponseStreamTypeDef:
    return {
        "fields": ...,
    }


# GetLogObjectResponseStreamTypeDef definition

class GetLogObjectResponseStreamTypeDef(TypedDict):
    fields: NotRequired[FieldsDataTypeDef],  # (1)
    InternalStreamingException: NotRequired[InternalStreamingExceptionTypeDef],  # (2)
```

1. See [:material-code-braces: FieldsDataTypeDef](./type_defs.md#fieldsdatatypedef)
2. See [:material-code-braces: InternalStreamingExceptionTypeDef](./type_defs.md#internalstreamingexceptiontypedef)
...
1. See [:material-code-brackets: QueryLanguageType](./literals.md#querylanguagetype)
2. See `list[list[ResultFieldTypeDef]]`
3. See [:material-code-braces: QueryStatisticsTypeDef](./type_defs.md#querystatisticstypedef)
4. See [:material-code-brackets: QueryStatusType](./literals.md#querystatustype)
...
from types_aiobotocore_logs.type_defs import PutLogEventsRequestTypeDef
...
from types_aiobotocore_logs.type_defs import ListIntegrationsResponseTypeDef
...
class ListLogGroupsRequestTypeDef(TypedDict):
    ...
    nextToken: NotRequired[str],
    limit: NotRequired[int],
    dataSources: NotRequired[Sequence[DataSourceFilterTypeDef]],  # (2)
    fieldIndexNames: NotRequired[Sequence[str]],
    logGroupTags: NotRequired[Sequence[TagFilterTypeDef]],  # (3)
```
...
```python
# ListLogGroupsResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import ListLogGroupsResponseTypeDef


def get_value() -> ListLogGroupsResponseTypeDef:
    return {
        "logGroups": ...,
    }


# ListLogGroupsResponseTypeDef definition

class ListLogGroupsResponseTypeDef(TypedDict):
    logGroups: list[LogGroupSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[LogGroupSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import LiveTailSessionUpdateTypeDef
...
2. See `list[LiveTailSessionLogEventTypeDef]`

## LogFieldsListItemTypeDef

```python
# LogFieldsListItemTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import LogFieldsListItemTypeDef


def get_value() -> LogFieldsListItemTypeDef:
    return {
        "logFieldName": ...,
    }


# LogFieldsListItemTypeDef definition

class LogFieldsListItemTypeDef(TypedDict):
    logFieldName: NotRequired[str],
    logFieldType: NotRequired[LogFieldTypeTypeDef],  # (1)
```

1. See [:material-code-braces: LogFieldTypeTypeDef](./type_defs.md#logfieldtypetypedef)
...
1. See `list[MetricFilterMatchRecordTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
1. See `list[MetricTransformationOutputTypeDef]`
...
from types_aiobotocore_logs.type_defs import MoveKeysOutputTypeDef
...
1. See `list[MoveKeyEntryTypeDef]`
...
from types_aiobotocore_logs.type_defs import MoveKeysTypeDef
...
1. See `Sequence[MoveKeyEntryTypeDef]`
...
from types_aiobotocore_logs.type_defs import OpenSearchApplicationTypeDef
...
1. See [:material-code-braces: OpenSearchResourceStatusTypeDef](./type_defs.md#opensearchresourcestatustypedef)
...
from types_aiobotocore_logs.type_defs import OpenSearchCollectionTypeDef
...
from types_aiobotocore_logs.type_defs import OpenSearchDataAccessPolicyTypeDef
...
from types_aiobotocore_logs.type_defs import OpenSearchDataSourceTypeDef
...
from types_aiobotocore_logs.type_defs import OpenSearchEncryptionPolicyTypeDef
...
from types_aiobotocore_logs.type_defs import OpenSearchLifecyclePolicyTypeDef
...
from types_aiobotocore_logs.type_defs import OpenSearchNetworkPolicyTypeDef
...
from types_aiobotocore_logs.type_defs import OpenSearchWorkspaceTypeDef
...
from types_aiobotocore_logs.type_defs import ResourceConfigTypeDef
...
1. See [:material-code-braces: OpenSearchResourceConfigTypeDef](./type_defs.md#opensearchresourceconfigtypedef)
...
class PutQueryDefinitionRequestTypeDef(TypedDict):
    ...
    parameters: NotRequired[Sequence[QueryParameterTypeDef]],  # (2)
```
...
class QueryDefinitionTypeDef(TypedDict):
    ...
    parameters: NotRequired[list[QueryParameterTypeDef]],  # (2)
```

1. See [:material-code-brackets: QueryLanguageType](./literals.md#querylanguagetype)
2. See `list[QueryParameterTypeDef]`
...
from types_aiobotocore_logs.type_defs import RenameKeysOutputTypeDef
...
1. See `list[RenameKeyEntryTypeDef]`
...
from types_aiobotocore_logs.type_defs import RenameKeysTypeDef
...
1. See `Sequence[RenameKeyEntryTypeDef]`

## TriggerHistoryRecordTypeDef

```python
# TriggerHistoryRecordTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import TriggerHistoryRecordTypeDef


def get_value() -> TriggerHistoryRecordTypeDef:
    return {
        "queryId": ...,
    }


# TriggerHistoryRecordTypeDef definition
...
class TriggerHistoryRecordTypeDef(TypedDict):
    ...
    errorMessage: NotRequired[str],
    destinations: NotRequired[list[ScheduledQueryDestinationTypeDef]],  # (2)
```

1. See [:material-code-brackets: ExecutionStatusType](./literals.md#executionstatustype)
2. See `list[ScheduledQueryDestinationTypeDef]`
...
from types_aiobotocore_logs.type_defs import SplitStringOutputTypeDef
...
1. See `list[SplitStringEntryTypeDef]`
...
from types_aiobotocore_logs.type_defs import SplitStringTypeDef
...
1. See `Sequence[SplitStringEntryTypeDef]`
...
from types_aiobotocore_logs.type_defs import SubstituteStringOutputTypeDef
...
1. See `list[SubstituteStringEntryTypeDef]`
...
from types_aiobotocore_logs.type_defs import SubstituteStringTypeDef
...
1. See `Sequence[SubstituteStringEntryTypeDef]`
...
from types_aiobotocore_logs.type_defs import UpdateAnomalyRequestTypeDef
...
from types_aiobotocore_logs.type_defs import TestTransformerResponseTypeDef
...
1. See `list[TransformedLogRecordTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import TypeConverterOutputTypeDef
...
1. See `list[TypeConverterEntryTypeDef]`
...
from types_aiobotocore_logs.type_defs import TypeConverterTypeDef
...
1. See `Sequence[TypeConverterEntryTypeDef]`

## ListAggregateLogGroupSummariesResponseTypeDef

```python
# ListAggregateLogGroupSummariesResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import ListAggregateLogGroupSummariesResponseTypeDef


def get_value() -> ListAggregateLogGroupSummariesResponseTypeDef:
    return {
        "aggregateLogGroupSummaries": ...,
    }


# ListAggregateLogGroupSummariesResponseTypeDef definition

class ListAggregateLogGroupSummariesResponseTypeDef(TypedDict):
    aggregateLogGroupSummaries: list[AggregateLogGroupSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[AggregateLogGroupSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import ListAnomaliesResponseTypeDef
...
```python
# ListSourcesForS3TableIntegrationResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import ListSourcesForS3TableIntegrationResponseTypeDef


def get_value() -> ListSourcesForS3TableIntegrationResponseTypeDef:
    return {
        "sources": ...,
    }


# ListSourcesForS3TableIntegrationResponseTypeDef definition

class ListSourcesForS3TableIntegrationResponseTypeDef(TypedDict):
    sources: list[S3TableIntegrationSourceTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[S3TableIntegrationSourceTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import ConfigurationTemplateTypeDef
...
class ConfigurationTemplateTypeDef(TypedDict):
    ...
    deliverySourceConfiguration: NotRequired[list[DeliverySourceConfigurationSchemaTypeDef]],  # (5)
    s3TablesIntegration: NotRequired[S3TablesIntegrationTypeDef],  # (6)
```
...
3. See `list[RecordFieldTypeDef]`
4. See `list[OutputFormatType]`
5. See `list[DeliverySourceConfigurationSchemaTypeDef]`
6. See [:material-code-braces: S3TablesIntegrationTypeDef](./type_defs.md#s3tablesintegrationtypedef)
...
from types_aiobotocore_logs.type_defs import CreateDeliveryResponseTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeDeliveriesResponseTypeDef
...
from types_aiobotocore_logs.type_defs import GetDeliveryResponseTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeImportTasksResponseTypeDef
...
from types_aiobotocore_logs.type_defs import DescribeDeliveryDestinationsResponseTypeDef
...
1. See `list[DeliveryDestinationTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import GetDeliveryDestinationResponseTypeDef
...
from types_aiobotocore_logs.type_defs import PutDeliveryDestinationResponseTypeDef
...
from types_aiobotocore_logs.type_defs import CreateScheduledQueryRequestTypeDef
...
class CreateScheduledQueryRequestTypeDef(TypedDict):
    ...
    destinationConfiguration: NotRequired[DestinationConfigurationTypeDef],  # (2)
    scheduleStartTime: NotRequired[int],
    scheduleEndTime: NotRequired[int],
    state: NotRequired[ScheduledQueryStateType],  # (3)
    tags: NotRequired[Mapping[str, str]],
```
...
```python
# GetScheduledQueryResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import GetScheduledQueryResponseTypeDef


def get_value() -> GetScheduledQueryResponseTypeDef:
    return {
        "scheduledQueryArn": ...,
    }


# GetScheduledQueryResponseTypeDef definition
...
class GetScheduledQueryResponseTypeDef(TypedDict):
    ...
    lastExecutionStatus: ExecutionStatusType,  # (4)
...
2. See [:material-code-braces: DestinationConfigurationTypeDef](./type_defs.md#destinationconfigurationtypedef)
3. See [:material-code-brackets: ScheduledQueryStateType](./literals.md#scheduledquerystatetype)
4. See [:material-code-brackets: ExecutionStatusType](./literals.md#executionstatustype)
5. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## ScheduledQuerySummaryTypeDef

```python
# ScheduledQuerySummaryTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import ScheduledQuerySummaryTypeDef


def get_value() -> ScheduledQuerySummaryTypeDef:
    return {
        "scheduledQueryArn": ...,
    }


# ScheduledQuerySummaryTypeDef definition
...
class ScheduledQuerySummaryTypeDef(TypedDict):
    ...
    lastExecutionStatus: NotRequired[ExecutionStatusType],  # (2)
    scheduleExpression: NotRequired[str],
    timezone: NotRequired[str],
    destinationConfiguration: NotRequired[DestinationConfigurationTypeDef],  # (3)
    creationTime: NotRequired[int],
    lastUpdatedTime: NotRequired[int],
```
...
3. See [:material-code-braces: DestinationConfigurationTypeDef](./type_defs.md#destinationconfigurationtypedef)
...
from types_aiobotocore_logs.type_defs import UpdateScheduledQueryRequestTypeDef
...
```python
# UpdateScheduledQueryResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import UpdateScheduledQueryResponseTypeDef


def get_value() -> UpdateScheduledQueryResponseTypeDef:
    return {
        "scheduledQueryArn": ...,
    }


# UpdateScheduledQueryResponseTypeDef definition
...
```python
# GetLogObjectResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import GetLogObjectResponseTypeDef


def get_value() -> GetLogObjectResponseTypeDef:
    return {
        "fieldStream": ...,
    }


# GetLogObjectResponseTypeDef definition

class GetLogObjectResponseTypeDef(TypedDict):
    fieldStream: aiobotocore.eventstream.AioEventStream[GetLogObjectResponseStreamTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See `AioEventStream[GetLogObjectResponseStreamTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import StartLiveTailResponseStreamTypeDef
...
```python
# GetLogFieldsResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import GetLogFieldsResponseTypeDef


def get_value() -> GetLogFieldsResponseTypeDef:
    return {
        "logFields": ...,
    }


# GetLogFieldsResponseTypeDef definition

class GetLogFieldsResponseTypeDef(TypedDict):
    logFields: list[LogFieldsListItemTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See `list[LogFieldsListItemTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
1. See `list[MetricFilterTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import PutMetricFilterRequestTypeDef
...
from types_aiobotocore_logs.type_defs import OpenSearchIntegrationDetailsTypeDef
...
1. See [:material-code-braces: OpenSearchDataSourceTypeDef](./type_defs.md#opensearchdatasourcetypedef)
2. See [:material-code-braces: OpenSearchApplicationTypeDef](./type_defs.md#opensearchapplicationtypedef)
3. See [:material-code-braces: OpenSearchCollectionTypeDef](./type_defs.md#opensearchcollectiontypedef)
4. See [:material-code-braces: OpenSearchWorkspaceTypeDef](./type_defs.md#opensearchworkspacetypedef)
5. See [:material-code-braces: OpenSearchEncryptionPolicyTypeDef](./type_defs.md#opensearchencryptionpolicytypedef)
6. See [:material-code-braces: OpenSearchNetworkPolicyTypeDef](./type_defs.md#opensearchnetworkpolicytypedef)
7. See [:material-code-braces: OpenSearchDataAccessPolicyTypeDef](./type_defs.md#opensearchdataaccesspolicytypedef)
8. See [:material-code-braces: OpenSearchLifecyclePolicyTypeDef](./type_defs.md#opensearchlifecyclepolicytypedef)
...
from types_aiobotocore_logs.type_defs import PutIntegrationRequestTypeDef
...
1. See `list[QueryDefinitionTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## GetScheduledQueryHistoryResponseTypeDef

```python
# GetScheduledQueryHistoryResponseTypeDef TypedDict usage example

from types_aiobotocore_logs.type_defs import GetScheduledQueryHistoryResponseTypeDef


def get_value() -> GetScheduledQueryHistoryResponseTypeDef:
    return {
        "name": ...,
    }


# GetScheduledQueryHistoryResponseTypeDef definition

class GetScheduledQueryHistoryResponseTypeDef(TypedDict):
    name: str,
    scheduledQueryArn: str,
    triggerHistory: list[TriggerHistoryRecordTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[TriggerHistoryRecordTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import ProcessorOutputTypeDef
...
class ProcessorOutputTypeDef(TypedDict):
    ...
    parseToOCSF: NotRequired[ParseToOCSFTypeDef],  # (14)
    parsePostgres: NotRequired[ParsePostgresTypeDef],  # (15)
    parseVPC: NotRequired[ParseVPCTypeDef],  # (16)
    parseWAF: NotRequired[ParseWAFTypeDef],  # (17)
    renameKeys: NotRequired[RenameKeysOutputTypeDef],  # (18)
    splitString: NotRequired[SplitStringOutputTypeDef],  # (19)
    substituteString: NotRequired[SubstituteStringOutputTypeDef],  # (20)
    trimString: NotRequired[TrimStringOutputTypeDef],  # (21)
    typeConverter: NotRequired[TypeConverterOutputTypeDef],  # (22)
    upperCaseString: NotRequired[UpperCaseStringOutputTypeDef],  # (23)
```

1. See [:material-code-braces: AddKeysOutputTypeDef](./type_defs.md#addkeysoutputtypedef)
2. See [:material-code-braces: CopyValueOutputTypeDef](./type_defs.md#copyvalueoutputtypedef)
3. See [:material-code-braces: CSVOutputTypeDef](./type_defs.md#csvoutputtypedef)
4. See [:material-code-braces: DateTimeConverterOutputTypeDef](./type_defs.md#datetimeconverteroutputtypedef)
5. See [:material-code-braces: DeleteKeysOutputTypeDef](./type_defs.md#deletekeysoutputtypedef)
6. See [:material-code-braces: GrokTypeDef](./type_defs.md#groktypedef)
7. See [:material-code-braces: ListToMapTypeDef](./type_defs.md#listtomaptypedef)
8. See [:material-code-braces: LowerCaseStringOutputTypeDef](./type_defs.md#lowercasestringoutputtypedef)
9. See [:material-code-braces: MoveKeysOutputTypeDef](./type_defs.md#movekeysoutputtypedef)
10. See [:material-code-braces: ParseCloudfrontTypeDef](./type_defs.md#parsecloudfronttypedef)
11. See [:material-code-braces: ParseJSONTypeDef](./type_defs.md#parsejsontypedef)
12. See [:material-code-braces: ParseKeyValueTypeDef](./type_defs.md#parsekeyvaluetypedef)
13. See [:material-code-braces: ParseRoute53TypeDef](./type_defs.md#parseroute53typedef)
14. See [:material-code-braces: ParseToOCSFTypeDef](./type_defs.md#parsetoocsftypedef)
15. See [:material-code-braces: ParsePostgresTypeDef](./type_defs.md#parsepostgrestypedef)
16. See [:material-code-braces: ParseVPCTypeDef](./type_defs.md#parsevpctypedef)
17. See [:material-code-braces: ParseWAFTypeDef](./type_defs.md#parsewaftypedef)
18. See [:material-code-braces: RenameKeysOutputTypeDef](./type_defs.md#renamekeysoutputtypedef)
19. See [:material-code-braces: SplitStringOutputTypeDef](./type_defs.md#splitstringoutputtypedef)
20. See [:material-code-braces: SubstituteStringOutputTypeDef](./type_defs.md#substitutestringoutputtypedef)
21. See [:material-code-braces: TrimStringOutputTypeDef](./type_defs.md#trimstringoutputtypedef)
22. See [:material-code-braces: TypeConverterOutputTypeDef](./type_defs.md#typeconverteroutputtypedef)
23. See [:material-code-braces: UpperCaseStringOutputTypeDef](./type_defs.md#uppercasestringoutputtypedef)
...
1. See `list[ConfigurationTemplateTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import ListScheduledQueriesResponseTypeDef
...
class ListScheduledQueriesResponseTypeDef(TypedDict):
    scheduledQueries: list[ScheduledQuerySummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[ScheduledQuerySummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import StartLiveTailResponseTypeDef
...
class StartLiveTailResponseTypeDef(TypedDict):
    responseStream: aiobotocore.eventstream.AioEventStream[StartLiveTailResponseStreamTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See `AioEventStream[StartLiveTailResponseStreamTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_logs.type_defs import IntegrationDetailsTypeDef
...
1. See [:material-code-braces: OpenSearchIntegrationDetailsTypeDef](./type_defs.md#opensearchintegrationdetailstypedef)
...
from types_aiobotocore_logs.type_defs import GetTransformerResponseTypeDef
...
from types_aiobotocore_logs.type_defs import ProcessorTypeDef
...
class ProcessorTypeDef(TypedDict):
    ...
    parseVPC: NotRequired[ParseVPCTypeDef],  # (16)
    parseWAF: NotRequired[ParseWAFTypeDef],  # (17)
    renameKeys: NotRequired[RenameKeysUnionTypeDef],  # (18)
    splitString: NotRequired[SplitStringUnionTypeDef],  # (19)
    substituteString: NotRequired[SubstituteStringUnionTypeDef],  # (20)
    trimString: NotRequired[TrimStringUnionTypeDef],  # (21)
    typeConverter: NotRequired[TypeConverterUnionTypeDef],  # (22)
    upperCaseString: NotRequired[UpperCaseStringUnionTypeDef],  # (23)
```

1. See [:material-code-braces: AddKeysUnionTypeDef](#addkeysuniontypedef)
2. See [:material-code-braces: CopyValueUnionTypeDef](#copyvalueuniontypedef)
3. See [:material-code-braces: CSVUnionTypeDef](#csvuniontypedef)
4. See [:material-code-braces: DateTimeConverterUnionTypeDef](#datetimeconverteruniontypedef)
5. See [:material-code-braces: DeleteKeysUnionTypeDef](#deletekeysuniontypedef)
6. See [:material-code-braces: GrokTypeDef](./type_defs.md#groktypedef)
7. See [:material-code-braces: ListToMapTypeDef](./type_defs.md#listtomaptypedef)
8. See [:material-code-braces: LowerCaseStringUnionTypeDef](#lowercasestringuniontypedef)
9. See [:material-code-braces: MoveKeysUnionTypeDef](#movekeysuniontypedef)
10. See [:material-code-braces: ParseCloudfrontTypeDef](./type_defs.md#parsecloudfronttypedef)
11. See [:material-code-braces: ParseJSONTypeDef](./type_defs.md#parsejsontypedef)
12. See [:material-code-braces: ParseKeyValueTypeDef](./type_defs.md#parsekeyvaluetypedef)
13. See [:material-code-braces: ParseRoute53TypeDef](./type_defs.md#parseroute53typedef)
...
16. See [:material-code-braces: ParseVPCTypeDef](./type_defs.md#parsevpctypedef)
17. See [:material-code-braces: ParseWAFTypeDef](./type_defs.md#parsewaftypedef)
18. See [:material-code-braces: RenameKeysUnionTypeDef](#renamekeysuniontypedef)
19. See [:material-code-braces: SplitStringUnionTypeDef](#splitstringuniontypedef)
20. See [:material-code-braces: SubstituteStringUnionTypeDef](#substitutestringuniontypedef)
21. See [:material-code-braces: TrimStringUnionTypeDef](#trimstringuniontypedef)
22. See [:material-code-braces: TypeConverterUnionTypeDef](#typeconverteruniontypedef)
23. See [:material-code-braces: UpperCaseStringUnionTypeDef](#uppercasestringuniontypedef)
...
from types_aiobotocore_logs.type_defs import GetIntegrationResponseTypeDef
...
1. See [:material-code-brackets: IntegrationTypeType](./literals.md#integrationtypetype)
2. See [:material-code-brackets: IntegrationStatusType](./literals.md#integrationstatustype)
3. See [:material-code-braces: IntegrationDetailsTypeDef](./type_defs.md#integrationdetailstypedef)
...
from types_aiobotocore_logs.type_defs import PutTransformerRequestTypeDef
...
from types_aiobotocore_logs.type_defs import TestTransformerRequestTypeDef
