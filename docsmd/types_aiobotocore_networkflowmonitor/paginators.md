...
) -> AsyncIterator[GetQueryResultsMonitorTopContributorsOutputTypeDef]:  # (2)
    ...
```
...
kwargs: GetQueryResultsMonitorTopContributorsInputGetQueryResultsMonitorTopContributorsPaginateTypeDef = {  # (1)
    "monitorName": ...,
    "queryId": ...,
}
...
1. See [:material-code-braces: GetQueryResultsMonitorTopContributorsInputGetQueryResultsMonitorTopContributorsPaginateTypeDef](./type_defs.md#getqueryresultsmonitortopcontributorsinputgetqueryresultsmonitortopcontributorspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    queryId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[GetQueryResultsWorkloadInsightsTopContributorsDataOutputTypeDef]:  # (2)
    ...
```
...
kwargs: GetQueryResultsWorkloadInsightsTopContributorsDataInputGetQueryResultsWorkloadInsightsTopContributorsDataPaginateTypeDef = {  # (1)
    "scopeId": ...,
    "queryId": ...,
}
...
1. See [:material-code-braces: GetQueryResultsWorkloadInsightsTopContributorsDataInputGetQueryResultsWorkloadInsightsTopContributorsDataPaginateTypeDef](./type_defs.md#getqueryresultsworkloadinsightstopcontributorsdatainputgetqueryresultsworkloadinsightstopcontributorsdatapaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    queryId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[GetQueryResultsWorkloadInsightsTopContributorsOutputTypeDef]:  # (2)
    ...
```
...
kwargs: GetQueryResultsWorkloadInsightsTopContributorsInputGetQueryResultsWorkloadInsightsTopContributorsPaginateTypeDef = {  # (1)
    "scopeId": ...,
    "queryId": ...,
}
...
1. See [:material-code-braces: GetQueryResultsWorkloadInsightsTopContributorsInputGetQueryResultsWorkloadInsightsTopContributorsPaginateTypeDef](./type_defs.md#getqueryresultsworkloadinsightstopcontributorsinputgetqueryresultsworkloadinsightstopcontributorspaginatetypedef) 
...
) -> AsyncIterator[ListMonitorsOutputTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListScopesOutputTypeDef]:  # (2)
    ...
```
...
kwargs: ListScopesInputListScopesPaginateTypeDef = {  # (1)
    "PaginationConfig": ...,
}
...
1. See [:material-code-braces: ListScopesInputListScopesPaginateTypeDef](./type_defs.md#listscopesinputlistscopespaginatetypedef) 
