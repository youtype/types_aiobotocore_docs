...
from types_aiobotocore_ebs.literals import ChecksumAlgorithmType
...
from types_aiobotocore_ebs.literals import SSETypeType
...
from types_aiobotocore_ebs.literals import StatusType
...
```python
# EBSServiceName usage example
from types_aiobotocore_ebs.literals import EBSServiceName

def get_value() -> EBSServiceName:
    return "ebs"
```

```python
# EBSServiceName definition
EBSServiceName = Literal[
    "ebs",
]
```
## ServiceName
...
from types_aiobotocore_ebs.literals import ServiceName
...
from types_aiobotocore_ebs.literals import ResourceServiceName
...
from types_aiobotocore_ebs.literals import RegionName
