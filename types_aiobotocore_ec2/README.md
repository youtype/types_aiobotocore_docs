<a id="type-annotations-for-aiobotocore-ec2-module"></a>

# Type annotations for aiobotocore EC2 module
...
- [Type annotations for aiobotocore EC2 module](#type-annotations-for-aiobotocore-ec2-module)
  - [EC2Client](#ec2client)
    - [Methods](#methods)
...
Type annotations for collections from `aiobotocore.resource("ec2").*`.
