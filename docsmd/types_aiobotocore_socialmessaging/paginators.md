...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/socialmessaging.html#EndUserMessagingSocial.Paginator.ListLinkedWhatsAppBusinessAccounts)
...
) -> AsyncIterator[ListLinkedWhatsAppBusinessAccountsOutputTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListLinkedWhatsAppBusinessAccountsInputListLinkedWhatsAppBusinessAccountsPaginateTypeDef](./type_defs.md#listlinkedwhatsappbusinessaccountsinputlistlinkedwhatsappbusinessaccountspaginatetypedef) 
