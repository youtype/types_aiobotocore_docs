...
Type annotations and code completion for `#!python session.create_client("lexv2-models").delete_bot_analyzer_recommendation` method.
...
await def delete_bot_analyzer_recommendation(
    self,
    *,
    botId: str,
...
Type annotations and code completion for `#!python session.create_client("lexv2-models").describe_bot_analyzer_recommendation` method.
...
await def describe_bot_analyzer_recommendation(
    self,
    *,
    botId: str,
    botAnalyzerRequestId: str,
...
Type annotations and code completion for `#!python session.create_client("lexv2-models").list_bot_analyzer_history` method.
...
await def list_bot_analyzer_history(
    self,
    *,
    botId: str,
    localeId: str = ...,
...
Type annotations and code completion for `#!python session.create_client("lexv2-models").start_bot_analyzer` method.
...
Type annotations and code completion for `#!python session.create_client("lexv2-models").stop_bot_analyzer` method.
...
Type annotations and code completion for `#!python session.create_client("lexv2-models").get_paginator` method with overloads.
