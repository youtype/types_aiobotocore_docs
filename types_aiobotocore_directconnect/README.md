<a id="type-annotations-for-aiobotocore-directconnect-module"></a>

# Type annotations for aiobotocore DirectConnect module
...
pip install 'types-aiobotocore[directconnect]'

# install as a standalone
pip install types-aiobotocore-directconnect
```

- [Type annotations for aiobotocore DirectConnect module](#type-annotations-for-aiobotocore-directconnect-module)
...
Type annotations for `aiobotocore.create_client("directconnect")` as
...
```python
from types_aiobotocore_directconnect.paginators import DescribeDirectConnectGatewayAssociationsPaginator, ...
```
