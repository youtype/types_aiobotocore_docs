...
Type annotations and code completion for `#!python session.create_client("mediatailor").delete_function` method.
...
Type annotations and code completion for `#!python session.create_client("mediatailor").get_function` method.
...
Type annotations and code completion for `#!python session.create_client("mediatailor").list_functions` method.
...
Type annotations and code completion for `#!python session.create_client("mediatailor").put_function` method.
...
await def put_function(
    ...
    *,
    ...
    SequentialExecutorConfiguration: SequentialExecutorConfigurationUnionTypeDef = ...,  # (4)
    Tags: Mapping[str, str] = ...,
) -> PutFunctionResponseTypeDef:  # (5)
    ...
```
...
5. See [:material-code-braces: PutFunctionResponseTypeDef](./type_defs.md#putfunctionresponsetypedef)
...
await def put_playback_configuration(
    ...
    *,
    ...
    FunctionMapping: Mapping[EventNameType, str] = ...,  # (10)
) -> PutPlaybackConfigurationResponseTypeDef:  # (11)
    ...
```
...
11. See [:material-code-braces: PutPlaybackConfigurationResponseTypeDef](./type_defs.md#putplaybackconfigurationresponsetypedef)
