...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/route53profiles.html#Route53Profiles.Paginator.ListProfileAssociations)
...
) -> AsyncIterator[ListProfileAssociationsResponseTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListProfileAssociationsRequestListProfileAssociationsPaginateTypeDef](./type_defs.md#listprofileassociationsrequestlistprofileassociationspaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/route53profiles.html#Route53Profiles.Paginator.ListProfileResourceAssociations)
...
def paginate(
    ...
    *,
    ...
    ResourceType: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListProfileResourceAssociationsResponseTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListProfileResourceAssociationsRequestListProfileResourceAssociationsPaginateTypeDef](./type_defs.md#listprofileresourceassociationsrequestlistprofileresourceassociationspaginatetypedef) 
## ListProfilesPaginator

Type annotations and code completion for `#!python session.create_client("route53profiles").get_paginator("list_profiles")`.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/route53profiles.html#Route53Profiles.Paginator.ListProfiles)
