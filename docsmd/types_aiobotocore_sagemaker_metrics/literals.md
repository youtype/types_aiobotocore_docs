...
> [Index](../README.md) > [SageMakerMetrics](./README.md) > Literals
...
from types_aiobotocore_sagemaker_metrics.literals import MetricStatisticType
...
from types_aiobotocore_sagemaker_metrics.literals import PeriodType
...
```python
# PutMetricsErrorCodeType definition
...
```python
# XAxisTypeType usage example
from types_aiobotocore_sagemaker_metrics.literals import XAxisTypeType

def get_value() -> XAxisTypeType:
    return "IterationNumber"
```

```python
# XAxisTypeType definition
XAxisTypeType = Literal[
    "IterationNumber",
    "Timestamp",
]
```
...
```python
# SageMakerMetricsServiceName usage example
from types_aiobotocore_sagemaker_metrics.literals import SageMakerMetricsServiceName

def get_value() -> SageMakerMetricsServiceName:
    return "sagemaker-metrics"
```

```python
# SageMakerMetricsServiceName definition
SageMakerMetricsServiceName = Literal[
    "sagemaker-metrics",
]
```
## ServiceName
...
from types_aiobotocore_sagemaker_metrics.literals import ServiceName
...
from types_aiobotocore_sagemaker_metrics.literals import ResourceServiceName
...
from types_aiobotocore_sagemaker_metrics.literals import RegionName
