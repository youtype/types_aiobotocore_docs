...
Type annotations and code completion for `#!python session.create_client("apigateway").reject_domain_name_access_association` method.
...
await def reject_domain_name_access_association(
    self,
    *,
    domainNameAccessAssociationArn: str,
    domainNameArn: str,
