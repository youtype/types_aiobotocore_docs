<a id="literals-for-aiobotocore-iotsecuretunneling-module"></a>

# Literals for aiobotocore IoTSecureTunneling module
...
- [Literals for aiobotocore IoTSecureTunneling module](#literals-for-aiobotocore-iotsecuretunneling-module)
...
```python
from types_aiobotocore_iotsecuretunneling.literals import TunnelStatusType
```
...
```python
from types_aiobotocore_iotsecuretunneling.literals import IoTSecureTunnelingServiceName
```
...
```python
from types_aiobotocore_iotsecuretunneling.literals import ServiceName
```
...
```python
from types_aiobotocore_iotsecuretunneling.literals import ResourceServiceName
```
