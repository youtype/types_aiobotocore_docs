...
Type annotations and code completion for `#!python session.create_client("backup").create_tiering_configuration` method.
...
await def create_tiering_configuration(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("backup").delete_tiering_configuration` method.
...
await def delete_tiering_configuration(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("backup").describe_scan_job` method.
...
Type annotations and code completion for `#!python session.create_client("backup").disassociate_backup_vault_mpa_approval_team` method.
...
Type annotations and code completion for `#!python session.create_client("backup").get_tiering_configuration` method.
...
await def get_tiering_configuration(
    self,
    *,
    TieringConfigurationName: str,
...
Type annotations and code completion for `#!python session.create_client("backup").list_scan_job_summaries` method.
...
await def list_scan_job_summaries(
    self,
    *,
    AccountId: str = ...,
    ResourceType: str = ...,
...
Type annotations and code completion for `#!python session.create_client("backup").list_scan_jobs` method.
...
Type annotations and code completion for `#!python session.create_client("backup").list_tiering_configurations` method.
...
await def list_tiering_configurations(
    self,
    *,
    MaxResults: int = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("backup").start_scan_job` method.
...
Type annotations and code completion for `#!python session.create_client("backup").update_tiering_configuration` method.
...
await def update_tiering_configuration(
    self,
    *,
    TieringConfigurationName: str,
