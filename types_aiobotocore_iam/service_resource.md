<a id="iamserviceresource-for-aiobotocore-iam-module"></a>
...
Type annotations for `aiobotocore.resource("iam").AccessKey` method.
...
Returns a `Coroutine` for [AccountPasswordPolicy](#accountpasswordpolicy).
...
Asynchronous method. Use `await ServerCertificate(...)` for a synchronous call.
...
Type annotations for `aiobotocore.resource("iam").create_saml_provider` method.
...
Type annotations for `aiobotocore.resource("iam").create_signing_certificate`
method.
...
Type annotations for `aiobotocore.resource("iam").AssumeRolePolicy` class.
...
Type annotations for `aiobotocore.resource("iam").RolePolicy` class.
...
Type annotations for `aiobotocore.resource("iam").SamlProvider` class.
...
Type annotations for `aiobotocore.resource("iam").ServerCertificate` class.
...
Type annotations for `aiobotocore.resource("iam").SigningCertificate` class.
...
Type annotations for `aiobotocore.resource("iam").User` class.
...
Type annotations for `aiobotocore.resource("iam").User(...).access_keys`
collection.
...
Type annotations for `aiobotocore.resource("iam").User(...).attached_policies`
collection.
...
Type annotations for `aiobotocore.resource("iam").User(...).groups` collection.
...
Type annotations for `aiobotocore.resource("iam").User(...).mfa_devices`
collection.
...
Type annotations for `aiobotocore.resource("iam").User(...).policies`
collection.
...
Type annotations for
`aiobotocore.resource("iam").User(...).signing_certificates` collection.
...
Type annotations for `aiobotocore.resource("iam").add_group` method.

Boto3 documentation:
[IAM.User.add_group](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/iam.html#IAM.User.add_group)

Asynchronous method. Use `await add_group(...)` for a synchronous call.
...
Type annotations for `aiobotocore.resource("iam").create_access_key_pair`
method.
...
Asynchronous method. Use `await create_access_key_pair(...)` for a synchronous
call.
...
Type annotations for `aiobotocore.resource("iam").create_login_profile` method.
...
Type annotations for `aiobotocore.resource("iam").enable_mfa` method.
...
Asynchronous method. Use `await enable_mfa(...)` for a synchronous call.
...
Type annotations for `aiobotocore.resource("iam").remove_group` method.
...
Asynchronous method. Use `await remove_group(...)` for a synchronous call.
...
Type annotations for `aiobotocore.resource("iam").UserPolicy` class.
...
Type annotations for `aiobotocore.resource("iam").VirtualMfaDevice` class.
