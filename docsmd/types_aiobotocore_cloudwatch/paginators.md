...
Type annotations and code completion for `#!python session.create_client("cloudwatch").get_paginator("list_alarm_mute_rules")`.
...
from types_aiobotocore_cloudwatch.paginator import ListAlarmMuteRulesPaginator

session = get_session()
async with session.create_client("cloudwatch") as client:  # (1)
    paginator: ListAlarmMuteRulesPaginator = client.get_paginator("list_alarm_mute_rules")  # (2)
    async for item in paginator.paginate(...):
        item: ListAlarmMuteRulesOutputTypeDef
        print(item)  # (3)
```

1. client: [CloudWatchClient](./client.md)
2. paginator: [ListAlarmMuteRulesPaginator](./paginators.md#listalarmmuterulespaginator)
3. item: `AioPageIterator[ListAlarmMuteRulesOutputTypeDef]`
...
) -> aiobotocore.paginate.AioPageIterator[ListAlarmMuteRulesOutputTypeDef]:  # (3)
    ...
```

1. See `Sequence[AlarmMuteRuleStatusType]`
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `AioPageIterator[ListAlarmMuteRulesOutputTypeDef]`
