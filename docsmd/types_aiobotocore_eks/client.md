...
Type annotations and code completion for `#!python session.create_client("eks").create_capability` method.
...
Type annotations and code completion for `#!python session.create_client("eks").delete_capability` method.
...
Type annotations and code completion for `#!python session.create_client("eks").describe_capability` method.
...
Type annotations and code completion for `#!python session.create_client("eks").describe_cluster_versions` method.
...
Type annotations and code completion for `#!python session.create_client("eks").list_capabilities` method.
...
Type annotations and code completion for `#!python session.create_client("eks").update_capability` method.
