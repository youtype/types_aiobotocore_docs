...
2. See [:material-code-braces: AudioChannelTaggingSettingsOutputTypeDef](./type_defs.md#audiochanneltaggingsettingsoutputtypedef) 
...
2. See [:material-code-braces: AudioSelectorGroupOutputTypeDef](./type_defs.md#audioselectorgroupoutputtypedef) 
...
2. See [:material-code-braces: CmafAdditionalManifestOutputTypeDef](./type_defs.md#cmafadditionalmanifestoutputtypedef) 
...
2. See [:material-code-braces: DashAdditionalManifestOutputTypeDef](./type_defs.md#dashadditionalmanifestoutputtypedef) 
...
1. See [:material-code-braces: HlsAdditionalManifestTypeDef](./type_defs.md#hlsadditionalmanifesttypedef) 
2. See [:material-code-braces: HlsAdditionalManifestOutputTypeDef](./type_defs.md#hlsadditionalmanifestoutputtypedef) 
...
2. See [:material-code-braces: M3u8SettingsOutputTypeDef](./type_defs.md#m3u8settingsoutputtypedef) 
...
2. See [:material-code-braces: MsSmoothAdditionalManifestOutputTypeDef](./type_defs.md#mssmoothadditionalmanifestoutputtypedef) 
...
2. See [:material-code-braces: OutputChannelMappingOutputTypeDef](./type_defs.md#outputchannelmappingoutputtypedef) 
...
1. See [:material-code-braces: TeletextDestinationSettingsTypeDef](./type_defs.md#teletextdestinationsettingstypedef) 
2. See [:material-code-braces: TeletextDestinationSettingsOutputTypeDef](./type_defs.md#teletextdestinationsettingsoutputtypedef) 
...
2. See [:material-code-braces: AutomatedAbrRuleOutputTypeDef](./type_defs.md#automatedabrruleoutputtypedef) 
...
1. See [:material-code-braces: SpekeKeyProviderCmafTypeDef](./type_defs.md#spekekeyprovidercmaftypedef) 
2. See [:material-code-braces: SpekeKeyProviderCmafOutputTypeDef](./type_defs.md#spekekeyprovidercmafoutputtypedef) 
...
1. See [:material-code-braces: TimedMetadataInsertionTypeDef](./type_defs.md#timedmetadatainsertiontypedef) 
2. See [:material-code-braces: TimedMetadataInsertionOutputTypeDef](./type_defs.md#timedmetadatainsertionoutputtypedef) 
...
1. See [:material-code-braces: ImageInserterTypeDef](./type_defs.md#imageinsertertypedef) 
2. See [:material-code-braces: ImageInserterOutputTypeDef](./type_defs.md#imageinserteroutputtypedef) 
...
2. See [:material-code-braces: M2tsSettingsOutputTypeDef](./type_defs.md#m2tssettingsoutputtypedef) 
...
1. See [:material-code-braces: VideoOverlayInputTypeDef](./type_defs.md#videooverlayinputtypedef) 
2. See [:material-code-braces: VideoOverlayInputOutputTypeDef](./type_defs.md#videooverlayinputoutputtypedef) 
...
2. See [:material-code-braces: ChannelMappingOutputTypeDef](./type_defs.md#channelmappingoutputtypedef) 
...
2. See [:material-code-braces: AutomatedAbrSettingsOutputTypeDef](./type_defs.md#automatedabrsettingsoutputtypedef) 
...
1. See [:material-code-braces: CmafEncryptionSettingsTypeDef](./type_defs.md#cmafencryptionsettingstypedef) 
2. See [:material-code-braces: CmafEncryptionSettingsOutputTypeDef](./type_defs.md#cmafencryptionsettingsoutputtypedef) 
...
1. See [:material-code-braces: DashIsoEncryptionSettingsTypeDef](./type_defs.md#dashisoencryptionsettingstypedef) 
2. See [:material-code-braces: DashIsoEncryptionSettingsOutputTypeDef](./type_defs.md#dashisoencryptionsettingsoutputtypedef) 
...
1. See [:material-code-braces: HlsEncryptionSettingsTypeDef](./type_defs.md#hlsencryptionsettingstypedef) 
2. See [:material-code-braces: HlsEncryptionSettingsOutputTypeDef](./type_defs.md#hlsencryptionsettingsoutputtypedef) 
...
1. See [:material-code-braces: MsSmoothEncryptionSettingsTypeDef](./type_defs.md#mssmoothencryptionsettingstypedef) 
2. See [:material-code-braces: MsSmoothEncryptionSettingsOutputTypeDef](./type_defs.md#mssmoothencryptionsettingsoutputtypedef) 
...
1. See [:material-code-braces: VideoPreprocessorTypeDef](./type_defs.md#videopreprocessortypedef) 
2. See [:material-code-braces: VideoPreprocessorOutputTypeDef](./type_defs.md#videopreprocessoroutputtypedef) 
...
1. See [:material-code-braces: ContainerSettingsTypeDef](./type_defs.md#containersettingstypedef) 
2. See [:material-code-braces: ContainerSettingsOutputTypeDef](./type_defs.md#containersettingsoutputtypedef) 
...
1. See [:material-code-braces: VideoOverlayTypeDef](./type_defs.md#videooverlaytypedef) 
2. See [:material-code-braces: VideoOverlayOutputTypeDef](./type_defs.md#videooverlayoutputtypedef) 
...
1. See [:material-code-braces: CaptionDescriptionPresetTypeDef](./type_defs.md#captiondescriptionpresettypedef) 
2. See [:material-code-braces: CaptionDescriptionPresetOutputTypeDef](./type_defs.md#captiondescriptionpresetoutputtypedef) 
...
2. See [:material-code-braces: AutomatedEncodingSettingsOutputTypeDef](./type_defs.md#automatedencodingsettingsoutputtypedef) 
...
2. See [:material-code-braces: CmafGroupSettingsOutputTypeDef](./type_defs.md#cmafgroupsettingsoutputtypedef) 
...
1. See [:material-code-braces: DashIsoGroupSettingsTypeDef](./type_defs.md#dashisogroupsettingstypedef) 
...
1. See [:material-code-braces: MsSmoothGroupSettingsTypeDef](./type_defs.md#mssmoothgroupsettingstypedef) 
2. See [:material-code-braces: MsSmoothGroupSettingsOutputTypeDef](./type_defs.md#mssmoothgroupsettingsoutputtypedef) 
...
1. See [:material-code-braces: InputTemplateTypeDef](./type_defs.md#inputtemplatetypedef) 
2. See [:material-code-braces: InputTemplateOutputTypeDef](./type_defs.md#inputtemplateoutputtypedef) 
...
6. See [:material-code-braces: Av1QvbrSettingsTypeDef](./type_defs.md#av1qvbrsettingstypedef) 
7. See [:material-code-brackets: Av1RateControlModeType](./literals.md#av1ratecontrolmodetype) 
8. See [:material-code-brackets: Av1SpatialAdaptiveQuantizationType](./literals.md#av1spatialadaptivequantizationtype) 
...
1. See [:material-code-braces: OutputChannelMappingOutputTypeDef](./type_defs.md#outputchannelmappingoutputtypedef) 
...
class H264SettingsTypeDef(TypedDict):
    ...
    WriteMp4PackagingType: NotRequired[H264WriteMp4PackagingTypeType],  # (29)
```
...
16. See [:material-code-brackets: H264QualityTuningLevelType](./literals.md#h264qualitytuningleveltype) 
17. See [:material-code-braces: H264QvbrSettingsTypeDef](./type_defs.md#h264qvbrsettingstypedef) 
18. See [:material-code-brackets: H264RateControlModeType](./literals.md#h264ratecontrolmodetype) 
19. See [:material-code-brackets: H264RepeatPpsType](./literals.md#h264repeatppstype) 
20. See [:material-code-brackets: H264SaliencyAwareEncodingType](./literals.md#h264saliencyawareencodingtype) 
21. See [:material-code-brackets: H264ScanTypeConversionModeType](./literals.md#h264scantypeconversionmodetype) 
22. See [:material-code-brackets: H264SceneChangeDetectType](./literals.md#h264scenechangedetecttype) 
23. See [:material-code-brackets: H264SlowPalType](./literals.md#h264slowpaltype) 
24. See [:material-code-brackets: H264SpatialAdaptiveQuantizationType](./literals.md#h264spatialadaptivequantizationtype) 
25. See [:material-code-brackets: H264SyntaxType](./literals.md#h264syntaxtype) 
26. See [:material-code-brackets: H264TelecineType](./literals.md#h264telecinetype) 
27. See [:material-code-brackets: H264TemporalAdaptiveQuantizationType](./literals.md#h264temporaladaptivequantizationtype) 
28. See [:material-code-brackets: H264UnregisteredSeiTimecodeType](./literals.md#h264unregisteredseitimecodetype) 
29. See [:material-code-brackets: H264WriteMp4PackagingTypeType](./literals.md#h264writemp4packagingtypetype) 
## H265SettingsTypeDef
...
7. See [:material-code-brackets: H265EndOfStreamMarkersType](./literals.md#h265endofstreammarkerstype) 
8. See [:material-code-brackets: H265FlickerAdaptiveQuantizationType](./literals.md#h265flickeradaptivequantizationtype) 
9. See [:material-code-brackets: H265FramerateControlType](./literals.md#h265frameratecontroltype) 
10. See [:material-code-brackets: H265FramerateConversionAlgorithmType](./literals.md#h265framerateconversionalgorithmtype) 
11. See [:material-code-brackets: H265GopBReferenceType](./literals.md#h265gopbreferencetype) 
12. See [:material-code-brackets: H265GopSizeUnitsType](./literals.md#h265gopsizeunitstype) 
13. See [:material-code-brackets: H265InterlaceModeType](./literals.md#h265interlacemodetype) 
14. See [:material-code-brackets: H265ParControlType](./literals.md#h265parcontroltype) 
15. See [:material-code-brackets: H265QualityTuningLevelType](./literals.md#h265qualitytuningleveltype) 
16. See [:material-code-braces: H265QvbrSettingsTypeDef](./type_defs.md#h265qvbrsettingstypedef) 
17. See [:material-code-brackets: H265RateControlModeType](./literals.md#h265ratecontrolmodetype) 
18. See [:material-code-brackets: H265SampleAdaptiveOffsetFilterModeType](./literals.md#h265sampleadaptiveoffsetfiltermodetype) 
19. See [:material-code-brackets: H265ScanTypeConversionModeType](./literals.md#h265scantypeconversionmodetype) 
20. See [:material-code-brackets: H265SceneChangeDetectType](./literals.md#h265scenechangedetecttype) 
21. See [:material-code-brackets: H265SlowPalType](./literals.md#h265slowpaltype) 
22. See [:material-code-brackets: H265SpatialAdaptiveQuantizationType](./literals.md#h265spatialadaptivequantizationtype) 
23. See [:material-code-brackets: H265TelecineType](./literals.md#h265telecinetype) 
24. See [:material-code-brackets: H265TemporalAdaptiveQuantizationType](./literals.md#h265temporaladaptivequantizationtype) 
25. See [:material-code-brackets: H265TemporalIdsType](./literals.md#h265temporalidstype) 
26. See [:material-code-brackets: H265TilesType](./literals.md#h265tilestype) 
27. See [:material-code-brackets: H265UnregisteredSeiTimecodeType](./literals.md#h265unregisteredseitimecodetype) 
28. See [:material-code-brackets: H265WriteMp4PackagingTypeType](./literals.md#h265writemp4packagingtypetype) 
...
1. See [:material-code-braces: JobEngineVersionTypeDef](./type_defs.md#jobengineversiontypedef) 
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef) 
...
3. See [:material-code-braces: ServiceOverrideTypeDef](./type_defs.md#serviceoverridetypedef) 
...
1. See [:material-code-braces: VideoOverlayInputClippingTypeDef](./type_defs.md#videooverlayinputclippingtypedef) 
2. See [:material-code-brackets: InputTimecodeSourceType](./literals.md#inputtimecodesourcetype) 
...
1. See [:material-code-braces: AutomatedAbrRuleOutputTypeDef](./type_defs.md#automatedabrruleoutputtypedef) 
...
1. See [:material-code-braces: OutputChannelMappingTypeDef](./type_defs.md#outputchannelmappingtypedef) [:material-code-braces: OutputChannelMappingOutputTypeDef](./type_defs.md#outputchannelmappingoutputtypedef) 
...
6. See [:material-code-braces: SccDestinationSettingsTypeDef](./type_defs.md#sccdestinationsettingstypedef) 
7. See [:material-code-braces: SrtDestinationSettingsTypeDef](./type_defs.md#srtdestinationsettingstypedef) 
8. See [:material-code-braces: TeletextDestinationSettingsTypeDef](./type_defs.md#teletextdestinationsettingstypedef) [:material-code-braces: TeletextDestinationSettingsOutputTypeDef](./type_defs.md#teletextdestinationsettingsoutputtypedef) 
9. See [:material-code-braces: TtmlDestinationSettingsTypeDef](./type_defs.md#ttmldestinationsettingstypedef) 
10. See [:material-code-braces: WebvttDestinationSettingsTypeDef](./type_defs.md#webvttdestinationsettingstypedef) 
...
1. See [:material-code-braces: VideoOverlayPositionTypeDef](./type_defs.md#videooverlaypositiontypedef) 
2. See [:material-code-braces: VideoOverlayInputOutputTypeDef](./type_defs.md#videooverlayinputoutputtypedef) 
3. See [:material-code-brackets: VideoOverlayPlayBackModeType](./literals.md#videooverlayplaybackmodetype) 
4. See [:material-code-braces: VideoOverlayTransitionTypeDef](./type_defs.md#videooverlaytransitiontypedef) 
...
9. See [:material-code-braces: UncompressedSettingsTypeDef](./type_defs.md#uncompressedsettingstypedef) 
10. See [:material-code-braces: Vc3SettingsTypeDef](./type_defs.md#vc3settingstypedef) 
11. See [:material-code-braces: Vp8SettingsTypeDef](./type_defs.md#vp8settingstypedef) 
12. See [:material-code-braces: Vp9SettingsTypeDef](./type_defs.md#vp9settingstypedef) 
13. See [:material-code-braces: XavcSettingsTypeDef](./type_defs.md#xavcsettingstypedef) 
...
1. See [:material-code-braces: AutomatedAbrRuleTypeDef](./type_defs.md#automatedabrruletypedef) [:material-code-braces: AutomatedAbrRuleOutputTypeDef](./type_defs.md#automatedabrruleoutputtypedef) 
...
1. See [:material-code-brackets: CmafEncryptionTypeType](./literals.md#cmafencryptiontypetype) 
2. See [:material-code-brackets: CmafInitializationVectorInManifestType](./literals.md#cmafinitializationvectorinmanifesttype) 
3. See [:material-code-braces: SpekeKeyProviderCmafTypeDef](./type_defs.md#spekekeyprovidercmaftypedef) [:material-code-braces: SpekeKeyProviderCmafOutputTypeDef](./type_defs.md#spekekeyprovidercmafoutputtypedef) 
4. See [:material-code-braces: StaticKeyProviderTypeDef](./type_defs.md#statickeyprovidertypedef) 
5. See [:material-code-brackets: CmafKeyProviderTypeType](./literals.md#cmafkeyprovidertypetype) 
...
2. See [:material-code-brackets: HlsInitializationVectorInManifestType](./literals.md#hlsinitializationvectorinmanifesttype) 
3. See [:material-code-brackets: HlsOfflineEncryptedType](./literals.md#hlsofflineencryptedtype) 
4. See [:material-code-braces: SpekeKeyProviderTypeDef](./type_defs.md#spekekeyprovidertypedef) [:material-code-braces: SpekeKeyProviderOutputTypeDef](./type_defs.md#spekekeyprovideroutputtypedef) 
5. See [:material-code-braces: StaticKeyProviderTypeDef](./type_defs.md#statickeyprovidertypedef) 
6. See [:material-code-brackets: HlsKeyProviderTypeType](./literals.md#hlskeyprovidertypetype) 
...
3. See [:material-code-braces: DolbyVisionTypeDef](./type_defs.md#dolbyvisiontypedef) 
4. See [:material-code-braces: Hdr10PlusTypeDef](./type_defs.md#hdr10plustypedef) 
5. See [:material-code-braces: ImageInserterTypeDef](./type_defs.md#imageinsertertypedef) [:material-code-braces: ImageInserterOutputTypeDef](./type_defs.md#imageinserteroutputtypedef) 
6. See [:material-code-braces: NoiseReducerTypeDef](./type_defs.md#noisereducertypedef) 
7. See [:material-code-braces: PartnerWatermarkingTypeDef](./type_defs.md#partnerwatermarkingtypedef) 
8. See [:material-code-braces: TimecodeBurninTypeDef](./type_defs.md#timecodeburnintypedef) 
...
2. See [:material-code-brackets: ContainerTypeType](./literals.md#containertypetype) 
3. See [:material-code-braces: F4vSettingsTypeDef](./type_defs.md#f4vsettingstypedef) 
4. See [:material-code-braces: M2tsSettingsTypeDef](./type_defs.md#m2tssettingstypedef) [:material-code-braces: M2tsSettingsOutputTypeDef](./type_defs.md#m2tssettingsoutputtypedef) 
5. See [:material-code-braces: M3u8SettingsTypeDef](./type_defs.md#m3u8settingstypedef) [:material-code-braces: M3u8SettingsOutputTypeDef](./type_defs.md#m3u8settingsoutputtypedef) 
6. See [:material-code-braces: MovSettingsTypeDef](./type_defs.md#movsettingstypedef) 
7. See [:material-code-braces: Mp4SettingsTypeDef](./type_defs.md#mp4settingstypedef) 
8. See [:material-code-braces: MpdSettingsTypeDef](./type_defs.md#mpdsettingstypedef) 
9. See [:material-code-braces: MxfSettingsTypeDef](./type_defs.md#mxfsettingstypedef) 
...
1. See [:material-code-braces: CmafAdditionalManifestOutputTypeDef](./type_defs.md#cmafadditionalmanifestoutputtypedef) 
...
1. See [:material-code-braces: DashAdditionalManifestOutputTypeDef](./type_defs.md#dashadditionalmanifestoutputtypedef) 
...
1. See [:material-code-braces: MsSmoothAdditionalManifestOutputTypeDef](./type_defs.md#mssmoothadditionalmanifestoutputtypedef) 
...
1. See [:material-code-braces: VideoOverlayPositionTypeDef](./type_defs.md#videooverlaypositiontypedef) 
2. See [:material-code-braces: VideoOverlayInputTypeDef](./type_defs.md#videooverlayinputtypedef) [:material-code-braces: VideoOverlayInputOutputTypeDef](./type_defs.md#videooverlayinputoutputtypedef) 
3. See [:material-code-brackets: VideoOverlayPlayBackModeType](./literals.md#videooverlayplaybackmodetype) 
4. See [:material-code-braces: VideoOverlayTransitionTypeDef](./type_defs.md#videooverlaytransitiontypedef) 
...
class VideoDescriptionOutputTypeDef(TypedDict):
    ...
    TimecodeTrack: NotRequired[TimecodeTrackType],  # (11)
    VideoPreprocessors: NotRequired[VideoPreprocessorOutputTypeDef],  # (12)
    Width: NotRequired[int],
```
...
11. See [:material-code-brackets: TimecodeTrackType](./literals.md#timecodetracktype) 
12. See [:material-code-braces: VideoPreprocessorOutputTypeDef](./type_defs.md#videopreprocessoroutputtypedef) 
## InputOutputTypeDef
...
3. See [:material-code-braces: AudioSelectorGroupOutputTypeDef](./type_defs.md#audioselectorgroupoutputtypedef) 
4. See [:material-code-braces: AudioSelectorOutputTypeDef](./type_defs.md#audioselectoroutputtypedef) 
...
18. See [:material-code-braces: VideoOverlayOutputTypeDef](./type_defs.md#videooverlayoutputtypedef) 
...
10. See [:material-code-braces: ImageInserterOutputTypeDef](./type_defs.md#imageinserteroutputtypedef) 
...
16. See [:material-code-braces: VideoOverlayOutputTypeDef](./type_defs.md#videooverlayoutputtypedef) 
17. See [:material-code-braces: VideoSelectorTypeDef](./type_defs.md#videoselectortypedef) 
...
1. See [:material-code-braces: ChannelMappingTypeDef](./type_defs.md#channelmappingtypedef) [:material-code-braces: ChannelMappingOutputTypeDef](./type_defs.md#channelmappingoutputtypedef) 
...
1. See [:material-code-braces: CaptionDestinationSettingsTypeDef](./type_defs.md#captiondestinationsettingstypedef) [:material-code-braces: CaptionDestinationSettingsOutputTypeDef](./type_defs.md#captiondestinationsettingsoutputtypedef) 
2. See [:material-code-brackets: LanguageCodeType](./literals.md#languagecodetype) 
...
1. See [:material-code-braces: AutomatedAbrSettingsTypeDef](./type_defs.md#automatedabrsettingstypedef) [:material-code-braces: AutomatedAbrSettingsOutputTypeDef](./type_defs.md#automatedabrsettingsoutputtypedef) 
...
1. See [:material-code-braces: CmafAdditionalManifestTypeDef](./type_defs.md#cmafadditionalmanifesttypedef) [:material-code-braces: CmafAdditionalManifestOutputTypeDef](./type_defs.md#cmafadditionalmanifestoutputtypedef) 
2. See [:material-code-brackets: CmafClientCacheType](./literals.md#cmafclientcachetype) 
3. See [:material-code-brackets: CmafCodecSpecificationType](./literals.md#cmafcodecspecificationtype) 
4. See [:material-code-brackets: DashManifestStyleType](./literals.md#dashmanifeststyletype) 
5. See [:material-code-braces: DestinationSettingsTypeDef](./type_defs.md#destinationsettingstypedef) 
6. See [:material-code-braces: CmafEncryptionSettingsTypeDef](./type_defs.md#cmafencryptionsettingstypedef) [:material-code-braces: CmafEncryptionSettingsOutputTypeDef](./type_defs.md#cmafencryptionsettingsoutputtypedef) 
7. See [:material-code-brackets: CmafImageBasedTrickPlayType](./literals.md#cmafimagebasedtrickplaytype) 
8. See [:material-code-braces: CmafImageBasedTrickPlaySettingsTypeDef](./type_defs.md#cmafimagebasedtrickplaysettingstypedef) 
9. See [:material-code-brackets: CmafManifestCompressionType](./literals.md#cmafmanifestcompressiontype) 
10. See [:material-code-brackets: CmafManifestDurationFormatType](./literals.md#cmafmanifestdurationformattype) 
...
1. See [:material-code-braces: DashAdditionalManifestTypeDef](./type_defs.md#dashadditionalmanifesttypedef) [:material-code-braces: DashAdditionalManifestOutputTypeDef](./type_defs.md#dashadditionalmanifestoutputtypedef) 
2. See [:material-code-brackets: DashIsoGroupAudioChannelConfigSchemeIdUriType](./literals.md#dashisogroupaudiochannelconfigschemeiduritype) 
3. See [:material-code-brackets: DashManifestStyleType](./literals.md#dashmanifeststyletype) 
4. See [:material-code-braces: DestinationSettingsTypeDef](./type_defs.md#destinationsettingstypedef) 
5. See [:material-code-braces: DashIsoEncryptionSettingsTypeDef](./type_defs.md#dashisoencryptionsettingstypedef) [:material-code-braces: DashIsoEncryptionSettingsOutputTypeDef](./type_defs.md#dashisoencryptionsettingsoutputtypedef) 
6. See [:material-code-brackets: DashIsoHbbtvComplianceType](./literals.md#dashisohbbtvcompliancetype) 
7. See [:material-code-brackets: DashIsoImageBasedTrickPlayType](./literals.md#dashisoimagebasedtrickplaytype) 
8. See [:material-code-braces: DashIsoImageBasedTrickPlaySettingsTypeDef](./type_defs.md#dashisoimagebasedtrickplaysettingstypedef) 
9. See [:material-code-brackets: DashIsoMpdManifestBandwidthTypeType](./literals.md#dashisompdmanifestbandwidthtypetype) 
...
1. See [:material-code-brackets: HlsAdMarkersType](./literals.md#hlsadmarkerstype) 
2. See [:material-code-braces: HlsAdditionalManifestTypeDef](./type_defs.md#hlsadditionalmanifesttypedef) [:material-code-braces: HlsAdditionalManifestOutputTypeDef](./type_defs.md#hlsadditionalmanifestoutputtypedef) 
3. See [:material-code-brackets: HlsAudioOnlyHeaderType](./literals.md#hlsaudioonlyheadertype) 
4. See [:material-code-braces: HlsCaptionLanguageMappingTypeDef](./type_defs.md#hlscaptionlanguagemappingtypedef) 
5. See [:material-code-brackets: HlsCaptionLanguageSettingType](./literals.md#hlscaptionlanguagesettingtype) 
6. See [:material-code-brackets: HlsCaptionSegmentLengthControlType](./literals.md#hlscaptionsegmentlengthcontroltype) 
...
9. See [:material-code-braces: DestinationSettingsTypeDef](./type_defs.md#destinationsettingstypedef) 
10. See [:material-code-brackets: HlsDirectoryStructureType](./literals.md#hlsdirectorystructuretype) 
11. See [:material-code-braces: HlsEncryptionSettingsTypeDef](./type_defs.md#hlsencryptionsettingstypedef) [:material-code-braces: HlsEncryptionSettingsOutputTypeDef](./type_defs.md#hlsencryptionsettingsoutputtypedef) 
12. See [:material-code-brackets: HlsImageBasedTrickPlayType](./literals.md#hlsimagebasedtrickplaytype) 
13. See [:material-code-braces: HlsImageBasedTrickPlaySettingsTypeDef](./type_defs.md#hlsimagebasedtrickplaysettingstypedef) 
14. See [:material-code-brackets: HlsManifestCompressionType](./literals.md#hlsmanifestcompressiontype) 
15. See [:material-code-brackets: HlsManifestDurationFormatType](./literals.md#hlsmanifestdurationformattype) 
...
1. See [:material-code-braces: MsSmoothAdditionalManifestTypeDef](./type_defs.md#mssmoothadditionalmanifesttypedef) [:material-code-braces: MsSmoothAdditionalManifestOutputTypeDef](./type_defs.md#mssmoothadditionalmanifestoutputtypedef) 
2. See [:material-code-brackets: MsSmoothAudioDeduplicationType](./literals.md#mssmoothaudiodeduplicationtype) 
3. See [:material-code-braces: DestinationSettingsTypeDef](./type_defs.md#destinationsettingstypedef) 
4. See [:material-code-braces: MsSmoothEncryptionSettingsTypeDef](./type_defs.md#mssmoothencryptionsettingstypedef) [:material-code-braces: MsSmoothEncryptionSettingsOutputTypeDef](./type_defs.md#mssmoothencryptionsettingsoutputtypedef) 
5. See [:material-code-brackets: MsSmoothFragmentLengthControlType](./literals.md#mssmoothfragmentlengthcontroltype) 
6. See [:material-code-brackets: MsSmoothManifestEncodingType](./literals.md#mssmoothmanifestencodingtype) 
...
class VideoDescriptionTypeDef(TypedDict):
    ...
    TimecodeInsertion: NotRequired[VideoTimecodeInsertionType],  # (10)
    TimecodeTrack: NotRequired[TimecodeTrackType],  # (11)
    VideoPreprocessors: NotRequired[VideoPreprocessorUnionTypeDef],  # (12)
    Width: NotRequired[int],
```
...
10. See [:material-code-brackets: VideoTimecodeInsertionType](./literals.md#videotimecodeinsertiontype) 
11. See [:material-code-brackets: TimecodeTrackType](./literals.md#timecodetracktype) 
12. See [:material-code-braces: VideoPreprocessorTypeDef](./type_defs.md#videopreprocessortypedef) [:material-code-braces: VideoPreprocessorOutputTypeDef](./type_defs.md#videopreprocessoroutputtypedef) 
...
1. See [:material-code-braces: AudioChannelTaggingSettingsTypeDef](./type_defs.md#audiochanneltaggingsettingstypedef) [:material-code-braces: AudioChannelTaggingSettingsOutputTypeDef](./type_defs.md#audiochanneltaggingsettingsoutputtypedef) 
2. See [:material-code-braces: AudioNormalizationSettingsTypeDef](./type_defs.md#audionormalizationsettingstypedef) 
3. See [:material-code-brackets: AudioTypeControlType](./literals.md#audiotypecontroltype) 
4. See [:material-code-braces: AudioCodecSettingsTypeDef](./type_defs.md#audiocodecsettingstypedef) 
5. See [:material-code-brackets: LanguageCodeType](./literals.md#languagecodetype) 
...
3. See [:material-code-braces: HlsRenditionGroupSettingsTypeDef](./type_defs.md#hlsrenditiongroupsettingstypedef) 
4. See [:material-code-brackets: LanguageCodeType](./literals.md#languagecodetype) 
5. See [:material-code-braces: RemixSettingsTypeDef](./type_defs.md#remixsettingstypedef) [:material-code-braces: RemixSettingsOutputTypeDef](./type_defs.md#remixsettingsoutputtypedef) 
6. See [:material-code-brackets: AudioSelectorTypeType](./literals.md#audioselectortypetype) 
...
2. See [:material-code-braces: ColorConversion3DLUTSettingTypeDef](./type_defs.md#colorconversion3dlutsettingtypedef) 
...
5. See [:material-code-braces: InputOutputTypeDef](./type_defs.md#inputoutputtypedef) 
...
3. See [:material-code-braces: EsamSettingsTypeDef](./type_defs.md#esamsettingstypedef) 
4. See [:material-code-braces: ExtendedDataServicesTypeDef](./type_defs.md#extendeddataservicestypedef) 
5. See [:material-code-braces: InputTemplateOutputTypeDef](./type_defs.md#inputtemplateoutputtypedef) 
6. See [:material-code-braces: KantarWatermarkSettingsTypeDef](./type_defs.md#kantarwatermarksettingstypedef) 
7. See [:material-code-braces: MotionImageInserterTypeDef](./type_defs.md#motionimageinsertertypedef) 
8. See [:material-code-braces: NielsenConfigurationTypeDef](./type_defs.md#nielsenconfigurationtypedef) 
9. See [:material-code-braces: NielsenNonLinearWatermarkSettingsTypeDef](./type_defs.md#nielsennonlinearwatermarksettingstypedef) 
...
1. See [:material-code-braces: CmafGroupSettingsTypeDef](./type_defs.md#cmafgroupsettingstypedef) [:material-code-braces: CmafGroupSettingsOutputTypeDef](./type_defs.md#cmafgroupsettingsoutputtypedef) 
2. See [:material-code-braces: DashIsoGroupSettingsTypeDef](./type_defs.md#dashisogroupsettingstypedef) [:material-code-braces: DashIsoGroupSettingsOutputTypeDef](./type_defs.md#dashisogroupsettingsoutputtypedef) 
3. See [:material-code-braces: FileGroupSettingsTypeDef](./type_defs.md#filegroupsettingstypedef) 
4. See [:material-code-braces: HlsGroupSettingsTypeDef](./type_defs.md#hlsgroupsettingstypedef) [:material-code-braces: HlsGroupSettingsOutputTypeDef](./type_defs.md#hlsgroupsettingsoutputtypedef) 
5. See [:material-code-braces: MsSmoothGroupSettingsTypeDef](./type_defs.md#mssmoothgroupsettingstypedef) [:material-code-braces: MsSmoothGroupSettingsOutputTypeDef](./type_defs.md#mssmoothgroupsettingsoutputtypedef) 
6. See [:material-code-brackets: OutputGroupTypeType](./literals.md#outputgrouptypetype) 
## JobTypeDef
...
2. See [:material-code-braces: CaptionDescriptionTypeDef](./type_defs.md#captiondescriptiontypedef) [:material-code-braces: CaptionDescriptionOutputTypeDef](./type_defs.md#captiondescriptionoutputtypedef) 
3. See [:material-code-braces: ContainerSettingsTypeDef](./type_defs.md#containersettingstypedef) [:material-code-braces: ContainerSettingsOutputTypeDef](./type_defs.md#containersettingsoutputtypedef) 
4. See [:material-code-braces: OutputSettingsTypeDef](./type_defs.md#outputsettingstypedef) 
5. See [:material-code-braces: VideoDescriptionTypeDef](./type_defs.md#videodescriptiontypedef) [:material-code-braces: VideoDescriptionOutputTypeDef](./type_defs.md#videodescriptionoutputtypedef) 
...
1. See [:material-code-braces: AudioDescriptionTypeDef](./type_defs.md#audiodescriptiontypedef) [:material-code-braces: AudioDescriptionOutputTypeDef](./type_defs.md#audiodescriptionoutputtypedef) 
2. See [:material-code-braces: CaptionDescriptionPresetTypeDef](./type_defs.md#captiondescriptionpresettypedef) [:material-code-braces: CaptionDescriptionPresetOutputTypeDef](./type_defs.md#captiondescriptionpresetoutputtypedef) 
3. See [:material-code-braces: ContainerSettingsTypeDef](./type_defs.md#containersettingstypedef) [:material-code-braces: ContainerSettingsOutputTypeDef](./type_defs.md#containersettingsoutputtypedef) 
4. See [:material-code-braces: VideoDescriptionTypeDef](./type_defs.md#videodescriptiontypedef) [:material-code-braces: VideoDescriptionOutputTypeDef](./type_defs.md#videodescriptionoutputtypedef) 
...
1. See [:material-code-brackets: AdvancedInputFilterType](./literals.md#advancedinputfiltertype) 
2. See [:material-code-braces: AdvancedInputFilterSettingsTypeDef](./type_defs.md#advancedinputfiltersettingstypedef) 
3. See [:material-code-braces: AudioSelectorGroupTypeDef](./type_defs.md#audioselectorgrouptypedef) [:material-code-braces: AudioSelectorGroupOutputTypeDef](./type_defs.md#audioselectorgroupoutputtypedef) 
4. See [:material-code-braces: AudioSelectorTypeDef](./type_defs.md#audioselectortypedef) [:material-code-braces: AudioSelectorOutputTypeDef](./type_defs.md#audioselectoroutputtypedef) 
5. See [:material-code-braces: CaptionSelectorTypeDef](./type_defs.md#captionselectortypedef) 
6. See [:material-code-braces: RectangleTypeDef](./type_defs.md#rectangletypedef) 
7. See [:material-code-brackets: InputDeblockFilterType](./literals.md#inputdeblockfiltertype) 
8. See [:material-code-brackets: InputDenoiseFilterType](./literals.md#inputdenoisefiltertype) 
9. See [:material-code-brackets: InputFilterEnableType](./literals.md#inputfilterenabletype) 
10. See [:material-code-braces: ImageInserterTypeDef](./type_defs.md#imageinsertertypedef) [:material-code-braces: ImageInserterOutputTypeDef](./type_defs.md#imageinserteroutputtypedef) 
11. See [:material-code-braces: InputClippingTypeDef](./type_defs.md#inputclippingtypedef) 
12. See [:material-code-brackets: InputScanTypeType](./literals.md#inputscantypetype) 
13. See [:material-code-braces: RectangleTypeDef](./type_defs.md#rectangletypedef) 
14. See [:material-code-brackets: InputPsiControlType](./literals.md#inputpsicontroltype) 
15. See [:material-code-brackets: InputTimecodeSourceType](./literals.md#inputtimecodesourcetype) 
16. See [:material-code-braces: VideoOverlayTypeDef](./type_defs.md#videooverlaytypedef) [:material-code-braces: VideoOverlayOutputTypeDef](./type_defs.md#videooverlayoutputtypedef) 
17. See [:material-code-braces: VideoSelectorTypeDef](./type_defs.md#videoselectortypedef) 
## InputTypeDef
...
9. See [:material-code-brackets: InputDenoiseFilterType](./literals.md#inputdenoisefiltertype) 
10. See [:material-code-brackets: InputFilterEnableType](./literals.md#inputfilterenabletype) 
11. See [:material-code-braces: ImageInserterTypeDef](./type_defs.md#imageinsertertypedef) [:material-code-braces: ImageInserterOutputTypeDef](./type_defs.md#imageinserteroutputtypedef) 
12. See [:material-code-braces: InputClippingTypeDef](./type_defs.md#inputclippingtypedef) 
13. See [:material-code-brackets: InputScanTypeType](./literals.md#inputscantypetype) 
14. See [:material-code-braces: RectangleTypeDef](./type_defs.md#rectangletypedef) 
15. See [:material-code-brackets: InputPsiControlType](./literals.md#inputpsicontroltype) 
16. See [:material-code-brackets: InputTimecodeSourceType](./literals.md#inputtimecodesourcetype) 
17. See [:material-code-braces: InputVideoGeneratorTypeDef](./type_defs.md#inputvideogeneratortypedef) 
18. See [:material-code-braces: VideoOverlayTypeDef](./type_defs.md#videooverlaytypedef) [:material-code-braces: VideoOverlayOutputTypeDef](./type_defs.md#videooverlayoutputtypedef) 
19. See [:material-code-braces: VideoSelectorTypeDef](./type_defs.md#videoselectortypedef) 
...
1. See [:material-code-braces: AutomatedEncodingSettingsTypeDef](./type_defs.md#automatedencodingsettingstypedef) [:material-code-braces: AutomatedEncodingSettingsOutputTypeDef](./type_defs.md#automatedencodingsettingsoutputtypedef) 
2. See [:material-code-braces: OutputGroupSettingsTypeDef](./type_defs.md#outputgroupsettingstypedef) [:material-code-braces: OutputGroupSettingsOutputTypeDef](./type_defs.md#outputgroupsettingsoutputtypedef) 
...
3. See [:material-code-braces: EsamSettingsTypeDef](./type_defs.md#esamsettingstypedef) 
4. See [:material-code-braces: ExtendedDataServicesTypeDef](./type_defs.md#extendeddataservicestypedef) 
5. See [:material-code-braces: InputTypeDef](./type_defs.md#inputtypedef) [:material-code-braces: InputOutputTypeDef](./type_defs.md#inputoutputtypedef) 
6. See [:material-code-braces: KantarWatermarkSettingsTypeDef](./type_defs.md#kantarwatermarksettingstypedef) 
7. See [:material-code-braces: MotionImageInserterTypeDef](./type_defs.md#motionimageinsertertypedef) 
8. See [:material-code-braces: NielsenConfigurationTypeDef](./type_defs.md#nielsenconfigurationtypedef) 
9. See [:material-code-braces: NielsenNonLinearWatermarkSettingsTypeDef](./type_defs.md#nielsennonlinearwatermarksettingstypedef) 
...
11. See [:material-code-braces: TimecodeConfigTypeDef](./type_defs.md#timecodeconfigtypedef) 
12. See [:material-code-braces: TimedMetadataInsertionTypeDef](./type_defs.md#timedmetadatainsertiontypedef) [:material-code-braces: TimedMetadataInsertionOutputTypeDef](./type_defs.md#timedmetadatainsertionoutputtypedef) 
...
3. See [:material-code-braces: EsamSettingsTypeDef](./type_defs.md#esamsettingstypedef) 
4. See [:material-code-braces: ExtendedDataServicesTypeDef](./type_defs.md#extendeddataservicestypedef) 
5. See [:material-code-braces: InputTemplateTypeDef](./type_defs.md#inputtemplatetypedef) [:material-code-braces: InputTemplateOutputTypeDef](./type_defs.md#inputtemplateoutputtypedef) 
6. See [:material-code-braces: KantarWatermarkSettingsTypeDef](./type_defs.md#kantarwatermarksettingstypedef) 
7. See [:material-code-braces: MotionImageInserterTypeDef](./type_defs.md#motionimageinsertertypedef) 
8. See [:material-code-braces: NielsenConfigurationTypeDef](./type_defs.md#nielsenconfigurationtypedef) 
9. See [:material-code-braces: NielsenNonLinearWatermarkSettingsTypeDef](./type_defs.md#nielsennonlinearwatermarksettingstypedef) 
