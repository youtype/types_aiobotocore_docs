...
```python
# BatchLoadDataFormatType definition
...
```python
# BatchLoadStatusType usage example
from types_aiobotocore_timestream_write.literals import BatchLoadStatusType
...
```python
# BatchLoadStatusType definition
...
```python
# PartitionKeyEnforcementLevelType usage example
from types_aiobotocore_timestream_write.literals import PartitionKeyEnforcementLevelType

def get_value() -> PartitionKeyEnforcementLevelType:
    return "OPTIONAL"
```

```python
# PartitionKeyEnforcementLevelType definition
PartitionKeyEnforcementLevelType = Literal[
    "OPTIONAL",
    "REQUIRED",
]
```
...
```python
# PartitionKeyTypeType usage example
from types_aiobotocore_timestream_write.literals import PartitionKeyTypeType

def get_value() -> PartitionKeyTypeType:
    return "DIMENSION"
```

```python
# PartitionKeyTypeType definition
PartitionKeyTypeType = Literal[
    "DIMENSION",
    "MEASURE",
]
```
...
from types_aiobotocore_timestream_write.literals import ScalarMeasureValueTypeType
...
```python
# TimestreamWriteServiceName usage example
...
```python
# TimestreamWriteServiceName definition
...
from types_aiobotocore_timestream_write.literals import RegionName
