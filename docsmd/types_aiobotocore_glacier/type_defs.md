...
```python
# VaultNotificationConfigNotificationTypeDef definition

class VaultNotificationConfigNotificationTypeDef(TypedDict):
    SNSTopic: NotRequired[str],
...
```python
# InventoryRetrievalJobDescriptionResponseTypeDef definition

class InventoryRetrievalJobDescriptionResponseTypeDef(TypedDict):
    Format: str,
    StartDate: str,
    EndDate: str,
    Limit: str,
...
class SetVaultNotificationsInputNotificationSetTypeDef(TypedDict):
    vaultNotificationConfig: NotRequired[VaultNotificationConfigNotificationTypeDef],  # (1)
```
...
```python
# SelectParametersResponseTypeDef definition

class SelectParametersResponseTypeDef(TypedDict):
...
```python
# OutputLocationResponseTypeDef definition

class OutputLocationResponseTypeDef(TypedDict):
