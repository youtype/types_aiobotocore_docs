...
def get_value() -> IoTSecureTunnelingServiceName:
    return "iotsecuretunneling"
```

```python
# IoTSecureTunnelingServiceName definition
IoTSecureTunnelingServiceName = Literal[
    "iotsecuretunneling",
]
```
## ServiceName
...
from types_aiobotocore_iotsecuretunneling.literals import RegionName
