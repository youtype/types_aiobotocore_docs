...
- `secondary_interfaces`: `Awaitable`[`list`[[InstanceSecondaryInterfaceTypeDef](./type_defs.md#instancesecondaryinterfacetypedef)]]
- `instance_id`: `Awaitable`[`str`]
- `image_id`: `Awaitable`[`str`]
...
- `create_time`: `Awaitable`[`datetime.datetime`]
- `key_name`: `Awaitable`[`str`]
- `key_fingerprint`: `Awaitable`[`str`]
- `meta`: `EC2ResourceMeta`
...
- `private_dns_name`: `Awaitable`[`str`]
- `public_dns_name`: `Awaitable`[`str`]
- `public_ip_dns_name_options`: `Awaitable`[[PublicIpDnsNameOptionsTypeDef](./type_defs.md#publicipdnsnameoptionstypedef)]
- `private_ip_address`: `Awaitable`[`str`]
...
- `restore_expiry_time`: `Awaitable`[`datetime.datetime`]
- `sse_type`: `Awaitable`[[SSETypeType](./literals.md#ssetypetype)]
- `availability_zone`: `Awaitable`[`str`]
- `transfer_type`: `Awaitable`[[TransferTypeType](./literals.md#transfertypetype)]
- `completion_duration_minutes`: `Awaitable`[`int`]
- `completion_time`: `Awaitable`[`datetime.datetime`]
...
- `start_time`: `Awaitable`[`datetime.datetime`]
...
- `block_public_access_states`: `Awaitable`[[BlockPublicAccessStatesTypeDef](./type_defs.md#blockpublicaccessstatestypedef)]
- `type`: `Awaitable`[`str`]
- `subnet_id`: `Awaitable`[`str`]
...
- `is_default`: `Awaitable`[`bool`]
- `encryption_control`: `Awaitable`[[VpcEncryptionControlTypeDef](./type_defs.md#vpcencryptioncontroltypedef)]
- `tags`: `Awaitable`[`list`[[TagTypeDef](./type_defs.md#tagtypedef)]]
- `block_public_access_states`: `Awaitable`[[BlockPublicAccessStatesTypeDef](./type_defs.md#blockpublicaccessstatestypedef)]
- `vpc_id`: `Awaitable`[`str`]
...
- `expiration_time`: `Awaitable`[`datetime.datetime`]
