...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/medical-imaging.html#HealthImaging.Paginator.ListDICOMImportJobs)
...
1. See [:material-code-braces: ListDICOMImportJobsRequestListDICOMImportJobsPaginateTypeDef](./type_defs.md#listdicomimportjobsrequestlistdicomimportjobspaginatetypedef) 
## ListDatastoresPaginator

Type annotations and code completion for `#!python session.create_client("medical-imaging").get_paginator("list_datastores")`.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/medical-imaging.html#HealthImaging.Paginator.ListDatastores)
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/medical-imaging.html#HealthImaging.Paginator.ListImageSetVersions)
...
1. See [:material-code-braces: ListImageSetVersionsRequestListImageSetVersionsPaginateTypeDef](./type_defs.md#listimagesetversionsrequestlistimagesetversionspaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/medical-imaging.html#HealthImaging.Paginator.SearchImageSets)
...
1. See [:material-code-braces: SearchImageSetsRequestSearchImageSetsPaginateTypeDef](./type_defs.md#searchimagesetsrequestsearchimagesetspaginatetypedef) 
