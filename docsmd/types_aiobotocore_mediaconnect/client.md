...
async with session.create_client("mediaconnect") as client:
    try:
        ...
        client.RouterInputServiceQuotaExceededException,
        client.RouterNetworkInterfaceServiceQuotaExceededException,
        client.RouterOutputServiceQuotaExceededException,
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").batch_get_router_input` method.
...
await def batch_get_router_input(
    self,
    *,
    Arns: Sequence[str],
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").batch_get_router_network_interface` method.
...
await def batch_get_router_network_interface(
    self,
    *,
    Arns: Sequence[str],
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").batch_get_router_output` method.
...
await def batch_get_router_output(
    self,
    *,
    Arns: Sequence[str],
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").create_router_input` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").create_router_network_interface` method.
...
await def create_router_network_interface(
    self,
    *,
    Name: str,
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").create_router_output` method.
...
await def create_router_output(
    self,
    *,
    Name: str,
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").delete_router_input` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").delete_router_network_interface` method.
...
await def delete_router_network_interface(
    self,
    *,
    Arn: str,
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").delete_router_output` method.
...
await def delete_router_output(
    self,
    *,
    Arn: str,
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").get_router_input` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").get_router_input_source_metadata` method.
...
await def get_router_input_source_metadata(
    self,
    *,
    Arn: str,
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").get_router_input_thumbnail` method.
...
await def get_router_input_thumbnail(
    self,
    *,
    Arn: str,
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").get_router_network_interface` method.
...
await def get_router_network_interface(
    self,
    *,
    Arn: str,
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").get_router_output` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").list_flows` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").list_offerings` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").list_router_inputs` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").list_router_network_interfaces` method.
...
await def list_router_network_interfaces(
    self,
    *,
    MaxResults: int = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").list_router_outputs` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").list_tags_for_global_resource` method.
...
await def list_tags_for_global_resource(
    self,
    *,
    ResourceArn: str,
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").purchase_offering` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").restart_router_input` method.
...
await def restart_router_input(
    self,
    *,
    Arn: str,
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").restart_router_output` method.
...
await def restart_router_output(
    self,
    *,
    Arn: str,
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").start_router_input` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").start_router_output` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").stop_flow` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").stop_router_input` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").stop_router_output` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").tag_global_resource` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").take_router_input` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").untag_global_resource` method.
...
await def untag_global_resource(
    self,
    *,
    ResourceArn: str,
...
await def update_flow_source(
    ...
    *,
    ...
    RouterIntegrationState: StateType = ...,  # (5)
    RouterIntegrationTransitDecryption: FlowTransitEncryptionUnionTypeDef = ...,  # (6)
) -> UpdateFlowSourceResponseTypeDef:  # (7)
    ...
```
...
7. See [:material-code-braces: UpdateFlowSourceResponseTypeDef](./type_defs.md#updateflowsourceresponsetypedef)
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").update_router_input` method.
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").update_router_network_interface` method.
...
await def update_router_network_interface(
    self,
    *,
    Arn: str,
    Name: str = ...,
...
Type annotations and code completion for `#!python session.create_client("mediaconnect").update_router_output` method.
...
await def update_router_output(
    self,
    *,
    Arn: str,
    Name: str = ...,
