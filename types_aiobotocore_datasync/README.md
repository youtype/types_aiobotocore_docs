<a id="type-annotations-for-aiobotocore-datasync-module"></a>
...
pip install 'types-aiobotocore[datasync]'
...
Type annotations for `aiobotocore.create_client("datasync")` as
...
```python
from types_aiobotocore_datasync.paginators import ListAgentsPaginator, ...
```
