...
```python
# AttachedPermissionsBoundaryResponseTypeDef definition

class AttachedPermissionsBoundaryResponseTypeDef(TypedDict):
...
```python
# RoleLastUsedResponseTypeDef definition

class RoleLastUsedResponseTypeDef(TypedDict):
    LastUsedDate: datetime,
    Region: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (1)
```
...
```python
# ServerCertificateMetadataResponseTypeDef definition

class ServerCertificateMetadataResponseTypeDef(TypedDict):
    Path: str,
    ServerCertificateName: str,
    ServerCertificateId: str,
    Arn: str,
...
```python
# ListInstanceProfileTagsRequestListInstanceProfileTagsPaginateTypeDef definition

class ListInstanceProfileTagsRequestListInstanceProfileTagsPaginateTypeDef(TypedDict):
    InstanceProfileName: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListMFADeviceTagsRequestListMFADeviceTagsPaginateTypeDef definition

class ListMFADeviceTagsRequestListMFADeviceTagsPaginateTypeDef(TypedDict):
    SerialNumber: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListOpenIDConnectProviderTagsRequestListOpenIDConnectProviderTagsPaginateTypeDef definition

class ListOpenIDConnectProviderTagsRequestListOpenIDConnectProviderTagsPaginateTypeDef(TypedDict):
    OpenIDConnectProviderArn: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListPolicyTagsRequestListPolicyTagsPaginateTypeDef definition

class ListPolicyTagsRequestListPolicyTagsPaginateTypeDef(TypedDict):
    PolicyArn: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListRoleTagsRequestListRoleTagsPaginateTypeDef definition

class ListRoleTagsRequestListRoleTagsPaginateTypeDef(TypedDict):
    RoleName: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListSAMLProviderTagsRequestListSAMLProviderTagsPaginateTypeDef definition

class ListSAMLProviderTagsRequestListSAMLProviderTagsPaginateTypeDef(TypedDict):
    SAMLProviderArn: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListServerCertificateTagsRequestListServerCertificateTagsPaginateTypeDef definition

class ListServerCertificateTagsRequestListServerCertificateTagsPaginateTypeDef(TypedDict):
    ServerCertificateName: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# SimulateCustomPolicyRequestSimulateCustomPolicyPaginateTypeDef definition
...
```python
# SimulatePrincipalPolicyRequestSimulatePrincipalPolicyPaginateTypeDef definition
...
```python
# GetInstanceProfileRequestInstanceProfileExistsWaitTypeDef definition
...
```python
# GetPolicyRequestPolicyExistsWaitTypeDef definition
...
```python
# GetRoleRequestRoleExistsWaitTypeDef definition
...
```python
# GetUserRequestUserExistsWaitTypeDef definition
...
class PolicyDocumentTypeDef(TypedDict):
    Version: str,
...
1. See [:material-code-braces: PolicyDocumentTypeDef](./type_defs.md#policydocumenttypedef) 
