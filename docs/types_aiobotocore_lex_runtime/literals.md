<a id="literals-for-aiobotocore-lexruntimeservice-module"></a>

# Literals for aiobotocore LexRuntimeService module
...
- [Literals for aiobotocore LexRuntimeService module](#literals-for-aiobotocore-lexruntimeservice-module)
...
```python
from types_aiobotocore_lex_runtime.literals import ContentTypeType
```
...
```python
from types_aiobotocore_lex_runtime.literals import DialogActionTypeType
```
...
```python
from types_aiobotocore_lex_runtime.literals import DialogStateType
```
...
```python
from types_aiobotocore_lex_runtime.literals import FulfillmentStateType
```
...
```python
from types_aiobotocore_lex_runtime.literals import MessageFormatTypeType
```
...
```python
from types_aiobotocore_lex_runtime.literals import LexRuntimeServiceServiceName
```
...
```python
from types_aiobotocore_lex_runtime.literals import ServiceName
```
...
```python
from types_aiobotocore_lex_runtime.literals import ResourceServiceName
```
