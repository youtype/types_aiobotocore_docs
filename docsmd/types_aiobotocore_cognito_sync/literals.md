...
```python
# BulkPublishStatusType definition
BulkPublishStatusType = Literal[
    "FAILED",
    "IN_PROGRESS",
    "NOT_STARTED",
    "SUCCEEDED",
...
from types_aiobotocore_cognito_sync.literals import OperationType
...
from types_aiobotocore_cognito_sync.literals import PlatformType
...
from types_aiobotocore_cognito_sync.literals import StreamingStatusType
...
```python
# CognitoSyncServiceName usage example
from types_aiobotocore_cognito_sync.literals import CognitoSyncServiceName

def get_value() -> CognitoSyncServiceName:
    return "cognito-sync"
```

```python
# CognitoSyncServiceName definition
CognitoSyncServiceName = Literal[
    "cognito-sync",
]
```
## ServiceName
...
from types_aiobotocore_cognito_sync.literals import ServiceName
...
from types_aiobotocore_cognito_sync.literals import ResourceServiceName
...
from types_aiobotocore_cognito_sync.literals import RegionName
