...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/verifiedpermissions.html#VerifiedPermissions.Paginator.ListIdentitySources)
...
) -> AsyncIterator[ListIdentitySourcesOutputTypeDef]:  # (3)
    ...
```
...
kwargs: ListIdentitySourcesInputListIdentitySourcesPaginateTypeDef = {  # (1)
    "policyStoreId": ...,
}
...
1. See [:material-code-braces: ListIdentitySourcesInputListIdentitySourcesPaginateTypeDef](./type_defs.md#listidentitysourcesinputlistidentitysourcespaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/verifiedpermissions.html#VerifiedPermissions.Paginator.ListPolicies)
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListPoliciesOutputTypeDef]:  # (3)
    ...
```
...
kwargs: ListPoliciesInputListPoliciesPaginateTypeDef = {  # (1)
    "policyStoreId": ...,
}
...
1. See [:material-code-braces: ListPoliciesInputListPoliciesPaginateTypeDef](./type_defs.md#listpoliciesinputlistpoliciespaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/verifiedpermissions.html#VerifiedPermissions.Paginator.ListPolicyStores)
...
) -> AsyncIterator[ListPolicyStoresOutputTypeDef]:  # (2)
    ...
```
...
kwargs: ListPolicyStoresInputListPolicyStoresPaginateTypeDef = {  # (1)
    "PaginationConfig": ...,
}
...
1. See [:material-code-braces: ListPolicyStoresInputListPolicyStoresPaginateTypeDef](./type_defs.md#listpolicystoresinputlistpolicystorespaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/verifiedpermissions.html#VerifiedPermissions.Paginator.ListPolicyTemplates)
...
def paginate(
    ...
    *,
    policyStoreId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListPolicyTemplatesOutputTypeDef]:  # (2)
    ...
```
...
kwargs: ListPolicyTemplatesInputListPolicyTemplatesPaginateTypeDef = {  # (1)
    "policyStoreId": ...,
}
...
1. See [:material-code-braces: ListPolicyTemplatesInputListPolicyTemplatesPaginateTypeDef](./type_defs.md#listpolicytemplatesinputlistpolicytemplatespaginatetypedef) 
