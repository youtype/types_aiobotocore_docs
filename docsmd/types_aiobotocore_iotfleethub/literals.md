...
from types_aiobotocore_iotfleethub.literals import ListApplicationsPaginatorName
...
```python
# IoTFleetHubServiceName usage example

from types_aiobotocore_iotfleethub.literals import IoTFleetHubServiceName

def get_value() -> IoTFleetHubServiceName:
    return "iotfleethub"
```

```python
# IoTFleetHubServiceName definition

IoTFleetHubServiceName = Literal[
    "iotfleethub",
]
```
## ServiceName
...
from types_aiobotocore_iotfleethub.literals import ServiceName
...
from types_aiobotocore_iotfleethub.literals import ResourceServiceName
...
from types_aiobotocore_iotfleethub.literals import RegionName
