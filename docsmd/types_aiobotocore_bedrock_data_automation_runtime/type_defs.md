...
from types_aiobotocore_bedrock_data_automation_runtime.type_defs import BlobTypeDef
...
from types_aiobotocore_bedrock_data_automation_runtime.type_defs import OutputSegmentTypeDef
...
from types_aiobotocore_bedrock_data_automation_runtime.type_defs import SyncInputConfigurationTypeDef
...
from types_aiobotocore_bedrock_data_automation_runtime.type_defs import InvokeDataAutomationResponseTypeDef
...
class InvokeDataAutomationResponseTypeDef(TypedDict):
    semanticModality: SemanticModalityType,  # (1)
    outputSegments: list[OutputSegmentTypeDef],  # (2)
    ResponseMetadata: ResponseMetadataTypeDef,  # (3)
```

1. See [:material-code-brackets: SemanticModalityType](./literals.md#semanticmodalitytype)
2. See `list[OutputSegmentTypeDef]`
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_bedrock_data_automation_runtime.type_defs import InvokeDataAutomationRequestTypeDef
