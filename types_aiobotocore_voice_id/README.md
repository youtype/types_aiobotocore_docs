<a id="type-annotations-for-aiobotocore-voiceid-module"></a>
...
pip install 'types-aiobotocore[voice-id]'
...
Type annotations for `aiobotocore.create_client("voice-id")` as
