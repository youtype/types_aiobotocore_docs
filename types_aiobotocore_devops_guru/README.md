<a id="type-annotations-for-aiobotocore-devopsguru-module"></a>

# Type annotations for aiobotocore DevOpsGuru module
...
pip install 'types-aiobotocore[devops-guru]'

# install as a standalone
pip install types-aiobotocore-devops-guru
```

- [Type annotations for aiobotocore DevOpsGuru module](#type-annotations-for-aiobotocore-devopsguru-module)
...
Type annotations for `aiobotocore.create_client("devops-guru")` as
...
```python
from types_aiobotocore_devops_guru.paginators import DescribeOrganizationResourceCollectionHealthPaginator, ...
```
