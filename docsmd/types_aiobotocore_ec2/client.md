...
Type annotations and code completion for `#!python session.create_client("ec2").create_image_usage_report` method.
...
await def create_image_usage_report(
    self,
    *,
    ImageId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").create_local_gateway_virtual_interface` method.
...
await def create_local_gateway_virtual_interface(
    self,
    *,
    LocalGatewayVirtualInterfaceGroupId: str,
    OutpostLagId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").create_local_gateway_virtual_interface_group` method.
...
await def create_local_gateway_virtual_interface_group(
    self,
    *,
    LocalGatewayId: str,
    LocalBgpAsn: int = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").create_mac_system_integrity_protection_modification_task` method.
...
await def create_mac_system_integrity_protection_modification_task(
    self,
    *,
    InstanceId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").create_route_server` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").create_route_server_endpoint` method.
...
await def create_route_server_endpoint(
    self,
    *,
    RouteServerId: str,
    SubnetId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").create_route_server_peer` method.
...
await def create_route_server_peer(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").create_vpc_block_public_access_exclusion` method.
...
await def create_vpc_block_public_access_exclusion(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_image_usage_report` method.
...
await def delete_image_usage_report(
    self,
    *,
    ReportId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_local_gateway_virtual_interface` method.
...
await def delete_local_gateway_virtual_interface(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_local_gateway_virtual_interface_group` method.
...
await def delete_local_gateway_virtual_interface_group(
    self,
    *,
    LocalGatewayVirtualInterfaceGroupId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_route_server` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_route_server_endpoint` method.
...
await def delete_route_server_endpoint(
    self,
    *,
    RouteServerEndpointId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_route_server_peer` method.
...
await def delete_route_server_peer(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").delete_vpc_block_public_access_exclusion` method.
...
await def delete_vpc_block_public_access_exclusion(
    self,
    *,
    ExclusionId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_capacity_block_extension_history` method.
...
await def describe_capacity_block_extension_history(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_capacity_block_extension_offerings` method.
...
await def describe_capacity_block_extension_offerings(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_capacity_block_status` method.
...
await def describe_capacity_block_status(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_capacity_blocks` method.
...
await def describe_capacity_blocks(
    self,
    *,
    CapacityBlockIds: Sequence[str] = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_declarative_policies_reports` method.
...
await def describe_declarative_policies_reports(
    self,
    *,
    DryRun: bool = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_image_references` method.
...
await def describe_image_references(
    self,
    *,
    ImageIds: Sequence[str],
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_image_usage_report_entries` method.
...
await def describe_image_usage_report_entries(
    self,
    *,
    ImageIds: Sequence[str] = ...,
    ReportIds: Sequence[str] = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_image_usage_reports` method.
...
await def describe_image_usage_reports(
    self,
    *,
    ImageIds: Sequence[str] = ...,
    ReportIds: Sequence[str] = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_mac_modification_tasks` method.
...
await def describe_mac_modification_tasks(
    self,
    *,
    DryRun: bool = ...,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_outpost_lags` method.
...
await def describe_outpost_lags(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_route_server_endpoints` method.
...
await def describe_route_server_endpoints(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_route_server_peers` method.
...
await def describe_route_server_peers(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_route_servers` method.
...
await def describe_route_servers(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_security_group_vpc_associations` method.
...
await def describe_security_group_vpc_associations(
    self,
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_service_link_virtual_interfaces` method.
...
await def describe_service_link_virtual_interfaces(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpc_block_public_access_exclusions` method.
...
await def describe_vpc_block_public_access_exclusions(
    self,
    *,
    DryRun: bool = ...,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpc_block_public_access_options` method.
...
await def describe_vpc_block_public_access_options(
    self,
    *,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").describe_vpc_endpoint_associations` method.
...
await def describe_vpc_endpoint_associations(
    self,
    *,
    DryRun: bool = ...,
    VpcEndpointIds: Sequence[str] = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_allowed_images_settings` method.
...
await def disable_allowed_images_settings(
    self,
    *,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").disable_route_server_propagation` method.
...
await def disable_route_server_propagation(
    self,
    *,
    RouteServerId: str,
    RouteTableId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_route_server` method.
...
await def disassociate_route_server(
    self,
    *,
    RouteServerId: str,
    VpcId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").disassociate_security_group_vpc` method.
...
await def disassociate_security_group_vpc(
    self,
    *,
    GroupId: str,
    VpcId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_allowed_images_settings` method.
...
await def enable_allowed_images_settings(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").enable_route_server_propagation` method.
...
await def enable_route_server_propagation(
    self,
    *,
    RouteServerId: str,
    RouteTableId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").export_verified_access_instance_client_configuration` method.
...
await def export_verified_access_instance_client_configuration(
    self,
    *,
    VerifiedAccessInstanceId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_active_vpn_tunnel_status` method.
...
await def get_active_vpn_tunnel_status(
    self,
    *,
    VpnConnectionId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_allowed_images_settings` method.
...
await def get_allowed_images_settings(
    self,
    *,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_declarative_policies_report_summary` method.
...
await def get_declarative_policies_report_summary(
    self,
    *,
    ReportId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_route_server_associations` method.
...
await def get_route_server_associations(
    self,
    *,
    RouteServerId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_route_server_propagations` method.
...
await def get_route_server_propagations(
    self,
    *,
    RouteServerId: str,
    RouteTableId: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_route_server_routing_database` method.
...
await def get_route_server_routing_database(
    self,
    *,
    RouteServerId: str,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").get_verified_access_endpoint_targets` method.
...
await def get_verified_access_endpoint_targets(
    self,
    *,
    VerifiedAccessEndpointId: str,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_instance_connect_endpoint` method.
...
await def modify_instance_connect_endpoint(
    self,
    *,
    InstanceConnectEndpointId: str,
    DryRun: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_instance_network_performance_options` method.
...
await def modify_instance_network_performance_options(
    self,
    *,
    InstanceId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_public_ip_dns_name_options` method.
...
await def modify_public_ip_dns_name_options(
    self,
    *,
    NetworkInterfaceId: str,
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_route_server` method.
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_vpc_block_public_access_exclusion` method.
...
await def modify_vpc_block_public_access_exclusion(
    self,
    *,
    ExclusionId: str,
    InternetGatewayExclusionMode: InternetGatewayExclusionModeType,  # (1)
...
Type annotations and code completion for `#!python session.create_client("ec2").modify_vpc_block_public_access_options` method.
...
await def modify_vpc_block_public_access_options(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").purchase_capacity_block_extension` method.
...
await def purchase_capacity_block_extension(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").replace_image_criteria_in_allowed_images_settings` method.
...
await def replace_image_criteria_in_allowed_images_settings(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("ec2").start_declarative_policies_report` method.
...
await def start_declarative_policies_report(
    self,
    *,
    S3Bucket: str,
    TargetId: str,
