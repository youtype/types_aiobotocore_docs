<a id="typed-dictionaries-for-aiobotocore-transcribeservice-module"></a>

# Typed dictionaries for aiobotocore TranscribeService module
...
- [Typed dictionaries for aiobotocore TranscribeService module](#typed-dictionaries-for-aiobotocore-transcribeservice-module)
...
```python
from types_aiobotocore_transcribe.type_defs import CreateLanguageModelRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import CreateMedicalVocabularyRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import CreateVocabularyFilterRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import CreateVocabularyRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import DeleteCallAnalyticsCategoryRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import DeleteCallAnalyticsJobRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import DeleteLanguageModelRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import DeleteMedicalTranscriptionJobRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import DeleteMedicalVocabularyRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import DeleteTranscriptionJobRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import DeleteVocabularyFilterRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import DeleteVocabularyRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import DescribeLanguageModelRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import GetCallAnalyticsCategoryRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import GetCallAnalyticsJobRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import GetMedicalTranscriptionJobRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import GetMedicalVocabularyRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import GetTranscriptionJobRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import GetVocabularyFilterRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import GetVocabularyRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import ListCallAnalyticsCategoriesRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import ListCallAnalyticsJobsRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import ListLanguageModelsRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import ListMedicalTranscriptionJobsRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import ListMedicalVocabulariesRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import ListTagsForResourceRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import ListTranscriptionJobsRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import ListVocabulariesRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import ListVocabularyFiltersRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import StartCallAnalyticsJobRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import StartMedicalTranscriptionJobRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import StartTranscriptionJobRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import TagResourceRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import UntagResourceRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import UpdateCallAnalyticsCategoryRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import UpdateCallAnalyticsCategoryResponseTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import UpdateMedicalVocabularyRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import UpdateVocabularyFilterRequestRequestTypeDef
```
...
```python
from types_aiobotocore_transcribe.type_defs import UpdateVocabularyRequestRequestTypeDef
```
