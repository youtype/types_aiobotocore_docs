...
class CreateGuardrailRequestTypeDef(TypedDict):
    ...
    crossRegionConfig: NotRequired[GuardrailCrossRegionConfigTypeDef],  # (6)
...
6. See [:material-code-braces: GuardrailCrossRegionConfigTypeDef](./type_defs.md#guardrailcrossregionconfigtypedef)
...
class GetGuardrailResponseTypeDef(TypedDict):
    ...
    crossRegionDetails: GuardrailCrossRegionDetailsTypeDef,  # (7)
    createdAt: datetime.datetime,
    updatedAt: datetime.datetime,
...
7. See [:material-code-braces: GuardrailCrossRegionDetailsTypeDef](./type_defs.md#guardrailcrossregiondetailstypedef)
