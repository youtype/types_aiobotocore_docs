...
> [Index](../README.md) > [Inspectorscan](./README.md) > Literals
...
```
## InspectorscanServiceName

```python
# InspectorscanServiceName usage example
from types_aiobotocore_inspector_scan.literals import InspectorscanServiceName

def get_value() -> InspectorscanServiceName:
    return "inspector-scan"
```

```python
# InspectorscanServiceName definition
InspectorscanServiceName = Literal[
    "inspector-scan",
]
```
## ServiceName
...
from types_aiobotocore_inspector_scan.literals import ServiceName
...
from types_aiobotocore_inspector_scan.literals import ResourceServiceName
