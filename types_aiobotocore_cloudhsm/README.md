<a id="type-annotations-for-aiobotocore-cloudhsm-module"></a>

# Type annotations for aiobotocore CloudHSM module
...
pip install 'types-aiobotocore[cloudhsm]'

# install as a standalone
pip install types-aiobotocore-cloudhsm
```

- [Type annotations for aiobotocore CloudHSM module](#type-annotations-for-aiobotocore-cloudhsm-module)
...
Type annotations for `aiobotocore.create_client("cloudhsm")` as
...
```python
from types_aiobotocore_cloudhsm.paginators import ListHapgsPaginator, ...
```
