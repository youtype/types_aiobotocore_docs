...
from types_aiobotocore_bedrock_data_automation_runtime.type_defs import GetDataAutomationStatusRequestRequestTypeDef
...
async with session.create_client("bedrock-data-automation-runtime") as client:
    ...
    kwargs: GetDataAutomationStatusRequestRequestTypeDef = {...}
