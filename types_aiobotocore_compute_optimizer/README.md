<a id="type-annotations-for-aiobotocore-computeoptimizer-module"></a>
...
pip install 'types-aiobotocore[compute-optimizer]'
...
Type annotations for `aiobotocore.create_client("compute-optimizer")` as
