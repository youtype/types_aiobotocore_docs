...
```python
# DescribeProtectConfigurationsRequestDescribeProtectConfigurationsPaginateTypeDef definition

class DescribeProtectConfigurationsRequestDescribeProtectConfigurationsPaginateTypeDef(TypedDict):
...
```python
# ListProtectConfigurationRuleSetNumberOverridesRequestListProtectConfigurationRuleSetNumberOverridesPaginateTypeDef definition

class ListProtectConfigurationRuleSetNumberOverridesRequestListProtectConfigurationRuleSetNumberOverridesPaginateTypeDef(TypedDict):
    ProtectConfigurationId: str,
