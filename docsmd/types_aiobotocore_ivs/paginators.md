...
Type annotations and code completion for `#!python session.create_client("ivs").get_paginator("list_ad_configurations")`.
...
3. item: `AioPageIterator[ListAdConfigurationsResponseTypeDef]`
...
) -> aiobotocore.paginate.AioPageIterator[ListAdConfigurationsResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `AioPageIterator[ListAdConfigurationsResponseTypeDef]`
