<a id="type-annotations-for-aiobotocore-mobile-module"></a>
...
Type annotations for `aiobotocore.create_client("mobile")` as
...
```python
from types_aiobotocore_mobile.paginators import ListBundlesPaginator, ...
```
