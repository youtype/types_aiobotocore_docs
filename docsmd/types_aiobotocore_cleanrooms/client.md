...
) -> CreateAnalysisTemplateOutputTypeDef:  # (5)
    ...
```
...
5. See [:material-code-braces: CreateAnalysisTemplateOutputTypeDef](./type_defs.md#createanalysistemplateoutputtypedef)
...
) -> CreateCollaborationOutputTypeDef:  # (9)
    ...
```
...
9. See [:material-code-braces: CreateCollaborationOutputTypeDef](./type_defs.md#createcollaborationoutputtypedef)
...
) -> StartProtectedJobOutputTypeDef:  # (4)
    ...
```
...
4. See [:material-code-braces: StartProtectedJobOutputTypeDef](./type_defs.md#startprotectedjoboutputtypedef)
...
await def update_configured_table(
    ...
    *,
    ...
    name: str = ...,
    description: str = ...,
    analysisMethod: AnalysisMethodType = ...,  # (1)
    selectedAnalysisMethods: Sequence[SelectedAnalysisMethodType] = ...,  # (2)
) -> UpdateConfiguredTableOutputTypeDef:  # (3)
    ...
```

1. See [:material-code-brackets: AnalysisMethodType](./literals.md#analysismethodtype)
2. See `Sequence[SelectedAnalysisMethodType]`
3. See [:material-code-braces: UpdateConfiguredTableOutputTypeDef](./type_defs.md#updateconfiguredtableoutputtypedef)
...
Type annotations and code completion for `#!python session.create_client("cleanrooms").update_protected_job` method.
...
await def update_protected_job(
    self,
    *,
    membershipIdentifier: str,
    protectedJobIdentifier: str,
