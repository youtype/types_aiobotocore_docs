...
Type annotations and code completion for  `#!python session.create_client("config")` as [ConfigServiceClient](./client.md)
...
- [ListResourceEvaluationsRequestListResourceEvaluationsPaginateTypeDef](./type_defs.md#listresourceevaluationsrequestlistresourceevaluationspaginatetypedef)
