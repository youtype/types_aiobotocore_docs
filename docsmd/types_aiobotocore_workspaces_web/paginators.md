...
) -> AsyncIterator[ListDataProtectionSettingsResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListDataProtectionSettingsRequestListDataProtectionSettingsPaginateTypeDef = {  # (1)
    "PaginationConfig": ...,
}
...
1. See [:material-code-braces: ListDataProtectionSettingsRequestListDataProtectionSettingsPaginateTypeDef](./type_defs.md#listdataprotectionsettingsrequestlistdataprotectionsettingspaginatetypedef) 
