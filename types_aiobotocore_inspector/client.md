<a id="inspectorclient-for-aiobotocore-inspector-module"></a>
...
Type annotations for `aiobotocore.create_client("inspector")`
...
Type annotations for `aiobotocore.create_client("inspector").exceptions`
method.
...
`aiobotocore.create_client("inspector").add_attributes_to_findings` method.
...
Type annotations for `aiobotocore.create_client("inspector").can_paginate`
method.
...
Type annotations for
`aiobotocore.create_client("inspector").create_assessment_target` method.
...
Type annotations for
`aiobotocore.create_client("inspector").create_assessment_template` method.
...
Type annotations for
`aiobotocore.create_client("inspector").create_exclusions_preview` method.
...
Type annotations for
`aiobotocore.create_client("inspector").create_resource_group` method.
...
Type annotations for
`aiobotocore.create_client("inspector").delete_assessment_run` method.
...
Type annotations for
`aiobotocore.create_client("inspector").delete_assessment_target` method.
...
Type annotations for
`aiobotocore.create_client("inspector").delete_assessment_template` method.
...
Type annotations for
`aiobotocore.create_client("inspector").describe_assessment_runs` method.
...
Type annotations for
`aiobotocore.create_client("inspector").describe_assessment_targets` method.
...
Asynchronous method. Use `await describe_assessment_targets(...)` for a
synchronous call.
...
Type annotations for
`aiobotocore.create_client("inspector").describe_assessment_templates` method.
...
Type annotations for
`aiobotocore.create_client("inspector").describe_cross_account_access_role`
method.
...
Type annotations for
`aiobotocore.create_client("inspector").describe_exclusions` method.
...
Type annotations for `aiobotocore.create_client("inspector").describe_findings`
method.
...
Type annotations for
`aiobotocore.create_client("inspector").describe_resource_groups` method.
...
Type annotations for
`aiobotocore.create_client("inspector").describe_rules_packages` method.
...
Type annotations for
`aiobotocore.create_client("inspector").generate_presigned_url` method.
...
Type annotations for
`aiobotocore.create_client("inspector").get_assessment_report` method.
...
Type annotations for
`aiobotocore.create_client("inspector").get_exclusions_preview` method.
...
Type annotations for
`aiobotocore.create_client("inspector").get_telemetry_metadata` method.
...
Type annotations for
`aiobotocore.create_client("inspector").list_assessment_run_agents` method.
...
Type annotations for
`aiobotocore.create_client("inspector").list_assessment_runs` method.
...
Type annotations for
`aiobotocore.create_client("inspector").list_assessment_targets` method.
...
Type annotations for
`aiobotocore.create_client("inspector").list_assessment_templates` method.
...
Type annotations for
`aiobotocore.create_client("inspector").list_event_subscriptions` method.
...
Type annotations for `aiobotocore.create_client("inspector").list_exclusions`
method.
...
Type annotations for `aiobotocore.create_client("inspector").list_findings`
method.
...
Type annotations for
`aiobotocore.create_client("inspector").list_rules_packages` method.
...
Type annotations for
`aiobotocore.create_client("inspector").list_tags_for_resource` method.
...
Type annotations for `aiobotocore.create_client("inspector").preview_agents`
method.
...
Type annotations for
`aiobotocore.create_client("inspector").register_cross_account_access_role`
method.
...
Asynchronous method. Use `await register_cross_account_access_role(...)` for a
synchronous call.
...
Type annotations for
`aiobotocore.create_client("inspector").remove_attributes_from_findings`
method.
...
Type annotations for
`aiobotocore.create_client("inspector").set_tags_for_resource` method.
...
Type annotations for
`aiobotocore.create_client("inspector").start_assessment_run` method.
...
Type annotations for
`aiobotocore.create_client("inspector").stop_assessment_run` method.
...
Type annotations for
`aiobotocore.create_client("inspector").subscribe_to_event` method.
...
Type annotations for
`aiobotocore.create_client("inspector").unsubscribe_from_event` method.
...
Type annotations for
`aiobotocore.create_client("inspector").update_assessment_target` method.
...
Type annotations for `aiobotocore.create_client("inspector").get_paginator`
