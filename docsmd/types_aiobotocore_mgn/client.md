...
Type annotations and code completion for `#!python session.create_client("mgn").create_network_migration_definition` method.
...
await def create_network_migration_definition(
    self,
    *,
    name: str,
...
) -> NetworkMigrationDefinitionTypeDef:  # (5)
    ...
```
...
5. See [:material-code-braces: NetworkMigrationDefinitionTypeDef](./type_defs.md#networkmigrationdefinitiontypedef)
...
Type annotations and code completion for `#!python session.create_client("mgn").delete_network_migration_definition` method.
...
await def delete_network_migration_definition(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("mgn").finalize_cutover` method.
...
Type annotations and code completion for `#!python session.create_client("mgn").get_network_migration_definition` method.
...
await def get_network_migration_definition(
    self,
    *,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").get_network_migration_mapper_segment_construct` method.
...
await def get_network_migration_mapper_segment_construct(
    self,
    *,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").list_connectors` method.
...
Type annotations and code completion for `#!python session.create_client("mgn").list_import_file_enrichments` method.
...
await def list_import_file_enrichments(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("mgn").list_network_migration_analyses` method.
...
await def list_network_migration_analyses(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").list_network_migration_analysis_results` method.
...
await def list_network_migration_analysis_results(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").list_network_migration_code_generation_segments` method.
...
await def list_network_migration_code_generation_segments(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").list_network_migration_code_generations` method.
...
await def list_network_migration_code_generations(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").list_network_migration_definitions` method.
...
await def list_network_migration_definitions(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("mgn").list_network_migration_deployed_stacks` method.
...
await def list_network_migration_deployed_stacks(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").list_network_migration_deployments` method.
...
await def list_network_migration_deployments(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").list_network_migration_executions` method.
...
await def list_network_migration_executions(
    self,
    *,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").list_network_migration_mapper_segment_constructs` method.
...
await def list_network_migration_mapper_segment_constructs(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").list_network_migration_mapper_segments` method.
...
await def list_network_migration_mapper_segments(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").list_network_migration_mapping_updates` method.
...
await def list_network_migration_mapping_updates(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").list_network_migration_mappings` method.
...
await def list_network_migration_mappings(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").retry_data_replication` method.
...
Type annotations and code completion for `#!python session.create_client("mgn").start_import_file_enrichment` method.
...
await def start_import_file_enrichment(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("mgn").start_network_migration_analysis` method.
...
await def start_network_migration_analysis(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").start_network_migration_code_generation` method.
...
await def start_network_migration_code_generation(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").start_network_migration_deployment` method.
...
await def start_network_migration_deployment(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").start_network_migration_mapping` method.
...
await def start_network_migration_mapping(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").start_network_migration_mapping_update` method.
...
await def start_network_migration_mapping_update(
    self,
    *,
    networkMigrationExecutionID: str,
    networkMigrationDefinitionID: str,
...
Type annotations and code completion for `#!python session.create_client("mgn").stop_replication` method.
...
Type annotations and code completion for `#!python session.create_client("mgn").update_network_migration_definition` method.
...
await def update_network_migration_definition(
    self,
    *,
    networkMigrationDefinitionID: str,
    name: str = ...,
...
Type annotations and code completion for `#!python session.create_client("mgn").update_network_migration_mapper_segment` method.
...
await def update_network_migration_mapper_segment(
    self,
    *,
    networkMigrationDefinitionID: str,
    networkMigrationExecutionID: str,
