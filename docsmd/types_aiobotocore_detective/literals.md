...
```python
# DatasourcePackageIngestStateType definition
...
```python
# DatasourcePackageType usage example
...
```python
# DatasourcePackageType definition
...
from types_aiobotocore_detective.literals import EntityTypeType
...
from types_aiobotocore_detective.literals import FieldType

def get_value() -> FieldType:
    return "CREATED_TIME"
```
...
from types_aiobotocore_detective.literals import IndicatorTypeType
...
```python
# InvitationTypeType usage example
...
```python
# InvitationTypeType definition
InvitationTypeType = Literal[
    "INVITATION",
    "ORGANIZATION",
]
```
...
```python
# MemberDisabledReasonType usage example
from types_aiobotocore_detective.literals import MemberDisabledReasonType

def get_value() -> MemberDisabledReasonType:
    return "VOLUME_TOO_HIGH"
```

```python
# MemberDisabledReasonType definition
MemberDisabledReasonType = Literal[
    "VOLUME_TOO_HIGH",
    "VOLUME_UNKNOWN",
]
```
...
from types_aiobotocore_detective.literals import MemberStatusType
...
from types_aiobotocore_detective.literals import ReasonType
...
from types_aiobotocore_detective.literals import SeverityType
...
from types_aiobotocore_detective.literals import SortOrderType
...
from types_aiobotocore_detective.literals import StateType
...
from types_aiobotocore_detective.literals import StatusType
...
```python
# DetectiveServiceName usage example
from types_aiobotocore_detective.literals import DetectiveServiceName

def get_value() -> DetectiveServiceName:
    return "detective"
```

```python
# DetectiveServiceName definition
DetectiveServiceName = Literal[
    "detective",
]
```
## ServiceName
...
from types_aiobotocore_detective.literals import ServiceName
...
from types_aiobotocore_detective.literals import ResourceServiceName
...
from types_aiobotocore_detective.literals import RegionName
