...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/freetier.html#FreeTier.Paginator.GetFreeTierUsage)
...
) -> AsyncIterator[GetFreeTierUsageResponseTypeDef]:  # (3)
    ...
```
