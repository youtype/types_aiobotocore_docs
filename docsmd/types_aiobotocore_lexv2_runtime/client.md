...
Type annotations and code completion for `#!python session.create_client("lexv2-runtime").close` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/lexv2-runtime/client/close.html)
...
Type annotations and code completion for `#!python session.create_client("lexv2-runtime").recognize_utterance` method.
