...
from types_aiobotocore_socialmessaging.type_defs import AssociateWhatsAppBusinessAccountInputRequestTypeDef
...
async with session.create_client("socialmessaging") as client:
    ...
    kwargs: AssociateWhatsAppBusinessAccountInputRequestTypeDef = {...}
