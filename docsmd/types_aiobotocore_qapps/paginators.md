...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/qapps.html#QApps.Paginator.ListLibraryItems)
...
) -> AsyncIterator[ListLibraryItemsOutputTypeDef]:  # (2)
    ...
```
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/qapps.html#QApps.Paginator.ListQApps)
...
def paginate(
    ...
    *,
    instanceId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListQAppsOutputTypeDef]:  # (2)
    ...
```
