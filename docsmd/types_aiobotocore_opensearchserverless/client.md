...
Type annotations and code completion for `#!python session.create_client("opensearchserverless").batch_get_collection_group` method.
...
await def batch_get_collection_group(
    self,
    *,
    ids: Sequence[str] = ...,
    names: Sequence[str] = ...,
...
Type annotations and code completion for `#!python session.create_client("opensearchserverless").create_collection_group` method.
...
await def create_collection_group(
    self,
    *,
    name: str,
...
Type annotations and code completion for `#!python session.create_client("opensearchserverless").delete_collection_group` method.
...
await def delete_collection_group(
    self,
    *,
    id: str,
    clientToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("opensearchserverless").list_collection_groups` method.
...
await def list_collection_groups(
    self,
    *,
    nextToken: str = ...,
    maxResults: int = ...,
...
await def update_collection(
    ...
    *,
    ...
    clientToken: str = ...,
) -> UpdateCollectionResponseTypeDef:  # (2)
    ...
```

1. See [:material-code-braces: VectorOptionsTypeDef](./type_defs.md#vectoroptionstypedef)
2. See [:material-code-braces: UpdateCollectionResponseTypeDef](./type_defs.md#updatecollectionresponsetypedef)
...
Type annotations and code completion for `#!python session.create_client("opensearchserverless").update_collection_group` method.
...
await def update_collection_group(
    self,
    *,
    id: str,
    description: str = ...,
