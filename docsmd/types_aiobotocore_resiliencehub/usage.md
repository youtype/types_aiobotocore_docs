...
from types_aiobotocore_resiliencehub.type_defs import AcceptResourceGroupingRecommendationsRequestRequestTypeDef
...
async with session.create_client("resiliencehub") as client:
    ...
    kwargs: AcceptResourceGroupingRecommendationsRequestRequestTypeDef = {...}
