...
) -> AsyncIterator[ListEngagementByAcceptingInvitationTasksResponseTypeDef]:  # (4)
    ...
```
...
kwargs: ListEngagementByAcceptingInvitationTasksRequestListEngagementByAcceptingInvitationTasksPaginateTypeDef = {  # (1)
    "Catalog": ...,
}
...
1. See [:material-code-braces: ListEngagementByAcceptingInvitationTasksRequestListEngagementByAcceptingInvitationTasksPaginateTypeDef](./type_defs.md#listengagementbyacceptinginvitationtasksrequestlistengagementbyacceptinginvitationtaskspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    TaskStatus: Sequence[TaskStatusType] = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[ListEngagementFromOpportunityTasksResponseTypeDef]:  # (4)
    ...
```
...
kwargs: ListEngagementFromOpportunityTasksRequestListEngagementFromOpportunityTasksPaginateTypeDef = {  # (1)
    "Catalog": ...,
}
...
1. See [:material-code-braces: ListEngagementFromOpportunityTasksRequestListEngagementFromOpportunityTasksPaginateTypeDef](./type_defs.md#listengagementfromopportunitytasksrequestlistengagementfromopportunitytaskspaginatetypedef) 
...
) -> AsyncIterator[ListEngagementInvitationsResponseTypeDef]:  # (6)
    ...
```
...
) -> AsyncIterator[ListEngagementMembersResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListEngagementMembersRequestListEngagementMembersPaginateTypeDef = {  # (1)
    "Catalog": ...,
    "Identifier": ...,
}
...
1. See [:material-code-braces: ListEngagementMembersRequestListEngagementMembersPaginateTypeDef](./type_defs.md#listengagementmembersrequestlistengagementmemberspaginatetypedef) 
...
) -> AsyncIterator[ListEngagementResourceAssociationsResponseTypeDef]:  # (3)
    ...
```
...
kwargs: ListEngagementResourceAssociationsRequestListEngagementResourceAssociationsPaginateTypeDef = {  # (1)
    "Catalog": ...,
}
...
1. See [:material-code-braces: ListEngagementResourceAssociationsRequestListEngagementResourceAssociationsPaginateTypeDef](./type_defs.md#listengagementresourceassociationsrequestlistengagementresourceassociationspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListEngagementsResponseTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (5)
) -> AsyncIterator[ListOpportunitiesResponseTypeDef]:  # (6)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[ListResourceSnapshotJobsResponseTypeDef]:  # (4)
    ...
```
...
kwargs: ListResourceSnapshotJobsRequestListResourceSnapshotJobsPaginateTypeDef = {  # (1)
    "Catalog": ...,
}
...
1. See [:material-code-braces: ListResourceSnapshotJobsRequestListResourceSnapshotJobsPaginateTypeDef](./type_defs.md#listresourcesnapshotjobsrequestlistresourcesnapshotjobspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    ResourceType: ResourceTypeType = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListResourceSnapshotsResponseTypeDef]:  # (3)
    ...
```
...
kwargs: ListResourceSnapshotsRequestListResourceSnapshotsPaginateTypeDef = {  # (1)
    "Catalog": ...,
...
1. See [:material-code-braces: ListResourceSnapshotsRequestListResourceSnapshotsPaginateTypeDef](./type_defs.md#listresourcesnapshotsrequestlistresourcesnapshotspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[ListSolutionsResponseTypeDef]:  # (4)
    ...
```
