...
Type annotations and code completion for `#!python session.create_client("omics").cancel_run_batch` method.
...
Type annotations and code completion for `#!python session.create_client("omics").create_configuration` method.
...
Type annotations and code completion for `#!python session.create_client("omics").delete_batch` method.
...
Type annotations and code completion for `#!python session.create_client("omics").delete_configuration` method.
...
Type annotations and code completion for `#!python session.create_client("omics").delete_run_batch` method.
...
Type annotations and code completion for `#!python session.create_client("omics").get_batch` method.
...
Type annotations and code completion for `#!python session.create_client("omics").get_configuration` method.
...
Type annotations and code completion for `#!python session.create_client("omics").list_batch` method.
...
Type annotations and code completion for `#!python session.create_client("omics").list_configurations` method.
...
Type annotations and code completion for `#!python session.create_client("omics").list_runs_in_batch` method.
...
7. See [:material-code-braces: StartRunResponseTypeDef](./type_defs.md#startrunresponsetypedef)
...
Type annotations and code completion for `#!python session.create_client("omics").start_run_batch` method.
...
Type annotations and code completion for `#!python session.create_client("omics").update_workflow_version` method.
...
await def update_workflow_version(
    self,
    *,
    workflowId: str,
    versionName: str,
