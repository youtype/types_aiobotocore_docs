...
> [Index](../README.md) > [EKSAuth](./README.md) > Literals
...
```python
# EKSAuthServiceName definition
EKSAuthServiceName = Literal[
    "eks-auth",
]
```
## ServiceName
...
from types_aiobotocore_eks_auth.literals import ServiceName
...
from types_aiobotocore_eks_auth.literals import ResourceServiceName
...
from types_aiobotocore_eks_auth.literals import RegionName
