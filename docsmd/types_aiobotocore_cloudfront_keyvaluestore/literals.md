...
> [Index](../README.md) > [CloudFrontKeyValueStore](./README.md) > Literals
...
```python
# CloudFrontKeyValueStoreServiceName usage example
from types_aiobotocore_cloudfront_keyvaluestore.literals import CloudFrontKeyValueStoreServiceName

def get_value() -> CloudFrontKeyValueStoreServiceName:
    return "cloudfront-keyvaluestore"
```

```python
# CloudFrontKeyValueStoreServiceName definition
CloudFrontKeyValueStoreServiceName = Literal[
...
from types_aiobotocore_cloudfront_keyvaluestore.literals import ServiceName
...
from types_aiobotocore_cloudfront_keyvaluestore.literals import ResourceServiceName
...
from types_aiobotocore_cloudfront_keyvaluestore.literals import PaginatorName
