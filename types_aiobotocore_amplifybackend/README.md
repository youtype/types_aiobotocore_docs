<a id="type-annotations-for-aiobotocore-amplifybackend-module"></a>

# Type annotations for aiobotocore AmplifyBackend module
...
pip install 'types-aiobotocore[amplifybackend]'

# install as a standalone
pip install types-aiobotocore-amplifybackend
```

- [Type annotations for aiobotocore AmplifyBackend module](#type-annotations-for-aiobotocore-amplifybackend-module)
...
Type annotations for `aiobotocore.create_client("amplifybackend")` as
...
```python
from types_aiobotocore_amplifybackend.paginators import ListBackendJobsPaginator, ...
```
