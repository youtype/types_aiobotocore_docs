...
) -> AsyncIterator[ListExportTasksOutputTypeDef]:  # (2)
    ...
```
...
kwargs: ListExportTasksInputListExportTasksPaginateTypeDef = {  # (1)
    "PaginationConfig": ...,
}
...
1. See [:material-code-braces: ListExportTasksInputListExportTasksPaginateTypeDef](./type_defs.md#listexporttasksinputlistexporttaskspaginatetypedef) 
