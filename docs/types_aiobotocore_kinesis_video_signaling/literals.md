<a id="literals-for-aiobotocore-kinesisvideosignalingchannels-module"></a>

# Literals for aiobotocore KinesisVideoSignalingChannels module
...
- [Literals for aiobotocore KinesisVideoSignalingChannels module](#literals-for-aiobotocore-kinesisvideosignalingchannels-module)
...
```python
from types_aiobotocore_kinesis_video_signaling.literals import KinesisVideoSignalingChannelsServiceName
```
...
```python
from types_aiobotocore_kinesis_video_signaling.literals import ServiceName
```
...
```python
from types_aiobotocore_kinesis_video_signaling.literals import ResourceServiceName
```
