...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/securityhub.html#SecurityHub.Paginator.GetFindingHistory)
...
1. See [:material-code-braces: GetFindingHistoryRequestGetFindingHistoryPaginateTypeDef](./type_defs.md#getfindinghistoryrequestgetfindinghistorypaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/securityhub.html#SecurityHub.Paginator.ListConfigurationPolicies)
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListConfigurationPoliciesResponseTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListConfigurationPoliciesRequestListConfigurationPoliciesPaginateTypeDef](./type_defs.md#listconfigurationpoliciesrequestlistconfigurationpoliciespaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/securityhub.html#SecurityHub.Paginator.ListConfigurationPolicyAssociations)
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListConfigurationPolicyAssociationsResponseTypeDef]:  # (3)
    ...
```
...
1. See [:material-code-braces: ListConfigurationPolicyAssociationsRequestListConfigurationPolicyAssociationsPaginateTypeDef](./type_defs.md#listconfigurationpolicyassociationsrequestlistconfigurationpolicyassociationspaginatetypedef) 
