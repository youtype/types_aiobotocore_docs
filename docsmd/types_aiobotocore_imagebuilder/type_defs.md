...
2. See [:material-code-braces: EcrConfigurationOutputTypeDef](./type_defs.md#ecrconfigurationoutputtypedef) 
...
```python
# ImportDiskImageRequestRequestTypeDef definition

class ImportDiskImageRequestRequestTypeDef(TypedDict):
    name: str,
    semanticVersion: str,
    platform: str,
    osVersion: str,
...
1. See [:material-code-braces: EcrConfigurationTypeDef](./type_defs.md#ecrconfigurationtypedef) [:material-code-braces: EcrConfigurationOutputTypeDef](./type_defs.md#ecrconfigurationoutputtypedef) 
