...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel")`
...
This class provides code completion for `#!python session.create_client("partnercentral-channel").exceptions` structure.

```python
# PartnerCentralChannelAPIClient.exceptions usage example
...
```python
# PartnerCentralChannelAPIClient usage type checking example

from types_aiobotocore_partnercentral_channel.client import Exceptions
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").can_paginate` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").generate_presigned_url` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").accept_channel_handshake` method.
...
await def accept_channel_handshake(
    self,
    *,
    catalog: str,
    identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").cancel_channel_handshake` method.
...
await def cancel_channel_handshake(
    self,
    *,
    catalog: str,
    identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").create_channel_handshake` method.
...
await def create_channel_handshake(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").create_program_management_account` method.
...
await def create_program_management_account(
    self,
    *,
    catalog: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").create_relationship` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").delete_program_management_account` method.
...
await def delete_program_management_account(
    self,
    *,
    catalog: str,
    identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").delete_relationship` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").get_relationship` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").list_channel_handshakes` method.
...
await def list_channel_handshakes(
    self,
    *,
    handshakeType: HandshakeTypeType,  # (1)
    catalog: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").list_program_management_accounts` method.
...
await def list_program_management_accounts(
    self,
    *,
    catalog: str,
    maxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").list_relationships` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").reject_channel_handshake` method.
...
await def reject_channel_handshake(
    self,
    *,
    catalog: str,
    identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").untag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").update_program_management_account` method.
...
await def update_program_management_account(
    self,
    *,
    catalog: str,
    identifier: str,
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").update_relationship` method.
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/partnercentral-channel.html#PartnerCentralChannelAPI.Client)
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/partnercentral-channel.html#PartnerCentralChannelAPI.Client)
...
Type annotations and code completion for `#!python session.create_client("partnercentral-channel").get_paginator` method with overloads.
