...
def paginate(
    ...
    *,
    ...
    DryRun: bool = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DescribeCapacityBlockExtensionHistoryResultTypeDef]:  # (3)
    ...
```
...
def paginate(
    ...
    *,
    ...
    DryRun: bool = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeCapacityBlockExtensionOfferingsResultTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    DryRun: bool = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[DescribeSecurityGroupVpcAssociationsResultTypeDef]:  # (3)
    ...
```
