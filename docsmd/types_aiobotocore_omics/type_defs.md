...
class GetWorkflowResponseTypeDef(TypedDict):
    ...
    uuid: str,
    readme: str,
    definitionRepositoryDetails: DefinitionRepositoryDetailsTypeDef,  # (7)
    readmePath: str,
...
7. See [:material-code-braces: DefinitionRepositoryDetailsTypeDef](./type_defs.md#definitionrepositorydetailstypedef)
...
class CreateWorkflowRequestTypeDef(TypedDict):
    ...
    definitionRepository: NotRequired[DefinitionRepositoryTypeDef],  # (5)
...
5. See [:material-code-braces: DefinitionRepositoryTypeDef](./type_defs.md#definitionrepositorytypedef)
