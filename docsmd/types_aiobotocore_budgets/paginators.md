...
async with session.create_client("budgets") as client:  # (1)
    ...
    async for item in paginator.paginate(...):
        item: DescribeBudgetPerformanceHistoryResponsePaginatorTypeDef
        print(item)  # (3)
```

1. client: [BudgetsClient](./client.md)
2. paginator: [DescribeBudgetPerformanceHistoryPaginator](./paginators.md#describebudgetperformancehistorypaginator)
3. item: `AioPageIterator[DescribeBudgetPerformanceHistoryResponsePaginatorTypeDef]`
...
def paginate(
    ...
    *,
    ...
    TimePeriod: TimePeriodUnionTypeDef = ...,  # (1)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> aiobotocore.paginate.AioPageIterator[DescribeBudgetPerformanceHistoryResponsePaginatorTypeDef]:  # (3)
    ...
```

1. See [:material-code-braces: TimePeriodUnionTypeDef](#timeperioduniontypedef)
2. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
3. See `AioPageIterator[DescribeBudgetPerformanceHistoryResponsePaginatorTypeDef]`
