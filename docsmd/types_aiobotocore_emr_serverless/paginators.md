...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/emr-serverless.html#EMRServerless.Paginator.ListJobRunAttempts)
...
) -> AsyncIterator[ListJobRunAttemptsResponseTypeDef]:  # (2)
    ...
```
...
) -> AsyncIterator[ListJobRunsResponseTypeDef]:  # (4)
    ...
```
