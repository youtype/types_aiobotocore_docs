...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeMultiRegionClustersResponseTypeDef]:  # (2)
    ...
```
...
kwargs: DescribeMultiRegionClustersRequestDescribeMultiRegionClustersPaginateTypeDef = {  # (1)
...
1. See [:material-code-braces: DescribeMultiRegionClustersRequestDescribeMultiRegionClustersPaginateTypeDef](./type_defs.md#describemultiregionclustersrequestdescribemultiregionclusterspaginatetypedef) 
