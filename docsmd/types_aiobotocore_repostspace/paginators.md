...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/repostspace.html#RePostPrivate.Paginator.ListSpaces)
...
) -> AsyncIterator[ListSpacesOutputTypeDef]:  # (2)
    ...
```
