...
```python
# ListConfigurationProfilesRequestListConfigurationProfilesPaginateTypeDef definition

class ListConfigurationProfilesRequestListConfigurationProfilesPaginateTypeDef(TypedDict):
    ApplicationId: str,
    Type: NotRequired[str],
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListDeploymentStrategiesRequestListDeploymentStrategiesPaginateTypeDef definition

class ListDeploymentStrategiesRequestListDeploymentStrategiesPaginateTypeDef(TypedDict):
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListExtensionAssociationsRequestListExtensionAssociationsPaginateTypeDef definition

class ListExtensionAssociationsRequestListExtensionAssociationsPaginateTypeDef(TypedDict):
    ResourceIdentifier: NotRequired[str],
    ExtensionIdentifier: NotRequired[str],
    ExtensionVersionNumber: NotRequired[int],
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
...
```python
# ListHostedConfigurationVersionsRequestListHostedConfigurationVersionsPaginateTypeDef definition

class ListHostedConfigurationVersionsRequestListHostedConfigurationVersionsPaginateTypeDef(TypedDict):
    ApplicationId: str,
    ConfigurationProfileId: str,
    VersionLabel: NotRequired[str],
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
