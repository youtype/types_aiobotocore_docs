...
Type annotations and code completion for `#!python session.create_client("cloudfront").create_connection_function` method.
...
await def create_connection_function(
    self,
    *,
    Name: str,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").create_trust_store` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").delete_connection_function` method.
...
await def delete_connection_function(
    self,
    *,
    Id: str,
    IfMatch: str,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").delete_resource_policy` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").delete_trust_store` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").describe_connection_function` method.
...
await def describe_connection_function(
    self,
    *,
    Identifier: str,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").get_connection_function` method.
...
await def get_connection_function(
    self,
    *,
    Identifier: str,
    Stage: FunctionStageType = ...,  # (1)
...
Type annotations and code completion for `#!python session.create_client("cloudfront").get_resource_policy` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").get_trust_store` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_connection_functions` method.
...
await def list_connection_functions(
    self,
    *,
    Marker: str = ...,
    MaxItems: int = ...,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_connection_groups` method.
...
await def list_connection_groups(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_distribution_tenants` method.
...
await def list_distribution_tenants(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_distribution_tenants_by_customization` method.
...
await def list_distribution_tenants_by_customization(
    self,
    *,
    WebACLArn: str = ...,
    CertificateArn: str = ...,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_distributions_by_connection_function` method.
...
await def list_distributions_by_connection_function(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_distributions_by_connection_mode` method.
...
await def list_distributions_by_connection_mode(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_distributions_by_owned_resource` method.
...
await def list_distributions_by_owned_resource(
    self,
    *,
    ResourceArn: str,
    Marker: str = ...,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_distributions_by_trust_store` method.
...
await def list_distributions_by_trust_store(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_distributions_by_vpc_origin_id` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_distributions_by_web_acl_id` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_domain_conflicts` method.
...
await def list_domain_conflicts(
    self,
    *,
    Domain: str,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_field_level_encryption_configs` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_field_level_encryption_profiles` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_functions` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_invalidations` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_invalidations_for_distribution_tenant` method.
...
await def list_invalidations_for_distribution_tenant(
    self,
    *,
    Id: str,
    Marker: str = ...,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_key_groups` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_key_value_stores` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_origin_access_controls` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_origin_request_policies` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_public_keys` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_realtime_log_configs` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_response_headers_policies` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_streaming_distributions` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_trust_stores` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").list_vpc_origins` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").publish_connection_function` method.
...
await def publish_connection_function(
    self,
    *,
    Id: str,
    IfMatch: str,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").publish_function` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").put_resource_policy` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").test_connection_function` method.
...
await def test_connection_function(
    self,
    *,
    Id: str,
    IfMatch: str,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").test_function` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").untag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_anycast_ip_list` method.
...
await def update_anycast_ip_list(
    self,
    *,
    Id: str,
    IfMatch: str,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_cache_policy` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_cloud_front_origin_access_identity` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_connection_function` method.
...
await def update_connection_function(
    self,
    *,
    Id: str,
    IfMatch: str,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_connection_group` method.
...
await def update_connection_group(
    self,
    *,
    Id: str,
    IfMatch: str,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_continuous_deployment_policy` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_distribution` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_distribution_tenant` method.
...
await def update_distribution_tenant(
    self,
    *,
    Id: str,
    IfMatch: str,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_distribution_with_staging_config` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_domain_association` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_field_level_encryption_config` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_field_level_encryption_profile` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_function` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_key_group` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_key_value_store` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_origin_access_control` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_origin_request_policy` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_public_key` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_realtime_log_config` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_response_headers_policy` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_streaming_distribution` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_trust_store` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").update_vpc_origin` method.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").verify_dns_configuration` method.
...
await def verify_dns_configuration(
    self,
    *,
    Identifier: str,
    Domain: str = ...,
...
Type annotations and code completion for `#!python session.create_client("cloudfront").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudfront.html#CloudFront.Client)
...
Type annotations and code completion for `#!python session.create_client("cloudfront").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudfront.html#CloudFront.Client)
...
Type annotations and code completion for `#!python session.create_client("cloudfront").get_paginator` method with overloads.
...
Type annotations and code completion for `#!python session.create_client("cloudfront").get_waiter` method with overloads.
