...
```python
# StartSelectorTypeType definition
...
```python
# KinesisVideoMediaServiceName usage example
...
```python
# KinesisVideoMediaServiceName definition
...
from types_aiobotocore_kinesis_video_media.literals import RegionName
