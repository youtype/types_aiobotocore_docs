...
```python
# ListMigrationTaskUpdatesRequestListMigrationTaskUpdatesPaginateTypeDef definition

class ListMigrationTaskUpdatesRequestListMigrationTaskUpdatesPaginateTypeDef(TypedDict):
    ProgressUpdateStream: str,
    MigrationTaskName: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListSourceResourcesRequestListSourceResourcesPaginateTypeDef definition

class ListSourceResourcesRequestListSourceResourcesPaginateTypeDef(TypedDict):
    ProgressUpdateStream: str,
    MigrationTaskName: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
