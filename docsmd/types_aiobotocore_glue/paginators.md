...
) -> AsyncIterator[GetDatabasesResponseTypeDef]:  # (4)
    ...
```
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[GetJobsResponsePaginatorTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    CatalogId: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[GetTableVersionsResponsePaginatorTypeDef]:  # (2)
    ...
```
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[GetTablesResponsePaginatorTypeDef]:  # (3)
    ...
```
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/glue.html#Glue.Paginator.GetWorkflowRuns)
...
def paginate(
    ...
    *,
    ...
    IncludeGraph: bool = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[GetWorkflowRunsResponseTypeDef]:  # (2)
    ...
```
...
kwargs: GetWorkflowRunsRequestGetWorkflowRunsPaginateTypeDef = {  # (1)
    "Name": ...,
}
...
1. See [:material-code-braces: GetWorkflowRunsRequestGetWorkflowRunsPaginateTypeDef](./type_defs.md#getworkflowrunsrequestgetworkflowrunspaginatetypedef) 
## ListBlueprintsPaginator

Type annotations and code completion for `#!python session.create_client("glue").get_paginator("list_blueprints")`.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/glue.html#Glue.Paginator.ListBlueprints)
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListBlueprintsResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListBlueprintsRequestListBlueprintsPaginateTypeDef = {  # (1)
    "Tags": ...,
}
...
1. See [:material-code-braces: ListBlueprintsRequestListBlueprintsPaginateTypeDef](./type_defs.md#listblueprintsrequestlistblueprintspaginatetypedef) 
## ListJobsPaginator

Type annotations and code completion for `#!python session.create_client("glue").get_paginator("list_jobs")`.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/glue.html#Glue.Paginator.ListJobs)
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/glue.html#Glue.Paginator.ListTableOptimizerRuns)
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListTableOptimizerRunsResponseTypeDef]:  # (3)
    ...
```
...
kwargs: ListTableOptimizerRunsRequestListTableOptimizerRunsPaginateTypeDef = {  # (1)
    "CatalogId": ...,
    "DatabaseName": ...,
    "TableName": ...,
    "Type": ...,
...
1. See [:material-code-braces: ListTableOptimizerRunsRequestListTableOptimizerRunsPaginateTypeDef](./type_defs.md#listtableoptimizerrunsrequestlisttableoptimizerrunspaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/glue.html#Glue.Paginator.ListTriggers)
...
def paginate(
    ...
    *,
    ...
    Tags: Mapping[str, str] = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListTriggersResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListTriggersRequestListTriggersPaginateTypeDef = {  # (1)
    "DependentJobName": ...,
}
...
1. See [:material-code-braces: ListTriggersRequestListTriggersPaginateTypeDef](./type_defs.md#listtriggersrequestlisttriggerspaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/glue.html#Glue.Paginator.ListUsageProfiles)
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListUsageProfilesResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListUsageProfilesRequestListUsageProfilesPaginateTypeDef = {  # (1)
    "PaginationConfig": ...,
}
...
1. See [:material-code-braces: ListUsageProfilesRequestListUsageProfilesPaginateTypeDef](./type_defs.md#listusageprofilesrequestlistusageprofilespaginatetypedef) 
## ListWorkflowsPaginator

Type annotations and code completion for `#!python session.create_client("glue").get_paginator("list_workflows")`.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/glue.html#Glue.Paginator.ListWorkflows)
