...
3. item: [:material-code-braces: DescribeAnomalyDetectorsOutputMetricTypeDef](./type_defs.md#describeanomalydetectorsoutputmetrictypedef) 
...
3. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef) 
4. See [:material-code-braces: DescribeAnomalyDetectorsOutputMetricTypeDef](./type_defs.md#describeanomalydetectorsoutputmetrictypedef) 
