<a id="type-annotations-for-aiobotocore-resiliencehub-module"></a>
...
pip install 'types-aiobotocore[resiliencehub]'
...
Type annotations for `aiobotocore.create_client("resiliencehub")` as
