<a id="type-annotations-for-aiobotocore-pinpoint-module"></a>

# Type annotations for aiobotocore Pinpoint module
...
pip install 'types-aiobotocore[pinpoint]'

# install as a standalone
pip install types-aiobotocore-pinpoint
```

- [Type annotations for aiobotocore Pinpoint module](#type-annotations-for-aiobotocore-pinpoint-module)
...
Type annotations for `aiobotocore.create_client("pinpoint")` as
