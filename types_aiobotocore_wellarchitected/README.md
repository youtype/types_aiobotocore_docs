<a id="type-annotations-for-aiobotocore-wellarchitected-module"></a>

# Type annotations for aiobotocore WellArchitected module
...
pip install 'types-aiobotocore[wellarchitected]'

# install as a standalone
pip install types-aiobotocore-wellarchitected
```

- [Type annotations for aiobotocore WellArchitected module](#type-annotations-for-aiobotocore-wellarchitected-module)
...
Type annotations for `aiobotocore.create_client("wellarchitected")` as
