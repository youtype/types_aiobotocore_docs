...
) -> AsyncIterator[DescribeEntityResponseTypeDef]:  # (2)
    ...
```
...
kwargs: DescribeEntityRequestDescribeEntityPaginateTypeDef = {  # (1)
    "ConnectionName": ...,
    "EntityName": ...,
}
...
1. See [:material-code-braces: DescribeEntityRequestDescribeEntityPaginateTypeDef](./type_defs.md#describeentityrequestdescribeentitypaginatetypedef) 
...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListConnectionTypesResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListConnectionTypesRequestListConnectionTypesPaginateTypeDef = {  # (1)
    "PaginationConfig": ...,
}
...
1. See [:material-code-braces: ListConnectionTypesRequestListConnectionTypesPaginateTypeDef](./type_defs.md#listconnectiontypesrequestlistconnectiontypespaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    DataStoreApiVersion: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListEntitiesResponseTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListEntitiesRequestListEntitiesPaginateTypeDef](./type_defs.md#listentitiesrequestlistentitiespaginatetypedef) 
## ListJobsPaginator
