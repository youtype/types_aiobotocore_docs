...
Type annotations and code completion for `#!python session.create_client("backupsearch").close` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/backupsearch/client/close.html)
...
1. See [:material-code-braces: GetSearchJobInputRequestTypeDef](./type_defs.md#getsearchjobinputrequesttypedef) 
...
1. See [:material-code-braces: GetSearchResultExportJobInputRequestTypeDef](./type_defs.md#getsearchresultexportjobinputrequesttypedef) 
...
1. See [:material-code-braces: ListSearchJobBackupsInputRequestTypeDef](./type_defs.md#listsearchjobbackupsinputrequesttypedef) 

### list\_search\_job\_results

This operation returns a list of a specified search job.

Type annotations and code completion for `#!python session.create_client("backupsearch").list_search_job_results` method.
...
1. See [:material-code-braces: ListSearchJobResultsInputRequestTypeDef](./type_defs.md#listsearchjobresultsinputrequesttypedef) 
...
1. See [:material-code-braces: ListSearchJobsInputRequestTypeDef](./type_defs.md#listsearchjobsinputrequesttypedef) 
...
1. See [:material-code-braces: ListSearchResultExportJobsInputRequestTypeDef](./type_defs.md#listsearchresultexportjobsinputrequesttypedef) 
...
1. See [:material-code-braces: StartSearchJobInputRequestTypeDef](./type_defs.md#startsearchjobinputrequesttypedef) 
...
1. See [:material-code-braces: StartSearchResultExportJobInputRequestTypeDef](./type_defs.md#startsearchresultexportjobinputrequesttypedef) 
...
1. See [:material-code-braces: StopSearchJobInputRequestTypeDef](./type_defs.md#stopsearchjobinputrequesttypedef) 
