...
from types_aiobotocore_emr_serverless.literals import ArchitectureType
...
from types_aiobotocore_emr_serverless.literals import JobRunModeType
...
from types_aiobotocore_emr_serverless.literals import ListApplicationsPaginatorName
...
```python
# ListJobRunAttemptsPaginatorName usage example
from types_aiobotocore_emr_serverless.literals import ListJobRunAttemptsPaginatorName

def get_value() -> ListJobRunAttemptsPaginatorName:
    return "list_job_run_attempts"
```

```python
# ListJobRunAttemptsPaginatorName definition
ListJobRunAttemptsPaginatorName = Literal[
...
from types_aiobotocore_emr_serverless.literals import ListJobRunsPaginatorName
...
from types_aiobotocore_emr_serverless.literals import ListSessionsPaginatorName
...
from types_aiobotocore_emr_serverless.literals import ResourceTypeType
...
from types_aiobotocore_emr_serverless.literals import SessionStateType
...
```python
# EMRServerlessServiceName usage example
from types_aiobotocore_emr_serverless.literals import EMRServerlessServiceName
...
```python
# EMRServerlessServiceName definition
...
from types_aiobotocore_emr_serverless.literals import ServiceName
...
from types_aiobotocore_emr_serverless.literals import ResourceServiceName
...
from types_aiobotocore_emr_serverless.literals import PaginatorName
...
from types_aiobotocore_emr_serverless.literals import RegionName
