...
) -> AsyncIterator[ListConnectionsOutputTypeDef]:  # (5)
    ...
```
...
kwargs: ListConnectionsInputListConnectionsPaginateTypeDef = {  # (1)
    "domainIdentifier": ...,
    "projectIdentifier": ...,
}
...
1. See [:material-code-braces: ListConnectionsInputListConnectionsPaginateTypeDef](./type_defs.md#listconnectionsinputlistconnectionspaginatetypedef) 
...
) -> AsyncIterator[ListJobRunsOutputTypeDef]:  # (4)
    ...
```
...
kwargs: ListJobRunsInputListJobRunsPaginateTypeDef = {  # (1)
    "domainIdentifier": ...,
    "jobIdentifier": ...,
}
...
1. See [:material-code-braces: ListJobRunsInputListJobRunsPaginateTypeDef](./type_defs.md#listjobrunsinputlistjobrunspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[ListLineageEventsOutputTypeDef]:  # (4)
    ...
```
...
kwargs: ListLineageEventsInputListLineageEventsPaginateTypeDef = {  # (1)
    "domainIdentifier": ...,
}
...
1. See [:material-code-braces: ListLineageEventsInputListLineageEventsPaginateTypeDef](./type_defs.md#listlineageeventsinputlistlineageeventspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    sortOrder: SortOrderType = ...,  # (2)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> AsyncIterator[ListProjectProfilesOutputTypeDef]:  # (4)
    ...
```
...
kwargs: ListProjectProfilesInputListProjectProfilesPaginateTypeDef = {  # (1)
    "domainIdentifier": ...,
}
...
1. See [:material-code-braces: ListProjectProfilesInputListProjectProfilesPaginateTypeDef](./type_defs.md#listprojectprofilesinputlistprojectprofilespaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> AsyncIterator[ListRulesOutputTypeDef]:  # (5)
    ...
```
