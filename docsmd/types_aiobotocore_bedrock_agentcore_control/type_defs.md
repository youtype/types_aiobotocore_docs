...
from types_aiobotocore_bedrock_agentcore_control.type_defs import VpcConfigUnionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ClaimMatchValueTypeUnionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ComponentConfigurationUnionTypeDef
...
```python
# HarnessInlineFunctionConfigUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessInlineFunctionConfigUnionTypeDef


def get_value() -> HarnessInlineFunctionConfigUnionTypeDef:
    return ...


# HarnessInlineFunctionConfigUnionTypeDef definition

HarnessInlineFunctionConfigUnionTypeDef = Union[
    HarnessInlineFunctionConfigTypeDef,  # (1)
    HarnessInlineFunctionConfigOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: HarnessInlineFunctionConfigTypeDef](./type_defs.md#harnessinlinefunctionconfigtypedef)
2. See [:material-code-braces: HarnessInlineFunctionConfigOutputTypeDef](./type_defs.md#harnessinlinefunctionconfigoutputtypedef)

## HarnessRemoteMcpConfigUnionTypeDef

```python
# HarnessRemoteMcpConfigUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessRemoteMcpConfigUnionTypeDef


def get_value() -> HarnessRemoteMcpConfigUnionTypeDef:
    return ...


# HarnessRemoteMcpConfigUnionTypeDef definition

HarnessRemoteMcpConfigUnionTypeDef = Union[
    HarnessRemoteMcpConfigTypeDef,  # (1)
    HarnessRemoteMcpConfigOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: HarnessRemoteMcpConfigTypeDef](./type_defs.md#harnessremotemcpconfigtypedef)
2. See [:material-code-braces: HarnessRemoteMcpConfigOutputTypeDef](./type_defs.md#harnessremotemcpconfigoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ManagedVpcResourceUnionTypeDef
...
```python
# MatchPathsUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import MatchPathsUnionTypeDef


def get_value() -> MatchPathsUnionTypeDef:
    return ...


# MatchPathsUnionTypeDef definition

MatchPathsUnionTypeDef = Union[
    MatchPathsTypeDef,  # (1)
    MatchPathsOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: MatchPathsTypeDef](./type_defs.md#matchpathstypedef)
2. See [:material-code-braces: MatchPathsOutputTypeDef](./type_defs.md#matchpathsoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import MetadataConfigurationUnionTypeDef
...
1. See [:material-code-braces: Oauth2AuthorizationServerMetadataTypeDef](./type_defs.md#oauth2authorizationservermetadatatypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RegistryRecordOAuthCredentialProviderUnionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RequestHeaderConfigurationUnionTypeDef
...
```python
# StringListValidationUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StringListValidationUnionTypeDef


def get_value() -> StringListValidationUnionTypeDef:
    return ...


# StringListValidationUnionTypeDef definition

StringListValidationUnionTypeDef = Union[
    StringListValidationTypeDef,  # (1)
    StringListValidationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: StringListValidationTypeDef](./type_defs.md#stringlistvalidationtypedef)
2. See [:material-code-braces: StringListValidationOutputTypeDef](./type_defs.md#stringlistvalidationoutputtypedef)

## StringValidationUnionTypeDef

```python
# StringValidationUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StringValidationUnionTypeDef


def get_value() -> StringValidationUnionTypeDef:
    return ...


# StringValidationUnionTypeDef definition

StringValidationUnionTypeDef = Union[
    StringValidationTypeDef,  # (1)
    StringValidationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: StringValidationTypeDef](./type_defs.md#stringvalidationtypedef)
2. See [:material-code-braces: StringValidationOutputTypeDef](./type_defs.md#stringvalidationoutputtypedef)

## TargetTrafficSplitEntryUnionTypeDef

```python
# TargetTrafficSplitEntryUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import TargetTrafficSplitEntryUnionTypeDef


def get_value() -> TargetTrafficSplitEntryUnionTypeDef:
    return ...


# TargetTrafficSplitEntryUnionTypeDef definition

TargetTrafficSplitEntryUnionTypeDef = Union[
    TargetTrafficSplitEntryTypeDef,  # (1)
    TargetTrafficSplitEntryOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: TargetTrafficSplitEntryTypeDef](./type_defs.md#targettrafficsplitentrytypedef)
2. See [:material-code-braces: TargetTrafficSplitEntryOutputTypeDef](./type_defs.md#targettrafficsplitentryoutputtypedef)

## TokenExchangeGrantTypeConfigTypeUnionTypeDef

```python
# TokenExchangeGrantTypeConfigTypeUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import TokenExchangeGrantTypeConfigTypeUnionTypeDef


def get_value() -> TokenExchangeGrantTypeConfigTypeUnionTypeDef:
    return ...


# TokenExchangeGrantTypeConfigTypeUnionTypeDef definition

TokenExchangeGrantTypeConfigTypeUnionTypeDef = Union[
    TokenExchangeGrantTypeConfigTypeTypeDef,  # (1)
    TokenExchangeGrantTypeConfigTypeOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: TokenExchangeGrantTypeConfigTypeTypeDef](./type_defs.md#tokenexchangegranttypeconfigtypetypedef)
2. See [:material-code-braces: TokenExchangeGrantTypeConfigTypeOutputTypeDef](./type_defs.md#tokenexchangegranttypeconfigtypeoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import BrowserNetworkConfigurationUnionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CodeInterpreterNetworkConfigurationUnionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DataSourceConfigUnionTypeDef
...
```python
# TrafficSplitEntryUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import TrafficSplitEntryUnionTypeDef


def get_value() -> TrafficSplitEntryUnionTypeDef:
    return ...


# TrafficSplitEntryUnionTypeDef definition

TrafficSplitEntryUnionTypeDef = Union[
    TrafficSplitEntryTypeDef,  # (1)
    TrafficSplitEntryOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: TrafficSplitEntryTypeDef](./type_defs.md#trafficsplitentrytypedef)
2. See [:material-code-braces: TrafficSplitEntryOutputTypeDef](./type_defs.md#trafficsplitentryoutputtypedef)

## HarnessAgentCoreMemoryConfigurationUnionTypeDef

```python
# HarnessAgentCoreMemoryConfigurationUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessAgentCoreMemoryConfigurationUnionTypeDef


def get_value() -> HarnessAgentCoreMemoryConfigurationUnionTypeDef:
    return ...


# HarnessAgentCoreMemoryConfigurationUnionTypeDef definition

HarnessAgentCoreMemoryConfigurationUnionTypeDef = Union[
    HarnessAgentCoreMemoryConfigurationTypeDef,  # (1)
    HarnessAgentCoreMemoryConfigurationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: HarnessAgentCoreMemoryConfigurationTypeDef](./type_defs.md#harnessagentcorememoryconfigurationtypedef)
2. See [:material-code-braces: HarnessAgentCoreMemoryConfigurationOutputTypeDef](./type_defs.md#harnessagentcorememoryconfigurationoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import NetworkConfigurationUnionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import AuthorizingClaimMatchValueTypeUnionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RuleUnionTypeDef
...
```python
# MatchPrincipalsUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import MatchPrincipalsUnionTypeDef


def get_value() -> MatchPrincipalsUnionTypeDef:
    return ...


# MatchPrincipalsUnionTypeDef definition

MatchPrincipalsUnionTypeDef = Union[
    MatchPrincipalsTypeDef,  # (1)
    MatchPrincipalsOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: MatchPrincipalsTypeDef](./type_defs.md#matchprincipalstypedef)
2. See [:material-code-braces: MatchPrincipalsOutputTypeDef](./type_defs.md#matchprincipalsoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GatewayInterceptorConfigurationUnionTypeDef
...
1. See [:material-code-braces: GatewayInterceptorConfigurationTypeDef](./type_defs.md#gatewayinterceptorconfigurationtypedef)
2. See [:material-code-braces: GatewayInterceptorConfigurationOutputTypeDef](./type_defs.md#gatewayinterceptorconfigurationoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PrivateEndpointUnionTypeDef
...
```python
# HarnessGatewayOutboundAuthUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessGatewayOutboundAuthUnionTypeDef


def get_value() -> HarnessGatewayOutboundAuthUnionTypeDef:
    return ...


# HarnessGatewayOutboundAuthUnionTypeDef definition

HarnessGatewayOutboundAuthUnionTypeDef = Union[
    HarnessGatewayOutboundAuthTypeDef,  # (1)
    HarnessGatewayOutboundAuthOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: HarnessGatewayOutboundAuthTypeDef](./type_defs.md#harnessgatewayoutboundauthtypedef)
2. See [:material-code-braces: HarnessGatewayOutboundAuthOutputTypeDef](./type_defs.md#harnessgatewayoutboundauthoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RegistryRecordCredentialProviderUnionUnionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ValidationUnionTypeDef
...
```python
# WeightedRouteUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import WeightedRouteUnionTypeDef


def get_value() -> WeightedRouteUnionTypeDef:
    return ...


# WeightedRouteUnionTypeDef definition

WeightedRouteUnionTypeDef = Union[
    WeightedRouteTypeDef,  # (1)
    WeightedRouteOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: WeightedRouteTypeDef](./type_defs.md#weightedroutetypedef)
2. See [:material-code-braces: WeightedRouteOutputTypeDef](./type_defs.md#weightedrouteoutputtypedef)

## OnBehalfOfTokenExchangeConfigTypeUnionTypeDef

```python
# OnBehalfOfTokenExchangeConfigTypeUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import OnBehalfOfTokenExchangeConfigTypeUnionTypeDef


def get_value() -> OnBehalfOfTokenExchangeConfigTypeUnionTypeDef:
    return ...


# OnBehalfOfTokenExchangeConfigTypeUnionTypeDef definition

OnBehalfOfTokenExchangeConfigTypeUnionTypeDef = Union[
    OnBehalfOfTokenExchangeConfigTypeTypeDef,  # (1)
    OnBehalfOfTokenExchangeConfigTypeOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: OnBehalfOfTokenExchangeConfigTypeTypeDef](./type_defs.md#onbehalfoftokenexchangeconfigtypetypedef)
2. See [:material-code-braces: OnBehalfOfTokenExchangeConfigTypeOutputTypeDef](./type_defs.md#onbehalfoftokenexchangeconfigtypeoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import AgentRuntimeArtifactUnionTypeDef
...
2. See [:material-code-braces: AgentRuntimeArtifactOutputTypeDef](./type_defs.md#agentruntimeartifactoutputtypedef)

## WeightedOverrideUnionTypeDef

```python
# WeightedOverrideUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import WeightedOverrideUnionTypeDef


def get_value() -> WeightedOverrideUnionTypeDef:
    return ...


# WeightedOverrideUnionTypeDef definition

WeightedOverrideUnionTypeDef = Union[
    WeightedOverrideTypeDef,  # (1)
    WeightedOverrideOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: WeightedOverrideTypeDef](./type_defs.md#weightedoverridetypedef)
2. See [:material-code-braces: WeightedOverrideOutputTypeDef](./type_defs.md#weightedoverrideoutputtypedef)

## StreamDeliveryResourcesUnionTypeDef

```python
# StreamDeliveryResourcesUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StreamDeliveryResourcesUnionTypeDef


def get_value() -> StreamDeliveryResourcesUnionTypeDef:
    return ...


# StreamDeliveryResourcesUnionTypeDef definition

StreamDeliveryResourcesUnionTypeDef = Union[
    StreamDeliveryResourcesTypeDef,  # (1)
    StreamDeliveryResourcesOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: StreamDeliveryResourcesTypeDef](./type_defs.md#streamdeliveryresourcestypedef)
2. See [:material-code-braces: StreamDeliveryResourcesOutputTypeDef](./type_defs.md#streamdeliveryresourcesoutputtypedef)

## HarnessMemoryConfigurationUnionTypeDef

```python
# HarnessMemoryConfigurationUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessMemoryConfigurationUnionTypeDef


def get_value() -> HarnessMemoryConfigurationUnionTypeDef:
    return ...


# HarnessMemoryConfigurationUnionTypeDef definition

HarnessMemoryConfigurationUnionTypeDef = Union[
    HarnessMemoryConfigurationTypeDef,  # (1)
    HarnessMemoryConfigurationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: HarnessMemoryConfigurationTypeDef](./type_defs.md#harnessmemoryconfigurationtypedef)
2. See [:material-code-braces: HarnessMemoryConfigurationOutputTypeDef](./type_defs.md#harnessmemoryconfigurationoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EvaluatorConfigUnionTypeDef
...
1. See [:material-code-braces: EvaluatorConfigTypeDef](./type_defs.md#evaluatorconfigtypedef)
2. See [:material-code-braces: EvaluatorConfigOutputTypeDef](./type_defs.md#evaluatorconfigoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CustomClaimValidationTypeUnionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ConditionUnionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PrivateEndpointOverrideUnionTypeDef
...
```python
# HarnessAgentCoreGatewayConfigUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessAgentCoreGatewayConfigUnionTypeDef


def get_value() -> HarnessAgentCoreGatewayConfigUnionTypeDef:
    return ...


# HarnessAgentCoreGatewayConfigUnionTypeDef definition

HarnessAgentCoreGatewayConfigUnionTypeDef = Union[
    HarnessAgentCoreGatewayConfigTypeDef,  # (1)
    HarnessAgentCoreGatewayConfigOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: HarnessAgentCoreGatewayConfigTypeDef](./type_defs.md#harnessagentcoregatewayconfigtypedef)
2. See [:material-code-braces: HarnessAgentCoreGatewayConfigOutputTypeDef](./type_defs.md#harnessagentcoregatewayconfigoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RegistryRecordCredentialProviderConfigurationUnionTypeDef
...
```python
# LlmExtractionConfigUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import LlmExtractionConfigUnionTypeDef


def get_value() -> LlmExtractionConfigUnionTypeDef:
    return ...


# LlmExtractionConfigUnionTypeDef definition

LlmExtractionConfigUnionTypeDef = Union[
    LlmExtractionConfigTypeDef,  # (1)
    LlmExtractionConfigOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: LlmExtractionConfigTypeDef](./type_defs.md#llmextractionconfigtypedef)
2. See [:material-code-braces: LlmExtractionConfigOutputTypeDef](./type_defs.md#llmextractionconfigoutputtypedef)

## RouteToTargetActionUnionTypeDef

```python
# RouteToTargetActionUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import RouteToTargetActionUnionTypeDef


def get_value() -> RouteToTargetActionUnionTypeDef:
    return ...


# RouteToTargetActionUnionTypeDef definition

RouteToTargetActionUnionTypeDef = Union[
    RouteToTargetActionTypeDef,  # (1)
    RouteToTargetActionOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: RouteToTargetActionTypeDef](./type_defs.md#routetotargetactiontypedef)
2. See [:material-code-braces: RouteToTargetActionOutputTypeDef](./type_defs.md#routetotargetactionoutputtypedef)

## ConfigurationBundleActionUnionTypeDef

```python
# ConfigurationBundleActionUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ConfigurationBundleActionUnionTypeDef


def get_value() -> ConfigurationBundleActionUnionTypeDef:
    return ...


# ConfigurationBundleActionUnionTypeDef definition

ConfigurationBundleActionUnionTypeDef = Union[
    ConfigurationBundleActionTypeDef,  # (1)
    ConfigurationBundleActionOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: ConfigurationBundleActionTypeDef](./type_defs.md#configurationbundleactiontypedef)
2. See [:material-code-braces: ConfigurationBundleActionOutputTypeDef](./type_defs.md#configurationbundleactionoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CustomJWTAuthorizerConfigurationUnionTypeDef
...
```python
# HarnessToolConfigurationUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessToolConfigurationUnionTypeDef


def get_value() -> HarnessToolConfigurationUnionTypeDef:
    return ...


# HarnessToolConfigurationUnionTypeDef definition

HarnessToolConfigurationUnionTypeDef = Union[
    HarnessToolConfigurationTypeDef,  # (1)
    HarnessToolConfigurationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: HarnessToolConfigurationTypeDef](./type_defs.md#harnesstoolconfigurationtypedef)
2. See [:material-code-braces: HarnessToolConfigurationOutputTypeDef](./type_defs.md#harnesstoolconfigurationoutputtypedef)

## FromUrlSynchronizationConfigurationUnionTypeDef

```python
# FromUrlSynchronizationConfigurationUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import FromUrlSynchronizationConfigurationUnionTypeDef


def get_value() -> FromUrlSynchronizationConfigurationUnionTypeDef:
    return ...


# FromUrlSynchronizationConfigurationUnionTypeDef definition

FromUrlSynchronizationConfigurationUnionTypeDef = Union[
    FromUrlSynchronizationConfigurationTypeDef,  # (1)
    FromUrlSynchronizationConfigurationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: FromUrlSynchronizationConfigurationTypeDef](./type_defs.md#fromurlsynchronizationconfigurationtypedef)
2. See [:material-code-braces: FromUrlSynchronizationConfigurationOutputTypeDef](./type_defs.md#fromurlsynchronizationconfigurationoutputtypedef)

## ExtractionConfigUnionTypeDef

```python
# ExtractionConfigUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ExtractionConfigUnionTypeDef


def get_value() -> ExtractionConfigUnionTypeDef:
    return ...


# ExtractionConfigUnionTypeDef definition

ExtractionConfigUnionTypeDef = Union[
    ExtractionConfigTypeDef,  # (1)
    ExtractionConfigOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: ExtractionConfigTypeDef](./type_defs.md#extractionconfigtypedef)
2. See [:material-code-braces: ExtractionConfigOutputTypeDef](./type_defs.md#extractionconfigoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ActionUnionTypeDef
...
```python
# HarnessToolUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessToolUnionTypeDef


def get_value() -> HarnessToolUnionTypeDef:
    return ...


# HarnessToolUnionTypeDef definition

HarnessToolUnionTypeDef = Union[
    HarnessToolTypeDef,  # (1)
    HarnessToolOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: HarnessToolTypeDef](./type_defs.md#harnesstooltypedef)
2. See [:material-code-braces: HarnessToolOutputTypeDef](./type_defs.md#harnesstooloutputtypedef)

## SynchronizationConfigurationUnionTypeDef

```python
# SynchronizationConfigurationUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import SynchronizationConfigurationUnionTypeDef


def get_value() -> SynchronizationConfigurationUnionTypeDef:
    return ...


# SynchronizationConfigurationUnionTypeDef definition

SynchronizationConfigurationUnionTypeDef = Union[
    SynchronizationConfigurationTypeDef,  # (1)
    SynchronizationConfigurationOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: SynchronizationConfigurationTypeDef](./type_defs.md#synchronizationconfigurationtypedef)
2. See [:material-code-braces: SynchronizationConfigurationOutputTypeDef](./type_defs.md#synchronizationconfigurationoutputtypedef)

## MetadataSchemaEntryUnionTypeDef

```python
# MetadataSchemaEntryUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import MetadataSchemaEntryUnionTypeDef


def get_value() -> MetadataSchemaEntryUnionTypeDef:
    return ...


# MetadataSchemaEntryUnionTypeDef definition

MetadataSchemaEntryUnionTypeDef = Union[
    MetadataSchemaEntryTypeDef,  # (1)
    MetadataSchemaEntryOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: MetadataSchemaEntryTypeDef](./type_defs.md#metadataschemaentrytypedef)
2. See [:material-code-braces: MetadataSchemaEntryOutputTypeDef](./type_defs.md#metadataschemaentryoutputtypedef)

## MemoryRecordSchemaUnionTypeDef

```python
# MemoryRecordSchemaUnionTypeDef Union usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import MemoryRecordSchemaUnionTypeDef


def get_value() -> MemoryRecordSchemaUnionTypeDef:
    return ...


# MemoryRecordSchemaUnionTypeDef definition

MemoryRecordSchemaUnionTypeDef = Union[
    MemoryRecordSchemaTypeDef,  # (1)
    MemoryRecordSchemaOutputTypeDef,  # (2)
]
```

1. See [:material-code-braces: MemoryRecordSchemaTypeDef](./type_defs.md#memoryrecordschematypedef)
2. See [:material-code-braces: MemoryRecordSchemaOutputTypeDef](./type_defs.md#memoryrecordschemaoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import AgentCardDefinitionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import AgentRuntimeEndpointTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import AgentRuntimeTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SkillDefinitionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SkillMdDefinitionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ApiGatewayToolFilterOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ApiGatewayToolOverrideTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ApiGatewayToolFilterTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ApprovalConfigurationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import AtlassianOauth2ProviderConfigInputTypeDef
...
```python
# OAuth2AuthorizationDataTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import OAuth2AuthorizationDataTypeDef


def get_value() -> OAuth2AuthorizationDataTypeDef:
    return {
        "authorizationUrl": ...,
    }


# OAuth2AuthorizationDataTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ClaimMatchValueTypeOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import InferenceConfigurationOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import InferenceConfigurationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import VpcConfigOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import VpcConfigTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import BrowserProfileSummaryTypeDef
...
1. See [:material-code-brackets: BrowserProfileStatusType](./literals.md#browserprofilestatustype)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import BrowserSigningConfigInputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import BrowserSigningConfigOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CategoricalScaleDefinitionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CedarPolicyTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SecretsManagerLocationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ClaimMatchValueTypeTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CloudWatchLogsInputConfigOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CloudWatchLogsInputConfigTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CloudWatchOutputConfigTypeDef
...
```python
# LambdaEvaluatorConfigTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import LambdaEvaluatorConfigTypeDef


def get_value() -> LambdaEvaluatorConfigTypeDef:
    return {
        "lambdaArn": ...,
    }


# LambdaEvaluatorConfigTypeDef definition
...
```python
# CoinbaseCdpConfigurationInputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CoinbaseCdpConfigurationInputTypeDef


def get_value() -> CoinbaseCdpConfigurationInputTypeDef:
    return {
        "apiKeyId": ...,
    }


# CoinbaseCdpConfigurationInputTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ComponentConfigurationOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ComponentConfigurationTypeDef
...
```python
# MatchPathsOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import MatchPathsOutputTypeDef


def get_value() -> MatchPathsOutputTypeDef:
    return {
        "anyOf": ...,
    }


# MatchPathsOutputTypeDef definition
...
```python
# StaticOverrideTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StaticOverrideTypeDef


def get_value() -> StaticOverrideTypeDef:
    return {
        "bundleArn": ...,
    }


# StaticOverrideTypeDef definition
...
```python
# ConfigurationBundleReferenceTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ConfigurationBundleReferenceTypeDef


def get_value() -> ConfigurationBundleReferenceTypeDef:
    return {
        "bundleArn": ...,
    }


# ConfigurationBundleReferenceTypeDef definition
...
```python
# ConfigurationBundleSummaryTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ConfigurationBundleSummaryTypeDef


def get_value() -> ConfigurationBundleSummaryTypeDef:
    return {
        "bundleArn": ...,
    }


# ConfigurationBundleSummaryTypeDef definition
...
```python
# ContentConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ContentConfigurationTypeDef


def get_value() -> ContentConfigurationTypeDef:
    return {
        "type": ...,
    }


# ContentConfigurationTypeDef definition

class ContentConfigurationTypeDef(TypedDict):
    type: ContentTypeType,  # (1)
    level: NotRequired[ContentLevelType],  # (2)
```

1. See [:material-code-brackets: ContentTypeType](./literals.md#contenttypetype)
2. See [:material-code-brackets: ContentLevelType](./literals.md#contentleveltype)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ContentTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import LifecycleConfigurationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateBrowserProfileRequestTypeDef
...
```python
# VersionCreatedBySourceTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import VersionCreatedBySourceTypeDef


def get_value() -> VersionCreatedBySourceTypeDef:
    return {
        "name": ...,
    }


# VersionCreatedBySourceTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GatewayPolicyEngineConfigurationTypeDef
...
1. See [:material-code-brackets: GatewayPolicyEngineModeType](./literals.md#gatewaypolicyenginemodetype)

## SystemManagedBlockTypeDef

```python
# SystemManagedBlockTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import SystemManagedBlockTypeDef


def get_value() -> SystemManagedBlockTypeDef:
    return {
        "managedBy": ...,
    }


# SystemManagedBlockTypeDef definition
...
```python
# ManagedResourceDetailsTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ManagedResourceDetailsTypeDef


def get_value() -> ManagedResourceDetailsTypeDef:
    return {
        "domain": ...,
    }


# ManagedResourceDetailsTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import MetadataConfigurationOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessSkillTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessSystemContentBlockTypeDef
...
```python
# IndexedKeyTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import IndexedKeyTypeDef


def get_value() -> IndexedKeyTypeDef:
    return {
        "key": ...,
    }


# IndexedKeyTypeDef definition

class IndexedKeyTypeDef(TypedDict):
    key: str,
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EvaluatorReferenceTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreatePolicyEngineRequestTypeDef
...
```python
# IamCredentialProviderTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import IamCredentialProviderTypeDef


def get_value() -> IamCredentialProviderTypeDef:
    return {
        "service": ...,
    }


# IamCredentialProviderTypeDef definition
...
```python
# PaymentCredentialProviderConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import PaymentCredentialProviderConfigurationTypeDef


def get_value() -> PaymentCredentialProviderConfigurationTypeDef:
    return {
        "credentialProviderArn": ...,
    }


# PaymentCredentialProviderConfigurationTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EpisodicOverrideConsolidationConfigurationInputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EpisodicConsolidationOverrideTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CustomDescriptorTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EpisodicOverrideExtractionConfigurationInputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EpisodicExtractionOverrideTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteBrowserProfileRequestTypeDef
...
```python
# DeleteConfigurationBundleRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteConfigurationBundleRequestTypeDef


def get_value() -> DeleteConfigurationBundleRequestTypeDef:
    return {
        "bundleId": ...,
    }


# DeleteConfigurationBundleRequestTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteEvaluatorRequestTypeDef
...
```python
# DeleteGatewayRuleRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteGatewayRuleRequestTypeDef


def get_value() -> DeleteGatewayRuleRequestTypeDef:
    return {
        "gatewayIdentifier": ...,
    }


# DeleteGatewayRuleRequestTypeDef definition
...
```python
# DeleteHarnessRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteHarnessRequestTypeDef


def get_value() -> DeleteHarnessRequestTypeDef:
    return {
        "harnessId": ...,
    }


# DeleteHarnessRequestTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteOnlineEvaluationConfigRequestTypeDef
...
```python
# DeletePaymentConnectorRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import DeletePaymentConnectorRequestTypeDef


def get_value() -> DeletePaymentConnectorRequestTypeDef:
    return {
        "paymentManagerId": ...,
    }


# DeletePaymentConnectorRequestTypeDef definition
...
```python
# DeletePaymentCredentialProviderRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import DeletePaymentCredentialProviderRequestTypeDef


def get_value() -> DeletePaymentCredentialProviderRequestTypeDef:
    return {
        "name": ...,
    }


# DeletePaymentCredentialProviderRequestTypeDef definition
...
```python
# DeletePaymentManagerRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import DeletePaymentManagerRequestTypeDef


def get_value() -> DeletePaymentManagerRequestTypeDef:
    return {
        "paymentManagerId": ...,
    }


# DeletePaymentManagerRequestTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeletePolicyEngineRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeletePolicyRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteRegistryRecordRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteRegistryRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteResourcePolicyRequestTypeDef
...
```python
# EfsAccessPointConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import EfsAccessPointConfigurationTypeDef


def get_value() -> EfsAccessPointConfigurationTypeDef:
    return {
        "accessPointArn": ...,
    }


# EfsAccessPointConfigurationTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EvaluatorSummaryTypeDef
...
1. See [:material-code-brackets: EvaluatorTypeType](./literals.md#evaluatortypetype)
2. See [:material-code-brackets: EvaluatorLevelType](./literals.md#evaluatorleveltype)
3. See [:material-code-brackets: EvaluatorStatusType](./literals.md#evaluatorstatustype)

## S3FilesAccessPointConfigurationTypeDef

```python
# S3FilesAccessPointConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import S3FilesAccessPointConfigurationTypeDef


def get_value() -> S3FilesAccessPointConfigurationTypeDef:
    return {
        "accessPointArn": ...,
    }


# S3FilesAccessPointConfigurationTypeDef definition
...
```python
# SessionStorageConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import SessionStorageConfigurationTypeDef


def get_value() -> SessionStorageConfigurationTypeDef:
    return {
        "mountPath": ...,
    }


# SessionStorageConfigurationTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import FilterValueTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import FindingTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import InterceptorInputConfigurationTypeDef
...
class GatewaySummaryTypeDef(TypedDict):
    ...
    description: NotRequired[str],
    protocolType: NotRequired[GatewayProtocolTypeType],  # (3)
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RequestHeaderConfigurationOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RuntimeMetadataConfigurationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetBrowserProfileRequestTypeDef
...
```python
# GetConfigurationBundleRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetConfigurationBundleRequestTypeDef


def get_value() -> GetConfigurationBundleRequestTypeDef:
    return {
        "bundleId": ...,
    }


# GetConfigurationBundleRequestTypeDef definition
...
```python
# GetConfigurationBundleVersionRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetConfigurationBundleVersionRequestTypeDef


def get_value() -> GetConfigurationBundleVersionRequestTypeDef:
    return {
        "bundleId": ...,
    }


# GetConfigurationBundleVersionRequestTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetEvaluatorRequestTypeDef
...
```python
# GetGatewayRuleRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetGatewayRuleRequestTypeDef


def get_value() -> GetGatewayRuleRequestTypeDef:
    return {
        "gatewayIdentifier": ...,
    }


# GetGatewayRuleRequestTypeDef definition
...
```python
# GetHarnessRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetHarnessRequestTypeDef


def get_value() -> GetHarnessRequestTypeDef:
    return {
        "harnessId": ...,
    }


# GetHarnessRequestTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetOnlineEvaluationConfigRequestTypeDef
...
```python
# GetPaymentConnectorRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPaymentConnectorRequestTypeDef


def get_value() -> GetPaymentConnectorRequestTypeDef:
    return {
        "paymentManagerId": ...,
    }


# GetPaymentConnectorRequestTypeDef definition
...
```python
# GetPaymentCredentialProviderRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPaymentCredentialProviderRequestTypeDef


def get_value() -> GetPaymentCredentialProviderRequestTypeDef:
    return {
        "name": ...,
    }


# GetPaymentCredentialProviderRequestTypeDef definition
...
```python
# GetPaymentManagerRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPaymentManagerRequestTypeDef


def get_value() -> GetPaymentManagerRequestTypeDef:
    return {
        "paymentManagerId": ...,
    }


# GetPaymentManagerRequestTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPolicyEngineRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPolicyGenerationRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ResourceTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPolicyRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetRegistryRecordRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetRegistryRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetResourcePolicyRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessAgentCoreBrowserConfigTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessAgentCoreCodeInterpreterConfigTypeDef
...
```python
# HarnessAgentCoreMemoryRetrievalConfigTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessAgentCoreMemoryRetrievalConfigTypeDef


def get_value() -> HarnessAgentCoreMemoryRetrievalConfigTypeDef:
    return {
        "topK": ...,
    }


# HarnessAgentCoreMemoryRetrievalConfigTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessBedrockModelConfigTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessGeminiModelConfigTypeDef
...
```python
# HarnessInlineFunctionConfigOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessInlineFunctionConfigOutputTypeDef


def get_value() -> HarnessInlineFunctionConfigOutputTypeDef:
    return {
        "description": ...,
    }


# HarnessInlineFunctionConfigOutputTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessInlineFunctionConfigTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessOpenAiModelConfigTypeDef
...
```python
# HarnessRemoteMcpConfigOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessRemoteMcpConfigOutputTypeDef


def get_value() -> HarnessRemoteMcpConfigOutputTypeDef:
    return {
        "url": ...,
    }


# HarnessRemoteMcpConfigOutputTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessRemoteMcpConfigTypeDef
...
```python
# HarnessSlidingWindowConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessSlidingWindowConfigurationTypeDef


def get_value() -> HarnessSlidingWindowConfigurationTypeDef:
    return {
        "messagesCount": ...,
    }


# HarnessSlidingWindowConfigurationTypeDef definition
...
```python
# HarnessSummarizationConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessSummarizationConfigurationTypeDef


def get_value() -> HarnessSummarizationConfigurationTypeDef:
    return {
        "summaryRatio": ...,
    }


# HarnessSummarizationConfigurationTypeDef definition
...
```python
# HarnessSummaryTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessSummaryTypeDef


def get_value() -> HarnessSummaryTypeDef:
    return {
        "harnessId": ...,
    }


# HarnessSummaryTypeDef definition

class HarnessSummaryTypeDef(TypedDict):
    harnessId: str,
    harnessName: str,
    arn: str,
    status: HarnessStatusType,  # (1)
    createdAt: datetime.datetime,
    updatedAt: datetime.datetime,
```

1. See [:material-code-brackets: HarnessStatusType](./literals.md#harnessstatustype)

## RuntimeTargetConfigurationTypeDef

```python
# RuntimeTargetConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import RuntimeTargetConfigurationTypeDef


def get_value() -> RuntimeTargetConfigurationTypeDef:
    return {
        "arn": ...,
    }


# RuntimeTargetConfigurationTypeDef definition
...
```python
# IamPrincipalTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import IamPrincipalTypeDef


def get_value() -> IamPrincipalTypeDef:
    return {
        "arn": ...,
    }


# IamPrincipalTypeDef definition

class IamPrincipalTypeDef(TypedDict):
    arn: str,
    operator: NotRequired[PrincipalMatchOperatorType],  # (1)
```

1. See [:material-code-brackets: PrincipalMatchOperatorType](./literals.md#principalmatchoperatortype)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import IncludedOauth2ProviderConfigInputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import LambdaInterceptorConfigurationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import InvocationConfigurationInputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import InvocationConfigurationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import LinkedinOauth2ProviderConfigInputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListBrowserProfilesRequestTypeDef
...
```python
# VersionFilterTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import VersionFilterTypeDef


def get_value() -> VersionFilterTypeDef:
    return {
        "branchName": ...,
    }


# VersionFilterTypeDef definition
...
```python
# ListConfigurationBundlesRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListConfigurationBundlesRequestTypeDef


def get_value() -> ListConfigurationBundlesRequestTypeDef:
    return {
        "nextToken": ...,
    }


# ListConfigurationBundlesRequestTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListEvaluatorsRequestTypeDef
...
```python
# ListGatewayRulesRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListGatewayRulesRequestTypeDef


def get_value() -> ListGatewayRulesRequestTypeDef:
    return {
        "gatewayIdentifier": ...,
    }


# ListGatewayRulesRequestTypeDef definition
...
```python
# ListHarnessesRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListHarnessesRequestTypeDef


def get_value() -> ListHarnessesRequestTypeDef:
    return {
        "maxResults": ...,
    }


# ListHarnessesRequestTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListOnlineEvaluationConfigsRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import OnlineEvaluationConfigSummaryTypeDef
...
1. See [:material-code-brackets: OnlineEvaluationConfigStatusType](./literals.md#onlineevaluationconfigstatustype)
2. See [:material-code-brackets: OnlineEvaluationExecutionStatusType](./literals.md#onlineevaluationexecutionstatustype)

## ListPaymentConnectorsRequestTypeDef

```python
# ListPaymentConnectorsRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPaymentConnectorsRequestTypeDef


def get_value() -> ListPaymentConnectorsRequestTypeDef:
    return {
        "paymentManagerId": ...,
    }


# ListPaymentConnectorsRequestTypeDef definition
...
```python
# PaymentConnectorSummaryTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import PaymentConnectorSummaryTypeDef


def get_value() -> PaymentConnectorSummaryTypeDef:
    return {
        "paymentConnectorId": ...,
    }


# PaymentConnectorSummaryTypeDef definition

class PaymentConnectorSummaryTypeDef(TypedDict):
    paymentConnectorId: str,
    name: str,
    type: PaymentConnectorTypeType,  # (1)
    status: PaymentConnectorStatusType,  # (2)
    lastUpdatedAt: datetime.datetime,
```

1. See [:material-code-brackets: PaymentConnectorTypeType](./literals.md#paymentconnectortypetype)
2. See [:material-code-brackets: PaymentConnectorStatusType](./literals.md#paymentconnectorstatustype)

## ListPaymentCredentialProvidersRequestTypeDef

```python
# ListPaymentCredentialProvidersRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPaymentCredentialProvidersRequestTypeDef


def get_value() -> ListPaymentCredentialProvidersRequestTypeDef:
    return {
        "nextToken": ...,
    }


# ListPaymentCredentialProvidersRequestTypeDef definition
...
```python
# PaymentCredentialProviderItemTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import PaymentCredentialProviderItemTypeDef


def get_value() -> PaymentCredentialProviderItemTypeDef:
    return {
        "name": ...,
    }


# PaymentCredentialProviderItemTypeDef definition
...
```python
# ListPaymentManagersRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPaymentManagersRequestTypeDef


def get_value() -> ListPaymentManagersRequestTypeDef:
    return {
        "maxResults": ...,
    }


# ListPaymentManagersRequestTypeDef definition
...
```python
# PaymentManagerSummaryTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import PaymentManagerSummaryTypeDef


def get_value() -> PaymentManagerSummaryTypeDef:
    return {
        "paymentManagerArn": ...,
    }


# PaymentManagerSummaryTypeDef definition
...
class PaymentManagerSummaryTypeDef(TypedDict):
    ...
    roleArn: str,
    status: PaymentManagerStatusType,  # (2)
    lastUpdatedAt: datetime.datetime,
    description: NotRequired[str],
...
2. See [:material-code-brackets: PaymentManagerStatusType](./literals.md#paymentmanagerstatustype)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPoliciesRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPolicyEnginesRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PolicyEngineTypeDef
...
1. See [:material-code-brackets: PolicyEngineStatusType](./literals.md#policyenginestatustype)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPolicyGenerationAssetsRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPolicyGenerationsRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListRegistriesRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RegistrySummaryTypeDef
...
class RegistrySummaryTypeDef(TypedDict):
    ...
    updatedAt: datetime.datetime,
    description: NotRequired[str],
    authorizerType: NotRequired[RegistryAuthorizerTypeType],  # (1)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListRegistryRecordsRequestTypeDef
...
class ListRegistryRecordsRequestTypeDef(TypedDict):
    ...
    nextToken: NotRequired[str],
    name: NotRequired[str],
    status: NotRequired[RegistryRecordStatusType],  # (1)
    descriptorType: NotRequired[DescriptorTypeType],  # (2)
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RegistryRecordSummaryTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListTagsForResourceRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SessionConfigurationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import StreamingConfigurationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ManagedVpcResourceOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ManagedVpcResourceTypeDef
...
```python
# MatchPathsTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import MatchPathsTypeDef


def get_value() -> MatchPathsTypeDef:
    return {
        "anyOf": ...,
    }


# MatchPathsTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ServerDefinitionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ToolsDefinitionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import MessageBasedTriggerInputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import MessageBasedTriggerTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import MetadataConfigurationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ModifyInvocationConfigurationInputTypeDef
...
```python
# NumberValidationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import NumberValidationTypeDef


def get_value() -> NumberValidationTypeDef:
    return {
        "minValue": ...,
    }


# NumberValidationTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import NumericalScaleDefinitionTypeDef
...
```python
# TokenExchangeGrantTypeConfigTypeOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import TokenExchangeGrantTypeConfigTypeOutputTypeDef


def get_value() -> TokenExchangeGrantTypeConfigTypeOutputTypeDef:
    return {
        "actorTokenContent": ...,
    }


# TokenExchangeGrantTypeConfigTypeOutputTypeDef definition

class TokenExchangeGrantTypeConfigTypeOutputTypeDef(TypedDict):
    actorTokenContent: ActorTokenContentTypeType,  # (1)
    actorTokenScopes: NotRequired[list[str]],
```

1. See [:material-code-brackets: ActorTokenContentTypeType](./literals.md#actortokencontenttypetype)

## StripePrivyConfigurationInputTypeDef

```python
# StripePrivyConfigurationInputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StripePrivyConfigurationInputTypeDef


def get_value() -> StripePrivyConfigurationInputTypeDef:
    return {
        "appId": ...,
    }


# StripePrivyConfigurationInputTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PolicyGenerationDetailsTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SelfManagedLatticeResourceTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PutResourcePolicyRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RegistryRecordIamCredentialProviderTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RegistryRecordOAuthCredentialProviderOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RegistryRecordOAuthCredentialProviderTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RequestHeaderConfigurationTypeDef
...
```python
# StaticRouteTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StaticRouteTypeDef


def get_value() -> StaticRouteTypeDef:
    return {
        "targetName": ...,
    }


# StaticRouteTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SamplingConfigTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SessionConfigTypeDef
...
```python
# StringListValidationOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StringListValidationOutputTypeDef


def get_value() -> StringListValidationOutputTypeDef:
    return {
        "allowedValues": ...,
    }


# StringListValidationOutputTypeDef definition
...
```python
# StringListValidationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StringListValidationTypeDef


def get_value() -> StringListValidationTypeDef:
    return {
        "allowedValues": ...,
    }


# StringListValidationTypeDef definition
...
```python
# StringValidationOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StringValidationOutputTypeDef


def get_value() -> StringValidationOutputTypeDef:
    return {
        "allowedValues": ...,
    }


# StringValidationOutputTypeDef definition
...
```python
# StringValidationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StringValidationTypeDef


def get_value() -> StringValidationTypeDef:
    return {
        "allowedValues": ...,
    }


# StringValidationTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SubmitRegistryRecordForApprovalRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SynchronizeGatewayTargetsRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import TagResourceRequestTypeDef
...
```python
# TargetTrafficSplitEntryOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import TargetTrafficSplitEntryOutputTypeDef


def get_value() -> TargetTrafficSplitEntryOutputTypeDef:
    return {
        "name": ...,
    }


# TargetTrafficSplitEntryOutputTypeDef definition
...
```python
# TargetTrafficSplitEntryTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import TargetTrafficSplitEntryTypeDef


def get_value() -> TargetTrafficSplitEntryTypeDef:
    return {
        "name": ...,
    }


# TargetTrafficSplitEntryTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import TimeBasedTriggerInputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import TimeBasedTriggerTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import TokenBasedTriggerInputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import TokenBasedTriggerTypeDef
...
```python
# TokenExchangeGrantTypeConfigTypeTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import TokenExchangeGrantTypeConfigTypeTypeDef


def get_value() -> TokenExchangeGrantTypeConfigTypeTypeDef:
    return {
        "actorTokenContent": ...,
    }


# TokenExchangeGrantTypeConfigTypeTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UntagResourceRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedDescriptionTypeDef
...
```python
# UpdatedSynchronizationTypeTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedSynchronizationTypeTypeDef


def get_value() -> UpdatedSynchronizationTypeTypeDef:
    return {
        "optionalValue": ...,
    }


# UpdatedSynchronizationTypeTypeDef definition

class UpdatedSynchronizationTypeTypeDef(TypedDict):
    optionalValue: NotRequired[SynchronizationTypeType],  # (1)
```

1. See [:material-code-brackets: SynchronizationTypeType](./literals.md#synchronizationtypetype)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateRegistryRecordStatusRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import A2aDescriptorTypeDef
...
class A2aDescriptorTypeDef(TypedDict):
    agentCard: NotRequired[AgentCardDefinitionTypeDef],  # (1)
```
...
```python
# HarnessEnvironmentArtifactTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessEnvironmentArtifactTypeDef


def get_value() -> HarnessEnvironmentArtifactTypeDef:
    return {
        "containerConfiguration": ...,
    }


# HarnessEnvironmentArtifactTypeDef definition
...
```python
# UpdatedSkillDefinitionTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedSkillDefinitionTypeDef


def get_value() -> UpdatedSkillDefinitionTypeDef:
    return {
        "optionalValue": ...,
    }


# UpdatedSkillDefinitionTypeDef definition

class UpdatedSkillDefinitionTypeDef(TypedDict):
    optionalValue: NotRequired[SkillDefinitionTypeDef],  # (1)
```

1. See [:material-code-braces: SkillDefinitionTypeDef](./type_defs.md#skilldefinitiontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import AgentSkillsDescriptorTypeDef
...
class AgentSkillsDescriptorTypeDef(TypedDict):
    skillMd: NotRequired[SkillMdDefinitionTypeDef],  # (1)
...
```python
# UpdatedSkillMdDefinitionTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedSkillMdDefinitionTypeDef


def get_value() -> UpdatedSkillMdDefinitionTypeDef:
    return {
        "optionalValue": ...,
    }


# UpdatedSkillMdDefinitionTypeDef definition

class UpdatedSkillMdDefinitionTypeDef(TypedDict):
    optionalValue: NotRequired[SkillMdDefinitionTypeDef],  # (1)
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ApiGatewayToolConfigurationOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ApiGatewayToolConfigurationTypeDef
...
```python
# McpToolSchemaConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import McpToolSchemaConfigurationTypeDef


def get_value() -> McpToolSchemaConfigurationTypeDef:
    return {
        "s3": ...,
    }


# McpToolSchemaConfigurationTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedApprovalConfigurationTypeDef
...
class UpdatedApprovalConfigurationTypeDef(TypedDict):
    optionalValue: NotRequired[ApprovalConfigurationTypeDef],  # (1)
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import AuthorizationDataTypeDef
...
class AuthorizationDataTypeDef(TypedDict):
    oauth2: NotRequired[OAuth2AuthorizationDataTypeDef],  # (1)
```

1. See [:material-code-braces: OAuth2AuthorizationDataTypeDef](./type_defs.md#oauth2authorizationdatatypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import AuthorizingClaimMatchValueTypeOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import BedrockEvaluatorModelConfigOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import BedrockEvaluatorModelConfigTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import BrowserNetworkConfigurationOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CodeInterpreterNetworkConfigurationOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import NetworkConfigurationOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CertificateLocationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DataSourceConfigOutputTypeDef
...
1. See [:material-code-braces: CloudWatchLogsInputConfigOutputTypeDef](./type_defs.md#cloudwatchlogsinputconfigoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DataSourceConfigTypeDef
...
1. See [:material-code-braces: CloudWatchLogsInputConfigTypeDef](./type_defs.md#cloudwatchlogsinputconfigtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import OutputConfigTypeDef
...
```python
# CodeBasedEvaluatorConfigTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CodeBasedEvaluatorConfigTypeDef


def get_value() -> CodeBasedEvaluatorConfigTypeDef:
    return {
        "lambdaConfig": ...,
    }


# CodeBasedEvaluatorConfigTypeDef definition

class CodeBasedEvaluatorConfigTypeDef(TypedDict):
    lambdaConfig: NotRequired[LambdaEvaluatorConfigTypeDef],  # (1)
```

1. See [:material-code-braces: LambdaEvaluatorConfigTypeDef](./type_defs.md#lambdaevaluatorconfigtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CodeTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RecordingConfigTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ResourceLocationTypeDef
...
```python
# CoinbaseCdpConfigurationOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CoinbaseCdpConfigurationOutputTypeDef


def get_value() -> CoinbaseCdpConfigurationOutputTypeDef:
    return {
        "apiKeyId": ...,
    }


# CoinbaseCdpConfigurationOutputTypeDef definition

class CoinbaseCdpConfigurationOutputTypeDef(TypedDict):
    apiKeyId: str,
    apiKeySecretArn: SecretTypeDef,  # (1)
    walletSecretArn: SecretTypeDef,  # (1)
```
...
```python
# StripePrivyConfigurationOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StripePrivyConfigurationOutputTypeDef


def get_value() -> StripePrivyConfigurationOutputTypeDef:
    return {
        "appId": ...,
    }


# StripePrivyConfigurationOutputTypeDef definition

class StripePrivyConfigurationOutputTypeDef(TypedDict):
    appId: str,
    appSecretArn: SecretTypeDef,  # (1)
    authorizationPrivateKeyArn: SecretTypeDef,  # (1)
    authorizationId: str,
```
...
```python
# TrafficSplitEntryOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import TrafficSplitEntryOutputTypeDef


def get_value() -> TrafficSplitEntryOutputTypeDef:
    return {
        "name": ...,
    }


# TrafficSplitEntryOutputTypeDef definition

class TrafficSplitEntryOutputTypeDef(TypedDict):
    name: str,
    weight: int,
    configurationBundle: ConfigurationBundleReferenceTypeDef,  # (1)
    description: NotRequired[str],
    metadata: NotRequired[dict[str, str]],
```

1. See [:material-code-braces: ConfigurationBundleReferenceTypeDef](./type_defs.md#configurationbundlereferencetypedef)

## TrafficSplitEntryTypeDef

```python
# TrafficSplitEntryTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import TrafficSplitEntryTypeDef


def get_value() -> TrafficSplitEntryTypeDef:
    return {
        "name": ...,
    }


# TrafficSplitEntryTypeDef definition
...
```python
# KinesisResourceOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import KinesisResourceOutputTypeDef


def get_value() -> KinesisResourceOutputTypeDef:
    return {
        "dataStreamArn": ...,
    }


# KinesisResourceOutputTypeDef definition

class KinesisResourceOutputTypeDef(TypedDict):
    dataStreamArn: str,
    contentConfigurations: list[ContentConfigurationTypeDef],  # (1)
```

1. See `list[ContentConfigurationTypeDef]`

## KinesisResourceTypeDef

```python
# KinesisResourceTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import KinesisResourceTypeDef


def get_value() -> KinesisResourceTypeDef:
    return {
        "dataStreamArn": ...,
    }


# KinesisResourceTypeDef definition

class KinesisResourceTypeDef(TypedDict):
    dataStreamArn: str,
    contentConfigurations: Sequence[ContentConfigurationTypeDef],  # (1)
```

1. See `Sequence[ContentConfigurationTypeDef]`
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateBrowserProfileResponseTypeDef
...
```python
# CreateConfigurationBundleResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateConfigurationBundleResponseTypeDef


def get_value() -> CreateConfigurationBundleResponseTypeDef:
    return {
        "bundleArn": ...,
    }


# CreateConfigurationBundleResponseTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateEvaluatorResponseTypeDef
...
1. See [:material-code-brackets: EvaluatorStatusType](./literals.md#evaluatorstatustype)
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreatePolicyEngineResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateRegistryRecordResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateRegistryResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteBrowserProfileResponseTypeDef
...
```python
# DeleteConfigurationBundleResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteConfigurationBundleResponseTypeDef


def get_value() -> DeleteConfigurationBundleResponseTypeDef:
    return {
        "bundleId": ...,
    }


# DeleteConfigurationBundleResponseTypeDef definition

class DeleteConfigurationBundleResponseTypeDef(TypedDict):
    bundleId: str,
    status: ConfigurationBundleStatusType,  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-brackets: ConfigurationBundleStatusType](./literals.md#configurationbundlestatustype)
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteEvaluatorResponseTypeDef
...
```python
# DeleteGatewayRuleResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteGatewayRuleResponseTypeDef


def get_value() -> DeleteGatewayRuleResponseTypeDef:
    return {
        "ruleId": ...,
    }


# DeleteGatewayRuleResponseTypeDef definition

class DeleteGatewayRuleResponseTypeDef(TypedDict):
    ruleId: str,
    status: GatewayRuleStatusType,  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-brackets: GatewayRuleStatusType](./literals.md#gatewayrulestatustype)
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteOnlineEvaluationConfigResponseTypeDef
...
```python
# DeletePaymentConnectorResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import DeletePaymentConnectorResponseTypeDef


def get_value() -> DeletePaymentConnectorResponseTypeDef:
    return {
        "status": ...,
    }


# DeletePaymentConnectorResponseTypeDef definition

class DeletePaymentConnectorResponseTypeDef(TypedDict):
    status: PaymentConnectorStatusType,  # (1)
    paymentConnectorId: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-brackets: PaymentConnectorStatusType](./literals.md#paymentconnectorstatustype)
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## DeletePaymentManagerResponseTypeDef

```python
# DeletePaymentManagerResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import DeletePaymentManagerResponseTypeDef


def get_value() -> DeletePaymentManagerResponseTypeDef:
    return {
        "status": ...,
    }


# DeletePaymentManagerResponseTypeDef definition

class DeletePaymentManagerResponseTypeDef(TypedDict):
    status: PaymentManagerStatusType,  # (1)
    paymentManagerId: str,
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-brackets: PaymentManagerStatusType](./literals.md#paymentmanagerstatustype)
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeletePolicyEngineResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteRegistryResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetBrowserProfileResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPolicyEngineResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetResourcePolicyResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListBrowserProfilesResponseTypeDef
...
```python
# ListConfigurationBundlesResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListConfigurationBundlesResponseTypeDef


def get_value() -> ListConfigurationBundlesResponseTypeDef:
    return {
        "bundles": ...,
    }


# ListConfigurationBundlesResponseTypeDef definition

class ListConfigurationBundlesResponseTypeDef(TypedDict):
    bundles: list[ConfigurationBundleSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[ConfigurationBundleSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListTagsForResourceResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PutResourcePolicyResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SubmitRegistryRecordForApprovalResponseTypeDef
...
```python
# UpdateConfigurationBundleResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateConfigurationBundleResponseTypeDef


def get_value() -> UpdateConfigurationBundleResponseTypeDef:
    return {
        "bundleArn": ...,
    }


# UpdateConfigurationBundleResponseTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateEvaluatorResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateOnlineEvaluationConfigResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatePolicyEngineResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateRegistryRecordStatusResponseTypeDef
...
```python
# UpdatePaymentManagerResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatePaymentManagerResponseTypeDef


def get_value() -> UpdatePaymentManagerResponseTypeDef:
    return {
        "paymentManagerArn": ...,
    }


# UpdatePaymentManagerResponseTypeDef definition
...
class UpdatePaymentManagerResponseTypeDef(TypedDict):
    ...
    authorizerType: PaymentsAuthorizerTypeType,  # (1)
    roleArn: str,
    workloadIdentityDetails: WorkloadIdentityDetailsTypeDef,  # (2)
    lastUpdatedAt: datetime.datetime,
    status: PaymentManagerStatusType,  # (3)
    ResponseMetadata: ResponseMetadataTypeDef,  # (4)
```

1. See [:material-code-brackets: PaymentsAuthorizerTypeType](./literals.md#paymentsauthorizertypetype)
2. See [:material-code-braces: WorkloadIdentityDetailsTypeDef](./type_defs.md#workloadidentitydetailstypedef)
3. See [:material-code-brackets: PaymentManagerStatusType](./literals.md#paymentmanagerstatustype)
4. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## VersionLineageMetadataTypeDef

```python
# VersionLineageMetadataTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import VersionLineageMetadataTypeDef


def get_value() -> VersionLineageMetadataTypeDef:
    return {
        "parentVersionIds": ...,
    }


# VersionLineageMetadataTypeDef definition

class VersionLineageMetadataTypeDef(TypedDict):
    parentVersionIds: NotRequired[list[str]],
    branchName: NotRequired[str],
    createdBy: NotRequired[VersionCreatedBySourceTypeDef],  # (1)
    commitMessage: NotRequired[str],
```

1. See [:material-code-braces: VersionCreatedBySourceTypeDef](./type_defs.md#versioncreatedbysourcetypedef)
...
class CredentialProviderOutputTypeDef(TypedDict):
    ...
    iamCredentialProvider: NotRequired[IamCredentialProviderTypeDef],  # (3)
```

1. See [:material-code-braces: OAuthCredentialProviderOutputTypeDef](./type_defs.md#oauthcredentialprovideroutputtypedef)
2. See [:material-code-braces: ApiKeyCredentialProviderTypeDef](./type_defs.md#apikeycredentialprovidertypedef)
3. See [:material-code-braces: IamCredentialProviderTypeDef](./type_defs.md#iamcredentialprovidertypedef)

## HarnessGatewayOutboundAuthOutputTypeDef

```python
# HarnessGatewayOutboundAuthOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessGatewayOutboundAuthOutputTypeDef


def get_value() -> HarnessGatewayOutboundAuthOutputTypeDef:
    return {
        "awsIam": ...,
    }


# HarnessGatewayOutboundAuthOutputTypeDef definition

class HarnessGatewayOutboundAuthOutputTypeDef(TypedDict):
    awsIam: NotRequired[dict[str, Any]],
    none: NotRequired[dict[str, Any]],
    oauth: NotRequired[OAuthCredentialProviderOutputTypeDef],  # (1)
```
...
```python
# CredentialsProviderConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CredentialsProviderConfigurationTypeDef


def get_value() -> CredentialsProviderConfigurationTypeDef:
    return {
        "coinbaseCDP": ...,
    }


# CredentialsProviderConfigurationTypeDef definition

class CredentialsProviderConfigurationTypeDef(TypedDict):
    coinbaseCDP: NotRequired[PaymentCredentialProviderConfigurationTypeDef],  # (1)
    stripePrivy: NotRequired[PaymentCredentialProviderConfigurationTypeDef],  # (1)
```

1. See [:material-code-braces: PaymentCredentialProviderConfigurationTypeDef](./type_defs.md#paymentcredentialproviderconfigurationtypedef)
2. See [:material-code-braces: PaymentCredentialProviderConfigurationTypeDef](./type_defs.md#paymentcredentialproviderconfigurationtypedef)
...
1. See [:material-code-braces: SemanticOverrideConsolidationConfigurationInputTypeDef](./type_defs.md#semanticoverrideconsolidationconfigurationinputtypedef)
...
4. See [:material-code-braces: EpisodicOverrideConsolidationConfigurationInputTypeDef](./type_defs.md#episodicoverrideconsolidationconfigurationinputtypedef)
...
4. See [:material-code-braces: EpisodicConsolidationOverrideTypeDef](./type_defs.md#episodicconsolidationoverridetypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedCustomDescriptorTypeDef
...
class UpdatedCustomDescriptorTypeDef(TypedDict):
    optionalValue: NotRequired[CustomDescriptorTypeDef],  # (1)
```

1. See [:material-code-braces: CustomDescriptorTypeDef](./type_defs.md#customdescriptortypedef)
...
3. See [:material-code-braces: EpisodicOverrideExtractionConfigurationInputTypeDef](./type_defs.md#episodicoverrideextractionconfigurationinputtypedef)
...
1. See [:material-code-braces: UserPreferenceOverrideExtractionConfigurationInputTypeDef](./type_defs.md#userpreferenceoverrideextractionconfigurationinputtypedef)
...
3. See [:material-code-braces: EpisodicExtractionOverrideTypeDef](./type_defs.md#episodicextractionoverridetypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListEvaluatorsResponseTypeDef
...
```python
# FilesystemConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import FilesystemConfigurationTypeDef


def get_value() -> FilesystemConfigurationTypeDef:
    return {
        "sessionStorage": ...,
    }


# FilesystemConfigurationTypeDef definition

class FilesystemConfigurationTypeDef(TypedDict):
    sessionStorage: NotRequired[SessionStorageConfigurationTypeDef],  # (1)
    s3FilesAccessPoint: NotRequired[S3FilesAccessPointConfigurationTypeDef],  # (2)
    efsAccessPoint: NotRequired[EfsAccessPointConfigurationTypeDef],  # (3)
```

1. See [:material-code-braces: SessionStorageConfigurationTypeDef](./type_defs.md#sessionstorageconfigurationtypedef)
2. See [:material-code-braces: S3FilesAccessPointConfigurationTypeDef](./type_defs.md#s3filesaccesspointconfigurationtypedef)
3. See [:material-code-braces: EfsAccessPointConfigurationTypeDef](./type_defs.md#efsaccesspointconfigurationtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import FilterTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPolicyEngineRequestWaitExtraTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPolicyEngineRequestWaitTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPolicyGenerationRequestWaitTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPolicyRequestWaitExtraTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPolicyRequestWaitTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPolicyGenerationResponseTypeDef
...
2. See [:material-code-brackets: PolicyGenerationStatusType](./literals.md#policygenerationstatustype)
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PolicyGenerationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import StartPolicyGenerationRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import StartPolicyGenerationResponseTypeDef
...
```python
# HarnessAgentCoreMemoryConfigurationOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessAgentCoreMemoryConfigurationOutputTypeDef


def get_value() -> HarnessAgentCoreMemoryConfigurationOutputTypeDef:
    return {
        "arn": ...,
    }


# HarnessAgentCoreMemoryConfigurationOutputTypeDef definition

class HarnessAgentCoreMemoryConfigurationOutputTypeDef(TypedDict):
    arn: str,
    actorId: NotRequired[str],
    messagesCount: NotRequired[int],
    retrievalConfig: NotRequired[dict[str, HarnessAgentCoreMemoryRetrievalConfigTypeDef]],  # (1)
```

1. See `dict[str, HarnessAgentCoreMemoryRetrievalConfigTypeDef]`

## HarnessAgentCoreMemoryConfigurationTypeDef

```python
# HarnessAgentCoreMemoryConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessAgentCoreMemoryConfigurationTypeDef


def get_value() -> HarnessAgentCoreMemoryConfigurationTypeDef:
    return {
        "arn": ...,
    }


# HarnessAgentCoreMemoryConfigurationTypeDef definition

class HarnessAgentCoreMemoryConfigurationTypeDef(TypedDict):
    arn: str,
    actorId: NotRequired[str],
    messagesCount: NotRequired[int],
    retrievalConfig: NotRequired[Mapping[str, HarnessAgentCoreMemoryRetrievalConfigTypeDef]],  # (1)
```

1. See `Mapping[str, HarnessAgentCoreMemoryRetrievalConfigTypeDef]`
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessModelConfigurationTypeDef
...
```python
# HarnessTruncationStrategyConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessTruncationStrategyConfigurationTypeDef


def get_value() -> HarnessTruncationStrategyConfigurationTypeDef:
    return {
        "slidingWindow": ...,
    }


# HarnessTruncationStrategyConfigurationTypeDef definition

class HarnessTruncationStrategyConfigurationTypeDef(TypedDict):
    slidingWindow: NotRequired[HarnessSlidingWindowConfigurationTypeDef],  # (1)
    summarization: NotRequired[HarnessSummarizationConfigurationTypeDef],  # (2)
```

1. See [:material-code-braces: HarnessSlidingWindowConfigurationTypeDef](./type_defs.md#harnessslidingwindowconfigurationtypedef)
2. See [:material-code-braces: HarnessSummarizationConfigurationTypeDef](./type_defs.md#harnesssummarizationconfigurationtypedef)

## ListHarnessesResponseTypeDef

```python
# ListHarnessesResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListHarnessesResponseTypeDef


def get_value() -> ListHarnessesResponseTypeDef:
    return {
        "harnesses": ...,
    }


# ListHarnessesResponseTypeDef definition

class ListHarnessesResponseTypeDef(TypedDict):
    harnesses: list[HarnessSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[HarnessSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## HttpTargetConfigurationTypeDef

```python
# HttpTargetConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HttpTargetConfigurationTypeDef


def get_value() -> HttpTargetConfigurationTypeDef:
    return {
        "agentcoreRuntime": ...,
    }


# HttpTargetConfigurationTypeDef definition

class HttpTargetConfigurationTypeDef(TypedDict):
    agentcoreRuntime: NotRequired[RuntimeTargetConfigurationTypeDef],  # (1)
```

1. See [:material-code-braces: RuntimeTargetConfigurationTypeDef](./type_defs.md#runtimetargetconfigurationtypedef)

## MatchPrincipalEntryTypeDef

```python
# MatchPrincipalEntryTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import MatchPrincipalEntryTypeDef


def get_value() -> MatchPrincipalEntryTypeDef:
    return {
        "iamPrincipal": ...,
    }


# MatchPrincipalEntryTypeDef definition

class MatchPrincipalEntryTypeDef(TypedDict):
    iamPrincipal: NotRequired[IamPrincipalTypeDef],  # (1)
```

1. See [:material-code-braces: IamPrincipalTypeDef](./type_defs.md#iamprincipaltypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import InterceptorConfigurationTypeDef
...
1. See [:material-code-braces: LambdaInterceptorConfigurationTypeDef](./type_defs.md#lambdainterceptorconfigurationtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListBrowserProfilesRequestPaginateTypeDef
...
```python
# ListConfigurationBundlesRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListConfigurationBundlesRequestPaginateTypeDef


def get_value() -> ListConfigurationBundlesRequestPaginateTypeDef:
    return {
        "PaginationConfig": ...,
    }


# ListConfigurationBundlesRequestPaginateTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListEvaluatorsRequestPaginateTypeDef
...
```python
# ListGatewayRulesRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListGatewayRulesRequestPaginateTypeDef


def get_value() -> ListGatewayRulesRequestPaginateTypeDef:
    return {
        "gatewayIdentifier": ...,
    }


# ListGatewayRulesRequestPaginateTypeDef definition
...
```python
# ListHarnessesRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListHarnessesRequestPaginateTypeDef


def get_value() -> ListHarnessesRequestPaginateTypeDef:
    return {
        "PaginationConfig": ...,
    }


# ListHarnessesRequestPaginateTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListOnlineEvaluationConfigsRequestPaginateTypeDef
...
```python
# ListPaymentConnectorsRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPaymentConnectorsRequestPaginateTypeDef


def get_value() -> ListPaymentConnectorsRequestPaginateTypeDef:
    return {
        "paymentManagerId": ...,
    }


# ListPaymentConnectorsRequestPaginateTypeDef definition
...
```python
# ListPaymentCredentialProvidersRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPaymentCredentialProvidersRequestPaginateTypeDef


def get_value() -> ListPaymentCredentialProvidersRequestPaginateTypeDef:
    return {
        "PaginationConfig": ...,
    }


# ListPaymentCredentialProvidersRequestPaginateTypeDef definition
...
```python
# ListPaymentManagersRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPaymentManagersRequestPaginateTypeDef


def get_value() -> ListPaymentManagersRequestPaginateTypeDef:
    return {
        "PaginationConfig": ...,
    }


# ListPaymentManagersRequestPaginateTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPoliciesRequestPaginateTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPolicyEnginesRequestPaginateTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPolicyGenerationAssetsRequestPaginateTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPolicyGenerationsRequestPaginateTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListRegistriesRequestPaginateTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListRegistryRecordsRequestPaginateTypeDef
...
```python
# ListConfigurationBundleVersionsRequestPaginateTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListConfigurationBundleVersionsRequestPaginateTypeDef


def get_value() -> ListConfigurationBundleVersionsRequestPaginateTypeDef:
    return {
        "bundleId": ...,
    }


# ListConfigurationBundleVersionsRequestPaginateTypeDef definition

class ListConfigurationBundleVersionsRequestPaginateTypeDef(TypedDict):
    bundleId: str,
    filter: NotRequired[VersionFilterTypeDef],  # (1)
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (2)
```
...
```python
# ListConfigurationBundleVersionsRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListConfigurationBundleVersionsRequestTypeDef


def get_value() -> ListConfigurationBundleVersionsRequestTypeDef:
    return {
        "bundleId": ...,
    }


# ListConfigurationBundleVersionsRequestTypeDef definition

class ListConfigurationBundleVersionsRequestTypeDef(TypedDict):
    bundleId: str,
    nextToken: NotRequired[str],
    maxResults: NotRequired[int],
    filter: NotRequired[VersionFilterTypeDef],  # (1)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListMemoriesOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListOauth2CredentialProvidersResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListOnlineEvaluationConfigsResponseTypeDef
...
```python
# ListPaymentConnectorsResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPaymentConnectorsResponseTypeDef


def get_value() -> ListPaymentConnectorsResponseTypeDef:
    return {
        "paymentConnectors": ...,
    }


# ListPaymentConnectorsResponseTypeDef definition

class ListPaymentConnectorsResponseTypeDef(TypedDict):
    paymentConnectors: list[PaymentConnectorSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[PaymentConnectorSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## ListPaymentCredentialProvidersResponseTypeDef

```python
# ListPaymentCredentialProvidersResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPaymentCredentialProvidersResponseTypeDef


def get_value() -> ListPaymentCredentialProvidersResponseTypeDef:
    return {
        "credentialProviders": ...,
    }


# ListPaymentCredentialProvidersResponseTypeDef definition

class ListPaymentCredentialProvidersResponseTypeDef(TypedDict):
    credentialProviders: list[PaymentCredentialProviderItemTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[PaymentCredentialProviderItemTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## ListPaymentManagersResponseTypeDef

```python
# ListPaymentManagersResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPaymentManagersResponseTypeDef


def get_value() -> ListPaymentManagersResponseTypeDef:
    return {
        "paymentManagers": ...,
    }


# ListPaymentManagersResponseTypeDef definition

class ListPaymentManagersResponseTypeDef(TypedDict):
    paymentManagers: list[PaymentManagerSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[PaymentManagerSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPolicyEnginesResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListRegistriesResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListRegistryRecordsResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListWorkloadIdentitiesResponseTypeDef
...
class MCPGatewayConfigurationOutputTypeDef(TypedDict):
    ...
    sessionConfiguration: NotRequired[SessionConfigurationTypeDef],  # (2)
    streamingConfiguration: NotRequired[StreamingConfigurationTypeDef],  # (3)
```
...
3. See [:material-code-braces: StreamingConfigurationTypeDef](./type_defs.md#streamingconfigurationtypedef)
...
```python
# UpdatedServerDefinitionTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedServerDefinitionTypeDef


def get_value() -> UpdatedServerDefinitionTypeDef:
    return {
        "optionalValue": ...,
    }


# UpdatedServerDefinitionTypeDef definition

class UpdatedServerDefinitionTypeDef(TypedDict):
    optionalValue: NotRequired[ServerDefinitionTypeDef],  # (1)
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import McpDescriptorTypeDef
...
class McpDescriptorTypeDef(TypedDict):
    server: NotRequired[ServerDefinitionTypeDef],  # (1)
    tools: NotRequired[ToolsDefinitionTypeDef],  # (2)
```
...
```python
# UpdatedToolsDefinitionTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedToolsDefinitionTypeDef


def get_value() -> UpdatedToolsDefinitionTypeDef:
    return {
        "optionalValue": ...,
    }


# UpdatedToolsDefinitionTypeDef definition

class UpdatedToolsDefinitionTypeDef(TypedDict):
    optionalValue: NotRequired[ToolsDefinitionTypeDef],  # (1)
```

1. See [:material-code-braces: ToolsDefinitionTypeDef](./type_defs.md#toolsdefinitiontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RatingScaleOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RatingScaleTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import Oauth2DiscoveryOutputTypeDef
...
1. See [:material-code-braces: Oauth2AuthorizationServerMetadataOutputTypeDef](./type_defs.md#oauth2authorizationservermetadataoutputtypedef)

## OnBehalfOfTokenExchangeConfigTypeOutputTypeDef

```python
# OnBehalfOfTokenExchangeConfigTypeOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import OnBehalfOfTokenExchangeConfigTypeOutputTypeDef


def get_value() -> OnBehalfOfTokenExchangeConfigTypeOutputTypeDef:
    return {
        "grantType": ...,
    }


# OnBehalfOfTokenExchangeConfigTypeOutputTypeDef definition

class OnBehalfOfTokenExchangeConfigTypeOutputTypeDef(TypedDict):
    grantType: OnBehalfOfTokenExchangeGrantTypeTypeType,  # (1)
    tokenExchangeGrantTypeConfig: NotRequired[TokenExchangeGrantTypeConfigTypeOutputTypeDef],  # (2)
```

1. See [:material-code-brackets: OnBehalfOfTokenExchangeGrantTypeTypeType](./literals.md#onbehalfoftokenexchangegranttypetypetype)
2. See [:material-code-braces: TokenExchangeGrantTypeConfigTypeOutputTypeDef](./type_defs.md#tokenexchangegranttypeconfigtypeoutputtypedef)

## PaymentProviderConfigurationInputTypeDef

```python
# PaymentProviderConfigurationInputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import PaymentProviderConfigurationInputTypeDef


def get_value() -> PaymentProviderConfigurationInputTypeDef:
    return {
        "coinbaseCdpConfiguration": ...,
    }


# PaymentProviderConfigurationInputTypeDef definition

class PaymentProviderConfigurationInputTypeDef(TypedDict):
    coinbaseCdpConfiguration: NotRequired[CoinbaseCdpConfigurationInputTypeDef],  # (1)
    stripePrivyConfiguration: NotRequired[StripePrivyConfigurationInputTypeDef],  # (2)
```

1. See [:material-code-braces: CoinbaseCdpConfigurationInputTypeDef](./type_defs.md#coinbasecdpconfigurationinputtypedef)
2. See [:material-code-braces: StripePrivyConfigurationInputTypeDef](./type_defs.md#stripeprivyconfigurationinputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PolicyDefinitionTypeDef
...
1. See [:material-code-braces: CedarPolicyTypeDef](./type_defs.md#cedarpolicytypedef)
2. See [:material-code-braces: PolicyGenerationDetailsTypeDef](./type_defs.md#policygenerationdetailstypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PrivateEndpointOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RegistryRecordCredentialProviderUnionOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ToolDefinitionOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ToolDefinitionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ValidationOutputTypeDef
...
class ValidationOutputTypeDef(TypedDict):
    stringValidation: NotRequired[StringValidationOutputTypeDef],  # (1)
    stringListValidation: NotRequired[StringListValidationOutputTypeDef],  # (2)
    numberValidation: NotRequired[NumberValidationTypeDef],  # (3)
```

1. See [:material-code-braces: StringValidationOutputTypeDef](./type_defs.md#stringvalidationoutputtypedef)
2. See [:material-code-braces: StringListValidationOutputTypeDef](./type_defs.md#stringlistvalidationoutputtypedef)
3. See [:material-code-braces: NumberValidationTypeDef](./type_defs.md#numbervalidationtypedef)

## WeightedRouteOutputTypeDef

```python
# WeightedRouteOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import WeightedRouteOutputTypeDef


def get_value() -> WeightedRouteOutputTypeDef:
    return {
        "trafficSplit": ...,
    }


# WeightedRouteOutputTypeDef definition

class WeightedRouteOutputTypeDef(TypedDict):
    trafficSplit: list[TargetTrafficSplitEntryOutputTypeDef],  # (1)
```

1. See `list[TargetTrafficSplitEntryOutputTypeDef]`
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import TriggerConditionInputTypeDef
...
1. See [:material-code-braces: MessageBasedTriggerInputTypeDef](./type_defs.md#messagebasedtriggerinputtypedef)
2. See [:material-code-braces: TokenBasedTriggerInputTypeDef](./type_defs.md#tokenbasedtriggerinputtypedef)
3. See [:material-code-braces: TimeBasedTriggerInputTypeDef](./type_defs.md#timebasedtriggerinputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import TriggerConditionTypeDef
...
1. See [:material-code-braces: MessageBasedTriggerTypeDef](./type_defs.md#messagebasedtriggertypedef)
2. See [:material-code-braces: TokenBasedTriggerTypeDef](./type_defs.md#tokenbasedtriggertypedef)
3. See [:material-code-braces: TimeBasedTriggerTypeDef](./type_defs.md#timebasedtriggertypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatePolicyEngineRequestTypeDef
...
```python
# UpdatedA2aDescriptorTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedA2aDescriptorTypeDef


def get_value() -> UpdatedA2aDescriptorTypeDef:
    return {
        "optionalValue": ...,
    }


# UpdatedA2aDescriptorTypeDef definition

class UpdatedA2aDescriptorTypeDef(TypedDict):
    optionalValue: NotRequired[A2aDescriptorTypeDef],  # (1)
```

1. See [:material-code-braces: A2aDescriptorTypeDef](./type_defs.md#a2adescriptortypedef)

## UpdatedHarnessEnvironmentArtifactTypeDef

```python
# UpdatedHarnessEnvironmentArtifactTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedHarnessEnvironmentArtifactTypeDef


def get_value() -> UpdatedHarnessEnvironmentArtifactTypeDef:
    return {
        "optionalValue": ...,
    }


# UpdatedHarnessEnvironmentArtifactTypeDef definition

class UpdatedHarnessEnvironmentArtifactTypeDef(TypedDict):
    optionalValue: NotRequired[HarnessEnvironmentArtifactTypeDef],  # (1)
```

1. See [:material-code-braces: HarnessEnvironmentArtifactTypeDef](./type_defs.md#harnessenvironmentartifacttypedef)

## UpdatedAgentSkillsDescriptorFieldsTypeDef

```python
# UpdatedAgentSkillsDescriptorFieldsTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedAgentSkillsDescriptorFieldsTypeDef


def get_value() -> UpdatedAgentSkillsDescriptorFieldsTypeDef:
    return {
        "skillMd": ...,
    }


# UpdatedAgentSkillsDescriptorFieldsTypeDef definition

class UpdatedAgentSkillsDescriptorFieldsTypeDef(TypedDict):
    skillMd: NotRequired[UpdatedSkillMdDefinitionTypeDef],  # (1)
    skillDefinition: NotRequired[UpdatedSkillDefinitionTypeDef],  # (2)
```

1. See [:material-code-braces: UpdatedSkillMdDefinitionTypeDef](./type_defs.md#updatedskillmddefinitiontypedef)
2. See [:material-code-braces: UpdatedSkillDefinitionTypeDef](./type_defs.md#updatedskilldefinitiontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ApiGatewayTargetConfigurationOutputTypeDef
...
1. See [:material-code-braces: ApiGatewayToolConfigurationOutputTypeDef](./type_defs.md#apigatewaytoolconfigurationoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ApiGatewayTargetConfigurationTypeDef
...
1. See [:material-code-braces: ApiGatewayToolConfigurationTypeDef](./type_defs.md#apigatewaytoolconfigurationtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import McpServerTargetConfigurationTypeDef
...
class McpServerTargetConfigurationTypeDef(TypedDict):
    endpoint: str,
    mcpToolSchema: NotRequired[McpToolSchemaConfigurationTypeDef],  # (1)
    listingMode: NotRequired[ListingModeType],  # (2)
    resourcePriority: NotRequired[int],
```

1. See [:material-code-braces: McpToolSchemaConfigurationTypeDef](./type_defs.md#mcptoolschemaconfigurationtypedef)
2. See [:material-code-brackets: ListingModeType](./literals.md#listingmodetype)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CustomClaimValidationTypeOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EvaluatorModelConfigOutputTypeDef
...
1. See [:material-code-braces: BedrockEvaluatorModelConfigOutputTypeDef](./type_defs.md#bedrockevaluatormodelconfigoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EvaluatorModelConfigTypeDef
...
1. See [:material-code-braces: BedrockEvaluatorModelConfigTypeDef](./type_defs.md#bedrockevaluatormodelconfigtypedef)
...
class NetworkConfigurationTypeDef(TypedDict):
    networkMode: NetworkModeType,  # (1)
    networkModeConfig: NotRequired[VpcConfigUnionTypeDef],  # (2)
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CertificateTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import AuthorizingClaimMatchValueTypeTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateOnlineEvaluationConfigResponseTypeDef
...
2. See [:material-code-brackets: OnlineEvaluationConfigStatusType](./literals.md#onlineevaluationconfigstatustype)
3. See [:material-code-brackets: OnlineEvaluationExecutionStatusType](./literals.md#onlineevaluationexecutionstatustype)
4. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CodeConfigurationOutputTypeDef
...
2. See [:material-code-brackets: AgentManagedRuntimeTypeType](./literals.md#agentmanagedruntimetypetype)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CodeConfigurationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import BrowserEnterprisePolicyTypeDef
...
```python
# PaymentProviderConfigurationOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import PaymentProviderConfigurationOutputTypeDef


def get_value() -> PaymentProviderConfigurationOutputTypeDef:
    return {
        "coinbaseCdpConfiguration": ...,
    }


# PaymentProviderConfigurationOutputTypeDef definition

class PaymentProviderConfigurationOutputTypeDef(TypedDict):
    coinbaseCdpConfiguration: NotRequired[CoinbaseCdpConfigurationOutputTypeDef],  # (1)
    stripePrivyConfiguration: NotRequired[StripePrivyConfigurationOutputTypeDef],  # (2)
```

1. See [:material-code-braces: CoinbaseCdpConfigurationOutputTypeDef](./type_defs.md#coinbasecdpconfigurationoutputtypedef)
2. See [:material-code-braces: StripePrivyConfigurationOutputTypeDef](./type_defs.md#stripeprivyconfigurationoutputtypedef)

## CreateConfigurationBundleRequestTypeDef

```python
# CreateConfigurationBundleRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateConfigurationBundleRequestTypeDef


def get_value() -> CreateConfigurationBundleRequestTypeDef:
    return {
        "bundleName": ...,
    }


# CreateConfigurationBundleRequestTypeDef definition
...
class CreateConfigurationBundleRequestTypeDef(TypedDict):
    ...
    branchName: NotRequired[str],
    commitMessage: NotRequired[str],
    createdBy: NotRequired[VersionCreatedBySourceTypeDef],  # (2)
    tags: NotRequired[Mapping[str, str]],
```
...
```python
# UpdateConfigurationBundleRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateConfigurationBundleRequestTypeDef


def get_value() -> UpdateConfigurationBundleRequestTypeDef:
    return {
        "bundleId": ...,
    }


# UpdateConfigurationBundleRequestTypeDef definition
...
class UpdateConfigurationBundleRequestTypeDef(TypedDict):
    ...
    description: NotRequired[str],
    components: NotRequired[Mapping[str, ComponentConfigurationUnionTypeDef]],  # (1)
...
```python
# WeightedOverrideOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import WeightedOverrideOutputTypeDef


def get_value() -> WeightedOverrideOutputTypeDef:
    return {
        "trafficSplit": ...,
    }


# WeightedOverrideOutputTypeDef definition

class WeightedOverrideOutputTypeDef(TypedDict):
    trafficSplit: list[TrafficSplitEntryOutputTypeDef],  # (1)
```

1. See `list[TrafficSplitEntryOutputTypeDef]`

## StreamDeliveryResourceOutputTypeDef

```python
# StreamDeliveryResourceOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StreamDeliveryResourceOutputTypeDef


def get_value() -> StreamDeliveryResourceOutputTypeDef:
    return {
        "kinesis": ...,
    }


# StreamDeliveryResourceOutputTypeDef definition

class StreamDeliveryResourceOutputTypeDef(TypedDict):
    kinesis: NotRequired[KinesisResourceOutputTypeDef],  # (1)
```

1. See [:material-code-braces: KinesisResourceOutputTypeDef](./type_defs.md#kinesisresourceoutputtypedef)

## StreamDeliveryResourceTypeDef

```python
# StreamDeliveryResourceTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StreamDeliveryResourceTypeDef


def get_value() -> StreamDeliveryResourceTypeDef:
    return {
        "kinesis": ...,
    }


# StreamDeliveryResourceTypeDef definition

class StreamDeliveryResourceTypeDef(TypedDict):
    kinesis: NotRequired[KinesisResourceTypeDef],  # (1)
```

1. See [:material-code-braces: KinesisResourceTypeDef](./type_defs.md#kinesisresourcetypedef)

## ConfigurationBundleVersionSummaryTypeDef

```python
# ConfigurationBundleVersionSummaryTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ConfigurationBundleVersionSummaryTypeDef


def get_value() -> ConfigurationBundleVersionSummaryTypeDef:
    return {
        "bundleArn": ...,
    }


# ConfigurationBundleVersionSummaryTypeDef definition
...
class ConfigurationBundleVersionSummaryTypeDef(TypedDict):
    ...
    lineageMetadata: NotRequired[VersionLineageMetadataTypeDef],  # (1)
```

1. See [:material-code-braces: VersionLineageMetadataTypeDef](./type_defs.md#versionlineagemetadatatypedef)

## GetConfigurationBundleResponseTypeDef

```python
# GetConfigurationBundleResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetConfigurationBundleResponseTypeDef


def get_value() -> GetConfigurationBundleResponseTypeDef:
    return {
        "bundleArn": ...,
    }


# GetConfigurationBundleResponseTypeDef definition
...
class GetConfigurationBundleResponseTypeDef(TypedDict):
    ...
    description: str,
    versionId: str,
    components: dict[str, ComponentConfigurationOutputTypeDef],  # (1)
    lineageMetadata: VersionLineageMetadataTypeDef,  # (2)
    createdAt: datetime.datetime,
    updatedAt: datetime.datetime,
    ResponseMetadata: ResponseMetadataTypeDef,  # (3)
```

1. See `dict[str, ComponentConfigurationOutputTypeDef]`
2. See [:material-code-braces: VersionLineageMetadataTypeDef](./type_defs.md#versionlineagemetadatatypedef)
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## GetConfigurationBundleVersionResponseTypeDef

```python
# GetConfigurationBundleVersionResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetConfigurationBundleVersionResponseTypeDef


def get_value() -> GetConfigurationBundleVersionResponseTypeDef:
    return {
        "bundleArn": ...,
    }


# GetConfigurationBundleVersionResponseTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CredentialProviderConfigurationOutputTypeDef
...
```python
# HarnessAgentCoreGatewayConfigOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessAgentCoreGatewayConfigOutputTypeDef


def get_value() -> HarnessAgentCoreGatewayConfigOutputTypeDef:
    return {
        "gatewayArn": ...,
    }


# HarnessAgentCoreGatewayConfigOutputTypeDef definition

class HarnessAgentCoreGatewayConfigOutputTypeDef(TypedDict):
    gatewayArn: str,
    outboundAuth: NotRequired[HarnessGatewayOutboundAuthOutputTypeDef],  # (1)
```

1. See [:material-code-braces: HarnessGatewayOutboundAuthOutputTypeDef](./type_defs.md#harnessgatewayoutboundauthoutputtypedef)

## CreatePaymentConnectorRequestTypeDef

```python
# CreatePaymentConnectorRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CreatePaymentConnectorRequestTypeDef


def get_value() -> CreatePaymentConnectorRequestTypeDef:
    return {
        "paymentManagerId": ...,
    }


# CreatePaymentConnectorRequestTypeDef definition

class CreatePaymentConnectorRequestTypeDef(TypedDict):
    paymentManagerId: str,
    name: str,
    type: PaymentConnectorTypeType,  # (1)
...
```python
# CreatePaymentConnectorResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CreatePaymentConnectorResponseTypeDef


def get_value() -> CreatePaymentConnectorResponseTypeDef:
    return {
        "paymentConnectorId": ...,
    }


# CreatePaymentConnectorResponseTypeDef definition

class CreatePaymentConnectorResponseTypeDef(TypedDict):
    paymentConnectorId: str,
    paymentManagerId: str,
    name: str,
    type: PaymentConnectorTypeType,  # (1)
    credentialProviderConfigurations: list[CredentialsProviderConfigurationTypeDef],  # (2)
    createdAt: datetime.datetime,
    status: PaymentConnectorStatusType,  # (3)
    ResponseMetadata: ResponseMetadataTypeDef,  # (4)
```

1. See [:material-code-brackets: PaymentConnectorTypeType](./literals.md#paymentconnectortypetype)
2. See `list[CredentialsProviderConfigurationTypeDef]`
3. See [:material-code-brackets: PaymentConnectorStatusType](./literals.md#paymentconnectorstatustype)
4. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## GetPaymentConnectorResponseTypeDef

```python
# GetPaymentConnectorResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPaymentConnectorResponseTypeDef


def get_value() -> GetPaymentConnectorResponseTypeDef:
    return {
        "paymentConnectorId": ...,
    }


# GetPaymentConnectorResponseTypeDef definition

class GetPaymentConnectorResponseTypeDef(TypedDict):
    paymentConnectorId: str,
    name: str,
    description: str,
    type: PaymentConnectorTypeType,  # (1)
...
```python
# UpdatePaymentConnectorRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatePaymentConnectorRequestTypeDef


def get_value() -> UpdatePaymentConnectorRequestTypeDef:
    return {
        "paymentManagerId": ...,
    }


# UpdatePaymentConnectorRequestTypeDef definition

class UpdatePaymentConnectorRequestTypeDef(TypedDict):
    paymentManagerId: str,
    paymentConnectorId: str,
    description: NotRequired[str],
    type: NotRequired[PaymentConnectorTypeType],  # (1)
    credentialProviderConfigurations: NotRequired[Sequence[CredentialsProviderConfigurationTypeDef]],  # (2)
    clientToken: NotRequired[str],
```
...
```python
# UpdatePaymentConnectorResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatePaymentConnectorResponseTypeDef


def get_value() -> UpdatePaymentConnectorResponseTypeDef:
    return {
        "paymentConnectorId": ...,
    }


# UpdatePaymentConnectorResponseTypeDef definition

class UpdatePaymentConnectorResponseTypeDef(TypedDict):
    paymentConnectorId: str,
    paymentManagerId: str,
    name: str,
    type: PaymentConnectorTypeType,  # (1)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ModifyConsolidationConfigurationTypeDef
...
1. See [:material-code-braces: CustomConsolidationConfigurationInputTypeDef](./type_defs.md#customconsolidationconfigurationinputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ConsolidationConfigurationTypeDef
...
1. See [:material-code-braces: CustomConsolidationConfigurationTypeDef](./type_defs.md#customconsolidationconfigurationtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ModifyExtractionConfigurationTypeDef
...
1. See [:material-code-braces: CustomExtractionConfigurationInputTypeDef](./type_defs.md#customextractionconfigurationinputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ExtractionConfigurationTypeDef
...
1. See [:material-code-braces: CustomExtractionConfigurationTypeDef](./type_defs.md#customextractionconfigurationtypedef)

## HarnessAgentCoreRuntimeEnvironmentTypeDef

```python
# HarnessAgentCoreRuntimeEnvironmentTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessAgentCoreRuntimeEnvironmentTypeDef


def get_value() -> HarnessAgentCoreRuntimeEnvironmentTypeDef:
    return {
        "agentRuntimeArn": ...,
    }


# HarnessAgentCoreRuntimeEnvironmentTypeDef definition
...
class HarnessAgentCoreRuntimeEnvironmentTypeDef(TypedDict):
    ...
    networkConfiguration: NetworkConfigurationOutputTypeDef,  # (2)
    filesystemConfigurations: NotRequired[list[FilesystemConfigurationTypeDef]],  # (3)
```

1. See [:material-code-braces: LifecycleConfigurationTypeDef](./type_defs.md#lifecycleconfigurationtypedef)
2. See [:material-code-braces: NetworkConfigurationOutputTypeDef](./type_defs.md#networkconfigurationoutputtypedef)
3. See `list[FilesystemConfigurationTypeDef]`
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RuleOutputTypeDef
...
1. See [:material-code-braces: SamplingConfigTypeDef](./type_defs.md#samplingconfigtypedef)
2. See `list[FilterTypeDef]`
3. See [:material-code-braces: SessionConfigTypeDef](./type_defs.md#sessionconfigtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RuleTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPolicyGenerationsResponseTypeDef
...
```python
# HarnessMemoryConfigurationOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessMemoryConfigurationOutputTypeDef


def get_value() -> HarnessMemoryConfigurationOutputTypeDef:
    return {
        "agentCoreMemoryConfiguration": ...,
    }


# HarnessMemoryConfigurationOutputTypeDef definition

class HarnessMemoryConfigurationOutputTypeDef(TypedDict):
    agentCoreMemoryConfiguration: NotRequired[HarnessAgentCoreMemoryConfigurationOutputTypeDef],  # (1)
```

1. See [:material-code-braces: HarnessAgentCoreMemoryConfigurationOutputTypeDef](./type_defs.md#harnessagentcorememoryconfigurationoutputtypedef)

## HarnessTruncationConfigurationTypeDef

```python
# HarnessTruncationConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessTruncationConfigurationTypeDef


def get_value() -> HarnessTruncationConfigurationTypeDef:
    return {
        "strategy": ...,
    }


# HarnessTruncationConfigurationTypeDef definition

class HarnessTruncationConfigurationTypeDef(TypedDict):
    strategy: HarnessTruncationStrategyType,  # (1)
    config: NotRequired[HarnessTruncationStrategyConfigurationTypeDef],  # (2)
```

1. See [:material-code-brackets: HarnessTruncationStrategyType](./literals.md#harnesstruncationstrategytype)
2. See [:material-code-braces: HarnessTruncationStrategyConfigurationTypeDef](./type_defs.md#harnesstruncationstrategyconfigurationtypedef)

## MatchPrincipalsOutputTypeDef

```python
# MatchPrincipalsOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import MatchPrincipalsOutputTypeDef


def get_value() -> MatchPrincipalsOutputTypeDef:
    return {
        "anyOf": ...,
    }


# MatchPrincipalsOutputTypeDef definition

class MatchPrincipalsOutputTypeDef(TypedDict):
    anyOf: list[MatchPrincipalEntryTypeDef],  # (1)
```

1. See `list[MatchPrincipalEntryTypeDef]`

## MatchPrincipalsTypeDef

```python
# MatchPrincipalsTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import MatchPrincipalsTypeDef


def get_value() -> MatchPrincipalsTypeDef:
    return {
        "anyOf": ...,
    }


# MatchPrincipalsTypeDef definition

class MatchPrincipalsTypeDef(TypedDict):
    anyOf: Sequence[MatchPrincipalEntryTypeDef],  # (1)
```

1. See `Sequence[MatchPrincipalEntryTypeDef]`
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GatewayInterceptorConfigurationOutputTypeDef
...
1. See [:material-code-braces: InterceptorConfigurationTypeDef](./type_defs.md#interceptorconfigurationtypedef)
2. See `list[GatewayInterceptionPointType]`
3. See [:material-code-braces: InterceptorInputConfigurationTypeDef](./type_defs.md#interceptorinputconfigurationtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GatewayInterceptorConfigurationTypeDef
...
1. See [:material-code-braces: MCPGatewayConfigurationOutputTypeDef](./type_defs.md#mcpgatewayconfigurationoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PrivateEndpointTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DescriptorsTypeDef
...
```python
# UpdatedMcpDescriptorFieldsTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedMcpDescriptorFieldsTypeDef


def get_value() -> UpdatedMcpDescriptorFieldsTypeDef:
    return {
        "server": ...,
    }


# UpdatedMcpDescriptorFieldsTypeDef definition

class UpdatedMcpDescriptorFieldsTypeDef(TypedDict):
    server: NotRequired[UpdatedServerDefinitionTypeDef],  # (1)
    tools: NotRequired[UpdatedToolsDefinitionTypeDef],  # (2)
```

1. See [:material-code-braces: UpdatedServerDefinitionTypeDef](./type_defs.md#updatedserverdefinitiontypedef)
2. See [:material-code-braces: UpdatedToolsDefinitionTypeDef](./type_defs.md#updatedtoolsdefinitiontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CredentialProviderTypeDef
...
1. See [:material-code-braces: OAuthCredentialProviderUnionTypeDef](#oauthcredentialprovideruniontypedef)
2. See [:material-code-braces: ApiKeyCredentialProviderTypeDef](./type_defs.md#apikeycredentialprovidertypedef)
3. See [:material-code-braces: IamCredentialProviderTypeDef](./type_defs.md#iamcredentialprovidertypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessGatewayOutboundAuthTypeDef
...
class HarnessGatewayOutboundAuthTypeDef(TypedDict):
    ...
    oauth: NotRequired[OAuthCredentialProviderUnionTypeDef],  # (1)
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import AtlassianOauth2ProviderConfigOutputTypeDef
...
1. See [:material-code-braces: Oauth2DiscoveryOutputTypeDef](./type_defs.md#oauth2discoveryoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GithubOauth2ProviderConfigOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GoogleOauth2ProviderConfigOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import IncludedOauth2ProviderConfigOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import LinkedinOauth2ProviderConfigOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import MicrosoftOauth2ProviderConfigOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SalesforceOauth2ProviderConfigOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SlackOauth2ProviderConfigOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import Oauth2DiscoveryTypeDef
...
1. See [:material-code-braces: Oauth2AuthorizationServerMetadataUnionTypeDef](#oauth2authorizationservermetadatauniontypedef)

## CreatePaymentCredentialProviderRequestTypeDef

```python
# CreatePaymentCredentialProviderRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CreatePaymentCredentialProviderRequestTypeDef


def get_value() -> CreatePaymentCredentialProviderRequestTypeDef:
    return {
        "name": ...,
    }


# CreatePaymentCredentialProviderRequestTypeDef definition
...
```python
# UpdatePaymentCredentialProviderRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatePaymentCredentialProviderRequestTypeDef


def get_value() -> UpdatePaymentCredentialProviderRequestTypeDef:
    return {
        "name": ...,
    }


# UpdatePaymentCredentialProviderRequestTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreatePolicyRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreatePolicyResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import DeletePolicyResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPolicyResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PolicyGenerationAssetTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PolicyTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatePolicyRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatePolicyResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PrivateEndpointOverrideOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RegistryRecordCredentialProviderConfigurationOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RegistryRecordCredentialProviderUnionTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ToolSchemaOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ToolSchemaTypeDef
...
```python
# LlmExtractionConfigOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import LlmExtractionConfigOutputTypeDef


def get_value() -> LlmExtractionConfigOutputTypeDef:
    return {
        "llmExtractionInstruction": ...,
    }


# LlmExtractionConfigOutputTypeDef definition

class LlmExtractionConfigOutputTypeDef(TypedDict):
    definition: str,
    llmExtractionInstruction: NotRequired[str],
    validation: NotRequired[ValidationOutputTypeDef],  # (1)
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ValidationTypeDef
...
class ValidationTypeDef(TypedDict):
    stringValidation: NotRequired[StringValidationUnionTypeDef],  # (1)
    stringListValidation: NotRequired[StringListValidationUnionTypeDef],  # (2)
    numberValidation: NotRequired[NumberValidationTypeDef],  # (3)
```

1. See [:material-code-braces: StringValidationUnionTypeDef](#stringvalidationuniontypedef)
2. See [:material-code-braces: StringListValidationUnionTypeDef](#stringlistvalidationuniontypedef)
3. See [:material-code-braces: NumberValidationTypeDef](./type_defs.md#numbervalidationtypedef)

## RouteToTargetActionOutputTypeDef

```python
# RouteToTargetActionOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import RouteToTargetActionOutputTypeDef


def get_value() -> RouteToTargetActionOutputTypeDef:
    return {
        "staticRoute": ...,
    }


# RouteToTargetActionOutputTypeDef definition

class RouteToTargetActionOutputTypeDef(TypedDict):
    staticRoute: NotRequired[StaticRouteTypeDef],  # (1)
    weightedRoute: NotRequired[WeightedRouteOutputTypeDef],  # (2)
```

1. See [:material-code-braces: StaticRouteTypeDef](./type_defs.md#staticroutetypedef)
2. See [:material-code-braces: WeightedRouteOutputTypeDef](./type_defs.md#weightedrouteoutputtypedef)

## WeightedRouteTypeDef

```python
# WeightedRouteTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import WeightedRouteTypeDef


def get_value() -> WeightedRouteTypeDef:
    return {
        "trafficSplit": ...,
    }


# WeightedRouteTypeDef definition

class WeightedRouteTypeDef(TypedDict):
    trafficSplit: Sequence[TargetTrafficSplitEntryUnionTypeDef],  # (1)
```

1. See `Sequence[TargetTrafficSplitEntryUnionTypeDef]`
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ModifySelfManagedConfigurationTypeDef
...
2. See [:material-code-braces: ModifyInvocationConfigurationInputTypeDef](./type_defs.md#modifyinvocationconfigurationinputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SelfManagedConfigurationInputTypeDef
...
1. See `Sequence[TriggerConditionInputTypeDef]`
2. See [:material-code-braces: InvocationConfigurationInputTypeDef](./type_defs.md#invocationconfigurationinputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SelfManagedConfigurationTypeDef
...
2. See [:material-code-braces: InvocationConfigurationTypeDef](./type_defs.md#invocationconfigurationtypedef)

## OnBehalfOfTokenExchangeConfigTypeTypeDef

```python
# OnBehalfOfTokenExchangeConfigTypeTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import OnBehalfOfTokenExchangeConfigTypeTypeDef


def get_value() -> OnBehalfOfTokenExchangeConfigTypeTypeDef:
    return {
        "grantType": ...,
    }


# OnBehalfOfTokenExchangeConfigTypeTypeDef definition

class OnBehalfOfTokenExchangeConfigTypeTypeDef(TypedDict):
    grantType: OnBehalfOfTokenExchangeGrantTypeTypeType,  # (1)
    tokenExchangeGrantTypeConfig: NotRequired[TokenExchangeGrantTypeConfigTypeUnionTypeDef],  # (2)
```

1. See [:material-code-brackets: OnBehalfOfTokenExchangeGrantTypeTypeType](./literals.md#onbehalfoftokenexchangegranttypetypetype)
2. See [:material-code-braces: TokenExchangeGrantTypeConfigTypeUnionTypeDef](#tokenexchangegranttypeconfigtypeuniontypedef)

## UpdatedAgentSkillsDescriptorTypeDef

```python
# UpdatedAgentSkillsDescriptorTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedAgentSkillsDescriptorTypeDef


def get_value() -> UpdatedAgentSkillsDescriptorTypeDef:
    return {
        "optionalValue": ...,
    }


# UpdatedAgentSkillsDescriptorTypeDef definition

class UpdatedAgentSkillsDescriptorTypeDef(TypedDict):
    optionalValue: NotRequired[UpdatedAgentSkillsDescriptorFieldsTypeDef],  # (1)
```

1. See [:material-code-braces: UpdatedAgentSkillsDescriptorFieldsTypeDef](./type_defs.md#updatedagentskillsdescriptorfieldstypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import LlmAsAJudgeEvaluatorConfigOutputTypeDef
...
1. See [:material-code-braces: RatingScaleOutputTypeDef](./type_defs.md#ratingscaleoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import LlmAsAJudgeEvaluatorConfigTypeDef
...
1. See [:material-code-braces: RatingScaleTypeDef](./type_defs.md#ratingscaletypedef)
...
class GetCodeInterpreterResponseTypeDef(TypedDict):
    ...
    certificates: list[CertificateTypeDef],  # (3)
    failureReason: str,
    createdAt: datetime.datetime,
    lastUpdatedAt: datetime.datetime,
    ResponseMetadata: ResponseMetadataTypeDef,  # (4)
...
1. See [:material-code-braces: CodeInterpreterNetworkConfigurationOutputTypeDef](./type_defs.md#codeinterpreternetworkconfigurationoutputtypedef)
2. See [:material-code-brackets: CodeInterpreterStatusType](./literals.md#codeinterpreterstatustype)
3. See `list[CertificateTypeDef]`
4. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import AgentRuntimeArtifactOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import AgentRuntimeArtifactTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateBrowserRequestTypeDef
...
class CreateBrowserRequestTypeDef(TypedDict):
    ...
    enterprisePolicies: NotRequired[Sequence[BrowserEnterprisePolicyTypeDef]],  # (4)
    certificates: NotRequired[Sequence[CertificateTypeDef]],  # (5)
    clientToken: NotRequired[str],
    tags: NotRequired[Mapping[str, str]],
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetBrowserResponseTypeDef
...
class GetBrowserResponseTypeDef(TypedDict):
    ...
    enterprisePolicies: list[BrowserEnterprisePolicyTypeDef],  # (4)
    certificates: list[CertificateTypeDef],  # (5)
    status: BrowserStatusType,  # (6)
    failureReason: str,
    createdAt: datetime.datetime,
    lastUpdatedAt: datetime.datetime,
...
1. See [:material-code-braces: BrowserNetworkConfigurationOutputTypeDef](./type_defs.md#browsernetworkconfigurationoutputtypedef)
2. See [:material-code-braces: RecordingConfigTypeDef](./type_defs.md#recordingconfigtypedef)
3. See [:material-code-braces: BrowserSigningConfigOutputTypeDef](./type_defs.md#browsersigningconfigoutputtypedef)
4. See `list[BrowserEnterprisePolicyTypeDef]`
5. See `list[CertificateTypeDef]`
6. See [:material-code-brackets: BrowserStatusType](./literals.md#browserstatustype)
7. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## CreatePaymentCredentialProviderResponseTypeDef

```python
# CreatePaymentCredentialProviderResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CreatePaymentCredentialProviderResponseTypeDef


def get_value() -> CreatePaymentCredentialProviderResponseTypeDef:
    return {
        "name": ...,
    }


# CreatePaymentCredentialProviderResponseTypeDef definition

class CreatePaymentCredentialProviderResponseTypeDef(TypedDict):
    name: str,
    credentialProviderVendor: PaymentCredentialProviderVendorTypeType,  # (1)
    credentialProviderArn: str,
    providerConfigurationOutput: PaymentProviderConfigurationOutputTypeDef,  # (2)
    ResponseMetadata: ResponseMetadataTypeDef,  # (3)
```

1. See [:material-code-brackets: PaymentCredentialProviderVendorTypeType](./literals.md#paymentcredentialprovidervendortypetype)
2. See [:material-code-braces: PaymentProviderConfigurationOutputTypeDef](./type_defs.md#paymentproviderconfigurationoutputtypedef)
3. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## GetPaymentCredentialProviderResponseTypeDef

```python
# GetPaymentCredentialProviderResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPaymentCredentialProviderResponseTypeDef


def get_value() -> GetPaymentCredentialProviderResponseTypeDef:
    return {
        "name": ...,
    }


# GetPaymentCredentialProviderResponseTypeDef definition
...
```python
# UpdatePaymentCredentialProviderResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatePaymentCredentialProviderResponseTypeDef


def get_value() -> UpdatePaymentCredentialProviderResponseTypeDef:
    return {
        "name": ...,
    }


# UpdatePaymentCredentialProviderResponseTypeDef definition
...
```python
# ConfigurationBundleActionOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ConfigurationBundleActionOutputTypeDef


def get_value() -> ConfigurationBundleActionOutputTypeDef:
    return {
        "staticOverride": ...,
    }


# ConfigurationBundleActionOutputTypeDef definition

class ConfigurationBundleActionOutputTypeDef(TypedDict):
    staticOverride: NotRequired[StaticOverrideTypeDef],  # (1)
    weightedOverride: NotRequired[WeightedOverrideOutputTypeDef],  # (2)
```

1. See [:material-code-braces: StaticOverrideTypeDef](./type_defs.md#staticoverridetypedef)
2. See [:material-code-braces: WeightedOverrideOutputTypeDef](./type_defs.md#weightedoverrideoutputtypedef)

## WeightedOverrideTypeDef

```python
# WeightedOverrideTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import WeightedOverrideTypeDef


def get_value() -> WeightedOverrideTypeDef:
    return {
        "trafficSplit": ...,
    }


# WeightedOverrideTypeDef definition

class WeightedOverrideTypeDef(TypedDict):
    trafficSplit: Sequence[TrafficSplitEntryUnionTypeDef],  # (1)
```

1. See `Sequence[TrafficSplitEntryUnionTypeDef]`

## StreamDeliveryResourcesOutputTypeDef

```python
# StreamDeliveryResourcesOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StreamDeliveryResourcesOutputTypeDef


def get_value() -> StreamDeliveryResourcesOutputTypeDef:
    return {
        "resources": ...,
    }


# StreamDeliveryResourcesOutputTypeDef definition

class StreamDeliveryResourcesOutputTypeDef(TypedDict):
    resources: list[StreamDeliveryResourceOutputTypeDef],  # (1)
```

1. See `list[StreamDeliveryResourceOutputTypeDef]`

## StreamDeliveryResourcesTypeDef

```python
# StreamDeliveryResourcesTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import StreamDeliveryResourcesTypeDef


def get_value() -> StreamDeliveryResourcesTypeDef:
    return {
        "resources": ...,
    }


# StreamDeliveryResourcesTypeDef definition

class StreamDeliveryResourcesTypeDef(TypedDict):
    resources: Sequence[StreamDeliveryResourceTypeDef],  # (1)
```

1. See `Sequence[StreamDeliveryResourceTypeDef]`

## ListConfigurationBundleVersionsResponseTypeDef

```python
# ListConfigurationBundleVersionsResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListConfigurationBundleVersionsResponseTypeDef


def get_value() -> ListConfigurationBundleVersionsResponseTypeDef:
    return {
        "versions": ...,
    }


# ListConfigurationBundleVersionsResponseTypeDef definition

class ListConfigurationBundleVersionsResponseTypeDef(TypedDict):
    versions: list[ConfigurationBundleVersionSummaryTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[ConfigurationBundleVersionSummaryTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## HarnessToolConfigurationOutputTypeDef

```python
# HarnessToolConfigurationOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessToolConfigurationOutputTypeDef


def get_value() -> HarnessToolConfigurationOutputTypeDef:
    return {
        "remoteMcp": ...,
    }


# HarnessToolConfigurationOutputTypeDef definition

class HarnessToolConfigurationOutputTypeDef(TypedDict):
    remoteMcp: NotRequired[HarnessRemoteMcpConfigOutputTypeDef],  # (1)
    agentCoreBrowser: NotRequired[HarnessAgentCoreBrowserConfigTypeDef],  # (2)
    agentCoreGateway: NotRequired[HarnessAgentCoreGatewayConfigOutputTypeDef],  # (3)
    inlineFunction: NotRequired[HarnessInlineFunctionConfigOutputTypeDef],  # (4)
    agentCoreCodeInterpreter: NotRequired[HarnessAgentCoreCodeInterpreterConfigTypeDef],  # (5)
```

1. See [:material-code-braces: HarnessRemoteMcpConfigOutputTypeDef](./type_defs.md#harnessremotemcpconfigoutputtypedef)
2. See [:material-code-braces: HarnessAgentCoreBrowserConfigTypeDef](./type_defs.md#harnessagentcorebrowserconfigtypedef)
3. See [:material-code-braces: HarnessAgentCoreGatewayConfigOutputTypeDef](./type_defs.md#harnessagentcoregatewayconfigoutputtypedef)
4. See [:material-code-braces: HarnessInlineFunctionConfigOutputTypeDef](./type_defs.md#harnessinlinefunctionconfigoutputtypedef)
...
```python
# HarnessEnvironmentProviderTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessEnvironmentProviderTypeDef


def get_value() -> HarnessEnvironmentProviderTypeDef:
    return {
        "agentCoreRuntimeEnvironment": ...,
    }


# HarnessEnvironmentProviderTypeDef definition

class HarnessEnvironmentProviderTypeDef(TypedDict):
    agentCoreRuntimeEnvironment: NotRequired[HarnessAgentCoreRuntimeEnvironmentTypeDef],  # (1)
```

1. See [:material-code-braces: HarnessAgentCoreRuntimeEnvironmentTypeDef](./type_defs.md#harnessagentcoreruntimeenvironmenttypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetOnlineEvaluationConfigResponseTypeDef
...
5. See [:material-code-brackets: OnlineEvaluationConfigStatusType](./literals.md#onlineevaluationconfigstatustype)
6. See [:material-code-brackets: OnlineEvaluationExecutionStatusType](./literals.md#onlineevaluationexecutionstatustype)
7. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## HarnessMemoryConfigurationTypeDef

```python
# HarnessMemoryConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessMemoryConfigurationTypeDef


def get_value() -> HarnessMemoryConfigurationTypeDef:
    return {
        "agentCoreMemoryConfiguration": ...,
    }


# HarnessMemoryConfigurationTypeDef definition

class HarnessMemoryConfigurationTypeDef(TypedDict):
    agentCoreMemoryConfiguration: NotRequired[HarnessAgentCoreMemoryConfigurationUnionTypeDef],  # (1)
```

1. See [:material-code-braces: HarnessAgentCoreMemoryConfigurationUnionTypeDef](#harnessagentcorememoryconfigurationuniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ConditionOutputTypeDef
...
class ConditionOutputTypeDef(TypedDict):
    matchPrincipals: NotRequired[MatchPrincipalsOutputTypeDef],  # (1)
    matchPaths: NotRequired[MatchPathsOutputTypeDef],  # (2)
```

1. See [:material-code-braces: MatchPrincipalsOutputTypeDef](./type_defs.md#matchprincipalsoutputtypedef)
2. See [:material-code-braces: MatchPathsOutputTypeDef](./type_defs.md#matchpathsoutputtypedef)

## UpdatedMcpDescriptorTypeDef

```python
# UpdatedMcpDescriptorTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedMcpDescriptorTypeDef


def get_value() -> UpdatedMcpDescriptorTypeDef:
    return {
        "optionalValue": ...,
    }


# UpdatedMcpDescriptorTypeDef definition

class UpdatedMcpDescriptorTypeDef(TypedDict):
    optionalValue: NotRequired[UpdatedMcpDescriptorFieldsTypeDef],  # (1)
```

1. See [:material-code-braces: UpdatedMcpDescriptorFieldsTypeDef](./type_defs.md#updatedmcpdescriptorfieldstypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPolicyGenerationAssetsResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ListPoliciesResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CustomOauth2ProviderConfigOutputTypeDef
...
class CustomOauth2ProviderConfigOutputTypeDef(TypedDict):
    ...
    privateEndpoint: NotRequired[PrivateEndpointOutputTypeDef],  # (2)
    privateEndpointOverrides: NotRequired[list[PrivateEndpointOverrideOutputTypeDef]],  # (3)
    onBehalfOfTokenExchangeConfig: NotRequired[OnBehalfOfTokenExchangeConfigTypeOutputTypeDef],  # (4)
    clientAuthenticationMethod: NotRequired[ClientAuthenticationMethodTypeType],  # (5)
```

1. See [:material-code-braces: Oauth2DiscoveryOutputTypeDef](./type_defs.md#oauth2discoveryoutputtypedef)
2. See [:material-code-braces: PrivateEndpointOutputTypeDef](./type_defs.md#privateendpointoutputtypedef)
3. See `list[PrivateEndpointOverrideOutputTypeDef]`
4. See [:material-code-braces: OnBehalfOfTokenExchangeConfigTypeOutputTypeDef](./type_defs.md#onbehalfoftokenexchangeconfigtypeoutputtypedef)
5. See [:material-code-brackets: ClientAuthenticationMethodTypeType](./literals.md#clientauthenticationmethodtypetype)

## FromUrlSynchronizationConfigurationOutputTypeDef

```python
# FromUrlSynchronizationConfigurationOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import FromUrlSynchronizationConfigurationOutputTypeDef


def get_value() -> FromUrlSynchronizationConfigurationOutputTypeDef:
    return {
        "url": ...,
    }


# FromUrlSynchronizationConfigurationOutputTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import McpLambdaTargetConfigurationOutputTypeDef
...
1. See [:material-code-braces: ToolSchemaOutputTypeDef](./type_defs.md#toolschemaoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import McpLambdaTargetConfigurationTypeDef
...
1. See [:material-code-braces: ToolSchemaTypeDef](./type_defs.md#toolschematypedef)

## ExtractionConfigOutputTypeDef

```python
# ExtractionConfigOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ExtractionConfigOutputTypeDef


def get_value() -> ExtractionConfigOutputTypeDef:
    return {
        "llmExtractionConfig": ...,
    }


# ExtractionConfigOutputTypeDef definition

class ExtractionConfigOutputTypeDef(TypedDict):
    llmExtractionConfig: NotRequired[LlmExtractionConfigOutputTypeDef],  # (1)
```

1. See [:material-code-braces: LlmExtractionConfigOutputTypeDef](./type_defs.md#llmextractionconfigoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EvaluatorConfigOutputTypeDef
...
class EvaluatorConfigOutputTypeDef(TypedDict):
    ...
    codeBased: NotRequired[CodeBasedEvaluatorConfigTypeDef],  # (2)
```

1. See [:material-code-braces: LlmAsAJudgeEvaluatorConfigOutputTypeDef](./type_defs.md#llmasajudgeevaluatorconfigoutputtypedef)
2. See [:material-code-braces: CodeBasedEvaluatorConfigTypeDef](./type_defs.md#codebasedevaluatorconfigtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EvaluatorConfigTypeDef
...
1. See [:material-code-braces: LlmAsAJudgeEvaluatorConfigTypeDef](./type_defs.md#llmasajudgeevaluatorconfigtypedef)
2. See [:material-code-braces: CodeBasedEvaluatorConfigTypeDef](./type_defs.md#codebasedevaluatorconfigtypedef)

## HarnessAgentCoreRuntimeEnvironmentRequestTypeDef

```python
# HarnessAgentCoreRuntimeEnvironmentRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessAgentCoreRuntimeEnvironmentRequestTypeDef


def get_value() -> HarnessAgentCoreRuntimeEnvironmentRequestTypeDef:
    return {
        "lifecycleConfiguration": ...,
    }


# HarnessAgentCoreRuntimeEnvironmentRequestTypeDef definition
...
class HarnessAgentCoreRuntimeEnvironmentRequestTypeDef(TypedDict):
    ...
    filesystemConfigurations: NotRequired[Sequence[FilesystemConfigurationTypeDef]],  # (3)
```

1. See [:material-code-braces: LifecycleConfigurationTypeDef](./type_defs.md#lifecycleconfigurationtypedef)
2. See [:material-code-braces: NetworkConfigurationUnionTypeDef](#networkconfigurationuniontypedef)
3. See `Sequence[FilesystemConfigurationTypeDef]`
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CustomClaimValidationTypeTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ActionOutputTypeDef
...
class ActionOutputTypeDef(TypedDict):
    configurationBundle: NotRequired[ConfigurationBundleActionOutputTypeDef],  # (1)
    routeToTarget: NotRequired[RouteToTargetActionOutputTypeDef],  # (2)
```

1. See [:material-code-braces: ConfigurationBundleActionOutputTypeDef](./type_defs.md#configurationbundleactionoutputtypedef)
2. See [:material-code-braces: RouteToTargetActionOutputTypeDef](./type_defs.md#routetotargetactionoutputtypedef)

## HarnessToolOutputTypeDef

```python
# HarnessToolOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessToolOutputTypeDef


def get_value() -> HarnessToolOutputTypeDef:
    return {
        "type": ...,
    }


# HarnessToolOutputTypeDef definition

class HarnessToolOutputTypeDef(TypedDict):
    type: HarnessToolTypeType,  # (1)
    name: NotRequired[str],
    config: NotRequired[HarnessToolConfigurationOutputTypeDef],  # (2)
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateOnlineEvaluationConfigRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateOnlineEvaluationConfigRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ConditionTypeDef
...
class ConditionTypeDef(TypedDict):
    matchPrincipals: NotRequired[MatchPrincipalsUnionTypeDef],  # (1)
    matchPaths: NotRequired[MatchPathsUnionTypeDef],  # (2)
```

1. See [:material-code-braces: MatchPrincipalsUnionTypeDef](#matchprincipalsuniontypedef)
2. See [:material-code-braces: MatchPathsUnionTypeDef](#matchpathsuniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import PrivateEndpointOverrideTypeDef
...
```python
# UpdatedDescriptorsUnionTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedDescriptorsUnionTypeDef


def get_value() -> UpdatedDescriptorsUnionTypeDef:
    return {
        "mcp": ...,
    }


# UpdatedDescriptorsUnionTypeDef definition

class UpdatedDescriptorsUnionTypeDef(TypedDict):
    mcp: NotRequired[UpdatedMcpDescriptorTypeDef],  # (1)
    a2a: NotRequired[UpdatedA2aDescriptorTypeDef],  # (2)
    custom: NotRequired[UpdatedCustomDescriptorTypeDef],  # (3)
    agentSkills: NotRequired[UpdatedAgentSkillsDescriptorTypeDef],  # (4)
```

1. See [:material-code-braces: UpdatedMcpDescriptorTypeDef](./type_defs.md#updatedmcpdescriptortypedef)
2. See [:material-code-braces: UpdatedA2aDescriptorTypeDef](./type_defs.md#updateda2adescriptortypedef)
3. See [:material-code-braces: UpdatedCustomDescriptorTypeDef](./type_defs.md#updatedcustomdescriptortypedef)
4. See [:material-code-braces: UpdatedAgentSkillsDescriptorTypeDef](./type_defs.md#updatedagentskillsdescriptortypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CredentialProviderConfigurationTypeDef
...
1. See [:material-code-brackets: CredentialProviderTypeType](./literals.md#credentialprovidertypetype)
2. See [:material-code-braces: CredentialProviderUnionTypeDef](#credentialprovideruniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessAgentCoreGatewayConfigTypeDef
...
class HarnessAgentCoreGatewayConfigTypeDef(TypedDict):
    gatewayArn: str,
    outboundAuth: NotRequired[HarnessGatewayOutboundAuthUnionTypeDef],  # (1)
```

1. See [:material-code-braces: HarnessGatewayOutboundAuthUnionTypeDef](#harnessgatewayoutboundauthuniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import Oauth2ProviderConfigOutputTypeDef
...
1. See [:material-code-braces: CustomOauth2ProviderConfigOutputTypeDef](./type_defs.md#customoauth2providerconfigoutputtypedef)
2. See [:material-code-braces: GoogleOauth2ProviderConfigOutputTypeDef](./type_defs.md#googleoauth2providerconfigoutputtypedef)
3. See [:material-code-braces: GithubOauth2ProviderConfigOutputTypeDef](./type_defs.md#githuboauth2providerconfigoutputtypedef)
4. See [:material-code-braces: SlackOauth2ProviderConfigOutputTypeDef](./type_defs.md#slackoauth2providerconfigoutputtypedef)
5. See [:material-code-braces: SalesforceOauth2ProviderConfigOutputTypeDef](./type_defs.md#salesforceoauth2providerconfigoutputtypedef)
6. See [:material-code-braces: MicrosoftOauth2ProviderConfigOutputTypeDef](./type_defs.md#microsoftoauth2providerconfigoutputtypedef)
7. See [:material-code-braces: AtlassianOauth2ProviderConfigOutputTypeDef](./type_defs.md#atlassianoauth2providerconfigoutputtypedef)
8. See [:material-code-braces: LinkedinOauth2ProviderConfigOutputTypeDef](./type_defs.md#linkedinoauth2providerconfigoutputtypedef)
9. See [:material-code-braces: IncludedOauth2ProviderConfigOutputTypeDef](./type_defs.md#includedoauth2providerconfigoutputtypedef)

## SynchronizationConfigurationOutputTypeDef

```python
# SynchronizationConfigurationOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import SynchronizationConfigurationOutputTypeDef


def get_value() -> SynchronizationConfigurationOutputTypeDef:
    return {
        "fromUrl": ...,
    }


# SynchronizationConfigurationOutputTypeDef definition

class SynchronizationConfigurationOutputTypeDef(TypedDict):
    fromUrl: NotRequired[FromUrlSynchronizationConfigurationOutputTypeDef],  # (1)
```

1. See [:material-code-braces: FromUrlSynchronizationConfigurationOutputTypeDef](./type_defs.md#fromurlsynchronizationconfigurationoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import RegistryRecordCredentialProviderConfigurationTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import McpTargetConfigurationOutputTypeDef
...
1. See [:material-code-braces: ApiSchemaConfigurationTypeDef](./type_defs.md#apischemaconfigurationtypedef)
2. See [:material-code-braces: ApiSchemaConfigurationTypeDef](./type_defs.md#apischemaconfigurationtypedef)
3. See [:material-code-braces: McpLambdaTargetConfigurationOutputTypeDef](./type_defs.md#mcplambdatargetconfigurationoutputtypedef)
4. See [:material-code-braces: McpServerTargetConfigurationTypeDef](./type_defs.md#mcpservertargetconfigurationtypedef)
5. See [:material-code-braces: ApiGatewayTargetConfigurationOutputTypeDef](./type_defs.md#apigatewaytargetconfigurationoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import McpTargetConfigurationTypeDef
...
1. See [:material-code-braces: ApiSchemaConfigurationTypeDef](./type_defs.md#apischemaconfigurationtypedef)
2. See [:material-code-braces: ApiSchemaConfigurationTypeDef](./type_defs.md#apischemaconfigurationtypedef)
3. See [:material-code-braces: McpLambdaTargetConfigurationTypeDef](./type_defs.md#mcplambdatargetconfigurationtypedef)
4. See [:material-code-braces: McpServerTargetConfigurationTypeDef](./type_defs.md#mcpservertargetconfigurationtypedef)
5. See [:material-code-braces: ApiGatewayTargetConfigurationTypeDef](./type_defs.md#apigatewaytargetconfigurationtypedef)

## MetadataSchemaEntryOutputTypeDef

```python
# MetadataSchemaEntryOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import MetadataSchemaEntryOutputTypeDef


def get_value() -> MetadataSchemaEntryOutputTypeDef:
    return {
        "key": ...,
    }


# MetadataSchemaEntryOutputTypeDef definition

class MetadataSchemaEntryOutputTypeDef(TypedDict):
    key: str,
    type: NotRequired[MetadataValueTypeType],  # (1)
    extractionConfig: NotRequired[ExtractionConfigOutputTypeDef],  # (2)
```
...
```python
# LlmExtractionConfigTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import LlmExtractionConfigTypeDef


def get_value() -> LlmExtractionConfigTypeDef:
    return {
        "llmExtractionInstruction": ...,
    }


# LlmExtractionConfigTypeDef definition

class LlmExtractionConfigTypeDef(TypedDict):
    definition: str,
    llmExtractionInstruction: NotRequired[str],
    validation: NotRequired[ValidationUnionTypeDef],  # (1)
```

1. See [:material-code-braces: ValidationUnionTypeDef](#validationuniontypedef)

## RouteToTargetActionTypeDef

```python
# RouteToTargetActionTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import RouteToTargetActionTypeDef


def get_value() -> RouteToTargetActionTypeDef:
    return {
        "staticRoute": ...,
    }


# RouteToTargetActionTypeDef definition

class RouteToTargetActionTypeDef(TypedDict):
    staticRoute: NotRequired[StaticRouteTypeDef],  # (1)
    weightedRoute: NotRequired[WeightedRouteUnionTypeDef],  # (2)
```

1. See [:material-code-braces: StaticRouteTypeDef](./type_defs.md#staticroutetypedef)
2. See [:material-code-braces: WeightedRouteUnionTypeDef](#weightedrouteuniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetEvaluatorResponseTypeDef
...
1. See [:material-code-braces: EvaluatorConfigOutputTypeDef](./type_defs.md#evaluatorconfigoutputtypedef)
2. See [:material-code-brackets: EvaluatorLevelType](./literals.md#evaluatorleveltype)
3. See [:material-code-brackets: EvaluatorStatusType](./literals.md#evaluatorstatustype)
4. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
```python
# HarnessEnvironmentProviderRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessEnvironmentProviderRequestTypeDef


def get_value() -> HarnessEnvironmentProviderRequestTypeDef:
    return {
        "agentCoreRuntimeEnvironment": ...,
    }


# HarnessEnvironmentProviderRequestTypeDef definition

class HarnessEnvironmentProviderRequestTypeDef(TypedDict):
    agentCoreRuntimeEnvironment: NotRequired[HarnessAgentCoreRuntimeEnvironmentRequestTypeDef],  # (1)
```

1. See [:material-code-braces: HarnessAgentCoreRuntimeEnvironmentRequestTypeDef](./type_defs.md#harnessagentcoreruntimeenvironmentrequesttypedef)

## CreateGatewayRuleResponseTypeDef

```python
# CreateGatewayRuleResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateGatewayRuleResponseTypeDef


def get_value() -> CreateGatewayRuleResponseTypeDef:
    return {
        "ruleId": ...,
    }


# CreateGatewayRuleResponseTypeDef definition
...
class CreateGatewayRuleResponseTypeDef(TypedDict):
    ...
    actions: list[ActionOutputTypeDef],  # (2)
    description: str,
    createdAt: datetime.datetime,
    status: GatewayRuleStatusType,  # (3)
    system: SystemManagedBlockTypeDef,  # (4)
    ResponseMetadata: ResponseMetadataTypeDef,  # (5)
```

1. See `list[ConditionOutputTypeDef]`
2. See `list[ActionOutputTypeDef]`
3. See [:material-code-brackets: GatewayRuleStatusType](./literals.md#gatewayrulestatustype)
4. See [:material-code-braces: SystemManagedBlockTypeDef](./type_defs.md#systemmanagedblocktypedef)
5. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## GatewayRuleDetailTypeDef

```python
# GatewayRuleDetailTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GatewayRuleDetailTypeDef


def get_value() -> GatewayRuleDetailTypeDef:
    return {
        "ruleId": ...,
    }


# GatewayRuleDetailTypeDef definition
...
class GatewayRuleDetailTypeDef(TypedDict):
    ...
    createdAt: datetime.datetime,
    status: GatewayRuleStatusType,  # (3)
    conditions: NotRequired[list[ConditionOutputTypeDef]],  # (1)
    description: NotRequired[str],
    system: NotRequired[SystemManagedBlockTypeDef],  # (4)
...
```python
# GetGatewayRuleResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetGatewayRuleResponseTypeDef


def get_value() -> GetGatewayRuleResponseTypeDef:
    return {
        "ruleId": ...,
    }


# GetGatewayRuleResponseTypeDef definition
...
```python
# UpdateGatewayRuleResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateGatewayRuleResponseTypeDef


def get_value() -> UpdateGatewayRuleResponseTypeDef:
    return {
        "ruleId": ...,
    }


# UpdateGatewayRuleResponseTypeDef definition
...
```python
# ConfigurationBundleActionTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ConfigurationBundleActionTypeDef


def get_value() -> ConfigurationBundleActionTypeDef:
    return {
        "staticOverride": ...,
    }


# ConfigurationBundleActionTypeDef definition

class ConfigurationBundleActionTypeDef(TypedDict):
    staticOverride: NotRequired[StaticOverrideTypeDef],  # (1)
    weightedOverride: NotRequired[WeightedOverrideUnionTypeDef],  # (2)
```

1. See [:material-code-braces: StaticOverrideTypeDef](./type_defs.md#staticoverridetypedef)
2. See [:material-code-braces: WeightedOverrideUnionTypeDef](#weightedoverrideuniontypedef)

## UpdatedHarnessMemoryConfigurationTypeDef

```python
# UpdatedHarnessMemoryConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedHarnessMemoryConfigurationTypeDef


def get_value() -> UpdatedHarnessMemoryConfigurationTypeDef:
    return {
        "optionalValue": ...,
    }


# UpdatedHarnessMemoryConfigurationTypeDef definition

class UpdatedHarnessMemoryConfigurationTypeDef(TypedDict):
    optionalValue: NotRequired[HarnessMemoryConfigurationUnionTypeDef],  # (1)
```

1. See [:material-code-braces: HarnessMemoryConfigurationUnionTypeDef](#harnessmemoryconfigurationuniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedDescriptorsTypeDef
...
class UpdatedDescriptorsTypeDef(TypedDict):
    optionalValue: NotRequired[UpdatedDescriptorsUnionTypeDef],  # (1)
```

1. See [:material-code-braces: UpdatedDescriptorsUnionTypeDef](./type_defs.md#updateddescriptorsuniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateGatewayResponseTypeDef
...
3. See [:material-code-braces: GatewayProtocolConfigurationOutputTypeDef](./type_defs.md#gatewayprotocolconfigurationoutputtypedef)
4. See [:material-code-brackets: AuthorizerTypeType](./literals.md#authorizertypetype)
5. See [:material-code-braces: AuthorizerConfigurationOutputTypeDef](./type_defs.md#authorizerconfigurationoutputtypedef)
...
8. See [:material-code-braces: WorkloadIdentityDetailsTypeDef](./type_defs.md#workloadidentitydetailstypedef)
9. See [:material-code-brackets: ExceptionLevelType](./literals.md#exceptionleveltype)
10. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## CreatePaymentManagerResponseTypeDef

```python
# CreatePaymentManagerResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CreatePaymentManagerResponseTypeDef


def get_value() -> CreatePaymentManagerResponseTypeDef:
    return {
        "paymentManagerArn": ...,
    }


# CreatePaymentManagerResponseTypeDef definition
...
class CreatePaymentManagerResponseTypeDef(TypedDict):
    ...
    name: str,
    authorizerType: PaymentsAuthorizerTypeType,  # (1)
    authorizerConfiguration: AuthorizerConfigurationOutputTypeDef,  # (2)
    roleArn: str,
    workloadIdentityDetails: WorkloadIdentityDetailsTypeDef,  # (3)
    createdAt: datetime.datetime,
    status: PaymentManagerStatusType,  # (4)
    tags: dict[str, str],
    ResponseMetadata: ResponseMetadataTypeDef,  # (5)
```
...
4. See [:material-code-brackets: PaymentManagerStatusType](./literals.md#paymentmanagerstatustype)
5. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetAgentRuntimeResponseTypeDef
...
class GetAgentRuntimeResponseTypeDef(TypedDict):
    ...
    filesystemConfigurations: list[FilesystemConfigurationTypeDef],  # (10)
    ResponseMetadata: ResponseMetadataTypeDef,  # (11)
```

1. See [:material-code-braces: NetworkConfigurationOutputTypeDef](./type_defs.md#networkconfigurationoutputtypedef)
2. See [:material-code-brackets: AgentRuntimeStatusType](./literals.md#agentruntimestatustype)
3. See [:material-code-braces: LifecycleConfigurationTypeDef](./type_defs.md#lifecycleconfigurationtypedef)
4. See [:material-code-braces: WorkloadIdentityDetailsTypeDef](./type_defs.md#workloadidentitydetailstypedef)
5. See [:material-code-braces: AgentRuntimeArtifactOutputTypeDef](./type_defs.md#agentruntimeartifactoutputtypedef)
6. See [:material-code-braces: ProtocolConfigurationTypeDef](./type_defs.md#protocolconfigurationtypedef)
7. See [:material-code-braces: AuthorizerConfigurationOutputTypeDef](./type_defs.md#authorizerconfigurationoutputtypedef)
8. See [:material-code-braces: RequestHeaderConfigurationOutputTypeDef](./type_defs.md#requestheaderconfigurationoutputtypedef)
9. See [:material-code-braces: RuntimeMetadataConfigurationTypeDef](./type_defs.md#runtimemetadataconfigurationtypedef)
10. See `list[FilesystemConfigurationTypeDef]`
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetGatewayResponseTypeDef
...
```python
# GetPaymentManagerResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetPaymentManagerResponseTypeDef


def get_value() -> GetPaymentManagerResponseTypeDef:
    return {
        "paymentManagerArn": ...,
    }


# GetPaymentManagerResponseTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetRegistryResponseTypeDef
...
```python
# HarnessTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessTypeDef


def get_value() -> HarnessTypeDef:
    return {
        "harnessId": ...,
    }


# HarnessTypeDef definition
...
class HarnessTypeDef(TypedDict):
    ...
    systemPrompt: list[HarnessSystemContentBlockTypeDef],  # (3)
    tools: list[HarnessToolOutputTypeDef],  # (4)
    skills: list[HarnessSkillTypeDef],  # (5)
    allowedTools: list[str],
    truncation: HarnessTruncationConfigurationTypeDef,  # (6)
    environment: HarnessEnvironmentProviderTypeDef,  # (7)
    environmentArtifact: NotRequired[HarnessEnvironmentArtifactTypeDef],  # (8)
    environmentVariables: NotRequired[dict[str, str]],
    authorizerConfiguration: NotRequired[AuthorizerConfigurationOutputTypeDef],  # (9)
    memory: NotRequired[HarnessMemoryConfigurationOutputTypeDef],  # (10)
...
3. See `list[HarnessSystemContentBlockTypeDef]`
4. See `list[HarnessToolOutputTypeDef]`
5. See `list[HarnessSkillTypeDef]`
6. See [:material-code-braces: HarnessTruncationConfigurationTypeDef](./type_defs.md#harnesstruncationconfigurationtypedef)
7. See [:material-code-braces: HarnessEnvironmentProviderTypeDef](./type_defs.md#harnessenvironmentprovidertypedef)
8. See [:material-code-braces: HarnessEnvironmentArtifactTypeDef](./type_defs.md#harnessenvironmentartifacttypedef)
9. See [:material-code-braces: AuthorizerConfigurationOutputTypeDef](./type_defs.md#authorizerconfigurationoutputtypedef)
10. See [:material-code-braces: HarnessMemoryConfigurationOutputTypeDef](./type_defs.md#harnessmemoryconfigurationoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateGatewayResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateRegistryResponseTypeDef
...
1. See [:material-code-braces: SecretTypeDef](./type_defs.md#secrettypedef)
2. See [:material-code-braces: Oauth2ProviderConfigOutputTypeDef](./type_defs.md#oauth2providerconfigoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetOauth2CredentialProviderResponseTypeDef
...
1. See [:material-code-braces: SecretTypeDef](./type_defs.md#secrettypedef)
2. See [:material-code-brackets: CredentialProviderVendorTypeType](./literals.md#credentialprovidervendortypetype)
3. See [:material-code-braces: Oauth2ProviderConfigOutputTypeDef](./type_defs.md#oauth2providerconfigoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateOauth2CredentialProviderResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetRegistryRecordResponseTypeDef
...
class GetRegistryRecordResponseTypeDef(TypedDict):
    ...
    updatedAt: datetime.datetime,
    statusReason: str,
    synchronizationType: SynchronizationTypeType,  # (4)
    synchronizationConfiguration: SynchronizationConfigurationOutputTypeDef,  # (5)
...
4. See [:material-code-brackets: SynchronizationTypeType](./literals.md#synchronizationtypetype)
5. See [:material-code-braces: SynchronizationConfigurationOutputTypeDef](./type_defs.md#synchronizationconfigurationoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateRegistryRecordResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import TargetConfigurationOutputTypeDef
...
class TargetConfigurationOutputTypeDef(TypedDict):
    ...
    http: NotRequired[HttpTargetConfigurationTypeDef],  # (2)
```

1. See [:material-code-braces: McpTargetConfigurationOutputTypeDef](./type_defs.md#mcptargetconfigurationoutputtypedef)
2. See [:material-code-braces: HttpTargetConfigurationTypeDef](./type_defs.md#httptargetconfigurationtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import TargetConfigurationTypeDef
...
1. See [:material-code-braces: McpTargetConfigurationTypeDef](./type_defs.md#mcptargetconfigurationtypedef)
2. See [:material-code-braces: HttpTargetConfigurationTypeDef](./type_defs.md#httptargetconfigurationtypedef)

## MemoryRecordSchemaOutputTypeDef

```python
# MemoryRecordSchemaOutputTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import MemoryRecordSchemaOutputTypeDef


def get_value() -> MemoryRecordSchemaOutputTypeDef:
    return {
        "metadataSchema": ...,
    }


# MemoryRecordSchemaOutputTypeDef definition

class MemoryRecordSchemaOutputTypeDef(TypedDict):
    metadataSchema: NotRequired[list[MetadataSchemaEntryOutputTypeDef]],  # (1)
```

1. See `list[MetadataSchemaEntryOutputTypeDef]`
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateEvaluatorRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateEvaluatorRequestTypeDef
...
```python
# ListGatewayRulesResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import ListGatewayRulesResponseTypeDef


def get_value() -> ListGatewayRulesResponseTypeDef:
    return {
        "gatewayRules": ...,
    }


# ListGatewayRulesResponseTypeDef definition

class ListGatewayRulesResponseTypeDef(TypedDict):
    gatewayRules: list[GatewayRuleDetailTypeDef],  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
    nextToken: NotRequired[str],
```

1. See `list[GatewayRuleDetailTypeDef]`
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CustomOauth2ProviderConfigInputTypeDef
...
class CustomOauth2ProviderConfigInputTypeDef(TypedDict):
    ...
    privateEndpoint: NotRequired[PrivateEndpointUnionTypeDef],  # (2)
    privateEndpointOverrides: NotRequired[Sequence[PrivateEndpointOverrideUnionTypeDef]],  # (3)
    onBehalfOfTokenExchangeConfig: NotRequired[OnBehalfOfTokenExchangeConfigTypeUnionTypeDef],  # (4)
    clientAuthenticationMethod: NotRequired[ClientAuthenticationMethodTypeType],  # (5)
```

1. See [:material-code-braces: Oauth2DiscoveryUnionTypeDef](#oauth2discoveryuniontypedef)
2. See [:material-code-braces: PrivateEndpointUnionTypeDef](#privateendpointuniontypedef)
3. See `Sequence[PrivateEndpointOverrideUnionTypeDef]`
4. See [:material-code-braces: OnBehalfOfTokenExchangeConfigTypeUnionTypeDef](#onbehalfoftokenexchangeconfigtypeuniontypedef)
5. See [:material-code-brackets: ClientAuthenticationMethodTypeType](./literals.md#clientauthenticationmethodtypetype)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessToolConfigurationTypeDef
...
class HarnessToolConfigurationTypeDef(TypedDict):
    remoteMcp: NotRequired[HarnessRemoteMcpConfigUnionTypeDef],  # (1)
    agentCoreBrowser: NotRequired[HarnessAgentCoreBrowserConfigTypeDef],  # (2)
    agentCoreGateway: NotRequired[HarnessAgentCoreGatewayConfigUnionTypeDef],  # (3)
    inlineFunction: NotRequired[HarnessInlineFunctionConfigUnionTypeDef],  # (4)
    agentCoreCodeInterpreter: NotRequired[HarnessAgentCoreCodeInterpreterConfigTypeDef],  # (5)
```

1. See [:material-code-braces: HarnessRemoteMcpConfigUnionTypeDef](#harnessremotemcpconfiguniontypedef)
2. See [:material-code-braces: HarnessAgentCoreBrowserConfigTypeDef](./type_defs.md#harnessagentcorebrowserconfigtypedef)
3. See [:material-code-braces: HarnessAgentCoreGatewayConfigUnionTypeDef](#harnessagentcoregatewayconfiguniontypedef)
4. See [:material-code-braces: HarnessInlineFunctionConfigUnionTypeDef](#harnessinlinefunctionconfiguniontypedef)
5. See [:material-code-braces: HarnessAgentCoreCodeInterpreterConfigTypeDef](./type_defs.md#harnessagentcorecodeinterpreterconfigtypedef)

## CreateHarnessResponseTypeDef

```python
# CreateHarnessResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateHarnessResponseTypeDef


def get_value() -> CreateHarnessResponseTypeDef:
    return {
        "harness": ...,
    }


# CreateHarnessResponseTypeDef definition

class CreateHarnessResponseTypeDef(TypedDict):
    harness: HarnessTypeDef,  # (1)
    ResponseMetadata: ResponseMetadataTypeDef,  # (2)
```

1. See [:material-code-braces: HarnessTypeDef](./type_defs.md#harnesstypedef)
2. See [:material-code-braces: ResponseMetadataTypeDef](./type_defs.md#responsemetadatatypedef)

## DeleteHarnessResponseTypeDef

```python
# DeleteHarnessResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import DeleteHarnessResponseTypeDef


def get_value() -> DeleteHarnessResponseTypeDef:
    return {
        "harness": ...,
    }


# DeleteHarnessResponseTypeDef definition
...
```python
# GetHarnessResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import GetHarnessResponseTypeDef


def get_value() -> GetHarnessResponseTypeDef:
    return {
        "harness": ...,
    }


# GetHarnessResponseTypeDef definition
...
```python
# UpdateHarnessResponseTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateHarnessResponseTypeDef


def get_value() -> UpdateHarnessResponseTypeDef:
    return {
        "harness": ...,
    }


# UpdateHarnessResponseTypeDef definition
...
```python
# FromUrlSynchronizationConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import FromUrlSynchronizationConfigurationTypeDef


def get_value() -> FromUrlSynchronizationConfigurationTypeDef:
    return {
        "url": ...,
    }


# FromUrlSynchronizationConfigurationTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateGatewayTargetResponseTypeDef
...
class CreateGatewayTargetResponseTypeDef(TypedDict):
    ...
    privateEndpoint: PrivateEndpointOutputTypeDef,  # (5)
    privateEndpointManagedResources: list[ManagedResourceDetailsTypeDef],  # (6)
    authorizationData: AuthorizationDataTypeDef,  # (7)
    protocolType: TargetProtocolTypeType,  # (8)
...
4. See [:material-code-braces: MetadataConfigurationOutputTypeDef](./type_defs.md#metadataconfigurationoutputtypedef)
5. See [:material-code-braces: PrivateEndpointOutputTypeDef](./type_defs.md#privateendpointoutputtypedef)
6. See `list[ManagedResourceDetailsTypeDef]`
7. See [:material-code-braces: AuthorizationDataTypeDef](./type_defs.md#authorizationdatatypedef)
8. See [:material-code-brackets: TargetProtocolTypeType](./literals.md#targetprotocoltypetype)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GatewayTargetTypeDef
...
class GatewayTargetTypeDef(TypedDict):
    ...
    privateEndpoint: NotRequired[PrivateEndpointOutputTypeDef],  # (5)
    privateEndpointManagedResources: NotRequired[list[ManagedResourceDetailsTypeDef]],  # (6)
    authorizationData: NotRequired[AuthorizationDataTypeDef],  # (7)
    protocolType: NotRequired[TargetProtocolTypeType],  # (8)
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetGatewayTargetResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateGatewayTargetResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EpisodicReflectionConfigurationTypeDef
...
class EpisodicReflectionConfigurationTypeDef(TypedDict):
    ...
    memoryRecordSchema: NotRequired[MemoryRecordSchemaOutputTypeDef],  # (1)
```

1. See [:material-code-braces: MemoryRecordSchemaOutputTypeDef](./type_defs.md#memoryrecordschemaoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EpisodicReflectionOverrideTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ExtractionConfigTypeDef
...
class ExtractionConfigTypeDef(TypedDict):
    llmExtractionConfig: NotRequired[LlmExtractionConfigUnionTypeDef],  # (1)
```

1. See [:material-code-braces: LlmExtractionConfigUnionTypeDef](#llmextractionconfiguniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ActionTypeDef
...
class ActionTypeDef(TypedDict):
    configurationBundle: NotRequired[ConfigurationBundleActionUnionTypeDef],  # (1)
    routeToTarget: NotRequired[RouteToTargetActionUnionTypeDef],  # (2)
```

1. See [:material-code-braces: ConfigurationBundleActionUnionTypeDef](#configurationbundleactionuniontypedef)
2. See [:material-code-braces: RouteToTargetActionUnionTypeDef](#routetotargetactionuniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import Oauth2ProviderConfigInputTypeDef
...
1. See [:material-code-braces: CustomOauth2ProviderConfigInputTypeDef](./type_defs.md#customoauth2providerconfiginputtypedef)
2. See [:material-code-braces: GoogleOauth2ProviderConfigInputTypeDef](./type_defs.md#googleoauth2providerconfiginputtypedef)
3. See [:material-code-braces: GithubOauth2ProviderConfigInputTypeDef](./type_defs.md#githuboauth2providerconfiginputtypedef)
4. See [:material-code-braces: SlackOauth2ProviderConfigInputTypeDef](./type_defs.md#slackoauth2providerconfiginputtypedef)
5. See [:material-code-braces: SalesforceOauth2ProviderConfigInputTypeDef](./type_defs.md#salesforceoauth2providerconfiginputtypedef)
6. See [:material-code-braces: MicrosoftOauth2ProviderConfigInputTypeDef](./type_defs.md#microsoftoauth2providerconfiginputtypedef)
7. See [:material-code-braces: AtlassianOauth2ProviderConfigInputTypeDef](./type_defs.md#atlassianoauth2providerconfiginputtypedef)
8. See [:material-code-braces: LinkedinOauth2ProviderConfigInputTypeDef](./type_defs.md#linkedinoauth2providerconfiginputtypedef)
9. See [:material-code-braces: IncludedOauth2ProviderConfigInputTypeDef](./type_defs.md#includedoauth2providerconfiginputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import SynchronizeGatewayTargetsResponseTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateGatewayTargetRequestTypeDef
...
class CreateGatewayTargetRequestTypeDef(TypedDict):
    ...
    privateEndpoint: NotRequired[PrivateEndpointUnionTypeDef],  # (4)
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateGatewayTargetRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CustomReflectionConfigurationTypeDef
...
1. See [:material-code-braces: EpisodicReflectionOverrideTypeDef](./type_defs.md#episodicreflectionoverridetypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateOauth2CredentialProviderRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateOauth2CredentialProviderRequestTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import HarnessToolTypeDef
...
class HarnessToolTypeDef(TypedDict):
    type: HarnessToolTypeType,  # (1)
    name: NotRequired[str],
    config: NotRequired[HarnessToolConfigurationUnionTypeDef],  # (2)
```

1. See [:material-code-brackets: HarnessToolTypeType](./literals.md#harnesstooltypetype)
2. See [:material-code-braces: HarnessToolConfigurationUnionTypeDef](#harnesstoolconfigurationuniontypedef)

## SynchronizationConfigurationTypeDef

```python
# SynchronizationConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import SynchronizationConfigurationTypeDef


def get_value() -> SynchronizationConfigurationTypeDef:
    return {
        "fromUrl": ...,
    }


# SynchronizationConfigurationTypeDef definition

class SynchronizationConfigurationTypeDef(TypedDict):
    fromUrl: NotRequired[FromUrlSynchronizationConfigurationUnionTypeDef],  # (1)
```

1. See [:material-code-braces: FromUrlSynchronizationConfigurationUnionTypeDef](#fromurlsynchronizationconfigurationuniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ReflectionConfigurationTypeDef
...
1. See [:material-code-braces: CustomReflectionConfigurationTypeDef](./type_defs.md#customreflectionconfigurationtypedef)
2. See [:material-code-braces: EpisodicReflectionConfigurationTypeDef](./type_defs.md#episodicreflectionconfigurationtypedef)

## MetadataSchemaEntryTypeDef

```python
# MetadataSchemaEntryTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import MetadataSchemaEntryTypeDef


def get_value() -> MetadataSchemaEntryTypeDef:
    return {
        "key": ...,
    }


# MetadataSchemaEntryTypeDef definition

class MetadataSchemaEntryTypeDef(TypedDict):
    key: str,
    type: NotRequired[MetadataValueTypeType],  # (1)
    extractionConfig: NotRequired[ExtractionConfigUnionTypeDef],  # (2)
```

1. See [:material-code-brackets: MetadataValueTypeType](./literals.md#metadatavaluetypetype)
2. See [:material-code-braces: ExtractionConfigUnionTypeDef](#extractionconfiguniontypedef)

## CreateGatewayRuleRequestTypeDef

```python
# CreateGatewayRuleRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateGatewayRuleRequestTypeDef


def get_value() -> CreateGatewayRuleRequestTypeDef:
    return {
        "gatewayIdentifier": ...,
    }


# CreateGatewayRuleRequestTypeDef definition
...
class CreateGatewayRuleRequestTypeDef(TypedDict):
    ...
    clientToken: NotRequired[str],
    conditions: NotRequired[Sequence[ConditionUnionTypeDef]],  # (2)
    description: NotRequired[str],
```
...
```python
# UpdateGatewayRuleRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateGatewayRuleRequestTypeDef


def get_value() -> UpdateGatewayRuleRequestTypeDef:
    return {
        "gatewayIdentifier": ...,
    }


# UpdateGatewayRuleRequestTypeDef definition

class UpdateGatewayRuleRequestTypeDef(TypedDict):
    gatewayIdentifier: str,
    ruleId: str,
    priority: NotRequired[int],
    conditions: NotRequired[Sequence[ConditionUnionTypeDef]],  # (1)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import StrategyConfigurationTypeDef
...
1. See [:material-code-brackets: OverrideTypeType](./literals.md#overridetypetype)
2. See [:material-code-braces: ExtractionConfigurationTypeDef](./type_defs.md#extractionconfigurationtypedef)
3. See [:material-code-braces: ConsolidationConfigurationTypeDef](./type_defs.md#consolidationconfigurationtypedef)
4. See [:material-code-braces: ReflectionConfigurationTypeDef](./type_defs.md#reflectionconfigurationtypedef)
5. See [:material-code-braces: SelfManagedConfigurationTypeDef](./type_defs.md#selfmanagedconfigurationtypedef)
...
class CreateAgentRuntimeRequestTypeDef(TypedDict):
    ...
    filesystemConfigurations: NotRequired[Sequence[FilesystemConfigurationTypeDef]],  # (7)
    tags: NotRequired[Mapping[str, str]],
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateGatewayRequestTypeDef
...
class CreateGatewayRequestTypeDef(TypedDict):
    ...
    description: NotRequired[str],
    clientToken: NotRequired[str],
    protocolType: NotRequired[GatewayProtocolTypeType],  # (2)
...
```python
# CreatePaymentManagerRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CreatePaymentManagerRequestTypeDef


def get_value() -> CreatePaymentManagerRequestTypeDef:
    return {
        "name": ...,
    }


# CreatePaymentManagerRequestTypeDef definition
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateRegistryRequestTypeDef
...
class CreateRegistryRequestTypeDef(TypedDict):
    ...
    authorizerConfiguration: NotRequired[AuthorizerConfigurationUnionTypeDef],  # (2)
    clientToken: NotRequired[str],
    approvalConfiguration: NotRequired[ApprovalConfigurationTypeDef],  # (3)
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateAgentRuntimeRequestTypeDef
...
class UpdateAgentRuntimeRequestTypeDef(TypedDict):
    ...
    environmentVariables: NotRequired[Mapping[str, str]],
    filesystemConfigurations: NotRequired[Sequence[FilesystemConfigurationTypeDef]],  # (8)
    clientToken: NotRequired[str],
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateGatewayRequestTypeDef
...
```python
# UpdatePaymentManagerRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatePaymentManagerRequestTypeDef


def get_value() -> UpdatePaymentManagerRequestTypeDef:
    return {
        "paymentManagerId": ...,
    }


# UpdatePaymentManagerRequestTypeDef definition

class UpdatePaymentManagerRequestTypeDef(TypedDict):
    paymentManagerId: str,
    description: NotRequired[str],
    authorizerType: NotRequired[PaymentsAuthorizerTypeType],  # (1)
    authorizerConfiguration: NotRequired[AuthorizerConfigurationUnionTypeDef],  # (2)
    roleArn: NotRequired[str],
    clientToken: NotRequired[str],
```
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedAuthorizerConfigurationTypeDef
...
```python
# CreateHarnessRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateHarnessRequestTypeDef


def get_value() -> CreateHarnessRequestTypeDef:
    return {
        "harnessName": ...,
    }


# CreateHarnessRequestTypeDef definition

class CreateHarnessRequestTypeDef(TypedDict):
    harnessName: str,
    executionRoleArn: str,
    clientToken: NotRequired[str],
    environment: NotRequired[HarnessEnvironmentProviderRequestTypeDef],  # (1)
    environmentArtifact: NotRequired[HarnessEnvironmentArtifactTypeDef],  # (2)
    environmentVariables: NotRequired[Mapping[str, str]],
    authorizerConfiguration: NotRequired[AuthorizerConfigurationUnionTypeDef],  # (3)
    model: NotRequired[HarnessModelConfigurationTypeDef],  # (4)
    systemPrompt: NotRequired[Sequence[HarnessSystemContentBlockTypeDef]],  # (5)
    tools: NotRequired[Sequence[HarnessToolUnionTypeDef]],  # (6)
    skills: NotRequired[Sequence[HarnessSkillTypeDef]],  # (7)
    allowedTools: NotRequired[Sequence[str]],
    memory: NotRequired[HarnessMemoryConfigurationUnionTypeDef],  # (8)
    truncation: NotRequired[HarnessTruncationConfigurationTypeDef],  # (9)
    maxIterations: NotRequired[int],
    maxTokens: NotRequired[int],
    timeoutSeconds: NotRequired[int],
    tags: NotRequired[Mapping[str, str]],
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateRegistryRecordRequestTypeDef
...
class CreateRegistryRecordRequestTypeDef(TypedDict):
    ...
    descriptorType: DescriptorTypeType,  # (1)
    description: NotRequired[str],
    descriptors: NotRequired[DescriptorsTypeDef],  # (2)
    recordVersion: NotRequired[str],
    synchronizationType: NotRequired[SynchronizationTypeType],  # (3)
    synchronizationConfiguration: NotRequired[SynchronizationConfigurationUnionTypeDef],  # (4)
    clientToken: NotRequired[str],
```
...
```python
# UpdatedSynchronizationConfigurationTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdatedSynchronizationConfigurationTypeDef


def get_value() -> UpdatedSynchronizationConfigurationTypeDef:
    return {
        "optionalValue": ...,
    }


# UpdatedSynchronizationConfigurationTypeDef definition

class UpdatedSynchronizationConfigurationTypeDef(TypedDict):
    optionalValue: NotRequired[SynchronizationConfigurationUnionTypeDef],  # (1)
```

1. See [:material-code-braces: SynchronizationConfigurationUnionTypeDef](#synchronizationconfigurationuniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import MemoryStrategyTypeDef
...
class MemoryStrategyTypeDef(TypedDict):
    ...
    memoryRecordSchema: NotRequired[MemoryRecordSchemaOutputTypeDef],  # (4)
```

1. See [:material-code-braces: StrategyConfigurationTypeDef](./type_defs.md#strategyconfigurationtypedef)
2. See [:material-code-brackets: MemoryStrategyTypeType](./literals.md#memorystrategytypetype)
3. See [:material-code-brackets: MemoryStrategyStatusType](./literals.md#memorystrategystatustype)
4. See [:material-code-braces: MemoryRecordSchemaOutputTypeDef](./type_defs.md#memoryrecordschemaoutputtypedef)

## MemoryRecordSchemaTypeDef

```python
# MemoryRecordSchemaTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import MemoryRecordSchemaTypeDef


def get_value() -> MemoryRecordSchemaTypeDef:
    return {
        "metadataSchema": ...,
    }


# MemoryRecordSchemaTypeDef definition

class MemoryRecordSchemaTypeDef(TypedDict):
    metadataSchema: NotRequired[Sequence[MetadataSchemaEntryUnionTypeDef]],  # (1)
```

1. See `Sequence[MetadataSchemaEntryUnionTypeDef]`

## UpdateHarnessRequestTypeDef

```python
# UpdateHarnessRequestTypeDef TypedDict usage example

from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateHarnessRequestTypeDef


def get_value() -> UpdateHarnessRequestTypeDef:
    return {
        "harnessId": ...,
    }


# UpdateHarnessRequestTypeDef definition
...
class UpdateHarnessRequestTypeDef(TypedDict):
    ...
    executionRoleArn: NotRequired[str],
    environment: NotRequired[HarnessEnvironmentProviderRequestTypeDef],  # (1)
    environmentArtifact: NotRequired[UpdatedHarnessEnvironmentArtifactTypeDef],  # (2)
    environmentVariables: NotRequired[Mapping[str, str]],
    authorizerConfiguration: NotRequired[UpdatedAuthorizerConfigurationTypeDef],  # (3)
    model: NotRequired[HarnessModelConfigurationTypeDef],  # (4)
    systemPrompt: NotRequired[Sequence[HarnessSystemContentBlockTypeDef]],  # (5)
    tools: NotRequired[Sequence[HarnessToolUnionTypeDef]],  # (6)
    skills: NotRequired[Sequence[HarnessSkillTypeDef]],  # (7)
    allowedTools: NotRequired[Sequence[str]],
    memory: NotRequired[UpdatedHarnessMemoryConfigurationTypeDef],  # (8)
    truncation: NotRequired[HarnessTruncationConfigurationTypeDef],  # (9)
    maxIterations: NotRequired[int],
    maxTokens: NotRequired[int],
    timeoutSeconds: NotRequired[int],
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateRegistryRequestTypeDef
...
class UpdateRegistryRequestTypeDef(TypedDict):
    ...
    name: NotRequired[str],
    description: NotRequired[UpdatedDescriptionTypeDef],  # (1)
    authorizerConfiguration: NotRequired[UpdatedAuthorizerConfigurationTypeDef],  # (2)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateRegistryRecordRequestTypeDef
...
class UpdateRegistryRecordRequestTypeDef(TypedDict):
    ...
    description: NotRequired[UpdatedDescriptionTypeDef],  # (1)
    descriptorType: NotRequired[DescriptorTypeType],  # (2)
    descriptors: NotRequired[UpdatedDescriptorsTypeDef],  # (3)
    recordVersion: NotRequired[str],
    synchronizationType: NotRequired[UpdatedSynchronizationTypeTypeDef],  # (4)
    synchronizationConfiguration: NotRequired[UpdatedSynchronizationConfigurationTypeDef],  # (5)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import MemoryTypeDef
...
class MemoryTypeDef(TypedDict):
    ...
    indexedKeys: NotRequired[list[IndexedKeyTypeDef]],  # (3)
    streamDeliveryResources: NotRequired[StreamDeliveryResourcesOutputTypeDef],  # (4)
```

1. See [:material-code-brackets: MemoryStatusType](./literals.md#memorystatustype)
2. See `list[MemoryStrategyTypeDef]`
3. See `list[IndexedKeyTypeDef]`
4. See [:material-code-braces: StreamDeliveryResourcesOutputTypeDef](./type_defs.md#streamdeliveryresourcesoutputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateMemoryOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import GetMemoryOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateMemoryOutputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EpisodicOverrideReflectionConfigurationInputTypeDef
...
class EpisodicOverrideReflectionConfigurationInputTypeDef(TypedDict):
    ...
    memoryRecordSchema: NotRequired[MemoryRecordSchemaUnionTypeDef],  # (1)
```

1. See [:material-code-braces: MemoryRecordSchemaUnionTypeDef](#memoryrecordschemauniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EpisodicReflectionConfigurationInputTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CustomReflectionConfigurationInputTypeDef
...
1. See [:material-code-braces: EpisodicOverrideReflectionConfigurationInputTypeDef](./type_defs.md#episodicoverridereflectionconfigurationinputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EpisodicOverrideConfigurationInputTypeDef
...
1. See [:material-code-braces: EpisodicOverrideExtractionConfigurationInputTypeDef](./type_defs.md#episodicoverrideextractionconfigurationinputtypedef)
2. See [:material-code-braces: EpisodicOverrideConsolidationConfigurationInputTypeDef](./type_defs.md#episodicoverrideconsolidationconfigurationinputtypedef)
3. See [:material-code-braces: EpisodicOverrideReflectionConfigurationInputTypeDef](./type_defs.md#episodicoverridereflectionconfigurationinputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import EpisodicMemoryStrategyInputTypeDef
...
class EpisodicMemoryStrategyInputTypeDef(TypedDict):
    ...
    memoryRecordSchema: NotRequired[MemoryRecordSchemaUnionTypeDef],  # (2)
```

1. See [:material-code-braces: EpisodicReflectionConfigurationInputTypeDef](./type_defs.md#episodicreflectionconfigurationinputtypedef)
2. See [:material-code-braces: MemoryRecordSchemaUnionTypeDef](#memoryrecordschemauniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ModifyReflectionConfigurationTypeDef
...
1. See [:material-code-braces: EpisodicReflectionConfigurationInputTypeDef](./type_defs.md#episodicreflectionconfigurationinputtypedef)
2. See [:material-code-braces: CustomReflectionConfigurationInputTypeDef](./type_defs.md#customreflectionconfigurationinputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CustomConfigurationInputTypeDef
...
1. See [:material-code-braces: SemanticOverrideConfigurationInputTypeDef](./type_defs.md#semanticoverrideconfigurationinputtypedef)
2. See [:material-code-braces: SummaryOverrideConfigurationInputTypeDef](./type_defs.md#summaryoverrideconfigurationinputtypedef)
3. See [:material-code-braces: UserPreferenceOverrideConfigurationInputTypeDef](./type_defs.md#userpreferenceoverrideconfigurationinputtypedef)
4. See [:material-code-braces: EpisodicOverrideConfigurationInputTypeDef](./type_defs.md#episodicoverrideconfigurationinputtypedef)
5. See [:material-code-braces: SelfManagedConfigurationInputTypeDef](./type_defs.md#selfmanagedconfigurationinputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ModifyStrategyConfigurationTypeDef
...
1. See [:material-code-braces: ModifyExtractionConfigurationTypeDef](./type_defs.md#modifyextractionconfigurationtypedef)
2. See [:material-code-braces: ModifyConsolidationConfigurationTypeDef](./type_defs.md#modifyconsolidationconfigurationtypedef)
3. See [:material-code-braces: ModifyReflectionConfigurationTypeDef](./type_defs.md#modifyreflectionconfigurationtypedef)
4. See [:material-code-braces: ModifySelfManagedConfigurationTypeDef](./type_defs.md#modifyselfmanagedconfigurationtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CustomMemoryStrategyInputTypeDef
...
1. See [:material-code-braces: CustomConfigurationInputTypeDef](./type_defs.md#customconfigurationinputtypedef)
2. See [:material-code-braces: MemoryRecordSchemaUnionTypeDef](#memoryrecordschemauniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ModifyMemoryStrategyInputTypeDef
...
1. See [:material-code-braces: ModifyStrategyConfigurationTypeDef](./type_defs.md#modifystrategyconfigurationtypedef)
2. See [:material-code-braces: MemoryRecordSchemaUnionTypeDef](#memoryrecordschemauniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import MemoryStrategyInputTypeDef
...
1. See [:material-code-braces: SemanticMemoryStrategyInputTypeDef](./type_defs.md#semanticmemorystrategyinputtypedef)
2. See [:material-code-braces: SummaryMemoryStrategyInputTypeDef](./type_defs.md#summarymemorystrategyinputtypedef)
3. See [:material-code-braces: UserPreferenceMemoryStrategyInputTypeDef](./type_defs.md#userpreferencememorystrategyinputtypedef)
4. See [:material-code-braces: CustomMemoryStrategyInputTypeDef](./type_defs.md#custommemorystrategyinputtypedef)
5. See [:material-code-braces: EpisodicMemoryStrategyInputTypeDef](./type_defs.md#episodicmemorystrategyinputtypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import CreateMemoryInputTypeDef
...
class CreateMemoryInputTypeDef(TypedDict):
    ...
    indexedKeys: NotRequired[Sequence[IndexedKeyTypeDef]],  # (2)
    streamDeliveryResources: NotRequired[StreamDeliveryResourcesUnionTypeDef],  # (3)
    tags: NotRequired[Mapping[str, str]],
```

1. See `Sequence[MemoryStrategyInputTypeDef]`
2. See `Sequence[IndexedKeyTypeDef]`
3. See [:material-code-braces: StreamDeliveryResourcesUnionTypeDef](#streamdeliveryresourcesuniontypedef)
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import ModifyMemoryStrategiesTypeDef
...
from types_aiobotocore_bedrock_agentcore_control.type_defs import UpdateMemoryInputTypeDef
...
class UpdateMemoryInputTypeDef(TypedDict):
    ...
    addIndexedKeys: NotRequired[Sequence[IndexedKeyTypeDef]],  # (2)
    streamDeliveryResources: NotRequired[StreamDeliveryResourcesUnionTypeDef],  # (3)
```
