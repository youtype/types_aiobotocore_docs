...
from types_aiobotocore_dynamodbstreams.literals import OperationTypeType
...
from types_aiobotocore_dynamodbstreams.literals import ShardFilterTypeType
...
from types_aiobotocore_dynamodbstreams.literals import ShardIteratorTypeType
...
from types_aiobotocore_dynamodbstreams.literals import StreamStatusType
...
from types_aiobotocore_dynamodbstreams.literals import StreamViewTypeType
...
```python
# DynamoDBStreamsServiceName usage example
from types_aiobotocore_dynamodbstreams.literals import DynamoDBStreamsServiceName

def get_value() -> DynamoDBStreamsServiceName:
    return "dynamodbstreams"
```

```python
# DynamoDBStreamsServiceName definition
DynamoDBStreamsServiceName = Literal[
    "dynamodbstreams",
]
```
## ServiceName
...
from types_aiobotocore_dynamodbstreams.literals import ServiceName
...
from types_aiobotocore_dynamodbstreams.literals import ResourceServiceName
...
from types_aiobotocore_dynamodbstreams.literals import RegionName
