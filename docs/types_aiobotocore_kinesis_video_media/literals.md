<a id="literals-for-aiobotocore-kinesisvideomedia-module"></a>

# Literals for aiobotocore KinesisVideoMedia module
...
- [Literals for aiobotocore KinesisVideoMedia module](#literals-for-aiobotocore-kinesisvideomedia-module)
...
```python
from types_aiobotocore_kinesis_video_media.literals import KinesisVideoMediaServiceName
```
...
```python
from types_aiobotocore_kinesis_video_media.literals import ServiceName
```
...
```python
from types_aiobotocore_kinesis_video_media.literals import ResourceServiceName
```
