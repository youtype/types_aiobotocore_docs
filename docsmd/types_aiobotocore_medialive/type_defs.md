...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListChannelsRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListInputDeviceTransfersRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListInputDevicesRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListInputSecurityGroupsRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListInputsRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListMultiplexProgramsRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListMultiplexesRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListOfferingsRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListReservationsRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListTagsForResourceRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import RejectInputDeviceTransferRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import StartChannelRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import StartMultiplexRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import StopChannelRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import StopMultiplexRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import TransferInputDeviceRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import UpdateInputSecurityGroupRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import UpdateMultiplexRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import DescribeChannelRequestChannelCreatedWaitTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import DescribeChannelRequestChannelDeletedWaitTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import DescribeChannelRequestChannelRunningWaitTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import DescribeChannelRequestChannelStoppedWaitTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import DescribeInputRequestInputAttachedWaitTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import DescribeInputRequestInputDeletedWaitTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import DescribeInputRequestInputDetachedWaitTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import DescribeMultiplexRequestMultiplexCreatedWaitTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import DescribeMultiplexRequestMultiplexDeletedWaitTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import DescribeMultiplexRequestMultiplexRunningWaitTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import DescribeMultiplexRequestMultiplexStoppedWaitTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import DescribeScheduleRequestDescribeSchedulePaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListChannelsRequestListChannelsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListInputDeviceTransfersRequestListInputDeviceTransfersPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListInputDevicesRequestListInputDevicesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListInputSecurityGroupsRequestListInputSecurityGroupsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListInputsRequestListInputsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListMultiplexProgramsRequestListMultiplexProgramsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListMultiplexesRequestListMultiplexesPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListOfferingsRequestListOfferingsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import ListReservationsRequestListReservationsPaginateTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import UpdateInputDeviceRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import UpdateInputRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import UpdateChannelClassRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import UpdateMultiplexProgramRequestRequestTypeDef
...
```python title="Usage Example"
from types_aiobotocore_medialive.type_defs import UpdateChannelRequestRequestTypeDef
