...
Type annotations and code completion for `#!python session.create_client("license-manager").create_license_asset_group` method.
...
await def create_license_asset_group(
    self,
    *,
    Name: str,
...
Type annotations and code completion for `#!python session.create_client("license-manager").create_license_asset_ruleset` method.
...
await def create_license_asset_ruleset(
    self,
    *,
    Name: str,
...
Type annotations and code completion for `#!python session.create_client("license-manager").delete_license_asset_group` method.
...
await def delete_license_asset_group(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("license-manager").delete_license_asset_ruleset` method.
...
await def delete_license_asset_ruleset(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("license-manager").get_license_asset_group` method.
...
await def get_license_asset_group(
    self,
    *,
    LicenseAssetGroupArn: str,
...
Type annotations and code completion for `#!python session.create_client("license-manager").get_license_asset_ruleset` method.
...
await def get_license_asset_ruleset(
    self,
    *,
    LicenseAssetRulesetArn: str,
...
Type annotations and code completion for `#!python session.create_client("license-manager").list_assets_for_license_asset_group` method.
...
await def list_assets_for_license_asset_group(
    self,
    *,
    LicenseAssetGroupArn: str,
    AssetType: str,
...
Type annotations and code completion for `#!python session.create_client("license-manager").list_license_asset_groups` method.
...
await def list_license_asset_groups(
    self,
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("license-manager").list_license_asset_rulesets` method.
...
await def list_license_asset_rulesets(
    self,
    *,
    Filters: Sequence[FilterTypeDef] = ...,  # (1)
...
Type annotations and code completion for `#!python session.create_client("license-manager").list_license_configurations_for_organization` method.
...
await def list_license_configurations_for_organization(
    self,
    *,
    LicenseConfigurationArns: Sequence[str] = ...,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("license-manager").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("license-manager").update_license_asset_group` method.
...
await def update_license_asset_group(
    self,
    *,
    AssociatedLicenseAssetRulesetARNs: Sequence[str],
    LicenseAssetGroupArn: str,
...
Type annotations and code completion for `#!python session.create_client("license-manager").update_license_asset_ruleset` method.
...
await def update_license_asset_ruleset(
    self,
    *,
    Rules: Sequence[LicenseAssetRuleUnionTypeDef],  # (1)
    LicenseAssetRulesetArn: str,
