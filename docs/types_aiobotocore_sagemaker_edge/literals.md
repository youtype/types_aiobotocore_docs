<a id="literals-for-aiobotocore-sagemakeredgemanager-module"></a>

# Literals for aiobotocore SagemakerEdgeManager module

> [Index](../README.md) > [SagemakerEdgeManager](./README.md) > Literals
...
- [Literals for aiobotocore SagemakerEdgeManager module](#literals-for-aiobotocore-sagemakeredgemanager-module)
...
```python
from types_aiobotocore_sagemaker_edge.literals import ResourceServiceName
```
