...
pip install 'types-aiobotocore[mwaa]'
...
Type annotations for `aiobotocore.create_client("mwaa")` as
...
```python
from types_aiobotocore_mwaa.paginators import ListEnvironmentsPaginator, ...
```
