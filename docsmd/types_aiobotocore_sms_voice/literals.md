...
```python
# SMSVoiceServiceName usage example
from types_aiobotocore_sms_voice.literals import SMSVoiceServiceName

def get_value() -> SMSVoiceServiceName:
    return "sms-voice"
```

```python
# SMSVoiceServiceName definition
SMSVoiceServiceName = Literal[
    "sms-voice",
]
```
## ServiceName
