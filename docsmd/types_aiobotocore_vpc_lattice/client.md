...
Type annotations and code completion for `#!python session.create_client("vpc-lattice").delete_domain_verification` method.
...
await def delete_domain_verification(
    self,
    *,
    domainVerificationIdentifier: str,
) -> dict[str, Any]:
...
Type annotations and code completion for `#!python session.create_client("vpc-lattice").get_domain_verification` method.
...
await def get_domain_verification(
    self,
    *,
    domainVerificationIdentifier: str,
...
Type annotations and code completion for `#!python session.create_client("vpc-lattice").list_domain_verifications` method.
...
await def list_domain_verifications(
    self,
    *,
    maxResults: int = ...,
    nextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("vpc-lattice").start_domain_verification` method.
...
await def start_domain_verification(
    self,
    *,
    domainName: str,
    clientToken: str = ...,
