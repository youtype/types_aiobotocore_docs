...
class CertificateSummaryTypeDef(TypedDict):
    ...
    ManagedBy: NotRequired[CertificateManagedByType],  # (7)
```
...
7. See [:material-code-brackets: CertificateManagedByType](./literals.md#certificatemanagedbytype)
...
class FiltersTypeDef(TypedDict):
    ...
    managedBy: NotRequired[CertificateManagedByType],  # (4)
```

1. See `Sequence[ExtendedKeyUsageNameType]`
2. See `Sequence[KeyUsageNameType]`
3. See `Sequence[KeyAlgorithmType]`
4. See [:material-code-brackets: CertificateManagedByType](./literals.md#certificatemanagedbytype)
