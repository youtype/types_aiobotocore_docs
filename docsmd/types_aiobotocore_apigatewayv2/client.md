...
```python
# ApiGatewayV2Client usage type checking example
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").create_portal` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").create_portal_product` method.
...
await def create_portal_product(
    self,
    *,
    DisplayName: str,
    Description: str = ...,
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").create_product_page` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").create_product_rest_endpoint_page` method.
...
await def create_product_rest_endpoint_page(
    self,
    *,
    PortalProductId: str,
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").create_routing_rule` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").delete_portal` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").delete_portal_product` method.
...
await def delete_portal_product(
    self,
    *,
    PortalProductId: str,
) -> EmptyResponseMetadataTypeDef:  # (1)
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").delete_portal_product_sharing_policy` method.
...
await def delete_portal_product_sharing_policy(
    self,
    *,
    PortalProductId: str,
) -> EmptyResponseMetadataTypeDef:  # (1)
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").delete_product_page` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").delete_product_rest_endpoint_page` method.
...
await def delete_product_rest_endpoint_page(
    self,
    *,
    PortalProductId: str,
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").delete_routing_rule` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").disable_portal` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").get_integrations` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").get_portal` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").get_portal_product` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").get_portal_product_sharing_policy` method.
...
await def get_portal_product_sharing_policy(
    self,
    *,
    PortalProductId: str,
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").get_product_page` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").get_product_rest_endpoint_page` method.
...
await def get_product_rest_endpoint_page(
    self,
    *,
    PortalProductId: str,
    ProductRestEndpointPageId: str,
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").get_routes` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").get_routing_rule` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").list_routing_rules` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").list_portal_products` method.
...
await def list_portal_products(
    self,
    *,
    MaxResults: str = ...,
    NextToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").list_portals` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").list_product_pages` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").list_product_rest_endpoint_pages` method.
...
await def list_product_rest_endpoint_pages(
    self,
    *,
    PortalProductId: str,
    MaxResults: str = ...,
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").preview_portal` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").publish_portal` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").put_portal_product_sharing_policy` method.
...
await def put_portal_product_sharing_policy(
    self,
    *,
    PolicyDocument: str,
    PortalProductId: str,
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").put_routing_rule` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").update_domain_name` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").update_portal` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").update_portal_product` method.
...
await def update_portal_product(
    self,
    *,
    PortalProductId: str,
    Description: str = ...,
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").update_product_page` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").update_product_rest_endpoint_page` method.
...
await def update_product_rest_endpoint_page(
    self,
    *,
    PortalProductId: str,
    ProductRestEndpointPageId: str,
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").update_route` method.
...
Type annotations and code completion for `#!python session.create_client("apigatewayv2").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/apigatewayv2.html#ApiGatewayV2.Client)
