...
async with session.create_client("wafv2") as client:
    try:
        ...
        client.WAFFeatureNotIncludedInPricingPlanException,
...
Type annotations and code completion for `#!python session.create_client("wafv2").get_top_path_statistics_by_traffic` method.
...
await def get_top_path_statistics_by_traffic(
    self,
    *,
    WebAclArn: str,
    Scope: ScopeType,  # (1)
