...
```python
# ListPendingMaintenanceActionsInputListPendingMaintenanceActionsPaginateTypeDef definition

class ListPendingMaintenanceActionsInputListPendingMaintenanceActionsPaginateTypeDef(TypedDict):
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
