...
Type annotations and code completion for `#!python session.create_client("connect").get_paginator("list_attached_files_configurations")`.
...
def paginate(
    ...
    *,
    InstanceId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> aiobotocore.paginate.AioPageIterator[ListAttachedFilesConfigurationsResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `AioPageIterator[ListAttachedFilesConfigurationsResponseTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("connect").get_paginator("list_test_cases")`.
...
from types_aiobotocore_connect.paginator import ListTestCasesPaginator
...
Type annotations and code completion for `#!python session.create_client("connect").get_paginator("search_test_cases")`.
...
from types_aiobotocore_connect.paginator import SearchTestCasesPaginator

session = get_session()
async with session.create_client("connect") as client:  # (1)
    paginator: SearchTestCasesPaginator = client.get_paginator("search_test_cases")  # (2)
    async for item in paginator.paginate(...):
        item: SearchTestCasesResponseTypeDef
        print(item)  # (3)
```

1. client: [ConnectClient](./client.md)
2. paginator: [SearchTestCasesPaginator](./paginators.md#searchtestcasespaginator)
3. item: `AioPageIterator[SearchTestCasesResponseTypeDef]`
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (3)
) -> aiobotocore.paginate.AioPageIterator[SearchTestCasesResponseTypeDef]:  # (4)
    ...
```
...
3. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
4. See `AioPageIterator[SearchTestCasesResponseTypeDef]`
