...
class AttributeConditionOutputTypeDef(TypedDict):
    ...
    MatchCriteria: NotRequired[MatchCriteriaOutputTypeDef],  # (1)
    ComparisonOperator: NotRequired[str],
```

1. See [:material-code-braces: MatchCriteriaOutputTypeDef](./type_defs.md#matchcriteriaoutputtypedef) 
...
class AttributeConditionTypeDef(TypedDict):
    ...
    Value: NotRequired[str],
    ProficiencyLevel: NotRequired[float],
    MatchCriteria: NotRequired[MatchCriteriaUnionTypeDef],  # (1)
    ComparisonOperator: NotRequired[str],
```

1. See [:material-code-braces: MatchCriteriaTypeDef](./type_defs.md#matchcriteriatypedef) [:material-code-braces: MatchCriteriaOutputTypeDef](./type_defs.md#matchcriteriaoutputtypedef) 
...
7. See [:material-code-braces: CustomerTypeDef](./type_defs.md#customertypedef) 
8. See [:material-code-braces: CampaignTypeDef](./type_defs.md#campaigntypedef) 
9. See [:material-code-brackets: AnsweringMachineDetectionStatusType](./literals.md#answeringmachinedetectionstatustype) 
10. See [:material-code-braces: CustomerVoiceActivityTypeDef](./type_defs.md#customervoiceactivitytypedef) 
11. See [:material-code-braces: QualityMetricsTypeDef](./type_defs.md#qualitymetricstypedef) 
12. See [:material-code-braces: DisconnectDetailsTypeDef](./type_defs.md#disconnectdetailstypedef) 
13. See [:material-code-braces: SegmentAttributeValueTypeDef](./type_defs.md#segmentattributevaluetypedef) 
## ExpressionTypeDef
