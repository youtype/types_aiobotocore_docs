<a id="type-annotations-for-aiobotocore-mturk-module"></a>

# Type annotations for aiobotocore MTurk module
...
pip install 'types-aiobotocore[mturk]'

# install as a standalone
pip install types-aiobotocore-mturk
```

- [Type annotations for aiobotocore MTurk module](#type-annotations-for-aiobotocore-mturk-module)
...
Type annotations for `aiobotocore.create_client("mturk")` as
[MTurkClient](./client.md)
...
```python
from types_aiobotocore_mturk.paginators import ListAssignmentsForHITPaginator, ...
```
