...
from types_aiobotocore_s3control.type_defs import AssociateAccessGrantsIdentityCenterRequestRequestTypeDef
...
async with session.create_client("s3control") as client:
    ...
    kwargs: AssociateAccessGrantsIdentityCenterRequestRequestTypeDef = {...}
