...
kwargs: DeleteContactFlowVersionRequestRequestTypeDef = {  # (1)
    "InstanceId": ...,
    "ContactFlowId": ...,
    "ContactFlowVersion": ...,
}
...
1. See [:material-code-braces: DeleteContactFlowVersionRequestRequestTypeDef](./type_defs.md#deletecontactflowversionrequestrequesttypedef) 
