...
Type annotations and code completion for `#!python session.create_client("memorydb").describe_multi_region_parameter_groups` method.
...
await def describe_multi_region_parameter_groups(
    self,
    *,
    MultiRegionParameterGroupName: str = ...,
    MaxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("memorydb").describe_multi_region_parameters` method.
...
await def describe_multi_region_parameters(
    self,
    *,
    MultiRegionParameterGroupName: str,
    Source: str = ...,
