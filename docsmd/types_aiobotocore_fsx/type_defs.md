...
class S3AccessPointAttachmentTypeDef(TypedDict):
    ...
    S3AccessPoint: NotRequired[S3AccessPointTypeDef],  # (5)
```
...
5. See [:material-code-braces: S3AccessPointTypeDef](./type_defs.md#s3accesspointtypedef)
...
class CreateAndAttachS3AccessPointRequestTypeDef(TypedDict):
    ...
    S3AccessPoint: NotRequired[CreateAndAttachS3AccessPointS3ConfigurationTypeDef],  # (3)
```
