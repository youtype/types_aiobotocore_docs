...
Type annotations and code completion for `#!python session.create_client("cost-optimization-hub").list_efficiency_metrics` method.
...
await def list_efficiency_metrics(
    self,
    *,
