...
class AssetListingTypeDef(TypedDict):
    ...
    latestTimeSeriesDataPointForms: NotRequired[List[TimeSeriesDataPointSummaryFormOutputTypeDef]],  # (3)
    owningProjectId: NotRequired[str],
```
...
class EnvironmentConfigurationUserParameterOutputTypeDef(TypedDict):
    ...
    environmentResolvedAccount: NotRequired[EnvironmentResolvedAccountTypeDef],  # (2)
```

1. See `List[EnvironmentParameterTypeDef]`
2. See [:material-code-braces: EnvironmentResolvedAccountTypeDef](./type_defs.md#environmentresolvedaccounttypedef)
...
class CreateAccountPoolOutputTypeDef(TypedDict):
    accountSource: AccountSourceOutputTypeDef,  # (1)
    createdAt: datetime.datetime,
    createdBy: str,
    description: str,
    domainId: str,
...
1. See [:material-code-braces: AccountSourceOutputTypeDef](./type_defs.md#accountsourceoutputtypedef)
...
class EnvironmentConfigurationOutputTypeDef(TypedDict):
    ...
    awsRegion: NotRequired[RegionTypeDef],  # (2)
...
class SearchListingsInputPaginateTypeDef(TypedDict):
    ...
    aggregations: NotRequired[Sequence[AggregationListItemTypeDef]],  # (2)
    filters: NotRequired[FilterClausePaginatorTypeDef],  # (3)
    searchIn: NotRequired[Sequence[SearchInItemTypeDef]],  # (4)
    searchText: NotRequired[str],
    sort: NotRequired[SearchSortTypeDef],  # (5)
...
class UpdateAccountPoolInputTypeDef(TypedDict):
    domainIdentifier: str,
    identifier: str,
    accountSource: NotRequired[AccountSourceUnionTypeDef],  # (1)
    description: NotRequired[str],
    name: NotRequired[str],
    resolutionStrategy: NotRequired[ResolutionStrategyType],  # (2)
```
...
class AssetItemAdditionalAttributesTypeDef(TypedDict):
    ...
    matchRationale: NotRequired[List[MatchRationaleItemTypeDef]],  # (3)
    readOnlyFormsOutput: NotRequired[List[FormOutputTypeDef]],  # (1)
```

1. See `List[FormOutputTypeDef]`
2. See `List[TimeSeriesDataPointSummaryFormOutputTypeDef]`
3. See `List[MatchRationaleItemTypeDef]`
4. See `List[FormOutputTypeDef]`
...
class AssetListingItemAdditionalAttributesTypeDef(TypedDict):
    ...
    matchRationale: NotRequired[List[MatchRationaleItemTypeDef]],  # (2)
```

1. See `List[TimeSeriesDataPointSummaryFormOutputTypeDef]`
2. See `List[MatchRationaleItemTypeDef]`
...
class ConnectionPropertiesOutputTypeDef(TypedDict):
    ...
    s3Properties: NotRequired[S3PropertiesOutputTypeDef],  # (6)
    sparkEmrProperties: NotRequired[SparkEmrPropertiesOutputTypeDef],  # (7)
    sparkGlueProperties: NotRequired[SparkGluePropertiesOutputTypeDef],  # (8)
```
...
6. See [:material-code-braces: S3PropertiesOutputTypeDef](./type_defs.md#s3propertiesoutputtypedef)
7. See [:material-code-braces: SparkEmrPropertiesOutputTypeDef](./type_defs.md#sparkemrpropertiesoutputtypedef)
8. See [:material-code-braces: SparkGluePropertiesOutputTypeDef](./type_defs.md#sparkgluepropertiesoutputtypedef)
...
class ConnectionPropertiesPatchTypeDef(TypedDict):
    ...
    s3Properties: NotRequired[S3PropertiesPatchTypeDef],  # (5)
    sparkEmrProperties: NotRequired[SparkEmrPropertiesPatchTypeDef],  # (6)
```
...
5. See [:material-code-braces: S3PropertiesPatchTypeDef](./type_defs.md#s3propertiespatchtypedef)
6. See [:material-code-braces: SparkEmrPropertiesPatchTypeDef](./type_defs.md#sparkemrpropertiespatchtypedef)
...
class GlossaryItemTypeDef(TypedDict):
    ...
    name: str,
    owningProjectId: str,
    status: GlossaryStatusType,  # (2)
    additionalAttributes: NotRequired[GlossaryItemAdditionalAttributesTypeDef],  # (1)
    createdAt: NotRequired[datetime.datetime],
    createdBy: NotRequired[str],
    description: NotRequired[str],
    updatedAt: NotRequired[datetime.datetime],
    updatedBy: NotRequired[str],
    usageRestrictions: NotRequired[List[GlossaryUsageRestrictionType]],  # (3)
```

1. See [:material-code-braces: GlossaryItemAdditionalAttributesTypeDef](./type_defs.md#glossaryitemadditionalattributestypedef)
2. See [:material-code-brackets: GlossaryStatusType](./literals.md#glossarystatustype)
3. See `List[Literal['ASSET_GOVERNED_TERMS']]`
...
class GlossaryTermItemTypeDef(TypedDict):
    ...
    additionalAttributes: NotRequired[GlossaryTermItemAdditionalAttributesTypeDef],  # (1)
    createdAt: NotRequired[datetime.datetime],
    createdBy: NotRequired[str],
    longDescription: NotRequired[str],
    shortDescription: NotRequired[str],
    termRelations: NotRequired[TermRelationsOutputTypeDef],  # (3)
    updatedAt: NotRequired[datetime.datetime],
    updatedBy: NotRequired[str],
    usageRestrictions: NotRequired[List[GlossaryUsageRestrictionType]],  # (4)
```

1. See [:material-code-braces: GlossaryTermItemAdditionalAttributesTypeDef](./type_defs.md#glossarytermitemadditionalattributestypedef)
2. See [:material-code-brackets: GlossaryTermStatusType](./literals.md#glossarytermstatustype)
3. See [:material-code-braces: TermRelationsOutputTypeDef](./type_defs.md#termrelationsoutputtypedef)
4. See `List[Literal['ASSET_GOVERNED_TERMS']]`
...
class SearchListingsOutputTypeDef(TypedDict):
    aggregates: List[AggregationOutputTypeDef],  # (1)
    items: List[SearchResultItemTypeDef],  # (2)
    totalMatchCount: int,
    ResponseMetadata: ResponseMetadataTypeDef,  # (3)
    nextToken: NotRequired[str],
```

1. See `List[AggregationOutputTypeDef]`
...
class ConnectionPropertiesInputTypeDef(TypedDict):
    ...
    s3Properties: NotRequired[S3PropertiesInputTypeDef],  # (6)
    sparkEmrProperties: NotRequired[SparkEmrPropertiesInputTypeDef],  # (7)
    sparkGlueProperties: NotRequired[SparkGluePropertiesInputTypeDef],  # (8)
```
...
6. See [:material-code-braces: S3PropertiesInputTypeDef](./type_defs.md#s3propertiesinputtypedef)
7. See [:material-code-braces: SparkEmrPropertiesInputTypeDef](./type_defs.md#sparkemrpropertiesinputtypedef)
8. See [:material-code-braces: SparkGluePropertiesInputTypeDef](./type_defs.md#sparkgluepropertiesinputtypedef)
