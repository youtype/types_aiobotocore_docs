...
> [Index](../README.md) > [CloudTrailDataService](./README.md) > Literals
...
```python
# CloudTrailDataServiceServiceName definition
CloudTrailDataServiceServiceName = Literal[
    "cloudtrail-data",
]
```
## ServiceName
...
from types_aiobotocore_cloudtrail_data.literals import ServiceName
...
from types_aiobotocore_cloudtrail_data.literals import ResourceServiceName
...
from types_aiobotocore_cloudtrail_data.literals import RegionName
