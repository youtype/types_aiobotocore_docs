...
Type annotations and code completion for `#!python session.create_client("transcribe").get_waiter("call_analytics_job_completed")`.
...
from types_aiobotocore_transcribe.waiter import CallAnalyticsJobCompletedWaiter
...
Type annotations and code completion for `#!python session.create_client("transcribe").get_waiter("language_model_completed")`.
...
from types_aiobotocore_transcribe.waiter import LanguageModelCompletedWaiter
...
Type annotations and code completion for `#!python session.create_client("transcribe").get_waiter("medical_scribe_job_completed")`.
...
from types_aiobotocore_transcribe.waiter import MedicalScribeJobCompletedWaiter
...
Type annotations and code completion for `#!python session.create_client("transcribe").get_waiter("medical_transcription_job_completed")`.
...
from types_aiobotocore_transcribe.waiter import MedicalTranscriptionJobCompletedWaiter
...
Type annotations and code completion for `#!python session.create_client("transcribe").get_waiter("medical_vocabulary_ready")`.
...
from types_aiobotocore_transcribe.waiter import MedicalVocabularyReadyWaiter
...
Type annotations and code completion for `#!python session.create_client("transcribe").get_waiter("transcription_job_completed")`.
...
from types_aiobotocore_transcribe.waiter import TranscriptionJobCompletedWaiter
...
Type annotations and code completion for `#!python session.create_client("transcribe").get_waiter("vocabulary_ready")`.
...
from types_aiobotocore_transcribe.waiter import VocabularyReadyWaiter
