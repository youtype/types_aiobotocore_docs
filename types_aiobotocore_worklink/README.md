<a id="type-annotations-for-aiobotocore-worklink-module"></a>
...
pip install 'types-aiobotocore[worklink]'
...
Type annotations for `aiobotocore.create_client("worklink")` as
