<a id="type-annotations-for-aiobotocore-workdocs-module"></a>
...
Type annotations for `aiobotocore.create_client("workdocs")` as
...
```python
from types_aiobotocore_workdocs.paginators import DescribeActivitiesPaginator, ...
```
