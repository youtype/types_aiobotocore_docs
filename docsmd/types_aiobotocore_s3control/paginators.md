...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3control.html#S3Control.Paginator.ListCallerAccessGrants)
...
def paginate(
    ...
    *,
    ...
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListCallerAccessGrantsResultTypeDef]:  # (2)
    ...
```
...
1. See [:material-code-braces: ListCallerAccessGrantsRequestListCallerAccessGrantsPaginateTypeDef](./type_defs.md#listcalleraccessgrantsrequestlistcalleraccessgrantspaginatetypedef) 
