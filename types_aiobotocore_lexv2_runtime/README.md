<a id="type-annotations-for-aiobotocore-lexruntimev2-module"></a>

# Type annotations for aiobotocore LexRuntimeV2 module
...
pip install 'types-aiobotocore[lexv2-runtime]'

# install as a standalone
pip install types-aiobotocore-lexv2-runtime
```

- [Type annotations for aiobotocore LexRuntimeV2 module](#type-annotations-for-aiobotocore-lexruntimev2-module)
...
Type annotations for `aiobotocore.create_client("lexv2-runtime")` as
