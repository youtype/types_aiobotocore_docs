...
def paginate(
    ...
    *,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListStateTemplatesResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListStateTemplatesRequestListStateTemplatesPaginateTypeDef = {  # (1)
    "PaginationConfig": ...,
}
...
1. See [:material-code-braces: ListStateTemplatesRequestListStateTemplatesPaginateTypeDef](./type_defs.md#liststatetemplatesrequestliststatetemplatespaginatetypedef) 
