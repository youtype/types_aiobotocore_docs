...
- `message_attributes`: `Awaitable`[`Dict`[`str`, [MessageAttributeValueTypeDef](./type_defs.md#messageattributevaluetypedef)]]
- `queue_url`: `str`
- `receipt_handle`: `str`
...
await def send_message(
    ...
    *,
    MessageBody: str,
    DelaySeconds: int = ...,
    MessageAttributes: Mapping[str, MessageAttributeValueQueueTypeDef] = ...,  # (1)
