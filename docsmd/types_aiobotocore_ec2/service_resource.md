...
await def create_instances(
    ...
    *,
    ...
    ClientToken: str = ...,
    AdditionalInfo: str = ...,
    NetworkInterfaces: Sequence[InstanceNetworkInterfaceSpecificationTypeDef] = ...,  # (21)
...
21. See [:material-code-braces: InstanceNetworkInterfaceSpecificationTypeDef](./type_defs.md#instancenetworkinterfacespecificationtypedef) 
...
- `association_attribute`: `Awaitable`[[NetworkInterfaceAssociationTypeDef](./type_defs.md#networkinterfaceassociationtypedef)]
- `attachment`: `Awaitable`[[NetworkInterfaceAttachmentTypeDef](./type_defs.md#networkinterfaceattachmenttypedef)]
- `availability_zone`: `Awaitable`[`str`]
- `connection_tracking_configuration`: `Awaitable`[[ConnectionTrackingConfigurationTypeDef](./type_defs.md#connectiontrackingconfigurationtypedef)]
- `description`: `Awaitable`[`str`]
...
- `subnet_id`: `Awaitable`[`str`]
- `gateway_id`: `Awaitable`[`str`]
- `association_state`: `Awaitable`[[RouteTableAssociationStateTypeDef](./type_defs.md#routetableassociationstatetypedef)]
- `id`: `str`
...
- `group_id`: `Awaitable`[`str`]
- `ip_permissions_egress`: `Awaitable`[`List`[[IpPermissionOutputTypeDef](./type_defs.md#ippermissionoutputtypedef)]]
- `tags`: `Awaitable`[`List`[[TagTypeDef](./type_defs.md#tagtypedef)]]
- `vpc_id`: `Awaitable`[`str`]
- `owner_id`: `Awaitable`[`str`]
- `group_name`: `Awaitable`[`str`]
- `description`: `Awaitable`[`str`]
- `ip_permissions`: `Awaitable`[`List`[[IpPermissionOutputTypeDef](./type_defs.md#ippermissionoutputtypedef)]]
- `id`: `str`
- `meta`: `"EC2ResourceMeta"`
...
await def authorize_egress(
    ...
    *,
    ...
    ToPort: int = ...,
    CidrIp: str = ...,
    IpPermissions: Sequence[IpPermissionTypeDef] = ...,  # (2)
...
- `ipv6_native`: `Awaitable`[`bool`]
- `private_dns_name_options_on_launch`: `Awaitable`[[PrivateDnsNameOptionsOnLaunchTypeDef](./type_defs.md#privatednsnameoptionsonlaunchtypedef)]
- `subnet_id`: `Awaitable`[`str`]
...
- `accepter_vpc_info`: `Awaitable`[[VpcPeeringConnectionVpcInfoTypeDef](./type_defs.md#vpcpeeringconnectionvpcinfotypedef)]
- `expiration_time`: `Awaitable`[`datetime`]
- `requester_vpc_info`: `Awaitable`[[VpcPeeringConnectionVpcInfoTypeDef](./type_defs.md#vpcpeeringconnectionvpcinfotypedef)]
- `status`: `Awaitable`[[VpcPeeringConnectionStateReasonTypeDef](./type_defs.md#vpcpeeringconnectionstatereasontypedef)]
- `tags`: `Awaitable`[`List`[[TagTypeDef](./type_defs.md#tagtypedef)]]
- `vpc_peering_connection_id`: `Awaitable`[`str`]
- `id`: `str`
- `accepter_vpc`: `"Vpc"`
