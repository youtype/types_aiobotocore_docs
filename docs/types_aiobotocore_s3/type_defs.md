<a id="typed-dictionaries-for-aiobotocore-s3-module"></a>
...
- [Typed dictionaries for aiobotocore S3 module](#typed-dictionaries-for-aiobotocore-s3-module)
  ...
  - [AbortMultipartUploadRequestMultipartUploadAbortTypeDef](#abortmultipartuploadrequestmultipartuploadaborttypedef)
  ...
  - [CompleteMultipartUploadRequestMultipartUploadCompleteTypeDef](#completemultipartuploadrequestmultipartuploadcompletetypedef)
  ...
  - [CopyObjectRequestObjectCopyFromTypeDef](#copyobjectrequestobjectcopyfromtypedef)
  - [CopyObjectRequestObjectSummaryCopyFromTypeDef](#copyobjectrequestobjectsummarycopyfromtypedef)
  ...
  - [CreateBucketRequestBucketCreateTypeDef](#createbucketrequestbucketcreatetypedef)
  - [CreateBucketRequestRequestTypeDef](#createbucketrequestrequesttypedef)
  - [CreateBucketRequestServiceResourceCreateBucketTypeDef](#createbucketrequestserviceresourcecreatebuckettypedef)
  - [CreateMultipartUploadOutputTypeDef](#createmultipartuploadoutputtypedef)
  - [CreateMultipartUploadRequestObjectInitiateMultipartUploadTypeDef](#createmultipartuploadrequestobjectinitiatemultipartuploadtypedef)
  - [CreateMultipartUploadRequestObjectSummaryInitiateMultipartUploadTypeDef](#createmultipartuploadrequestobjectsummaryinitiatemultipartuploadtypedef)
  ...
  - [DeleteBucketCorsRequestBucketCorsDeleteTypeDef](#deletebucketcorsrequestbucketcorsdeletetypedef)
  ...
  - [DeleteBucketLifecycleRequestBucketLifecycleConfigurationDeleteTypeDef](#deletebucketlifecyclerequestbucketlifecycleconfigurationdeletetypedef)
  - [DeleteBucketLifecycleRequestBucketLifecycleDeleteTypeDef](#deletebucketlifecyclerequestbucketlifecycledeletetypedef)
  ...
  - [DeleteBucketPolicyRequestBucketPolicyDeleteTypeDef](#deletebucketpolicyrequestbucketpolicydeletetypedef)
  ...
  - [DeleteBucketRequestBucketDeleteTypeDef](#deletebucketrequestbucketdeletetypedef)
  - [DeleteBucketRequestRequestTypeDef](#deletebucketrequestrequesttypedef)
  - [DeleteBucketTaggingRequestBucketTaggingDeleteTypeDef](#deletebuckettaggingrequestbuckettaggingdeletetypedef)
  - [DeleteBucketTaggingRequestRequestTypeDef](#deletebuckettaggingrequestrequesttypedef)
  - [DeleteBucketWebsiteRequestBucketWebsiteDeleteTypeDef](#deletebucketwebsiterequestbucketwebsitedeletetypedef)
  ...
  - [DeleteObjectRequestObjectDeleteTypeDef](#deleteobjectrequestobjectdeletetypedef)
  - [DeleteObjectRequestObjectSummaryDeleteTypeDef](#deleteobjectrequestobjectsummarydeletetypedef)
  - [DeleteObjectRequestObjectVersionDeleteTypeDef](#deleteobjectrequestobjectversiondeletetypedef)
  ...
  - [DeleteObjectsRequestBucketDeleteObjectsTypeDef](#deleteobjectsrequestbucketdeleteobjectstypedef)
  ...
  - [GetObjectRequestObjectGetTypeDef](#getobjectrequestobjectgettypedef)
  - [GetObjectRequestObjectSummaryGetTypeDef](#getobjectrequestobjectsummarygettypedef)
  - [GetObjectRequestObjectVersionGetTypeDef](#getobjectrequestobjectversiongettypedef)
  ...
  - [HeadObjectRequestObjectVersionHeadTypeDef](#headobjectrequestobjectversionheadtypedef)
  ...
  - [PutBucketAclRequestBucketAclPutTypeDef](#putbucketaclrequestbucketaclputtypedef)
  ...
  - [PutBucketCorsRequestBucketCorsPutTypeDef](#putbucketcorsrequestbucketcorsputtypedef)
  ...
  - [PutBucketLifecycleConfigurationRequestBucketLifecycleConfigurationPutTypeDef](#putbucketlifecycleconfigurationrequestbucketlifecycleconfigurationputtypedef)
  - [PutBucketLifecycleConfigurationRequestRequestTypeDef](#putbucketlifecycleconfigurationrequestrequesttypedef)
  - [PutBucketLifecycleRequestBucketLifecyclePutTypeDef](#putbucketlifecyclerequestbucketlifecycleputtypedef)
  - [PutBucketLifecycleRequestRequestTypeDef](#putbucketlifecyclerequestrequesttypedef)
  - [PutBucketLoggingRequestBucketLoggingPutTypeDef](#putbucketloggingrequestbucketloggingputtypedef)
  ...
  - [PutBucketNotificationConfigurationRequestBucketNotificationPutTypeDef](#putbucketnotificationconfigurationrequestbucketnotificationputtypedef)
  ...
  - [PutBucketPolicyRequestBucketPolicyPutTypeDef](#putbucketpolicyrequestbucketpolicyputtypedef)
  ...
  - [PutBucketRequestPaymentRequestBucketRequestPaymentPutTypeDef](#putbucketrequestpaymentrequestbucketrequestpaymentputtypedef)
  - [PutBucketRequestPaymentRequestRequestTypeDef](#putbucketrequestpaymentrequestrequesttypedef)
  - [PutBucketTaggingRequestBucketTaggingPutTypeDef](#putbuckettaggingrequestbuckettaggingputtypedef)
  - [PutBucketTaggingRequestRequestTypeDef](#putbuckettaggingrequestrequesttypedef)
  - [PutBucketVersioningRequestBucketVersioningEnableTypeDef](#putbucketversioningrequestbucketversioningenabletypedef)
  - [PutBucketVersioningRequestBucketVersioningPutTypeDef](#putbucketversioningrequestbucketversioningputtypedef)
  - [PutBucketVersioningRequestBucketVersioningSuspendTypeDef](#putbucketversioningrequestbucketversioningsuspendtypedef)
  - [PutBucketVersioningRequestRequestTypeDef](#putbucketversioningrequestrequesttypedef)
  - [PutBucketWebsiteRequestBucketWebsitePutTypeDef](#putbucketwebsiterequestbucketwebsiteputtypedef)
  ...
  - [PutObjectAclRequestObjectAclPutTypeDef](#putobjectaclrequestobjectaclputtypedef)
  ...
  - [PutObjectRequestBucketPutObjectTypeDef](#putobjectrequestbucketputobjecttypedef)
  - [PutObjectRequestObjectPutTypeDef](#putobjectrequestobjectputtypedef)
  - [PutObjectRequestObjectSummaryPutTypeDef](#putobjectrequestobjectsummaryputtypedef)
  ...
  - [RestoreObjectRequestObjectRestoreObjectTypeDef](#restoreobjectrequestobjectrestoreobjecttypedef)
  - [RestoreObjectRequestObjectSummaryRestoreObjectTypeDef](#restoreobjectrequestobjectsummaryrestoreobjecttypedef)
  ...
  - [UploadPartCopyRequestMultipartUploadPartCopyFromTypeDef](#uploadpartcopyrequestmultipartuploadpartcopyfromtypedef)
  - [UploadPartCopyRequestRequestTypeDef](#uploadpartcopyrequestrequesttypedef)
  - [UploadPartOutputTypeDef](#uploadpartoutputtypedef)
  - [UploadPartRequestMultipartUploadPartUploadTypeDef](#uploadpartrequestmultipartuploadpartuploadtypedef)
...
<a id="abortmultipartuploadrequestmultipartuploadaborttypedef"></a>
...
<a id="completemultipartuploadrequestmultipartuploadcompletetypedef"></a>

## CompleteMultipartUploadRequestMultipartUploadCompleteTypeDef

```python
from types_aiobotocore_s3.type_defs import CompleteMultipartUploadRequestMultipartUploadCompleteTypeDef
```
...
<a id="copyobjectrequestobjectcopyfromtypedef"></a>
...
<a id="copyobjectrequestobjectsummarycopyfromtypedef"></a>
...
<a id="createbucketrequestbucketcreatetypedef"></a>

## CreateBucketRequestBucketCreateTypeDef

```python
from types_aiobotocore_s3.type_defs import CreateBucketRequestBucketCreateTypeDef
```
...
<a id="createbucketrequestserviceresourcecreatebuckettypedef"></a>
...
<a id="createmultipartuploadrequestobjectinitiatemultipartuploadtypedef"></a>
...
<a id="createmultipartuploadrequestobjectsummaryinitiatemultipartuploadtypedef"></a>
...
<a id="deletebucketcorsrequestbucketcorsdeletetypedef"></a>
...
<a id="deletebucketlifecyclerequestbucketlifecycleconfigurationdeletetypedef"></a>
...
<a id="deletebucketlifecyclerequestbucketlifecycledeletetypedef"></a>
...
<a id="deletebucketpolicyrequestbucketpolicydeletetypedef"></a>
...
<a id="deletebucketrequestbucketdeletetypedef"></a>
...
<a id="deletebuckettaggingrequestbuckettaggingdeletetypedef"></a>
...
<a id="deletebucketwebsiterequestbucketwebsitedeletetypedef"></a>
...
<a id="deleteobjectrequestobjectdeletetypedef"></a>
...
<a id="deleteobjectrequestobjectsummarydeletetypedef"></a>
...
<a id="deleteobjectrequestobjectversiondeletetypedef"></a>
...
<a id="deleteobjectsrequestbucketdeleteobjectstypedef"></a>

## DeleteObjectsRequestBucketDeleteObjectsTypeDef

```python
from types_aiobotocore_s3.type_defs import DeleteObjectsRequestBucketDeleteObjectsTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import GetObjectAttributesPartsTypeDef
```
...
<a id="getobjectrequestobjectgettypedef"></a>
...
<a id="getobjectrequestobjectsummarygettypedef"></a>
...
<a id="getobjectrequestobjectversiongettypedef"></a>
...
```python
from types_aiobotocore_s3.type_defs import GetObjectRetentionOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import GetObjectTaggingOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import GetObjectTorrentOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import GetPublicAccessBlockOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import GrantTypeDef
```
...
<a id="headobjectrequestobjectversionheadtypedef"></a>
...
```python
from types_aiobotocore_s3.type_defs import IndexDocumentResponseMetadataTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import InitiatorResponseMetadataTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import InputSerializationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import IntelligentTieringAndOperatorTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import IntelligentTieringConfigurationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import IntelligentTieringFilterTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import InventoryConfigurationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import InventoryDestinationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import InventoryEncryptionTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import InventoryS3BucketDestinationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import LambdaFunctionConfigurationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import LifecycleConfigurationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import LifecycleRuleAndOperatorTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import LifecycleRuleFilterTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import LifecycleRuleTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ListBucketAnalyticsConfigurationsOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ListBucketIntelligentTieringConfigurationsOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ListBucketInventoryConfigurationsOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ListBucketMetricsConfigurationsOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ListObjectsOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ListPartsOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import LoggingEnabledResponseMetadataTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import LoggingEnabledTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import MetricsAndOperatorTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import MetricsConfigurationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import MetricsFilterTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import MetricsTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import MultipartUploadTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import NotificationConfigurationDeprecatedResponseMetadataTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import NotificationConfigurationDeprecatedTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import NotificationConfigurationFilterTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import NotificationConfigurationResponseMetadataTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ObjectCopyRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ObjectLockConfigurationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ObjectLockRuleTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import OutputLocationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import OutputSerializationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import OwnerResponseMetadataTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import OwnershipControlsTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ProgressEventTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketAccelerateConfigurationRequestRequestTypeDef
```
...
<a id="putbucketaclrequestbucketaclputtypedef"></a>

## PutBucketAclRequestBucketAclPutTypeDef

```python
from types_aiobotocore_s3.type_defs import PutBucketAclRequestBucketAclPutTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketAclRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketAnalyticsConfigurationRequestRequestTypeDef
```
...
<a id="putbucketcorsrequestbucketcorsputtypedef"></a>

## PutBucketCorsRequestBucketCorsPutTypeDef

```python
from types_aiobotocore_s3.type_defs import PutBucketCorsRequestBucketCorsPutTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketCorsRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketEncryptionRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketIntelligentTieringConfigurationRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketInventoryConfigurationRequestRequestTypeDef
```
...
<a id="putbucketlifecycleconfigurationrequestbucketlifecycleconfigurationputtypedef"></a>

## PutBucketLifecycleConfigurationRequestBucketLifecycleConfigurationPutTypeDef

```python
from types_aiobotocore_s3.type_defs import PutBucketLifecycleConfigurationRequestBucketLifecycleConfigurationPutTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketLifecycleConfigurationRequestRequestTypeDef
```
...
<a id="putbucketlifecyclerequestbucketlifecycleputtypedef"></a>

## PutBucketLifecycleRequestBucketLifecyclePutTypeDef

```python
from types_aiobotocore_s3.type_defs import PutBucketLifecycleRequestBucketLifecyclePutTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketLifecycleRequestRequestTypeDef
```
...
<a id="putbucketloggingrequestbucketloggingputtypedef"></a>

## PutBucketLoggingRequestBucketLoggingPutTypeDef

```python
from types_aiobotocore_s3.type_defs import PutBucketLoggingRequestBucketLoggingPutTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketLoggingRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketMetricsConfigurationRequestRequestTypeDef
```
...
<a id="putbucketnotificationconfigurationrequestbucketnotificationputtypedef"></a>

## PutBucketNotificationConfigurationRequestBucketNotificationPutTypeDef

```python
from types_aiobotocore_s3.type_defs import PutBucketNotificationConfigurationRequestBucketNotificationPutTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketNotificationConfigurationRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketNotificationRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketOwnershipControlsRequestRequestTypeDef
```
...
<a id="putbucketpolicyrequestbucketpolicyputtypedef"></a>
...
```python
from types_aiobotocore_s3.type_defs import PutBucketReplicationRequestRequestTypeDef
```
...
<a id="putbucketrequestpaymentrequestbucketrequestpaymentputtypedef"></a>

## PutBucketRequestPaymentRequestBucketRequestPaymentPutTypeDef

```python
from types_aiobotocore_s3.type_defs import PutBucketRequestPaymentRequestBucketRequestPaymentPutTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketRequestPaymentRequestRequestTypeDef
```
...
<a id="putbuckettaggingrequestbuckettaggingputtypedef"></a>

## PutBucketTaggingRequestBucketTaggingPutTypeDef

```python
from types_aiobotocore_s3.type_defs import PutBucketTaggingRequestBucketTaggingPutTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketTaggingRequestRequestTypeDef
```
...
<a id="putbucketversioningrequestbucketversioningenabletypedef"></a>
...
<a id="putbucketversioningrequestbucketversioningputtypedef"></a>

## PutBucketVersioningRequestBucketVersioningPutTypeDef

```python
from types_aiobotocore_s3.type_defs import PutBucketVersioningRequestBucketVersioningPutTypeDef
```
...
<a id="putbucketversioningrequestbucketversioningsuspendtypedef"></a>
...
```python
from types_aiobotocore_s3.type_defs import PutBucketVersioningRequestRequestTypeDef
```
...
<a id="putbucketwebsiterequestbucketwebsiteputtypedef"></a>

## PutBucketWebsiteRequestBucketWebsitePutTypeDef

```python
from types_aiobotocore_s3.type_defs import PutBucketWebsiteRequestBucketWebsitePutTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutBucketWebsiteRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutObjectAclOutputTypeDef
```
...
<a id="putobjectaclrequestobjectaclputtypedef"></a>

## PutObjectAclRequestObjectAclPutTypeDef

```python
from types_aiobotocore_s3.type_defs import PutObjectAclRequestObjectAclPutTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutObjectAclRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutObjectLegalHoldOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutObjectLegalHoldRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutObjectLockConfigurationOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutObjectLockConfigurationRequestRequestTypeDef
```
...
<a id="putobjectrequestbucketputobjecttypedef"></a>
...
<a id="putobjectrequestobjectputtypedef"></a>

## PutObjectRequestObjectPutTypeDef

```python
from types_aiobotocore_s3.type_defs import PutObjectRequestObjectPutTypeDef
```
...
<a id="putobjectrequestobjectsummaryputtypedef"></a>

## PutObjectRequestObjectSummaryPutTypeDef

```python
from types_aiobotocore_s3.type_defs import PutObjectRequestObjectSummaryPutTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutObjectRetentionOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutObjectRetentionRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutObjectTaggingOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutObjectTaggingRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import PutPublicAccessBlockRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import QueueConfigurationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import RedirectAllRequestsToResponseMetadataTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import RedirectTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ReplicaModificationsTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ReplicationConfigurationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ReplicationRuleAndOperatorTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ReplicationRuleFilterTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ReplicationRuleTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ReplicationTimeTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import RequestProgressTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import RestoreObjectOutputTypeDef
```
...
<a id="restoreobjectrequestobjectrestoreobjecttypedef"></a>

## RestoreObjectRequestObjectRestoreObjectTypeDef

```python
from types_aiobotocore_s3.type_defs import RestoreObjectRequestObjectRestoreObjectTypeDef
```
...
<a id="restoreobjectrequestobjectsummaryrestoreobjecttypedef"></a>

## RestoreObjectRequestObjectSummaryRestoreObjectTypeDef

```python
from types_aiobotocore_s3.type_defs import RestoreObjectRequestObjectSummaryRestoreObjectTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import RestoreObjectRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import RestoreRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import RoutingRuleTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import RuleTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import S3KeyFilterTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import S3LocationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ScanRangeTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import SelectObjectContentEventStreamTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import SelectObjectContentOutputTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import SelectObjectContentRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import SelectParametersTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServerSideEncryptionByDefaultTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServerSideEncryptionConfigurationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServerSideEncryptionRuleTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceBucketAclRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceBucketCorsRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceBucketLifecycleConfigurationRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceBucketLifecycleRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceBucketLoggingRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceBucketNotificationRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceBucketPolicyRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceBucketRequestPaymentRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceBucketRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceBucketTaggingRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceBucketVersioningRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceBucketWebsiteRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceMultipartUploadPartRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceMultipartUploadRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceObjectAclRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceObjectRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceObjectSummaryRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import ServiceResourceObjectVersionRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import SourceSelectionCriteriaTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import SseKmsEncryptedObjectsTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import StatsEventTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import StatsTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import StorageClassAnalysisDataExportTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import StorageClassAnalysisTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import TargetGrantTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import TopicConfigurationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import UploadPartCopyOutputTypeDef
```
...
<a id="uploadpartcopyrequestmultipartuploadpartcopyfromtypedef"></a>

## UploadPartCopyRequestMultipartUploadPartCopyFromTypeDef

```python
from types_aiobotocore_s3.type_defs import UploadPartCopyRequestMultipartUploadPartCopyFromTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import UploadPartCopyRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import UploadPartOutputTypeDef
```
...
<a id="uploadpartrequestmultipartuploadpartuploadtypedef"></a>

## UploadPartRequestMultipartUploadPartUploadTypeDef

```python
from types_aiobotocore_s3.type_defs import UploadPartRequestMultipartUploadPartUploadTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import UploadPartRequestRequestTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import WebsiteConfigurationTypeDef
```
...
```python
from types_aiobotocore_s3.type_defs import WriteGetObjectResponseRequestRequestTypeDef
```
