...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/elasticache.html#ElastiCache.Paginator.DescribeServerlessCacheSnapshots)
...
def paginate(
    ...
    *,
    ...
    SnapshotType: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeServerlessCacheSnapshotsResponseTypeDef]:  # (2)
    ...
```
...
kwargs: DescribeServerlessCacheSnapshotsRequestDescribeServerlessCacheSnapshotsPaginateTypeDef = {  # (1)
    "ServerlessCacheName": ...,
}
...
1. See [:material-code-braces: DescribeServerlessCacheSnapshotsRequestDescribeServerlessCacheSnapshotsPaginateTypeDef](./type_defs.md#describeserverlesscachesnapshotsrequestdescribeserverlesscachesnapshotspaginatetypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/elasticache.html#ElastiCache.Paginator.DescribeServerlessCaches)
...
def paginate(
    ...
    *,
    ServerlessCacheName: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[DescribeServerlessCachesResponseTypeDef]:  # (2)
    ...
```
...
kwargs: DescribeServerlessCachesRequestDescribeServerlessCachesPaginateTypeDef = {  # (1)
    "ServerlessCacheName": ...,
}
...
1. See [:material-code-braces: DescribeServerlessCachesRequestDescribeServerlessCachesPaginateTypeDef](./type_defs.md#describeserverlesscachesrequestdescribeserverlesscachespaginatetypedef) 
