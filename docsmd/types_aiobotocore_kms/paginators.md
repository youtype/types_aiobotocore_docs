...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/kms.html#KMS.Paginator.ListKeyRotations)
...
def paginate(
    ...
    *,
    KeyId: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListKeyRotationsResponseTypeDef]:  # (2)
    ...
```
...
kwargs: ListKeyRotationsRequestListKeyRotationsPaginateTypeDef = {  # (1)
    "KeyId": ...,
}
...
1. See [:material-code-braces: ListKeyRotationsRequestListKeyRotationsPaginateTypeDef](./type_defs.md#listkeyrotationsrequestlistkeyrotationspaginatetypedef) 
## ListKeysPaginator
