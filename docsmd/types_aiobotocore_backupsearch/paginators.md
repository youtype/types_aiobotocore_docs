...
) -> AsyncIterator[ListSearchJobBackupsOutputTypeDef]:  # (2)
    ...
```
...
kwargs: ListSearchJobBackupsInputListSearchJobBackupsPaginateTypeDef = {  # (1)
    "SearchJobIdentifier": ...,
}
...
1. See [:material-code-braces: ListSearchJobBackupsInputListSearchJobBackupsPaginateTypeDef](./type_defs.md#listsearchjobbackupsinputlistsearchjobbackupspaginatetypedef) 
...
def paginate(
    ...
    *,
    SearchJobIdentifier: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> AsyncIterator[ListSearchJobResultsOutputTypeDef]:  # (2)
    ...
```
...
kwargs: ListSearchJobResultsInputListSearchJobResultsPaginateTypeDef = {  # (1)
    "SearchJobIdentifier": ...,
}
...
1. See [:material-code-braces: ListSearchJobResultsInputListSearchJobResultsPaginateTypeDef](./type_defs.md#listsearchjobresultsinputlistsearchjobresultspaginatetypedef) 
...
) -> AsyncIterator[ListSearchJobsOutputTypeDef]:  # (3)
    ...
```
...
kwargs: ListSearchJobsInputListSearchJobsPaginateTypeDef = {  # (1)
    "ByStatus": ...,
}
...
1. See [:material-code-braces: ListSearchJobsInputListSearchJobsPaginateTypeDef](./type_defs.md#listsearchjobsinputlistsearchjobspaginatetypedef) 
...
def paginate(
    ...
    *,
    ...
    SearchJobIdentifier: str = ...,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (2)
) -> AsyncIterator[ListSearchResultExportJobsOutputTypeDef]:  # (3)
    ...
```
...
kwargs: ListSearchResultExportJobsInputListSearchResultExportJobsPaginateTypeDef = {  # (1)
    "Status": ...,
}
...
1. See [:material-code-braces: ListSearchResultExportJobsInputListSearchResultExportJobsPaginateTypeDef](./type_defs.md#listsearchresultexportjobsinputlistsearchresultexportjobspaginatetypedef) 
