...
Type annotations and code completion for `#!python session.create_client("datazone").batch_get_attributes_metadata` method.
...
await def batch_get_attributes_metadata(
    self,
    *,
    domainIdentifier: str,
...
Type annotations and code completion for `#!python session.create_client("datazone").batch_put_attributes_metadata` method.
...
await def batch_put_attributes_metadata(
    self,
    *,
    domainIdentifier: str,
    entityType: AttributeEntityTypeType,  # (1)
...
Type annotations and code completion for `#!python session.create_client("datazone").create_environment_blueprint` method.
...
await def create_environment_blueprint(
    self,
    *,
    domainIdentifier: str,
    name: str,
...
Type annotations and code completion for `#!python session.create_client("datazone").delete_data_export_configuration` method.
...
await def delete_data_export_configuration(
    self,
    *,
    domainIdentifier: str,
) -> dict[str, Any]:
...
Type annotations and code completion for `#!python session.create_client("datazone").delete_environment_blueprint` method.
...
await def delete_environment_blueprint(
    self,
    *,
    domainIdentifier: str,
    identifier: str,
...
Type annotations and code completion for `#!python session.create_client("datazone").get_data_export_configuration` method.
...
await def get_data_export_configuration(
    self,
    *,
    domainIdentifier: str,
...
Type annotations and code completion for `#!python session.create_client("datazone").get_lineage_event` method.
...
Type annotations and code completion for `#!python session.create_client("datazone").get_notebook_run` method.
...
Type annotations and code completion for `#!python session.create_client("datazone").list_account_pools` method.
...
Type annotations and code completion for `#!python session.create_client("datazone").list_accounts_in_account_pool` method.
...
await def list_accounts_in_account_pool(
    self,
    *,
    domainIdentifier: str,
    identifier: str,
...
Type annotations and code completion for `#!python session.create_client("datazone").list_connections` method.
...
Type annotations and code completion for `#!python session.create_client("datazone").list_job_runs` method.
...
Type annotations and code completion for `#!python session.create_client("datazone").list_lineage_events` method.
...
Type annotations and code completion for `#!python session.create_client("datazone").list_notebook_runs` method.
...
Type annotations and code completion for `#!python session.create_client("datazone").list_project_profiles` method.
...
await def list_project_profiles(
    self,
    *,
    domainIdentifier: str,
    name: str = ...,
...
Type annotations and code completion for `#!python session.create_client("datazone").list_rules` method.
...
Type annotations and code completion for `#!python session.create_client("datazone").put_data_export_configuration` method.
...
await def put_data_export_configuration(
    self,
    *,
    domainIdentifier: str,
    enableExport: bool,
...
Type annotations and code completion for `#!python session.create_client("datazone").query_graph` method.
...
Type annotations and code completion for `#!python session.create_client("datazone").start_notebook_run` method.
...
Type annotations and code completion for `#!python session.create_client("datazone").stop_notebook_run` method.
...
Type annotations and code completion for `#!python session.create_client("datazone").update_account_pool` method.
...
Type annotations and code completion for `#!python session.create_client("datazone").update_connection` method.
...
Type annotations and code completion for `#!python session.create_client("datazone").update_environment_blueprint` method.
...
await def update_environment_blueprint(
    self,
    *,
    domainIdentifier: str,
    identifier: str,
...
Type annotations and code completion for `#!python session.create_client("datazone").update_project_profile` method.
...
await def update_project_profile(
    self,
    *,
    domainIdentifier: str,
    identifier: str,
...
Type annotations and code completion for `#!python session.create_client("datazone").update_root_domain_unit_owner` method.
...
await def update_root_domain_unit_owner(
    self,
    *,
    domainIdentifier: str,
    currentOwner: str,
...
Type annotations and code completion for `#!python session.create_client("datazone").update_rule` method.
