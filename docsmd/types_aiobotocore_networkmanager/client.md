...
Type annotations and code completion for `#!python session.create_client("networkmanager").create_connection` method.
...
Type annotations and code completion for `#!python session.create_client("networkmanager").create_core_network_prefix_list_association` method.
...
await def create_core_network_prefix_list_association(
    self,
    *,
    CoreNetworkId: str,
    PrefixListArn: str,
...
Type annotations and code completion for `#!python session.create_client("networkmanager").delete_core_network_prefix_list_association` method.
...
await def delete_core_network_prefix_list_association(
    self,
    *,
    CoreNetworkId: str,
    PrefixListArn: str,
...
Type annotations and code completion for `#!python session.create_client("networkmanager").delete_peering` method.
...
Type annotations and code completion for `#!python session.create_client("networkmanager").list_attachment_routing_policy_associations` method.
...
await def list_attachment_routing_policy_associations(
    self,
    *,
    CoreNetworkId: str,
    AttachmentId: str = ...,
...
Type annotations and code completion for `#!python session.create_client("networkmanager").list_core_network_prefix_list_associations` method.
...
await def list_core_network_prefix_list_associations(
    self,
    *,
    CoreNetworkId: str,
    PrefixListArn: str = ...,
...
Type annotations and code completion for `#!python session.create_client("networkmanager").list_core_network_routing_information` method.
...
await def list_core_network_routing_information(
    self,
    *,
    CoreNetworkId: str,
    SegmentName: str,
...
Type annotations and code completion for `#!python session.create_client("networkmanager").put_attachment_routing_policy_label` method.
...
await def put_attachment_routing_policy_label(
    self,
    *,
    CoreNetworkId: str,
    AttachmentId: str,
...
Type annotations and code completion for `#!python session.create_client("networkmanager").remove_attachment_routing_policy_label` method.
...
await def remove_attachment_routing_policy_label(
    self,
    *,
    CoreNetworkId: str,
    AttachmentId: str,
