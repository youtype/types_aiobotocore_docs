...
class LensReviewTypeDef(TypedDict):
    ...
    RiskCounts: NotRequired[Dict[RiskType, int]],  # (3)
    NextToken: NotRequired[str],
    Profiles: NotRequired[List[WorkloadProfileTypeDef]],  # (4)
    PrioritizedRiskCounts: NotRequired[Dict[RiskType, int]],  # (3)
```
...
3. See [:material-code-brackets: RiskType](./literals.md#risktype) 
4. See [:material-code-braces: WorkloadProfileTypeDef](./type_defs.md#workloadprofiletypedef) 
5. See [:material-code-brackets: RiskType](./literals.md#risktype) 
