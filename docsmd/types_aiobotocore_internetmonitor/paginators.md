...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/internetmonitor.html#CloudWatchInternetMonitor.Paginator.ListInternetEvents)
...
) -> AsyncIterator[ListInternetEventsOutputTypeDef]:  # (2)
    ...
```
...
kwargs: ListInternetEventsInputListInternetEventsPaginateTypeDef = {  # (1)
    "StartTime": ...,
}
...
1. See [:material-code-braces: ListInternetEventsInputListInternetEventsPaginateTypeDef](./type_defs.md#listinterneteventsinputlistinterneteventspaginatetypedef) 
