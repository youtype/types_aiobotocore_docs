<a id="type-annotations-for-aiobotocore-outposts-module"></a>
...
pip install 'types-aiobotocore[outposts]'
...
Type annotations for `aiobotocore.create_client("outposts")` as
