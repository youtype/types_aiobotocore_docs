...
```python
# ListContactFlowVersionsRequestListContactFlowVersionsPaginateTypeDef definition

class ListContactFlowVersionsRequestListContactFlowVersionsPaginateTypeDef(TypedDict):
    InstanceId: str,
    ContactFlowId: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# ListHoursOfOperationOverridesRequestListHoursOfOperationOverridesPaginateTypeDef definition

class ListHoursOfOperationOverridesRequestListHoursOfOperationOverridesPaginateTypeDef(TypedDict):
    InstanceId: str,
    HoursOfOperationId: str,
    PaginationConfig: NotRequired[PaginatorConfigTypeDef],  # (1)
```
...
```python
# SearchHoursOfOperationOverridesRequestSearchHoursOfOperationOverridesPaginateTypeDef definition

class SearchHoursOfOperationOverridesRequestSearchHoursOfOperationOverridesPaginateTypeDef(TypedDict):
    InstanceId: str,
    SearchFilter: NotRequired[HoursOfOperationSearchFilterTypeDef],  # (1)
