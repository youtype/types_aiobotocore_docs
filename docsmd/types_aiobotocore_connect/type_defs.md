...
class ContactTypeDef(TypedDict):
    ...
    Recordings: NotRequired[List[RecordingInfoTypeDef]],  # (17)
    DisconnectReason: NotRequired[str],
    ContactEvaluations: NotRequired[Dict[str, ContactEvaluationTypeDef]],  # (18)
    ContactDetails: NotRequired[ContactDetailsTypeDef],  # (19)
...
16. See `Dict[str, SegmentAttributeValueOutputTypeDef]`
17. See `List[RecordingInfoTypeDef]`
18. See `Dict[str, ContactEvaluationTypeDef]`
19. See [:material-code-braces: ContactDetailsTypeDef](./type_defs.md#contactdetailstypedef)
