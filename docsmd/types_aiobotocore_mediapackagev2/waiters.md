...
kwargs: GetHarvestJobRequestHarvestJobFinishedWaitTypeDef = {  # (1)
    "ChannelGroupName": ...,
    "ChannelName": ...,
    "OriginEndpointName": ...,
    "HarvestJobName": ...,
...
1. See [:material-code-braces: GetHarvestJobRequestHarvestJobFinishedWaitTypeDef](./type_defs.md#getharvestjobrequestharvestjobfinishedwaittypedef) 
