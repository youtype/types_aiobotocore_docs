<a id="literals-for-aiobotocore-forecastqueryservice-module"></a>

# Literals for aiobotocore ForecastQueryService module

> [Index](../README.md) > [ForecastQueryService](./README.md) > Literals
...
- [Literals for aiobotocore ForecastQueryService module](#literals-for-aiobotocore-forecastqueryservice-module)
...
```python
from types_aiobotocore_forecastquery.literals import ResourceServiceName
```
