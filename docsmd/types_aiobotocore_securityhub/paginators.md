...
) -> aiobotocore.paginate.AioPageIterator[GetFindingsV2ResponseTypeDef]:  # (5)
    ...
```
...
5. See `AioPageIterator[GetFindingsV2ResponseTypeDef]`
...
Type annotations and code completion for `#!python session.create_client("securityhub").get_paginator("get_recommended_policy_v2")`.
...
from types_aiobotocore_securityhub.paginator import GetRecommendedPolicyV2Paginator

session = get_session()
async with session.create_client("securityhub") as client:  # (1)
    paginator: GetRecommendedPolicyV2Paginator = client.get_paginator("get_recommended_policy_v2")  # (2)
    async for item in paginator.paginate(...):
        item: GetRecommendedPolicyV2ResponseTypeDef
        print(item)  # (3)
```

1. client: [SecurityHubClient](./client.md)
2. paginator: [GetRecommendedPolicyV2Paginator](./paginators.md#getrecommendedpolicyv2paginator)
3. item: `AioPageIterator[GetRecommendedPolicyV2ResponseTypeDef]`
...
def paginate(
    ...
    *,
    MetadataUid: str,
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (1)
) -> aiobotocore.paginate.AioPageIterator[GetRecommendedPolicyV2ResponseTypeDef]:  # (2)
    ...
```

1. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
2. See `AioPageIterator[GetRecommendedPolicyV2ResponseTypeDef]`
...
def paginate(
    ...
    *,
    ...
    SortCriteria: Sequence[SortCriterionTypeDef] = ...,  # (3)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> aiobotocore.paginate.AioPageIterator[GetResourcesV2ResponseTypeDef]:  # (5)
    ...
```
...
3. See `Sequence[SortCriterionTypeDef]`
4. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
5. See `AioPageIterator[GetResourcesV2ResponseTypeDef]`
