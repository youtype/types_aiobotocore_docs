...
```python
# GetComplianceSummaryPaginatorName usage example
from types_aiobotocore_resourcegroupstaggingapi.literals import GetComplianceSummaryPaginatorName

def get_value() -> GetComplianceSummaryPaginatorName:
    return "get_compliance_summary"
```

```python
# GetComplianceSummaryPaginatorName definition
GetComplianceSummaryPaginatorName = Literal[
...
```python
# GetTagKeysPaginatorName usage example
from types_aiobotocore_resourcegroupstaggingapi.literals import GetTagKeysPaginatorName

def get_value() -> GetTagKeysPaginatorName:
    return "get_tag_keys"
```

```python
# GetTagKeysPaginatorName definition
GetTagKeysPaginatorName = Literal[
    "get_tag_keys",
]
```
...
```python
# GetTagValuesPaginatorName usage example
from types_aiobotocore_resourcegroupstaggingapi.literals import GetTagValuesPaginatorName

def get_value() -> GetTagValuesPaginatorName:
    return "get_tag_values"
```

```python
# GetTagValuesPaginatorName definition
GetTagValuesPaginatorName = Literal[
    "get_tag_values",
]
```
...
```python
# GroupByAttributeType usage example
from types_aiobotocore_resourcegroupstaggingapi.literals import GroupByAttributeType

def get_value() -> GroupByAttributeType:
    return "REGION"
```

```python
# GroupByAttributeType definition
GroupByAttributeType = Literal[
    "REGION",
    "RESOURCE_TYPE",
    "TARGET_ID",
]
...
```python
# ListRequiredTagsPaginatorName usage example
from types_aiobotocore_resourcegroupstaggingapi.literals import ListRequiredTagsPaginatorName

def get_value() -> ListRequiredTagsPaginatorName:
    return "list_required_tags"
```

```python
# ListRequiredTagsPaginatorName definition
ListRequiredTagsPaginatorName = Literal[
    "list_required_tags",
]
```
## TargetIdTypeType
...
```python
# TargetIdTypeType usage example
from types_aiobotocore_resourcegroupstaggingapi.literals import TargetIdTypeType

def get_value() -> TargetIdTypeType:
    return "ACCOUNT"
```

```python
# TargetIdTypeType definition
TargetIdTypeType = Literal[
    "ACCOUNT",
    "OU",
    "ROOT",
]
...
```python
# ResourceGroupsTaggingAPIServiceName usage example
from types_aiobotocore_resourcegroupstaggingapi.literals import ResourceGroupsTaggingAPIServiceName

def get_value() -> ResourceGroupsTaggingAPIServiceName:
    return "resourcegroupstaggingapi"
```

```python
# ResourceGroupsTaggingAPIServiceName definition
ResourceGroupsTaggingAPIServiceName = Literal[
...
from types_aiobotocore_resourcegroupstaggingapi.literals import RegionName
