...
class AnomalyMonitorPaginatorTypeDef(TypedDict):
    ...
    LastEvaluatedDate: NotRequired[str],
    MonitorDimension: NotRequired[MonitorDimensionType],  # (2)
    MonitorSpecification: NotRequired[ExpressionPaginatorTypeDef],  # (3)
    DimensionalValueCount: NotRequired[int],
```

1. See [:material-code-brackets: MonitorTypeType](./literals.md#monitortypetype)
2. See [:material-code-brackets: MonitorDimensionType](./literals.md#monitordimensiontype)
3. See [:material-code-braces: ExpressionPaginatorTypeDef](./type_defs.md#expressionpaginatortypedef)
...
class AnomalySubscriptionPaginatorTypeDef(TypedDict):
    ...
    AccountId: NotRequired[str],
    Threshold: NotRequired[float],
    ThresholdExpression: NotRequired[ExpressionPaginatorTypeDef],  # (3)
```
