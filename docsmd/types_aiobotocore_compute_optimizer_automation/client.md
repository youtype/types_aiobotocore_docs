...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation")`
...
This class provides code completion for `#!python session.create_client("compute-optimizer-automation").exceptions` structure.

```python
# ComputeOptimizerAutomationClient.exceptions usage example
...
async with session.create_client("compute-optimizer-automation") as client:
    try:
        ...
        client.IdempotencyTokenInUseException,
        client.IdempotentParameterMismatchException,
        client.InternalServerException,
        client.InvalidParameterValueException,
        client.NotManagementAccountException,
...
```python
# ComputeOptimizerAutomationClient usage type checking example

from types_aiobotocore_compute_optimizer_automation.client import Exceptions
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").can_paginate` method.
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").generate_presigned_url` method.
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").associate_accounts` method.
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").create_automation_rule` method.
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").delete_automation_rule` method.
...
await def delete_automation_rule(
    self,
    *,
    ruleArn: str,
    ruleRevision: int,
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").disassociate_accounts` method.
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").get_automation_event` method.
...
await def get_automation_event(
    self,
    *,
    eventId: str,
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").get_automation_rule` method.
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").get_enrollment_configuration` method.
...
await def get_enrollment_configuration(
    self,
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").list_accounts` method.
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").list_automation_event_steps` method.
...
await def list_automation_event_steps(
    self,
    *,
    eventId: str,
    maxResults: int = ...,
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").list_automation_event_summaries` method.
...
await def list_automation_event_summaries(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").list_automation_events` method.
...
await def list_automation_events(
    self,
    *,
    filters: Sequence[AutomationEventFilterTypeDef] = ...,  # (1)
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").list_automation_rule_preview` method.
...
await def list_automation_rule_preview(
    self,
    *,
    ruleType: RuleTypeType,  # (1)
    recommendedActionTypes: Sequence[RecommendedActionTypeType],  # (2)
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").list_automation_rule_preview_summaries` method.
...
await def list_automation_rule_preview_summaries(
    self,
    *,
    ruleType: RuleTypeType,  # (1)
    recommendedActionTypes: Sequence[RecommendedActionTypeType],  # (2)
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").list_automation_rules` method.
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").list_recommended_action_summaries` method.
...
await def list_recommended_action_summaries(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").list_recommended_actions` method.
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").list_tags_for_resource` method.
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").rollback_automation_event` method.
...
await def rollback_automation_event(
    self,
    *,
    eventId: str,
    clientToken: str = ...,
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").start_automation_event` method.
...
await def start_automation_event(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").tag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").untag_resource` method.
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").update_automation_rule` method.
...
await def update_automation_rule(
    self,
    *,
    ruleArn: str,
    ruleRevision: int,
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").update_enrollment_configuration` method.
...
await def update_enrollment_configuration(
    self,
    *,
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").__aenter__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/compute-optimizer-automation.html#ComputeOptimizerAutomation.Client)
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").__aexit__` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/compute-optimizer-automation.html#ComputeOptimizerAutomation.Client)
...
Type annotations and code completion for `#!python session.create_client("compute-optimizer-automation").get_paginator` method with overloads.
