...
def paginate(
    ...
    *,
    ...
    language: RecommendationLanguageType = ...,  # (3)
    PaginationConfig: PaginatorConfigTypeDef = ...,  # (4)
) -> aiobotocore.paginate.AioPageIterator[ListRecommendationResourcesResponseTypeDef]:  # (5)
    ...
```
...
3. See [:material-code-brackets: RecommendationLanguageType](./literals.md#recommendationlanguagetype)
4. See [:material-code-braces: PaginatorConfigTypeDef](./type_defs.md#paginatorconfigtypedef)
5. See `AioPageIterator[ListRecommendationResourcesResponseTypeDef]`
...
) -> aiobotocore.paginate.AioPageIterator[ListRecommendationsResponseTypeDef]:  # (7)
    ...
```
...
7. See `AioPageIterator[ListRecommendationsResponseTypeDef]`
