...
> [Index](../README.md) > [CloudControlApi](./README.md) > Literals
...
```python
# ListResourceRequestsPaginatorName usage example
...
```python
# ListResourceRequestsPaginatorName definition
...
from types_aiobotocore_cloudcontrol.literals import OperationStatusType
...
from types_aiobotocore_cloudcontrol.literals import OperationType
...
```python
# ResourceRequestSuccessWaiterName usage example
from types_aiobotocore_cloudcontrol.literals import ResourceRequestSuccessWaiterName

def get_value() -> ResourceRequestSuccessWaiterName:
    return "resource_request_success"
```

```python
# ResourceRequestSuccessWaiterName definition
ResourceRequestSuccessWaiterName = Literal[
...
```python
# CloudControlApiServiceName usage example
from types_aiobotocore_cloudcontrol.literals import CloudControlApiServiceName

def get_value() -> CloudControlApiServiceName:
    return "cloudcontrol"
```

```python
# CloudControlApiServiceName definition
CloudControlApiServiceName = Literal[
    "cloudcontrol",
]
```
## ServiceName
...
from types_aiobotocore_cloudcontrol.literals import ServiceName
...
from types_aiobotocore_cloudcontrol.literals import ResourceServiceName
...
from types_aiobotocore_cloudcontrol.literals import RegionName
