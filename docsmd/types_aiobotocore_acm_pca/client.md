...
Type annotations and code completion for `#!python session.create_client("acm-pca").close` method.
...
Type annotations and code completion for `#!python session.create_client("acm-pca").issue_certificate` method.
