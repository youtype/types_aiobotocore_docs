...
```python
# SagemakerEdgeManagerServiceName usage example
...
```python
# SagemakerEdgeManagerServiceName definition
SagemakerEdgeManagerServiceName = Literal[
    "sagemaker-edge",
]
```
## ServiceName
