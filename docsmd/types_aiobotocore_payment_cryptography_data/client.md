...
Type annotations and code completion for `#!python session.create_client("payment-cryptography-data").generate_as2805_kek_validation` method.
...
await def generate_as2805_kek_validation(
    self,
    *,
    KeyIdentifier: str,
...
Type annotations and code completion for `#!python session.create_client("payment-cryptography-data").translate_key_material` method.
...
await def translate_key_material(
    self,
    *,
