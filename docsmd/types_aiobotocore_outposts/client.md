...
Type annotations and code completion for `#!python session.create_client("outposts").create_renewal` method.
...
Type annotations and code completion for `#!python session.create_client("outposts").get_renewal_pricing` method.
...
Type annotations and code completion for `#!python session.create_client("outposts").start_outpost_decommission` method.
...
await def start_outpost_decommission(
    self,
    *,
    OutpostIdentifier: str,
    ValidateOnly: bool = ...,
