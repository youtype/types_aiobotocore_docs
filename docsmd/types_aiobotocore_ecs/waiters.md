...
Type annotations and code completion for `#!python session.create_client("ecs").get_waiter("daemon_active")`.
...
from types_aiobotocore_ecs.waiter import DaemonActiveWaiter
...
Type annotations and code completion for `#!python session.create_client("ecs").get_waiter("daemon_deployment_stopped")`.
...
from types_aiobotocore_ecs.waiter import DaemonDeploymentStoppedWaiter
...
Type annotations and code completion for `#!python session.create_client("ecs").get_waiter("daemon_deployment_successful")`.
...
from types_aiobotocore_ecs.waiter import DaemonDeploymentSuccessfulWaiter
...
Type annotations and code completion for `#!python session.create_client("ecs").get_waiter("daemon_task_definition_active")`.
...
from types_aiobotocore_ecs.waiter import DaemonTaskDefinitionActiveWaiter
...
Type annotations and code completion for `#!python session.create_client("ecs").get_waiter("daemon_task_definition_deleted")`.
...
from types_aiobotocore_ecs.waiter import DaemonTaskDefinitionDeletedWaiter
