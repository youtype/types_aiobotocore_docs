...
Type annotations and code completion for `#!python session.create_client("groundstation").get_waiter("contact_updated")`.
...
from types_aiobotocore_groundstation.waiter import ContactUpdatedWaiter
