...
- [GetClusterInputClusterActiveWaitTypeDef](./type_defs.md#getclusterinputclusteractivewaittypedef)
- [GetClusterInputClusterNotExistsWaitTypeDef](./type_defs.md#getclusterinputclusternotexistswaittypedef)
