...
```python
# ListCustomerAgreementsRequestListCustomerAgreementsPaginateTypeDef definition

class ListCustomerAgreementsRequestListCustomerAgreementsPaginateTypeDef(TypedDict):
...
```python
# ListReportsRequestListReportsPaginateTypeDef definition
