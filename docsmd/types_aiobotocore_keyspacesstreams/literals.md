...
> [Index](../README.md) > [KeyspacesStreams](./README.md) > Literals
...
```python
# GetStreamPaginatorName definition
GetStreamPaginatorName = Literal[
    "get_stream",
]
```
...
from types_aiobotocore_keyspacesstreams.literals import ListStreamsPaginatorName
...
from types_aiobotocore_keyspacesstreams.literals import OriginTypeType
...
from types_aiobotocore_keyspacesstreams.literals import ShardFilterTypeType
...
from types_aiobotocore_keyspacesstreams.literals import ShardIteratorTypeType
...
from types_aiobotocore_keyspacesstreams.literals import StreamStatusType
...
from types_aiobotocore_keyspacesstreams.literals import StreamViewTypeType
...
```python
# KeyspacesStreamsServiceName usage example
from types_aiobotocore_keyspacesstreams.literals import KeyspacesStreamsServiceName

def get_value() -> KeyspacesStreamsServiceName:
    return "keyspacesstreams"
```

```python
# KeyspacesStreamsServiceName definition
KeyspacesStreamsServiceName = Literal[
    "keyspacesstreams",
]
```
## ServiceName
...
from types_aiobotocore_keyspacesstreams.literals import ServiceName
...
from types_aiobotocore_keyspacesstreams.literals import ResourceServiceName
...
from types_aiobotocore_keyspacesstreams.literals import PaginatorName
