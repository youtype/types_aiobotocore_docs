...
Type annotations and code completion for `#!python session.create_client("signer").close` method.
...
Type annotations and code completion for `#!python session.create_client("signer").get_revocation_status` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/signer.html#Signer.Client.get_revocation_status)
...
1. See [:material-code-braces: GetRevocationStatusRequestRequestTypeDef](./type_defs.md#getrevocationstatusrequestrequesttypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/signer.html#Signer.Client.sign_payload)
...
1. See [:material-code-braces: SignPayloadRequestRequestTypeDef](./type_defs.md#signpayloadrequestrequesttypedef) 
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/signer.html#Signer.Client.__aenter__)
...
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/signer.html#Signer.Client.__aexit__)
