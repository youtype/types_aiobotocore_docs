...
class UpdateConfiguredTableInputTypeDef(TypedDict):
    ...
    name: NotRequired[str],
    description: NotRequired[str],
    analysisMethod: NotRequired[AnalysisMethodType],  # (1)
    selectedAnalysisMethods: NotRequired[Sequence[SelectedAnalysisMethodType]],  # (2)
```

1. See [:material-code-brackets: AnalysisMethodType](./literals.md#analysismethodtype)
2. See `Sequence[SelectedAnalysisMethodType]`
