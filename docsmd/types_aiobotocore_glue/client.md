...
async with session.create_client("glue") as client:
    try:
        ...
        client.MaterializedViewRefreshTaskNotRunningException,
        client.MaterializedViewRefreshTaskRunningException,
        client.MaterializedViewRefreshTaskStoppingException,
...
Type annotations and code completion for `#!python session.create_client("glue").delete_connection_type` method.
...
await def delete_connection_type(
    self,
    *,
    ConnectionType: str,
) -> dict[str, Any]:
...
Type annotations and code completion for `#!python session.create_client("glue").delete_integration_resource_property` method.
...
await def delete_integration_resource_property(
    self,
    *,
    ResourceArn: str,
) -> dict[str, Any]:
...
Type annotations and code completion for `#!python session.create_client("glue").get_catalog` method.
...
Type annotations and code completion for `#!python session.create_client("glue").get_catalogs` method.
...
Type annotations and code completion for `#!python session.create_client("glue").get_column_statistics_task_settings` method.
...
Type annotations and code completion for `#!python session.create_client("glue").get_entity_records` method.
...
Type annotations and code completion for `#!python session.create_client("glue").get_glue_identity_center_configuration` method.
...
await def get_glue_identity_center_configuration(
    self,
...
Type annotations and code completion for `#!python session.create_client("glue").get_integration_resource_property` method.
...
Type annotations and code completion for `#!python session.create_client("glue").get_integration_table_properties` method.
...
Type annotations and code completion for `#!python session.create_client("glue").get_materialized_view_refresh_task_run` method.
...
await def get_materialized_view_refresh_task_run(
    self,
    *,
    CatalogId: str,
...
Type annotations and code completion for `#!python session.create_client("glue").list_connection_types` method.
...
Type annotations and code completion for `#!python session.create_client("glue").list_entities` method.
...
Type annotations and code completion for `#!python session.create_client("glue").list_integration_resource_properties` method.
...
await def list_integration_resource_properties(
    self,
    *,
    Marker: str = ...,
...
Type annotations and code completion for `#!python session.create_client("glue").list_materialized_view_refresh_task_runs` method.
...
await def list_materialized_view_refresh_task_runs(
    self,
    *,
    CatalogId: str,
    DatabaseName: str = ...,
...
Type annotations and code completion for `#!python session.create_client("glue").modify_integration` method.
...
Type annotations and code completion for `#!python session.create_client("glue").register_connection_type` method.
...
await def register_connection_type(
    self,
    *,
    ConnectionType: str,
...
Type annotations and code completion for `#!python session.create_client("glue").start_column_statistics_task_run_schedule` method.
...
Type annotations and code completion for `#!python session.create_client("glue").start_materialized_view_refresh_task_run` method.
...
await def start_materialized_view_refresh_task_run(
    self,
    *,
    CatalogId: str,
    DatabaseName: str,
...
Type annotations and code completion for `#!python session.create_client("glue").stop_column_statistics_task_run_schedule` method.
...
Type annotations and code completion for `#!python session.create_client("glue").stop_materialized_view_refresh_task_run` method.
...
await def stop_materialized_view_refresh_task_run(
    self,
    *,
    CatalogId: str,
    DatabaseName: str,
...
Type annotations and code completion for `#!python session.create_client("glue").update_catalog` method.
...
Type annotations and code completion for `#!python session.create_client("glue").update_column_statistics_task_settings` method.
...
Type annotations and code completion for `#!python session.create_client("glue").update_glue_identity_center_configuration` method.
...
await def update_glue_identity_center_configuration(
    self,
    *,
    Scopes: Sequence[str] = ...,
    UserBackgroundSessionsEnabled: bool = ...,
...
Type annotations and code completion for `#!python session.create_client("glue").update_integration_resource_property` method.
...
Type annotations and code completion for `#!python session.create_client("glue").update_integration_table_properties` method.
