...
Type annotations and code completion for `#!python session.create_client("cloud9").close` method.
[:material-aws: boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloud9/client/close.html)
...
Type annotations and code completion for `#!python session.create_client("cloud9").create_environment_membership` method.
